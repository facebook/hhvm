...
cdef shared_ptr[_fbthrift_cbindings.cCustomException] CustomException_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cCustomException](deref(
        (<_fbthrift_ctypes.CustomException?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))
...
cdef shared_ptr[_fbthrift_cbindings.cShouldBeBoxed] ShouldBeBoxed_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cShouldBeBoxed](deref(
        (<_fbthrift_ctypes.ShouldBeBoxed?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))
