...
template <> struct TSchemaAssociation<::a::different::ns::AStruct> {
...
template <> struct TSchemaAssociation<::a::different::ns::AStructB> {
  static ::folly::Range<const ::std::string_view*>(*bundle)();
  static constexpr int64_t programId = 8484490338943287823;
  static constexpr ::std::string_view definitionKey = {"\x8b\x29\x28\xed\x06\xe9\xbe\x4d\xf0\x75\xa7\x6c\x27\xd1\xce\x18", 16};
};
template <> struct TSchemaAssociation<::a::different::ns::AnEnum> {
  static ::folly::Range<const ::std::string_view*>(*bundle)();
  static constexpr int64_t programId = 8484490338943287823;
