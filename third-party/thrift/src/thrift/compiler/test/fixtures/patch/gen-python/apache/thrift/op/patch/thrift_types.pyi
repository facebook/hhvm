...
class OptionalBinaryPatch(_fbthrift_python_types.Struct):
    ...
    ensure: _typing.Final[_typing.Optional[_fbthrift_iobuf.IOBuf]] = ...
    patch: _typing.Final[BinaryPatch] = ...
    def __init__(
        self, *,
        clear: _typing.Optional[bool]=...,
        patchPrior: _typing.Optional[BinaryPatch]=...,
        ensure: _typing.Optional[_fbthrift_iobuf.IOBuf]=...,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[bool, BinaryPatch, _fbthrift_iobuf.IOBuf, BinaryPatch]]]: ...
