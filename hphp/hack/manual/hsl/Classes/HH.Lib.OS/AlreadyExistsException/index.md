...
+ [` ::_getValidErrno(): Errno `](/hsl/Classes/HH.Lib.OS/AlreadyExistsException/_getValidErrno/)
+ [` ->__construct(string $message) `](/hsl/Classes/HH.Lib.OS/AlreadyExistsException/__construct/)
