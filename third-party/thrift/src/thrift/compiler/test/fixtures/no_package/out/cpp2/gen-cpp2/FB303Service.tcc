...
typedef apache::thrift::ThriftPresult<true, apache::thrift::FieldData<0, ::apache::thrift::type_class::structure, ::cpp2::ReservedKeyword*>> FB303Service_simple_rpc_presult;
//
// Service Methods
//
...
void FB303ServiceAsyncProcessor::executeRequest_simple_rpc(
  ...
  apache::thrift::HandlerCallback<std::unique_ptr<::cpp2::ReservedKeyword>>::DecoratorAfterCallback decoratorCallback{
    static_cast<void*>(iface_),
    apache::thrift::ServiceHandler<::cpp2::FB303Service>::fbthrift_invoke_decorator_after_simple_rpc};
 auto callback =
      apache::thrift::HandlerCallbackPtr<std::unique_ptr<::cpp2::ReservedKeyword>>::make(
...
/* static */ apache::thrift::SerializedResponse FB303ServiceAsyncProcessor::return_simple_rpc(
    ...
    ::cpp2::ReservedKeyword const& _return) {
  ProtocolOut_ prot;
  ::cpp2::FB303Service_simple_rpc_presult result;
  result.get<0>().value = const_cast<::cpp2::ReservedKeyword*>(&_return);
