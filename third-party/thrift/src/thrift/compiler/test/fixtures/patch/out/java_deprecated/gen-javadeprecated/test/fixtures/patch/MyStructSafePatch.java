...
public class MyStructSafePatch implements TBase, java.io.Serializable, Cloneable, Comparable<MyStructSafePatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MyStructSafePatch.class, metaDataMap);
  }
  ...
  public MyStructSafePatch setVersion(int version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public MyStructSafePatch setData(byte[] data) {
    this.data = data;
    return this;
  }
  ...
  @Override
  public int compareTo(MyStructSafePatch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MyStructSafePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
