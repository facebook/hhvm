...
::std::string_view _fbthrift_schema_c3ce7c68ed1b6c88() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_c3ce7c68ed1b6c88_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_c3ce7c68ed1b6c88_uris() {
  return {};
}
