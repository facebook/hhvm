...
class MyStruct(_fbthrift_python_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.Mapping[str, str], _typing.AbstractSet[str], _typing.Sequence[int], LateDefStruct, MyData, MyEnum, bytes, str, float, float, int, int, int, int, bool, LateDefStruct, MyUnion, MyData, MyEnum, bytes, str, float, float, int, int, int, int, bool]]]: ...
...
class MyStructFieldPatch(_fbthrift_python_types.Struct):
    optMapVal: _typing.Final[MyStructFieldN28Patch] = ...
    optSetVal: _typing.Final[MyStructFieldN27Patch] = ...
    optListVal: _typing.Final[MyStructFieldN26Patch] = ...
    optLateStructVal: _typing.Final[LateDefStructPatch] = ...
    optStructVal: _typing.Final[MyDataPatch] = ...
    optEnumVal: _typing.Final[MyStructFieldN23Patch] = ...
    ...
    def __init__(
        self, *,
        optMapVal: _typing.Optional[MyStructFieldN28Patch]=...,
        optSetVal: _typing.Optional[MyStructFieldN27Patch]=...,
        optListVal: _typing.Optional[MyStructFieldN26Patch]=...,
        optLateStructVal: _typing.Optional[LateDefStructPatch]=...,
        optStructVal: _typing.Optional[MyDataPatch]=...,
        optEnumVal: _typing.Optional[MyStructFieldN23Patch]=...,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[MyStructFieldN28Patch, MyStructFieldN27Patch, MyStructFieldN26Patch, LateDefStructPatch, MyDataPatch, MyStructFieldN23Patch, apache.thrift.op.patch.thrift_types.BinaryPatch, apache.thrift.op.patch.thrift_types.StringPatch, apache.thrift.op.patch.thrift_types.DoublePatch, apache.thrift.op.patch.thrift_types.FloatPatch, apache.thrift.op.patch.thrift_types.I64Patch, apache.thrift.op.patch.thrift_types.I32Patch, apache.thrift.op.patch.thrift_types.I16Patch, apache.thrift.op.patch.thrift_types.BytePatch, apache.thrift.op.patch.thrift_types.BoolPatch, LateDefStructPatch, MyUnionPatch, MyDataPatch, MyStructFieldN10Patch, apache.thrift.op.patch.thrift_types.BinaryPatch, apache.thrift.op.patch.thrift_types.StringPatch, apache.thrift.op.patch.thrift_types.DoublePatch, apache.thrift.op.patch.thrift_types.FloatPatch, apache.thrift.op.patch.thrift_types.I64Patch, apache.thrift.op.patch.thrift_types.I32Patch, apache.thrift.op.patch.thrift_types.I16Patch, apache.thrift.op.patch.thrift_types.BytePatch, apache.thrift.op.patch.thrift_types.BoolPatch]]]: ...
...
class MyStructFieldN26Patch(_fbthrift_python_types.Struct):
    ...
    def _to_python(self) -> MyStructFieldN26Patch: ...
    def _to_py3(self) -> "test.fixtures.patch.module.types.MyStructFieldN26Patch": ...  # type: ignore
    def _to_py_deprecated(self) -> "module.ttypes.MyStructFieldN26Patch": ...  # type: ignore


class MyStructFieldN27Patch(_fbthrift_python_types.Struct):
    ...
    def _to_python(self) -> MyStructFieldN27Patch: ...
    def _to_py3(self) -> "test.fixtures.patch.module.types.MyStructFieldN27Patch": ...  # type: ignore
    def _to_py_deprecated(self) -> "module.ttypes.MyStructFieldN27Patch": ...  # type: ignore
