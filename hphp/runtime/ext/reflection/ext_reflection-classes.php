...
class ReflectionClass implements Reflector {
  ...
  private function normalizeMethodName($name) {
    if (!$this->caseInsensitiveMethodMap) {
      $this->getInfo();
    }

    $properCaseName = $this->caseInsensitiveMethodMap[strtolower($name)];
  ...
  public function getMethod($name) {
    if (!$this->info) {
      ...
      if (isset($methods[$name])) $method = $methods[$name];
    }
    if (empty($method)) {
      $class = $this->name;
...
class ReflectionProperty implements Reflector {
  ...
  private $caseInsensitiveMethodMap = null;
