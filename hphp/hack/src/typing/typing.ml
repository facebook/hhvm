...
let rec rewrite_expr_tree_maketree env expr f =
  ...
  let (env, expr_) =
    match expr_ with
    | Call
        ((fun_pos, (Lfun (fun_, idl) | Efun (fun_, idl))), targs, args, variadic)
      ->
      ...
      (env, Call ((fun_pos, Lfun (fun_, idl)), targs, args, variadic))
    | Call _ ->
      ...
      | ( _,
          New
            ( _,
              ...
              [
                _;
                (_, (Varray (_, children) | ValCollection (Vec, _, children)));
                _;
                _;
              ],
              _,
