...
if(HHVM_DYNAMIC_EXTENSION_DIR)
  ...
  if(UNIX)
    if(IS_ABSOLUTE "${CMAKE_INSTALL_LIBDIR}")
      set(HHVM_DYNAMIC_EXTENSION_DIR "${CMAKE_INSTALL_LIBDIR}/hhvm/extensions")
    else()
      set(HHVM_DYNAMIC_EXTENSION_DIR "${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/hhvm/extensions")
    endif()
    add_definitions(-DHHVM_DYNAMIC_EXTENSION_DIR="${HHVM_DYNAMIC_EXTENSION_DIR}")
  endif()
endif()
