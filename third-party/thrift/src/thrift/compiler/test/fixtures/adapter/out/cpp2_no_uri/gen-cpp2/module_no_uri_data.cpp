...
THRIFT_DATA_MEMBER const std::array<std::string_view, 1> TStructDataStorage<::cpp2::RefUnion>::storage_names = { {
  "field1"sv,
}};
...
::folly::Range<const ::std::string_view*>(*TSchemaAssociation<::cpp2::RefUnion, false>::bundle)() =
    nullptr;
