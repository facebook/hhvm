...
class _std_unordered_map__Map__i32_patch_I16Patch(_typing.Mapping[int, _apache_thrift_op_patch_types.I16Patch], _typing.Hashable):
    def __init__(self, items: _typing.Optional[_typing.Mapping[int, _apache_thrift_op_patch_types.I16Patch]]=None) -> None: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __copy__(self) -> _typing.Mapping[int, _apache_thrift_op_patch_types.I16Patch]: ...
    def __getitem__(self, key: int) -> _apache_thrift_op_patch_types.I16Patch: ...
    def __iter__(self) -> _typing.Iterator[int]: ...


class _std_unordered_set__Set__string(_typing.AbstractSet[str], _typing.Hashable):
    def __init__(self, items: _typing.Optional[_typing.AbstractSet[str]]=None) -> None: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __copy__(self) -> _typing.AbstractSet[str]: ...
    def __contains__(self, x: object) -> bool: ...
    def union(self, other: _typing.AbstractSet[str]) -> '_std_unordered_set__Set__string': ...
    def intersection(self, other: _typing.AbstractSet[str]) -> '_std_unordered_set__Set__string': ...
    def difference(self, other: _typing.AbstractSet[str]) -> '_std_unordered_set__Set__string': ...
    def symmetric_difference(self, other: _typing.AbstractSet[str]) -> '_std_unordered_set__Set__string': ...
    def issubset(self, other: _typing.AbstractSet[str]) -> bool: ...
    def issuperset(self, other: _typing.AbstractSet[str]) -> bool: ...
    def __iter__(self) -> _typing.Iterator[str]: ...
