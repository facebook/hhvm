...
apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>::semifuture_init(::std::int64_t p_int1) {
...
apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>::future_init(::std::int64_t p_int1) {
...
apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>::co_init(::std::int64_t p_int1) {
...
folly::coro::Task<::std::int64_t> apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>::co_init(
...
void apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>::async_tm_init(
