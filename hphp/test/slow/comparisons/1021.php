...
$i = 0;
 ...
 print ++$i;
 print "\t";
 print (darray['b' => 1]<=__hhvm_intrinsics\dummy_cast_to_kindofarray(vec[])) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['b' => 1];
 ...
 print ++$i;
 print "\t";
 print (darray['b' => 1]<=darray['0' => '1']) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['b' => 1];
 ...
 print ++$i;
 print "\t";
 print (darray['b' => 1]<=darray['a' => 1]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['b' => 1];
 ...
 print ++$i;
 print "\t";
 print (darray['b' => 1]<=darray['b' => 1]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['b' => 1];
 ...
 print ++$i;
 print "\t";
 print (darray['b' => 1]<=darray['a' => 1, 'b' => 2]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['b' => 1];
 ...
 print ++$i;
 print "\t";
 print (darray['b' => 1]<=varray[darray['a' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['b' => 1];
 ...
 print ++$i;
 print "\t";
 print (darray['b' => 1]<=varray[darray['b' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['b' => 1];
