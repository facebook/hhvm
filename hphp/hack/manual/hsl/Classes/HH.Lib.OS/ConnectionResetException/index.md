---
title: ConnectionResetException
---
...
+ [` ::_getValidErrno(): Errno `](/docs/hsl/Classes/HH.Lib.OS/ConnectionResetException/_getValidErrno/)
+ [` ->__construct(string $message) `](/docs/hsl/Classes/HH.Lib.OS/ConnectionResetException/__construct/)
