...
apache::thrift::ServiceRequestInfoMap InteractLocallyServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"SharedInteraction.init",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::thrift::shared_interactions::InteractLocally>("SharedInteraction", "init")}},
  {"SharedInteraction.do_something",
    { false,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::thrift::shared_interactions::InteractLocally>("SharedInteraction", "do_something")}},
  {"SharedInteraction.tear_down",
    { false,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::thrift::shared_interactions::InteractLocally>("SharedInteraction", "tear_down")}},
  };
