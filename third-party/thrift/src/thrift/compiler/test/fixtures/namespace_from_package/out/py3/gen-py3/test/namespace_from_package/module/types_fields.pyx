...
cdef class __Foo_FieldsSetter(__StructFieldsSetter):
    ...
    @staticmethod
    cdef __Foo_FieldsSetter _fbthrift_create(_test_namespace_from_package_module_cbindings.cFoo* struct_cpp_obj):
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        ...
        if _fbthrift_value is None:
            __reset_field[_test_namespace_from_package_module_cbindings.cFoo](deref(self._struct_cpp_obj), 0)
            return
