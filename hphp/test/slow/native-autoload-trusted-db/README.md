...
3. Find the DB that this test generated. Run 'hphp/test/run --verbose --no-clean hphp/test/slow/native-autoload-trusted-db/trusted-autoload.php' and look for something like: -vAutoload.DB.Path='/tmp/hphp-test-MG8uqD/hphp/test/slow/native-autoload-trusted-db/trusted-autoload.php/autoloadDB.0' in the repro instructions.
