...
namespace module_constants {
  ...
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_590aa06b465b942_includes();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_590aa06b465b942_uris();
