...
::std::string_view _fbthrift_schema_8cdf804324301929() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_8cdf804324301929_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_8cdf804324301929_uris() {
  return {};
}
