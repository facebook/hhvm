...
public class AdaptedStructWithTerseInternBox implements TBase, java.io.Serializable, Cloneable {
  ...
  public static AdaptedStructWithTerseInternBox deserialize(TProtocol iprot) throws TException {
    ...
    AdaptedStructWithTerseInternBox _that;
    _that = new AdaptedStructWithTerseInternBox(
      tmp_field1
      ,tmp_field2
    );
    _that.validate();
