...
public class FastServer implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("FastServer");
   ...
   */
  public FastServer(FastServer other) {
  }

  public FastServer deepCopy() {
    return new FastServer(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof FastServer))
      return false;
    FastServer that = (FastServer)_that;
  ...
  public static FastServer deserialize(TProtocol iprot) throws TException {
    TField __field;
