...
apache::thrift::ServiceHandler<::test::namespace_from_package_without_module_name::TestService>::semifuture_init(::std::int64_t p_int1) {
...
apache::thrift::ServiceHandler<::test::namespace_from_package_without_module_name::TestService>::future_init(::std::int64_t p_int1) {
  ...
  return apache::thrift::detail::si::future(
      semifuture_init(p_int1),
      getInternalKeepAlive());
}

#if FOLLY_HAS_COROUTINES
folly::coro::Task<::std::int64_t>
apache::thrift::ServiceHandler<::test::namespace_from_package_without_module_name::TestService>::co_init(::std::int64_t p_int1) {
  ...
  folly::throw_exception(apache::thrift::detail::si::UnimplementedCoroMethod::
                             withCapturedArgs<::std::int64_t /*int1*/>(p_int1));
}

folly::coro::Task<::std::int64_t> apache::thrift::ServiceHandler<::test::namespace_from_package_without_module_name::TestService>::co_init(
    apache::thrift::RequestParams /* params */, ::std::int64_t p_int1) {
...
void apache::thrift::ServiceHandler<::test::namespace_from_package_without_module_name::TestService>::async_tm_init(
    apache::thrift::HandlerCallbackPtr<::std::int64_t> callback, ::std::int64_t p_int1) {
...
::folly::Range<const ::std::string_view*>(*TSchemaAssociation<::test::namespace_from_package_without_module_name::TestService, false>::bundle)() =
    nullptr;
}
