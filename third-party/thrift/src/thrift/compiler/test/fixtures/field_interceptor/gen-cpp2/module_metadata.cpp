...
StructMetadata<::facebook::thrift::test::InterceptedFields>::gen(ThriftMetadata& metadata) {
  ...
  module_InterceptedFields_fields = new std::array<EncodedThriftField, 6>{{
    ...
    {5, "access_optional_shared_const_field", true, std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I32_TYPE), std::vector<ThriftConstStruct>{*cvStruct("cpp.FieldInterceptor", {{"name", cvString(R"(my::FieldInterceptor)")}}).cv_struct_ref(), *cvStruct("cpp.Ref", {{"type", cvInteger(1)}}).cv_struct_ref(), }},
    {6, "access_optional_boxed_field", true, std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I32_TYPE), std::vector<ThriftConstStruct>{*cvStruct("cpp.FieldInterceptor", {{"name", cvString(R"(my::FieldInterceptor)")}}).cv_struct_ref(), *cvStruct("thrift.Box", {}).cv_struct_ref(), }},
  }};
