...
public class FastServer implements TBase, java.io.Serializable, Cloneable, Comparable<FastServer> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(FastServer.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public FastServer build() {
      FastServer result = new FastServer();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(FastServer other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("FastServer");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
