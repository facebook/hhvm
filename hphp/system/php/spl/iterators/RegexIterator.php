...
class RegexIterator extends FilterIterator 
{
     ...
     * @param integer  $mode       Operation mode, see RegexIterator::setMode() for a list of modes.
     * @param integer  $flags      Special flags, see RegexIterator::setFlags() for a list of available flags.
     * @param integer  $preg_flags The regular expression flags. These flags depend on the operation mode parameter:
     ...
     *
     * Matches (string) RegexIterator::current() (or RegexIterator::key() if the RegexIterator::USE_KEY flag is set) 
    ...
    public function accept()
    {
        ...
        switch ($this->mode) {
            ...
            case self::GET_MATCH:
                ...
                return (preg_match($this->regex, $subject, $this->current, $this->pregFlags) > 0);
     ...
     *                      The available modes are listed below. The actual meanings of these modes are described in 
     ...
     *                       The available flags are listed below. The actual meanings of these flags are described in 
     *                       the predefined constants.
     ...
     *
     * @param integer $preg_flags The regular expression flags. See RegexIterator::__construct() for an overview of 
     *                            available flags. 
     */
