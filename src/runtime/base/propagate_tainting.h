...
#ifndef __HPHP_PROPAGATE_TAINTING_H__
#define __HPHP_PROPAGATE_TAINTING_H__
...
/* we give them different names to avoid possible unwanted automatic casts
 * they do essentially the same things with different argument types */
...
#endif // __HPHP_PROPAGATE_TAINTING_H__
