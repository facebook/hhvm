...
class SmallStruct(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.SmallStruct: ...
...
class containerStruct(thrift.py3.types.Struct, _typing.Hashable):
    ...
    fieldF: _typing.Final[_typing.Sequence[_typing.Sequence[_typing.Sequence[int]]]] = ...
    ...
    fieldN: _typing.Final[_typing.Sequence[int]] = ...
    fieldO: _typing.Final[_typing.Sequence[float]] = ...
    fieldP: _typing.Final[_typing.Sequence[int]] = ...
    fieldQ: _typing.Final[MyEnumA] = ...
    fieldR: _typing.Final[_typing.Optional[_typing.Mapping[str, bool]]] = ...
    fieldS: _typing.Final[_typing.Optional[SmallStruct]] = ...
    fieldT: _typing.Final[_typing.Optional[SmallStruct]] = ...
    fieldU: _typing.Final[_typing.Optional[SmallStruct]] = ...
    fieldX: _typing.Final[_typing.Optional[SmallStruct]] = ...
...
class List__Foo__i64(_typing.Sequence[int], _typing.Hashable):
    ...
    def __radd__(self, other: _typing.Sequence[int]) -> 'List__Foo__i64': ...
    def __reversed__(self) -> _typing.Iterator[int]: ...
    #pyre-ignore[14]: no idea what pyre is on about
    def __iter__(self) -> _typing.Iterator[int]: ...
...
class List__Baz__i32(_typing.Sequence[int], _typing.Hashable):
    ...
    def __radd__(self, other: _typing.Sequence[int]) -> 'List__Baz__i32': ...
    def __reversed__(self) -> _typing.Iterator[int]: ...
    #pyre-ignore[14]: no idea what pyre is on about
    def __iter__(self) -> _typing.Iterator[int]: ...
