...
impl TokenKind {
    ...
    pub fn try_from_u8(tag: u8) -> Option<Self> {
        match tag {
            ...
            67 => Some(TokenKind::Module),
            68 => Some(TokenKind::Namespace),
            69 => Some(TokenKind::New),
            70 => Some(TokenKind::Newctx),
            71 => Some(TokenKind::Newtype),
            72 => Some(TokenKind::Noreturn),
            73 => Some(TokenKind::Num),
            74 => Some(TokenKind::Object),
            75 => Some(TokenKind::Parent),
            76 => Some(TokenKind::Print),
            77 => Some(TokenKind::Private),
            78 => Some(TokenKind::Protected),
            79 => Some(TokenKind::Public),
            80 => Some(TokenKind::Real),
            81 => Some(TokenKind::Reify),
