...
$files_zend = array(
  ...
  'runtime/base/zend_collator.h',
  'runtime/base/zend_collator.cpp',
  'runtime/base/zend_functions.h',
  'runtime/base/zend_functions.cpp',
  'runtime/base/zend_ini.lex.yy.cpp',
  'runtime/base/zend_math.h',
  'runtime/base/zend_multiply.h',
  'runtime/base/zend_pack.h',
  'runtime/base/zend_pack.cpp',
  'runtime/base/zend_php_config.h',
  'runtime/base/zend_printf.h',
  'runtime/base/zend_printf.cpp',
  'runtime/base/zend_qsort.h',
  'runtime/base/zend_qsort.cpp',
  'runtime/base/zend_rand.cpp',
  'runtime/base/zend_scanf.h',
  'runtime/base/zend_scanf.cpp',
  'runtime/base/zend_string.h',
  'runtime/base/zend_string.cpp',
  'runtime/base/zend_strtod.h',
  'runtime/base/zend_strtod.cpp',
  'runtime/base/zend_url.h',
  'runtime/base/zend_url.cpp',
);
$files_php = array(
  'runtime/ext/',
