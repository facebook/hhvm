...
def roundtrip_CapiIssetInspectionStruct(
    x: CapiIssetInspectionStruct,
) -> CapiIssetInspectionStruct: ...
def roundtrip_IssetStruct(x: IssetStruct) -> IssetStruct: ...
def roundtrip_IssetEmpty(x: IssetEmpty) -> IssetEmpty: ...
