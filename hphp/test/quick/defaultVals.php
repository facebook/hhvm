...
class A {
  const foo = 'ABC';
  public function a(?varray  $a0 = null, varray  $a1 = varray[], varray  $a2 = varray[1, 2, 3]) :mixed{}
...
class B implements I {
  ...
  public function b(?varray $b1 = null, varray $y = varray[], int $z1 = 1, int $z2 = 2, float $z3 = 3.0, string $z4 = "abc") :mixed{}
}
