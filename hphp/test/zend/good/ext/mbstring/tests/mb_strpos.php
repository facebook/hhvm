...
function entrypoint_mb_strpos(): void {
  ...
  $r = mb_strpos($euc_jp, "\xc6\xfc\xcb\xdc\xb8\xec", -15, 'EUC-JP');
  ...
  $r = mb_strpos($euc_jp, '0', -15,       'EUC-JP');
  ($r === FALSE) ? print "OK_NEGATIVE_OFFSET\n" : print "NG_NEGATIVE_OFFSET\n";
  $r = mb_strpos($euc_jp, "\xc6\xfc\xcb\xdc\xb8\xec", -50, 'EUC-JP');
  ($r === FALSE) ? print "OK_NEGATIVE_OFFSET\n" : print "NG_NEGATIVE_OFFSET\n";
  ...
  print ("== OUT OF RANGE ==\n");
  $r =  mb_strpos($euc_jp, "\xc6\xfc\xcb\xdc\xb8\xec", 40, 'EUC-JP');
