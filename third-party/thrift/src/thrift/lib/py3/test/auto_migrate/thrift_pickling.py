...
class ThriftPicklingTest(unittest.TestCase):
    python_pickled_data = b"\x80\x04\x95o\x00\x00\x00\x00\x00\x00\x00\x8c\x13thrift.python.types\x94\x8c\x10_unpickle_struct\x94\x93\x94\x8c(pickle_thrift.pickle_thrift.thrift_types\x94\x8c\x04easy\x94\x93\x94C\x08\x15T(\x03foo\x00\x94\x86\x94R\x94."
    py3_pickled_data = b"\x80\x04\x95f\x00\x00\x00\x00\x00\x00\x00\x8c\x15thrift.py3.serializer\x94\x8c\x0bdeserialize\x94\x93\x94\x8c!pickle_thrift.pickle_thrift.types\x94\x8c\x04easy\x94\x93\x94C\t8\x03foo\x05\x02T\x00\x94\x86\x94R\x94."
