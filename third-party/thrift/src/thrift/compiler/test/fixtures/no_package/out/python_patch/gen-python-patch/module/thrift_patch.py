...
class MyStructPatch(
    BaseStructPatch[_fbthrift__module__thrift_types.MyStruct]
):
    pass
    @property
    ...
    def MyDataField(self) -> UnqualifiedFieldPatch[
            _fbthrift__module__thrift_types.MyDataItem,
            MyDataItemPatch]:
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            3,
            _fbthrift_python_types.StructTypeInfo(_fbthrift__module__thrift_types.MyDataItem))
    @property
    def myEnum(self) -> UnqualifiedFieldPatch[
            _fbthrift__module__thrift_types.MyEnum,
            EnumPatch]:
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            4,
            _fbthrift_python_types.EnumTypeInfo(_fbthrift__module__thrift_types.MyEnum))
    @property
...
class ContainersPatch(
    BaseStructPatch[_fbthrift__module__thrift_types.Containers]
):
    pass
    @property
...
class MyDataItemPatch(
    BaseStructPatch[_fbthrift__module__thrift_types.MyDataItem]
):
    pass
...
class MyUnionPatch(
    BaseUnionPatch[_fbthrift__module__thrift_types.MyUnion]
):
    pass
    @property
    ...
    def myStruct(self) -> OptionalFieldPatch[
            _fbthrift__module__thrift_types.MyStruct,
            MyStructPatch]:
        ...
        return OptionalFieldPatch(
            ...
            self._patch,
            2,
            _fbthrift_python_types.StructTypeInfo(_fbthrift__module__thrift_types.MyStruct))
    @property
...
class MyExceptionPatch(
    BaseStructPatch[_fbthrift__module__thrift_types.MyException]
):
    pass
    @property
    def MyIntField(self) -> UnqualifiedFieldPatch[
    ...
    def myUnion(self) -> UnqualifiedFieldPatch[
            _fbthrift__module__thrift_types.MyUnion,
            MyUnionPatch]:
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            4,
            _fbthrift_python_types.StructTypeInfo(_fbthrift__module__thrift_types.MyUnion))
...
class MyExceptionWithMessagePatch(
    BaseStructPatch[_fbthrift__module__thrift_types.MyExceptionWithMessage]
):
    pass
    @property
    def MyIntField(self) -> UnqualifiedFieldPatch[
...
class ReservedKeywordPatch(
    BaseStructPatch[_fbthrift__module__thrift_types.ReservedKeyword]
):
    pass
    @property
...
class UnionToBeRenamedPatch(
    BaseUnionPatch[_fbthrift__module__thrift_types.UnionToBeRenamed]
):
    pass
    @property
