 ...
 *  static expressions;
 */
class StaticStatement /*implements IStaticStatement*/ {
  use Statement;
  use Node;
  ...
  /**
   * Returns $visitor->visitStaticStatement($this) if
  ...
  public function accept(/*mixed*/ $visitor) /*: mixed*/ {
    if (method_exists($visitor, "visitStaticStatement")) {
      // UNSAFE
      return $visitor->visitStaticStatement($this);
