...
void apache::thrift::Client<::cpp2::FooService>::fbthrift_send_simple_rpc(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback, std::unique_ptr<folly::IOBuf> interceptorFrameworkMetadata) {
...
void apache::thrift::Client<::cpp2::FooService>::simple_rpc(std::unique_ptr<apache::thrift::RequestCallback> callback) {
  ::apache::thrift::RpcOptions rpcOptions;
  simple_rpc(rpcOptions, std::move(callback));
}

void apache::thrift::Client<::cpp2::FooService>::simple_rpc(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback) {
...
apache::thrift::SerializedRequest apache::thrift::Client<::cpp2::FooService>::fbthrift_serialize_simple_rpc(const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack) {
  return apache::thrift::detail::ac::withProtocolWriter(apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId(), [&](auto&& prot) {
    ...
    ::cpp2::FooService_simple_rpc_pargs args;
...
void apache::thrift::Client<::cpp2::FooService>::fbthrift_serialize_and_send_simple_rpc(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback, bool stealRpcOptions) {
...
std::pair<::apache::thrift::ContextStack::UniquePtr, std::shared_ptr<::apache::thrift::transport::THeader>> apache::thrift::Client<::cpp2::FooService>::simple_rpcCtx(apache::thrift::RpcOptions* rpcOptions) {
...
void apache::thrift::Client<::cpp2::FooService>::sync_simple_rpc() {
  ::apache::thrift::RpcOptions rpcOptions;
  sync_simple_rpc(rpcOptions);
}

void apache::thrift::Client<::cpp2::FooService>::sync_simple_rpc(apache::thrift::RpcOptions& rpcOptions) {
...
folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::FooService>::fbthrift_semifuture_simple_rpc(apache::thrift::RpcOptions& rpcOptions) {
...
folly::Future<folly::Unit> apache::thrift::Client<::cpp2::FooService>::future_simple_rpc() {
  ::apache::thrift::RpcOptions rpcOptions;
  return future_simple_rpc(rpcOptions);
}

folly::Future<folly::Unit> apache::thrift::Client<::cpp2::FooService>::future_simple_rpc(apache::thrift::RpcOptions& rpcOptions) {
...
folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::FooService>::semifuture_simple_rpc() {
  ::apache::thrift::RpcOptions rpcOptions;
  return semifuture_simple_rpc(rpcOptions);
}

folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::FooService>::semifuture_simple_rpc(apache::thrift::RpcOptions& rpcOptions) {
...
void apache::thrift::Client<::cpp2::FooService>::simple_rpc(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback) {
  simple_rpc(std::make_unique<apache::thrift::FunctionReplyCallback>(std::move(callback)));
}

#if FOLLY_HAS_COROUTINES
#endif // FOLLY_HAS_COROUTINES
folly::exception_wrapper apache::thrift::Client<::cpp2::FooService>::recv_wrapped_simple_rpc(::apache::thrift::ClientReceiveState& state) {
    if (auto ew = apache::thrift::detail::ac::check_recv_state(state)) {
    return ew;
  }

  using result = ::cpp2::FooService_simple_rpc_presult;
...
void apache::thrift::Client<::cpp2::FooService>::recv_simple_rpc(::apache::thrift::ClientReceiveState& state) {
...
void apache::thrift::Client<::cpp2::FooService>::recv_instance_simple_rpc(::apache::thrift::ClientReceiveState& state) {
  recv_simple_rpc(state);
}

folly::exception_wrapper apache::thrift::Client<::cpp2::FooService>::recv_instance_wrapped_simple_rpc(::apache::thrift::ClientReceiveState& state) {
