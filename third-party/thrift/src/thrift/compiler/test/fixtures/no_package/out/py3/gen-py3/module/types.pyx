...
cdef class MyStruct(thrift.py3.types.Struct):
    ...
    cdef inline MyDataField_impl(self):
        if self.__fbthrift_cached_MyDataField is None:
            self.__fbthrift_cached_MyDataField = MyDataItem._create_FBTHRIFT_ONLY_DO_NOT_USE(__reference_shared_ptr[_module_cbindings.cMyDataItem](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).MyDataField_ref().ref(), self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
...
cdef class Containers(thrift.py3.types.Struct):
    ...
    def __init__(Containers self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cContainers]()
    ...
    def __call__(Containers self, **kwargs):
        ...
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cContainers](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cContainers] cpp_obj):
    ...
    def __richcmp__(self, other, int op):
        r = self._fbthrift_cmp_sametype(other, op)
        return __richcmp[_module_cbindings.cContainers](
            self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
    ...
    def __get_metadata__():
        cdef __fbthrift_cThriftMetadata meta
        _module_cbindings.StructMetadata[_module_cbindings.cContainers].gen(meta)
        return __MetadataBox.box(cmove(meta))
    ...
    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module_cbindings.cContainers](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(Containers self, __Protocol proto):
        cdef unique_ptr[_fbthrift_iobuf.cIOBuf] data
        with nogil:
            data = cmove(serializer.cserialize[_module_cbindings.cContainers](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
        return _fbthrift_iobuf.from_unique_ptr(cmove(data))
    ...
    cdef cuint32_t _fbthrift_deserialize(Containers self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cContainers]()
        with nogil:
            needed = serializer.cdeserialize[_module_cbindings.cContainers](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
...
cdef class MyDataItem(thrift.py3.types.Struct):
    ...
    def __init__(MyDataItem self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cMyDataItem]()
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cMyDataItem] cpp_obj):
    ...
    def __richcmp__(self, other, int op):
        r = self._fbthrift_cmp_sametype(other, op)
        return __richcmp[_module_cbindings.cMyDataItem](
            self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
    ...
    def __get_metadata__():
        cdef __fbthrift_cThriftMetadata meta
        _module_cbindings.StructMetadata[_module_cbindings.cMyDataItem].gen(meta)
        return __MetadataBox.box(cmove(meta))
    ...
    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module_cbindings.cMyDataItem](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(MyDataItem self, __Protocol proto):
        cdef unique_ptr[_fbthrift_iobuf.cIOBuf] data
        with nogil:
            data = cmove(serializer.cserialize[_module_cbindings.cMyDataItem](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
        return _fbthrift_iobuf.from_unique_ptr(cmove(data))
    ...
    cdef cuint32_t _fbthrift_deserialize(MyDataItem self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cMyDataItem]()
        with nogil:
            needed = serializer.cdeserialize[_module_cbindings.cMyDataItem](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
...
cdef class MyUnion(thrift.py3.types.Union):
    ...
    cdef unique_ptr[_module_cbindings.cMyUnion] _make_instance(
        ...
        if myEnum is not None:
            ...
            deref(c_inst).set_myEnum(<_module_cbindings.cMyEnum><int>myEnum)
            any_set = True
    ...
    def value(MyUnion self not None):
        if self.py_value is not None or self.type_int == 0:
            ...
            self.py_value = MyStruct._create_FBTHRIFT_ONLY_DO_NOT_USE(make_shared[_module_cbindings.cMyStruct](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).get_myStruct()))
        elif self.type_int == 3:
            self.py_value = MyDataItem._create_FBTHRIFT_ONLY_DO_NOT_USE(make_shared[_module_cbindings.cMyDataItem](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).get_myDataItem()))
...
cdef class MyException(thrift.py3.exceptions.GeneratedError):
    ...
    def __init__(MyException self, *args, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cMyException]()
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cMyException] cpp_obj):
    ...
    cdef inline myStruct_impl(self):
        if self.__fbthrift_cached_myStruct is None:
            self.__fbthrift_cached_myStruct = MyStruct._create_FBTHRIFT_ONLY_DO_NOT_USE(__reference_shared_ptr[_module_cbindings.cMyStruct](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).myStruct_ref().ref(), self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    cdef inline myUnion_impl(self):
        if self.__fbthrift_cached_myUnion is None:
            self.__fbthrift_cached_myUnion = MyUnion._create_FBTHRIFT_ONLY_DO_NOT_USE(__reference_shared_ptr[_module_cbindings.cMyUnion](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).myUnion_ref().ref(), self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    def __richcmp__(self, other, int op):
        r = self._fbthrift_cmp_sametype(other, op)
        return __richcmp[_module_cbindings.cMyException](
            self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
    ...
    def __get_metadata__():
        cdef __fbthrift_cThriftMetadata meta
        _module_cbindings.ExceptionMetadata[_module_cbindings.cMyException].gen(meta)
        return __MetadataBox.box(cmove(meta))
    ...
    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module_cbindings.cMyException](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(MyException self, __Protocol proto):
        cdef unique_ptr[_fbthrift_iobuf.cIOBuf] data
        with nogil:
            data = cmove(serializer.cserialize[_module_cbindings.cMyException](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
        return _fbthrift_iobuf.from_unique_ptr(cmove(data))
    ...
    cdef cuint32_t _fbthrift_deserialize(MyException self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cMyException]()
        with nogil:
            needed = serializer.cdeserialize[_module_cbindings.cMyException](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
...
cdef class MyExceptionWithMessage(thrift.py3.exceptions.GeneratedError):
    ...
    def __init__(MyExceptionWithMessage self, *args, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cMyExceptionWithMessage]()
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cMyExceptionWithMessage] cpp_obj):
    ...
    def __richcmp__(self, other, int op):
        r = self._fbthrift_cmp_sametype(other, op)
        return __richcmp[_module_cbindings.cMyExceptionWithMessage](
            self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
    ...
    def __get_metadata__():
        cdef __fbthrift_cThriftMetadata meta
        _module_cbindings.ExceptionMetadata[_module_cbindings.cMyExceptionWithMessage].gen(meta)
        return __MetadataBox.box(cmove(meta))
    ...
    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module_cbindings.cMyExceptionWithMessage](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(MyExceptionWithMessage self, __Protocol proto):
        cdef unique_ptr[_fbthrift_iobuf.cIOBuf] data
        with nogil:
            data = cmove(serializer.cserialize[_module_cbindings.cMyExceptionWithMessage](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
        return _fbthrift_iobuf.from_unique_ptr(cmove(data))
    ...
    cdef cuint32_t _fbthrift_deserialize(MyExceptionWithMessage self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cMyExceptionWithMessage]()
        with nogil:
            needed = serializer.cdeserialize[_module_cbindings.cMyExceptionWithMessage](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
...
cdef class ReservedKeyword(thrift.py3.types.Struct):
    ...
    def __init__(ReservedKeyword self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cReservedKeyword]()
    ...
    def __call__(ReservedKeyword self, **kwargs):
        ...
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cReservedKeyword](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cReservedKeyword] cpp_obj):
    ...
    def __richcmp__(self, other, int op):
        r = self._fbthrift_cmp_sametype(other, op)
        return __richcmp[_module_cbindings.cReservedKeyword](
            self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
    ...
    def __get_metadata__():
        cdef __fbthrift_cThriftMetadata meta
        _module_cbindings.StructMetadata[_module_cbindings.cReservedKeyword].gen(meta)
        return __MetadataBox.box(cmove(meta))
    ...
    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module_cbindings.cReservedKeyword](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(ReservedKeyword self, __Protocol proto):
        cdef unique_ptr[_fbthrift_iobuf.cIOBuf] data
        with nogil:
            data = cmove(serializer.cserialize[_module_cbindings.cReservedKeyword](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
        return _fbthrift_iobuf.from_unique_ptr(cmove(data))
    ...
    cdef cuint32_t _fbthrift_deserialize(ReservedKeyword self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cReservedKeyword]()
        with nogil:
            needed = serializer.cdeserialize[_module_cbindings.cReservedKeyword](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
...
cdef class UnionToBeRenamed(thrift.py3.types.Union):
    ...
    cdef unique_ptr[_module_cbindings.cUnionToBeRenamed] _make_instance(
        ...
        cdef unique_ptr[_module_cbindings.cUnionToBeRenamed] c_inst = make_unique[_module_cbindings.cUnionToBeRenamed]()
        cdef bint any_set = False
        if reserved_field is not None:
            if any_set:
                raise TypeError("At most one field may be set when initializing a union")
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cUnionToBeRenamed] cpp_obj):
    ...
    def __richcmp__(self, other, int op):
        r = self._fbthrift_cmp_sametype(other, op)
        return __richcmp[_module_cbindings.cUnionToBeRenamed](
            self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
    ...
    def __get_metadata__():
        cdef __fbthrift_cThriftMetadata meta
        _module_cbindings.StructMetadata[_module_cbindings.cUnionToBeRenamed].gen(meta)
        return __MetadataBox.box(cmove(meta))
    ...
    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module_cbindings.cUnionToBeRenamed](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(UnionToBeRenamed self, __Protocol proto):
        cdef unique_ptr[_fbthrift_iobuf.cIOBuf] data
        with nogil:
            data = cmove(serializer.cserialize[_module_cbindings.cUnionToBeRenamed](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
        return _fbthrift_iobuf.from_unique_ptr(cmove(data))

    cdef cuint32_t _fbthrift_deserialize(UnionToBeRenamed self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        cdef cuint32_t needed
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_cbindings.cUnionToBeRenamed]()
        with nogil:
            needed = serializer.cdeserialize[_module_cbindings.cUnionToBeRenamed](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        # clear cache reload since the underlying data's changed
        self._initialize_py()
        return needed
...
E = 2.718281828459
DATE = "June 28, 2017"
AList = List__i32__from_cpp(_module_cbindings.cAList())
ASet = Set__string__from_cpp(_module_cbindings.cASet())
AMap = Map__string_List__i32__from_cpp(_module_cbindings.cAMap())
MyEnumAlias = MyEnum
