...
#define CONFIGURE_COMMAND " './configure'  '--with-xsl' '--with-tidy' '--with-readline' '--with-pdo-mysql' '--with-openssl' '--with-mysql' '--with-mhash' '--with-mcrypt' '--with-icu-dir' '--with-iconv-dir=' '--with-gettext' '--with-gd--with-curl' '--with-bz2' '--enable-pcntl' '--enable-ftp' '--enable-sockets'"
