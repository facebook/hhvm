...
__all__ = ['UTF8STRINGS', 'Py3Hidden', 'PyDeprecatedHidden', 'Flags', 'Name', 'Adapter', 'UseCAPI', 'Py3EnableCppAdapter', 'MigrationBlockingAllowInheritance', 'NoIntBaseClassDeprecated']
...
class NoIntBaseClassDeprecated:
  r"""
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('NoIntBaseClassDeprecated')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.python.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.NoIntBaseClassDeprecated, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.python.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.NoIntBaseClassDeprecated, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.python.types")
    return thrift.py3.converter.to_py3_struct(py3_types.NoIntBaseClassDeprecated, self)
...
all_structs.append(NoIntBaseClassDeprecated)
NoIntBaseClassDeprecated.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

NoIntBaseClassDeprecated.thrift_struct_annotations = {
}
NoIntBaseClassDeprecated.thrift_field_annotations = {
}
