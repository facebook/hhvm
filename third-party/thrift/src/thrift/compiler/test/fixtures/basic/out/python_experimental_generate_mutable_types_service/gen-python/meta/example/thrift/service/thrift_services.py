...
import meta.example.thrift.service.thrift_types
...
class EchoServiceInterface(
    ...
    async def echo(
            self,
            request: meta.example.thrift.service.thrift_types.EchoRequest
        ) -> meta.example.thrift.service.thrift_types.EchoResponse:
    ...
    async def _fbthrift__handler_echo(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(meta.example.thrift.service.thrift_types._fbthrift_EchoService_echo_args, args, protocol)
        try:
            value = await self.echo(args_struct.request,)
            return_struct = meta.example.thrift.service.thrift_types._fbthrift_EchoService_echo_result(success=value)
            
        except meta.example.thrift.service.thrift_types.WhisperException as e:
            return_struct = meta.example.thrift.service.thrift_types._fbthrift_EchoService_echo_result(ex=e)
