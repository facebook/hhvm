...
class C{}
function f1(string $x = null) {$y = (string) $x; var_dump($y); return $y; }
function f2(array $x = null) {$y = (array) $x; var_dump($y); return $y; }
function f3(C $x = null) {$y = (object) $x; var_dump($y); return $y; }
function f4(int $x = null) {$y = (int) $x; var_dump($y); return $y; }
function f5(bool $x = null) {$y = (bool) $x; var_dump($y); return $y; }
function f6(double $x = null) {$y = (double) $x; var_dump($y); return $y; }
