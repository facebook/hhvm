...
class Client<::test::fixtures::basic::MyService> : public apache::thrift::GeneratedAsyncClient {
 ...
 private:
  ...
  folly::coro::Task<void> co_sink(apache::thrift::RpcOptions* rpcOptions, ::std::int64_t p_sink) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_sink(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_sink);
    } else {
      fbthrift_serialize_and_send_sink(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_sink);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_sink(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<void> co_deleteDataById(apache::thrift::RpcOptions* rpcOptions, ::std::int64_t p_id) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_deleteDataById(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_id);
    } else {
      fbthrift_serialize_and_send_deleteDataById(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_id);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_deleteDataById(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::set<float>> co_invalid_return_for_hack(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_invalid_return_for_hack(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_invalid_return_for_hack(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_invalid_return_for_hack(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
  ...
  FOLLY_NOINLINE folly::SemiFuture<::std::set<float>> fbthrift_semifuture_invalid_return_for_hack(folly::SemiFuture<typename apache::thrift::detail::FutureCallbackHelper<::std::set<float>>::PromiseResult> semifuture, apache::thrift::RpcOptions& rpcOptions, apache::thrift::RequestClientCallback::Ptr callback, apache::thrift::ContextStack* contextStack, std::shared_ptr<::apache::thrift::transport::THeader> header);
 public:
 ...
 private:
  ...
  folly::coro::Task<void> co_rpc_skipped_codegen(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_rpc_skipped_codegen(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_rpc_skipped_codegen(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_rpc_skipped_codegen(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
