...
_readField_bar:
  {
    ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::integral, ::std::int32_t, ::apache::thrift::type::i32_t>::readWithContext(*iprot, this->__fbthrift_field_bar, _readState);
  }
  isset_bar = true;
...
uint32_t Foo::serializedSize(Protocol_ const* prot_) const {
  ...
  {
    xfer += prot_->serializedFieldSize("bar", apache::thrift::protocol::TType::T_I32, 1);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::integral, ::std::int32_t, ::apache::thrift::type::i32_t>::serializedSize<false>(*prot_, this->__fbthrift_field_bar);
  }
...
uint32_t Foo::write(Protocol_* prot_) const {
  ...
  bool previousFieldHasValue = true;
  {
    ...
    xfer += ::apache::thrift::detail::writeFieldBegin<apache::thrift::protocol::TType::T_I32, 1, kPrevFieldId>(*prot_, "bar", previousFieldHasValue);
    previousFieldHasValue = true;
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::integral, ::std::int32_t, ::apache::thrift::type::i32_t>::write(*prot_, this->__fbthrift_field_bar);
