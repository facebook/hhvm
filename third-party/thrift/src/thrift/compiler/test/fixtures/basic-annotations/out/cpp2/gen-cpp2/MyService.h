...
#endif
  virtual void async_tm_ping(apache::thrift::HandlerCallback<void>::Ptr callback);
...
#endif
  virtual void async_tm_getRandomData(apache::thrift::HandlerCallback<std::unique_ptr<::std::string>>::Ptr callback);
...
#endif
  virtual void async_tm_hasDataById(apache::thrift::HandlerCallback<bool>::Ptr callback, ::std::int64_t p_id);
...
#endif
  virtual void async_tm_getDataById(apache::thrift::HandlerCallback<std::unique_ptr<::std::string>>::Ptr callback, ::std::int64_t p_id);
...
#endif
  virtual void async_tm_putDataById(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int64_t p_id, std::unique_ptr<::std::string> p_data);
...
#endif
  virtual void async_tm_cppDoNothing(apache::thrift::HandlerCallback<void>::Ptr callback);
 private:
...
class MyServiceAsyncProcessor : public ::apache::thrift::GeneratedAsyncProcessorBase {
 ...
 private:
  ...
  template <class ProtocolIn_, class ProtocolOut_>
  static apache::thrift::SerializedResponse return_cppDoNothing(apache::thrift::ContextStack* ctx);
  template <class ProtocolIn_, class ProtocolOut_>
