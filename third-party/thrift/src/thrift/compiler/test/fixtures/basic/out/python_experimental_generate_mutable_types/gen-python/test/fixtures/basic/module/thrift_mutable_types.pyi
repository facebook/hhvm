...
class Containers(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_Containers):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.MutableSequence[int], _typing.MutableSet[str], _typing.MutableMapping[str, int]]]]: ...
...
AMap: _typing.Dict[str, _typing.MutableSequence[int]] = ...
