...
apache::thrift::ServiceRequestInfoMap InteractWithSharedServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"do_some_similar_things",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::InteractWithShared>("do_some_similar_things")}},
  {"MyInteraction.frobnicate",
    { false,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::cpp2::InteractWithShared>("MyInteraction", "frobnicate")}},
  {"MyInteraction.ping",
    { false,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::cpp2::InteractWithShared>("MyInteraction", "ping")}},
  {"MyInteraction.truthify",
    { false,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::cpp2::InteractWithShared>("MyInteraction", "truthify")}},
  {"MyInteraction.encode",
    { false,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::cpp2::InteractWithShared>("MyInteraction", "encode")}},
  {"SharedInteraction.init",
    { false,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::cpp2::InteractWithShared>("SharedInteraction", "init")}},
  {"SharedInteraction.do_something",
    { false,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::cpp2::InteractWithShared>("SharedInteraction", "do_something")}},
  {"SharedInteraction.tear_down",
    { false,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getInteractionFunctionNode<::cpp2::InteractWithShared>("SharedInteraction", "tear_down")}},
  };
