...
class MyStruct_Builder(thrift.py3.builder.StructBuilder):
    ...
    def __init__(self):
        ...
        self.myEnum: _typing.Optional[_module_types.MyEnum] = None
...
_fbthrift_struct_type__Containers = _module_types.Containers
...
_fbthrift_struct_type__MyDataItem = _module_types.MyDataItem
...
_fbthrift_struct_type__MyException = _module_types.MyException
...
_fbthrift_struct_type__MyExceptionWithMessage = _module_types.MyExceptionWithMessage
class MyExceptionWithMessage_Builder(thrift.py3.builder.StructBuilder):
    _struct_type = _fbthrift_struct_type__MyExceptionWithMessage
...
_fbthrift_struct_type__ReservedKeyword = _module_types.ReservedKeyword
...
_fbthrift_struct_type__UnionToBeRenamed = _module_types.UnionToBeRenamed
