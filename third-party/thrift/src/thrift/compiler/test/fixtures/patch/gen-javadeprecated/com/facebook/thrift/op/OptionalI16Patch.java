...
public class OptionalI16Patch implements TBase, java.io.Serializable, Cloneable, Comparable<OptionalI16Patch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(OptionalI16Patch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    private I16Patch patchPrior;
    private short ensure;
    private I16Patch patch;
    ...
    public Builder setPatchPrior(final I16Patch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }

    public Builder setEnsure(final short ensure) {
      this.ensure = ensure;
      __optional_isset.set(__ENSURE_ISSET_ID, true);
      return this;
    }

    public Builder setPatch(final I16Patch patch) {
      this.patch = patch;
      return this;
    }

    public OptionalI16Patch build() {
      OptionalI16Patch result = new OptionalI16Patch();
   ...
   * Clears any set value. Applies first.
   */
  public OptionalI16Patch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public OptionalI16Patch setPatchPrior(I16Patch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((I16Patch)__value);
      }
      break;
  ...
  @Override
  public int compareTo(OptionalI16Patch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("OptionalI16Patch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
