...
module Make (Token : TokenType) (SyntaxValue : SyntaxValueType) = struct
  ...
  and validate_top_level_declaration : top_level_declaration validator =
   fun x ->
    ...
    | Syntax.EndOfFile _ ->
      tag validate_end_of_file (fun x -> TLDEndOfFile x) x
    ...
    | Syntax.GotoStatement _ ->
      tag validate_goto_statement (fun x -> TLDGoto x) x
  ...
  and validate_expression : expression validator =
   fun x ->
    ...
    | Syntax.YieldFromExpression _ ->
      tag validate_yield_from_expression (fun x -> ExprYieldFrom x) x
    ...
    | Syntax.HaltCompilerExpression _ ->
      tag validate_halt_compiler_expression (fun x -> ExprHaltCompiler x) x
    ...
    | Syntax.ArrayCreationExpression _ ->
      tag validate_array_creation_expression (fun x -> ExprArrayCreation x) x
    | Syntax.ArrayIntrinsicExpression _ ->
      tag validate_array_intrinsic_expression (fun x -> ExprArrayIntrinsic x) x
    ...
    | Syntax.PocketAtomExpression _ ->
      tag validate_pocket_atom_expression (fun x -> ExprPocketAtom x) x
    | Syntax.PocketIdentifierExpression _ ->
      tag
        validate_pocket_identifier_expression
        (fun x -> ExprPocketIdentifier x)
        x
  ...
  and invalidate_expression : expression invalidator =
   fun (value, thing) ->
    ...
    | ExprHaltCompiler thing ->
      invalidate_halt_compiler_expression (value, thing)
    ...
    | ExprArrayCreation thing ->
      invalidate_array_creation_expression (value, thing)
    | ExprArrayIntrinsic thing ->
      invalidate_array_intrinsic_expression (value, thing)
    ...
    | ExprPocketIdentifier thing ->
      invalidate_pocket_identifier_expression (value, thing)
  ...
  and validate_specifier : specifier validator =
   fun x ->
    ...
    | Syntax.VectorArrayTypeSpecifier _ ->
      tag validate_vector_array_type_specifier (fun x -> SpecVectorArray x) x
    | Syntax.DarrayTypeSpecifier _ ->
      tag validate_darray_type_specifier (fun x -> SpecDarray x) x
    | Syntax.MapArrayTypeSpecifier _ ->
      tag validate_map_array_type_specifier (fun x -> SpecMapArray x) x
  ...
  and invalidate_specifier : specifier invalidator =
   fun (value, thing) ->
    ...
    | SpecVectorArray thing ->
      invalidate_vector_array_type_specifier (value, thing)
    ...
    | SpecDictionary thing ->
      invalidate_dictionary_type_specifier (value, thing)
  ...
  and validate_class_body_declaration : class_body_declaration validator =
   fun x ->
    ...
    | Syntax.PocketEnumDeclaration _ ->
      tag validate_pocket_enum_declaration (fun x -> BodyPocketEnum x) x
  ...
  and invalidate_class_body_declaration : class_body_declaration invalidator =
   fun (value, thing) ->
    ...
    | BodyXHPChildren thing ->
      invalidate_xhp_children_declaration (value, thing)
    | BodyXHPCategory thing ->
      invalidate_xhp_category_declaration (value, thing)
  ...
  and validate_statement : statement validator =
   fun x ->
    ...
    | Syntax.LetStatement _ ->
      tag validate_let_statement (fun x -> StmtLet x) x
    | Syntax.UsingStatementBlockScoped _ ->
      tag
        validate_using_statement_block_scoped
    ...
    | Syntax.TryStatement _ ->
      tag validate_try_statement (fun x -> StmtTry x) x
    | Syntax.DoStatement _ -> tag validate_do_statement (fun x -> StmtDo x) x
    | Syntax.ForStatement _ ->
      tag validate_for_statement (fun x -> StmtFor x) x
    | Syntax.ForeachStatement _ ->
    ...
    | Syntax.GotoLabel _ ->
      tag validate_goto_label (fun x -> StmtGotoLabel x) x
    | Syntax.GotoStatement _ ->
      tag validate_goto_statement (fun x -> StmtGoto x) x
    | Syntax.ThrowStatement _ ->
  ...
  and invalidate_statement : statement invalidator =
   fun (value, thing) ->
    ...
    | StmtSwitchFallthrough thing ->
      invalidate_switch_fallthrough (value, thing)
  ...
  and validate_lambda_body : lambda_body validator =
   fun x ->
    ...
    | Syntax.YieldFromExpression _ ->
      tag validate_yield_from_expression (fun x -> LambdaYieldFrom x) x
    | Syntax.PrefixUnaryExpression _ ->
    ...
    | Syntax.HaltCompilerExpression _ ->
      tag validate_halt_compiler_expression (fun x -> LambdaHaltCompiler x) x
    | Syntax.IssetExpression _ ->
    ...
    | Syntax.RecordCreationExpression _ ->
      tag
        ...
        x
    | Syntax.ArrayCreationExpression _ ->
      tag validate_array_creation_expression (fun x -> LambdaArrayCreation x) x
    | Syntax.ArrayIntrinsicExpression _ ->
      tag
        validate_array_intrinsic_expression
        (fun x -> LambdaArrayIntrinsic x)
        x
    | Syntax.DarrayIntrinsicExpression _ ->
      tag
        validate_darray_intrinsic_expression
    ...
    | Syntax.PocketIdentifierExpression _ ->
      tag
        validate_pocket_identifier_expression
        (fun x -> LambdaPocketIdentifier x)
        x
  ...
  and invalidate_lambda_body : lambda_body invalidator =
   fun (value, thing) ->
    ...
    | LambdaRecordCreation thing ->
      invalidate_record_creation_expression (value, thing)
    | LambdaArrayCreation thing ->
      invalidate_array_creation_expression (value, thing)
    | LambdaArrayIntrinsic thing ->
      invalidate_array_intrinsic_expression (value, thing)
  ...
  and validate_constructor_expression : constructor_expression validator =
   fun x ->
    ...
    | Syntax.YieldFromExpression _ ->
      tag validate_yield_from_expression (fun x -> CExprYieldFrom x) x
    | Syntax.PrefixUnaryExpression _ ->
    ...
    | Syntax.IsExpression _ ->
      tag validate_is_expression (fun x -> CExprIs x) x
    | Syntax.AsExpression _ ->
      tag validate_as_expression (fun x -> CExprAs x) x
    | Syntax.NullableAsExpression _ ->
    ...
    | Syntax.HaltCompilerExpression _ ->
      tag validate_halt_compiler_expression (fun x -> CExprHaltCompiler x) x
    | Syntax.IssetExpression _ ->
    ...
    | Syntax.ObjectCreationExpression _ ->
      tag
        validate_object_creation_expression
        (fun x -> CExprObjectCreation x)
        x
    | Syntax.RecordCreationExpression _ ->
      tag
        validate_record_creation_expression
        (fun x -> CExprRecordCreation x)
        x
    | Syntax.ArrayCreationExpression _ ->
      tag validate_array_creation_expression (fun x -> CExprArrayCreation x) x
    | Syntax.ArrayIntrinsicExpression _ ->
      tag
        validate_array_intrinsic_expression
        (fun x -> CExprArrayIntrinsic x)
        x
    | Syntax.DarrayIntrinsicExpression _ ->
      tag
        validate_darray_intrinsic_expression
  ...
  and invalidate_constructor_expression : constructor_expression invalidator =
   fun (value, thing) ->
    ...
    | CExprRecordCreation thing ->
      invalidate_record_creation_expression (value, thing)
    | CExprArrayCreation thing ->
      invalidate_array_creation_expression (value, thing)
    | CExprArrayIntrinsic thing ->
      invalidate_array_intrinsic_expression (value, thing)
  ...
  and validate_xhp_attribute : xhp_attribute validator =
   fun x ->
    ...
    | Syntax.XHPSimpleAttribute _ ->
      tag
        validate_xhp_simple_attribute
        (fun x -> XHPAttrXHPSimpleAttribute x)
        x
    | Syntax.XHPSpreadAttribute _ ->
      tag
        validate_xhp_spread_attribute
        (fun x -> XHPAttrXHPSpreadAttribute x)
        x
  ...
  and validate_pufield_aggregate : pufield_aggregate validator =
   fun x ->
    match Syntax.syntax x with
    | Syntax.PocketAtomMappingDeclaration _ ->
      tag
        validate_pocket_atom_mapping_declaration
        (fun x -> PocketFieldPocketAtomMappingDeclaration x)
        x
    | Syntax.PocketFieldTypeExprDeclaration _ ->
      tag
        validate_pocket_field_type_expr_declaration
        (fun x -> PocketFieldPocketFieldTypeExprDeclaration x)
        x
    | Syntax.PocketFieldTypeDeclaration _ ->
      tag
        validate_pocket_field_type_declaration
        (fun x -> PocketFieldPocketFieldTypeDeclaration x)
        x
    | s -> aggregation_fail Def.PUField s

  and invalidate_pufield_aggregate : pufield_aggregate invalidator =
   fun (value, thing) ->
    match thing with
    | PocketFieldPocketAtomMappingDeclaration thing ->
      invalidate_pocket_atom_mapping_declaration (value, thing)
    | PocketFieldPocketFieldTypeExprDeclaration thing ->
      invalidate_pocket_field_type_expr_declaration (value, thing)
    | PocketFieldPocketFieldTypeDeclaration thing ->
      invalidate_pocket_field_type_declaration (value, thing)

  and validate_pumapping_aggregate : pumapping_aggregate validator =
   fun x ->
    match Syntax.syntax x with
    | Syntax.PocketMappingIdDeclaration _ ->
      tag
        validate_pocket_mapping_id_declaration
        (fun x -> PocketMappingPocketMappingIdDeclaration x)
        x
    | Syntax.PocketMappingTypeDeclaration _ ->
      tag
        validate_pocket_mapping_type_declaration
        (fun x -> PocketMappingPocketMappingTypeDeclaration x)
        x
    | s -> aggregation_fail Def.PUMapping s

  and invalidate_pumapping_aggregate : pumapping_aggregate invalidator =
   fun (value, thing) ->
    match thing with
    | PocketMappingPocketMappingIdDeclaration thing ->
      invalidate_pocket_mapping_id_declaration (value, thing)
    | PocketMappingPocketMappingTypeDeclaration thing ->
      invalidate_pocket_mapping_type_declaration (value, thing)
  ...
  and validate_prefixed_string_expression :
      prefixed_string_expression validator = function
  ...
  and invalidate_pipe_variable_expression :
      pipe_variable_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        ...
        Syntax.FileAttributeSpecification
          {
            ...
            file_attribute_specification_right_double_angle =
              invalidate_token
                x.file_attribute_specification_right_double_angle;
          };
      Syntax.value = v;
    }
      ...
      ( v,
        {
          ...
          record_extends_list =
            validate_option_with validate_specifier x.record_extends_list;
        ...
        Syntax.RecordDeclaration
          {
            ...
            record_extends_list =
              invalidate_option_with invalidate_specifier x.record_extends_list;
      ...
      ( v,
        {
          ...
          namespace_use_clauses =
            validate_list_with
              (validate_option_with validate_namespace_use_clause)
        ...
        Syntax.NamespaceUseDeclaration
          {
            ...
            namespace_use_clauses =
              invalidate_list_with
                (invalidate_option_with invalidate_namespace_use_clause)
                x.namespace_use_clauses;
            namespace_use_semicolon =
      ...
      ( v,
        {
          ...
          function_parameter_list =
            validate_list_with
              (validate_option_with validate_parameter)
        ...
        Syntax.FunctionDeclarationHeader
          {
            ...
            function_parameter_list =
              invalidate_list_with
                (invalidate_option_with invalidate_parameter)
                x.function_parameter_list;
      ...
      ( v,
        {
          ...
          where_constraint_operator =
            validate_token x.where_constraint_operator;
  ...
  and validate_methodish_trait_resolution :
      methodish_trait_resolution validator = function
    | { Syntax.syntax = Syntax.MethodishTraitResolution x; value = v } ->
      ( v,
        {
          methodish_trait_semicolon =
            validate_token x.methodish_trait_semicolon;
      ...
      ( v,
        {
          classish_body_right_brace =
            validate_token x.classish_body_right_brace;
        ...
        Syntax.TypeConstDeclaration
          {
            ...
            type_const_type_keyword =
              invalidate_token x.type_const_type_keyword;
  ...
  and validate_markup_section : markup_section validator = function
    | { Syntax.syntax = Syntax.MarkupSection x; value = v } ->
      ( v,
        {
          markup_expression =
            validate_option_with validate_expression x.markup_expression;
          markup_suffix =
   ...
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.MarkupSection
          {
            markup_prefix =
              invalidate_option_with invalidate_token x.markup_prefix;
            markup_text = invalidate_token x.markup_text;
            markup_suffix =
              invalidate_option_with invalidate_markup_suffix x.markup_suffix;
            markup_expression =
              invalidate_option_with invalidate_expression x.markup_expression;
          };
      Syntax.value = v;
    }
  ...
  and validate_let_statement : let_statement validator = function
    | { Syntax.syntax = Syntax.LetStatement x; value = v } ->
      ( v,
        {
          let_statement_semicolon = validate_token x.let_statement_semicolon;
          let_statement_initializer =
            validate_simple_initializer x.let_statement_initializer;
          let_statement_type =
            validate_option_with validate_specifier x.let_statement_type;
          let_statement_colon =
            validate_option_with validate_token x.let_statement_colon;
  ...
  and invalidate_let_statement : let_statement invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.LetStatement
          {
            ...
            let_statement_colon =
              invalidate_option_with invalidate_token x.let_statement_colon;
            let_statement_type =
              invalidate_option_with invalidate_specifier x.let_statement_type;
            let_statement_initializer =
              invalidate_simple_initializer x.let_statement_initializer;
            let_statement_semicolon =
              invalidate_token x.let_statement_semicolon;
          };
      Syntax.value = v;
    }
      ...
      ( v,
        {
          ...
          using_block_using_keyword =
            validate_token x.using_block_using_keyword;
        ...
        Syntax.UsingStatementBlockScoped
          {
            ...
            using_block_right_paren =
              invalidate_token x.using_block_right_paren;
  ...
  and validate_goto_label : goto_label validator = function
    | { Syntax.syntax = Syntax.GotoLabel x; value = v } ->
      ( v,
        {
  ...
  and invalidate_goto_label : goto_label invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.GotoLabel
        ...
        Syntax.GotoStatement
          {
            ...
            goto_statement_label_name =
              invalidate_token x.goto_statement_label_name;
            goto_statement_semicolon =
              invalidate_token x.goto_statement_semicolon;
          };
      Syntax.value = v;
    }
      ...
      ( v,
        {
          ...
          break_level =
            validate_option_with validate_literal_expression x.break_level;
      ...
      ( v,
        {
          ...
          continue_level =
            validate_option_with validate_literal_expression x.continue_level;
      ...
      ( v,
        {
          ...
          anonymous_coroutine_keyword =
            validate_option_with validate_token x.anonymous_coroutine_keyword;
      ...
      ( v,
        {
          anonymous_use_right_paren =
            validate_token x.anonymous_use_right_paren;
      ...
      ( v,
        {
          ...
          lambda_coroutine =
            validate_option_with validate_token x.lambda_coroutine;
        ...
        Syntax.LambdaExpression
          {
            ...
            lambda_coroutine =
              invalidate_option_with invalidate_token x.lambda_coroutine;
      ...
      ( v,
        {
          ...
          scope_resolution_operator =
            validate_token x.scope_resolution_operator;
  ...
  and validate_embedded_member_selection_expression :
    ...
    | s ->
      validation_fail (Some SyntaxKind.EmbeddedMemberSelectionExpression) s
  ...
  and validate_yield_from_expression : yield_from_expression validator =
    function
    | { Syntax.syntax = Syntax.YieldFromExpression x; value = v } ->
      ( v,
        {
  ...
  and invalidate_yield_from_expression : yield_from_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.YieldFromExpression
          {
            yield_from_yield_keyword =
              invalidate_token x.yield_from_yield_keyword;
            yield_from_from_keyword =
              invalidate_token x.yield_from_from_keyword;
  ...
  and invalidate_postfix_unary_expression :
      postfix_unary_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
  ...
  and validate_halt_compiler_expression : halt_compiler_expression validator =
    function
    | { Syntax.syntax = Syntax.HaltCompilerExpression x; value = v } ->
      ( v,
        {
          halt_compiler_right_paren =
            validate_token x.halt_compiler_right_paren;
          halt_compiler_argument_list =
            validate_list_with
              validate_expression
              x.halt_compiler_argument_list;
  ...
  and invalidate_halt_compiler_expression :
      halt_compiler_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.HaltCompilerExpression
          {
            ...
            halt_compiler_left_paren =
              invalidate_token x.halt_compiler_left_paren;
            halt_compiler_argument_list =
              invalidate_list_with
                invalidate_expression
                x.halt_compiler_argument_list;
            halt_compiler_right_paren =
              invalidate_token x.halt_compiler_right_paren;
          };
      Syntax.value = v;
    }
      ...
      ( v,
        {
          function_call_right_paren =
            validate_token x.function_call_right_paren;
  ...
  and invalidate_function_call_expression :
      function_call_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
  ...
  and invalidate_parenthesized_expression :
      parenthesized_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
  ...
  and validate_embedded_braced_expression :
      embedded_braced_expression validator = function
      ...
      ( v,
        {
          ...
          list_members =
            validate_list_with
              (validate_option_with validate_expression)
              x.list_members;
        ...
        Syntax.ListExpression
          {
            ...
            list_members =
              invalidate_list_with
                (invalidate_option_with invalidate_expression)
                x.list_members;
      ...
      ( v,
        {
          ...
          collection_literal_name =
            validate_specifier x.collection_literal_name;
        } )
  ...
  and validate_object_creation_expression :
      object_creation_expression validator = function
  ...
  and validate_record_creation_expression :
      record_creation_expression validator = function
      ...
      ( v,
        {
          ...
          record_creation_array_token =
            validate_option_with validate_token x.record_creation_array_token;
  ...
  and validate_array_creation_expression : array_creation_expression validator
      = function
    | { Syntax.syntax = Syntax.ArrayCreationExpression x; value = v } ->
      ( v,
        {
          array_creation_right_bracket =
            validate_token x.array_creation_right_bracket;
          array_creation_members =
            validate_list_with
              validate_constructor_expression
              x.array_creation_members;
          array_creation_left_bracket =
            validate_token x.array_creation_left_bracket;
        } )
    | s -> validation_fail (Some SyntaxKind.ArrayCreationExpression) s

  and invalidate_array_creation_expression :
      array_creation_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.ArrayCreationExpression
          {
            array_creation_left_bracket =
              invalidate_token x.array_creation_left_bracket;
            array_creation_members =
              invalidate_list_with
                invalidate_constructor_expression
                x.array_creation_members;
            array_creation_right_bracket =
              invalidate_token x.array_creation_right_bracket;
          };
      Syntax.value = v;
    }

  and validate_array_intrinsic_expression :
      array_intrinsic_expression validator = function
    | { Syntax.syntax = Syntax.ArrayIntrinsicExpression x; value = v } ->
      ( v,
        {
          array_intrinsic_right_paren =
            validate_token x.array_intrinsic_right_paren;
          array_intrinsic_members =
            validate_list_with
              validate_constructor_expression
              x.array_intrinsic_members;
          array_intrinsic_left_paren =
            validate_token x.array_intrinsic_left_paren;
  ...
  and invalidate_array_intrinsic_expression :
      array_intrinsic_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.ArrayIntrinsicExpression
          {
            array_intrinsic_keyword =
              invalidate_token x.array_intrinsic_keyword;
            array_intrinsic_left_paren =
              invalidate_token x.array_intrinsic_left_paren;
            array_intrinsic_members =
              invalidate_list_with
                invalidate_constructor_expression
                x.array_intrinsic_members;
            array_intrinsic_right_paren =
              invalidate_token x.array_intrinsic_right_paren;
          };
      Syntax.value = v;
    }
        ...
        Syntax.SubscriptExpression
          {
            ...
            subscript_right_bracket =
              invalidate_token x.subscript_right_bracket;
          };
      Syntax.value = v;
    }
      ...
      ( v,
        {
          ...
          awaitable_coroutine =
            validate_option_with validate_token x.awaitable_coroutine;
        ...
        Syntax.AwaitableCreationExpression
          {
            ...
            awaitable_coroutine =
              invalidate_option_with invalidate_token x.awaitable_coroutine;
            awaitable_compound_statement =
  ...
  and invalidate_xhp_children_declaration :
      xhp_children_declaration invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
  ...
  and invalidate_xhp_category_declaration :
      xhp_category_declaration invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
      ...
      ( v,
        {
          ...
          xhp_enum_optional =
            validate_option_with validate_token x.xhp_enum_optional;
        } )
   ...
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.XHPEnumType
          {
            xhp_enum_optional =
              invalidate_option_with invalidate_token x.xhp_enum_optional;
        ...
        Syntax.XHPClassAttributeDeclaration
          {
            ...
            xhp_attribute_semicolon =
              invalidate_token x.xhp_attribute_semicolon;
          };
      Syntax.value = v;
    }
      ...
      ( v,
        {
          ...
          xhp_attribute_decl_type =
            validate_specifier x.xhp_attribute_decl_type;
        } )
        ...
        Syntax.XHPClassAttribute
          {
            ...
            xhp_attribute_decl_name =
              invalidate_token x.xhp_attribute_decl_name;
            xhp_attribute_decl_initializer =
              invalidate_option_with
                invalidate_simple_initializer
                x.xhp_attribute_decl_initializer;
  ...
  and validate_xhp_simple_class_attribute :
      xhp_simple_class_attribute validator = function
        ...
        Syntax.XHPSimpleClassAttribute
          {
            xhp_simple_class_attribute_type =
              invalidate_simple_type_specifier
                x.xhp_simple_class_attribute_type;
          };
      Syntax.value = v;
    }
      ...
      ( v,
        {
          ...
          xhp_simple_attribute_name =
            validate_token x.xhp_simple_attribute_name;
        } )
      ...
      ( v,
        {
          ...
          type_constant_left_type =
            validate_specifier x.type_constant_left_type;
        } )
        ...
        Syntax.TypeConstant
          {
            ...
            type_constant_separator =
              invalidate_token x.type_constant_separator;
  ...
  and validate_pu_access : pu_access validator = function
    | { Syntax.syntax = Syntax.PUAccess x; value = v } ->
      ( v,
        {
  ...
  and invalidate_pu_access : pu_access invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PUAccess
        ...
        Syntax.VectorTypeSpecifier
          {
            ...
            vector_type_right_angle =
              invalidate_token x.vector_type_right_angle;
          };
      Syntax.value = v;
    }
        ...
        Syntax.KeysetTypeSpecifier
          {
            ...
            keyset_type_right_angle =
              invalidate_token x.keyset_type_right_angle;
          };
      Syntax.value = v;
    }
  ...
  and validate_vector_array_type_specifier :
      vector_array_type_specifier validator = function
    | { Syntax.syntax = Syntax.VectorArrayTypeSpecifier x; value = v } ->
      ( v,
        {
  ...
  and invalidate_vector_array_type_specifier :
      vector_array_type_specifier invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.VectorArrayTypeSpecifier
          {
            ...
            vector_array_left_angle =
              invalidate_token x.vector_array_left_angle;
            vector_array_type = invalidate_specifier x.vector_array_type;
            vector_array_right_angle =
              invalidate_token x.vector_array_right_angle;
          };
      Syntax.value = v;
    }
  ...
  and validate_map_array_type_specifier : map_array_type_specifier validator =
    function
    | { Syntax.syntax = Syntax.MapArrayTypeSpecifier x; value = v } ->
      ( v,
        {
  ...
  and invalidate_map_array_type_specifier :
      map_array_type_specifier invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        ...
        Syntax.DictionaryTypeSpecifier
          {
            dictionary_type_keyword =
              invalidate_token x.dictionary_type_keyword;
            dictionary_type_left_angle =
      ...
      ( v,
        {
          closure_outer_right_paren =
            validate_token x.closure_outer_right_paren;
          ...
          closure_inner_right_paren =
            validate_token x.closure_inner_right_paren;
          ...
          closure_coroutine =
            validate_option_with validate_token x.closure_coroutine;
        ...
        Syntax.ClosureTypeSpecifier
          {
            ...
            closure_coroutine =
              invalidate_option_with invalidate_token x.closure_coroutine;
  ...
  and invalidate_classname_type_specifier :
      classname_type_specifier invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        ...
        Syntax.FieldInitializer
          {
            ...
            field_initializer_arrow =
              invalidate_token x.field_initializer_arrow;
            field_initializer_value =
      ...
      ( v,
        {
          ...
          type_arguments_left_angle =
            validate_token x.type_arguments_left_angle;
        } )
      ...
      ( v,
        {
          ...
          tuple_types =
            validate_list_with
              (validate_option_with validate_specifier)
              x.tuple_types;
        ...
        Syntax.TupleTypeSpecifier
          {
            ...
            tuple_types =
              invalidate_list_with
                (invalidate_option_with invalidate_specifier)
                x.tuple_types;
  ...
  and validate_pocket_atom_expression : pocket_atom_expression validator =
    function
    | { Syntax.syntax = Syntax.PocketAtomExpression x; value = v } ->
      ( v,
        {
  ...
  and invalidate_pocket_atom_expression : pocket_atom_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
  ...
  and validate_pocket_identifier_expression :
      pocket_identifier_expression validator = function
    | { Syntax.syntax = Syntax.PocketIdentifierExpression x; value = v } ->
      ( v,
        {
          pocket_identifier_name = validate_expression x.pocket_identifier_name;
          pocket_identifier_operator =
            validate_token x.pocket_identifier_operator;
          pocket_identifier_field =
            validate_expression x.pocket_identifier_field;
          pocket_identifier_pu_operator =
            validate_token x.pocket_identifier_pu_operator;
          pocket_identifier_qualifier =
            validate_expression x.pocket_identifier_qualifier;
        } )
    | s -> validation_fail (Some SyntaxKind.PocketIdentifierExpression) s

  and invalidate_pocket_identifier_expression :
      pocket_identifier_expression invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PocketIdentifierExpression
          {
            pocket_identifier_qualifier =
              invalidate_expression x.pocket_identifier_qualifier;
            pocket_identifier_pu_operator =
              invalidate_token x.pocket_identifier_pu_operator;
            pocket_identifier_field =
              invalidate_expression x.pocket_identifier_field;
            pocket_identifier_operator =
              invalidate_token x.pocket_identifier_operator;
            pocket_identifier_name =
              invalidate_expression x.pocket_identifier_name;
          };
      Syntax.value = v;
    }

  and validate_pocket_atom_mapping_declaration :
      pocket_atom_mapping_declaration validator = function
    | { Syntax.syntax = Syntax.PocketAtomMappingDeclaration x; value = v } ->
      ( v,
        {
          pocket_atom_mapping_semicolon =
            validate_token x.pocket_atom_mapping_semicolon;
          pocket_atom_mapping_right_paren =
            validate_option_with
              validate_token
              x.pocket_atom_mapping_right_paren;
          pocket_atom_mapping_mappings =
            validate_list_with
              validate_pumapping_aggregate
              x.pocket_atom_mapping_mappings;
          pocket_atom_mapping_left_paren =
            validate_option_with
              validate_token
              x.pocket_atom_mapping_left_paren;
          pocket_atom_mapping_name =
            validate_expression x.pocket_atom_mapping_name;
          pocket_atom_mapping_glyph =
            validate_token x.pocket_atom_mapping_glyph;
        } )
    | s -> validation_fail (Some SyntaxKind.PocketAtomMappingDeclaration) s

  and invalidate_pocket_atom_mapping_declaration :
      pocket_atom_mapping_declaration invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PocketAtomMappingDeclaration
          {
            pocket_atom_mapping_glyph =
              invalidate_token x.pocket_atom_mapping_glyph;
            pocket_atom_mapping_name =
              invalidate_expression x.pocket_atom_mapping_name;
            pocket_atom_mapping_left_paren =
              invalidate_option_with
                invalidate_token
                x.pocket_atom_mapping_left_paren;
            pocket_atom_mapping_mappings =
              invalidate_list_with
                invalidate_pumapping_aggregate
                x.pocket_atom_mapping_mappings;
            pocket_atom_mapping_right_paren =
              invalidate_option_with
                invalidate_token
                x.pocket_atom_mapping_right_paren;
            pocket_atom_mapping_semicolon =
              invalidate_token x.pocket_atom_mapping_semicolon;
          };
      Syntax.value = v;
    }

  and validate_pocket_enum_declaration : pocket_enum_declaration validator =
    function
    | { Syntax.syntax = Syntax.PocketEnumDeclaration x; value = v } ->
      ( v,
        {
          pocket_enum_right_brace = validate_token x.pocket_enum_right_brace;
          pocket_enum_fields =
            validate_list_with validate_pufield_aggregate x.pocket_enum_fields;
          ...
          pocket_enum_modifiers =
            validate_option_with validate_token x.pocket_enum_modifiers;
        } )
    | s -> validation_fail (Some SyntaxKind.PocketEnumDeclaration) s

  and invalidate_pocket_enum_declaration : pocket_enum_declaration invalidator
      =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PocketEnumDeclaration
          {
            pocket_enum_modifiers =
              invalidate_option_with invalidate_token x.pocket_enum_modifiers;
            ...
            pocket_enum_fields =
              invalidate_list_with
                invalidate_pufield_aggregate
                x.pocket_enum_fields;
            pocket_enum_right_brace =
              invalidate_token x.pocket_enum_right_brace;
          };
      Syntax.value = v;
    }

  and validate_pocket_field_type_expr_declaration :
      pocket_field_type_expr_declaration validator = function
    | { Syntax.syntax = Syntax.PocketFieldTypeExprDeclaration x; value = v } ->
      ( v,
        {
          pocket_field_type_expr_semicolon =
            validate_token x.pocket_field_type_expr_semicolon;
          pocket_field_type_expr_name =
            validate_expression x.pocket_field_type_expr_name;
          pocket_field_type_expr_type =
            validate_specifier x.pocket_field_type_expr_type;
          pocket_field_type_expr_case =
            validate_token x.pocket_field_type_expr_case;
        } )
    | s -> validation_fail (Some SyntaxKind.PocketFieldTypeExprDeclaration) s

  and invalidate_pocket_field_type_expr_declaration :
      pocket_field_type_expr_declaration invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PocketFieldTypeExprDeclaration
          {
            pocket_field_type_expr_case =
              invalidate_token x.pocket_field_type_expr_case;
            pocket_field_type_expr_type =
              invalidate_specifier x.pocket_field_type_expr_type;
            pocket_field_type_expr_name =
              invalidate_expression x.pocket_field_type_expr_name;
            pocket_field_type_expr_semicolon =
              invalidate_token x.pocket_field_type_expr_semicolon;
          };
      Syntax.value = v;
    }

  and validate_pocket_field_type_declaration :
      pocket_field_type_declaration validator = function
    | { Syntax.syntax = Syntax.PocketFieldTypeDeclaration x; value = v } ->
      ( v,
        {
          pocket_field_type_semicolon =
            validate_token x.pocket_field_type_semicolon;
  ...
  and invalidate_pocket_field_type_declaration :
      pocket_field_type_declaration invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PocketFieldTypeDeclaration
          {
            ...
            pocket_field_type_name =
              invalidate_expression x.pocket_field_type_name;
            pocket_field_type_semicolon =
              invalidate_token x.pocket_field_type_semicolon;
          };
      Syntax.value = v;
    }

  and validate_pocket_mapping_id_declaration :
      pocket_mapping_id_declaration validator = function
    | { Syntax.syntax = Syntax.PocketMappingIdDeclaration x; value = v } ->
      ( v,
        {
          pocket_mapping_id_initializer =
            validate_simple_initializer x.pocket_mapping_id_initializer;
  ...
  and invalidate_pocket_mapping_id_declaration :
      pocket_mapping_id_declaration invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PocketMappingIdDeclaration
          {
            pocket_mapping_id_name =
              invalidate_expression x.pocket_mapping_id_name;
            pocket_mapping_id_initializer =
              invalidate_simple_initializer x.pocket_mapping_id_initializer;
          };
      Syntax.value = v;
    }

  and validate_pocket_mapping_type_declaration :
      pocket_mapping_type_declaration validator = function
    | { Syntax.syntax = Syntax.PocketMappingTypeDeclaration x; value = v } ->
      ( v,
        {
          pocket_mapping_type_type =
            validate_specifier x.pocket_mapping_type_type;
          pocket_mapping_type_equal =
            validate_token x.pocket_mapping_type_equal;
          pocket_mapping_type_name =
            validate_expression x.pocket_mapping_type_name;
          pocket_mapping_type_keyword =
            validate_token x.pocket_mapping_type_keyword;
        } )
    | s -> validation_fail (Some SyntaxKind.PocketMappingTypeDeclaration) s

  and invalidate_pocket_mapping_type_declaration :
      pocket_mapping_type_declaration invalidator =
   fun (v, x) ->
    {
      Syntax.syntax =
        Syntax.PocketMappingTypeDeclaration
          {
            pocket_mapping_type_keyword =
              invalidate_token x.pocket_mapping_type_keyword;
            pocket_mapping_type_name =
              invalidate_expression x.pocket_mapping_type_name;
            pocket_mapping_type_equal =
              invalidate_token x.pocket_mapping_type_equal;
            pocket_mapping_type_type =
              invalidate_specifier x.pocket_mapping_type_type;
          };
      Syntax.value = v;
    }
end
