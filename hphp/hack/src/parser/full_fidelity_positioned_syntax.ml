...
external rust_parser_errors : Full_fidelity_source_text.t -> Rust_pointer.t -> ParserOptions.t -> Full_fidelity_syntax_error.t list = "rust_parser_errors_positioned"
