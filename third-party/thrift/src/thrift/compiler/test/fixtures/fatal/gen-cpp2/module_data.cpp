...
THRIFT_DATA_MEMBER const std::array<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter::Type, 1> TEnumDataStorage<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter::Type>::values = {{
  type::field,
}};
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 1> TEnumDataStorage<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter::Type>::names = {{
  "field",
}};
