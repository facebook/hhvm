...
cdef class __Foo_FieldsSetter(__StructFieldsSetter):
    ...
    cdef __Foo_FieldsSetter _fbthrift_create(_module_types.cFoo* struct_cpp_obj):
        ...
        __fbthrift_inst._setters[__cstring_view(<const char*>"field2")] = __Foo_FieldsSetter._set_field_1
        __fbthrift_inst._setters[__cstring_view(<const char*>"field3")] = __Foo_FieldsSetter._set_field_2
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        ...
        deref(self._struct_cpp_obj).field1_ref().assign(_fbthrift_value)
    ...
    cdef void _set_field_1(self, _fbthrift_value) except *:
        ...
        _fbthrift_value = <cint32_t> _fbthrift_value
        deref(self._struct_cpp_obj).field2_ref().assign(_fbthrift_value)
    ...
    cdef void _set_field_2(self, _fbthrift_value) except *:
        ...
        _fbthrift_value = <cint32_t> _fbthrift_value
        deref(self._struct_cpp_obj).field3_ref().assign(_fbthrift_value)
...
cdef class __Foo2_FieldsSetter(__StructFieldsSetter):
    ...
    cdef __Foo2_FieldsSetter _fbthrift_create(_module_types.cFoo2* struct_cpp_obj):
        ...
        __fbthrift_inst._setters[__cstring_view(<const char*>"field2")] = __Foo2_FieldsSetter._set_field_1
        __fbthrift_inst._setters[__cstring_view(<const char*>"field3")] = __Foo2_FieldsSetter._set_field_2
        return __fbthrift_inst

    cdef void set_field(__Foo2_FieldsSetter self, const char* name, object value) except *:
        cdef __cstring_view cname = __cstring_view(name)
        cdef cumap[__cstring_view, __Foo2_FieldsSetterFunc].iterator found = self._setters.find(cname)
        if found == self._setters.end():
            raise TypeError(f"invalid field name {name.decode('utf-8')}")
        deref(found).second(self, value)
