...
template void TccStructTraits<::test_cpp2::cpp_reflection::struct_with_special_names>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::test_cpp2::cpp_reflection::StructWithFieldAdapter>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
folly::Range<std::string_view const*> const TEnumTraits<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter::Type>::names = folly::range(TEnumDataStorage<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter::Type>::names);

bool TEnumTraits<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter::Type>::findName(type value, std::string_view* out) noexcept {
  return ::apache::thrift::detail::st::enum_find_name(value, out);
}

bool TEnumTraits<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter::Type>::findValue(std::string_view name, type* out) noexcept {
  return ::apache::thrift::detail::st::enum_find_value(name, out);
}
}} // apache::thrift
namespace test_cpp2::cpp_reflection {
...
void UnionWithTypedefFieldAdapter::__fbthrift_destruct() {
  switch(getType()) {
    case Type::__EMPTY__:
      break;
    case Type::field:
...
void UnionWithTypedefFieldAdapter::__fbthrift_clear() {
  ...
  UnionWithTypedefFieldAdapter::~UnionWithTypedefFieldAdapter() {
    __fbthrift_destruct();
  }
...
std::partial_ordering UnionWithTypedefFieldAdapter::operator<=>([[maybe_unused]] const UnionWithTypedefFieldAdapter& rhs) const {
  return ::apache::thrift::op::compare<UnionWithTypedefFieldAdapter>(*this, rhs);
}
