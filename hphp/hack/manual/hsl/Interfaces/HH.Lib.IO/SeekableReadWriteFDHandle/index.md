---
title: SeekableReadWriteFDHandle
---
...
interface SeekableReadWriteFDHandle implements ReadWriteFDHandle, SeekableWriteFDHandle, SeekableReadFDHandle, SeekableReadWriteHandle {...}
```
