...
cdef shared_ptr[_fbthrift_cbindings.cColor] Color_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cColor](deref(
        (<_fbthrift_ctypes.Color?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))
...
cdef shared_ptr[_fbthrift_cbindings.cVehicle] Vehicle_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cVehicle](deref(
        (<_fbthrift_ctypes.Vehicle?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))
...
cdef shared_ptr[_fbthrift_cbindings.cPerson] Person_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cPerson](deref(
        (<_fbthrift_ctypes.Person?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))
