...
$i = 0;
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gte(varray[2], varray['1'])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[2];
 ...
 $b = 't';
 $b = varray['1'];
 try { P(HH\Lib\Legacy_FIXME\gte(varray[2], $b)); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gte(varray[2], varray['a'])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[2];
 try { P(HH\Lib\Legacy_FIXME\gte($a, varray['a'])); } catch (Throwable $_) { print 'E'; }
 $b = 1;
 $b = 't';
 $b = varray['a'];
 try { P(HH\Lib\Legacy_FIXME\gte(varray[2], $b)); } catch (Throwable $_) { print 'E'; }
