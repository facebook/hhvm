...
const int CURLINFO_EFFECTIVE_METHOD = 0;
...
const int CURLOPT_CAINFO_BLOB = 0;
...
const int CURLOPT_DOH_SSL_VERIFYHOST = 0;
const int CURLOPT_DOH_SSL_VERIFYPEER = 0;
const int CURLOPT_DOH_SSL_VERIFYSTATUS = 0;
...
const int CURLOPT_HSTS = 0;
const int CURLOPT_HSTS_CTRL = 0;
...
const int CURLOPT_MAXAGE_CONN = 0;
...
const int CURLOPT_PROXY_CAINFO_BLOB = 0;
...
const int CURLOPT_SASL_AUTHZID = 0;
...
const int CURLE_QUIC_CONNECT_ERROR = 0;
...
const int CURL_VERSION_HSTS = 0;
const int CURL_VERSION_HTTP2 = 0;
const int CURL_VERSION_HTTP3 = 0;
...
const int CURL_VERSION_UNICODE = 0;
const int CURL_VERSION_ZSTD = 0;
...
const int CURLSSLOPT_AUTO_CLIENT_CERT = 0;
const int CURLSSLOPT_NO_PARTIALCHAIN = 0;
const int CURLSSLOPT_NO_REVOKE = 0;
const int CURLSSLOPT_REVOKE_BEST_EFFORT = 0;
...
const int CURL_HTTP_VERSION_3 = 0;
