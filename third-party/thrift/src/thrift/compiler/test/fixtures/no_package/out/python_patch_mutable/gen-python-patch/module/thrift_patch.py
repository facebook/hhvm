...
import module.gen_safe_patch_module.thrift_types as _fbthrift_safe_patch_types



class MyStructPatch(
    BaseStructPatch[_fbthrift__module__thrift_mutable_types.MyStruct]
):
    pass
    @property
    ...
    def MyDataField(self) -> UnqualifiedFieldPatch[
            _fbthrift__module__thrift_mutable_types.MyDataItem,
            MyDataItemPatch]:
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            3,
            _fbthrift_python_mutable_typeinfos.MutableStructTypeInfo(_fbthrift__module__thrift_mutable_types.MyDataItem))
    @property
    def myEnum(self) -> UnqualifiedFieldPatch[
            _fbthrift__module__thrift_mutable_types.MyEnum,
            EnumPatch]:
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            4,
            _fbthrift_python_types.EnumTypeInfo(_fbthrift__module__thrift_mutable_types.MyEnum))
    @property
    ...
    def floatSet(self) -> UnqualifiedFieldPatch[
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            8,
            _fbthrift_python_mutable_typeinfos.MutableSetTypeInfo(_fbthrift_python_types.typeinfo_float))
    @property
...
class ContainersPatch(
    BaseStructPatch[_fbthrift__module__thrift_mutable_types.Containers]
):
    pass
    @property
    def I32List(self) -> UnqualifiedFieldPatch[
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            1,
            _fbthrift_python_mutable_typeinfos.MutableListTypeInfo(_fbthrift_python_types.typeinfo_i32))
    @property
    def StringSet(self) -> UnqualifiedFieldPatch[
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            2,
            _fbthrift_python_mutable_typeinfos.MutableSetTypeInfo(_fbthrift_python_types.typeinfo_string))
    @property
    def StringToI64Map(self) -> UnqualifiedFieldPatch[
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            3,
            _fbthrift_python_mutable_typeinfos.MutableMapTypeInfo(_fbthrift_python_types.typeinfo_string, _fbthrift_python_types.typeinfo_i64))
...
class MyDataItemPatch(
    BaseStructPatch[_fbthrift__module__thrift_mutable_types.MyDataItem]
):
    pass
...
class MyUnionPatch(
    BaseUnionPatch[_fbthrift__module__thrift_mutable_types.MyUnion]
):
    pass
    @property
    ...
    def myStruct(self) -> OptionalFieldPatch[
            _fbthrift__module__thrift_mutable_types.MyStruct,
            MyStructPatch]:
        ...
        return OptionalFieldPatch(
            ...
            self._patch,
            2,
            _fbthrift_python_mutable_typeinfos.MutableStructTypeInfo(_fbthrift__module__thrift_mutable_types.MyStruct))
    @property
...
class MyExceptionPatch(
    BaseStructPatch[_fbthrift__module__thrift_mutable_types.MyException]
):
    pass
    @property
    def MyIntField(self) -> UnqualifiedFieldPatch[
    ...
    def myUnion(self) -> UnqualifiedFieldPatch[
            _fbthrift__module__thrift_mutable_types.MyUnion,
            MyUnionPatch]:
        ...
        return UnqualifiedFieldPatch(
            ...
            self._patch,
            4,
            _fbthrift_python_mutable_typeinfos.MutableStructTypeInfo(_fbthrift__module__thrift_mutable_types.MyUnion))
...
class MyExceptionWithMessagePatch(
    BaseStructPatch[_fbthrift__module__thrift_mutable_types.MyExceptionWithMessage]
):
    pass
    @property
    def MyIntField(self) -> UnqualifiedFieldPatch[
...
class ReservedKeywordPatch(
    BaseStructPatch[_fbthrift__module__thrift_mutable_types.ReservedKeyword]
):
    pass
    @property
...
class UnionToBeRenamedPatch(
    BaseUnionPatch[_fbthrift__module__thrift_mutable_types.UnionToBeRenamed]
):
    pass
    @property
