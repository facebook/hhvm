...
/* Generic exception class to be used in OpenSSL functions
 */
...
/* openssl_csr_get_dns_names() returns the DNS names from the given CSR.
 * @param mixed $csr - A CSR previously generated by openssl_csr_new()
 * @return vec<string> - Returns a vec of DNS names on success, empty if
 *  none are found
 * @throws Exception if the CSR could not be parsed
 */
<<__Native>>
function openssl_csr_get_dns_names(mixed $csr): vec<string>;

/* openssl_csr_get_upn() returns the User Principal Name from the given CSR.
 * @param mixed $csr - A CSR previously generated by openssl_csr_new()
 * @return string - Returns the UPN if the CSR contains a valid one.
 * @throws Exception if the CSR could not be parsed, or if the CSR does not
 *  contain a UPN.
 */
<<__Native>>
