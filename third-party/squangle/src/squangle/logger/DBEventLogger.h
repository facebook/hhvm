...
struct QueryLoggingData : CommonLoggingData {
  ...
  // Only invoked once the query is sampled for logging.
  common::mysql_client::DeferredAttributesFn deferred_response_attributes;
  bool was_slow;
  ...
  // Caller-defined labels serialized into mysql_client_logs.misc_tags.
  std::vector<std::string> misc_tags;
};
