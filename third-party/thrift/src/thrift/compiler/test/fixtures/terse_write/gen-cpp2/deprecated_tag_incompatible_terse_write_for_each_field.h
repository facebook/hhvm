...
template <>
struct ForEachField<::facebook::thrift::test::terse_write::deprecated_tag_incompatible::MyStruct> {
...
template <>
struct ForEachField<::facebook::thrift::test::terse_write::deprecated_tag_incompatible::MyStructWithCustomDefault> {
  template <typename F, typename... T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
...
template <>
struct ForEachField<::facebook::thrift::test::terse_write::deprecated_tag_incompatible::StructLevelTerseStruct> {
  template <typename F, typename... T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
...
template <>
struct ForEachField<::facebook::thrift::test::terse_write::deprecated_tag_incompatible::FieldLevelTerseStruct> {
  template <typename F, typename... T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
...
template <>
struct ForEachField<::facebook::thrift::test::terse_write::deprecated_tag_incompatible::TerseStructWithCustomDefault> {
  template <typename F, typename... T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
    f(0, static_cast<T&&>(t).bool_field_ref()...);
    f(1, static_cast<T&&>(t).byte_field_ref()...);
...
template <>
struct ForEachField<::facebook::thrift::test::terse_write::deprecated_tag_incompatible::AdaptedFields> {
  template <typename F, typename... T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
    f(0, static_cast<T&&>(t).field1_ref()...);
