  ...
  object ('b)
    constraint 'b =
      < on_ADef : 'c -> Ast_visitors_ancestors.def -> 'd;
        ...
        on_ParenthesizedExpr : 'c -> Ast_visitors_ancestors.expr -> 'd;
        ...
        on_param_kind : 'c -> Ast_visitors_ancestors.param_kind -> 'd;
    ...
    method on_ParenthesizedExpr : 'c -> Ast_visitors_ancestors.expr -> 'd
    ...
    method on_Continue : 'c -> Ast_visitors_ancestors.pos_t ->
      Ast_visitors_ancestors.expr option -> 'd
    ...
    method on_param_kind : 'c -> Ast_visitors_ancestors.param_kind -> 'd
