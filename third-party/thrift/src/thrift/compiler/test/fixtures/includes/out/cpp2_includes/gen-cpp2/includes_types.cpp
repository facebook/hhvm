...
template void TccStructTraits<::cpp2::Included>::translateFieldName(
...
std::partial_ordering Included::operator<=>([[maybe_unused]] const Included& rhs) const {
  return ::apache::thrift::op::compare<Included>(*this, rhs);
}
