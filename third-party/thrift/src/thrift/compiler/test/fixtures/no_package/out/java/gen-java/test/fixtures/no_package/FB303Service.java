...
public interface FB303Service extends java.io.Closeable, com.facebook.thrift.util.BlockingService {
    ...
    public interface Async extends java.io.Closeable, com.facebook.thrift.util.AsyncService {
        ...
        ListenableFuture<test.fixtures.no_package.ReservedKeyword> simpleRpc(
            @com.facebook.swift.codec.ThriftField(value=1, name="int_parameter", requiredness=Requiredness.NONE) final int intParameter);

        default ListenableFuture<test.fixtures.no_package.ReservedKeyword> simpleRpc(
            @com.facebook.swift.codec.ThriftField(value=1, name="int_parameter", requiredness=Requiredness.NONE) final int intParameter,
            RpcOptions rpcOptions) {
            throw new UnsupportedOperationException();
        }

        default ListenableFuture<ResponseWrapper<test.fixtures.no_package.ReservedKeyword>> simpleRpcWrapper(
            @com.facebook.swift.codec.ThriftField(value=1, name="int_parameter", requiredness=Requiredness.NONE) final int intParameter,
            RpcOptions rpcOptions) {
            throw new UnsupportedOperationException();
        }
    ...
    @ThriftMethod(value = "simple_rpc")
    test.fixtures.no_package.ReservedKeyword simpleRpc(
    ...
    default test.fixtures.no_package.ReservedKeyword simpleRpc(
        @com.facebook.swift.codec.ThriftField(value=1, name="int_parameter", requiredness=Requiredness.NONE) final int intParameter,
        RpcOptions rpcOptions) throws org.apache.thrift.TException {
        throw new UnsupportedOperationException();
    }

    default ResponseWrapper<test.fixtures.no_package.ReservedKeyword> simpleRpcWrapper(
        @com.facebook.swift.codec.ThriftField(value=1, name="int_parameter", requiredness=Requiredness.NONE) final int intParameter,
        RpcOptions rpcOptions) throws org.apache.thrift.TException {
        throw new UnsupportedOperationException();
    }
    ...
    interface Reactive extends reactor.core.Disposable, com.facebook.thrift.util.ReactiveService {
        ...
        @ThriftMethod(value = "simple_rpc")
        reactor.core.publisher.Mono<test.fixtures.no_package.ReservedKeyword> simpleRpc(final int intParameter);

        default reactor.core.publisher.Mono<test.fixtures.no_package.ReservedKeyword> simpleRpc(final int intParameter, RpcOptions rpcOptions) {
            throw new UnsupportedOperationException();
        }

        default reactor.core.publisher.Mono<ResponseWrapper<test.fixtures.no_package.ReservedKeyword>> simpleRpcWrapper(final int intParameter, RpcOptions rpcOptions) {
            throw new UnsupportedOperationException();
        }
