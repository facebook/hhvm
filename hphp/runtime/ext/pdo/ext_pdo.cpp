...
static struct PDOExtension final : Extension {
  ...
  void moduleInit() override {
    ...
    HHVM_RCC_INT(PDO, HH_MYSQL_ATTR_READ_TIMEOUT, HH_PDO_MYSQL_ATTR_READ_TIMEOUT);
    HHVM_RCC_INT(PDO, HH_MYSQL_ATTR_WRITE_TIMEOUT, HH_PDO_MYSQL_ATTR_WRITE_TIMEOUT);
#endif
