...
class ShouldBeBoxed(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.ShouldBeBoxed):
    ...
    @sessionId.setter
    def sessionId(self, value: builtins.str) -> None: ...
...
class _fbthrift_MyInteraction_encode_args(_fbthrift_python_mutable_types.MutableStruct):
...
class _fbthrift_MyInteraction_encode_result(_fbthrift_python_mutable_types.MutableStruct):
...
class _fbthrift_MyInteraction_encode_result_sink_elem(_fbthrift_python_mutable_types._fbthrift_MutableSinkResult[builtins.str]):
...
class _fbthrift_MyInteraction_encode_result_sink_final(_fbthrift_python_mutable_types._fbthrift_MutableSinkFinalResult[builtins.bytes]):
...
class _fbthrift_MyInteractionFast_encode_args(_fbthrift_python_mutable_types.MutableStruct):
...
class _fbthrift_MyInteractionFast_encode_result(_fbthrift_python_mutable_types.MutableStruct):
    success: _typing.Final[_fbthrift_python_mutable_containers.MutableSet[builtins.int]]
...
class _fbthrift_MyInteractionFast_encode_result_sink_elem(_fbthrift_python_mutable_types._fbthrift_MutableSinkResult[builtins.str]):
...
class _fbthrift_MyInteractionFast_encode_result_sink_final(_fbthrift_python_mutable_types._fbthrift_MutableSinkFinalResult[builtins.bytes]):
