...
public class ExtendedServiceRpcServerHandler  extends com.facebook.thrift.test.fixtures.service_schema.BaseServiceRpcServerHandler
  ...
  public ExtendedServiceRpcServerHandler(ExtendedService _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new ExtendedServiceBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public ExtendedServiceRpcServerHandler(ExtendedService.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new ExtendedServiceAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public ExtendedServiceRpcServerHandler(ExtendedService.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
  ...
  public reactor.core.publisher.Flux<com.facebook.thrift.payload.ServerResponsePayload> singleRequestStreamingResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    final String _qualifiedMethodName = "ExtendedService." + _name;
