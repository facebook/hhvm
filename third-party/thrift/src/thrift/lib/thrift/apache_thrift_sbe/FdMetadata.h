...
public:
        ...
        m_actingVersion(actingVersion)
    {
        ...
        {
            throw std::runtime_error("buffer too short for flyweight [E107] in FdMetadata");
        }
    }
    ...
    SBE_NODISCARD static const char *fdSeqNumMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
    ...
    static SBE_CONSTEXPR std::uint16_t fdSeqNumId() SBE_NOEXCEPT
    {
        return -1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t fdSeqNumSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool fdSeqNumInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t fdSeqNumEncodingOffset() SBE_NOEXCEPT
    {
        return 0;
    }
    ...
    SBE_NODISCARD static const char *numFdsMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t numFdsId() SBE_NOEXCEPT
    {
        return -1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t numFdsSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool numFdsInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t numFdsEncodingOffset() SBE_NOEXCEPT
    {
        return 8;
    }
