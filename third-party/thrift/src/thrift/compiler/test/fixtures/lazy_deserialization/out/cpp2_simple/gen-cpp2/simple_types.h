...
class IndexedFoo final  {
 private:
  ...
  static constexpr const std::int16_t __fbthrift_reflection_field_ids[] = {0,100,1,2,3,4,101};
...
template <> struct TSchemaAssociation<::apache::thrift::test::Foo> {
