...
import not_module.thrift_types as _fbthrift_python_types
...
cdef class Foo(thrift.py3.types.Struct):
    ...
    def __init__(Foo self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_not_module_cbindings.cFoo]()
    ...
    def __call__(Foo self, **kwargs):
        ...
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_not_module_cbindings.cFoo](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    cdef object _fbthrift_isset(self):
        return _fbthrift_IsSet("Foo", {
          "baz": deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).baz_ref().has_value(),
        })

    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_not_module_cbindings.cFoo] cpp_obj):
        __fbthrift_inst = <Foo>Foo.__new__(Foo)
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = cmove(cpp_obj)
        return __fbthrift_inst

    cdef inline baz_impl(self):
        return deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).baz_ref().value()

    @property
    def baz(self):
        return self.baz_impl()
    ...
    def __richcmp__(self, other, int op):
        ...
        return __richcmp[_not_module_cbindings.cFoo](
    ...
    def __get_metadata__():
        ...
        _not_module_cbindings.StructMetadata[_not_module_cbindings.cFoo].gen(meta)
        return __MetadataBox.box(cmove(meta))

    @staticmethod
    def __get_thrift_name__():
        return "not_module.Foo"

    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_not_module_cbindings.cFoo](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(Foo self, __Protocol proto):
        ...
        with nogil:
            data = cmove(serializer.cserialize[_not_module_cbindings.cFoo](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
    ...
    cdef cuint32_t _fbthrift_deserialize(Foo self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_not_module_cbindings.cFoo]()
        with nogil:
            needed = serializer.cdeserialize[_not_module_cbindings.cFoo](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
    ...
    def _to_py_deprecated(self):
        ...
        py_deprecated_types = importlib.import_module("not_module.ttypes")
