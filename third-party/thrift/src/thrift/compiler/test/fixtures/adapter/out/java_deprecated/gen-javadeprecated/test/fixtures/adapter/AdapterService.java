...
public class AdapterService {
  ...
  public static class count_args implements TBase, java.io.Serializable, Cloneable, Comparable<count_args>   {
  ...
  public static class count_result implements TBase, java.io.Serializable, Cloneable, Comparable<count_result>   {
    ...
    static {
      ...
      tmpMetaDataMap.put(SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new StructMetaData(TType.STRUCT, CountingStruct.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMetaDataMap);
    }
    ...
    public void setFieldValue(int fieldID, Object __value) {
      ...
      case SUCCESS:
        if (__value == null) {
          ...
          setSuccess((CountingStruct)__value);
        }
        break;
        ...
        switch (__field.id)
        {
          case SUCCESS:
            if (__field.type == TType.STRUCT) {
              this.success = new CountingStruct();
