 ...
 * monitoring connections (the fast_thrift counterpart of
 * apache::thrift::MonitoringServerInterface from
 * thrift/lib/cpp2/server/MonitoringServerInterface.h).
 *
 ...
 * class handles non-monitoring methods.
 */
class MonitoringServerInterface
