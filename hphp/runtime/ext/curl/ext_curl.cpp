...
const int64_t k_CURLCLOSEPOLICY_LEAST_RECENTLY_USED = CURLCLOSEPOLICY_LEAST_RECENTLY_USED;
...
const int64_t k_CURLE_FTP_USER_PASSWORD_INCORRECT = CURLE_FTP_USER_PASSWORD_INCORRECT;
...
const int64_t k_CURLINFO_CONTENT_LENGTH_DOWNLOAD = CURLINFO_CONTENT_LENGTH_DOWNLOAD;
...
const int64_t k_CURLOPT_FTP_CREATE_MISSING_DIRS = CURLOPT_FTP_CREATE_MISSING_DIRS;
...
const StaticString s_CURLCLOSEPOLICY_LEAST_RECENTLY_USED("CURLCLOSEPOLICY_LEAST_RECENTLY_USED");
const StaticString s_CURLCLOSEPOLICY_LEAST_TRAFFIC("CURLCLOSEPOLICY_LEAST_TRAFFIC");
...
const StaticString s_CURLE_FILE_COULDNT_READ_FILE("CURLE_FILE_COULDNT_READ_FILE");
const StaticString s_CURLE_FTP_ACCESS_DENIED("CURLE_FTP_ACCESS_DENIED");
const StaticString s_CURLE_FTP_BAD_DOWNLOAD_RESUME("CURLE_FTP_BAD_DOWNLOAD_RESUME");
...
const StaticString s_CURLE_FTP_COULDNT_SET_BINARY("CURLE_FTP_COULDNT_SET_BINARY");
...
const StaticString s_CURLE_FTP_USER_PASSWORD_INCORRECT("CURLE_FTP_USER_PASSWORD_INCORRECT");
...
const StaticString s_CURLE_FTP_WEIRD_SERVER_REPLY("CURLE_FTP_WEIRD_SERVER_REPLY");
...
const StaticString s_CURLINFO_CONTENT_LENGTH_DOWNLOAD("CURLINFO_CONTENT_LENGTH_DOWNLOAD");
const StaticString s_CURLINFO_CONTENT_LENGTH_UPLOAD("CURLINFO_CONTENT_LENGTH_UPLOAD");
...
const StaticString s_CURLOPT_DNS_USE_GLOBAL_CACHE("CURLOPT_DNS_USE_GLOBAL_CACHE");
...
const StaticString s_CURLOPT_FTP_CREATE_MISSING_DIRS("CURLOPT_FTP_CREATE_MISSING_DIRS");
...
class CurlExtension : public Extension {
 public:
  ...
  virtual void moduleInit() {
    ...
    Native::registerConstant<KindOfInt64>(
      s_CURLCLOSEPOLICY_LEAST_RECENTLY_USED.get(), k_CURLCLOSEPOLICY_LEAST_RECENTLY_USED
    );
    Native::registerConstant<KindOfInt64>(
    ...
    Native::registerConstant<KindOfInt64>(
      s_CURLE_FTP_USER_PASSWORD_INCORRECT.get(), k_CURLE_FTP_USER_PASSWORD_INCORRECT
    );
    Native::registerConstant<KindOfInt64>(
    ...
    Native::registerConstant<KindOfInt64>(
      s_CURLINFO_CONTENT_LENGTH_DOWNLOAD.get(), k_CURLINFO_CONTENT_LENGTH_DOWNLOAD
    );
    Native::registerConstant<KindOfInt64>(
