...
std::unique_ptr<apache::thrift::AsyncProcessor> apache::thrift::ServiceHandler<::cpp2::HeaderClientMethodsAnnotationOnService>::getProcessor() {
  return std::make_unique<::cpp2::HeaderClientMethodsAnnotationOnServiceAsyncProcessor>(this);
}

apache::thrift::ServiceHandler<::cpp2::HeaderClientMethodsAnnotationOnService>::CreateMethodMetadataResult apache::thrift::ServiceHandler<::cpp2::HeaderClientMethodsAnnotationOnService>::createMethodMetadata() {
  return ::apache::thrift::detail::ap::createMethodMetadataMap<::cpp2::HeaderClientMethodsAnnotationOnServiceAsyncProcessor>(getServiceRequestInfoMap().value().get());
}


std::optional<std::reference_wrapper<apache::thrift::ServiceRequestInfoMap const>> apache::thrift::ServiceHandler<::cpp2::HeaderClientMethodsAnnotationOnService>::getServiceRequestInfoMap() const {
...
void apache::thrift::ServiceHandler<::cpp2::HeaderClientMethodsAnnotationOnService>::sync_echo(::cpp2::EchoResponse& _return, std::unique_ptr<::cpp2::EchoRequest> p_request) {
...
void apache::thrift::ServiceHandler<::cpp2::HeaderClientMethodsAnnotationOnService>::sync_echo_2(::cpp2::EchoResponse& _return, std::unique_ptr<::cpp2::EchoRequest> p_request) {
...
const char* HeaderClientMethodsAnnotationOnServiceAsyncProcessor::getServiceName() {
  return "HeaderClientMethodsAnnotationOnService";
}

void HeaderClientMethodsAnnotationOnServiceAsyncProcessor::getServiceMetadata(apache::thrift::metadata::ThriftServiceMetadataResponse& response) {
  ::apache::thrift::detail::md::ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::HeaderClientMethodsAnnotationOnService>>::gen(response);
}
...
void HeaderClientMethodsAnnotationOnServiceAsyncProcessor::executeRequest(apache::thrift::ServerRequest&& request, const apache::thrift::AsyncProcessorFactory::MethodMetadata& methodMetadata) {
  apache::thrift::detail::ap::execute(this, std::move(request), apache::thrift::detail::ServerRequestHelper::protocol(request), methodMetadata);
}

const HeaderClientMethodsAnnotationOnServiceAsyncProcessor::ProcessMap& HeaderClientMethodsAnnotationOnServiceAsyncProcessor::getOwnProcessMap() {
  return kOwnProcessMap_;
}

const HeaderClientMethodsAnnotationOnServiceAsyncProcessor::ProcessMap HeaderClientMethodsAnnotationOnServiceAsyncProcessor::kOwnProcessMap_ {
  {"echo",
    {&HeaderClientMethodsAnnotationOnServiceAsyncProcessor::setUpAndProcess_echo<apache::thrift::CompactProtocolReader, apache::thrift::CompactProtocolWriter>,
     &HeaderClientMethodsAnnotationOnServiceAsyncProcessor::setUpAndProcess_echo<apache::thrift::BinaryProtocolReader, apache::thrift::BinaryProtocolWriter>,
     &HeaderClientMethodsAnnotationOnServiceAsyncProcessor::executeRequest_echo<apache::thrift::CompactProtocolReader, apache::thrift::CompactProtocolWriter>,
     &HeaderClientMethodsAnnotationOnServiceAsyncProcessor::executeRequest_echo<apache::thrift::BinaryProtocolReader, apache::thrift::BinaryProtocolWriter>}},
  {"echo_2",
    {&HeaderClientMethodsAnnotationOnServiceAsyncProcessor::setUpAndProcess_echo_2<apache::thrift::CompactProtocolReader, apache::thrift::CompactProtocolWriter>,
     &HeaderClientMethodsAnnotationOnServiceAsyncProcessor::setUpAndProcess_echo_2<apache::thrift::BinaryProtocolReader, apache::thrift::BinaryProtocolWriter>,
     &HeaderClientMethodsAnnotationOnServiceAsyncProcessor::executeRequest_echo_2<apache::thrift::CompactProtocolReader, apache::thrift::CompactProtocolWriter>,
     &HeaderClientMethodsAnnotationOnServiceAsyncProcessor::executeRequest_echo_2<apache::thrift::BinaryProtocolReader, apache::thrift::BinaryProtocolWriter>}},
};

apache::thrift::ServiceRequestInfoMap const& HeaderClientMethodsAnnotationOnServiceServiceInfoHolder::requestInfoMap() const {
  static folly::Indestructible<apache::thrift::ServiceRequestInfoMap> requestInfoMap{staticRequestInfoMap()};
  return *requestInfoMap;
}

apache::thrift::ServiceRequestInfoMap HeaderClientMethodsAnnotationOnServiceServiceInfoHolder::staticRequestInfoMap() {
...
::folly::Range<const ::std::string_view*>(*TSchemaAssociation<::cpp2::HeaderClientMethodsAnnotationOnService>::bundle)() =
    nullptr;
}
