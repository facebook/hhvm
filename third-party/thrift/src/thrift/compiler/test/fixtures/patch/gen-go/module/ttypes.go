...
func (p *MyStructEnsureStruct)  ReadField_30(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    for i := 0; i < size; i ++ {
      ...
      _val17[_key18] = _val19
    }
    if err := iprot.ReadMapEnd(); err != nil {
      return thrift.PrependError("error reading map end: ", err)
    }
    p.MapMap[_key16] = _val17
  }
  if err := iprot.ReadMapEnd(); err != nil {
    return thrift.PrependError("error reading map end: ", err)
  }
...
func (p *MyStructEnsureStruct)  ReadField_29(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.ListMap = append(p.ListMap, _elem20)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructEnsureStruct)  ReadField_27(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OptSetVal = append(p.OptSetVal, _elem25)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
...
func (p *MyStructEnsureStruct)  ReadField_26(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OptListVal = append(p.OptListVal, _elem26)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField26Patch) GetPatch() map[int32]*patch1.I16Patch {
  return p.Patch
}
...
func (m *MyStructField26PatchBuilder) Patch(patch map[int32]*patch1.I16Patch) *MyStructField26PatchBuilder {
  m.obj.Patch = patch
  return m
}
...
func (m *MyStructField26Patch) SetPatch(patch map[int32]*patch1.I16Patch) *MyStructField26Patch {
  m.Patch = patch
  return m
}
...
func (p *MyStructField26Patch)  ReadField1(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Assign = append(p.Assign, _elem27)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField26Patch)  ReadField7(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Remove = append(p.Remove, _elem30)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField26Patch)  ReadField8(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Prepend = append(p.Prepend, _elem31)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField26Patch)  ReadField9(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Append = append(p.Append, _elem32)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField27Patch)  ReadField1(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Assign = append(p.Assign, _elem33)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
...
func (p *MyStructField28Patch)  ReadField7(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Remove = append(p.Remove, _elem44)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
...
type MyStructField29Patch struct {
  ...
  Clear bool `thrift:"clear,2" db:"clear" json:"clear"`
  Patch map[int32]*MyStructField29Patch1 `thrift:"patch,3" db:"patch" json:"patch"`
  // unused fields # 4 to 6
...
func (p *MyStructField29Patch) GetPatch() map[int32]*MyStructField29Patch1 {
  return p.Patch
}
...
func (m *MyStructField29PatchBuilder) Patch(patch map[int32]*MyStructField29Patch1) *MyStructField29PatchBuilder {
  m.obj.Patch = patch
  return m
}
...
func (m *MyStructField29Patch) SetPatch(patch map[int32]*MyStructField29Patch1) *MyStructField29Patch {
  m.Patch = patch
  return m
}
...
func (p *MyStructField29Patch)  ReadField1(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Assign = append(p.Assign, _elem47)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField29Patch)  ReadField3(iprot thrift.Protocol) error {
  ...
  tMap := make(map[int32]*MyStructField29Patch1, size)
  p.Patch =  tMap
  for i := 0; i < size; i ++ {
    var _key50 int32
    if v, err := iprot.ReadI32(); err != nil {
...
func (p *MyStructField29Patch)  ReadField7(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Remove = append(p.Remove, _elem52)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField29Patch)  ReadField8(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Prepend = append(p.Prepend, _elem55)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField29Patch)  ReadField9(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Append = append(p.Append, _elem58)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField29Patch1)  ReadField6(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    _val68 := patch1.NewI32Patch()
    if err := _val68.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _val68), err)
    }
    p.Patch[_key67] = _val68
  }
  if err := iprot.ReadMapEnd(); err != nil {
    return thrift.PrependError("error reading map end: ", err)
  }
...
func (p *MyStructField29Patch1)  ReadField7(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Remove = append(p.Remove, _elem69)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
...
func (p *MyStructField30Patch)  ReadField6(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    _val83 := NewMyStructField30Patch1()
...
func (p *MyStructField30Patch1)  ReadField7(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Remove = append(p.Remove, _elem97)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
...
var LoopEnsureStruct_Bar_DEFAULT *Bar
func (p *LoopEnsureStruct) GetBar() *Bar {
  if !p.IsSetBar() {
    return LoopEnsureStruct_Bar_DEFAULT
  }
  return p.Bar
}
func (p *LoopEnsureStruct) DefaultGetBar() *Bar {
  if !p.IsSetBar() {
    return NewBar()
  }
  return p.Bar
}
func (p *LoopEnsureStruct) IsSetBar() bool {
  return p != nil && p.Bar != nil
}
...
func (p LoopEnsureStructBuilder) Emit() *LoopEnsureStruct{
  return &LoopEnsureStruct{
    Bar: p.obj.Bar,
  }
}

func (l *LoopEnsureStructBuilder) Bar(bar *Bar) *LoopEnsureStructBuilder {
  l.obj.Bar = bar
  return l
}

func (l *LoopEnsureStruct) SetBar(bar *Bar) *LoopEnsureStruct {
  l.Bar = bar
  return l
}

func (p *LoopEnsureStruct) Read(iprot thrift.Protocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *LoopEnsureStruct)  ReadField_1(iprot thrift.Protocol) error {
  p.Bar = NewBar()
  if err := p.Bar.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Bar), err)
  }
...
func (p *LoopEnsureStruct) Write(oprot thrift.Protocol) error {
  if err := oprot.WriteStructBegin("LoopEnsureStruct"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if err := p.writeField_1(oprot); err != nil { return err }
  if err := oprot.WriteFieldStop(); err != nil {
    return thrift.PrependError("write field stop error: ", err) }
...
func (p *LoopEnsureStruct) writeField_1(oprot thrift.Protocol) (err error) {
  if p.IsSetBar() {
    if err := oprot.WriteFieldBegin("bar", thrift.STRUCT, -1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error -1:bar: ", p), err) }
    if err := p.Bar.Write(oprot); err != nil {
...
func (p *LoopEnsureStruct) String() string {
  if p == nil {
    return "<nil>"
  }
  ...
  return fmt.Sprintf("LoopEnsureStruct({Bar:%s})", barVal)
}
