...
CPPFLAGS += -DFACEBOOK -DHAVE_PHPT -DHAVE_QUICKLZ
...
unexport LINK_OBJECTS MAKEFILE_LIST COMPILE_IT OBJECT_DIR_DEPS REC_SOURCES LIB_PATHS PREPROCESS_IT WWW_SHARED_FILES FLIB_FILES SIZE_SORTED_SOURCES ADDITIONAL_OBJS RECURSIVE_SOURCES
