...
This function is similar to ` mm() `, except the [` Map `](/docs/apis/Classes/HH/Map/) in the returned
...
``` m ```apping operation and each value member in the [` Map `](/docs/apis/Classes/HH/Map/) is `` w ``rapped by a
