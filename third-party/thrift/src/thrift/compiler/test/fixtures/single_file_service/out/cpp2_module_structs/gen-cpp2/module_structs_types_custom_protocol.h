...
uint32_t Foo::serializedSize(Protocol_ const* prot_) const {
  ...
  if (this->__isset.get(0)) {
    xfer += prot_->serializedFieldSize("value", apache::thrift::protocol::TType::T_I32, 1);
...
uint32_t Foo::write(Protocol_* prot_) const {
  ...
  if (this->__isset.get(0)) {
    ...
    xfer += ::apache::thrift::detail::writeFieldBegin<apache::thrift::protocol::TType::T_I32, 1, kPrevFieldId>(*prot_, "value", previousFieldHasValue);
