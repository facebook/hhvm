...
[` Set `](/docs/apis/Classes/HH/Set/)s don't have keys, so the [` Set `](/docs/apis/Classes/HH/Set/) values are used as the key in the
callback.




This method is like [` filterWithKey() `](/docs/apis/Classes/HH/Set/filterWithKey/), but mutates the current [` Set `](/docs/apis/Classes/HH/Set/) too
in addition to returning the current [` Set `](/docs/apis/Classes/HH/Set/).
