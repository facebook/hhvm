...
function f(
  ...
  varray $p3 = varray[varray[], [varray[1, 2, 3], []], [1, 2, 3]],
  varray $p4 = varray[varray[], [varray[1, C::A, 3], []], [1, 2, 3]],
...
function g(
  ...
  darray $p3 = darray[1 => darray[], "hi" => [darray["key1" => 123, "key2" => []], 456], 5 => []],
  darray $p4 = darray[1 => darray[], "hi" => [darray["key1" => C::A, "key2" => []], 456], 5 => []],
