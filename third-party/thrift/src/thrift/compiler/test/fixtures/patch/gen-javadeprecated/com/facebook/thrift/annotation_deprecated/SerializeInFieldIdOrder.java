...
public class SerializeInFieldIdOrder implements TBase, java.io.Serializable, Cloneable, Comparable<SerializeInFieldIdOrder> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(SerializeInFieldIdOrder.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public SerializeInFieldIdOrder build() {
      SerializeInFieldIdOrder result = new SerializeInFieldIdOrder();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(SerializeInFieldIdOrder other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("SerializeInFieldIdOrder");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
