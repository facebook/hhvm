...
void json_set_last_error_code(json_error_codes error_code, json_tokener_error parser_code) {
    s_json_state->error_code = error_code;
...
Variant json_object_to_variant(json_object *new_obj, const bool assoc, 
    ...
    case json_type_array:
        return json_type_array_to_variant(new_obj, assoc, stable_maps, collections);

    case json_type_object:
        return json_type_object_to_variant(new_obj, assoc, stable_maps, collections);
...
bool JSON_parser(Variant &return_value, const char *data, int data_len, bool assoc, 
    ...
    if (new_obj) {
        return_value = json_object_to_variant(new_obj, assoc, stable_maps, collections);
