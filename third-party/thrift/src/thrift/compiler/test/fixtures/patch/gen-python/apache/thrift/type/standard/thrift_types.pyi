...
class DurationStruct(_fbthrift_python_types.Struct):
    seconds: _typing.Final[int] = ...
    nanos: _typing.Final[int] = ...
    def __init__(
        self, *,
    ...
    def _to_python(self) -> DurationStruct: ...
    def _to_py3(self) -> "apache.thrift.type.standard.types.DurationStruct": ...  # type: ignore
    def _to_py_deprecated(self) -> "thrift.lib.thrift.standard.ttypes.DurationStruct": ...  # type: ignore


class TimeStruct(_fbthrift_python_types.Struct):
    seconds: _typing.Final[int] = ...
    nanos: _typing.Final[int] = ...
    def __init__(
        self, *,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[int, int]]]: ...
    def _to_python(self) -> TimeStruct: ...
    def _to_py3(self) -> "apache.thrift.type.standard.types.TimeStruct": ...  # type: ignore
    def _to_py_deprecated(self) -> "thrift.lib.thrift.standard.ttypes.TimeStruct": ...  # type: ignore


class FractionStruct(_fbthrift_python_types.Struct):
    numerator: _typing.Final[int] = ...
    denominator: _typing.Final[int] = ...
    def __init__(
        self, *,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[int, int]]]: ...
    def _to_python(self) -> FractionStruct: ...
    def _to_py3(self) -> "apache.thrift.type.standard.types.FractionStruct": ...  # type: ignore
...
class TypeName(_fbthrift_python_types.Union):
    ...
    typedefType: _typing.Final[TypeUri] = ...
    def __init__(
        self, *,
        ...
        typedefType: _typing.Optional[TypeUri]=...
    ) -> None: ...
    ...
    @classmethod
    def fromValue(cls, value: _typing.Union[None, Void, Void, Void, Void, Void, Void, Void, Void, Void, TypeUri, TypeUri, TypeUri, TypeUri, Void, Void, Void, TypeUri]) -> TypeName: ...
    value: _typing.Final[_typing.Union[None, Void, Void, Void, Void, Void, Void, Void, Void, Void, TypeUri, TypeUri, TypeUri, TypeUri, Void, Void, Void, TypeUri]]
    type: Type
    def get_type(self) -> Type:...
