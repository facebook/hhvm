 ...
 *
 * This is designed to used in alias classes. In most cases, a set that
 * cannot be precisely represented will be enlarged by introducing
 *
 * However, we guarantee precise representation of any single ID, and any
 * subset of of IDs below 62. Hopefully, these cover most practical cases.
 */
struct AliasIdSet {
