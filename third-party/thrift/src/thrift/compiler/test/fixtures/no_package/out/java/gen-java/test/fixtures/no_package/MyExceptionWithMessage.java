...
public final class MyExceptionWithMessage extends org.apache.thrift.TBaseException implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    private final test.fixtures.no_package.MyStruct myStruct;
    ...
    private final test.fixtures.no_package.MyUnion myUnion;
    ...
    public MyExceptionWithMessage(
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="myStruct", requiredness=Requiredness.NONE) final test.fixtures.no_package.MyStruct myStruct,
        @com.facebook.swift.codec.ThriftField(value=4, name="myUnion", requiredness=Requiredness.NONE) final test.fixtures.no_package.MyUnion myUnion
    ) {
        super(myStringField);
    ...
    public static class Builder {
        ...
        private test.fixtures.no_package.MyStruct myStruct = null;
        private test.fixtures.no_package.MyUnion myUnion = null;
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="myStruct", requiredness=Requiredness.NONE)    public Builder setMyStruct(test.fixtures.no_package.MyStruct myStruct) {
            this.myStruct = myStruct;
            return this;
        }

        public test.fixtures.no_package.MyStruct getMyStruct() { return myStruct; }

        @com.facebook.swift.codec.ThriftField(value=4, name="myUnion", requiredness=Requiredness.NONE)    public Builder setMyUnion(test.fixtures.no_package.MyUnion myUnion) {
            this.myUnion = myUnion;
            return this;
        }

        public test.fixtures.no_package.MyUnion getMyUnion() { return myUnion; }
        ...
        while (true) {
            ...
            case _MYSTRUCT:
                if (__field.type == TType.STRUCT) {
                    test.fixtures.no_package.MyStruct _fbthriftVar0;
                    _fbthriftVar0 = test.fixtures.no_package.MyStruct.read0(oprot);
            ...
            case _MYUNION:
                if (__field.type == TType.STRUCT) {
                    test.fixtures.no_package.MyUnion _fbthriftVar0;
                    _fbthriftVar0 = test.fixtures.no_package.MyUnion.read0(oprot);
    ...
    public void write0(TProtocol oprot) throws TException {
        ...
        {
            test.fixtures.no_package.MyStruct _fbthriftVar0 = this.myStruct;
            if (_fbthriftVar0 != null) {
        ...
        {
            test.fixtures.no_package.MyUnion _fbthriftVar0 = this.myUnion;
            if (_fbthriftVar0 != null) {
