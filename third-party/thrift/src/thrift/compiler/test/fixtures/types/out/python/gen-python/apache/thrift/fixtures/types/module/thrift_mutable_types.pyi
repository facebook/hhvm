...
class IncompleteMap(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.IncompleteMap):
    ...
    def __init__(
        self, *,
        field: _typing.Optional[_fbthrift_python_mutable_containers.MutableMap[int, _fbthrift_IncompleteMapDep] | _fbthrift_python_mutable_types._ThriftMapWrapper]=...
    ) -> None: ...
...
class CompleteMap(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.CompleteMap):
    ...
    def __init__(
        self, *,
        field: _typing.Optional[_fbthrift_python_mutable_containers.MutableMap[int, _fbthrift_CompleteMapDep] | _fbthrift_python_mutable_types._ThriftMapWrapper]=...
    ) -> None: ...
