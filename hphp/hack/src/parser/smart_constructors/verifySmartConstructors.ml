...
module WithSyntax(Syntax : Syntax_sig.Syntax_S) = struct
  ...
  let make_file_attribute_specification p0 p1 p2 p3 p4 stack =
    match stack with
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1; p2; p3; p4] [a0; a1; a2; a3; a4] "file_attribute_specification" in
  ...
  let make_methodish_trait_resolution p0 p1 p2 p3 p4 stack =
    match stack with
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1; p2; p3; p4] [a0; a1; a2; a3; a4] "methodish_trait_resolution" in
  ...
  let make_type_const_declaration p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 stack =
    match stack with
    | a9 :: a8 :: a7 :: a6 :: a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1; p2; p3; p4; p5; p6; p7; p8; p9] [a0; a1; a2; a3; a4; a5; a6; a7; a8; a9] "type_const_declaration" in
  ...
  let make_record_creation_expression p0 p1 p2 p3 p4 stack =
    match stack with
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1; p2; p3; p4] [a0; a1; a2; a3; a4] "record_creation_expression" in
  ...
  let make_pocket_identifier_expression p0 p1 p2 p3 p4 stack =
    match stack with
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1; p2; p3; p4] [a0; a1; a2; a3; a4] "pocket_identifier_expression" in
  ...
  let make_pocket_atom_mapping_declaration p0 p1 p2 p3 p4 p5 stack =
    match stack with
    | a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1; p2; p3; p4; p5] [a0; a1; a2; a3; a4; a5] "pocket_atom_mapping_declaration" in
