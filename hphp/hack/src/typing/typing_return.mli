...
val implicit_return:
  ...
  actual:Typing_defs.locl Typing_defs.ty -> env
...
val make_return_type:
  (env -> Typing_defs.decl Typing_defs.ty -> env * Typing_defs.locl Typing_defs.ty) ->
  env ->
  Typing_defs.decl Typing_defs.ty -> env * Typing_defs.locl Typing_defs.ty
...
val make_default_return:
  ...
  env ->
  Ast_defs.pos * string -> env * (Typing_reason.t * Typing_defs.locl Typing_defs.ty_)
