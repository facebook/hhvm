...
impl TokenKind {
    ...
    pub fn ocaml_tag(self) -> u8 {
        match self {
            ...
            TokenKind::Include_once => 54,
            TokenKind::Inout => 55,
            TokenKind::Instanceof => 56,
            TokenKind::Insteadof => 57,
            TokenKind::Int => 58,
            TokenKind::Integer => 59,
            TokenKind::Interface => 60,
            TokenKind::Is => 61,
            TokenKind::Isset => 62,
            TokenKind::Keyset => 63,
            TokenKind::List => 64,
    ...
    pub fn try_from_u8(tag: u8) -> Option<Self> {
        match tag {
            ...
            54 => Some(TokenKind::Include_once),
            55 => Some(TokenKind::Inout),
            56 => Some(TokenKind::Instanceof),
            57 => Some(TokenKind::Insteadof),
            58 => Some(TokenKind::Int),
            59 => Some(TokenKind::Integer),
            60 => Some(TokenKind::Interface),
            61 => Some(TokenKind::Is),
            62 => Some(TokenKind::Isset),
            63 => Some(TokenKind::Keyset),
            64 => Some(TokenKind::List),
            65 => Some(TokenKind::Mixed),
            66 => Some(TokenKind::Module),
