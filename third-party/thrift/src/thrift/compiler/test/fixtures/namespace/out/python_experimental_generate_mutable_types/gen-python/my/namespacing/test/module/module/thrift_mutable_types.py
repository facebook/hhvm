...
import python_module_root.my.namespacing.test.module.module.thrift_abstract_types as _fbthrift_abstract_types
...
class Foo(metaclass=_fbthrift_python_mutable_types.MutableStructMeta):
    ...
    def _to_python(self):
        ...
        import importlib
        immutable_types = importlib.import_module("python_module_root.my.namespacing.test.module.module.thrift_types")
