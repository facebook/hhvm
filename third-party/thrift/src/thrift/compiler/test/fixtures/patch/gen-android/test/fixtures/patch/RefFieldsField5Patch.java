...
public class RefFieldsField5Patch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static RefFieldsField5Patch deserialize(TProtocol iprot) throws TException {
    ...
    RefFieldsField5Patch _that;
    _that = new RefFieldsField5Patch(
      tmp_assign
      ,tmp_clear
      ,tmp_prepend
      ,tmp_append
