...
import my.namespacing.test.module.module.thrift_types as _fbthrift_current_module
...
class Foo(metaclass=_fbthrift_python_types.StructMeta):
    ...
    def _to_py3(self):
        import importlib
        py3_types = importlib.import_module("my.namespacing.test.module.module.types")
...
def _fbthrift_metadata__struct_Foo():
    return my.namespacing.test.module.module.thrift_metadata.gen_metadata_struct_Foo()
