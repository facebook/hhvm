...
::std::string_view _fbthrift_schema_62f83fb0478b676() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_62f83fb0478b676_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_62f83fb0478b676_uris() {
  return {};
}
