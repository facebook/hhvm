...
<<__EntryPoint>>
function main_861() :mixed{
$i = 0;
 print ++$i;
 print "\t";
 print (HH\Lib\Legacy_FIXME\eq(darray['a' => 1, 'b' => 2], true)) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['a' => 1, 'b' => 2];
 ...
 $b = 't';
 $b = true;
 print (HH\Lib\Legacy_FIXME\eq(darray['a' => 1, 'b' => 2], $b)) ? 'Y' : 'N';
 ...
 print ++$i;
 print "\t";
 print (darray['a' => 1, 'b' => 2]==darray[]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = darray['a' => 1, 'b' => 2];
 print ($a ==darray[]) ? 'Y' : 'N';
