...
folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::FooBarBazService>::fbthrift_semifuture_foo(folly::SemiFuture<typename apache::thrift::detail::FutureCallbackHelper<folly::Unit>::PromiseResult> semifuture, apache::thrift::RpcOptions& rpcOptions, apache::thrift::RequestClientCallback::Ptr wrappedCallback, apache::thrift::ContextStack* contextStack, std::shared_ptr<::apache::thrift::transport::THeader> header) {
  using CallbackHelper = apache::thrift::detail::FutureCallbackHelper<folly::Unit>;
  apache::thrift::SerializedRequest request = fbthrift_serialize_foo(rpcOptions, *header, contextStack);
#if FOLLY_HAS_COROUTINES
...
folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::FooBarBazService>::fbthrift_semifuture_baz(apache::thrift::RpcOptions& rpcOptions) {
  ...
  auto wrappedCallbackAndContextStack = apache::thrift::GeneratedAsyncClient::template prepareRequestClientCallback<false /* kIsOneWay */>(
    ...
    std::move(ctxAndHeader.first));
  return fbthrift_semifuture_baz(std::move(semifuture), rpcOptions, std::move(wrappedCallbackAndContextStack.first), wrappedCallbackAndContextStack.second, std::move(ctxAndHeader.second));
}

folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::FooBarBazService>::fbthrift_semifuture_baz(folly::SemiFuture<typename apache::thrift::detail::FutureCallbackHelper<folly::Unit>::PromiseResult> semifuture, apache::thrift::RpcOptions& rpcOptions, apache::thrift::RequestClientCallback::Ptr wrappedCallback, apache::thrift::ContextStack* contextStack, std::shared_ptr<::apache::thrift::transport::THeader> header) {
  using CallbackHelper = apache::thrift::detail::FutureCallbackHelper<folly::Unit>;
  apache::thrift::SerializedRequest request = fbthrift_serialize_baz(rpcOptions, *header, contextStack);
#if FOLLY_HAS_COROUTINES
  const bool shouldProcessClientInterceptors = contextStack && contextStack->shouldProcessClientInterceptors();
  if (!shouldProcessClientInterceptors) {
    fbthrift_send_baz(std::move(request), rpcOptions, std::move(header), std::move(wrappedCallback));
    return std::move(semifuture).deferValue(CallbackHelper::extractResult);
  }
  return CallbackHelper::executeWithClientInterceptors(*contextStack, [this, semifuture = std::move(semifuture), request = std::move(request), rpcOptions, header = std::move(header), wrappedCallback = std::move(wrappedCallback)]() mutable {
    fbthrift_send_baz(std::move(request), rpcOptions, std::move(header), std::move(wrappedCallback));
