...
inline bool equal(CVarRef v1, const Object& v2) {
  if (!v2.get()) return cellEqual(*v1.asCell(), false);
  return cellEqual(*v1.asCell(), v2.get());
}
...
inline bool less(CVarRef v1, const Object& v2) {
  if (!v2.get()) return cellLess(*v1.asCell(), false);
  return cellLess(*v1.asCell(), v2.get());
}
...
inline bool more(CVarRef v1, const Object& v2) {
  if (!v2.get()) return cellGreater(*v1.asCell(), false);
  return cellGreater(*v1.asCell(), v2.get());
}
...
inline bool same(const Object& v1, CVarRef v2)  { return same(v2, v1);}
...
inline bool equal(const Object& v1, CVarRef v2) { return equal(v2, v1);}
...
inline bool less(const Object& v1, CVarRef v2)  {
...
inline bool more(const Object& v1, CVarRef v2)  {
