...
class RequestRpcMetadataOptional {
 private:
   ...
   *       V0_TENANTID_DONE -> V0_TENANTID_DONE [label="
   * serviceTraceMetaLength()  "]; V0_TENANTID_DONE -> V0_SERVICETRACEMETA_DONE
   * [label="  serviceTraceMeta(?)  "]; V0_SERVICETRACEMETA_DONE ->
   * V0_SERVICETRACEMETA_DONE [label="  loggingContextLength()  "];
   *       V0_SERVICETRACEMETA_DONE -> V0_LOGGINGCONTEXT_DONE [label="
   * loggingContext(?)  "];
   *   }
   * }</pre>
   */
 ...
 public:
  ...
  RequestRpcMetadataOptional& wrapForEncode(
      char* buffer,
      const std::uint64_t offset,
      const std::uint64_t bufferLength) {
    m_buffer = buffer;
  ...
  RequestRpcMetadataOptional& wrapAndApplyHeader(
      char* buffer,
      const std::uint64_t offset,
      const std::uint64_t bufferLength) {
  ...
  SBE_NODISCARD std::uint64_t decodeLength() const {
    RequestRpcMetadataOptional skipper(
        m_buffer,
        m_offset,
        m_bufferLength,
        sbeBlockLength(),
  ...
  SBE_NODISCARD static const char* clientTimeoutMsMetaAttribute(
  ...
  SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t clientTimeoutMsSinceVersion()
      SBE_NOEXCEPT {
    return 0;
  }
  ...
  SBE_NODISCARD static SBE_CONSTEXPR std::size_t clientTimeoutMsEncodingOffset()
      SBE_NOEXCEPT {
    return 0;
  }
  ...
  void onClientTimeoutMsAccessed() const {
    if (codecState() == CodecState::NOT_WRAPPED) {
      throw AccessOrderError(
          ...
          "Cannot access field \"clientTimeoutMs\" in state: " +
 ...
 public:
  ...
  static SBE_CONSTEXPR std::size_t clientTimeoutMsEncodingLength()
      SBE_NOEXCEPT {
    return 4;
  }
  ...
  SBE_NODISCARD static const char* queueTimeoutMsMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "required";
  ...
  SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t queueTimeoutMsSinceVersion()
      SBE_NOEXCEPT {
    return 0;
  }
  ...
  SBE_NODISCARD static SBE_CONSTEXPR std::size_t queueTimeoutMsEncodingOffset()
      SBE_NOEXCEPT {
    return 4;
  }
 ...
 private:
  void onQueueTimeoutMsAccessed() const {
    if (codecState() == CodecState::NOT_WRAPPED) {
      throw AccessOrderError(
          std::string("Illegal field access order. ") +
          "Cannot access field \"queueTimeoutMs\" in state: " +
          codecStateName(codecState()) +
          ". Expected one of these transitions: [" +
          codecStateTransitions(codecState()) +
          "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  ...
  SBE_NODISCARD static const char* priorityMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "required";
  ...
  static SBE_CONSTEXPR std::uint16_t priorityId() SBE_NOEXCEPT { return 3; }

  SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t prioritySinceVersion()
      SBE_NOEXCEPT {
    return 0;
  }

  SBE_NODISCARD bool priorityInActingVersion() SBE_NOEXCEPT { return true; }

  SBE_NODISCARD static SBE_CONSTEXPR std::size_t priorityEncodingOffset()
      SBE_NOEXCEPT {
    return 8;
  }
 ...
 private:
  void onPriorityAccessed() const {
    if (codecState() == CodecState::NOT_WRAPPED) {
      throw AccessOrderError(
          std::string("Illegal field access order. ") +
          "Cannot access field \"priority\" in state: " +
          codecStateName(codecState()) +
          ". Expected one of these transitions: [" +
          codecStateTransitions(codecState()) +
          "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  SBE_NODISCARD static SBE_CONSTEXPR std::size_t priorityEncodingLength()
      SBE_NOEXCEPT {
    return 1;
  }
  ...
  SBE_NODISCARD static const char* compressionMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "optional";
  ...
  static SBE_CONSTEXPR std::uint16_t compressionId() SBE_NOEXCEPT { return 4; }

  SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t compressionSinceVersion()
      SBE_NOEXCEPT {
    return 0;
  }

  SBE_NODISCARD bool compressionInActingVersion() SBE_NOEXCEPT { return true; }

  SBE_NODISCARD static SBE_CONSTEXPR std::size_t compressionEncodingOffset()
      SBE_NOEXCEPT {
    return 9;
  }
 ...
 private:
  void onCompressionAccessed() const {
    if (codecState() == CodecState::NOT_WRAPPED) {
      throw AccessOrderError(
          std::string("Illegal field access order. ") +
          "Cannot access field \"compression\" in state: " +
          codecStateName(codecState()) +
          ". Expected one of these transitions: [" +
          codecStateTransitions(codecState()) +
          "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  SBE_NODISCARD static SBE_CONSTEXPR std::size_t compressionEncodingLength()
      SBE_NOEXCEPT {
    return 1;
  }
  ...
  RequestRpcMetadataOptional& compression(
      const CompressionAlgorithm::Value value) {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
    onCompressionAccessed();
#endif
    std::uint8_t val = (value);
  ...
  SBE_NODISCARD static const char* compressionConfigMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "optional";
  ...
  compressionConfigSinceVersion() SBE_NOEXCEPT {
    return 0;
  }
  ...
  compressionConfigEncodingOffset() SBE_NOEXCEPT {
    return 10;
  }
 ...
 private:
  void onCompressionConfigAccessed() const {
    if (codecState() == CodecState::NOT_WRAPPED) {
      throw AccessOrderError(
          std::string("Illegal field access order. ") +
          "Cannot access field \"compressionConfig\" in state: " +
          codecStateName(codecState()) +
          ". Expected one of these transitions: [" +
          codecStateTransitions(codecState()) +
          "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
...
#endif
    m_compressionConfig.wrap(
        m_buffer, m_offset + 10, m_actingVersion, m_bufferLength);
    return m_compressionConfig;
  }

  SBE_NODISCARD static const char* fdMetadataMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "optional";
  ...
  static SBE_CONSTEXPR std::uint16_t fdMetadataId() SBE_NOEXCEPT { return 6; }

  SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t fdMetadataSinceVersion()
      SBE_NOEXCEPT {
    return 0;
  }

  SBE_NODISCARD bool fdMetadataInActingVersion() SBE_NOEXCEPT { return true; }

  SBE_NODISCARD static SBE_CONSTEXPR std::size_t fdMetadataEncodingOffset()
      SBE_NOEXCEPT {
    return 19;
  }
 ...
 private:
  void onFdMetadataAccessed() const {
    if (codecState() == CodecState::NOT_WRAPPED) {
      throw AccessOrderError(
          std::string("Illegal field access order. ") +
          "Cannot access field \"fdMetadata\" in state: " +
          codecStateName(codecState()) +
          ". Expected one of these transitions: [" +
          codecStateTransitions(codecState()) +
          "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  ...
  SBE_NODISCARD static const char* loadMetricMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "required";
  ...
  bool loadMetricInActingVersion() SBE_NOEXCEPT { return true; }

  static SBE_CONSTEXPR std::uint16_t loadMetricId() SBE_NOEXCEPT { return 7; }
  ...
  void onLoadMetricLengthAccessed() const {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot decode length of var data \"loadMetric\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
  ...
  void onLoadMetricAccessed() {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot access field \"loadMetric\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  ...
  RequestRpcMetadataOptional& putLoadMetric(
  ...
  SBE_NODISCARD static const char* tenantIdMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "required";
  ...
  bool tenantIdInActingVersion() SBE_NOEXCEPT { return true; }

  static SBE_CONSTEXPR std::uint16_t tenantIdId() SBE_NOEXCEPT { return 8; }
  ...
  void onTenantIdLengthAccessed() const {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot decode length of var data \"tenantId\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
  ...
  void onTenantIdAccessed() {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot access field \"tenantId\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  ...
  RequestRpcMetadataOptional& putTenantId(
      const char* src, const std::uint32_t length) {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
    onTenantIdAccessed();
#endif
  ...
  SBE_NODISCARD static const char* serviceTraceMetaMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "required";
  ...
  static SBE_CONSTEXPR std::uint64_t serviceTraceMetaSinceVersion()
      SBE_NOEXCEPT {
    return 0;
  }

  bool serviceTraceMetaInActingVersion() SBE_NOEXCEPT { return true; }

  static SBE_CONSTEXPR std::uint16_t serviceTraceMetaId() SBE_NOEXCEPT {
    return 9;
  }

  static SBE_CONSTEXPR std::uint64_t serviceTraceMetaHeaderLength()
      SBE_NOEXCEPT {
    return 4;
  }
  ...
  void onServiceTraceMetaLengthAccessed() const {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot decode length of var data \"serviceTraceMeta\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
  ...
  void onServiceTraceMetaAccessed() {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot access field \"serviceTraceMeta\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  ...
  RequestRpcMetadataOptional& putServiceTraceMeta(
      const char* src, const std::uint32_t length) {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
    onServiceTraceMetaAccessed();
#endif
  ...
  SBE_NODISCARD static const char* loggingContextMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "required";
  ...
  bool loggingContextInActingVersion() SBE_NOEXCEPT { return true; }
  ...
  void onLoggingContextLengthAccessed() const {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot decode length of var data \"loggingContext\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
  ...
  void onLoggingContextAccessed() {
    switch (codecState()) {
      ...
      default:
        throw AccessOrderError(
            std::string("Illegal field access order. ") +
            "Cannot access field \"loggingContext\" in state: " +
            codecStateName(codecState()) +
            ". Expected one of these transitions: [" +
            codecStateTransitions(codecState()) +
            "]. Please see the diagram in the docs of the enum RequestRpcMetadataOptional::CodecState.");
 ...
 public:
  ...
  RequestRpcMetadataOptional& putLoggingContext(
      const char* src, const std::uint32_t length) {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
    onLoggingContextAccessed();
#endif
  ...
  friend std::basic_ostream<CharT, Traits>& operator<<(
      ...
      const RequestRpcMetadataOptional& _writer) {
    ...
    builder << '"' << writer.skipLoadMetric() << " bytes of raw data\"";
    builder << ", ";
    builder << R"("tenantId": )";
    builder << '"' << writer.getTenantIdAsJsonEscapedString().c_str() << '"';

    builder << ", ";
    builder << R"("serviceTraceMeta": )";
    builder << '"' << writer.getServiceTraceMetaAsJsonEscapedString().c_str()
            << '"';

    builder << ", ";
    builder << R"("loggingContext": )";
    builder << '"' << writer.skipLoggingContext() << " bytes of raw data\"";
    builder << '}';
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    if (loadMetricLength > 1073741824LL) {
      throw std::runtime_error(
          "loadMetricLength too long for length type [E109]");
    }
    ...
    if (tenantIdLength > 1073741824LL) {
      throw std::runtime_error(
          "tenantIdLength too long for length type [E109]");
    }
    ...
    if (serviceTraceMetaLength > 1073741824LL) {
      throw std::runtime_error(
          "serviceTraceMetaLength too long for length type [E109]");
    }
    ...
    if (loggingContextLength > 1073741824LL) {
      throw std::runtime_error(
          "loggingContextLength too long for length type [E109]");
    }
