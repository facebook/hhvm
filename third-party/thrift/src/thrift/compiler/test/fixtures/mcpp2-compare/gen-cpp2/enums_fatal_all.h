...
#include "thrift/compiler/test/fixtures/mcpp2-compare/gen-cpp2/enums_fatal_constant.h"
#include "thrift/compiler/test/fixtures/mcpp2-compare/gen-cpp2/enums_fatal_service.h"
