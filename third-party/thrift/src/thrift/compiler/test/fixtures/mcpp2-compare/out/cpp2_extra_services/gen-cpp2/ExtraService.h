...
#endif
  virtual void async_tm_simple_function(apache::thrift::HandlerCallback<bool>::Ptr callback);
  virtual void async_eb_throws_function(apache::thrift::HandlerCallback<void>::Ptr callback);
...
#endif
  virtual void async_tm_throws_function2(apache::thrift::HandlerCallback<bool>::Ptr callback, bool p_param1);
...
#endif
  virtual void async_tm_throws_function3(apache::thrift::HandlerCallback<::std::map<::std::int32_t, ::std::string>>::Ptr callback, bool p_param1, const ::std::string& p_param2);
