...
class Internship(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.Internship: ...
...
class Range(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.Range: ...
...
class struct1(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.struct1: ...
...
class struct2(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.struct2: ...
...
class struct3(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.struct3: ...
...
class struct4(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.struct4: ...
...
class union1(thrift.py3.types.Union, _typing.Hashable):
    ...
    type: _typing.Final[union1.Type]
    value: _typing.Final[_union1ValueType]
    def get_type(self) -> union1.Type: ...

    def _to_python(self) -> module.thrift_types.union1: ...
...
class union2(thrift.py3.types.Union, _typing.Hashable):
    ...
    type: _typing.Final[union2.Type]
    value: _typing.Final[_union2ValueType]
    def get_type(self) -> union2.Type: ...

    def _to_python(self) -> module.thrift_types.union2: ...
...
_List__CityT = _typing.TypeVar('_List__CityT', bound=_typing.Sequence[City])


class List__City(_typing.Sequence[City], _typing.Hashable):
    def __init__(self, items: _typing.Optional[_typing.Sequence[City]]=None) -> None: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __copy__(self) -> _typing.Sequence[City]: ...
    @_typing.overload
    def __getitem__(self, i: int) -> City: ...
    @_typing.overload
    def __getitem__(self, s: slice) -> _typing.Sequence[City]: ...
    def __add__(self, other: _typing.Sequence[City]) -> 'List__City': ...
    def __radd__(self, other: _typing.Sequence[City]) -> 'List__City': ...
    def __reversed__(self) -> _typing.Iterator[City]: ...
    #pyre-ignore[14]: no idea what pyre is on about
    def __iter__(self) -> _typing.Iterator[City]: ...


class Map__Company_List__City(_typing.Mapping[Company, _typing.Sequence[City]], _typing.Hashable):
    def __init__(self, items: _typing.Optional[_typing.Mapping[Company, _typing.Sequence[City]]]=None) -> None: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __copy__(self) -> _typing.Mapping[Company, _typing.Sequence[City]]: ...
    def __getitem__(self, key: Company) -> _typing.Sequence[City]: ...
    def __iter__(self) -> _typing.Iterator[Company]: ...
...
_List__CompanyT = _typing.TypeVar('_List__CompanyT', bound=_typing.Sequence[Company])


class List__Company(_typing.Sequence[Company], _typing.Hashable):
    def __init__(self, items: _typing.Optional[_typing.Sequence[Company]]=None) -> None: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __copy__(self) -> _typing.Sequence[Company]: ...
    @_typing.overload
    def __getitem__(self, i: int) -> Company: ...
    @_typing.overload
    def __getitem__(self, s: slice) -> _typing.Sequence[Company]: ...
    def __add__(self, other: _typing.Sequence[Company]) -> 'List__Company': ...
    def __radd__(self, other: _typing.Sequence[Company]) -> 'List__Company': ...
    def __reversed__(self) -> _typing.Iterator[Company]: ...
    #pyre-ignore[14]: no idea what pyre is on about
    def __iter__(self) -> _typing.Iterator[Company]: ...
...
class List__Range(_typing.Sequence[Range], _typing.Hashable):
    ...
    def __radd__(self, other: _typing.Sequence[Range]) -> 'List__Range': ...
...
class List__Internship(_typing.Sequence[Internship], _typing.Hashable):
    ...
    def __radd__(self, other: _typing.Sequence[Internship]) -> 'List__Internship': ...
...
my_apps: List__Company = ...
instagram: Internship = ...
partial_const: Internship = ...
cities: List__City = ...
company_locations: Map__Company_List__City = ...
kRanges: List__Range = ...
...
unicode_map: Map__string_string = ...
maxIntDec: int = ...
maxIntOct: int = ...
maxIntHex: int = ...
maxIntBin: int = ...
