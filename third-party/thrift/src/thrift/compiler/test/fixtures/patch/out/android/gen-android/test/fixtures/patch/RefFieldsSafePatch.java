...
public class RefFieldsSafePatch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static RefFieldsSafePatch deserialize(TProtocol iprot) throws TException {
    ...
    RefFieldsSafePatch _that;
    _that = new RefFieldsSafePatch(
      tmp_version
      ,tmp_data
    );
    _that.validate();
