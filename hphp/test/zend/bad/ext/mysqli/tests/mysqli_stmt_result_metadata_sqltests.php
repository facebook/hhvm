<?php
	$test_table_name = 'test_mysqli_stmt_result_metadata_sqltests_table_1'; require('table.inc');
...
?>
<?php
	$test_table_name = 'test_mysqli_stmt_result_metadata_sqltests_table_1'; require_once("clean_table.inc");
?>