...
public class ReadVarInt64Benchmark {
  public static void main(String[] args) throws RunnerException {

    Options opt =
        new OptionsBuilder().include(ReadVarInt64Benchmark.class.getSimpleName()).forks(1).build();
  ...
  @Benchmark
  public int benchmarkRead() {
    buffer.reset();
    return VarIntUtils.readVarInt32(buffer);
  }
}
