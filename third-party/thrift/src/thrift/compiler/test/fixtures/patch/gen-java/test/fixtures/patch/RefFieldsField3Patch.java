...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="RefFieldsField3Patch", builder=RefFieldsField3Patch.Builder.class)
public final class RefFieldsField3Patch implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    ...
    @ThriftConstructor
    protected RefFieldsField3Patch() {
      this.assign = null;
      this.clear = false;
    ...
    public static class Builder {
        ...
        public Builder() { }
        public Builder(RefFieldsField3Patch other) {
    ...
    static {
      ...
      com.facebook.thrift.type.TypeRegistry.add(new com.facebook.thrift.type.Type(
        new com.facebook.thrift.type.UniversalName("test.dev/fixtures/patch/RefFieldsField3Patch"),
        RefFieldsField3Patch.class, RefFieldsField3Patch::read0));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefFieldsField3Patch other = (RefFieldsField3Patch)o;
    ...
    public static com.facebook.thrift.payload.Reader<RefFieldsField3Patch> asReader() {
      return RefFieldsField3Patch::read0;
    }
    
    public static RefFieldsField3Patch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(RefFieldsField3Patch.NAMES_TO_IDS, RefFieldsField3Patch.THRIFT_NAMES_TO_IDS, RefFieldsField3Patch.FIELD_METADATA);
      RefFieldsField3Patch.Builder builder = new RefFieldsField3Patch.Builder();
      while (true) {
    ...
    private static class _RefFieldsField3PatchLazy {
        private static final RefFieldsField3Patch _DEFAULT = new RefFieldsField3Patch.Builder().build();
    }
    
    public static RefFieldsField3Patch defaultInstance() {
        return  _RefFieldsField3PatchLazy._DEFAULT;
    }
}
