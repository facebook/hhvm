...
void FooServiceAsyncProcessor::setUpAndProcess_simple_rpc(
  ...
  processInThread(
      ...
      &FooServiceAsyncProcessor::
          executeRequest_simple_rpc<ProtocolIn_, ProtocolOut_>,
      this);
}

template <typename ProtocolIn_, typename ProtocolOut_>
void FooServiceAsyncProcessor::executeRequest_simple_rpc(
  ...
  apache::thrift::HandlerCallback<void>::DecoratorAfterCallback decoratorCallback{
    ...
    apache::thrift::ServiceHandler<::cpp2::FooService>::fbthrift_invoke_decorator_after_simple_rpc};
 auto callback =
...
/* static */ apache::thrift::SerializedResponse FooServiceAsyncProcessor::return_simple_rpc(
    apache::thrift::ContextStack* ctx) {
  ProtocolOut_ prot;
  ::cpp2::FooService_simple_rpc_presult result;
  return serializeResponse("simple_rpc", &prot, ctx, result);
}

template <class ProtocolIn_, class ProtocolOut_>
void FooServiceAsyncProcessor::throw_wrapped_simple_rpc(
    apache::thrift::ResponseChannelRequest::UniquePtr req,
