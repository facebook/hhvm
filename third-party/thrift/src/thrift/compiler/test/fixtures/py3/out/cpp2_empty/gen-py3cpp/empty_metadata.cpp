...
void ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::NullService>>::gen(::apache::thrift::metadata::ThriftServiceMetadataResponse& response) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    genServiceMetadataResponse<::cpp2::NullService>(response);
    DCHECK_EQ(*response.context()->module()->name(), "empty");
    DCHECK_EQ(*response.context()->service_info()->name(), "empty.NullService");
    return;
  }
