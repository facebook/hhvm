...
def _fbthrift_metadata__struct_Foo():
    return _fbthrift__test__namespace_from_package__module__thrift_metadata.gen_metadata_struct_Foo()

def _fbthrift_get_reflection_module():
    try:
        import importlib
        return importlib.import_module("test.namespace_from_package.module.thrift_reflection")
    except ImportError:
        return None
