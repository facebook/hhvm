...
:::note
The Thrift compiler does not support binary literals currently.
:::
...
```
// Allows the definitions in SearchTypes.thrift to be used here qualified with
// the prefix `SearchTypes.`.
