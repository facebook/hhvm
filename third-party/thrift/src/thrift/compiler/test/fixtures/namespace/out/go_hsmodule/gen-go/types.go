...
func (x *HsFoo) writeField1(p thrift.Encoder) error {  // MyInt
    if err := p.WriteFieldBegin("MyInt", thrift.I64, 1); err != nil {
        return fmt.Errorf("HsFoo write field begin error: %w", err)
    }
    ...
    if err := p.WriteFieldEnd(); err != nil {
        return fmt.Errorf("HsFoo write field end error: %w", err)
    }
    return nil
}
...
func (x *HsFoo) Write(p thrift.Encoder) error {
    if err := p.WriteStructBegin("HsFoo"); err != nil {
        return fmt.Errorf("HsFoo write struct begin error: %w", err)
    }
    ...
    if err := p.WriteFieldStop(); err != nil {
        return fmt.Errorf("HsFoo write field stop error: %w", err)
    }

    if err := p.WriteStructEnd(); err != nil {
        return fmt.Errorf("HsFoo write struct end error: %w", err)
    }
    return nil
}
...
func (x *HsFoo) Read(p thrift.Decoder) error {
    if _, err := p.ReadStructBegin(); err != nil {
        return fmt.Errorf("HsFoo read error: %w", err)
    }

    for {
        fieldName, wireType, id, err := p.ReadFieldBegin()
        if err != nil {
            return fmt.Errorf("HsFoo field %d ('%s') read error: %w", id, fieldName, err)
        }
    ...
    if err := p.ReadStructEnd(); err != nil {
        return fmt.Errorf("HsFoo read struct end error: %w", err)
    }
...
func (x *reqHsTestServiceInit) writeField1(p thrift.Encoder) error {  // Int1
    if err := p.WriteFieldBegin("int1", thrift.I64, 1); err != nil {
        return fmt.Errorf("reqHsTestServiceInit write field begin error: %w", err)
    }
    ...
    if err := p.WriteFieldEnd(); err != nil {
        return fmt.Errorf("reqHsTestServiceInit write field end error: %w", err)
    }
    return nil
}
...
func (x *reqHsTestServiceInit) Write(p thrift.Encoder) error {
    if err := p.WriteStructBegin("reqHsTestServiceInit"); err != nil {
        return fmt.Errorf("reqHsTestServiceInit write struct begin error: %w", err)
    }
    ...
    if err := p.WriteFieldStop(); err != nil {
        return fmt.Errorf("reqHsTestServiceInit write field stop error: %w", err)
    }

    if err := p.WriteStructEnd(); err != nil {
        return fmt.Errorf("reqHsTestServiceInit write struct end error: %w", err)
    }
    return nil
}
...
func (x *reqHsTestServiceInit) Read(p thrift.Decoder) error {
    if _, err := p.ReadStructBegin(); err != nil {
        return fmt.Errorf("reqHsTestServiceInit read error: %w", err)
    }

    for {
        fieldName, wireType, id, err := p.ReadFieldBegin()
        if err != nil {
            return fmt.Errorf("reqHsTestServiceInit field %d ('%s') read error: %w", id, fieldName, err)
        }
    ...
    if err := p.ReadStructEnd(); err != nil {
        return fmt.Errorf("reqHsTestServiceInit read struct end error: %w", err)
    }
...
func (x *respHsTestServiceInit) writeField0(p thrift.Encoder) error {  // Success
    ...
    if err := p.WriteFieldBegin("success", thrift.I64, 0); err != nil {
        return fmt.Errorf("respHsTestServiceInit write field begin error: %w", err)
    }
    ...
    if err := p.WriteFieldEnd(); err != nil {
        return fmt.Errorf("respHsTestServiceInit write field end error: %w", err)
    }
    return nil
}
...
func (x *respHsTestServiceInit) Write(p thrift.Encoder) error {
    if err := p.WriteStructBegin("respHsTestServiceInit"); err != nil {
        return fmt.Errorf("respHsTestServiceInit write struct begin error: %w", err)
    }
    ...
    if err := p.WriteFieldStop(); err != nil {
        return fmt.Errorf("respHsTestServiceInit write field stop error: %w", err)
    }

    if err := p.WriteStructEnd(); err != nil {
        return fmt.Errorf("respHsTestServiceInit write struct end error: %w", err)
    }
    return nil
}
...
func (x *respHsTestServiceInit) Read(p thrift.Decoder) error {
    if _, err := p.ReadStructBegin(); err != nil {
        return fmt.Errorf("respHsTestServiceInit read error: %w", err)
    }

    for {
        fieldName, wireType, id, err := p.ReadFieldBegin()
        if err != nil {
            return fmt.Errorf("respHsTestServiceInit field %d ('%s') read error: %w", id, fieldName, err)
        }
    ...
    if err := p.ReadStructEnd(); err != nil {
        return fmt.Errorf("respHsTestServiceInit read struct end error: %w", err)
    }
