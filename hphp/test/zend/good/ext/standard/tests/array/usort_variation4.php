...
var_dump( usort(&$int_values, fun('cmp_function')) );
var_dump($int_values);
...
echo "\n-- Sorting Octal array --\n";
var_dump( usort(&$octal_values, fun('cmp_function')) );
...
echo "\n-- Sorting Hex array --\n";
var_dump( usort(&$hex_values, fun('cmp_function')) );
var_dump($hex_values);
...
echo "\n-- Sorting Float array --\n";
var_dump( usort(&$float_values, fun('cmp_function')) );
...
echo "\n-- Sorting empty array --\n";
var_dump( usort(&$empty_array, fun('cmp_function')) );
