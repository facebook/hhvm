          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_assign = new HashMap<String,String>(Math.max(0, 2*_map66.size));
              for (int _i67 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_patchPrior = new HashMap<String,StringPatch>(Math.max(0, 2*_map70.size));
              for (int _i71 = 0; 
                   ...
                   ++_i71)
              {
                ...
                _val73 = StringPatch.deserialize(iprot);
                tmp_patchPrior.put(_key72, _val73);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_add = new HashMap<String,String>(Math.max(0, 2*_map74.size));
              for (int _i75 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_patch = new HashMap<String,StringPatch>(Math.max(0, 2*_map78.size));
              for (int _i79 = 0; 
                   ...
                   ++_i79)
              {
                ...
                _val81 = StringPatch.deserialize(iprot);
                tmp_patch.put(_key80, _val81);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<String>(Math.max(0, 2*_set82.size));
              for (int _i83 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_put = new HashMap<String,String>(Math.max(0, 2*_map85.size));
              for (int _i86 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.patchPrior != null) {
      oprot.writeFieldBegin(PATCH_PRIOR_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, StringPatch> _iter90 : this.patchPrior.entrySet())        {
    ...
    if (this.patch != null) {
      oprot.writeFieldBegin(PATCH_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, StringPatch> _iter92 : this.patch.entrySet())        {
