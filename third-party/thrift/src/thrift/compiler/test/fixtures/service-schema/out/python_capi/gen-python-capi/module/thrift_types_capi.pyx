...
cdef api int can_extract__module__CustomException(object __obj) except -1:
...
cdef api object init__module__CustomException(object data):
    return __thrift_types.CustomException._fbthrift_from_internal_data(data)

cdef api int can_extract__module__Result(object __obj) except -1:
    return 1 if isinstance(__obj, __thrift_types.Result) else 0

cdef api object construct__module__Result(int64_t __val):
    return __thrift_types.Result(__val)
