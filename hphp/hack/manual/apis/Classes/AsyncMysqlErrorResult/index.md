...
This class is instantiated when an [` AsyncMysqlException `](/docs/apis/Classes/AsyncMysqlException/) is thrown and
[` AsyncMysqlException::getResult() `](/docs/apis/Classes/AsyncMysqlException/getResult/) is called.
