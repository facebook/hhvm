...
Object co_phpmcc(CArrRef params, bool init /* = true */) {
  return Object(p_phpmcc(NEW(c_phpmcc)())->dynCreate(params, init));
}
Variant c_phpmcc::os_get(const char *s, int64 hash) {
  return c_ObjectData::os_get(s, hash);
}
Variant &c_phpmcc::os_lval(const char *s, int64 hash) {
  return c_ObjectData::os_lval(s, hash);
}
void c_phpmcc::o_get(ArrayElementVec &props) const {
  c_ObjectData::o_get(props);
}
bool c_phpmcc::o_exists(CStrRef s, int64 hash) const {
  return c_ObjectData::o_exists(s, hash);
}
Variant c_phpmcc::o_get(CStrRef s, int64 hash) {
  return c_ObjectData::o_get(s, hash);
}
Variant c_phpmcc::o_set(CStrRef s, int64 hash, CVarRef v,bool forInit /* = false */) {
  return c_ObjectData::o_set(s, hash, v, forInit);
}
Variant &c_phpmcc::o_lval(CStrRef s, int64 hash) {
  return c_ObjectData::o_lval(s, hash);
}
Variant c_phpmcc::os_constant(const char *s) {
  int64 hash = hash_string(s);
  switch (hash & 3) {
    case 2:
      HASH_RETURN(0x4923E849F03135F6LL, q_phpmcc_IPPROTO_TCP, IPPROTO_TCP);
      break;
    case 3:
      HASH_RETURN(0x666DA84AE15B3863LL, q_phpmcc_IPPROTO_UDP, IPPROTO_UDP);
      break;
    default:
      break;
  }
...
ObjectData *c_phpmcc::dynCreate(CArrRef params, bool init /* = true */) {
  if (init) {
    ...
    if (count == 7) return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6)));
    if (count == 8) return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7)));
    if (count == 9) return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8)));
    if (count == 10) return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9)));
    if (count == 11) return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10)));
    if (count == 12) return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11)));
    if (count == 13) return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11), params.rvalAt(12)));
    return (create(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11), params.rvalAt(12), params.rvalAt(13)));
  } else return this;
}
void c_phpmcc::dynConstruct(CArrRef params) {
  int count = params.size();
  if (count <= 1) (t___construct(params.rvalAt(0)));
  if (count == 2) (t___construct(params.rvalAt(0), params.rvalAt(1)));
  if (count == 3) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
  ...
  if (count == 7) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6)));
  if (count == 8) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7)));
  if (count == 9) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8)));
  if (count == 10) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9)));
  if (count == 11) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10)));
  if (count == 12) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11)));
  if (count == 13) (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11), params.rvalAt(12)));
  (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11), params.rvalAt(12), params.rvalAt(13)));
}
void c_phpmcc::destruct() {
  if (!inCtorDtor()) {
    incRefCount();
    try {
      t___destruct();
...
ObjectData *c_phpmcc::cloneImpl() {
  c_phpmcc *obj = NEW(c_phpmcc)();
  cloneSet(obj);
  return obj;
}
void c_phpmcc::cloneSet(c_phpmcc *clone) {
  ObjectData::cloneSet(clone);
}
Variant c_phpmcc::o_invoke(const char *s, CArrRef params, int64 hash, bool fatal) {
  if (hash < 0) hash = hash_string_i(s);
  switch (hash & 127) {
    case 0:
      HASH_GUARD(0x287D45DFC81FC980LL, remove_accesspoint_listener) {
        return (t_remove_accesspoint_listener(params.rvalAt(0), ref(const_cast<Array&>(params).lvalAt(1))));
      }
      break;
    case 1:
      HASH_GUARD(0x46E23E0C0952C501LL, add_serverpool_ex) {
        return (t_add_serverpool_ex(params.rvalAt(0), params.rvalAt(1)));
      }
      break;
    case 2:
      HASH_GUARD(0x0D0D7334CFD39802LL, get_server) {
        return (t_get_server(params.rvalAt(0)));
      }
      break;
    case 3:
      HASH_GUARD(0x31A5F52718109C83LL, add_server_listener) {
        return (t_add_server_listener(params.rvalAt(0), ref(const_cast<Array&>(params).lvalAt(1))));
      }
      break;
    case 4:
      HASH_GUARD(0x4BC1ACE3DA46AE84LL, multi_add) {
        int count = params.size();
        if (count <= 1) return (t_multi_add(params.rvalAt(0)));
        if (count == 2) return (t_multi_add(params.rvalAt(0), params.rvalAt(1)));
        if (count == 3) return (t_multi_add(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        if (count == 4) return (t_multi_add(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
        return (t_multi_add(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)));
      }
      HASH_GUARD(0x2E784EAC5C9A4484LL, add_accesspoint) {
        int count = params.size();
        if (count <= 2) return (t_add_accesspoint(params.rvalAt(0), params.rvalAt(1)));
        if (count == 3) return (t_add_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        return (t_add_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
      }
      break;
    case 7:
      HASH_GUARD(0x243C448A57E7B987LL, serverpool_get_consistent_hashing_enabled) {
        return (t_serverpool_get_consistent_hashing_enabled(params.rvalAt(0)));
      }
      break;
    case 8:
      HASH_GUARD(0x23594ECA012C5588LL, remove_server) {
        int count = params.size();
        if (count <= 1) return (t_remove_server(params.rvalAt(0)), null);
        return (t_remove_server(params.rvalAt(0), params.rvalAt(1)), null);
      }
      break;
    case 11:
      HASH_GUARD(0x15D34462FC79458BLL, add) {
        int count = params.size();
        if (count <= 2) return (t_add(params.rvalAt(0), params.rvalAt(1)));
        if (count == 3) return (t_add(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        if (count == 4) return (t_add(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
        if (count == 5) return (t_add(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)));
        return (t_add(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5)));
      }
      break;
    case 12:
      HASH_GUARD(0x554D125BFDE3D20CLL, stats) {
        int count = params.size();
        if (count <= 0) return (t_stats());
        return (t_stats(params.rvalAt(0)));
      }
      break;
    case 15:
    ...
    case 19:
      ...
      HASH_GUARD(0x0BA3AA7BE2D9CB93LL, incr) {
        int count = params.size();
        if (count <= 1) return (t_incr(params.rvalAt(0)));
        return (t_incr(params.rvalAt(0), params.rvalAt(1)));
      }
      break;
    case 20:
      HASH_GUARD(0x57549DDFB56FAC94LL, remove_server_listener) {
        return (t_remove_server_listener(params.rvalAt(0), ref(const_cast<Array&>(params).lvalAt(1))));
      }
      break;
    case 21:
    ...
    case 33:
      HASH_GUARD(0x399A6427C2185621LL, set) {
        int count = params.size();
        if (count <= 2) return (t_set(params.rvalAt(0), params.rvalAt(1)));
        if (count == 3) return (t_set(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        if (count == 4) return (t_set(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
        if (count == 5) return (t_set(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)));
        return (t_set(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5)));
      }
      HASH_GUARD(0x10E5032E1C4D64A1LL, server_version) {
        return (t_server_version(params.rvalAt(0)));
      }
      break;
    case 35:
      HASH_GUARD(0x634DB670B6CE9023LL, del) {
        return (t_del());
      }
      break;
    case 39:
      HASH_GUARD(0x084E3295EBC0FC27LL, server_flush) {
        int count = params.size();
        if (count <= 1) return (t_server_flush(params.rvalAt(0)));
        return (t_server_flush(params.rvalAt(0), params.rvalAt(1)));
      }
      HASH_GUARD(0x5F169417C7165027LL, server_is_alive) {
        int count = params.size();
        if (count <= 0) return (t_server_is_alive());
        return (t_server_is_alive(params.rvalAt(0)));
      }
      break;
    case 40:
      HASH_GUARD(0x25DCCC35D69AD828LL, get) {
        int count = params.size();
        if (count <= 1) return (t_get(params.rvalAt(0)));
        if (count == 2) return (t_get(params.rvalAt(0), params.rvalAt(1)));
        return (t_get(params.rvalAt(0), params.rvalAt(1), ref(const_cast<Array&>(params).lvalAt(2))));
      }
      break;
    case 42:
      HASH_GUARD(0x4517BD70AECCB02ALL, get_accesspoints) {
        return (t_get_accesspoints(params.rvalAt(0)));
      }
      break;
    case 48:
      HASH_GUARD(0x1EE2831BCAC937B0LL, get_multi) {
        int count = params.size();
        if (count <= 1) return (t_get_multi(params.rvalAt(0)));
        if (count == 2) return (t_get_multi(params.rvalAt(0), params.rvalAt(1)));
        return (t_get_multi(params.rvalAt(0), params.rvalAt(1), ref(const_cast<Array&>(params).lvalAt(2))));
      }
      break;
    case 54:
      HASH_GUARD(0x311E08562CC0B336LL, add_mirror_accesspoint) {
        int count = params.size();
        if (count <= 3) return (t_add_mirror_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        if (count == 4) return (t_add_mirror_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
        return (t_add_mirror_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)));
      }
      break;
    case 57:
      HASH_GUARD(0x7227812505D83939LL, delete_details) {
        int count = params.size();
        if (count <= 1) return (t_delete_details(params.rvalAt(0)));
        return (t_delete_details(params.rvalAt(0), params.rvalAt(1)));
      }
      break;
    case 58:
      HASH_GUARD(0x31C0C13D01B3DBBALL, get_host) {
        return (t_get_host(params.rvalAt(0)));
      }
      HASH_GUARD(0x6AD9AC8BCC019E3ALL, serverpool_get_servers) {
        return (t_serverpool_get_servers(params.rvalAt(0)));
      }
      break;
    case 60:
      HASH_GUARD(0x256203B2C8626F3CLL, get_serverpool_by_key) {
        return (t_get_serverpool_by_key(params.rvalAt(0)));
      }
      break;
    case 64:
      HASH_GUARD(0x133C228C5F60F640LL, remove_error_listener) {
        return (t_remove_error_listener(params.rvalAt(0), ref(const_cast<Array&>(params).lvalAt(1))));
      }
      break;
    case 65:
      HASH_GUARD(0x78AE97BFBEBF5341LL, close) {
      ...
      break;
    case 68:
      HASH_GUARD(0x3BE70632874CEB44LL, add_mirror) {
        return (t_add_mirror(params.rvalAt(0), params.rvalAt(1)));
      }
      break;
    case 70:
      HASH_GUARD(0x42FAC655280A6146LL, replace) {
        int count = params.size();
        if (count <= 2) return (t_replace(params.rvalAt(0), params.rvalAt(1)));
        if (count == 3) return (t_replace(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        if (count == 4) return (t_replace(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
        if (count == 5) return (t_replace(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)));
        return (t_replace(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5)));
      }
      break;
    case 74:
      HASH_GUARD(0x25591D582B52EC4ALL, add_error_listener) {
        return (t_add_error_listener(params.rvalAt(0), ref(const_cast<Array&>(params).lvalAt(1))));
      }
      break;
    case 77:
      HASH_GUARD(0x171F238AA93B8F4DLL, remove_mirror) {
        return (t_remove_mirror(params.rvalAt(0)));
      }
      break;
    case 83:
      HASH_GUARD(0x1C660E5BFA6F55D3LL, delete) {
        int count = params.size();
        if (count <= 1) return (t_delete(params.rvalAt(0)));
        return (t_delete(params.rvalAt(0), params.rvalAt(1)));
      }
      break;
    case 85:
      HASH_GUARD(0x7F36B59A84C6F855LL, get_server_by_key) {
        return (t_get_server_by_key(params.rvalAt(0)));
      }
      break;
    case 91:
      HASH_GUARD(0x62353414DB69A2DBLL, test_proxy) {
        int count = params.size();
        if (count <= 0) return (t_test_proxy());
        return (t_test_proxy(params.rvalAt(0)));
      }
      break;
    case 95:
      HASH_GUARD(0x0D31D0AC229C615FLL, __construct) {
        ...
        if (count == 7) return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6)), null);
        if (count == 8) return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7)), null);
        if (count == 9) return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8)), null);
        if (count == 10) return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9)), null);
        if (count == 11) return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10)), null);
        if (count == 12) return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11)), null);
        if (count == 13) return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11), params.rvalAt(12)), null);
        return (t___construct(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4), params.rvalAt(5), params.rvalAt(6), params.rvalAt(7), params.rvalAt(8), params.rvalAt(9), params.rvalAt(10), params.rvalAt(11), params.rvalAt(12), params.rvalAt(13)), null);
      }
      HASH_GUARD(0x2575F1DA69AC775FLL, add_serverpool) {
        int count = params.size();
        if (count <= 1) return (t_add_serverpool(params.rvalAt(0)));
        return (t_add_serverpool(params.rvalAt(0), params.rvalAt(1)));
      }
      break;
    case 97:
      HASH_GUARD(0x0137D510C62DC561LL, decr) {
        int count = params.size();
        if (count <= 1) return (t_decr(params.rvalAt(0)));
        return (t_decr(params.rvalAt(0), params.rvalAt(1)));
      }
      break;
    case 104:
      HASH_GUARD(0x2DCA0F568B108368LL, remove_mirror_accesspoint) {
        int count = params.size();
        if (count <= 3) return (t_remove_mirror_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)), null);
        if (count == 4) return (t_remove_mirror_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)), null);
        return (t_remove_mirror_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)), null);
      }
      break;
    case 105:
      HASH_GUARD(0x52078303E3BC24E9LL, serverpool_add_server) {
        int count = params.size();
        if (count <= 2) return (t_serverpool_add_server(params.rvalAt(0), params.rvalAt(1)));
        return (t_serverpool_add_server(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
      }
      break;
    case 107:
      HASH_GUARD(0x6C6ECF5DBDCDA56BLL, serverpool_remove_server) {
        int count = params.size();
        if (count <= 2) return (t_serverpool_remove_server(params.rvalAt(0), params.rvalAt(1)));
        return (t_serverpool_remove_server(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
      }
      break;
    case 115:
      HASH_GUARD(0x7F974836AACC1EF3LL, __destruct) {
      ...
      break;
    case 116:
      HASH_GUARD(0x25362C52A06A7DF4LL, remove_serverpool) {
        return (t_remove_serverpool(params.rvalAt(0)), null);
      }
      HASH_GUARD(0x41DED45DAB6EA0F4LL, multi_set) {
        int count = params.size();
        if (count <= 1) return (t_multi_set(params.rvalAt(0)));
        if (count == 2) return (t_multi_set(params.rvalAt(0), params.rvalAt(1)));
        if (count == 3) return (t_multi_set(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        if (count == 4) return (t_multi_set(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
        return (t_multi_set(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)));
      }
      break;
    case 117:
      HASH_GUARD(0x1959BC64791572F5LL, add_server) {
        int count = params.size();
        if (count <= 1) return (t_add_server(params.rvalAt(0)));
        return (t_add_server(params.rvalAt(0), params.rvalAt(1)));
      }
      HASH_GUARD(0x17BE282CC008CE75LL, serverpool_get_consistent_hashing_version) {
        return (t_serverpool_get_consistent_hashing_version(params.rvalAt(0)));
      }
      break;
    case 118:
      HASH_GUARD(0x59A033953F63DBF6LL, add_accesspoint_listener) {
        return (t_add_accesspoint_listener(params.rvalAt(0), ref(const_cast<Array&>(params).lvalAt(1))));
      }
      break;
    case 122:
      HASH_GUARD(0x0D41BFBA13C4317ALL, multi_replace) {
        int count = params.size();
        if (count <= 1) return (t_multi_replace(params.rvalAt(0)));
        if (count == 2) return (t_multi_replace(params.rvalAt(0), params.rvalAt(1)));
        if (count == 3) return (t_multi_replace(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)));
        if (count == 4) return (t_multi_replace(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)));
        return (t_multi_replace(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3), params.rvalAt(4)));
      }
      break;
    case 124:
      HASH_GUARD(0x4F2C2C1CCF05AB7CLL, remove_accesspoint) {
        int count = params.size();
        if (count <= 2) return (t_remove_accesspoint(params.rvalAt(0), params.rvalAt(1)), null);
        if (count == 3) return (t_remove_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2)), null);
        return (t_remove_accesspoint(params.rvalAt(0), params.rvalAt(1), params.rvalAt(2), params.rvalAt(3)), null);
      }
      break;
    default:
      break;
...
Variant c_phpmcc::o_invoke_few_args(const char *s, int64 hash, int count, CVarRef a0, CVarRef a1, CVarRef a2, CVarRef a3, CVarRef a4, CVarRef a5) {
  if (hash < 0) hash = hash_string_i(s);
  switch (hash & 127) {
    case 0:
      HASH_GUARD(0x287D45DFC81FC980LL, remove_accesspoint_listener) {
        return (t_remove_accesspoint_listener(a0, ref(a1)));
      }
      break;
    case 1:
      HASH_GUARD(0x46E23E0C0952C501LL, add_serverpool_ex) {
        return (t_add_serverpool_ex(a0, a1));
      }
      break;
    case 2:
      HASH_GUARD(0x0D0D7334CFD39802LL, get_server) {
        return (t_get_server(a0));
      }
      break;
    case 3:
      HASH_GUARD(0x31A5F52718109C83LL, add_server_listener) {
        return (t_add_server_listener(a0, ref(a1)));
      }
      break;
    case 4:
      HASH_GUARD(0x4BC1ACE3DA46AE84LL, multi_add) {
        if (count <= 1) return (t_multi_add(a0));
        if (count == 2) return (t_multi_add(a0, a1));
        if (count == 3) return (t_multi_add(a0, a1, a2));
        if (count == 4) return (t_multi_add(a0, a1, a2, a3));
        return (t_multi_add(a0, a1, a2, a3, a4));
      }
      HASH_GUARD(0x2E784EAC5C9A4484LL, add_accesspoint) {
        if (count <= 2) return (t_add_accesspoint(a0, a1));
        if (count == 3) return (t_add_accesspoint(a0, a1, a2));
        return (t_add_accesspoint(a0, a1, a2, a3));
      }
      break;
    case 7:
      HASH_GUARD(0x243C448A57E7B987LL, serverpool_get_consistent_hashing_enabled) {
        return (t_serverpool_get_consistent_hashing_enabled(a0));
      }
      break;
    case 8:
      HASH_GUARD(0x23594ECA012C5588LL, remove_server) {
        if (count <= 1) return (t_remove_server(a0), null);
        return (t_remove_server(a0, a1), null);
      }
      break;
    case 11:
      HASH_GUARD(0x15D34462FC79458BLL, add) {
        ...
        if (count == 4) return (t_add(a0, a1, a2, a3));
        if (count == 5) return (t_add(a0, a1, a2, a3, a4));
        return (t_add(a0, a1, a2, a3, a4, a5));
      }
      break;
    case 12:
      HASH_GUARD(0x554D125BFDE3D20CLL, stats) {
    ...
    case 19:
      ...
      HASH_GUARD(0x0BA3AA7BE2D9CB93LL, incr) {
        if (count <= 1) return (t_incr(a0));
        return (t_incr(a0, a1));
      }
      break;
    case 20:
      HASH_GUARD(0x57549DDFB56FAC94LL, remove_server_listener) {
        return (t_remove_server_listener(a0, ref(a1)));
      }
      break;
    case 21:
      HASH_GUARD(0x52F3DAD783340395LL, __set) {
    ...
    case 33:
      HASH_GUARD(0x399A6427C2185621LL, set) {
        ...
        if (count == 4) return (t_set(a0, a1, a2, a3));
        if (count == 5) return (t_set(a0, a1, a2, a3, a4));
        return (t_set(a0, a1, a2, a3, a4, a5));
      }
      HASH_GUARD(0x10E5032E1C4D64A1LL, server_version) {
        return (t_server_version(a0));
      }
      break;
    case 35:
      HASH_GUARD(0x634DB670B6CE9023LL, del) {
    ...
    case 39:
      HASH_GUARD(0x084E3295EBC0FC27LL, server_flush) {
        if (count <= 1) return (t_server_flush(a0));
        return (t_server_flush(a0, a1));
      }
      HASH_GUARD(0x5F169417C7165027LL, server_is_alive) {
        if (count <= 0) return (t_server_is_alive());
        return (t_server_is_alive(a0));
      }
      break;
    case 40:
      HASH_GUARD(0x25DCCC35D69AD828LL, get) {
        if (count <= 1) return (t_get(a0));
        if (count == 2) return (t_get(a0, a1));
        return (t_get(a0, a1, ref(a2)));
      }
      break;
    case 42:
      HASH_GUARD(0x4517BD70AECCB02ALL, get_accesspoints) {
        return (t_get_accesspoints(a0));
      }
      break;
    case 48:
      HASH_GUARD(0x1EE2831BCAC937B0LL, get_multi) {
        if (count <= 1) return (t_get_multi(a0));
        if (count == 2) return (t_get_multi(a0, a1));
        return (t_get_multi(a0, a1, ref(a2)));
      }
      break;
    case 54:
      HASH_GUARD(0x311E08562CC0B336LL, add_mirror_accesspoint) {
        if (count <= 3) return (t_add_mirror_accesspoint(a0, a1, a2));
        if (count == 4) return (t_add_mirror_accesspoint(a0, a1, a2, a3));
        return (t_add_mirror_accesspoint(a0, a1, a2, a3, a4));
      }
      break;
    case 57:
      HASH_GUARD(0x7227812505D83939LL, delete_details) {
        if (count <= 1) return (t_delete_details(a0));
        return (t_delete_details(a0, a1));
      }
      break;
    case 58:
      HASH_GUARD(0x31C0C13D01B3DBBALL, get_host) {
        return (t_get_host(a0));
      }
      HASH_GUARD(0x6AD9AC8BCC019E3ALL, serverpool_get_servers) {
        return (t_serverpool_get_servers(a0));
      }
      break;
    case 60:
      HASH_GUARD(0x256203B2C8626F3CLL, get_serverpool_by_key) {
        return (t_get_serverpool_by_key(a0));
      }
      break;
    case 64:
      HASH_GUARD(0x133C228C5F60F640LL, remove_error_listener) {
        return (t_remove_error_listener(a0, ref(a1)));
      }
      break;
    case 65:
      HASH_GUARD(0x78AE97BFBEBF5341LL, close) {
    ...
    case 70:
      HASH_GUARD(0x42FAC655280A6146LL, replace) {
        ...
        if (count == 4) return (t_replace(a0, a1, a2, a3));
        if (count == 5) return (t_replace(a0, a1, a2, a3, a4));
        return (t_replace(a0, a1, a2, a3, a4, a5));
      }
      break;
    case 74:
      HASH_GUARD(0x25591D582B52EC4ALL, add_error_listener) {
        return (t_add_error_listener(a0, ref(a1)));
      }
      break;
    case 77:
      HASH_GUARD(0x171F238AA93B8F4DLL, remove_mirror) {
        return (t_remove_mirror(a0));
      }
      break;
    case 83:
      HASH_GUARD(0x1C660E5BFA6F55D3LL, delete) {
    ...
    case 85:
      HASH_GUARD(0x7F36B59A84C6F855LL, get_server_by_key) {
        return (t_get_server_by_key(a0));
      }
      break;
    case 91:
      HASH_GUARD(0x62353414DB69A2DBLL, test_proxy) {
        if (count <= 0) return (t_test_proxy());
        return (t_test_proxy(a0));
      }
      break;
    case 95:
      HASH_GUARD(0x0D31D0AC229C615FLL, __construct) {
      ...
      HASH_GUARD(0x2575F1DA69AC775FLL, add_serverpool) {
        if (count <= 1) return (t_add_serverpool(a0));
        return (t_add_serverpool(a0, a1));
      }
      break;
    case 97:
      HASH_GUARD(0x0137D510C62DC561LL, decr) {
        if (count <= 1) return (t_decr(a0));
        return (t_decr(a0, a1));
      }
      break;
    case 104:
      HASH_GUARD(0x2DCA0F568B108368LL, remove_mirror_accesspoint) {
        if (count <= 3) return (t_remove_mirror_accesspoint(a0, a1, a2), null);
        if (count == 4) return (t_remove_mirror_accesspoint(a0, a1, a2, a3), null);
        return (t_remove_mirror_accesspoint(a0, a1, a2, a3, a4), null);
      }
      break;
    case 105:
      HASH_GUARD(0x52078303E3BC24E9LL, serverpool_add_server) {
        if (count <= 2) return (t_serverpool_add_server(a0, a1));
        return (t_serverpool_add_server(a0, a1, a2));
      }
      break;
    case 107:
      HASH_GUARD(0x6C6ECF5DBDCDA56BLL, serverpool_remove_server) {
        if (count <= 2) return (t_serverpool_remove_server(a0, a1));
        return (t_serverpool_remove_server(a0, a1, a2));
      }
      break;
    case 115:
      HASH_GUARD(0x7F974836AACC1EF3LL, __destruct) {
    ...
    case 116:
      HASH_GUARD(0x25362C52A06A7DF4LL, remove_serverpool) {
        return (t_remove_serverpool(a0), null);
      }
      HASH_GUARD(0x41DED45DAB6EA0F4LL, multi_set) {
        if (count <= 1) return (t_multi_set(a0));
        if (count == 2) return (t_multi_set(a0, a1));
        if (count == 3) return (t_multi_set(a0, a1, a2));
        if (count == 4) return (t_multi_set(a0, a1, a2, a3));
        return (t_multi_set(a0, a1, a2, a3, a4));
      }
      break;
    case 117:
      HASH_GUARD(0x1959BC64791572F5LL, add_server) {
        if (count <= 1) return (t_add_server(a0));
        return (t_add_server(a0, a1));
      }
      HASH_GUARD(0x17BE282CC008CE75LL, serverpool_get_consistent_hashing_version) {
        return (t_serverpool_get_consistent_hashing_version(a0));
      }
      break;
    case 118:
      HASH_GUARD(0x59A033953F63DBF6LL, add_accesspoint_listener) {
        return (t_add_accesspoint_listener(a0, ref(a1)));
      }
      break;
    case 122:
      HASH_GUARD(0x0D41BFBA13C4317ALL, multi_replace) {
        if (count <= 1) return (t_multi_replace(a0));
        if (count == 2) return (t_multi_replace(a0, a1));
        if (count == 3) return (t_multi_replace(a0, a1, a2));
        if (count == 4) return (t_multi_replace(a0, a1, a2, a3));
        return (t_multi_replace(a0, a1, a2, a3, a4));
      }
      break;
    case 124:
      HASH_GUARD(0x4F2C2C1CCF05AB7CLL, remove_accesspoint) {
        if (count <= 2) return (t_remove_accesspoint(a0, a1), null);
        if (count == 3) return (t_remove_accesspoint(a0, a1, a2), null);
        return (t_remove_accesspoint(a0, a1, a2, a3), null);
      }
      break;
    default:
      break;
...
Variant c_phpmcc::os_invoke(const char *c, const char *s, CArrRef params, int64 hash, bool fatal) {
  return c_ObjectData::os_invoke(c, s, params, hash, fatal);
}
Variant c_phpmcc::o_invoke_from_eval(const char *s, Eval::VariableEnvironment &env, const Eval::FunctionCallExpression *caller, int64 hash, bool fatal) {
  if (hash < 0) hash = hash_string_i(s);
  switch (hash & 127) {
    case 0:
      HASH_GUARD(0x287D45DFC81FC980LL, remove_accesspoint_listener) {
    ...
    case 95:
      HASH_GUARD(0x0D31D0AC229C615FLL, __construct) {
        ...
        if (count == 4) return (t___construct(a0, a1, a2, a3), null);
        if (count == 5) return (t___construct(a0, a1, a2, a3, a4), null);
        if (count == 6) return (t___construct(a0, a1, a2, a3, a4, a5), null);
        if (count == 7) return (t___construct(a0, a1, a2, a3, a4, a5, a6), null);
        if (count == 8) return (t___construct(a0, a1, a2, a3, a4, a5, a6, a7), null);
        if (count == 9) return (t___construct(a0, a1, a2, a3, a4, a5, a6, a7, a8), null);
        if (count == 10) return (t___construct(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9), null);
        if (count == 11) return (t___construct(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10), null);
        if (count == 12) return (t___construct(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11), null);
        if (count == 13) return (t___construct(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12), null);
        return (t___construct(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13), null);
      }
      HASH_GUARD(0x2575F1DA69AC775FLL, add_serverpool) {
        Variant a0;
        Variant a1;
...
Variant c_phpmcc::os_invoke_from_eval(const char *c, const char *s, Eval::VariableEnvironment &env, const Eval::FunctionCallExpression *caller, int64 hash, bool fatal) {
  return c_ObjectData::os_invoke_from_eval(c, s, env, caller, hash, fatal);
}
Variant cw_phpmcc$os_get(const char *s) {
  return c_phpmcc::os_get(s, -1);
}
Variant &cw_phpmcc$os_lval(const char *s) {
  return c_phpmcc::os_lval(s, -1);
}
Variant cw_phpmcc$os_constant(const char *s) {
  return c_phpmcc::os_constant(s);
}
Variant cw_phpmcc$os_invoke(const char *c, const char *s, CArrRef params, bool fatal /* = true */) {
  return c_phpmcc::os_invoke(c, s, params, -1, fatal);
}
