...
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::Foo>::fields_names = {{
  "bar",
}};
THRIFT_DATA_SECTION const std::array<int16_t, 1> TStructDataStorage<::cpp2::Foo>::fields_ids = {{
  1,
}};
THRIFT_DATA_SECTION const std::array<protocol::TType, 1> TStructDataStorage<::cpp2::Foo>::fields_types = {{
  TType::T_I32,
}};
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::Foo>::storage_names = {{
  "__fbthrift_field_bar",
}};
THRIFT_DATA_SECTION const std::array<int, 1> TStructDataStorage<::cpp2::Foo>::isset_indexes = {{
  -1,
}};
