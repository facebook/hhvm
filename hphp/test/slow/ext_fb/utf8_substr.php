...
var_dump(fb_utf8_substr("hon\xE7k", 0, PHP_INT_MAX));
var_dump(fb_utf8_substr("hon\xE7k", 0, 3));
var_dump(fb_utf8_substr("hon\xE7k", -4, PHP_INT_MAX));

// Common cases
var_dump(fb_utf8_substr("X", 0, 1));
var_dump(fb_utf8_substr("Hello", 0, PHP_INT_MAX));
var_dump(fb_utf8_substr("Hello", 1, 2));
var_dump(fb_utf8_substr("Pr\u00DC\u00DDx", 2, 2));

// Negative start
var_dump(fb_utf8_substr("abcdef", -1, PHP_INT_MAX));
var_dump(fb_utf8_substr("abcdef", -2, PHP_INT_MAX));
