...
public class LoopSafePatch implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("LoopSafePatch");
   ...
   */
  public LoopSafePatch(LoopSafePatch other) {
  ...
  public LoopSafePatch deepCopy() {
    return new LoopSafePatch(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof LoopSafePatch))
      return false;
    LoopSafePatch that = (LoopSafePatch)_that;
  ...
  public static LoopSafePatch deserialize(TProtocol iprot) throws TException {
