...
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
  ...
  if (CCACHE_FOUND AND ENABLE_CCACHE)
    ...
    message(STATUS "using ${CMAKE_CXX_COMPILER_ARG1_stripped} to detect g++ version: ${GCXX_VERSION}")
  else()
    execute_process(COMMAND ${CMAKE_CXX_COMPILER} -dumpversion OUTPUT_VARIABLE GCC_VERSION)
    message(STATUS "using CMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} to detect g++ version: ${GCXX_VERSION}")
  endif()
