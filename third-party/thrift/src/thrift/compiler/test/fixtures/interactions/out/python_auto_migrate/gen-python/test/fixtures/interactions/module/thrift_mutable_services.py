...
class MyInteractionInterface(
    ...
    def _fbthrift__stream_wrapper_truthify(self, stream_generator: _typing.AsyncIterator[builtins.bool], protocol: Protocol) -> _typing.AsyncIterator[_fbthrift_iobuf.IOBuf]:
        return CloseableGenerator(
            stream_generator,
            protocol,
            _fbthrift__test__fixtures__interactions__module__thrift_mutable_types._fbthrift_MyInteraction_truthify_result_stream_elem,
            (),
        )
    ...
    async def _fbthrift__handler_truthify(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _typing.Tuple[_fbthrift_iobuf.IOBuf, _typing.AsyncIterator[_fbthrift_iobuf.IOBuf]]:
        args_struct = deserialize(_fbthrift__test__fixtures__interactions__module__thrift_mutable_types._fbthrift_MyInteraction_truthify_args, args, protocol)
        value = self.truthify()
        stream = value
        if not isinstance(stream, _typing.AsyncIterator):
            stream = await stream
        return_struct = _fbthrift__test__fixtures__interactions__module__thrift_mutable_types._fbthrift_MyInteraction_truthify_result()
...
class MyInteractionFastInterface(
    ...
    def _fbthrift__stream_wrapper_truthify(self, stream_generator: _typing.AsyncIterator[builtins.bool], protocol: Protocol) -> _typing.AsyncIterator[_fbthrift_iobuf.IOBuf]:
        return CloseableGenerator(
            stream_generator,
            protocol,
            _fbthrift__test__fixtures__interactions__module__thrift_mutable_types._fbthrift_MyInteractionFast_truthify_result_stream_elem,
            (),
        )

    async def _fbthrift__handler_truthify(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _typing.Tuple[_fbthrift_iobuf.IOBuf, _typing.AsyncIterator[_fbthrift_iobuf.IOBuf]]:
        args_struct = deserialize(_fbthrift__test__fixtures__interactions__module__thrift_mutable_types._fbthrift_MyInteractionFast_truthify_args, args, protocol)
        value = self.truthify()
        stream = value
        if not isinstance(stream, _typing.AsyncIterator):
            stream = await stream
        return_struct = _fbthrift__test__fixtures__interactions__module__thrift_mutable_types._fbthrift_MyInteractionFast_truthify_result()
        return_stream = self._fbthrift__stream_wrapper_truthify(stream, protocol)
        return (serialize_iobuf(return_struct, protocol), return_stream)
...
class BoxServiceInterface(
    ...
    async def getABoxSession(
        ...
        ) -> _typing.Tuple[BoxedInteractionInterface, _fbthrift__test__fixtures__interactions__module__thrift_mutable_types.ShouldBeBoxed]:
