...
template void TccStructTraits<::facebook::thrift::test::fixtures::terse_write::MyStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::terse_write::MyUnion>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::terse_write::MyStructWithCustomDefault>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::terse_write::StructLevelTerseStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::terse_write::FieldLevelTerseStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::terse_write::AdaptedFields>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::terse_write::TerseException>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
std::partial_ordering MyStructWithCustomDefault::operator<=>([[maybe_unused]] const MyStructWithCustomDefault& rhs) const {
  return ::apache::thrift::op::compare<MyStructWithCustomDefault>(*this, rhs);
}
...
std::partial_ordering AdaptedFields::operator<=>([[maybe_unused]] const AdaptedFields& rhs) const {
  return ::apache::thrift::op::compare<AdaptedFields>(*this, rhs);
}
...
std::partial_ordering TerseException::operator<=>([[maybe_unused]] const TerseException& rhs) const {
  return ::apache::thrift::op::compare<TerseException>(*this, rhs);
}
