...
if(${COW} MATCHES "MRB")
  add_definitions(-DCOW_MRB=1)
  message("Using MRB for CoW checks")
elseif(${COW} MATCHES "BLIND")
  add_definitions(-DCOW_BLIND=1)
  message("Using nothing for CoW checks")
else()
  add_definitions(-DCOW_RC=1)
  message("Using RC for CoW checks")
endif()
