...
public class RefFieldsField1Patch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static RefFieldsField1Patch deserialize(TProtocol iprot) throws TException {
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              tmp_assign = new ArrayList<Integer>(Math.max(0, _list288.size));
              for (int _i289 = 0; 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              tmp_prepend = new ArrayList<Integer>(Math.max(0, _list291.size));
              for (int _i292 = 0; 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              tmp_append = new ArrayList<Integer>(Math.max(0, _list294.size));
              for (int _i295 = 0; 
    ...
    RefFieldsField1Patch _that;
    _that = new RefFieldsField1Patch(
      tmp_assign
      ,tmp_clear
      ,tmp_prepend
      ,tmp_append
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.assign != null) {
      if (isSetAssign()) {
        oprot.writeFieldBegin(ASSIGN_FIELD_DESC);
        {
          ...
          for (Integer _iter297 : this.assign)          {
    ...
    if (this.prepend != null) {
      oprot.writeFieldBegin(PREPEND_FIELD_DESC);
      {
        ...
        for (Integer _iter298 : this.prepend)        {
    ...
    if (this.append != null) {
      oprot.writeFieldBegin(APPEND_FIELD_DESC);
      {
        ...
        for (Integer _iter299 : this.append)        {
