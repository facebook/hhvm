...
import test.namespace_from_package_without_module_name.module.thrift_abstract_types
...
class Foo(_fbthrift_python_types.Struct, _fbthrift_compatible_with_Foo, test.namespace_from_package_without_module_name.module.thrift_abstract_types.Foo):
