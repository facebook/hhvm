          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.assign = new HashSet<String>(Math.max(0, 2*_set25.size));
              for (int _i26 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.remove = new HashSet<String>(Math.max(0, 2*_set28.size));
              for (int _i29 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.add = new HashSet<String>(Math.max(0, 2*_set31.size));
              for (int _i32 = 0; 
