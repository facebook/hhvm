<?php
	require('connect.inc');
	$test_table_name = 'test_mysqli_class_mysqli_stmt_interface_table_1'; require('table.inc');
...
if (!$stmt->prepare("INSERT INTO test_mysqli_class_mysqli_stmt_interface_table_1(id, label) VALUES (100, 'z')") ||
!$stmt->execute())
