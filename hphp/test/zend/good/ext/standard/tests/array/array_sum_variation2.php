...
// Int array
$int_values = varray[3, 2, 100, 150, 25, 350, 0, -3, -1200];
echo "-- Sum of Integer array --\n";
var_dump( array_sum($int_values) );

// Octal array
$octal_values = varray[056, 023, 090, 015, -045, 01, -078];
echo "-- Sum of Octal array --\n";
var_dump( array_sum($octal_values) );

// Hexadecimal array
$hex_values = varray[0xAE, 0x2B, 0X10, -0xCF, 0X12, -0XF2];
echo "-- Sum of Hex array --\n";
var_dump( array_sum($hex_values) );

// Mixed values int, octal & hex
$mixed_int_value = varray[2, 5, -1, 054, 0X3E, 0, -014, -0x2A];
