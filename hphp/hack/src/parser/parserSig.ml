  ...
  module WithLexer (Lexer : Lexer_S) = struct
    module type Parser_S = sig
      ...
      module Make : sig
        ...
        val file_attribute_specification :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val namespace_use_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val namespace_group_use_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val namespace_use_clause :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val function_declaration : t -> SC.r -> SC.r -> SC.r -> t * SC.r

        val function_declaration_header :
          t ->
          SC.r ->
          SC.r ->
          SC.r ->
        ...
        val methodish_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val methodish_trait_resolution :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val classish_declaration :
          t ->
          SC.r ->
          SC.r ->
          SC.r ->
        ...
        val trait_use_alias_item :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val trait_use_conflict_resolution :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val const_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val constant_declarator : t -> SC.r -> SC.r -> t * SC.r

        val type_const_declaration :
          t ->
          SC.r ->
          SC.r ->
          SC.r ->
        ...
        val parameter_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val variadic_parameter : t -> SC.r -> SC.r -> SC.r -> t * SC.r

        val old_attribute_specification : t -> SC.r -> SC.r -> SC.r -> t * SC.r

        val attribute_specification : t -> SC.r -> t * SC.r

        val attribute : t -> SC.r -> SC.r -> t * SC.r
        ...
        val using_statement_block_scoped :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val using_statement_function_scoped :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val anonymous_function_use_clause :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val lambda_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val lambda_signature :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val safe_member_selection_expression :
          t -> SC.r -> SC.r -> SC.r -> t * SC.r

        val embedded_member_selection_expression :
          t -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val collection_literal_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val record_creation_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val array_creation_expression : t -> SC.r -> SC.r -> SC.r -> t * SC.r

        val array_intrinsic_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val darray_intrinsic_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val dictionary_intrinsic_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val keyset_intrinsic_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val varray_intrinsic_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val vector_intrinsic_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val element_initializer : t -> SC.r -> SC.r -> SC.r -> t * SC.r

        val subscript_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val embedded_subscript_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val awaitable_creation_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val xhp_children_declaration : t -> SC.r -> SC.r -> SC.r -> t * SC.r

        val xhp_children_parenthesized_list :
          t -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val xhp_class_attribute_declaration :
          t -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val vector_type_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val keyset_type_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val tuple_type_explicit_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val varray_type_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val vector_array_type_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val darray_type_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val map_array_type_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val dictionary_type_specifier :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val closure_type_specifier :
          t ->
          SC.r ->
          SC.r ->
          SC.r ->
        ...
        val pocket_identifier_expression :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val pocket_atom_mapping_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val pocket_enum_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val pocket_field_type_expr_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val pocket_field_type_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r

        val pocket_mapping_id_declaration : t -> SC.r -> SC.r -> t * SC.r

        val pocket_mapping_type_declaration :
          t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
      end
    end
  end
