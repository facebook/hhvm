...
class A implements \IThriftSyncStruct, \IThriftStructMetadata, \IThriftShapishSyncStruct {
  ...
  public static function __fromShape(self::TShape $shape)[]: this {
    return new static(
      Shapes::idx($shape, 'a'),
      Shapes::idx($shape, 'map_of_string_to_string') |> $$ === null ? null : ($$ |> new Map($$)),
    );
  }
...
class B implements \IThriftSyncStruct, \IThriftStructMetadata, \IThriftShapishSyncStruct {
  ...
  public static function __fromShape(self::TShape $shape)[]: this {
    return new static(
      Shapes::idx($shape, 'map_of_string_to_string') |> $$ === null ? null : ($$ |> new Map($$)),
      Shapes::idx($shape, 'map_of_string_to_i32') |> $$ === null ? null : ($$ |> new Map($$)),
      ...
      Shapes::idx($shape, 'list_of_string') |> $$ === null ? null : ($$ |> new Vector($$)),
