...
template <> struct TSchemaAssociation<::facebook::thrift::compiler::test::fixtures::any::detail::MyStruct> {
...
template <> struct TSchemaAssociation<::facebook::thrift::compiler::test::fixtures::any::MyUnion> {
  static ::folly::Range<const ::std::string_view*>(*bundle)();
  static constexpr int64_t programId = -5500604698416141242;
  static constexpr ::std::string_view definitionKey = {"\x2a\x25\x68\xcd\xd8\xea\x3b\x40\x52\x2d\xc7\x2f\x38\x8e\x51\xe6", 16};
};
template <> struct TSchemaAssociation<::facebook::thrift::compiler::test::fixtures::any::MyException> {
  static ::folly::Range<const ::std::string_view*>(*bundle)();
  static constexpr int64_t programId = -5500604698416141242;
