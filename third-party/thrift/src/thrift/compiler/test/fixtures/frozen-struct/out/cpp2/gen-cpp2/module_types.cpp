...
template void TccStructTraits<::some::ns::ModuleA>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::some::ns::ModuleB>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::some::ns::detail::DirectlyAdapted>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::some::ns::CppRef>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
const std::vector<std::any>& TEnumTraits<::some::ns::EnumB>::annotations() noexcept {
