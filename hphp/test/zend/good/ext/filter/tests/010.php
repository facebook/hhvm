...
var_dump(filter_var(varray[1,"1","", "-23234", "text", "asdf234asdfgs", array()], FILTER_VALIDATE_INT, FILTER_REQUIRE_ARRAY));
var_dump(filter_var(varray[1.2,"1.7","", "-23234.123", "text", "asdf234.2asdfgs", array()], FILTER_VALIDATE_FLOAT, FILTER_REQUIRE_ARRAY));
