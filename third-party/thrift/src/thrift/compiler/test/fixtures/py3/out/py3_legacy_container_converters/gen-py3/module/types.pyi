...
class IssetInspectionStruct(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def __init__(
        ...
        opt_str_field: _typing.Optional[str]=None,
        bool_field: _typing.Optional[bool]=None
    ) -> None: ...

    def __call__(
        self, *,
        int_field: _typing.Union[int, None]=None,
        opt_str_field: _typing.Union[str, None]=None,
        bool_field: _typing.Union[bool, None]=None
    ) -> IssetInspectionStruct: ...

    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['IssetInspectionStruct'], bytes]]: ...
    def __hash__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __lt__(self, other: 'IssetInspectionStruct') -> bool: ...
    def __gt__(self, other: 'IssetInspectionStruct') -> bool: ...
    def __le__(self, other: 'IssetInspectionStruct') -> bool: ...
    def __ge__(self, other: 'IssetInspectionStruct') -> bool: ...

    def _to_python(self) -> module.thrift_types.IssetInspectionStruct: ...
