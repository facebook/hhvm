        ...
        async def simple(
            ...
            *,
            ...
            _fbthrift_resp = await self._send_request(
                "BiDiService",
                "simple",
                _fbthrift__module__thrift_types._fbthrift_BiDiService_simple_args(),
                (_fbthrift__module__thrift_types._fbthrift_BiDiService_simple_result, _fbthrift__module__thrift_types._fbthrift_BiDiService_simple_result_stream_elem_fbthrift__module__thrift_types._fbthrift_BiDiService_simple_result_sink_elem, _fbthrift__module__thrift_types._fbthrift_BiDiService_simple_result_sink_final),
        ...
        async def response(
            ...
            *,
            ...
            _fbthrift_resp = await self._send_request(
                "BiDiService",
                "response",
                _fbthrift__module__thrift_types._fbthrift_BiDiService_response_args(),
                (_fbthrift__module__thrift_types._fbthrift_BiDiService_response_result, _fbthrift__module__thrift_types._fbthrift_BiDiService_response_result_stream_elem_fbthrift__module__thrift_types._fbthrift_BiDiService_response_result_sink_elem, _fbthrift__module__thrift_types._fbthrift_BiDiService_response_result_sink_final),
                qualifier = _fbthrift_FunctionQualifier.Unspecified,
                uri_or_name="BiDiService",
                rpc_options=rpc_options,
            )
        ...
        async def canThrow(
            ...
            *,
            ...
            _fbthrift_resp = await self._send_request(
                "BiDiService",
                "canThrow",
                _fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_args(),
                (_fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result, _fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result_stream_elem_fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result_sink_elem, _fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result_sink_final),
                qualifier = _fbthrift_FunctionQualifier.Unspecified,
                uri_or_name="BiDiService",
                rpc_options=rpc_options,
            )
