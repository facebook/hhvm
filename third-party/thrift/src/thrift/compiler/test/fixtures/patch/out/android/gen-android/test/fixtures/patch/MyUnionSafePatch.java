...
public class MyUnionSafePatch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyUnionSafePatch deserialize(TProtocol iprot) throws TException {
    ...
    MyUnionSafePatch _that;
    _that = new MyUnionSafePatch(
      tmp_version
      ,tmp_data
    );
    _that.validate();
