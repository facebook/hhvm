...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="RefFieldsField2Patch", builder=RefFieldsField2Patch.Builder.class)
public final class RefFieldsField2Patch implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    public RefFieldsField2Patch(
    ...
    @ThriftConstructor
    protected RefFieldsField2Patch() {
      this.assign = null;
      this.clear = false;
    ...
    public static class Builder {
        ...
        public Builder() { }
        public Builder(RefFieldsField2Patch other) {
        ...
        @ThriftConstructor
        public RefFieldsField2Patch build() {
            RefFieldsField2Patch result = new RefFieldsField2Patch (
                this.assign,
                this.clear,
                this.prepend,
                this.append
    ...
    private static final TStruct STRUCT_DESC = new TStruct("RefFieldsField2Patch");
    ...
    static {
      ...
      com.facebook.thrift.type.TypeRegistry.add(new com.facebook.thrift.type.Type(
        new com.facebook.thrift.type.UniversalName("test.dev/fixtures/patch/RefFieldsField2Patch"),
        RefFieldsField2Patch.class, RefFieldsField2Patch::read0));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefFieldsField2Patch other = (RefFieldsField2Patch)o;
    ...
    public static com.facebook.thrift.payload.Reader<RefFieldsField2Patch> asReader() {
      return RefFieldsField2Patch::read0;
    }
    
    public static RefFieldsField2Patch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(RefFieldsField2Patch.NAMES_TO_IDS, RefFieldsField2Patch.THRIFT_NAMES_TO_IDS, RefFieldsField2Patch.FIELD_METADATA);
      RefFieldsField2Patch.Builder builder = new RefFieldsField2Patch.Builder();
      while (true) {
    ...
    private static class _RefFieldsField2PatchLazy {
        private static final RefFieldsField2Patch _DEFAULT = new RefFieldsField2Patch.Builder().build();
    }
    
    public static RefFieldsField2Patch defaultInstance() {
        return  _RefFieldsField2PatchLazy._DEFAULT;
    }
}
