...
struct TestMessages {
  ...
  static ClientHello clientHello() {
    ...
    Extension ext2;
    FIZZ_THROW_ON_ERROR(encodeExtension(ext2, err, supportedGroups), err);
    ...
    Extension ext3;
    FIZZ_THROW_ON_ERROR(encodeExtension(ext3, err, keyShare), err);
    ...
    Extension ext4;
    FIZZ_THROW_ON_ERROR(encodeExtension(ext4, err, sigAlgs), err);
