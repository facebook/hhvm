...
class Deprecated:
  ...
  Attributes:
   - message: Explanation of why this is deprecated and what to use instead.
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.thrift.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.Deprecated, self)
...
Deprecated.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
