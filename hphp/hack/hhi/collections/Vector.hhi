...
final class Vector<Tv> implements \MutableVector<Tv> {
  ...
  public function map<Tu>(<<__AtMostRxAsFunc>>(function(Tv)[_]: Tu) $callback)[ctx $callback]: Vector<Tu>;
   ...
   */
  <<__Pure, __AtMostRxAsArgs, __MutableReturn, __MaybeMutable>>
  public function mapWithKey<Tu>(<<__AtMostRxAsFunc>>(function(int, Tv)[_]: Tu) $callback)[ctx $callback]: Vector<Tu>;
   ...
   */
  <<__Pure, __AtMostRxAsArgs, __MutableReturn, __MaybeMutable>>
  public function filter(<<__AtMostRxAsFunc>>(function(Tv)[_]: bool) $callback)[ctx $callback]: Vector<Tv>;
  ...
  *
   ...
   */
  <<__Pure, __AtMostRxAsArgs, __MutableReturn, __MaybeMutable>>
  public function takeWhile(<<__AtMostRxAsFunc>>(function(Tv)[_]: bool) $fn)[ctx $callback]: Vector<Tv>;
   ...
   */
  <<__Pure, __AtMostRxAsArgs, __MutableReturn, __MaybeMutable>>
  public function skipWhile(<<__AtMostRxAsFunc>>(function(Tv)[_]: bool) $fn)[ctx $callback]: Vector<Tv>;
