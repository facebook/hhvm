...
public class BytePatch implements TBase, java.io.Serializable, Cloneable, Comparable<BytePatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(BytePatch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public Builder setAdd(final byte add) {
      this.add = add;
      __optional_isset.set(__ADD_ISSET_ID, true);
      return this;
    }

    public BytePatch build() {
      BytePatch result = new BytePatch();
   ...
   * Clear any set value.
   */
  public BytePatch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
  ...
  public Object getFieldValue(int fieldID) {
    switch (fieldID) {
    case ASSIGN:
      return new Byte(getAssign());

    case CLEAR:
      return new Boolean(isClear());

    case ADD:
      return new Byte(getAdd());
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("BytePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
