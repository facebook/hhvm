...
public class DisableLazyChecksum implements TBase, java.io.Serializable, Cloneable {
  ...
  public static DisableLazyChecksum deserialize(TProtocol iprot) throws TException {
    TField __field;
    ...
    DisableLazyChecksum _that;
    _that = new DisableLazyChecksum(
    );
    _that.validate();
    return _that;
  }
