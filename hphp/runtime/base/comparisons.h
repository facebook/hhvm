...
DELETE_WITH_LHS_VARIANT(same, const OptString&)
...
DELETE_WITH_LHS_VARIANT(equal, const OptString&)
...
DELETE_WITH_LHS_VARIANT(less, const OptString&)
...
DELETE_WITH_LHS_VARIANT(more, const OptString&)
