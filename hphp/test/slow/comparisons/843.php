...
<<__EntryPoint>>
function main_843() :mixed{
$i = 0;
 print ++$i;
 print "\t";
 print (HH\Lib\Legacy_FIXME\eq('1.2', true)) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = '1.2';
 ...
 $b = 't';
 $b = true;
 print (HH\Lib\Legacy_FIXME\eq('1.2', $b)) ? 'Y' : 'N';
 ...
 print ++$i;
 print "\t";
 print ('1.2'==varray[darray['a' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = '1.2';
 ...
 print ++$i;
 print "\t";
 print ('1.2'==varray[darray['b' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = '1.2';
