...
class _fbthrift_Raiser_get500_result(_fbthrift_python_mutable_types.MutableStruct):
    ...
    def __init__(
        self, *, success: _typing.Optional[str] = ..., _ex0__f: _typing.Optional[_fbthrift_Fiery]=..., _ex1__b: _typing.Optional[_fbthrift_Banal]=..., _ex2__s: _typing.Optional[_fbthrift_Serious]=...
    ) -> None: ...
