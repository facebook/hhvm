...
::std::string_view _fbthrift_schema_7ed9aa9cd69f5bff() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_7ed9aa9cd69f5bff_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_7ed9aa9cd69f5bff_uris() {
  return {};
}
