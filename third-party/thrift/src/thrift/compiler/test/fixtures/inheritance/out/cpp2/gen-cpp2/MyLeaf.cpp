...
apache::thrift::ServiceHandler<::cpp2::MyLeaf>::semifuture_do_leaf() {
  auto expected{apache::thrift::detail::si::InvocationType::SemiFuture};
  __fbthrift_invocation_do_leaf.compare_exchange_strong(
      expected,
...
apache::thrift::ServiceHandler<::cpp2::MyLeaf>::future_do_leaf() {
...
apache::thrift::ServiceHandler<::cpp2::MyLeaf>::co_do_leaf() {
...
void apache::thrift::ServiceHandler<::cpp2::MyLeaf>::async_tm_do_leaf(
...
#endif // FOLLY_HAS_COROUTINES
  auto invocationType =
      __fbthrift_invocation_do_leaf.load(std::memory_order_relaxed);
  try {
