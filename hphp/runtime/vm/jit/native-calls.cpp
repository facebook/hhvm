...
static CallMap s_callMap {
    ...
    {ThrowMustBeEnclosedInReadonly,
                         throwMustBeEnclosedInReadonly, DNone, SSync,
    ...
    {RaiseCoeffectsFunParamCoeffectRulesViolation,
                          raiseCoeffectsFunParamCoeffectRulesViolation,
                          DNone, SSync, {{SSA, 0}}},
    {RaiseReadonlyPropViolation,
                          raiseReadonlyViolationWarning, DNone, SSync,
                          {extra(&ReadonlyPropData::rv), extra(&ReadonlyPropData::cls),
                          {SSA, 0}}},
