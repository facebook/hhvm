...
template void TccStructTraits<::some::ns::IncludedA>::translateFieldName(
...
std::partial_ordering IncludedA::operator<=>([[maybe_unused]] const IncludedA& rhs) const {
  return ::apache::thrift::op::compare<IncludedA>(*this, rhs);
}
