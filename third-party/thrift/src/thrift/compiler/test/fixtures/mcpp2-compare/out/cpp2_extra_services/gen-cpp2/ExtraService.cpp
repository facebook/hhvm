...
void apache::thrift::ServiceHandler<::extra::svc::ExtraService>::async_tm_simple_function(apache::thrift::HandlerCallback<bool>::Ptr callback) {
...
void apache::thrift::ServiceHandler<::extra::svc::ExtraService>::async_eb_throws_function(apache::thrift::HandlerCallback<void>::Ptr callback) {
...
void apache::thrift::ServiceHandler<::extra::svc::ExtraService>::async_tm_throws_function2(apache::thrift::HandlerCallback<bool>::Ptr callback, bool p_param1) {
  // It's possible the coroutine versions will delegate to a future-based
  // version. If that happens, we need the RequestParams arguments to be
  // available to the future through the thread-local backchannel, so we create
  // a RAII object that sets up RequestParams and clears them on destruction.
...
void apache::thrift::ServiceHandler<::extra::svc::ExtraService>::async_tm_throws_function3(apache::thrift::HandlerCallback<::std::map<::std::int32_t, ::std::string>>::Ptr callback, bool p_param1, const ::std::string& p_param2) {
  // It's possible the coroutine versions will delegate to a future-based
  // version. If that happens, we need the RequestParams arguments to be
  // available to the future through the thread-local backchannel, so we create
  // a RAII object that sets up RequestParams and clears them on destruction.
