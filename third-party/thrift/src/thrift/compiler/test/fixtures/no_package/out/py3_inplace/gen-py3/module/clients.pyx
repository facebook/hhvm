...
cdef void FB303Service_simple_rpc_callback(
    ...
    if result.hasException():
        ...
        try:
            pyfuture.set_result(_module_types.ReservedKeyword.from_python(_module_thrift_converter.ReservedKeyword_from_cpp(__deref_const[_module_cbindings.cReservedKeyword](result.value()))))
        except Exception as ex:
            pyfuture.set_exception(ex.with_traceback(None))
