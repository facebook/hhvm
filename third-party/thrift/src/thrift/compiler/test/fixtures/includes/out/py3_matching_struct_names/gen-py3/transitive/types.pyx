...
cdef class Foo(thrift.py3.types.Struct):
    def __init__(Foo self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_transitive_cbindings.cFoo]()
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_transitive_cbindings.cFoo] cpp_obj):
    ...
    def __copy__(Foo self):
        cdef shared_ptr[_transitive_cbindings.cFoo] cpp_obj = make_shared[_transitive_cbindings.cFoo](
    ...
    def __richcmp__(self, other, int op):
        ...
        return __richcmp[_transitive_cbindings.cFoo](
    ...
    def __get_metadata__():
        ...
        _transitive_cbindings.StructMetadata[_transitive_cbindings.cFoo].gen(meta)
    ...
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_transitive_cbindings.cFoo](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(Foo self, __Protocol proto):
        ...
        with nogil:
            data = cmove(serializer.cserialize[_transitive_cbindings.cFoo](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
    ...
    cdef cuint32_t _fbthrift_deserialize(Foo self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_transitive_cbindings.cFoo]()
        with nogil:
            needed = serializer.cdeserialize[_transitive_cbindings.cFoo](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
...
ExampleFoo = Foo._create_FBTHRIFT_ONLY_DO_NOT_USE(constant_shared_ptr(_transitive_cbindings.cExampleFoo()))
