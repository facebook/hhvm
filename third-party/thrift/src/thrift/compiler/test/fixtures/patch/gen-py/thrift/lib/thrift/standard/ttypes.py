...
__all__ = ['UTF8STRINGS', 'Void', 'StandardProtocol', 'DurationStruct', 'TimeStruct', 'FractionStruct', 'UriStruct', 'TypeUri', 'TypeName', 'ByteString', 'ByteBuffer', 'Fraction', 'SimpleFraction', 'Uuid', 'UuidString', 'Path', 'PathSegments', 'Domain', 'DomainLabels', 'QueryString', 'QueryArgs', 'Uri']
