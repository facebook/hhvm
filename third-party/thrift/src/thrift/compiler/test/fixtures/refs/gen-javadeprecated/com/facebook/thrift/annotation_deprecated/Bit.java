...
public class Bit implements TBase, java.io.Serializable, Cloneable, Comparable<Bit> {
  private static final TStruct STRUCT_DESC = new TStruct("Bit");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(Bit.class, metaDataMap);
  }
