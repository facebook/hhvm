...
public class v1alpha implements TBase, java.io.Serializable, Cloneable, Comparable<v1alpha> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(v1alpha.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public v1alpha build() {
      v1alpha result = new v1alpha();
      return result;
    }
  }
   ...
   */
  public v1alpha(v1alpha other) {
  }

  public v1alpha deepCopy() {
    return new v1alpha(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof v1alpha))
      return false;
    v1alpha that = (v1alpha)_that;
  ...
  @Override
  public int compareTo(v1alpha other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("v1alpha");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
