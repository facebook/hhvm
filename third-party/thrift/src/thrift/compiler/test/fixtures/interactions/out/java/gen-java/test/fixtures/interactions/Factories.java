...
@SwiftGenerated
@com.facebook.swift.service.ThriftService("Factories")
public interface Factories extends java.io.Closeable, com.facebook.thrift.util.BlockingService {
    static com.facebook.thrift.server.RpcServerHandlerBuilder<Factories> serverHandlerBuilder(Factories _serverImpl) {
        return new com.facebook.thrift.server.RpcServerHandlerBuilder<Factories>(_serverImpl) {
                @java.lang.Override
                public com.facebook.thrift.server.RpcServerHandler build() {
                return new FactoriesRpcServerHandler(impl, eventHandlers);
            }
        };
    }
    ...
    static com.facebook.thrift.client.ClientBuilder<Factories> clientBuilder() {
        return new ClientBuilder<Factories>() {
            @java.lang.Override
            public Factories build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                Factories.Reactive _delegate =
                    new FactoriesReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    public interface Async extends java.io.Closeable, com.facebook.thrift.util.AsyncService {
        static com.facebook.thrift.server.RpcServerHandlerBuilder<Factories.Async> serverHandlerBuilder(Factories.Async _serverImpl) {
            return new com.facebook.thrift.server.RpcServerHandlerBuilder<Factories.Async>(_serverImpl) {
                @java.lang.Override
                public com.facebook.thrift.server.RpcServerHandler build() {
                    return new FactoriesRpcServerHandler(impl, eventHandlers);
                }
        ...
        static com.facebook.thrift.client.ClientBuilder<Factories.Async> clientBuilder() {
            return new ClientBuilder<Factories.Async>() {
                @java.lang.Override
                public Factories.Async build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    Factories.Reactive _delegate =
                        new FactoriesReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    interface Reactive extends reactor.core.Disposable, com.facebook.thrift.util.ReactiveService {
        static com.facebook.thrift.server.RpcServerHandlerBuilder<Factories.Reactive> serverHandlerBuilder(Factories.Reactive _serverImpl) {
            return new com.facebook.thrift.server.RpcServerHandlerBuilder<Factories.Reactive>(_serverImpl) {
                @java.lang.Override
                public com.facebook.thrift.server.RpcServerHandler build() {
                    return new FactoriesRpcServerHandler(impl, eventHandlers);
                }
        ...
        static com.facebook.thrift.client.ClientBuilder<Factories.Reactive> clientBuilder() {
            return new ClientBuilder<Factories.Reactive>() {
                @java.lang.Override
                public Factories.Reactive build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    return new FactoriesReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
                }
            };
        }
