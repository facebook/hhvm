...
StructMetadata<::apache::thrift::metadata::ThriftField>::gen(ThriftMetadata& metadata) {
  ...
  metadata_ThriftField_fields[] = {
    ...
    std::make_tuple(6, "unstructured_annotations", true, std::make_unique<Map>(std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_STRING_TYPE), std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_STRING_TYPE)), std::vector<ThriftConstStruct>{}),
  };
