...
namespace android test.fixtures.no_package
namespace java test.fixtures.no_package
namespace java.swift test.fixtures.no_package
namespace hack.module hack.module.test
namespace csharp test.dev.fixtures.no_package

include "thrift/annotation/hack.thrift"
include "thrift/annotation/thrift.thrift"

// This is NOT a best practice and users should have a non-empty package statement.
// This test DOES NOT FOLLOW BEST PRACTICES INTENTIONALLY and acts as a check to
// ensure we don't introduce regressions for legacy files.
// @lint-ignore THRIFTCHECKS Empty package with AllowLegacyMissingUris by design.
