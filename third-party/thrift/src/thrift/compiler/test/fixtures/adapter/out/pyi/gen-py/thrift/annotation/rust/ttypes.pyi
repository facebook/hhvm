...
class Copy:
    ...
    def _to_mutable_python(self) -> "facebook.thrift.annotation.rust.thrift_mutable_types.Copy": ...   # type: ignore
...
class Serde:
    ...
    @enabled.setter
    def enabled(self, value: __T.Optional[bool]) -> None: ...
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.rust.thrift_types.Serde": ...   # type: ignore
    ...
    def _to_py_deprecated(self) -> Serde: ...
...
class Mod:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.rust.thrift_types.Mod": ...   # type: ignore
    ...
    def _to_py_deprecated(self) -> Mod: ...
