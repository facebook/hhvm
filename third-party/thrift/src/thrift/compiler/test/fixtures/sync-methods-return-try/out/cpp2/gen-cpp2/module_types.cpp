...
template void TccStructTraits<::cpp2::SinkException2>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::StreamItem>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
std::partial_ordering StreamItem::operator<=>([[maybe_unused]] const StreamItem& rhs) const {
  return ::apache::thrift::op::compare<StreamItem>(*this, rhs);
}
