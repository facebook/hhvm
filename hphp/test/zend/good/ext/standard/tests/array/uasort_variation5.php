...
var_dump( uasort(&$single_quoted_values, fun('cmp_function')) );  // expecting: bool(true)
...
var_dump( uasort(&$double_quoted_values, fun('cmp_function')) );  // expecting: bool(true)
...
var_dump( uasort(&$heredoc_values, fun('cmp_function')) );  // expecting: bool(true)
