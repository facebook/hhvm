...
class MyStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_MyStruct):
    ...
    @property
    def floatListy(self) -> _typing.MutableSequence[float]: ...
    @floatListy.setter
    def floatListy(self, value: _typing.MutableSequence[float]): ...
...
class AdaptedFields(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_AdaptedFields):
    ...
    @property
    def list_adapted_int(self) -> _typing.MutableSequence[int]: ...
    @list_adapted_int.setter
    def list_adapted_int(self, value: _typing.MutableSequence[int]): ...
...
class ListStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_ListStruct):
    ...
    @property
    def boolz(self) -> _typing.MutableSequence[bool]: ...
    @boolz.setter
    def boolz(self, value: _typing.MutableSequence[bool]): ...


    @property
    def intz(self) -> _typing.Optional[_typing.MutableSequence[int]]: ...
    @intz.setter
    def intz(self, value: _typing.Optional[_typing.MutableSequence[int]]): ...


    @property
    def stringz(self) -> _typing.Optional[_typing.MutableSequence[str]]: ...
    @stringz.setter
    def stringz(self, value: _typing.Optional[_typing.MutableSequence[str]]): ...


    @property
    def encoded(self) -> _typing.MutableSequence[bytes]: ...
    @encoded.setter
    def encoded(self, value: _typing.MutableSequence[bytes]): ...


    @property
    def uidz(self) -> _typing.MutableSequence[int]: ...
    @uidz.setter
    def uidz(self, value: _typing.MutableSequence[int]): ...


    @property
    def matrix(self) -> _typing.MutableSequence[_typing.MutableSequence[float]]: ...
    @matrix.setter
    def matrix(self, value: _typing.MutableSequence[_typing.MutableSequence[float]]): ...


    @property
    def ucharz(self) -> _typing.MutableSequence[_typing.MutableSequence[int]]: ...
    @ucharz.setter
    def ucharz(self, value: _typing.MutableSequence[_typing.MutableSequence[int]]): ...


    @property
    def voxels(self) -> _typing.MutableSequence[_typing.MutableSequence[_typing.MutableSequence[int]]]: ...
    @voxels.setter
    def voxels(self, value: _typing.MutableSequence[_typing.MutableSequence[_typing.MutableSequence[int]]]): ...


    @property
    def buf_ptrs(self) -> _typing.MutableSequence[_fbthrift_iobuf.IOBuf]: ...
    @buf_ptrs.setter
    def buf_ptrs(self, value: _typing.MutableSequence[_fbthrift_iobuf.IOBuf]): ...
...
class SetStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_SetStruct):
    ...
    @property
    def setz(self) -> _typing.MutableSequence[_typing.MutableSet[int]]: ...
    @setz.setter
    def setz(self, value: _typing.MutableSequence[_typing.MutableSet[int]]): ...
...
class MapStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_MapStruct):
    ...
    @property
    def map_list(self) -> _typing.MutableSequence[_typing.MutableMapping[int, int]]: ...
    @map_list.setter
    def map_list(self, value: _typing.MutableSequence[_typing.MutableMapping[int, int]]): ...


    @property
    def list_map(self) -> _typing.MutableMapping[int, _typing.MutableSequence[int]]: ...
    @list_map.setter
    def list_map(self, value: _typing.MutableMapping[int, _typing.MutableSequence[int]]): ...


    @property
    def fast_list_map(self) -> _typing.MutableMapping[int, _typing.MutableSequence[float]]: ...
    @fast_list_map.setter
    def fast_list_map(self, value: _typing.MutableMapping[int, _typing.MutableSequence[float]]): ...
    ...
    @property
    def unsigned_list_map(self) -> _typing.MutableMapping[int, _typing.MutableSequence[int]]: ...
    @unsigned_list_map.setter
    def unsigned_list_map(self, value: _typing.MutableMapping[int, _typing.MutableSequence[int]]): ...
...
class ComposeStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_ComposeStruct):
    ...
    @property
    def friends(self) -> _typing.MutableSequence[test.fixtures.python_capi.thrift_dep.thrift_mutable_types.DepStruct]: ...
    @friends.setter
    def friends(self, value: _typing.MutableSequence[test.fixtures.python_capi.thrift_dep.thrift_mutable_types.DepStruct]): ...
...
class Onion(_fbthrift_python_mutable_types.MutableUnion, _fbthrift_compatible_with_Onion):
    ...
    @property
    def doubleList(self) -> _typing.MutableSequence[float]: ...
    @doubleList.setter
    def doubleList(self, value: _typing.MutableSequence[float]): ...
