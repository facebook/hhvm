...
public class FB303ServiceReactiveAsyncWrapper 
  ...
  @java.lang.Override
  public com.google.common.util.concurrent.ListenableFuture<test.fixtures.no_package.ReservedKeyword> simpleRpc(final int intParameter) {
      return com.facebook.thrift.util.FutureUtil.toListenableFuture(_delegate.simpleRpc(intParameter));
  }

  @java.lang.Override
  public com.google.common.util.concurrent.ListenableFuture<test.fixtures.no_package.ReservedKeyword> simpleRpc(
  ...
  @java.lang.Override
  public com.google.common.util.concurrent.ListenableFuture<com.facebook.thrift.client.ResponseWrapper<test.fixtures.no_package.ReservedKeyword>> simpleRpcWrapper(
    final int intParameter,
    com.facebook.thrift.client.RpcOptions rpcOptions) {
