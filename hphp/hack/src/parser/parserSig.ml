  ...
  module WithLexer(Lexer : Lexer_S) = struct
    module type Parser_S = sig
      ...
      module Make : sig
        ...
        val record_declaration : t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val const_declaration : t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val record_creation_expression : t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val type_parameter : t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
