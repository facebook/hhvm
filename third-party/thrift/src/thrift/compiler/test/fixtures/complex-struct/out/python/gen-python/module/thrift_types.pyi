...
class Containers(_fbthrift_python_types.Struct, _fbthrift_compatible_with_Containers, _fbthrift_python_abstract_types.Containers):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.Sequence[_fbthrift_MyStruct], _typing.Sequence[_fbthrift_MyUnion], _typing.Sequence[_fbthrift_MyEnum], _typing.AbstractSet[_fbthrift_MyStruct], _typing.AbstractSet[_fbthrift_MyUnion], _typing.AbstractSet[_fbthrift_MyEnum], _typing.Mapping[_fbthrift_MyStruct, int], _typing.Mapping[_fbthrift_MyUnion, int], _typing.Mapping[_fbthrift_MyEnum, int], _typing.Mapping[int, _fbthrift_MyStruct], _typing.Mapping[int, _fbthrift_MyUnion], _typing.Mapping[int, _fbthrift_MyEnum], _typing.Mapping[_typing.Sequence[int], int], _typing.Mapping[int, _typing.Sequence[int]], _typing.Mapping[_typing.AbstractSet[int], int], _typing.Mapping[int, _typing.AbstractSet[int]], _typing.Mapping[_typing.Mapping[int, int], int], _typing.Mapping[int, _typing.Mapping[int, int]]]]]: ...
    def _to_python(self) -> _typing.Self: ...
