...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="MyStructField30Patch", builder=MyStructField30Patch.Builder.class)
public final class MyStructField30Patch implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    public MyStructField30Patch(
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="patchPrior", requiredness=Requiredness.TERSE) final Map<String, test.fixtures.patch.MyStructField30Patch1> patchPrior,
        @com.facebook.swift.codec.ThriftField(value=5, name="add", requiredness=Requiredness.TERSE) final Map<String, Map<String, Integer>> add,
        @com.facebook.swift.codec.ThriftField(value=6, name="patch", requiredness=Requiredness.TERSE) final Map<String, test.fixtures.patch.MyStructField30Patch1> patch,
        @com.facebook.swift.codec.ThriftField(value=7, name="remove", requiredness=Requiredness.TERSE) final Set<String> remove,
        @com.facebook.swift.codec.ThriftField(value=9, name="put", requiredness=Requiredness.TERSE) final Map<String, Map<String, Integer>> put
    ) {
        this.assign = assign;
        this.clear = clear;
    ...
    @ThriftConstructor
    protected MyStructField30Patch() {
      this.assign = null;
      this.clear = false;
    ...
    public static class Builder {
        ...
        private Map<String, test.fixtures.patch.MyStructField30Patch1> patchPrior = com.facebook.thrift.util.IntrinsicDefaults.defaultMap();
        private Map<String, Map<String, Integer>> add = com.facebook.thrift.util.IntrinsicDefaults.defaultMap();
        private Map<String, test.fixtures.patch.MyStructField30Patch1> patch = com.facebook.thrift.util.IntrinsicDefaults.defaultMap();
        private Set<String> remove = com.facebook.thrift.util.IntrinsicDefaults.defaultSet();
        private Map<String, Map<String, Integer>> put = com.facebook.thrift.util.IntrinsicDefaults.defaultMap();
        ...
        public Builder setPatchPrior(Map<String, test.fixtures.patch.MyStructField30Patch1> patchPrior) {
            this.patchPrior = patchPrior;
            return this;
        }
    
        public Map<String, test.fixtures.patch.MyStructField30Patch1> getPatchPrior() { return patchPrior; }
        ...
        public Builder setPatch(Map<String, test.fixtures.patch.MyStructField30Patch1> patch) {
            this.patch = patch;
            return this;
        }
    
        public Map<String, test.fixtures.patch.MyStructField30Patch1> getPatch() { return patch; }
        ...
        public Builder() { }
        public Builder(MyStructField30Patch other) {
    ...
    private static final TField CLEAR_FIELD_DESC = new TField("clear", TType.BOOL, (short)2);
        private final Map<String, test.fixtures.patch.MyStructField30Patch1> patchPrior;
    ...
    private static final TField ADD_FIELD_DESC = new TField("add", TType.MAP, (short)5);
        private final Map<String, test.fixtures.patch.MyStructField30Patch1> patch;
    ...
    static {
      ...
      com.facebook.thrift.type.TypeRegistry.add(new com.facebook.thrift.type.Type(
        new com.facebook.thrift.type.UniversalName("test.dev/fixtures/patch/MyStructField30Patch"),
        MyStructField30Patch.class, MyStructField30Patch::read0));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MyStructField30Patch other = (MyStructField30Patch)o;
    ...
    public static com.facebook.thrift.payload.Reader<MyStructField30Patch> asReader() {
      return MyStructField30Patch::read0;
    }
    
    public static MyStructField30Patch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(MyStructField30Patch.NAMES_TO_IDS, MyStructField30Patch.THRIFT_NAMES_TO_IDS, MyStructField30Patch.FIELD_METADATA);
      MyStructField30Patch.Builder builder = new MyStructField30Patch.Builder();
      while (true) {
        ...
        case _PATCHPRIOR:
          if (__field.type == TType.MAP) {
            Map<String, test.fixtures.patch.MyStructField30Patch1> patchPrior;
            {
            TMap _map = oprot.readMapBegin();
            patchPrior = new HashMap<String, test.fixtures.patch.MyStructField30Patch1>(Math.max(0, _map.size));
            for (int _i = 0; (_map.size < 0) ? oprot.peekMap() : (_i < _map.size); _i++) {
                
                String _key1 = oprot.readString();
                test.fixtures.patch.MyStructField30Patch1 _value1 = test.fixtures.patch.MyStructField30Patch1.read0(oprot);
        ...
        case _PATCH:
          if (__field.type == TType.MAP) {
            Map<String, test.fixtures.patch.MyStructField30Patch1> patch;
            {
            TMap _map = oprot.readMapBegin();
            patch = new HashMap<String, test.fixtures.patch.MyStructField30Patch1>(Math.max(0, _map.size));
            for (int _i = 0; (_map.size < 0) ? oprot.peekMap() : (_i < _map.size); _i++) {
    ...
    public void write0(TProtocol oprot) throws TException {
      ...
      if (!com.facebook.thrift.util.IntrinsicDefaults.isDefault(patchPrior)) {
        ...
        Map<String, test.fixtures.patch.MyStructField30Patch1> _iter0 = patchPrior;
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, _iter0.size()));
        for (Map.Entry<String, test.fixtures.patch.MyStructField30Patch1> _iter1 : _iter0.entrySet()) {
          oprot.writeString(_iter1.getKey());
      ...
      if (!com.facebook.thrift.util.IntrinsicDefaults.isDefault(patch)) {
        ...
        Map<String, test.fixtures.patch.MyStructField30Patch1> _iter0 = patch;
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, _iter0.size()));
        for (Map.Entry<String, test.fixtures.patch.MyStructField30Patch1> _iter1 : _iter0.entrySet()) {
          oprot.writeString(_iter1.getKey());
          _iter1.getValue().write0(oprot);
    ...
    private static class _MyStructField30PatchLazy {
        private static final MyStructField30Patch _DEFAULT = new MyStructField30Patch.Builder().build();
    }
    
    public static MyStructField30Patch defaultInstance() {
        return  _MyStructField30PatchLazy._DEFAULT;
    }
}
