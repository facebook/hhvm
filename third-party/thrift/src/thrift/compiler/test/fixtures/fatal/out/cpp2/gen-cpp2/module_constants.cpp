...
::std::string_view _fbthrift_schema_470fd005997c6c07() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_470fd005997c6c07_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_470fd005997c6c07_uris() {
  return {};
}
