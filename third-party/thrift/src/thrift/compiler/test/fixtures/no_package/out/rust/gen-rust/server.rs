    ...
    async fn handle_simple_rpc<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "FooService.simple_rpc", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("FooService.simple_rpc", exn);
                ::tracing::error!(method = "FooService.simple_rpc", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::foo_service::SimpleRpcExn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::foo_service::SimpleRpcExn>(
            "simple_rpc",
            METHOD_NAME,
            _seqid,
            req_ctxt,
...
impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_FB303Service_simple_rpc {
    ...
    fn rs_thrift_read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (::fbthrift::TType::Stop, _) => break,
                (::fbthrift::TType::I32, 1) => field_int_parameter = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingArgError { arg: "int_parameter", function: "simple_rpc"})?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
    ...
    ::fbthrift::ProtocolEncodedFinal<P>: ::std::clone::Clone + ::fbthrift::BufExt,
{
    ...
    async fn handle_simple_rpc<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "FB303Service.simple_rpc", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("FB303Service.simple_rpc", exn);
                ::tracing::error!(method = "FB303Service.simple_rpc", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::f_b303_service::SimpleRpcExn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::f_b303_service::SimpleRpcExn>(
            "simple_rpc",
            METHOD_NAME,
            _seqid,
            req_ctxt,
...
impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_MyService_sink {
    ...
    fn rs_thrift_read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (::fbthrift::TType::Stop, _) => break,
                (::fbthrift::TType::I64, 1) => field_sink = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingArgError { arg: "sink", function: "sink"})?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
...
impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_MyService_deleteDataById {
    ...
    fn rs_thrift_read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (::fbthrift::TType::Stop, _) => break,
                (::fbthrift::TType::I64, 1) => field_id = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingArgError { arg: "id", function: "deleteDataById"})?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
    ...
    ::fbthrift::ProtocolEncodedFinal<P>: ::std::clone::Clone + ::fbthrift::BufExt,
{
    ...
    async fn handle_sink<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "MyService.sink", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("MyService.sink", exn);
                ::tracing::error!(method = "MyService.sink", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::my_service::SinkExn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::my_service::SinkExn>(
            "sink",
            METHOD_NAME,
            _seqid,
            req_ctxt,
    ...
    async fn handle_deleteDataById<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "MyService.deleteDataById", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("MyService.deleteDataById", exn);
                ::tracing::error!(method = "MyService.deleteDataById", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::my_service::DeleteDataByIdExn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::my_service::DeleteDataByIdExn>(
            "deleteDataById",
            METHOD_NAME,
            _seqid,
            req_ctxt,
    ...
    async fn handle_invalid_return_for_hack<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "MyService.invalid_return_for_hack", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("MyService.invalid_return_for_hack", exn);
                ::tracing::error!(method = "MyService.invalid_return_for_hack", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::my_service::InvalidReturnForHackExn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::my_service::InvalidReturnForHackExn>(
            "invalid_return_for_hack",
            METHOD_NAME,
            _seqid,
            req_ctxt,
    ...
    async fn handle_rpc_skipped_codegen<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "MyService.rpc_skipped_codegen", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("MyService.rpc_skipped_codegen", exn);
                ::tracing::error!(method = "MyService.rpc_skipped_codegen", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::my_service::RpcSkippedCodegenExn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::my_service::RpcSkippedCodegenExn>(
            "rpc_skipped_codegen",
            METHOD_NAME,
            _seqid,
            req_ctxt,
...
impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_DbMixedStackArguments_getDataByKey0 {
    ...
    fn rs_thrift_read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (::fbthrift::TType::Stop, _) => break,
                (::fbthrift::TType::String, 1) => field_key = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingArgError { arg: "key", function: "getDataByKey0"})?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
...
impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_DbMixedStackArguments_getDataByKey1 {
    ...
    fn rs_thrift_read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (::fbthrift::TType::Stop, _) => break,
                (::fbthrift::TType::String, 1) => field_key = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingArgError { arg: "key", function: "getDataByKey1"})?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
    ...
    ::fbthrift::ProtocolEncodedFinal<P>: ::std::clone::Clone + ::fbthrift::BufExt,
{
    ...
    async fn handle_getDataByKey0<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "DbMixedStackArguments.getDataByKey0", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("DbMixedStackArguments.getDataByKey0", exn);
                ::tracing::error!(method = "DbMixedStackArguments.getDataByKey0", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::db_mixed_stack_arguments::GetDataByKey0Exn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::db_mixed_stack_arguments::GetDataByKey0Exn>(
            "getDataByKey0",
            METHOD_NAME,
            _seqid,
            req_ctxt,
    ...
    async fn handle_getDataByKey1<'a>(
        ...
        let res = match res {
            ...
            ::std::result::Result::Ok(::std::result::Result::Err(exn)) => {
                ::tracing::error!(method = "DbMixedStackArguments.getDataByKey1", exception = ?exn, error = exn.exn_value());
                ::std::result::Result::Err(exn)
            }
            ::std::result::Result::Err(exn) => {
                let aexn = ::fbthrift::ApplicationException::handler_panic("DbMixedStackArguments.getDataByKey1", exn);
                ::tracing::error!(method = "DbMixedStackArguments.getDataByKey1", panic = ?aexn, error = aexn.exn_value());
                ::std::result::Result::Err(crate::services::db_mixed_stack_arguments::GetDataByKey1Exn::ApplicationException(aexn))
            }
        };

        let env = ::fbthrift::help::serialize_result_envelope::<P, R, crate::services::db_mixed_stack_arguments::GetDataByKey1Exn>(
            "getDataByKey1",
            METHOD_NAME,
            _seqid,
            req_ctxt,
