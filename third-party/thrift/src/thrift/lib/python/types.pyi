...
class Struct(
    ...
    def __replace__(self: sT, *args: typing.Any, **changes: typing.Any) -> sT: ...
...
def isset_DEPRECATED(struct: StructOrError) -> typing.Mapping[str, bool]: ...
...
class ServiceInterface:
    ...
    async def getServiceHealthStatus(self) -> cServiceHealth: ...
