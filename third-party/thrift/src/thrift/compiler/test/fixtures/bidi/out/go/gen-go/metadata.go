...
var (
    premadeStructMetadata_BiDiSinkException =
    ...
    premadeStructMetadata_BiDiStreamException =
        &metadata.ThriftException{
            Name: "module.BiDiStreamException",
            Fields: []*metadata.ThriftField{
                &metadata.ThriftField{
    ...
    premadeStructMetadata_BiDiMethodException =
        &metadata.ThriftException{
            Name: "module.BiDiMethodException",
            Fields: []*metadata.ThriftField{
                &metadata.ThriftField{
...
var exceptionMetadatas = func() []*metadata.ThriftException {
    ...
    fbthriftResults = append(fbthriftResults, premadeStructMetadata_BiDiSinkException)
    fbthriftResults = append(fbthriftResults, premadeStructMetadata_BiDiStreamException)
    fbthriftResults = append(fbthriftResults, premadeStructMetadata_BiDiMethodException)
    return fbthriftResults
}()
