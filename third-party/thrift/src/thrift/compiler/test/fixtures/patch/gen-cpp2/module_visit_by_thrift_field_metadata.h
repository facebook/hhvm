...
struct VisitByFieldId<::test::fixtures::patch::MyStructFieldPatchStruct> {
  ...
  void operator()(FOLLY_MAYBE_UNUSED F&& f, int32_t fieldId, FOLLY_MAYBE_UNUSED T&& t) const {
    switch (fieldId) {
    case -30:
      return f(0, static_cast<T&&>(t).optMapVal_ref());
    case -29:
      return f(1, static_cast<T&&>(t).optSetVal_ref());
    case -28:
      return f(2, static_cast<T&&>(t).optListVal_ref());
    case -27:
      return f(3, static_cast<T&&>(t).optLateStructVal_ref());
    case -26:
      return f(4, static_cast<T&&>(t).optStructVal_ref());
    case -25:
      return f(5, static_cast<T&&>(t).optEnumVal_ref());
    case -24:
      return f(6, static_cast<T&&>(t).optBinaryVal_ref());
    case -23:
      return f(7, static_cast<T&&>(t).optStringVal_ref());
    case -22:
      return f(8, static_cast<T&&>(t).optDoubleVal_ref());
    case -21:
      return f(9, static_cast<T&&>(t).optFloatVal_ref());
    case -20:
      return f(10, static_cast<T&&>(t).optI64Val_ref());
    case -19:
      return f(11, static_cast<T&&>(t).optI32Val_ref());
    case -18:
      return f(12, static_cast<T&&>(t).optI16Val_ref());
    case -17:
      return f(13, static_cast<T&&>(t).optByteVal_ref());
    case -16:
      return f(14, static_cast<T&&>(t).optBoolVal_ref());
    case -15:
      return f(15, static_cast<T&&>(t).timeVal_ref());
    case -14:
      return f(16, static_cast<T&&>(t).durationVal_ref());
    case -13:
...
template <>
struct VisitByFieldId<::test::fixtures::patch::RecursiveFieldN1PatchStruct> {
  template <typename F, typename T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, int32_t fieldId, FOLLY_MAYBE_UNUSED T&& t) const {
    switch (fieldId) {
    case 1:
    ...
    case 2:
      return f(1, static_cast<T&&>(t).clear_ref());
    default:
      throwInvalidThriftId(fieldId, "::test::fixtures::patch::RecursiveFieldN1PatchStruct");
    }
  }
};
