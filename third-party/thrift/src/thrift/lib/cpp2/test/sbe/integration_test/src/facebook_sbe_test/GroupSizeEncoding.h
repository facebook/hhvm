...
#ifndef _FACEBOOK_SBE_TEST_GROUPSIZEENCODING_CXX_H_
#define _FACEBOOK_SBE_TEST_GROUPSIZEENCODING_CXX_H_
...
public:
        ...
        m_actingVersion(actingVersion)
    {
        ...
        {
            throw std::runtime_error("buffer too short for flyweight [E107] in GroupSizeEncoding");
        }
    }
