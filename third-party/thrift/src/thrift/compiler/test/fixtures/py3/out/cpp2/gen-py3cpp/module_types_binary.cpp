...
template void IssetInspectionStruct::readNoXfer<>(apache::thrift::BinaryProtocolReader*);
template uint32_t IssetInspectionStruct::write<>(apache::thrift::BinaryProtocolWriter*) const;
template uint32_t IssetInspectionStruct::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
template uint32_t IssetInspectionStruct::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
