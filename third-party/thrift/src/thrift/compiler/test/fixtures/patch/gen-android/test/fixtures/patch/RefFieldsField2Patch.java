...
public class RefFieldsField2Patch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public RefFieldsField2Patch(RefFieldsField2Patch other) {
  ...
  public RefFieldsField2Patch deepCopy() {
    return new RefFieldsField2Patch(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof RefFieldsField2Patch))
      return false;
    RefFieldsField2Patch that = (RefFieldsField2Patch)_that;
  ...
  public static RefFieldsField2Patch deserialize(TProtocol iprot) throws TException {
    ...
    RefFieldsField2Patch _that;
    _that = new RefFieldsField2Patch(
      tmp_assign
      ,tmp_clear
      ,tmp_prepend
      ,tmp_append
