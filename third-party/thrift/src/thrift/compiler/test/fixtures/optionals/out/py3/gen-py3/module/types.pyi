...
class Animal(thrift.python.types.Enum, int):
    DOG: Animal = ...
    CAT: Animal = ...
    TARANTULA: Animal = ...
    def _to_python(self) -> module.thrift_types.Animal: ...
...
class Color(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.Color: ...
...
class Vehicle(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.Vehicle: ...
...
class Person(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module.thrift_types.Person: ...
...
class List__Vehicle(_typing.Sequence[Vehicle], _typing.Hashable):
    ...
    def __radd__(self, other: _typing.Sequence[Vehicle]) -> 'List__Vehicle': ...
