...
impl<'o, 't> SmartConstructors for DirectDeclSmartConstructors<'o, 't> {
    ...
    fn make_named_argument(&mut self, name: Self::Output, equal: Self::Output, expression: Self::Output) -> Self::Output {
        <Self as FlattenSmartConstructors>::make_named_argument(self, name, equal, expression)
    }
    ...
    fn make_lambda_signature(&mut self, function_keyword: Self::Output, type_parameters: Self::Output, left_paren: Self::Output, parameters: Self::Output, right_paren: Self::Output, contexts: Self::Output, colon: Self::Output, readonly_return: Self::Output, type_: Self::Output) -> Self::Output {
        <Self as FlattenSmartConstructors>::make_lambda_signature(self, function_keyword, type_parameters, left_paren, parameters, right_paren, contexts, colon, readonly_return, type_)
    }
    ...
    fn make_closure_type_specifier(&mut self, outer_left_paren: Self::Output, readonly_keyword: Self::Output, function_keyword: Self::Output, type_parameters: Self::Output, inner_left_paren: Self::Output, parameter_list: Self::Output, inner_right_paren: Self::Output, contexts: Self::Output, colon: Self::Output, readonly_return: Self::Output, return_type: Self::Output, outer_right_paren: Self::Output) -> Self::Output {
        <Self as FlattenSmartConstructors>::make_closure_type_specifier(self, outer_left_paren, readonly_keyword, function_keyword, type_parameters, inner_left_paren, parameter_list, inner_right_paren, contexts, colon, readonly_return, return_type, outer_right_paren)
    }
    ...
    fn make_closure_parameter_type_specifier(&mut self, optional: Self::Output, call_convention: Self::Output, named: Self::Output, readonly: Self::Output, pre_ellipsis: Self::Output, type_: Self::Output, name: Self::Output, ellipsis: Self::Output) -> Self::Output {
        <Self as FlattenSmartConstructors>::make_closure_parameter_type_specifier(self, optional, call_convention, named, readonly, pre_ellipsis, type_, name, ellipsis)
    }
    ...
    fn make_class_ptr_type_specifier(&mut self, keyword: Self::Output, left_angle: Self::Output, type_: Self::Output, trailing_comma: Self::Output, right_angle: Self::Output) -> Self::Output {
        <Self as FlattenSmartConstructors>::make_class_ptr_type_specifier(self, keyword, left_angle, type_, trailing_comma, right_angle)
    }
    ...
    fn make_tuple_expression(&mut self, keyword: Self::Output, left_paren: Self::Output, items: Self::Output, ellipsis: Self::Output, right_paren: Self::Output) -> Self::Output {
        <Self as FlattenSmartConstructors>::make_tuple_expression(self, keyword, left_paren, items, ellipsis, right_paren)
    }
    ...
    fn make_module_declaration(&mut self, attribute_spec: Self::Output, new_keyword: Self::Output, module_keyword: Self::Output, name: Self::Output, left_brace: Self::Output, right_brace: Self::Output) -> Self::Output {
        <Self as FlattenSmartConstructors>::make_module_declaration(self, attribute_spec, new_keyword, module_keyword, name, left_brace, right_brace)
    }
