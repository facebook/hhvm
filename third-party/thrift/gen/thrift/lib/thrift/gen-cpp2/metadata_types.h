...
class ThriftConstValue final  {
 ...
 public:
  ...
  int64_t& set_cv_integer(int64_t t = int64_t()) {
    __clear();
    type_ = Type::cv_integer;
    ::new (std::addressof(value_.cv_integer)) int64_t(t);
  ...
  int64_t const & get_cv_integer() const {
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  ...
  // FragileConstructor for use in initialization lists only.
  [[deprecated("This constructor is deprecated")]]
  ThriftEnum(apache::thrift::FragileConstructor, ::std::string name__arg, ::std::map<int32_t, ::std::string> elements__arg, ::std::vector< ::apache::thrift::metadata::ThriftConstStruct> structured_annotations__arg);
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  ...
  // FragileConstructor for use in initialization lists only.
  [[deprecated("This constructor is deprecated")]]
  ThriftField(apache::thrift::FragileConstructor, int32_t id__arg,  ::apache::thrift::metadata::ThriftType type__arg, ::std::string name__arg, bool is_optional__arg, ::std::vector< ::apache::thrift::metadata::ThriftConstStruct> structured_annotations__arg);
