...
bool TestCodeRun::TestTaint() {
  ...
  MVCRO("<?php\n"
        ...
        "$c = new c;\n"
        "$c->p = 'zzz';\n"
        "var_dump(fb_get_taint(\"AAA ${a['x']} $a[x] $b $c->p\", TAINT_ALL));\n"
        "fb_set_taint($b, TAINT_ALL);\n"
        "var_dump(fb_get_taint(\"AAA ${a['x']} $a[x] $b $c->p\", TAINT_ALL));\n"
        "class X {\n"
        "  static function g() {}\n"
        ...
        "unset($tmp);\n"
        "$b = rand() % 42;\n"
        "var_dump(fb_get_taint('abc' . X::g() . $b . $a, TAINT_ALL));\n"
        "fb_set_taint($a, TAINT_ALL);\n"
        "var_dump(fb_get_taint('abc' . X::g() . 42 . $a, TAINT_ALL));\n"
        "var_dump(fb_get_taint('abc' . X::g() . $b . $a, TAINT_ALL));\n"
        "function f() {\n"
        "  $tmp = 'x';\n"
        "  $a = '';\n"
        ...
        "  return $buf;\n"
        "}\n"
        "var_dump(fb_get_taint(test1(array(1)), TAINT_ALL));\n"
        "function test2() {\n"
        "  return f() . g() . f() . g();\n"
        "}\n"
        "var_dump(fb_get_taint(test2(), TAINT_ALL));\n"
        "function test3() {\n"
        "  return f() . g() . f() . g() . f() . g() . f() . g() . f();\n"
        "}\n"
        "var_dump(fb_get_taint(test3(), TAINT_ALL));\n"
        "function test4() {\n"
        "  $s = f();\n"
        "  $s .=\n"
        "    ('foo'.\n"
        ...
        "  return $s;\n"
        "}\n"
        "var_dump(fb_get_taint(test4(), TAINT_ALL));\n"
        "function test6() {\n"
        "  return g().f().g();\n"
        "}\n"
        "var_dump(fb_get_taint(test6(), TAINT_ALL));\n",
        "bool(false)\n"
        "bool(true)\n"
        "bool(true)\n"
        "bool(true)\n"
  ...
  MVCRO("<?php\n"
        ...
        "var_dump(fb_get_taint($arrb[0], TAINT_ALL));\n"
        "$arr = array(\n"
        "  $good1 => $good2,\n"
        "  $bad1  => $bad2,\n"
        "  $bad2  => array(\n"
        ...
        "var_dump(fb_get_taint(print_r($arr, true), TAINT_ALL));\n"
        "var_dump(fb_get_taint($arr[$good1], TAINT_ALL));\n"
        "var_dump(fb_get_taint($arr[$bad1], TAINT_ALL));\n"
        "var_dump(fb_get_taint($arr[$bad2], TAINT_ALL));\n"
        "var_dump(fb_get_taint(print_r($arr[42], true), TAINT_ALL));\n"
        "var_dump(fb_get_taint($arr[$bad2][$good2], TAINT_ALL));\n"
        "var_dump(fb_get_taint($arr[$bad2][$bad2], TAINT_ALL));\n"
        "$keys = array_keys($arr);\n"
        "var_dump(fb_get_taint($keys[0], TAINT_ALL));\n"
        "var_dump(fb_get_taint($keys[1], TAINT_ALL));\n"
        "var_dump(fb_get_taint($keys[2], TAINT_ALL));\n",
        "bool(false)\n"
        "bool(true)\n"
        "bool(false)\n"
        "bool(true)\n"
  ...
  MVCRO("<?php\n"
        ...
        "var_dump(fb_get_taint(strval($good1), TAINT_HTML));\n"
        "var_dump(fb_get_taint(strval($bad1), TAINT_HTML));\n"
        ...
        "var_dump(fb_get_taint($arr['good1'], TAINT_HTML));\n"
        "var_dump(fb_get_taint($arr['bad1'], TAINT_HTML));\n"
        "$arr = array(\n"
        "  'good1' => $good1,\n"
        "  'bad1' => $bad1,\n"
        ");\n"
        "extract($arr, EXTR_PREFIX_ALL, 'extract');\n"
        "var_dump(fb_get_taint($extract_good1, TAINT_HTML));\n"
        "var_dump(fb_get_taint($extract_bad1, TAINT_HTML));\n",
        "bool(false)\n"
        "bool(true)\n"
        "bool(false)\n"
        "bool(false)\n"
  ...
  MVCRO("<?php\n"
        ...
        "  global $good1, $bad1;\n"
        "  var_dump(fb_get_taint($func($good1), TAINT_HTML));\n"
        "  var_dump(fb_get_taint($func($bad1), TAINT_HTML));\n"
        "  var_dump(fb_get_taint($func($good1), TAINT_MUTATED));\n"
        "  var_dump(fb_get_taint($func($bad1), TAINT_MUTATED));\n"
        "}\n"
        "foreach ($common_suite_funcs as $func) {\n"
        "  test_common_suite($func);\n"
        "}\n"
        "var_dump(fb_get_taint(addcslashes($good1, $good2), TAINT_HTML));\n"
        "var_dump(fb_get_taint(addcslashes($bad1, $bad1), TAINT_HTML));\n"
        "var_dump(fb_get_taint(addcslashes($good1, $bad1), TAINT_HTML));\n"
        "var_dump(fb_get_taint(addcslashes($good1, $good2), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(addcslashes($bad1, $bad2), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(rtrim($good1), TAINT_HTML));\n"
        "var_dump(fb_get_taint(rtrim($bad1), TAINT_HTML));\n"
        "var_dump(fb_get_taint(rtrim($good1), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(rtrim($bad1), TAINT_MUTATED));\n"
        "$arr = explode(\"\\n\", $good1);\n"
        "var_dump(fb_get_taint($arr[0], TAINT_HTML));\n"
        "var_dump(fb_get_taint($arr[1], TAINT_HTML));\n"
        "var_dump(fb_get_taint($arr[0], TAINT_MUTATED));\n"
        "var_dump(fb_get_taint($arr[1], TAINT_MUTATED));\n"
        "$arr = explode(\"\\n\", $bad1);\n"
        "var_dump(fb_get_taint($arr[0], TAINT_HTML));\n"
        "var_dump(fb_get_taint($arr[1], TAINT_HTML));\n"
        "var_dump(fb_get_taint($arr[0], TAINT_MUTATED));\n"
        ...
        "$arr[] = $good1;\n"
        "$arr[] = $good2;\n"
        "var_dump(fb_get_taint(implode(\"\\t\", $arr), TAINT_HTML));\n"
        "var_dump(fb_get_taint(implode(\"\\t\", $arr), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(implode($bad2, $arr), TAINT_MUTATED));\n"
        "$arr[] = $bad1;\n"
        "var_dump(fb_get_taint(implode(\"\\t\", $arr), TAINT_HTML));\n"
        "var_dump(fb_get_taint(implode(\"\\t\", $arr), TAINT_MUTATED));\n"
        "$arr = array();\n"
        "$arr[] = $good1;\n"
        "$arr[] = $good2;\n"
        "var_dump(fb_get_taint(join(\"\\t\", $arr), TAINT_HTML));\n"
        "var_dump(fb_get_taint(join(\"\\t\", $arr), TAINT_MUTATED));\n"
        "$arr[] = $bad1;\n"
        "var_dump(fb_get_taint(join(\"\\t\", $arr), TAINT_HTML));\n"
        "var_dump(fb_get_taint(join(\"\\t\", $arr), TAINT_MUTATED));\n"
        ...
        "var_dump(fb_get_taint($arr[0], TAINT_MUTATED));\n"
        "var_dump(fb_get_taint($arr[1], TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(chunk_split($good1, 3, $good2),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(chunk_split($bad1, 3, $good1),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(chunk_split($good1, 3, $bad1),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(chunk_split($good1, 3, $good2),\n"
        "                      TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(chunk_split($bad1, 3, $good1),\n"
        ...
        "var_dump(fb_get_taint(chunk_split($good1, 3, $bad1),\n"
        "                      TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(strtok($good1, \"\\n\"), TAINT_HTML));\n"
        "var_dump(fb_get_taint(strtok(\":\\n\"), TAINT_HTML));\n"
        "var_dump(fb_get_taint(strtok($good1, \"\\n\"), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(strtok(\":\\n\"), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(strtok($bad1, \"\\n\"), TAINT_HTML));\n"
        "var_dump(fb_get_taint(strtok(\":\\n\"), TAINT_HTML));\n"
        "var_dump(fb_get_taint(strtok($bad1, \"\\n\"), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(strtok(\":\\n\"), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_replace($good3, $good2, $good1),\n"
        "                      TAINT_HTML));\n"
        "$arr = array($good1, $good2);\n"
        "$a = str_replace($good3, $good2, $arr);\n"
        "var_dump(fb_get_taint($a[0], TAINT_HTML));\n"
        "var_dump(fb_get_taint($a[1], TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_replace($good3, $bad1, $good1),\n"
        "                      TAINT_HTML));\n"
        "$arr = array($bad1, $bad2);\n"
        "$a = str_replace($good3, $good2, $arr);\n"
        "var_dump(fb_get_taint($a[0], TAINT_HTML));\n"
        "var_dump(fb_get_taint($a[1], TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_ireplace($good3, $good2, $good1),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_ireplace($good3, $good2, $good1),\n"
        "                      TAINT_MUTATED));\n"
        "$arr = array($good1, $good2);\n"
        ...
        "var_dump(fb_get_taint($a[0], TAINT_HTML));\n"
        "var_dump(fb_get_taint($a[1], TAINT_HTML));\n"
        "var_dump(fb_get_taint($a[0], TAINT_MUTATED));\n"
        "// Note: if no replacement occurs, static strings remain static.\n"
        "var_dump(fb_get_taint($a[1], TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_ireplace($good3, $bad1, $good1),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_ireplace($good3, $bad1, $good1),\n"
        "                      TAINT_MUTATED));\n"
        "$arr = array($bad1, $bad2);\n"
        ...
        "var_dump(fb_get_taint($a[0], TAINT_MUTATED));\n"
        "var_dump(fb_get_taint($a[1], TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(substr_replace($good1, $good2, 0, 3),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($good1, $good2, 0),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($bad1, $good1, 0, 3),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($bad1, $good1, 0),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($good1, $bad1, 0, 3),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($good1, $bad1, 0),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($bad1, $bad2, 0, 3),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($bad1, $bad2, 0),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr_replace($good1, $good2, 0, 3),\n"
        "                      TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(substr_replace($good1, $good2, 0),\n"
        ...
        "var_dump(fb_get_taint(substr_replace($bad1, $bad2, 0),\n"
        "                      TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(substr($good1, 5, 5),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr($bad1, 5, 5), TAINT_HTML));\n"
        "var_dump(fb_get_taint(substr($good1, 5, 5), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(substr($bad1, 5, 5), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_pad($good1, 5, $good2), TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_pad($bad1, 5, $good1), TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_pad($good1, 5, $bad1), TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_pad($bad1, 5, $bad2), TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_pad($good1, 5, $good2), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_pad($bad1, 5, $good1), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_pad($good1, 5, $bad1), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_pad($bad1, 5, $bad2), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_repeat($good1, 5), TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_repeat($bad1, 13), TAINT_HTML));\n"
        "var_dump(fb_get_taint(str_repeat($good1, 5), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(str_repeat($bad1, 13), TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(wordwrap($good1, 5, $good2, true),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(wordwrap($bad1, 5, $good1, true),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(wordwrap($good1, 5, $bad1, true),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(wordwrap($bad1, 5, $bad2, true),\n"
        "                      TAINT_HTML));\n"
        "var_dump(fb_get_taint(wordwrap($good1, 5, $good2, true),\n"
        "                      TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(wordwrap($bad1, 5, $good1, true),\n"
        ...
        "var_dump(fb_get_taint(wordwrap($bad1, 5, $bad2, true),\n"
        "                      TAINT_MUTATED));\n"
        "var_dump(fb_get_taint(crc32($good1), TAINT_HTML));\n"
        "$arr = array($good1, $good2);\n"
        "$x = print_r($arr, true);\n"
        "var_dump(fb_get_taint($x, TAINT_HTML));\n"
        "var_dump(fb_get_taint($x, TAINT_MUTATED));\n"
