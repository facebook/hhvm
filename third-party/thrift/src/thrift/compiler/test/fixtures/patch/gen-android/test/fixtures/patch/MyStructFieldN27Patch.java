          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_assign = new HashSet<String>(Math.max(0, 2*_set34.size));
              for (int _i35 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<String>(Math.max(0, 2*_set37.size));
              for (int _i38 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_add = new HashSet<String>(Math.max(0, 2*_set40.size));
              for (int _i41 = 0; 
