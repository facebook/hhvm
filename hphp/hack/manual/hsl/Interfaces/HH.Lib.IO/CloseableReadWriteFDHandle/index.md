---
title: CloseableReadWriteFDHandle
---
...
interface CloseableReadWriteFDHandle implements ReadWriteFDHandle, CloseableWriteFDHandle, CloseableReadFDHandle, CloseableReadWriteHandle {...}
```
