...
public class reqXcep extends Exception implements TBase, java.io.Serializable, Cloneable {
  ...
  static {
    ...
    tmpMetaDataMap.put(ERRORCODE, new FieldMetaData("errorCode", TFieldRequirementType.REQUIRED, 
        new FieldValueMetaData(TType.I32)));
    metaDataMap = Collections.unmodifiableMap(tmpMetaDataMap);
  }

  static {
    FieldMetaData.addStructMetaDataMap(reqXcep.class, metaDataMap);
  }
  ...
  public reqXcep deepCopy() {
    return new reqXcep(this);
  }
  ...
  public reqXcep setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public reqXcep setErrorCode(int errorCode) {
    this.errorCode = errorCode;
    setErrorCodeIsSet(true);
    return this;
  }
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("reqXcep");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
