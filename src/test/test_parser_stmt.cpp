...
bool TestParserStmt::TestYieldStatement() {
  ...
  V2("<?php function foo() { yield break;}",
     ...
     "$" CONTINUATION_OBJECT_NAME "->update(1, null, get_defined_vars());\n"
     "return;\n"
     YIELD_LABEL_PREFIX "1:\n"
     "$" CONTINUATION_OBJECT_NAME "->done();\n"
     "}\n"
     "function foo() {\n"
     "return new Continuation(hphp_get_call_info('', '02316968161694270338_1'), "
            "0, "
            "false, "
            "get_defined_vars());\n"
     "}\n",
     ...
     "function foo() {\n"
     "return new Continuation(hphp_get_call_info('', '02316968161694270338_1'), "
            "hphp_get_call_info_extra('', '02316968161694270338_1'), "
            "false, "
            "get_defined_vars());\n"
     "}\n");

  V2("<?php function foo() { yield 123;}",
     "function (Continuation $" CONTINUATION_OBJECT_NAME ") {\n"
     "extract($" CONTINUATION_OBJECT_NAME "->getVars(), EXTR_REFS);\n"
     "switch ($" CONTINUATION_OBJECT_NAME "->getLabel()) {\n"
     "case 1:\n"
     "goto " YIELD_LABEL_PREFIX "1;\n"
     "}\n"
     "$" CONTINUATION_OBJECT_NAME "->update(1, 123, get_defined_vars());\n"
     "return;\n"
     YIELD_LABEL_PREFIX "1:\n"
     "$" CONTINUATION_OBJECT_NAME "->done();\n"
     "}\n"
  ...
  V2("<?php class bar { function foo() { yield 123; yield 456;} }",
     "class bar {\n"
     "public function foo() {\n"
     "return new Continuation("
            "hphp_get_call_info('bar', '02316968161694270338_1'), "
            "0, "
            "true, "
            "get_defined_vars(), "
            "hphp_get_this());\n"
     ...
     "return;\n"
     YIELD_LABEL_PREFIX "1:\n"
     "$" CONTINUATION_OBJECT_NAME "->update(2, 456, get_defined_vars());\n"
     "return;\n"
     ...
     "return new Continuation("
            "hphp_get_call_info('bar', '02316968161694270338_1'), "
            "hphp_get_call_info_extra('bar', '02316968161694270338_1'), "
            "true, "
            "get_defined_vars(), "
            "hphp_get_this());\n"
     "}\n"
