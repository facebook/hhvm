...
public class MyUnionSafePatch implements TBase, java.io.Serializable, Cloneable, Comparable<MyUnionSafePatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MyUnionSafePatch.class, metaDataMap);
  }
   ...
   */
  public MyUnionSafePatch(MyUnionSafePatch other) {
  ...
  public MyUnionSafePatch deepCopy() {
    return new MyUnionSafePatch(this);
  }
  ...
  public MyUnionSafePatch setVersion(int version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public MyUnionSafePatch setData(byte[] data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof MyUnionSafePatch))
      return false;
    MyUnionSafePatch that = (MyUnionSafePatch)_that;
  ...
  @Override
  public int compareTo(MyUnionSafePatch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MyUnionSafePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
