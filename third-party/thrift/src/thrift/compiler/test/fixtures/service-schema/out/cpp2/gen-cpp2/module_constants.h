...
namespace module_constants {
  ...
  FOLLY_EXPORT ::std::string_view _fbthrift_schema_b747839c13cb3aa5();

  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_b747839c13cb3aa5_includes();
