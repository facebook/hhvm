...
public class StructWithRefTypeUnique implements TBase, java.io.Serializable, Cloneable {
  ...
  public static StructWithRefTypeUnique deserialize(TProtocol iprot) throws TException {
    ...
    StructWithRefTypeUnique _that;
    _that = new StructWithRefTypeUnique(
      tmp_def_field
      ,tmp_opt_field
      ,tmp_req_field
    );
