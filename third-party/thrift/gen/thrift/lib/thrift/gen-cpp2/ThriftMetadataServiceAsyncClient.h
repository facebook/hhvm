...
class ThriftMetadataServiceAsyncClient : public apache::thrift::GeneratedAsyncClient {
 ...
 protected:
  void getThriftServiceMetadataImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback);
 public:
 ...
 private:
  ...
  void getThriftServiceMetadataT(Protocol_* prot, const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback);
  std::pair<std::unique_ptr<::apache::thrift::ContextStack>, std::shared_ptr<::apache::thrift::transport::THeader>> getThriftServiceMetadataCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
};
