...
pub(crate) fn get_type_structure_for_hint<'decl>(
    e: &mut Emitter<'decl>,
    tparams: &[&str],
...
fn emit_exprs_and_error_on_inout<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
...
fn emit_named_collection<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    expr: &ast::Expr,
...
fn emit_named_collection_str<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    expr: &ast::Expr,
...
fn emit_keyvalue_collection<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    fields: &[ast::Afield],
...
fn emit_dynamic_collection<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    expr: &ast::Expr,
    fields: &[ast::Afield],
...
fn emit_value_only_collection<'a, 'decl, F: FnOnce(u32) -> Instruct>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    fields: &[ast::Afield],
...
fn emit_call_isset_expr<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    outer_pos: &Pos,
    pk: &ParamKind,
...
fn emit_call_isset_exprs<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    exprs: &[(ParamKind, ast::Expr)],
...
fn emit_tag_provenance_here<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
...
fn emit_array_mark_legacy<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    es: &[(ParamKind, ast::Expr)],
...
pub fn emit_reified_targs<'a, 'decl, I>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    targs: I,
...
fn emit_call_lhs_and_fcall<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    expr: &ast::Expr,
...
fn emit_args_inout_setters<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    args: &[(ParamKind, ast::Expr)],
) -> Result<(InstrSeq, InstrSeq)> {
    ...
    fn emit_arg_and_inout_setter<'a, 'decl>(
        e: &mut Emitter<'decl>,
        env: &Env<'a>,
        i: usize,
        pk: &ParamKind,
...
fn emit_special_function<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    targs: &[ast::Targ],
...
fn emit_class_meth_native<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    cid: &ast::ClassId,
...
fn emit_function_pointer<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
...
fn emit_keyval_collection_expr<'a, 'decl>(
    emitter: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    e: &(
...
fn emit_new_obj_reified_instrs<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    op: NewObjOpInfo<'_>,
...
fn emit_store_for_simple_base<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
...
fn emit_conditional_expr<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    etest: &ast::Expr,
...
fn emit_null_coalesce_assignment<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    e1: &ast::Expr,
...
fn emit_short_circuit_op<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    expr: &ast::Expr,
...
pub fn emit_set_range_expr<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &mut Env<'a>,
    pos: &Pos,
    name: &str,
...
pub fn emit_ignored_exprs<'a, 'decl>(
    emitter: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    exprs: &[ast::Expr],
...
pub fn emit_ignored_expr<'a, 'decl>(
    emitter: &mut Emitter<'decl>,
    env: &Env<'a>,
    pos: &Pos,
    expr: &ast::Expr,
...
pub fn emit_lval_op_list<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    outer_pos: &Pos,
    local: Option<&Local>,
...
pub fn emit_lval_op_nonlist<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    outer_pos: &Pos,
    op: LValOp,
...
pub fn emit_lval_op_nonlist_steps<'a, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'a>,
    outer_pos: &Pos,
    op: LValOp,
...
pub fn emit_reified_arg<'b, 'decl>(
    e: &mut Emitter<'decl>,
    env: &Env<'b>,
    pos: &Pos,
    isas: bool,
