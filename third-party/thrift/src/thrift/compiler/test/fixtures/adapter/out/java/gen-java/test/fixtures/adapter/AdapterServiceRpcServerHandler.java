...
public class AdapterServiceRpcServerHandler 
  ...
  public AdapterServiceRpcServerHandler(AdapterService _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new AdapterServiceBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public AdapterServiceRpcServerHandler(AdapterService.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new AdapterServiceAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public AdapterServiceRpcServerHandler(AdapterService.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
  ...
  private static java.util.List<com.facebook.thrift.payload.Reader> _create_count_request_readers() {
  ...
  private static com.facebook.thrift.payload.Writer _create_count_response_writer(
    ...
    com.facebook.swift.service.ContextChain _chain) {
          ...
          reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload> _internalResponse =
            _delegateResponse.map(_response -> {
              ...
              com.facebook.thrift.payload.ServerResponsePayload _serverResponsePayload =
                com.facebook.thrift.util.RpcPayloadUtil.createServerResponsePayload(
                  _payload,
                  _create_count_response_writer(_response, _chain, _payload.getMessageSeqId()));
              ...
              reactor.core.publisher.Mono.fromSupplier(
                () -> {
                  org.apache.thrift.TApplicationException _tApplicationException =
                    new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "method count returned null");
            ...
            .<com.facebook.thrift.payload.ServerResponsePayload>onErrorResume(_t -> {
                ...
                String _errorMessage = String.format("Internal error processing count: %s", _t.getMessage() == null ? "<null>" : _t.getMessage());
                org.apache.thrift.TApplicationException _tApplicationException =
  ...
  public reactor.core.publisher.Flux<com.facebook.thrift.payload.ServerResponsePayload> singleRequestStreamingResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    final String _qualifiedMethodName = "AdapterService." + _name;
