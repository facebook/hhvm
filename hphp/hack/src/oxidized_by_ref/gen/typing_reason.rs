...
//
// @generated SignedSource<<ab7a9d4788704af1cd86f171674935e7>>
//
...
pub enum WitnessLocl<'a> {
    ...
    StaticPropertyAccess(&'a pos::Pos<'a>),
    #[serde(deserialize_with = "arena_deserializer::arena", borrow)]
    #[rust_to_ocaml(name = "Class_constant_access")]
    ClassConstantAccess(&'a pos::Pos<'a>),
}
...
pub enum T_<'a> {
    ...
    #[rust_to_ocaml(inline_tuple)]
    LikeCall(&'a (&'a pos_or_decl::PosOrDecl<'a>, T_<'a>)),
}
