...
public class MyServiceReactiveClient 
  ...
  private static final TField _query_U_FIELD_DESC = new TField("u", TType.STRUCT, (short)1);
  ...
  private com.facebook.thrift.payload.Writer _createqueryWriter(final test.fixtures.basic.MyUnion u) {
    return oprot -> {
      try {
        {
          oprot.writeFieldBegin(_query_U_FIELD_DESC);

          test.fixtures.basic.MyUnion _iter0 = u;
  ...
  private static final com.facebook.thrift.payload.Reader _query_READER = Readers.wrap(test.fixtures.basic.MyStruct.asReader());

  @java.lang.Override
  public reactor.core.publisher.Mono<com.facebook.thrift.client.ResponseWrapper<test.fixtures.basic.MyStruct>> queryWrapper(final test.fixtures.basic.MyUnion u,  final com.facebook.thrift.client.RpcOptions rpcOptions) {
    return _rpcClient
      .flatMap(_rpc -> {
  ...
  @java.lang.Override
  public reactor.core.publisher.Mono<test.fixtures.basic.MyStruct> query(final test.fixtures.basic.MyUnion u,  final com.facebook.thrift.client.RpcOptions rpcOptions) {
    return queryWrapper(u,  rpcOptions).map(_p -> _p.getData());
  }

  @java.lang.Override
  public reactor.core.publisher.Mono<test.fixtures.basic.MyStruct> query(final test.fixtures.basic.MyUnion u) {
    return query(u,  com.facebook.thrift.client.RpcOptions.EMPTY);
  }
