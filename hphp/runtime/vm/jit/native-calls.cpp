...
static CallMap s_callMap {
    ...
    {LdPublicFunc,       loadPublicFunction, DSSA, SSync, {}},
    ...
    {ThrowMissingNamedParam,
                         throwMissingNamedParam, DNone, SSync,
                         {extra(&FuncData::func), {SSA, 0}}},
    {ThrowNamedArgumentNameMismatch,
                         throwNamedArgumentNameMismatch, DNone, SSync,
                         {extra(&FuncData::func), {SSA, 0}}},
    {ThrowUnexpectedNamedArguments,
                         throwUnexpectedNamedArguments, DNone, SSync,
                         {extra(&FuncData::func)}},
    ...
    {CheckFunReifiedGenericMismatch, checkFunReifiedGenericMismatch,
                                     DNone, SSync,
                                     {{SSA, 0}, {SSA, 1}}},
    {CheckFunNamedArgsMismatch, checkFunNamedArgsMismatch,
                                     DNone, SSync,
                                     {{SSA, 0}, {SSA, 1}}},
