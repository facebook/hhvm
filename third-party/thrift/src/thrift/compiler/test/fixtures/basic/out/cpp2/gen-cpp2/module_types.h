...
class MyUnion final  {
 ...
 public:
  ...
  /** Glean { "field": "myEnum" } */
  FOLLY_ERASE ::apache::thrift::union_field_ref<const ::test::fixtures::basic::MyEnumAlias&> myEnum() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
    return {value_.myEnum, fbthrift_type_, folly::to_underlying(Type::myEnum), this, ::apache::thrift::detail::union_field_ref_owner_vtable_for<decltype(*this)>};
  }

  /** Glean { "field": "myEnum" } */
  FOLLY_ERASE ::apache::thrift::union_field_ref<::test::fixtures::basic::MyEnumAlias&> myEnum() & [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
    return {value_.myEnum, fbthrift_type_, folly::to_underlying(Type::myEnum), this, ::apache::thrift::detail::union_field_ref_owner_vtable_for<decltype(*this)>};
  }
  ...
  /** Glean { "field": "myStruct" } */
  FOLLY_ERASE ::apache::thrift::union_field_ref<const ::test::fixtures::basic::MyStruct&> myStruct() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
    return {value_.myStruct, fbthrift_type_, folly::to_underlying(Type::myStruct), this, ::apache::thrift::detail::union_field_ref_owner_vtable_for<decltype(*this)>};
  }

  /** Glean { "field": "myStruct" } */
  FOLLY_ERASE ::apache::thrift::union_field_ref<::test::fixtures::basic::MyStruct&> myStruct() & [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
    return {value_.myStruct, fbthrift_type_, folly::to_underlying(Type::myStruct), this, ::apache::thrift::detail::union_field_ref_owner_vtable_for<decltype(*this)>};
  }
  ...
  /** Glean { "field": "myDataItem" } */
  FOLLY_ERASE ::apache::thrift::union_field_ref<const ::test::fixtures::basic::MyDataItem&> myDataItem() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
    return {value_.myDataItem, fbthrift_type_, folly::to_underlying(Type::myDataItem), this, ::apache::thrift::detail::union_field_ref_owner_vtable_for<decltype(*this)>};
  }

  /** Glean { "field": "myDataItem" } */
  FOLLY_ERASE ::apache::thrift::union_field_ref<::test::fixtures::basic::MyDataItem&> myDataItem() & [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
    return {value_.myDataItem, fbthrift_type_, folly::to_underlying(Type::myDataItem), this, ::apache::thrift::detail::union_field_ref_owner_vtable_for<decltype(*this)>};
  }
...
template <> struct TSchemaAssociation<::test::fixtures::basic::MyStruct, false> {
  ...
  static constexpr ::std::string_view definitionKey = {"\x9f\x1c\x8f\x42\xa0\x25\xf9\xb6\x72\xfd\xe1\x07\x58\xd4\x68\x73", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::Containers, false> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\x8b\x21\x52\x94\x1c\x0b\xec\xa9\x4b\x83\x5a\xb0\x32\x93\xd6\x25", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::MyDataItem, false> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\xd4\x5a\xac\xbe\x7b\xab\xf2\x89\xfd\x75\x52\x44\x33\x87\xcc\x0a", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::MyUnion, false> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\x49\x78\xdc\x0d\xc3\x56\x12\xd2\xbe\x50\x82\x37\x64\x2b\x77\xbd", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::MyException, false> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\x6e\x53\x1a\x17\x84\xf7\xc0\xfb\xfa\x67\x3d\xbb\xc2\xbf\x54\x11", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::MyExceptionWithMessage, false> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\xcf\x2d\x7c\x04\xf0\xf6\x8f\xec\xae\x1e\xdc\xfc\x87\xf9\xf2\xfe", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::ReservedKeyword, false> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\xf7\x34\xc7\x98\x42\x01\xeb\x1e\x26\xfe\xa4\xf2\xac\x60\x6b\x69", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::UnionToBeRenamed, false> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\xf2\x18\xd3\x7e\x1f\xf4\x6a\xdd\x0c\x16\x2a\xfb\x29\x8f\x15\xa3", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::MyEnum, true> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\x58\xbd\xc1\xd6\xab\x95\x6b\xa9\x69\x13\x49\x30\x8f\xf5\x6b\x46", 16};
};
template <> struct TSchemaAssociation<::test::fixtures::basic::HackEnum, true> {
  static ::folly::Range<const ::std::string_view*> bundle();
  static constexpr int64_t programId = 155903679714251971;
  static constexpr ::std::string_view definitionKey = {"\x98\x64\xed\xc3\x2d\x54\x56\xa3\x6b\xb8\x9a\x71\x16\x6d\x8d\xa9", 16};
};
} // namespace apache::thrift::detail
