...
class Baz:
    ...
    def _to_mutable_python(self) -> "facebook.thrift.test.module.thrift_mutable_types.Baz": ...   # type: ignore
...
class IndependentDirectlyAdapted:
    ...
    def _to_mutable_python(self) -> "facebook.thrift.test.module.thrift_mutable_types.IndependentDirectlyAdapted": ...   # type: ignore
...
class AdaptTemplatedTestStruct:
    ...
    def _to_mutable_python(self) -> "facebook.thrift.test.module.thrift_mutable_types.AdaptTemplatedTestStruct": ...   # type: ignore
...
class SameNamespaceStruct:
    ...
    def _to_mutable_python(self) -> "facebook.thrift.test.module.thrift_mutable_types.SameNamespaceStruct": ...   # type: ignore
...
class ApplyAdapter:
    ...
    def _to_mutable_python(self) -> "facebook.thrift.test.module.thrift_mutable_types.ApplyAdapter": ...   # type: ignore
...
class RenamedStructWithStructAdapterAndFieldAdapter:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.test.module.thrift_types.RenamedStructWithStructAdapterAndFieldAdapter": ...   # type: ignore
    def _to_mutable_python(self) -> "facebook.thrift.test.module.thrift_mutable_types.RenamedStructWithStructAdapterAndFieldAdapter": ...   # type: ignore
