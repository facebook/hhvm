...
#include "../../../../src/thrift/lib/thrift/gen-cpp2/frozen_types.tcc"

#include <thrift/lib/cpp2/gen/module_types_cpp.h>

#include "../../../../src/thrift/lib/thrift/gen-cpp2/frozen_data.h"
...
void Field::__clear() {
  // clear all fields
  this->layoutId = 0;
  this->offset = static_cast<int16_t>(0);
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  __isset = {};
THRIFT_IGNORE_ISSET_USE_WARNING_END
}
...
Layout& Layout::operator=(const Layout&) = default;
THRIFT_IGNORE_ISSET_USE_WARNING_END
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
...
Layout& Layout::operator=(FOLLY_MAYBE_UNUSED Layout&& other) noexcept {
    this->size = std::move(other.size);
    this->bits = std::move(other.bits);
    this->fields = std::move(other.fields);
    this->typeName = std::move(other.typeName);
    __isset = other.__isset;
    return *this;
}
THRIFT_IGNORE_ISSET_USE_WARNING_END
...
void Layout::__clear() {
  // clear all fields
  this->size = 0;
  this->bits = static_cast<int16_t>(0);
  this->fields.clear();
  this->typeName = apache::thrift::StringTraits<std::string>::fromStringLiteral("");
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  __isset = {};
THRIFT_IGNORE_ISSET_USE_WARNING_END
}
...
Schema::Schema(Schema&& other) noexcept  :
    ...
    relaxTypeChecks(std::move(other.relaxTypeChecks)),
    layouts(std::move(other.layouts)),
    rootLayout(std::move(other.rootLayout)),
    __isset(other.__isset) {}
Schema& Schema::operator=(FOLLY_MAYBE_UNUSED Schema&& other) noexcept {
    this->fileVersion = std::move(other.fileVersion);
    this->relaxTypeChecks = std::move(other.relaxTypeChecks);
    this->layouts = std::move(other.layouts);
    this->rootLayout = std::move(other.rootLayout);
    __isset = other.__isset;
    return *this;
}
THRIFT_IGNORE_ISSET_USE_WARNING_END
...
void Schema::__clear() {
  // clear all fields
  this->fileVersion = 0;
  this->relaxTypeChecks = 0;
  this->layouts.clear();
  this->rootLayout = static_cast<int16_t>(0);
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  __isset = {};
THRIFT_IGNORE_ISSET_USE_WARNING_END
}
