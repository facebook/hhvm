...
public class OptionalI16Patch implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("OptionalI16Patch");
   ...
   */
  public OptionalI16Patch(OptionalI16Patch other) {
    if (other.isSetClear()) {
  ...
  public OptionalI16Patch deepCopy() {
    return new OptionalI16Patch(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof OptionalI16Patch))
      return false;
    OptionalI16Patch that = (OptionalI16Patch)_that;
  ...
  public static OptionalI16Patch deserialize(TProtocol iprot) throws TException {
    Boolean tmp_clear = null;
    I16Patch tmp_patchPrior = null;
    Short tmp_ensure = null;
    I16Patch tmp_patch = null;
    TField __field;
      ...
      switch (__field.id)
      {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            tmp_patchPrior = I16Patch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        ...
        case PATCH:
          if (__field.type == TType.STRUCT) {
            tmp_patch = I16Patch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
    ...
    OptionalI16Patch _that;
    _that = new OptionalI16Patch(
      tmp_clear
      ,tmp_patchPrior
      ,tmp_ensure
      ,tmp_patch
