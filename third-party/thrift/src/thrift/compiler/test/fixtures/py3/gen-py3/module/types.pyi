...
class _std_unordered_map__Map__i32_SimpleStruct(_typing.Mapping[int, SimpleStruct], _typing.Hashable):
    def __init__(self, items: _typing.Optional[_typing.Mapping[int, SimpleStruct]]=None) -> None: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __copy__(self) -> _typing.Mapping[int, SimpleStruct]: ...
    def __getitem__(self, key: int) -> SimpleStruct: ...
    def __iter__(self) -> _typing.Iterator[int]: ...
