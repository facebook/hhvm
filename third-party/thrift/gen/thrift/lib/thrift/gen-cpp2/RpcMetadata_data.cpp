...
const std::array<::apache::thrift::InterfaceKind, 3> TEnumDataStorage<::apache::thrift::InterfaceKind>::values = {{
  type::USER,
  type::DEBUGGING,
  type::MONITORING,
}};
const std::array<folly::StringPiece, 3> TEnumDataStorage<::apache::thrift::InterfaceKind>::names = {{
  "USER",
  "DEBUGGING",
  "MONITORING",
}};
