...
[` KeyedIterable `](/docs/apis/Interfaces/HH/KeyedIterable/) up to but not including the first value that produces
...
* [` KeyedIterable<Tk, `](/docs/apis/Interfaces/HH/KeyedIterable/)`` Tv> `` - A [` KeyedIterable `](/docs/apis/Interfaces/HH/KeyedIterable/) that is a proper subset of the current
  [` KeyedIterable `](/docs/apis/Interfaces/HH/KeyedIterable/) up until the callback returns `` false ``.
<!-- HHAPIDOC -->
