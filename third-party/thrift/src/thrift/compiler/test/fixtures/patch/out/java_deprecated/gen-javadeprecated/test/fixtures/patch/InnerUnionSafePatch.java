...
public class InnerUnionSafePatch implements TBase, java.io.Serializable, Cloneable, Comparable<InnerUnionSafePatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(InnerUnionSafePatch.class, metaDataMap);
  }
  ...
  public InnerUnionSafePatch setVersion(int version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public InnerUnionSafePatch setData(byte[] data) {
    this.data = data;
    return this;
  }
  ...
  @Override
  public int compareTo(InnerUnionSafePatch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("InnerUnionSafePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
