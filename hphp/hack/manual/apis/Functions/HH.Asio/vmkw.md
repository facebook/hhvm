...
This function is similar to ` vmk() `, except the [` Vector `](/docs/apis/Classes/HH/Vector/) in the returned
[` Awaitable `](/docs/apis/Classes/HH/Awaitable/) contains `` ResultOrExceptionWrapper ``s instead of raw values.




This function is similar to [` Vector::mapWithKey() `](/docs/apis/Classes/HH/Vector/mapWithKey/), but the mapping of the
