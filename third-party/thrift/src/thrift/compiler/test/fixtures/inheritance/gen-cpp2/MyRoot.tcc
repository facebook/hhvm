...
void MyRootAsyncProcessor::executeRequest_do_root(apache::thrift::ServerRequest&& serverRequest) {
  ...
  apache::thrift::ContextStack::UniquePtr ctxStack = apache::thrift::ContextStack::create(this->coalesceLegacyEventHandlersWith(server), this->getServiceName(), "MyRoot.do_root", serverRequest.requestContext());
  try {
