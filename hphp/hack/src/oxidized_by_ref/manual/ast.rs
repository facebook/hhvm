...
pub type ClassTparams<'a> = aast::ClassTparams<'a, Ex<'a>, Fb, En, Hi>;
pub type ClassTypeconst<'a> = aast::ClassTypeconst<'a, Ex<'a>, Fb, En, Hi>;
...
pub type MethodRedeclaration<'a> = aast::MethodRedeclaration<'a, Ex<'a>, Fb, En, Hi>;
