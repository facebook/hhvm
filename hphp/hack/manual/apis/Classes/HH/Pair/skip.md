...
element 3 in a [` Pair `](/docs/apis/Classes/HH/Pair/), but if you specify an element greater than or equal
to 2, it will just return empty. If you specify 0, it will return all the
elements in the [` Pair `](/docs/apis/Classes/HH/Pair/).
...
* [` ImmVector<mixed> `](/docs/apis/Classes/HH/ImmVector/) - An [` ImmVector `](/docs/apis/Classes/HH/ImmVector/) that contains values after the specified `` n ``-th
  element in the current [` Pair `](/docs/apis/Classes/HH/Pair/).
