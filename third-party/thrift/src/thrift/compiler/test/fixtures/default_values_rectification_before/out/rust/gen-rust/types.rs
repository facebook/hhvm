...
impl ::fbthrift::GetUri for self::EmptyStruct {
    fn uri() -> &'static ::std::primitive::str {
        "facebook.com/thrift/compiler/test/fixtures/default_values_rectification_before/EmptyStruct"
    }
}
...
impl ::fbthrift::GetUri for self::TestStruct {
    fn uri() -> &'static ::std::primitive::str {
        "facebook.com/thrift/compiler/test/fixtures/default_values_rectification_before/TestStruct"
    }
}
