...
pub mod classes {
    ...
    pub static cConcrete: Lazy<TypeName> = lazy!(sn::classes::CONCRETE);
...
pub mod user_attributes {
    ...
    pub static uaUnsafeAllowMultipleInstantiations: Lazy<TypeName> =
...
pub mod unstable_features {
    ...
    pub static named_parameters: Lazy<Symbol> = lazy!(sn::unstable_features::NAMED_PARAMETERS);
}
...
pub mod expression_trees {
    ...
    pub static visitSubscriptAssign: Lazy<MethodName> =
