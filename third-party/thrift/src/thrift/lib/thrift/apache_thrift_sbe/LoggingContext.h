...
private:
     ...
     *       V0_BLOCK -> V0_BLOCK [label="  logErrorSampleRatio(?)  "];
     *       V0_BLOCK -> V0_BLOCK [label="  requestIdLength()  "];
...
public:
    ...
    LoggingContext(char *buffer, const std::uint64_t bufferLength) :
        LoggingContext(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    LoggingContext(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        LoggingContext(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    LoggingContext &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    LoggingContext &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        LoggingContext skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion, m_codecState);
        skipper.skip();
    ...
    SBE_NODISCARD static const char *logSampleRatioMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t logSampleRatioSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t logSampleRatioEncodingOffset() SBE_NOEXCEPT
    {
        return 0;
    }
    ...
    void onLogSampleRatioAccessed() const
    {
        if (codecState() == CodecState::NOT_WRAPPED)
        {
            throw AccessOrderError(std::string("Illegal field access order. ") +
                "Cannot access field \"logSampleRatio\" in state: " + codecStateName(codecState()) +
...
public:
    ...
    LoggingContext &logSampleRatio(const std::int32_t value)
    {
    ...
    SBE_NODISCARD static const char *logErrorSampleRatioMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t logErrorSampleRatioId() SBE_NOEXCEPT
    {
        return 2;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t logErrorSampleRatioSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool logErrorSampleRatioInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t logErrorSampleRatioEncodingOffset() SBE_NOEXCEPT
    {
        return 4;
    }

private:
    void onLogErrorSampleRatioAccessed() const
    {
        if (codecState() == CodecState::NOT_WRAPPED)
        {
            throw AccessOrderError(std::string("Illegal field access order. ") +
                "Cannot access field \"logErrorSampleRatio\" in state: " + codecStateName(codecState()) +
                ". Expected one of these transitions: [" + codecStateTransitions(codecState()) +
                "]. Please see the diagram in the docs of the enum LoggingContext::CodecState.");
        }
    }
...
public:
    static SBE_CONSTEXPR std::int32_t logErrorSampleRatioNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT32;
    }

    static SBE_CONSTEXPR std::int32_t logErrorSampleRatioMinValue() SBE_NOEXCEPT
    {
        return INT32_C(-2147483647);
    }

    static SBE_CONSTEXPR std::int32_t logErrorSampleRatioMaxValue() SBE_NOEXCEPT
    {
        return INT32_C(2147483647);
    }

    static SBE_CONSTEXPR std::size_t logErrorSampleRatioEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t logErrorSampleRatio() const
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onLogErrorSampleRatioAccessed();
#endif
        std::int32_t val;
    ...
    LoggingContext &logErrorSampleRatio(const std::int32_t value)
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    static const char *requestIdCharacterEncoding() SBE_NOEXCEPT
    {
        return "UTF-8";
    }

    static SBE_CONSTEXPR std::uint64_t requestIdSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool requestIdInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }
    ...
    static SBE_CONSTEXPR std::uint64_t requestIdHeaderLength() SBE_NOEXCEPT
    {
        return 4;
    }

private:
    void onRequestIdLengthAccessed() const
    {
        switch (codecState())
        {
            ...
            default:
                throw AccessOrderError(std::string("Illegal field access order. ") +
                    "Cannot decode length of var data \"requestId\" in state: " + codecStateName(codecState()) +
                    ". Expected one of these transitions: [" + codecStateTransitions(codecState()) +
                    "]. Please see the diagram in the docs of the enum LoggingContext::CodecState.");
        }
    }
...
public:
    SBE_NODISCARD std::uint32_t requestIdLength() const
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRequestIdLengthAccessed();
#endif
        std::uint32_t length;
...
private:
    void onRequestIdAccessed()
    {
        switch (codecState())
        {
            case CodecState::V0_BLOCK:
                codecState(CodecState::V0_REQUESTID_DONE);
                break;
            default:
                throw AccessOrderError(std::string("Illegal field access order. ") +
                    "Cannot access field \"requestId\" in state: " + codecStateName(codecState()) +
                    ". Expected one of these transitions: [" + codecStateTransitions(codecState()) +
                    "]. Please see the diagram in the docs of the enum LoggingContext::CodecState.");
        }
    }
...
public:
    ...
    SBE_NODISCARD const char *requestId()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRequestIdAccessed();
#endif
    ...
    std::uint64_t getRequestId(char *dst, const std::uint64_t length)
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRequestIdAccessed();
#endif
    ...
    std::string getRequestIdAsString()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRequestIdAccessed();
#endif
    ...
    std::string getRequestIdAsJsonEscapedString()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRequestIdAccessed();
#endif
        std::ostringstream oss;
        std::string s = getRequestIdAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getRequestIdAsStringView()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRequestIdAccessed();
#endif
    ...
    LoggingContext &putRequestId(const std::string &str)
    {
    ...
    #if __cplusplus >= 201703L
    LoggingContext &putRequestId(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    SBE_NODISCARD static const char *routingTargetMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static const char *routingTargetCharacterEncoding() SBE_NOEXCEPT
    {
        return "UTF-8";
    }

    static SBE_CONSTEXPR std::uint64_t routingTargetSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool routingTargetInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    static SBE_CONSTEXPR std::uint16_t routingTargetId() SBE_NOEXCEPT
    {
        return 4;
    }

    static SBE_CONSTEXPR std::uint64_t routingTargetHeaderLength() SBE_NOEXCEPT
    {
        return 4;
    }

private:
    void onRoutingTargetLengthAccessed() const
    {
        switch (codecState())
        {
            case CodecState::V0_REQUESTID_DONE:
                break;
            default:
                throw AccessOrderError(std::string("Illegal field access order. ") +
                    "Cannot decode length of var data \"routingTarget\" in state: " + codecStateName(codecState()) +
                    ". Expected one of these transitions: [" + codecStateTransitions(codecState()) +
                    "]. Please see the diagram in the docs of the enum LoggingContext::CodecState.");
        }
    }
...
public:
    SBE_NODISCARD std::uint32_t routingTargetLength() const
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRoutingTargetLengthAccessed();
#endif
        std::uint32_t length;
        std::memcpy(&length, m_buffer + sbePosition(), sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(length);
...
private:
    void onRoutingTargetAccessed()
    {
        switch (codecState())
        {
            case CodecState::V0_REQUESTID_DONE:
                codecState(CodecState::V0_ROUTINGTARGET_DONE);
                break;
            default:
                throw AccessOrderError(std::string("Illegal field access order. ") +
                    "Cannot access field \"routingTarget\" in state: " + codecStateName(codecState()) +
                    ". Expected one of these transitions: [" + codecStateTransitions(codecState()) +
                    "]. Please see the diagram in the docs of the enum LoggingContext::CodecState.");
        }
    }
...
public:
    std::uint64_t skipRoutingTarget()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
    ...
    SBE_NODISCARD const char *routingTarget()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRoutingTargetAccessed();
#endif
    ...
    std::uint64_t getRoutingTarget(char *dst, const std::uint64_t length)
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRoutingTargetAccessed();
#endif
    ...
    std::string getRoutingTargetAsString()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRoutingTargetAccessed();
#endif
    ...
    std::string getRoutingTargetAsJsonEscapedString()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRoutingTargetAccessed();
#endif
        std::ostringstream oss;
        std::string s = getRoutingTargetAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getRoutingTargetAsStringView()
    {
#if defined(SBE_ENABLE_PRECEDENCE_CHECKS)
        onRoutingTargetAccessed();
#endif
    ...
    LoggingContext &putRoutingTarget(const std::string &str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    LoggingContext &putRoutingTarget(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    std::basic_ostream<CharT, Traits> &builder, const LoggingContext &_writer)
{
    ...
    builder << ", ";
    builder << R"("logErrorSampleRatio": )";
    builder << +writer.logErrorSampleRatio();

    builder << ", ";
    builder << R"("requestId": )";
    builder << '"' <<
        writer.getRequestIdAsJsonEscapedString().c_str() << '"';

    builder << ", ";
    builder << R"("routingTarget": )";
    builder << '"' <<
