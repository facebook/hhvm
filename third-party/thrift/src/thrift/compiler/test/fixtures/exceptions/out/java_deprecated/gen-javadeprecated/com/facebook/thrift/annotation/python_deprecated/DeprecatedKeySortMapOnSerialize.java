...
public class DeprecatedKeySortMapOnSerialize implements TBase, java.io.Serializable, Cloneable, Comparable<DeprecatedKeySortMapOnSerialize> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(DeprecatedKeySortMapOnSerialize.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public DeprecatedKeySortMapOnSerialize build() {
      DeprecatedKeySortMapOnSerialize result = new DeprecatedKeySortMapOnSerialize();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(DeprecatedKeySortMapOnSerialize other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("DeprecatedKeySortMapOnSerialize");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
