...
impl ::fbthrift::ThriftEnum for TypedEnum {
    ...
    fn from_inner_value(inner_value: i32) -> ::anyhow::Result<Self> {
        inner_value.try_into().map(Self).map_err(|e| {
            ::anyhow::anyhow!("Value {inner_value} is out of range for TypedEnum: {e}")
        })
    }
}
...
impl ::std::str::FromStr for TypedEnum {
    ...
    fn from_str(string: &::std::primitive::str) -> ::std::result::Result<Self, Self::Err> {
        ...
        ::fbthrift::help::enum_from_str(VARIANTS_BY_NAME, string, "TypedEnum").map(|v| Self(v as i32))
    }
}
...
impl ::fbthrift::help::clap::builder::ValueParserFactory for TypedEnum {
    type Parser = ::fbthrift::clap::ThriftEnumValueParser<Self>;
