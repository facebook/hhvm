...
+ [` ::_getValidErrno(): Errno `](/docs/hsl/Classes/HH.Lib.OS/NotFoundException/_getValidErrno/)
+ [` ->__construct(string $message) `](/docs/hsl/Classes/HH.Lib.OS/NotFoundException/__construct/)
