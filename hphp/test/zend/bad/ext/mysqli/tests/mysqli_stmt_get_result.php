<?php
	...
	*/
	...
	$tmp	= NULL;
	$link   = NULL;
	$test_table_name = 'test_mysqli_stmt_get_result_table_1'; require('table.inc');
	...
	if (!mysqli_stmt_prepare($stmt, "SELECT id, label FROM test_mysqli_stmt_get_result_table_1 ORDER BY id LIMIT 2"))
...
?>
<?php
	$test_table_name = 'test_mysqli_stmt_get_result_table_1'; require_once("clean_table.inc");
?>