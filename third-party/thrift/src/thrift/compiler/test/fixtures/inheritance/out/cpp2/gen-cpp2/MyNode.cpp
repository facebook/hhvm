...
apache::thrift::ServiceHandler<::cpp2::MyNode>::semifuture_do_mid() {
  auto expected{apache::thrift::detail::si::InvocationType::SemiFuture};
  __fbthrift_invocation_do_mid.compare_exchange_strong(
      expected,
...
apache::thrift::ServiceHandler<::cpp2::MyNode>::future_do_mid() {
...
apache::thrift::ServiceHandler<::cpp2::MyNode>::co_do_mid() {
...
void apache::thrift::ServiceHandler<::cpp2::MyNode>::async_tm_do_mid(
...
#endif // FOLLY_HAS_COROUTINES
  auto invocationType =
      __fbthrift_invocation_do_mid.load(std::memory_order_relaxed);
  try {
...
apache::thrift::ServiceRequestInfoMap MyNodeServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"do_mid",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::MyNode>("do_mid")}},
  };
