...
//
// @generated SignedSource<<780b06e043614d5cd8bdf78c8e052bfb>>
//
...
pub struct SubstContext {
    ...
    pub class_context: std::rc::Rc<String>,
...
pub struct MroElement {
    ...
    pub use_pos: std::rc::Rc<pos::Pos>,
    /// Like mro_use_pos, but includes type arguments (if any).
    pub ty_pos: std::rc::Rc<pos::Pos>,
    ...
    pub trait_reuse: Option<std::rc::Rc<String>>,
    ...
    /// hierarchy.
    pub required_at: Option<std::rc::Rc<pos::Pos>>,
...
pub type ConditionTypeName = Option<std::rc::Rc<String>>;
