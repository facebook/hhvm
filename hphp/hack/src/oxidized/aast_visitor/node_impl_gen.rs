...
//
// @generated SignedSource<<8027c985b0d5ac83d0f540c96d110c7b>>
//
...
impl<P: Params> Node<P> for Argument<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for As_<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for DestructureShape<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for DestructureShapeField<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for DestructureTarget<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for DestructureTarget_<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for DestructureTuple<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for DestructureTupleEntry<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for Expr_<P::Ex, P::En> {
    ...
    fn recurse<'node>(
        ...
        fn helper10<'node, P: Params + Params<Ex = Ex> + Params<En = En>, Ex, En>(
            a: &'node Box<(Expr<Ex, En>, Option<ast_defs::Bop>, Expr<Ex, En>)>,
            c: &mut P::Context,
            v: &mut dyn Visitor<'node, Params = P>,
        ) -> Result<(), P::Error> {
            a.0.accept(c, v)?;
...
impl<P: Params> Node<P> for LoopCond<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for LoopIter<P::Ex, P::En> {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for SplatKind {
    fn accept<'node>(
        &'node self,
        c: &mut P::Context,
        v: &mut dyn Visitor<'node, Params = P>,
...
impl<P: Params> Node<P> for Stmt_<P::Ex, P::En> {
    ...
    fn recurse<'node>(
        ...
        #[inline]
        fn helper2<'node, P: Params + Params<Ex = Ex> + Params<En = En>, Ex, En>(
            a: &'node Box<(Block<Ex, En>, LoopCond<Ex, En>)>,
            c: &mut P::Context,
            v: &mut dyn Visitor<'node, Params = P>,
        ) -> Result<(), P::Error> {
            a.0.accept(c, v)?;
        ...
        #[inline]
        fn helper3<'node, P: Params + Params<Ex = Ex> + Params<En = En>, Ex, En>(
            a: &'node Box<(LoopCond<Ex, En>, Block<Ex, En>)>,
            c: &mut P::Context,
            v: &mut dyn Visitor<'node, Params = P>,
        ) -> Result<(), P::Error> {
            a.0.accept(c, v)?;
