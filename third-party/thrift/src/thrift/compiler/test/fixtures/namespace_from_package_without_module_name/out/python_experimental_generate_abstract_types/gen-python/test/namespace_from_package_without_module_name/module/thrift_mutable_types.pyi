...
class Foo(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_Foo, test.namespace_from_package_without_module_name.module.thrift_abstract_types.Foo):
