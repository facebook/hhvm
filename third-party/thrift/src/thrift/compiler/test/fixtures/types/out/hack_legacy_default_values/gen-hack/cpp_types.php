...
class Frozen2Exclude implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
...
class Frozen2RequiresCompleteContainerParams implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
...
class ProcessInEbThreadUnsafe implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
...
class UseCursorSerialization implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
...
class AllowLegacyNonOptionalRef implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
...
class AllowLegacyDeprecatedTerseWritesRef implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
...
class EnableCustomTypeOrdering implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
...
class GenerateServiceMethodDecorator implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
 ...
 *
 * Original thrift struct:-
 * DeclareHashSpecialization
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/annotation/cpp/DeclareHashSpecialization'))>>
class DeclareHashSpecialization implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
  ...
  public function getName()[]: string {
    return 'DeclareHashSpecialization';
  }
 ...
 *
 * Original thrift struct:-
 * DeclareEqualToSpecialization
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/annotation/cpp/DeclareEqualToSpecialization'))>>
class DeclareEqualToSpecialization implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
  ...
  public function getName()[]: string {
    return 'DeclareEqualToSpecialization';
  }
