...
class SomeStruct(_fbthrift_python_types.Struct, _fbthrift_compatible_with_SomeStruct):
    reasonable: _typing.Final[_fbthrift_current_module.Metasyntactic] = ...
    fine: _typing.Final[_fbthrift_current_module.Metasyntactic] = ...
    questionable: _typing.Final[_fbthrift_current_module.Metasyntactic] = ...
...
class MyStruct(_fbthrift_python_types.Struct, _fbthrift_compatible_with_MyStruct):
    me2_3: _typing.Final[_fbthrift_current_module.MyEnum2] = ...
    me3_n3: _typing.Final[_fbthrift_current_module.MyEnum3] = ...
    me1_t1: _typing.Final[_fbthrift_current_module.MyEnum1] = ...
    me1_t2: _typing.Final[_fbthrift_current_module.MyEnum1] = ...
    def __init__(
        self, *,
