...
class RaiserInterface(
    ...
    async def _fbthrift__handler_doBland(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_Raiser_doBland_args, args, protocol)
        value = await self.doBland()
        return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_doBland_result()
    ...
    async def _fbthrift__handler_doRaise(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_Raiser_doRaise_args, args, protocol)
        try:
            value = await self.doRaise()
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_doRaise_result()
        except _fbthrift__module__thrift_types.Banal as e:
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_doRaise_result(_ex0__b=e)
            buf = serialize_iobuf(return_struct, protocol)
            exp = PythonUserException('Banal', str(e), buf)
            raise exp
        except _fbthrift__module__thrift_types.Fiery as e:
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_doRaise_result(_ex1__f=e)
            buf = serialize_iobuf(return_struct, protocol)
            exp = PythonUserException('Fiery', str(e), buf)
            raise exp
        except _fbthrift__module__thrift_types.Serious as e:
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_doRaise_result(_ex2__s=e)
            buf = serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_get200(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_Raiser_get200_args, args, protocol)
        value = await self.get200()
        return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_get200_result(success=value)
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_get500(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_Raiser_get500_args, args, protocol)
        try:
            value = await self.get500()
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_get500_result(success=value)
        except _fbthrift__module__thrift_types.Fiery as e:
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_get500_result(_ex0__f=e)
            buf = serialize_iobuf(return_struct, protocol)
            exp = PythonUserException('Fiery', str(e), buf)
            raise exp
        except _fbthrift__module__thrift_types.Banal as e:
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_get500_result(_ex1__b=e)
            buf = serialize_iobuf(return_struct, protocol)
            exp = PythonUserException('Banal', str(e), buf)
            raise exp
        except _fbthrift__module__thrift_types.Serious as e:
            return_struct = _fbthrift__module__thrift_types._fbthrift_Raiser_get500_result(_ex2__s=e)
            buf = serialize_iobuf(return_struct, protocol)
            exp = PythonUserException('Serious', str(e), buf)
            raise exp
        return serialize_iobuf(return_struct, protocol)
