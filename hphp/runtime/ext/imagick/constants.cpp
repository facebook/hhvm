...
#define MW_CONST(cns) Native::registerConstant<KindOfInt64> \
                        (makeStaticString("MW_" #cns), ::cns)
  // Global constants
  MW_CONST(AbsoluteIntent);
  MW_CONST(AddCompositeOp);
  MW_CONST(AddEvaluateOperator);
  MW_CONST(AddNoisePreview);
  MW_CONST(AllChannels);
  MW_CONST(AlphaChannel);
  MW_CONST(AndEvaluateOperator);
  MW_CONST(AnyStretch);
  MW_CONST(AnyStyle);
  MW_CONST(AreaResource);
  MW_CONST(AtopCompositeOp);
  MW_CONST(BZipCompression);
  MW_CONST(BackgroundDispose);
  MW_CONST(BesselFilter);
  MW_CONST(BevelJoin);
  MW_CONST(BilevelType);
  MW_CONST(BlackChannel);
  MW_CONST(BlackmanFilter);
  MW_CONST(BlendCompositeOp);
  MW_CONST(BlobError);
  MW_CONST(BlobFatalError);
  MW_CONST(BlobWarning);
  MW_CONST(BlueChannel);
  MW_CONST(BlurPreview);
  MW_CONST(BoxFilter);
  MW_CONST(BrightnessPreview);
  MW_CONST(BumpmapCompositeOp);
  MW_CONST(ButtCap);
  MW_CONST(CMYKColorspace);
  MW_CONST(CacheError);
  MW_CONST(CacheFatalError);
  MW_CONST(CacheWarning);
  MW_CONST(CatromFilter);
  MW_CONST(CenterAlign);
  MW_CONST(CenterGravity);
  MW_CONST(CharPixel);
  MW_CONST(CharcoalDrawingPreview);
  MW_CONST(ClearCompositeOp);
  MW_CONST(CoderError);
  MW_CONST(CoderFatalError);
  MW_CONST(CoderWarning);
  MW_CONST(ColorBurnCompositeOp);
  MW_CONST(ColorDodgeCompositeOp);
  MW_CONST(ColorSeparationMatteType);
  MW_CONST(ColorSeparationType);
  MW_CONST(ColorizeCompositeOp);
  MW_CONST(ConcatenateMode);
  MW_CONST(CondensedStretch);
  MW_CONST(ConfigureError);
  MW_CONST(ConfigureFatalError);
  MW_CONST(ConfigureWarning);
  MW_CONST(ConstantVirtualPixelMethod);
  MW_CONST(CopyBlackCompositeOp);
  MW_CONST(CopyBlueCompositeOp);
  MW_CONST(CopyCompositeOp);
  MW_CONST(CopyCyanCompositeOp);
  MW_CONST(CopyGreenCompositeOp);
  MW_CONST(CopyMagentaCompositeOp);
  MW_CONST(CopyOpacityCompositeOp);
  MW_CONST(CopyRedCompositeOp);
  MW_CONST(CopyYellowCompositeOp);
  MW_CONST(CorruptImageError);
  MW_CONST(CorruptImageFatalError);
  MW_CONST(CorruptImageWarning);
  MW_CONST(CubicFilter);
  MW_CONST(CyanChannel);
  MW_CONST(DarkenCompositeOp);
  MW_CONST(DelegateError);
  MW_CONST(DelegateFatalError);
  MW_CONST(DelegateWarning);
  MW_CONST(DespecklePreview);
  MW_CONST(DifferenceCompositeOp);
  MW_CONST(DiskResource);
  MW_CONST(DisplaceCompositeOp);
  MW_CONST(DissolveCompositeOp);
  MW_CONST(DivideEvaluateOperator);
  MW_CONST(DoublePixel);
  MW_CONST(DrawError);
  MW_CONST(DrawFatalError);
  MW_CONST(DrawWarning);
  MW_CONST(DstAtopCompositeOp);
  MW_CONST(DstCompositeOp);
  MW_CONST(DstInCompositeOp);
  MW_CONST(DstOutCompositeOp);
  MW_CONST(DstOverCompositeOp);
  MW_CONST(DullPreview);
  MW_CONST(EastGravity);
  MW_CONST(EdgeDetectPreview);
  MW_CONST(EdgeVirtualPixelMethod);
  MW_CONST(ErrorException);
  MW_CONST(EvenOddRule);
  MW_CONST(ExclusionCompositeOp);
  MW_CONST(ExpandedStretch);
  MW_CONST(ExtraCondensedStretch);
  MW_CONST(ExtraExpandedStretch);
  MW_CONST(FatalErrorException);
  MW_CONST(FaxCompression);
  MW_CONST(FileOpenError);
  MW_CONST(FileOpenFatalError);
  MW_CONST(FileOpenWarning);
  MW_CONST(FileResource);
  MW_CONST(FillToBorderMethod);
  MW_CONST(FloatPixel);
  MW_CONST(FloodfillMethod);
  MW_CONST(ForgetGravity);
  MW_CONST(FrameMode);
  MW_CONST(GRAYColorspace);
  MW_CONST(GammaPreview);
  MW_CONST(GaussianFilter);
  MW_CONST(GaussianNoise);
  MW_CONST(GrayscaleMatteType);
  MW_CONST(GrayscalePreview);
  MW_CONST(GrayscaleType);
  MW_CONST(GreenChannel);
  MW_CONST(Group4Compression);
  MW_CONST(HSBColorspace);
  MW_CONST(HSLColorspace);
  MW_CONST(HWBColorspace);
  MW_CONST(HammingFilter);
  MW_CONST(HanningFilter);
  MW_CONST(HardLightCompositeOp);
  MW_CONST(HermiteFilter);
  MW_CONST(HueCompositeOp);
  MW_CONST(HuePreview);
  MW_CONST(ImageError);
  MW_CONST(ImageFatalError);
  MW_CONST(ImageWarning);
  MW_CONST(ImplodePreview);
  MW_CONST(ImpulseNoise);
  MW_CONST(InCompositeOp);
  MW_CONST(IndexChannel);
  MW_CONST(IntegerPixel);
  MW_CONST(ItalicStyle);
  MW_CONST(JPEGCompression);
  MW_CONST(JPEGPreview);
  MW_CONST(LABColorspace);
  MW_CONST(LZWCompression);
  MW_CONST(LanczosFilter);
  MW_CONST(LaplacianNoise);
  MW_CONST(LeftAlign);
  MW_CONST(LeftShiftEvaluateOperator);
  MW_CONST(LightenCompositeOp);
  MW_CONST(LineInterlace);
  MW_CONST(LineThroughDecoration);
  MW_CONST(LongPixel);
  MW_CONST(LosslessJPEGCompression);
  MW_CONST(LuminizeCompositeOp);
  MW_CONST(MagentaChannel);
  MW_CONST(MapResource);
  MW_CONST(MaxEvaluateOperator);
  MW_CONST(MeanAbsoluteErrorMetric);
  MW_CONST(MeanSquaredErrorMetric);
  MW_CONST(MemoryResource);
  MW_CONST(MinEvaluateOperator);
  MW_CONST(MinusCompositeOp);
  MW_CONST(MirrorVirtualPixelMethod);
  MW_CONST(MissingDelegateError);
  MW_CONST(MissingDelegateFatalError);
  MW_CONST(MissingDelegateWarning);
  MW_CONST(MitchellFilter);
  MW_CONST(MiterJoin);
  MW_CONST(ModulateCompositeOp);
  MW_CONST(ModuleError);
  MW_CONST(ModuleFatalError);
  MW_CONST(ModuleWarning);
  MW_CONST(MonitorError);
  MW_CONST(MonitorFatalError);
  MW_CONST(MonitorWarning);
  MW_CONST(MultiplicativeGaussianNoise);
  MW_CONST(MultiplyCompositeOp);
  MW_CONST(MultiplyEvaluateOperator);
  MW_CONST(NoCompositeOp);
  MW_CONST(NoCompression);
  MW_CONST(NoDecoration);
  MW_CONST(NoInterlace);
  MW_CONST(NonZeroRule);
  MW_CONST(NoneDispose);
  MW_CONST(NormalStretch);
  MW_CONST(NormalStyle);
  MW_CONST(NorthEastGravity);
  MW_CONST(NorthGravity);
  MW_CONST(NorthWestGravity);
  MW_CONST(OHTAColorspace);
  MW_CONST(ObjectBoundingBox);
  MW_CONST(ObliqueStyle);
  MW_CONST(OilPaintPreview);
  MW_CONST(OpacityChannel);
  MW_CONST(OptimizeType);
  MW_CONST(OptionError);
  MW_CONST(OptionFatalError);
  MW_CONST(OptionWarning);
  MW_CONST(OrEvaluateOperator);
  MW_CONST(OutCompositeOp);
  MW_CONST(OverCompositeOp);
  MW_CONST(OverlayCompositeOp);
  MW_CONST(OverlineDecoration);
  MW_CONST(PaletteMatteType);
  MW_CONST(PaletteType);
  MW_CONST(PartitionInterlace);
  MW_CONST(PeakAbsoluteErrorMetric);
  MW_CONST(PeakSignalToNoiseRatioMetric);
  MW_CONST(PerceptualIntent);
  MW_CONST(PixelsPerCentimeterResolution);
  MW_CONST(PixelsPerInchResolution);
  MW_CONST(PlaneInterlace);
  MW_CONST(PlusCompositeOp);
  MW_CONST(PointFilter);
  MW_CONST(PointMethod);
  MW_CONST(PoissonNoise);
  MW_CONST(PreviousDispose);
  MW_CONST(QuadraticFilter);
  MW_CONST(QuantizePreview);
  MW_CONST(RGBColorspace);
  MW_CONST(RLECompression);
  MW_CONST(RaisePreview);
  MW_CONST(RedChannel);
  MW_CONST(ReduceNoisePreview);
  MW_CONST(RegistryError);
  MW_CONST(RegistryFatalError);
  MW_CONST(RegistryWarning);
  MW_CONST(RelativeIntent);
  MW_CONST(ReplaceCompositeOp);
  MW_CONST(ReplaceMethod);
  MW_CONST(ResetMethod);
  MW_CONST(ResourceLimitError);
  MW_CONST(ResourceLimitFatalError);
  MW_CONST(ResourceLimitWarning);
  MW_CONST(RightAlign);
  MW_CONST(RightShiftEvaluateOperator);
  MW_CONST(RollPreview);
  MW_CONST(RootMeanSquaredErrorMetric);
  MW_CONST(RotatePreview);
  MW_CONST(RoundCap);
  MW_CONST(RoundJoin);
  MW_CONST(SaturateCompositeOp);
  MW_CONST(SaturationIntent);
  MW_CONST(SaturationPreview);
  MW_CONST(ScreenCompositeOp);
  MW_CONST(SegmentPreview);
  MW_CONST(SemiCondensedStretch);
  MW_CONST(SemiExpandedStretch);
  MW_CONST(SetEvaluateOperator);
  MW_CONST(ShadePreview);
  MW_CONST(SharpenPreview);
  MW_CONST(ShearPreview);
  MW_CONST(ShortPixel);
  MW_CONST(SincFilter);
  MW_CONST(SoftLightCompositeOp);
  MW_CONST(SolarizePreview);
  MW_CONST(SouthEastGravity);
  MW_CONST(SouthGravity);
  MW_CONST(SouthWestGravity);
  MW_CONST(SpiffPreview);
  MW_CONST(SpreadPreview);
  MW_CONST(SquareCap);
  MW_CONST(SrcAtopCompositeOp);
  MW_CONST(SrcCompositeOp);
  MW_CONST(SrcInCompositeOp);
  MW_CONST(SrcOutCompositeOp);
  MW_CONST(SrcOverCompositeOp);
  MW_CONST(StaticGravity);
  MW_CONST(StreamError);
  MW_CONST(StreamFatalError);
  MW_CONST(StreamWarning);
  MW_CONST(SubtractCompositeOp);
  MW_CONST(SubtractEvaluateOperator);
  MW_CONST(SwirlPreview);
  MW_CONST(ThresholdCompositeOp);
  MW_CONST(ThresholdPreview);
  MW_CONST(TileVirtualPixelMethod);
  MW_CONST(TransparentColorspace);
  MW_CONST(TriangleFilter);
  MW_CONST(TrueColorMatteType);
  MW_CONST(TrueColorType);
  MW_CONST(TypeError);
  MW_CONST(TypeFatalError);
  MW_CONST(TypeWarning);
  MW_CONST(UltraCondensedStretch);
  MW_CONST(UltraExpandedStretch);
  MW_CONST(UndefinedAlign);
  MW_CONST(UndefinedCap);
  MW_CONST(UndefinedChannel);
  MW_CONST(UndefinedColorspace);
  MW_CONST(UndefinedCompositeOp);
  MW_CONST(UndefinedCompression);
  MW_CONST(UndefinedDecoration);
  MW_CONST(UndefinedDispose);
  MW_CONST(UndefinedEvaluateOperator);
  MW_CONST(UndefinedException);
  MW_CONST(UndefinedFilter);
  MW_CONST(UndefinedGravity);
  MW_CONST(UndefinedIntent);
  MW_CONST(UndefinedInterlace);
  MW_CONST(UndefinedJoin);
  MW_CONST(UndefinedMethod);
  MW_CONST(UndefinedMetric);
  MW_CONST(UndefinedMode);
  MW_CONST(UndefinedNoise);
  MW_CONST(UndefinedPathUnits);
  MW_CONST(UndefinedPixel);
  MW_CONST(UndefinedPreview);
  MW_CONST(UndefinedResolution);
  MW_CONST(UndefinedResource);
  MW_CONST(UndefinedRule);
  MW_CONST(UndefinedStretch);
  MW_CONST(UndefinedStyle);
  MW_CONST(UndefinedType);
  MW_CONST(UndefinedVirtualPixelMethod);
  MW_CONST(UnderlineDecoration);
  MW_CONST(UnframeMode);
  MW_CONST(UniformNoise);
  MW_CONST(UnrecognizedDispose);
  MW_CONST(UserSpace);
  MW_CONST(UserSpaceOnUse);
  MW_CONST(WandError);
  MW_CONST(WandFatalError);
  MW_CONST(WandWarning);
  MW_CONST(WarningException);
  MW_CONST(WavePreview);
  MW_CONST(WestGravity);
  MW_CONST(XYZColorspace);
  MW_CONST(XorCompositeOp);
  MW_CONST(XorEvaluateOperator);
  MW_CONST(YCCColorspace);
  MW_CONST(YCbCrColorspace);
  MW_CONST(YIQColorspace);
  MW_CONST(YPbPrColorspace);
  MW_CONST(YUVColorspace);
  MW_CONST(YellowChannel);
  MW_CONST(ZipCompression);
  MW_CONST(sRGBColorspace);
#undef MW_CONST

  size_t range;
  MagickGetQuantumRange(&range);
#define MW_QRCNS(name) Native::registerConstant<KindOfInt64> \
  (makeStaticString("MW_" #name), range);
  MW_QRCNS(MaxRGB);
  MW_QRCNS(QuantumRange);
  MW_QRCNS(TransparentOpacity);
#undef MW_QRCNS
  Native::registerConstant<KindOfInt64>
    (makeStaticString("MW_OpaqueOpacity"), 0);
}
