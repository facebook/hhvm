...
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 2> TStructDataStorage<::some::ns::IncludedA>::fields_names = {{
  "i32Field",
  "strField",
}};
THRIFT_DATA_SECTION const std::array<int16_t, 2> TStructDataStorage<::some::ns::IncludedA>::fields_ids = {{
  1,
  2,
}};
THRIFT_DATA_SECTION const std::array<protocol::TType, 2> TStructDataStorage<::some::ns::IncludedA>::fields_types = {{
  TType::T_I32,
  TType::T_STRING,
}};
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 2> TStructDataStorage<::some::ns::IncludedA>::storage_names = {{
  "__fbthrift_field_i32Field",
  "__fbthrift_field_strField",
}};
THRIFT_DATA_SECTION const std::array<int, 2> TStructDataStorage<::some::ns::IncludedA>::isset_indexes = {{
  0,
  1,
}};
