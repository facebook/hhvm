...
#endif
  virtual void async_tm_init(apache::thrift::HandlerCallback<::std::int64_t>::Ptr callback, ::std::int64_t p_param0, ::std::int64_t p_param1);
...
#endif
  virtual void async_tm_method_that_throws(apache::thrift::HandlerCallback<::cpp2::Result>::Ptr callback);
...
#endif
  virtual void async_tm_return_void_method(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int64_t p_id);
 private:
