...
apache::thrift::ServiceHandler<::cpp2::MyServicePrioChild>::semifuture_pang() {
  auto expected{apache::thrift::detail::si::InvocationType::SemiFuture};
  __fbthrift_invocation_pang.compare_exchange_strong(
      expected,
...
apache::thrift::ServiceHandler<::cpp2::MyServicePrioChild>::future_pang() {
...
apache::thrift::ServiceHandler<::cpp2::MyServicePrioChild>::co_pang() {
...
void apache::thrift::ServiceHandler<::cpp2::MyServicePrioChild>::async_tm_pang(
...
#endif // FOLLY_HAS_COROUTINES
  auto invocationType =
      __fbthrift_invocation_pang.load(std::memory_order_relaxed);
  try {
