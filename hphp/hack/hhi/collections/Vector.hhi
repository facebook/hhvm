...
final class Vector<Tv> implements MutableVector<Tv> {
  ...
  /**
   * Returns an immutable, integer-keyed Map based on the values of the current
   * Vector.
   *
   * @return - an immutable Map that has the integer keys and associated values
   ...
   *
   * @return - a Set with the current values of the current Vector.
   */
  public function toSet(): Set<Tv>;

  /**
   * Returns an immutable Set based on the values of the current Vector.
   *
   * @return - an immutable Set with the current values of the current Vector.
   */
   ...
   * Vector.
   *
   * Normally, memory is allocated for all of the elements of the Vector. With
  ...
  /**
   * Returns a Vector containing the values of the current Vector. Essentially a
  ...
  /**
   * Returns a Vector containing the values after an operation has been applied
   * to each value in the current Vector.
   *
   * Every value in the current Vector is affected by a call to map(), unlike
  ...
  /**
   * Returns a Vector containing the values after an operation has been applied
   * to each key and value in the current Vector.
   *
  ...
  /**
   *  Returns a Vector where each element is a Pair that combines the element
   *  of the current Vector and the provided Traversable.
   *
   ...
   *                        of this Vector.
   *
   *  @return - The Vector that combines the values of the current Vector with
   ...
   *
   * @param $n - The last element that will be included in the returned Vector.
   *
   * @return - A Vector that is a proper subset of the current Vector up to n
   *           elements.
   */
  public function take(int $n): Vector<Tv>;

  /**
   * Returns a Vector containing the values of the current Vector up to but not
   ...
   *
   * @return - A Vector that is a proper subset of the current Vector up until
   ...
   *
   * @return - A Vector that is a proper subset of the current Vector containing
   ...
   *              returned Vector.
   *
   * @return - A Vector that is a proper subset of the current Vector starting
   *           after the callback returns true.
   */
  public function skipWhile((function(Tv): bool) $fn): Vector<Tv>;

  /**
   * Returns a subset of the current Vector starting from a given key up to, but
   ...
   *
   * @return - The first value in the current Vector, or null if the Vector is
   *           empty.
   */
   ...
   *
   * @return - The first key (an integer) in the current Vector, or null if the
   *           Vector is empty.
   */
   ...
   *
   * @return - The last key (an integer) in the current Vector, or null if the
   *           Vector is empty.
   */
  ...
  /**
   * Stores a value into the current Vector with the specified key, overwriting
   ...
   *
   * @return - A shallow copy of the current Vector with the updated the values
   *           set. The current Vector is also updated.
   */
   ...
   * returned Vector, and vice-versa.
   *
   * @return - A shallow, empty copy of the current Vector. The current Vector
   *           is also empty.
   */
   ...
   *
   * This will cause elements with higher keys to be renumbered by n - 1, where
   * n is the last key in the current Vector.
   *
   * Future changes made to the current Vector ARE reflected in the
   * returned Vector, and vice-versa.
   *
   ...
   *
   * Resize the current Vector to contain 'sz' elements. If 'sz' is smaller than
   * the current size of the current Vector, elements are removed from the end
   * of the current Vector. If 'sz' is greater than the current size of the
   * current Vector, the current Vector is extended by appending as many copies
   * of 'value' as needed to reach a size of 'sz' elements.
   *
   ...
   * @param $len - The length of the splice. If null, then the current Vector
   ...
   * if "null" is passed.
   *
   * This is the static method version of the Vector __construct() constructor.
   *
   * @param $items - any traversable object from which to create a Vector
   *                 (e.g., array). If null, then an empty Vector is created.
   *
   * @return A Vector with the values from the Traversable; or an empty Vector
   ...
   * value.
   *
   * @param $container - The container with the keys used to create the Vector.
   *
