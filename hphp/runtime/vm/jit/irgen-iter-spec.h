...
// Returns true if the val (and, if applicable, key) output locals of this iter
// are known to be cells. HHBBC usually makes these assertions in repo mode.
//
// We only JIT IterNext bytecodes if FrameState satisfies this condition, and
// we only produce specialized iter code if both IterInit and IterNext do.
