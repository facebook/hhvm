...
template <typename T>
using detect_empty_struct_size = decltype(T::kEmptyStructSize);
template <typename T>
constexpr static bool has_empty_struct_size_v =
    folly::is_detected_v<detect_empty_struct_size, T>;
template <typename T>
using is_empty_struct_optimizable =
    std::enable_if_t<has_empty_struct_size_v<T>>;
template <typename T>
using is_not_empty_struct_optimizable =
    std::enable_if_t<!has_empty_struct_size_v<T>>;
 ...
 */
template <class Protocol_>
inline detail::is_empty_struct_optimizable<Protocol_> rewindIfEmptyStructField(
    Protocol_& prot,
...
template <class Protocol_>
inline detail::is_not_empty_struct_optimizable<Protocol_>
...
inline detail::is_empty_struct_optimizable<Protocol_> rewindIfEmptyStructField(
    Protocol_& prot,
    size_t& xfer,
    size_t xfer_after_field_begin,
    size_t xfer_before_field_begin) {
  if (xfer == xfer_after_field_begin + Protocol_::kEmptyStructSize()) {
    // Finish writing struct field.
    xfer += prot.writeFieldEnd();
    prot.rewind(xfer - xfer_before_field_begin);
...
template <class Protocol_>
inline detail::is_not_empty_struct_optimizable<Protocol_>
rewindIfEmptyStructField(Protocol_& prot, size_t& xfer, size_t, size_t) {
  xfer += prot.writeFieldEnd();
}
