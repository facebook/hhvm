...
cdef class __MinPaddingWithCustomType_FieldsSetter(__StructFieldsSetter):
    ...
    cdef __MinPaddingWithCustomType_FieldsSetter _fbthrift_create(_apache_thrift_fixtures_types_module_cbindings.cMinPaddingWithCustomType* struct_cpp_obj):
        ...
        __fbthrift_inst._setters[__cstring_view(<const char*>"biggish")] = __MinPaddingWithCustomType_FieldsSetter._set_field_1
        __fbthrift_inst._setters[__cstring_view(<const char*>"medium")] = __MinPaddingWithCustomType_FieldsSetter._set_field_2
        __fbthrift_inst._setters[__cstring_view(<const char*>"big")] = __MinPaddingWithCustomType_FieldsSetter._set_field_3
...
cdef class __AllocatorAware_FieldsSetter(__StructFieldsSetter):
    ...
    cdef void _set_field_5(self, _fbthrift_value) except *:
        ...
        _fbthrift_value = <cint32_t> _fbthrift_value
        assign_unique_ptr[cint32_t](deref(self._struct_cpp_obj).aa_unique_ref(), make_unique[cint32_t](deref((<cint32_t?>_fbthrift_value)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE)))
    ...
    cdef void _set_field_6(self, _fbthrift_value) except *:
        ...
        _fbthrift_value = <cint32_t> _fbthrift_value
        assign_shared_ptr[cint32_t](deref(self._struct_cpp_obj).aa_shared_ref(), (<cint32_t?>_fbthrift_value)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE)
