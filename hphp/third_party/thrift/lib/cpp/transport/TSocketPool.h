...
#ifndef HPHP_THRIFT_TRANSPORT_TSOCKETPOOL_H
#define HPHP_THRIFT_TRANSPORT_TSOCKETPOOL_H 1
...
class TSocketPool : public TSocket {
 ...
 public:
   ...
   /* implicit */
   TSocketPool(const
               std::vector< std::shared_ptr<TSocketPoolServer> >& servers);
...
#endif // #ifndef HPHP_THRIFT_TRANSPORT_TSOCKETPOOL_H
