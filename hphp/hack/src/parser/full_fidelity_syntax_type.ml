...
struct
  ...
  and pufield_aggregate =
    | PocketFieldPocketAtomMappingDeclaration of
        pocket_atom_mapping_declaration
    | PocketFieldPocketFieldTypeExprDeclaration of
  ...
  and pumapping_aggregate =
    ...
    | PocketMappingPocketMappingTypeDeclaration of
  ...
  and attributized_specifier = {
    attributized_specifier_attribute_spec:
      attribute_specification option value;
