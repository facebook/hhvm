...
#endif
  virtual void async_tm_getDataById(apache::thrift::HandlerCallback<::std::string>::Ptr callback, ::std::int64_t p_id);
...
#endif
  virtual void async_tm_putDataById(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int64_t p_id, const ::std::string& p_data);
...
#endif
  virtual void async_tm_lobDataById(apache::thrift::HandlerCallbackBase::Ptr callback, ::std::int64_t p_id, const ::std::string& p_data);
 private:
