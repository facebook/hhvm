...
public final class Bar implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public Bar(
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="structListField", requiredness=Requiredness.NONE) final List<com.facebook.thrift.my.AdaptedFoo_1> structListField,
        @com.facebook.swift.codec.ThriftField(value=4, name="optionalStructListField", requiredness=Requiredness.OPTIONAL) final List<com.facebook.thrift.my.AdaptedFoo_1> optionalStructListField,
        ...
        @com.facebook.swift.codec.ThriftField(value=8, name="structListFieldWithTypedef", requiredness=Requiredness.NONE) final List<test.fixtures.adapter.Foo> structListFieldWithTypedef
    ) {
    ...
    public static class Builder {
        ...
        private List<com.facebook.thrift.my.AdaptedFoo_1> structListField = null;
        private List<com.facebook.thrift.my.AdaptedFoo_1> optionalStructListField = null;
        ...
        private List<test.fixtures.adapter.Foo> structListFieldWithTypedef = null;
    
        @com.facebook.swift.codec.ThriftField(value=1, name="structField", requiredness=Requiredness.NONE)    public Builder setStructField(test.fixtures.adapter.Foo structField) {
            this.structField = structField;
            return this;
        }
        ...
        public Builder(Bar other) {
            ...
            this.structListFieldWithTypedef = other.structListFieldWithTypedef;
        }
        ...
        public Bar build() {
            Bar result = new Bar (
                ...
                this.structListFieldWithTypedef
            );
            return result;
        }
    }
    ...
    public String toString() {
        ...
        helper.add("structListFieldWithTypedef", structListFieldWithTypedef);
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return
            ...
            Objects.equals(structListFieldWithTypedef, other.structListFieldWithTypedef) &&
            true;
    }
