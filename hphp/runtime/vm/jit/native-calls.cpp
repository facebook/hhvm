...
static CallMap s_callMap {
    ...
    {ThrowOrWarnCannotModifyReadonlyCollection,
                         throw_or_warn_cannot_modify_readonly_collection, DNone, SSync,
                         {}},
    {ThrowOrWarnMustBeEnclosedInReadonly,
                         throwOrWarnMustBeEnclosedInReadonlyException, DNone, SSync,
                         {extra(&ClassData::cls), {SSA, 0}}},
    {ThrowOrWarnMustBeReadonlyException,
                         throwOrWarnMustBeReadonlyException, DNone, SSync,
                         {extra(&ClassData::cls), {SSA, 0}}},
    {ThrowOrWarnMustBeMutableException,
                         throwOrWarnMustBeMutableException, DNone, SSync,
                         {extra(&ClassData::cls), {SSA, 0}}},
    {ThrowOrWarnMustBeValueTypeException,
                         throwOrWarnMustBeValueTypeException, DNone, SSync,
                         {extra(&ClassData::cls), {SSA, 0}}},
