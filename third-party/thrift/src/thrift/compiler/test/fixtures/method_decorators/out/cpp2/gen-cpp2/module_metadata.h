...
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::DecoratedService>> {
 ...
 private:
  ...
  static void gen_noop(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_echo(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_increment(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_sum(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_withStruct(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_multiParam(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_echoInteraction(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
template <>
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::UndecoratedService>> {
 ...
 private:
  ...
  static void gen_withStruct(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_multiParam(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_adaptedRequest(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
template <>
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::DecoratedService_ExtendsUndecoratedService>> {
 ...
 private:
  ...
  static void gen_extension(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
template <>
...
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::DecoratedService_ExtendsUndecoratedService_ExtendsDecoratedService>> {
 ...
 private:
  ...
  static void gen_secondExtension(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
} // namespace md
} // namespace detail
} // namespace thrift
