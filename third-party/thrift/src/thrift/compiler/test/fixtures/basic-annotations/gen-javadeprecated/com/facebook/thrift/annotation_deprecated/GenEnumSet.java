...
public class GenEnumSet implements TBase, java.io.Serializable, Cloneable, Comparable<GenEnumSet> {
  private static final TStruct STRUCT_DESC = new TStruct("GenEnumSet");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(GenEnumSet.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public GenEnumSet build() {
      GenEnumSet result = new GenEnumSet();
   ...
   */
  public GenEnumSet(GenEnumSet other) {
    if (other.isSetName()) {
      this.name = TBaseHelper.deepCopy(other.name);
    }
  }

  public GenEnumSet deepCopy() {
    return new GenEnumSet(this);
  }
   ...
   * If a custom name is not provided, `{EnumName}Set` is used.
   */
  public GenEnumSet setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof GenEnumSet))
      return false;
    GenEnumSet that = (GenEnumSet)_that;
  ...
  @Override
  public int compareTo(GenEnumSet other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("GenEnumSet");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
