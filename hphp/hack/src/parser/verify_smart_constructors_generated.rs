...
impl<'a> SmartConstructors for VerifySmartConstructors<'a>
{
    ...
    fn make_anonymous_function(&mut self, arg0: Self::R, arg1: Self::R, arg2: Self::R, arg3: Self::R, arg4: Self::R, arg5: Self::R, arg6: Self::R, arg7: Self::R, arg8: Self::R, arg9: Self::R, arg10: Self::R, arg11: Self::R, arg12: Self::R) -> Self::R {
        ...
        let r = <Self as SyntaxSmartConstructors<PositionedSyntax<'a>, TokenFactory<'a>, State<'a>>>::make_anonymous_function(self, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
        self.state_mut().verify(&args);
        self.state_mut().push(r.kind());
        r
    }
    ...
    fn make_define_expression(&mut self, arg0: Self::R, arg1: Self::R, arg2: Self::R, arg3: Self::R) -> Self::R {
        let args = arg_kinds!(arg0, arg1, arg2, arg3);
        let r = <Self as SyntaxSmartConstructors<PositionedSyntax<'a>, TokenFactory<'a>, State<'a>>>::make_define_expression(self, arg0, arg1, arg2, arg3);
        self.state_mut().verify(&args);
        self.state_mut().push(r.kind());
        r
    }
    ...
    fn make_closure_type_specifier(&mut self, arg0: Self::R, arg1: Self::R, arg2: Self::R, arg3: Self::R, arg4: Self::R, arg5: Self::R, arg6: Self::R, arg7: Self::R, arg8: Self::R) -> Self::R {
        let args = arg_kinds!(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        let r = <Self as SyntaxSmartConstructors<PositionedSyntax<'a>, TokenFactory<'a>, State<'a>>>::make_closure_type_specifier(self, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        self.state_mut().verify(&args);
        self.state_mut().push(r.kind());
        r
    }
    ...
    fn make_closure_parameter_type_specifier(&mut self, arg0: Self::R, arg1: Self::R) -> Self::R {
        let args = arg_kinds!(arg0, arg1);
        let r = <Self as SyntaxSmartConstructors<PositionedSyntax<'a>, TokenFactory<'a>, State<'a>>>::make_closure_parameter_type_specifier(self, arg0, arg1);
        self.state_mut().verify(&args);
        self.state_mut().push(r.kind());
        r
    }
    ...
    fn make_enum_atom_expression(&mut self, arg0: Self::R, arg1: Self::R) -> Self::R {
        let args = arg_kinds!(arg0, arg1);
        let r = <Self as SyntaxSmartConstructors<PositionedSyntax<'a>, TokenFactory<'a>, State<'a>>>::make_enum_atom_expression(self, arg0, arg1);
        self.state_mut().verify(&args);
        self.state_mut().push(r.kind());
        r
    }
