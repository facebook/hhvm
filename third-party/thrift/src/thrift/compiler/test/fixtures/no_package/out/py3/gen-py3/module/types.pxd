...
cdef class Containers(thrift.py3.types.Struct):
    cdef shared_ptr[_module_cbindings.cContainers] _cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cContainers])



cdef class MyDataItem(thrift.py3.types.Struct):
    cdef shared_ptr[_module_cbindings.cMyDataItem] _cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    cdef _fbthrift_types_fields.__MyDataItem_FieldsSetter _fields_setter

    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cMyDataItem])
...
cdef class MyException(thrift.py3.exceptions.GeneratedError):
    cdef shared_ptr[_module_cbindings.cMyException] _cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cMyException])



cdef class MyExceptionWithMessage(thrift.py3.exceptions.GeneratedError):
    cdef shared_ptr[_module_cbindings.cMyExceptionWithMessage] _cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cMyExceptionWithMessage])



cdef class ReservedKeyword(thrift.py3.types.Struct):
    cdef shared_ptr[_module_cbindings.cReservedKeyword] _cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    cdef _fbthrift_types_fields.__ReservedKeyword_FieldsSetter _fields_setter
    cdef inline object reserved_field_impl(self)

    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cReservedKeyword])



cdef class UnionToBeRenamed(thrift.py3.types.Union):
    cdef shared_ptr[_module_cbindings.cUnionToBeRenamed] _cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    cdef int64_t type_int
    cdef object py_type
    cdef object py_value
    ...
    @staticmethod
    cdef unique_ptr[_module_cbindings.cUnionToBeRenamed] _make_instance(
        _module_cbindings.cUnionToBeRenamed* base_instance,
        object reserved_field
    ) except *

    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_cbindings.cUnionToBeRenamed])
