...
class TypeName(_fbthrift_python_types.Union):
    ...
    @classmethod
    def fromValue(cls, value: _typing.Union[None, Void, Void, Void, Void, Void, Void, Void, Void, Void, TypeUri, TypeUri, TypeUri, TypeUri, TypeUri, Void, Void, Void]) -> TypeName: ...
    value: _typing.Final[_typing.Union[None, Void, Void, Void, Void, Void, Void, Void, Void, Void, TypeUri, TypeUri, TypeUri, TypeUri, TypeUri, Void, Void, Void]]
    type: Type
    def get_type(self) -> Type:...
