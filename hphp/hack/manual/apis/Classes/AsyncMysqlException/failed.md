...
The following example shows how to use [` AsyncMysqlException::failed `](/docs/apis/Classes/AsyncMysqlException/failed/) to determine if the connection failed in some other way than a timeout.
