...
<<__EntryPoint>>
function main_955() :mixed{
$i = 0;
 print ++$i;
 print "\t";
 print (vec[dict['b' => 1]]!==true) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = vec[dict['b' => 1]];
 print ($a !==true) ? 'Y' : 'N';
 ...
 print ++$i;
 print "\t";
 print (vec[dict['b' => 1]]!==dict['0' => '1']) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = vec[dict['b' => 1]];
 ...
 print ++$i;
 print "\t";
 print (vec[dict['b' => 1]]!==dict['a' => 1]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = vec[dict['b' => 1]];
 ...
 print ++$i;
 print "\t";
 print (vec[dict['b' => 1]]!==dict['b' => 1]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = vec[dict['b' => 1]];
 ...
 print ++$i;
 print "\t";
 print (vec[dict['b' => 1]]!==dict['a' => 1, 'b' => 2]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = vec[dict['b' => 1]];
 ...
 print ++$i;
 print "\t";
 print (vec[dict['b' => 1]]!==vec[dict['a' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = vec[dict['b' => 1]];
 ...
 print ++$i;
 print "\t";
 print (vec[dict['b' => 1]]!==vec[dict['b' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = vec[dict['b' => 1]];
