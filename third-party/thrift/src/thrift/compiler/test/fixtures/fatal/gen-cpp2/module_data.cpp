...
const std::array<folly::StringPiece, 1> TStructDataStorage<::test_cpp2::cpp_reflection::StructWithFieldAdapter>::storage_names = {{
  "__fbthrift_field_field",
}};
const std::array<int, 1> TStructDataStorage<::test_cpp2::cpp_reflection::StructWithFieldAdapter>::isset_indexes = {{
  0,
}};
...
const std::array<folly::StringPiece, 1> TStructDataStorage<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter>::storage_names = {{
  "field",
}};
const std::array<int, 1> TStructDataStorage<::test_cpp2::cpp_reflection::UnionWithTypedefFieldAdapter>::isset_indexes = {{
  0,
}};
