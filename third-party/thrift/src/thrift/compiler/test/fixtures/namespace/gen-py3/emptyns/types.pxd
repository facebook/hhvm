...
cdef extern from "src/gen-py3/emptyns/types.h":
  pass
...
cdef extern from "src/gen-cpp2/emptyns_metadata.h" namespace "apache::thrift::detail::md":
...
cdef extern from "src/gen-cpp2/emptyns_metadata.h" namespace "apache::thrift::detail::md":
    cdef cppclass StructMetadata[T]:
        @staticmethod
        void gen(__fbthrift_cThriftMetadata &metadata)
cdef extern from "src/gen-cpp2/emptyns_types_custom_protocol.h" namespace "::cpp2":
