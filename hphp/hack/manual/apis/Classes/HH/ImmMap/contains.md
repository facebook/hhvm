...
This function is interchangeable with [` containsKey() `](/docs/apis/Classes/HH/ImmMap/containsKey/).
...
See [`Map::contains`](/docs/apis/Classes/HH/Map/contains/#examples) for usage examples.
<!-- HHAPIDOC -->
