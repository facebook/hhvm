...
__all__ = ['UTF8STRINGS', 'Transitive', 'Program', 'Struct', 'Union', 'Exception', 'Field', 'Typedef', 'Service', 'Interaction', 'Function', 'FunctionParameter', 'EnumValue', 'Const', 'Enum', 'Structured', 'Interface', 'RootDefinition', 'Definition', 'DisableSchemaConst']
