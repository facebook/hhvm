...
class GenerateTypedInterceptor:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.cpp.thrift_types.GenerateTypedInterceptor": ...   # type: ignore
    def _to_py3(self) -> "facebook.thrift.annotation.cpp.types.GenerateTypedInterceptor": ...   # type: ignore
    def _to_py_deprecated(self) -> GenerateTypedInterceptor: ...
