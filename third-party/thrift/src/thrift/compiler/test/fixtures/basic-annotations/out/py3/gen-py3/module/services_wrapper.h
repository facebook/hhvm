...
class MyServiceWrapper : virtual public MyServiceSvIf {
  ...
  public:
    ...
    void async_tm_cppDoNothing(apache::thrift::HandlerCallback<void>::Ptr callback) override;
...
class MyServicePrioParentWrapper : virtual public MyServicePrioParentSvIf {
  ...
  public:
    ...
    void async_tm_ping(apache::thrift::HandlerCallback<void>::Ptr callback) override;
    void async_tm_pong(apache::thrift::HandlerCallback<void>::Ptr callback) override;
folly::SemiFuture<folly::Unit> semifuture_onStartServing() override;
folly::SemiFuture<folly::Unit> semifuture_onStopRequested() override;
};
...
class MyServicePrioChildWrapper : public ::cpp2::MyServicePrioParentWrapper, virtual public MyServicePrioChildSvIf {
  public:
    ...
    void async_tm_pang(apache::thrift::HandlerCallback<void>::Ptr callback) override;
folly::SemiFuture<folly::Unit> semifuture_onStartServing() override;
folly::SemiFuture<folly::Unit> semifuture_onStopRequested() override;
};
...
class BadServiceWrapper : virtual public GoodServiceSvIf {
  ...
  public:
    ...
    void async_tm_bar(apache::thrift::HandlerCallback<int32_t>::Ptr callback) override;
...
class FooBarBazServiceWrapper : virtual public FooBarBazServiceSvIf {
  ...
  public:
    ...
    void async_tm_bar(apache::thrift::HandlerCallback<void>::Ptr callback) override;
    void async_tm_baz(apache::thrift::HandlerCallback<void>::Ptr callback) override;
folly::SemiFuture<folly::Unit> semifuture_onStartServing() override;
folly::SemiFuture<folly::Unit> semifuture_onStopRequested() override;
};
