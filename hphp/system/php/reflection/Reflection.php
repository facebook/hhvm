...
class ReflectionParameter implements Reflector {
  ...
  /**
   * Extra function to set $this->info. $this->info should not be visible by
   * client code, yet the current design requires this to be set (when reflecting)
   * a function.
   */
...
class ReflectionClass implements Reflector {
  ...
  public function isCloneable() {
    return $this->isInstantiable() &&
           (!$this->hasMethod('__clone') ||
            $this->getMethod('__clone')->isPublic());
  }
