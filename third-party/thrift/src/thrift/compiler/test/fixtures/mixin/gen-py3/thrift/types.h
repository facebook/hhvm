...
#include "thrift/compiler/test/fixtures/mixin/gen-cpp2/thrift_data.h"
#include "thrift/compiler/test/fixtures/mixin/gen-cpp2/thrift_types.h"
#include "thrift/compiler/test/fixtures/mixin/gen-cpp2/thrift_metadata.h"
namespace thrift {
namespace py3 {
