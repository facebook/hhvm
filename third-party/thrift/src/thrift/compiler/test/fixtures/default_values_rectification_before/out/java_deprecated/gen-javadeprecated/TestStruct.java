...
public class TestStruct implements TBase, java.io.Serializable, Cloneable, Comparable<TestStruct> {
  ...
  public TestStruct() {
    this.unqualified_int_field = 0;

    this.unqualified_bool_field = false;

    this.unqualified_list_field = new ArrayList<Integer>();

    this.unqualified_struct_field = new EmptyStruct();

    this.optional_int_field = 42;

    this.optional_bool_field = true;

    this.optional_list_field = new ArrayList<Integer>();
    this.optional_list_field.add(1);
    this.optional_list_field.add(2);
