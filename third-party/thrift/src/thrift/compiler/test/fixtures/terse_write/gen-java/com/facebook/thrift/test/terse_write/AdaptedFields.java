...
public final class AdaptedFields implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public AdaptedFields(
        @com.facebook.swift.codec.ThriftField(value=1, name="field1", requiredness=Requiredness.NONE) final int field1,
        @com.facebook.swift.codec.ThriftField(value=2, name="field2", requiredness=Requiredness.NONE) final int field2,
        @com.facebook.swift.codec.ThriftField(value=3, name="field3", requiredness=Requiredness.NONE) final int field3
    ) {
        this.field1 = field1;
        this.field2 = field2;
        this.field3 = field3;
    ...
    public static class Builder {
        ...
        public int getField2() { return field2; }
            ...
            @com.facebook.swift.codec.ThriftField(value=3, name="field3", requiredness=Requiredness.NONE)
    ...
    public void write0(TProtocol oprot) throws TException {
      ...
      if (!com.facebook.thrift.util.IntrinsicDefaults.isDefault(this.field1)) {
        oprot.writeFieldBegin(FIELD1_FIELD_DESC);
        oprot.writeI32(this.field1);
        oprot.writeFieldEnd();
      };
      if (!com.facebook.thrift.util.IntrinsicDefaults.isDefault(this.field2)) {
        oprot.writeFieldBegin(FIELD2_FIELD_DESC);
        oprot.writeI32(this.field2);
        oprot.writeFieldEnd();
      };
      if (!com.facebook.thrift.util.IntrinsicDefaults.isDefault(this.field3)) {
