...
class c_sqlite3 : public ObjectData {
 public:
...
class c_sqlite3stmt : public ObjectData {
 public:
  ...
  // implemented by HPHP
  public: ObjectData *create(Object dbobject, String statement);
  public: void dynConstruct(CArrRef Params);
  public: virtual void destruct();
...
class c_sqlite3result : public ObjectData {
 public:
