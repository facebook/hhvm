...
uint32_t TerseFoo::write(Protocol_* prot_) const {
  ...
  if constexpr (requires { prot_->fieldOrder(); }) {
    if (prot_->fieldOrder() == ::apache::thrift::FieldOrder::IdAscending) {
      return ::apache::thrift::op::detail::StructEncode<TerseFoo>{}(*prot_, *this);
    }
  }
  uint32_t xfer = 0;
...
uint32_t TerseLazyFoo::write(Protocol_* prot_) const {
  ...
  if constexpr (requires { prot_->fieldOrder(); }) {
    if (prot_->fieldOrder() == ::apache::thrift::FieldOrder::IdAscending) {
      return ::apache::thrift::op::detail::StructEncode<TerseLazyFoo>{}(*prot_, *this);
    }
  }
  uint32_t xfer = 0;
...
uint32_t TerseOptionalFoo::write(Protocol_* prot_) const {
  ...
  if constexpr (requires { prot_->fieldOrder(); }) {
    if (prot_->fieldOrder() == ::apache::thrift::FieldOrder::IdAscending) {
      return ::apache::thrift::op::detail::StructEncode<TerseOptionalFoo>{}(*prot_, *this);
    }
  }
  uint32_t xfer = 0;
...
uint32_t TerseOptionalLazyFoo::write(Protocol_* prot_) const {
  ...
  if constexpr (requires { prot_->fieldOrder(); }) {
    if (prot_->fieldOrder() == ::apache::thrift::FieldOrder::IdAscending) {
      return ::apache::thrift::op::detail::StructEncode<TerseOptionalLazyFoo>{}(*prot_, *this);
    }
  }
  uint32_t xfer = 0;
