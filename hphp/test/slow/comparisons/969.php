...
$i = 0;
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\lt(varray[1], varray['a'])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[1];
 try { P(HH\Lib\Legacy_FIXME\lt($a, varray['a'])); } catch (Throwable $_) { print 'E'; }
 $b = 1;
 $b = 't';
 $b = varray['a'];
 try { P(HH\Lib\Legacy_FIXME\lt(varray[1], $b)); } catch (Throwable $_) { print 'E'; }
