...
public class LateDefStructSafePatch implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("LateDefStructSafePatch");
   ...
   */
  public LateDefStructSafePatch(LateDefStructSafePatch other) {
  ...
  public LateDefStructSafePatch deepCopy() {
    return new LateDefStructSafePatch(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof LateDefStructSafePatch))
      return false;
    LateDefStructSafePatch that = (LateDefStructSafePatch)_that;
  ...
  public static LateDefStructSafePatch deserialize(TProtocol iprot) throws TException {
    ...
    LateDefStructSafePatch _that;
    _that = new LateDefStructSafePatch(
      tmp_version
      ,tmp_data
    );
    _that.validate();
