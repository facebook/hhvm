...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__data1 || setStructField(*fbthrift_data, 0, *_fbthrift__data1) == -1) {
    return nullptr;
  }
  StrongRef _fbthrift__data2(
    Constructor<int32_t>{}
    .constructFrom(val.data2_ref()));
  if (!_fbthrift__data2 || setStructField(*fbthrift_data, 1, *_fbthrift__data2) == -1) {
    return nullptr;
  }
...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__nodes || setStructField(*fbthrift_data, 0, *_fbthrift__nodes) == -1) {
    return nullptr;
  }
  return std::move(fbthrift_data).release();
}
...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__loop || setStructField(*fbthrift_data, 0, *_fbthrift__loop) == -1) {
    return nullptr;
  }
  return std::move(fbthrift_data).release();
}
...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__bar || setStructField(*fbthrift_data, 0, *_fbthrift__bar) == -1) {
    return nullptr;
  }
  return std::move(fbthrift_data).release();
}
