...
public class RecursivePatch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public RecursiveFieldPatch patchPrior;
  /**
   * Initialize fields, using the given defaults. Applies third.
   */
  public RecursiveEnsureStruct ensure;
  /**
  ...
  static {
    FieldMetaData.addStructMetaDataMap(RecursivePatch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public Builder setAssign(final Recursive assign) {
      this.assign = assign;
      return this;
    }
    ...
    public Builder setPatchPrior(final RecursiveFieldPatch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }

    public Builder setEnsure(final RecursiveEnsureStruct ensure) {
      this.ensure = ensure;
      return this;
    }

    public Builder setPatch(final RecursiveFieldPatch patch) {
      this.patch = patch;
      return this;
    }
   ...
   * 
   */
  public RecursivePatch setAssign(Recursive assign) {
    this.assign = assign;
    return this;
  }
   ...
   * Clears a value. Applies first.
   */
  public RecursivePatch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public RecursivePatch setPatchPrior(RecursiveFieldPatch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Initialize fields, using the given defaults. Applies third.
   */
  public RecursivePatch setEnsure(RecursiveEnsureStruct ensure) {
    this.ensure = ensure;
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public RecursivePatch setPatch(RecursiveFieldPatch patch) {
    this.patch = patch;
    return this;
  }
   ...
   * Removes entries, if present. Applies third.
   */
  public RecursivePatch setRemove(List<Short> remove) {
    this.remove = remove;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((RecursiveFieldPatch)__value);
      }
      break;
    ...
    case ENSURE:
      if (__value == null) {
        ...
        setEnsure((RecursiveEnsureStruct)__value);
      }
      break;
    ...
    case PATCH:
      if (__value == null) {
        ...
        setPatch((RecursiveFieldPatch)__value);
      }
      break;
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            this.patchPrior = new RecursiveFieldPatch();
        ...
        case ENSURE:
          if (__field.type == TType.STRUCT) {
            this.ensure = new RecursiveEnsureStruct();
        ...
        case PATCH:
          if (__field.type == TType.STRUCT) {
            this.patch = new RecursiveFieldPatch();
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("RecursivePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
