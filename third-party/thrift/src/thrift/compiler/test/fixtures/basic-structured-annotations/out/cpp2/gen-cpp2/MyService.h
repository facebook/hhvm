...
#endif
  virtual void async_tm_first(apache::thrift::HandlerCallback<std::unique_ptr<::test::fixtures::basic-structured-annotations::annotated_inline_string>>::Ptr callback);
...
#endif
  virtual void async_tm_second(apache::thrift::HandlerCallback<bool>::Ptr callback, ::std::int64_t p_count);
 private:
