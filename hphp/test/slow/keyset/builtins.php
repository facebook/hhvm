...
function with_keyset($k1) {
  ...
  var_dump(array_diff_uassoc($k1, $k3, fun('nocase')));
  echo "array_diff_ukey: ";
  var_dump(array_diff_ukey($k1, $k3, fun('nocase')));
  echo "array_udiff: ";
  var_dump(array_udiff($k1, $k3, fun('nocase')));
  echo "array_udiff_assoc: ";
  var_dump(array_udiff_assoc($k1, $k3, fun('nocase')));
  echo "array_udiff_uassoc: ";
  var_dump(array_udiff_uassoc($k1, $k3, fun('nocase'), fun('nocase')));
  ...
  var_dump(array_uintersect_assoc($k1, $k3, fun('nocase')));
  echo "array_uintersect_uassoc: ";
  var_dump(array_uintersect_uassoc($k1, $k3, fun('nocase'), fun('nocase')));
  ...
  var_dump(array_intersect_uassoc($k1, $k3, fun('nocase')));
  echo "array_intersect_ukey: ";
  var_dump(array_intersect_ukey($k1, $k3, fun('nocase')));
  echo "array_intersect: ";
  var_dump(array_intersect($k1, $k2));
  echo "array_uintersect: ";
  var_dump(array_uintersect($k1, $k3, fun('nocase')));
  echo "array_filter: ";
