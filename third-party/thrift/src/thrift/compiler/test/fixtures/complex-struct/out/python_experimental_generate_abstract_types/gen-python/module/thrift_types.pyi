...
class MyStruct(_fbthrift_python_types.Struct, _fbthrift_compatible_with_MyStruct, _fbthrift_python_abstract_types.MyStruct):
    ...
    MyStringField: _typing.Final[str] = ...
    MyDataField: _typing.Final[_fbthrift_current_module.MyDataItem] = ...
    ...
    mStringMyStruct: _typing.Final[_typing.Mapping[str, _fbthrift_current_module.MyStruct]] = ...
    ...
    sMyStruct: _typing.Final[_typing.AbstractSet[_fbthrift_current_module.MyStruct]] = ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[int, str, _fbthrift_current_module.MyDataItem, _fbthrift_current_module.MyEnum, bool, int, int, int, float, _typing.Sequence[float], _typing.Sequence[int], _typing.Sequence[int], _typing.Sequence[int], _typing.Sequence[str], _typing.Sequence[bool], _typing.Sequence[int], _typing.Mapping[int, str], _typing.Mapping[int, str], _typing.Mapping[str, _fbthrift_current_module.MyStruct], _typing.Mapping[str, bool], _typing.Mapping[int, int], _typing.Mapping[int, bool], _typing.AbstractSet[int], _typing.AbstractSet[_fbthrift_current_module.MyStruct], _typing.AbstractSet[int], _typing.AbstractSet[str], _typing.AbstractSet[int], _typing.Mapping[_typing.Sequence[int], _typing.Sequence[int]]]]]: ...
    def _to_python(self) -> _typing.Self: ...
...
class defaultStruct(_fbthrift_python_types.Struct, _fbthrift_compatible_with_defaultStruct, _fbthrift_python_abstract_types.defaultStruct):
    ...
    myList: _typing.Final[_typing.Sequence[_fbthrift_current_module.MyEnum]] = ...
    mySet: _typing.Final[_typing.AbstractSet[str]] = ...
    simpleStruct: _typing.Final[_fbthrift_current_module.SimpleStruct] = ...
    listStructDFset: _typing.Final[_typing.Sequence[_fbthrift_current_module.SimpleStruct]] = ...
    myUnion: _typing.Final[_fbthrift_current_module.MyUnion] = ...
    listUnionDFset: _typing.Final[_typing.Sequence[_fbthrift_current_module.MyUnion]] = ...
    mapNestlistStructDfSet: _typing.Final[_typing.Mapping[int, _typing.Sequence[_fbthrift_current_module.SimpleStruct]]] = ...
    mapJavaTypeDFset: _typing.Final[_typing.Mapping[int, str]] = ...
    emptyMap: _typing.Final[_typing.Mapping[int, int]] = ...
    enumMapDFset: _typing.Final[_typing.Mapping[str, _typing.Mapping[int, _fbthrift_current_module.MyEnum]]] = ...
    def __init__(
        self, *,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[int, int, int, int, bytes, bytes, int, int, float, float, float, _typing.Mapping[int, str], _typing.Sequence[_fbthrift_current_module.MyEnum], _typing.AbstractSet[str], _fbthrift_current_module.SimpleStruct, _typing.Sequence[_fbthrift_current_module.SimpleStruct], _fbthrift_current_module.MyUnion, _typing.Sequence[_fbthrift_current_module.MyUnion], _typing.Mapping[int, _typing.Sequence[_fbthrift_current_module.SimpleStruct]], _typing.Mapping[int, str], _typing.Mapping[int, int], _typing.Mapping[str, _typing.Mapping[int, _fbthrift_current_module.MyEnum]]]]]: ...
    def _to_python(self) -> _typing.Self: ...
...
class MyUnion(_fbthrift_python_types.Union, _fbthrift_compatible_with_MyUnion, _fbthrift_python_abstract_types.MyUnion):
    myEnum: _typing.Final[_fbthrift_current_module.MyEnum] = ...
    myStruct: _typing.Final[_fbthrift_current_module.MyStruct] = ...
    myDataItem: _typing.Final[_fbthrift_current_module.MyDataItem] = ...
    complexNestedStruct: _typing.Final[_fbthrift_current_module.ComplexNestedStruct] = ...
    ...
    value: _typing.Final[_typing.Union[None, _fbthrift_current_module.MyEnum, _fbthrift_current_module.MyStruct, _fbthrift_current_module.MyDataItem, _fbthrift_current_module.ComplexNestedStruct, int, int]]
...
class MyUnionFloatFieldThrowExp(_fbthrift_python_types.Union, _fbthrift_compatible_with_MyUnionFloatFieldThrowExp, _fbthrift_python_abstract_types.MyUnionFloatFieldThrowExp):
    ...
    value: _typing.Final[_typing.Union[None, _fbthrift_current_module.MyEnum, _typing.Sequence[_typing.Sequence[float]], _fbthrift_current_module.MyDataItem, _fbthrift_current_module.ComplexNestedStruct]]
...
class ComplexNestedStruct(_fbthrift_python_types.Struct, _fbthrift_compatible_with_ComplexNestedStruct, _fbthrift_python_abstract_types.ComplexNestedStruct):
    ...
    listofListOfListOfListOfEnum: _typing.Final[_typing.Sequence[_typing.Sequence[_typing.Sequence[_typing.Sequence[_fbthrift_current_module.MyEnum]]]]] = ...
    listOfListOfMyStruct: _typing.Final[_typing.Sequence[_typing.Sequence[_fbthrift_current_module.MyStruct]]] = ...
    ...
    mapStructListOfListOfLong: _typing.Final[_typing.Mapping[int, _typing.Sequence[_typing.Sequence[_fbthrift_current_module.MyStruct]]]] = ...
    mKeyStructValInt: _typing.Final[_typing.Mapping[_fbthrift_current_module.MyStruct, int]] = ...
    listOfMapKeyIntValInt: _typing.Final[_typing.Sequence[_typing.Mapping[int, int]]] = ...
    listOfMapKeyStrValList: _typing.Final[_typing.Sequence[_typing.Mapping[str, _typing.Sequence[_fbthrift_current_module.MyStruct]]]] = ...
    ...
    mapKeyIntValList: _typing.Final[_typing.Mapping[int, _typing.Sequence[_fbthrift_current_module.MyStruct]]] = ...
    mapKeyIntValSet: _typing.Final[_typing.Mapping[int, _typing.AbstractSet[bool]]] = ...
    mapKeySetValInt: _typing.Final[_typing.Mapping[_typing.AbstractSet[bool], _fbthrift_current_module.MyEnum]] = ...
    ...
    def __init__(
        ...
        mKeyStructValInt: _typing.Optional[_typing.Mapping[_fbthrift_current_module.MyStruct, int]]=...,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.AbstractSet[_typing.AbstractSet[int]], _typing.Sequence[_typing.Sequence[_typing.Sequence[_typing.Sequence[_fbthrift_current_module.MyEnum]]]], _typing.Sequence[_typing.Sequence[_fbthrift_current_module.MyStruct]], _typing.AbstractSet[_typing.Sequence[_typing.Sequence[int]]], _typing.AbstractSet[_typing.AbstractSet[_typing.AbstractSet[int]]], _typing.Mapping[int, _typing.Sequence[_typing.Sequence[_fbthrift_current_module.MyStruct]]], _typing.Mapping[_fbthrift_current_module.MyStruct, int], _typing.Sequence[_typing.Mapping[int, int]], _typing.Sequence[_typing.Mapping[str, _typing.Sequence[_fbthrift_current_module.MyStruct]]], _typing.Mapping[_typing.AbstractSet[int], int], _typing.Mapping[_typing.Sequence[str], int], _typing.Mapping[_typing.Mapping[int, str], _typing.Mapping[int, str]], _typing.Mapping[_typing.AbstractSet[_typing.Sequence[int]], _typing.Mapping[_typing.Sequence[_typing.AbstractSet[str]], str]], _typing.Mapping[_typing.Mapping[_typing.Mapping[int, str], str], _typing.Mapping[int, str]], _typing.Mapping[int, _typing.Sequence[_fbthrift_current_module.MyStruct]], _typing.Mapping[int, _typing.AbstractSet[bool]], _typing.Mapping[_typing.AbstractSet[bool], _fbthrift_current_module.MyEnum], _typing.Mapping[_typing.Sequence[int], _typing.AbstractSet[_typing.Mapping[float, str]]]]]]: ...
    def _to_python(self) -> _typing.Self: ...
...
class complexException(_fbthrift_python_exceptions.GeneratedError, _fbthrift_compatible_with_complexException, _fbthrift_python_abstract_types.complexException):
    ...
    errorEnum: _typing.Final[_fbthrift_current_module.MyEnum] = ...
    unionError: _typing.Final[_typing.Optional[_fbthrift_current_module.MyUnion]] = ...
    structError: _typing.Final[_fbthrift_current_module.MyStruct] = ...
    lsMap: _typing.Final[_typing.Mapping[int, str]] = ...
    def __init__(
        self, *,
        message: _typing.Optional[str]=...,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[str, _typing.Sequence[str], _fbthrift_current_module.MyEnum, _fbthrift_current_module.MyUnion, _fbthrift_current_module.MyStruct, _typing.Mapping[int, str]]]]: ...
    def _to_python(self) -> _typing.Self: ...
