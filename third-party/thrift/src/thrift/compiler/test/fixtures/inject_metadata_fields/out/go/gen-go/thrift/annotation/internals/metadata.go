...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    thriftTypesWithFullName = append(thriftTypesWithFullName, thriftTypeWithFullName{ "internal.InjectMetadataFields", premadeThriftType_internal_InjectMetadataFields })
