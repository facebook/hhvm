...
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 2> TStructDataStorage<::cpp2::MyStruct>::fields_names = {{
  "MyIntField",
  "MyStringField",
}};
...
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 2> TStructDataStorage<::cpp2::MyStruct>::storage_names = {{
