...
StructMetadata<::facebook::thrift::compiler::test::fixtures::aliasing::Foo>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::facebook::thrift::compiler::test::fixtures::aliasing::Foo>(metadata, kGenerateAll).metadata;
  }

  auto res = genStructMetadata<::facebook::thrift::compiler::test::fixtures::aliasing::Foo>(metadata, {.genAnnotations = folly::kIsDebug});
  if (res.preExists) {
    return res.metadata;
  }
  ...
  for (const auto& f : *module_Foo_fields) {
    genStructFieldMetadata<::facebook::thrift::compiler::test::fixtures::aliasing::Foo>(module_Foo.fields()[i], f, i);
