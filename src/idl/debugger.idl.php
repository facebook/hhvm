...
c('DebuggerClient', null, array(),
  array(
    ...
    m(PublicMethod, 'helpTitle', NULL,
      array('str' => String)),
    m(PublicMethod, 'helpCmds', NULL,
      array('cmd' => String,
            'desc' => String), VariableArguments),
  ...
  array(
    ...
    ck("AUTO_COMPLETE_CLASS_METHODS",    Int64),
    ck("AUTO_COMPLETE_CLASS_PROPERTIES", Int64),
    ck("AUTO_COMPLETE_CLASS_CONSTANTS",  Int64),
    ck("AUTO_COMPLETE_KEYWORDS",         Int64),
    ck("AUTO_COMPLETE_CODE",             Int64),
  ),
  "\n".
  " public:\n".
