...
class ReflectionParameter implements Reflector {
  ...
  public function isDefaultValueConstant() {
    ...
    // Rules for "default" key are as follows:
    // * non-existant -> required (handled above by !isOptional()
    // * NULL -> not constant
    // * 1 -> constant
    return $this->info['default'] == 1;
  }
...
class ReflectionFunctionAbstract {
  ...
  public function getStaticVariables() {
    if ($this->info['is_closure']) {
      return $this->info['static_variables'];
    } else {
      $ret = array(); 
      foreach ($this->info['static_variables'] as $variable => $valueText) {
        $ret[$variable] = eval("return $valueText;");
      }
      return $ret;
    }
  }
