...
$i = 0;
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\lte(vec[1], vec['1'])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = vec[1];
 ...
 $b = 't';
 $b = vec['1'];
 try { P(HH\Lib\Legacy_FIXME\lte(vec[1], $b)); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\lte(vec[1], vec['a'])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = vec[1];
