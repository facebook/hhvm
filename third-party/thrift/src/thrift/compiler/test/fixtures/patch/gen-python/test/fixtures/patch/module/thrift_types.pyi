...
class RecursiveFieldN1Patch(_fbthrift_python_types.Struct):
    ...
    def _to_python(self) -> RecursiveFieldN1Patch: ...
    def _to_py3(self) -> "test.fixtures.patch.module.types.RecursiveFieldN1Patch": ...  # type: ignore
    def _to_py_deprecated(self) -> "module.ttypes.RecursiveFieldN1Patch": ...  # type: ignore


class RecursiveFieldPatch(_fbthrift_python_types.Struct):
    nodes: _typing.Final[RecursiveFieldN1Patch] = ...
    def __init__(
        self, *,
        nodes: _typing.Optional[RecursiveFieldN1Patch]=...
    ) -> None: ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[RecursiveFieldN1Patch]]]: ...
