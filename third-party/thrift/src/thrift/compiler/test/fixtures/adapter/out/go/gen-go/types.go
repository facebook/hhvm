...
func RegisterTypes(registry interface {
  RegisterType(name string, initializer func() any)
    ...
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/MyAnnotation", func() any { return NewMyAnnotation() })
    registry.RegisterType("facebook.com/thrift/compiler/test/fixtures/adapter/src/module/Foo", func() any { return NewFoo() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/Baz", func() any { return NewBaz() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/Bar", func() any { return NewBar() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/DirectlyAdapted", func() any { return NewDirectlyAdapted() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/IndependentDirectlyAdapted", func() any { return NewIndependentDirectlyAdapted() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/StructWithFieldAdapter", func() any { return NewStructWithFieldAdapter() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/TerseAdaptedFields", func() any { return NewTerseAdaptedFields() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/B", func() any { return NewB() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/A", func() any { return NewA() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/Config", func() any { return NewConfig() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/MyStruct", func() any { return NewMyStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/AdaptTestStruct", func() any { return NewAdaptTestStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/AdaptTemplatedTestStruct", func() any { return NewAdaptTemplatedTestStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/AdaptTemplatedNestedTestStruct", func() any { return NewAdaptTemplatedNestedTestStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/AdaptTestUnion", func() any { return NewAdaptTestUnion() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/AdaptedStruct", func() any { return NewAdaptedStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/DirectlyAdaptedStruct", func() any { return NewDirectlyAdaptedStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/StructFieldAdaptedStruct", func() any { return NewStructFieldAdaptedStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/CircularAdaptee", func() any { return NewCircularAdaptee() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/CircularStruct", func() any { return NewCircularStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/ReorderedStruct", func() any { return NewReorderedStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/DeclaredAfterStruct", func() any { return NewDeclaredAfterStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/RenamedStruct", func() any { return NewRenamedStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/SameNamespaceStruct", func() any { return NewSameNamespaceStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/HeapAllocated", func() any { return NewHeapAllocated() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/MoveOnly", func() any { return NewMoveOnly() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/AlsoMoveOnly", func() any { return NewAlsoMoveOnly() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/ApplyAdapter", func() any { return NewApplyAdapter() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/TransitiveAdapted", func() any { return NewTransitiveAdapted() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/CountingStruct", func() any { return NewCountingStruct() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/Person", func() any { return NewPerson() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/Person2", func() any { return NewPerson2() })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/RenamedStructWithStructAdapterAndFieldAdapter", func() any { return NewRenamedStructWithStructAdapterAndFieldAdapter() })

    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/Color", func() any { return Color(0) })
    registry.RegisterType("facebook.com/thrift/test/fixtures/adapter/ThriftAdaptedEnum", func() any { return ThriftAdaptedEnum(0) })
}
