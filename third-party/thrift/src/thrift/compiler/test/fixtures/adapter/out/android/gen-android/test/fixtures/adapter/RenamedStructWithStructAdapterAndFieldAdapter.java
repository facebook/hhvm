...
public class RenamedStructWithStructAdapterAndFieldAdapter implements TBase, java.io.Serializable, Cloneable {
  ...
  public static RenamedStructWithStructAdapterAndFieldAdapter deserialize(TProtocol iprot) throws TException {
    ...
    RenamedStructWithStructAdapterAndFieldAdapter _that;
    _that = new RenamedStructWithStructAdapterAndFieldAdapter(
      tmp_field
    );
    _that.validate();
    return _that;
