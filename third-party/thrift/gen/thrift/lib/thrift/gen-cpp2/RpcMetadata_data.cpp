...
const std::array<::apache::thrift::ErrorKind, 4> TEnumDataStorage<::apache::thrift::ErrorKind>::values = {{
  type::UNSPECIFIED,
  type::TRANSIENT,
  type::STATEFUL,
  type::PERMANENT,
}};
const std::array<folly::StringPiece, 4> TEnumDataStorage<::apache::thrift::ErrorKind>::names = {{
  "UNSPECIFIED",
  "TRANSIENT",
  "STATEFUL",
  "PERMANENT",
...
const std::array<::apache::thrift::ErrorBlame, 3> TEnumDataStorage<::apache::thrift::ErrorBlame>::values = {{
  type::UNSPECIFIED,
  type::SERVER,
  type::CLIENT,
}};
const std::array<folly::StringPiece, 3> TEnumDataStorage<::apache::thrift::ErrorBlame>::names = {{
  "UNSPECIFIED",
  "SERVER",
  "CLIENT",
}};

const std::array<::apache::thrift::ErrorSafety, 2> TEnumDataStorage<::apache::thrift::ErrorSafety>::values = {{
  type::UNSPECIFIED,
  type::SAFE,
}};
const std::array<folly::StringPiece, 2> TEnumDataStorage<::apache::thrift::ErrorSafety>::names = {{
  "UNSPECIFIED",
  "SAFE",
}};

const std::array<::apache::thrift::FunctionQualifier, 4> TEnumDataStorage<::apache::thrift::FunctionQualifier>::values = {{
  type::Unspecified,
  type::OneWay,
  type::Idempotent,
  type::ReadOnly,
}};
const std::array<folly::StringPiece, 4> TEnumDataStorage<::apache::thrift::FunctionQualifier>::names = {{
  "Unspecified",
  "OneWay",
  "Idempotent",
  "ReadOnly",
...
const std::array<::apache::thrift::StreamRpcErrorCode, 3> TEnumDataStorage<::apache::thrift::StreamRpcErrorCode>::values = {{
  type::UNKNOWN,
  type::CREDIT_TIMEOUT,
  type::CHUNK_TIMEOUT,
}};
const std::array<folly::StringPiece, 3> TEnumDataStorage<::apache::thrift::StreamRpcErrorCode>::names = {{
  "UNKNOWN",
  "CREDIT_TIMEOUT",
  "CHUNK_TIMEOUT",
}};
...
const std::array<::apache::thrift::DrainCompleteCode, 1> TEnumDataStorage<::apache::thrift::DrainCompleteCode>::values = {{
  type::EXCEEDED_INGRESS_MEM_LIMIT,
}};
const std::array<folly::StringPiece, 1> TEnumDataStorage<::apache::thrift::DrainCompleteCode>::names = {{
...
const std::array<::apache::thrift::PayloadExceptionMetadata::Type, 6> TEnumDataStorage<::apache::thrift::PayloadExceptionMetadata::Type>::values = {{
  type::declaredException,
  type::proxyException,
  type::DEPRECATED_proxiedException,
  type::DEPRECATED_appClientException,
  type::DEPRECATED_appServerException,
  type::appUnknownException,
}};
const std::array<folly::StringPiece, 6> TEnumDataStorage<::apache::thrift::PayloadExceptionMetadata::Type>::names = {{
  "declaredException",
  "proxyException",
  "DEPRECATED_proxiedException",
  "DEPRECATED_appClientException",
  "DEPRECATED_appServerException",
  "appUnknownException",
}};
...
const std::array<::apache::thrift::ServerPushMetadata::Type, 3> TEnumDataStorage<::apache::thrift::ServerPushMetadata::Type>::values = {{
  type::setupResponse,
  type::streamHeadersPush,
  type::drainCompletePush,
}};
const std::array<folly::StringPiece, 3> TEnumDataStorage<::apache::thrift::ServerPushMetadata::Type>::names = {{
  "setupResponse",
  "streamHeadersPush",
  "drainCompletePush",
}};

const std::array<::apache::thrift::ClientPushMetadata::Type, 2> TEnumDataStorage<::apache::thrift::ClientPushMetadata::Type>::values = {{
  type::interactionTerminate,
  type::streamHeadersPush,
}};
const std::array<folly::StringPiece, 2> TEnumDataStorage<::apache::thrift::ClientPushMetadata::Type>::names = {{
...
const std::array<folly::StringPiece, 3> TStructDataStorage<::apache::thrift::ErrorClassification>::fields_names = {{
  "kind",
  "blame",
  "safety",
}};
const std::array<int16_t, 3> TStructDataStorage<::apache::thrift::ErrorClassification>::fields_ids = {{
  1,
  2,
  3,
}};
const std::array<protocol::TType, 3> TStructDataStorage<::apache::thrift::ErrorClassification>::fields_types = {{
  TType::T_I32,
  TType::T_I32,
  TType::T_I32,
}};
...
const std::array<folly::StringPiece, 1> TStructDataStorage<::apache::thrift::PayloadDeclaredExceptionMetadata>::fields_names = {{
  "errorClassification",
}};
const std::array<int16_t, 1> TStructDataStorage<::apache::thrift::PayloadDeclaredExceptionMetadata>::fields_ids = {{
  1,
}};
const std::array<protocol::TType, 1> TStructDataStorage<::apache::thrift::PayloadDeclaredExceptionMetadata>::fields_types = {{
  TType::T_STRUCT,
}};
...
const std::array<folly::StringPiece, 1> TStructDataStorage<::apache::thrift::PayloadAppUnknownExceptionMetdata>::fields_names = {{
  "errorClassification",
}};
const std::array<int16_t, 1> TStructDataStorage<::apache::thrift::PayloadAppUnknownExceptionMetdata>::fields_ids = {{
  1,
}};
const std::array<protocol::TType, 1> TStructDataStorage<::apache::thrift::PayloadAppUnknownExceptionMetdata>::fields_types = {{
  TType::T_STRUCT,
}};

const std::array<folly::StringPiece, 6> TStructDataStorage<::apache::thrift::PayloadExceptionMetadata>::fields_names = {{
  "declaredException",
  "proxyException",
  "DEPRECATED_proxiedException",
  "DEPRECATED_appClientException",
...
const std::array<int16_t, 6> TStructDataStorage<::apache::thrift::PayloadExceptionMetadata>::fields_ids = {{
  1,
  2,
  3,
  4,
...
const std::array<protocol::TType, 6> TStructDataStorage<::apache::thrift::PayloadExceptionMetadata>::fields_types = {{
  TType::T_STRUCT,
  TType::T_STRUCT,
  TType::T_STRUCT,
  TType::T_STRUCT,
...
const std::array<folly::StringPiece, 9> TStructDataStorage<::apache::thrift::ResponseRpcMetadata>::fields_names = {{
  "protocol",
  "seqId",
  "otherMetadata",
  "load",
...
const std::array<int16_t, 9> TStructDataStorage<::apache::thrift::ResponseRpcMetadata>::fields_ids = {{
  1,
  2,
  3,
  4,
...
const std::array<protocol::TType, 9> TStructDataStorage<::apache::thrift::ResponseRpcMetadata>::fields_types = {{
  TType::T_I32,
  TType::T_I32,
  TType::T_MAP,
  TType::T_I64,
...
const std::array<folly::StringPiece, 3> TStructDataStorage<::apache::thrift::StreamRpcError>::fields_names = {{
  "name_utf8",
  "what_utf8",
  "code",
}};
const std::array<int16_t, 3> TStructDataStorage<::apache::thrift::StreamRpcError>::fields_ids = {{
  1,
  2,
  4,
}};
const std::array<protocol::TType, 3> TStructDataStorage<::apache::thrift::StreamRpcError>::fields_types = {{
  TType::T_STRING,
  TType::T_STRING,
  TType::T_I32,
}};

const std::array<folly::StringPiece, 3> TStructDataStorage<::apache::thrift::StreamPayloadMetadata>::fields_names = {{
  "compression",
  "otherMetadata",
  "payloadMetadata",
}};
const std::array<int16_t, 3> TStructDataStorage<::apache::thrift::StreamPayloadMetadata>::fields_ids = {{
  1,
  2,
  3,
}};
const std::array<protocol::TType, 3> TStructDataStorage<::apache::thrift::StreamPayloadMetadata>::fields_types = {{
  TType::T_I32,
  TType::T_MAP,
  TType::T_STRUCT,
}};
...
const std::array<folly::StringPiece, 2> TStructDataStorage<::apache::thrift::StreamHeadersPush>::fields_names = {{
  "streamId",
  "headersPayloadContent",
}};
const std::array<int16_t, 2> TStructDataStorage<::apache::thrift::StreamHeadersPush>::fields_ids = {{
  1,
  2,
}};
const std::array<protocol::TType, 2> TStructDataStorage<::apache::thrift::StreamHeadersPush>::fields_types = {{
  TType::T_I32,
  TType::T_STRUCT,
}};

const std::array<folly::StringPiece, 1> TStructDataStorage<::apache::thrift::DrainCompletePush>::fields_names = {{
  "drainCompleteCode",
}};
const std::array<int16_t, 1> TStructDataStorage<::apache::thrift::DrainCompletePush>::fields_ids = {{
  1,
}};
const std::array<protocol::TType, 1> TStructDataStorage<::apache::thrift::DrainCompletePush>::fields_types = {{
  TType::T_I32,
}};

const std::array<folly::StringPiece, 3> TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_names = {{
  "setupResponse",
  "streamHeadersPush",
  "drainCompletePush",
}};
const std::array<int16_t, 3> TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_ids = {{
  1,
  2,
  3,
}};
const std::array<protocol::TType, 3> TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_types = {{
  TType::T_STRUCT,
  TType::T_STRUCT,
  TType::T_STRUCT,
}};

const std::array<folly::StringPiece, 2> TStructDataStorage<::apache::thrift::ClientPushMetadata>::fields_names = {{
  "interactionTerminate",
  "streamHeadersPush",
}};
const std::array<int16_t, 2> TStructDataStorage<::apache::thrift::ClientPushMetadata>::fields_ids = {{
  1,
  2,
}};
const std::array<protocol::TType, 2> TStructDataStorage<::apache::thrift::ClientPushMetadata>::fields_types = {{
  TType::T_STRUCT,
  TType::T_STRUCT,
}};
