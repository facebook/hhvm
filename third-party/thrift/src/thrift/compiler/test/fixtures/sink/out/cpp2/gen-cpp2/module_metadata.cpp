...
StructMetadata<::cpp2::InitialResponse>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_InitialResponse_fields) {
    genStructFieldMetadata<::cpp2::InitialResponse>(module_InitialResponse.fields()[i], f, i);
...
StructMetadata<::cpp2::FinalResponse>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_FinalResponse_fields) {
    genStructFieldMetadata<::cpp2::FinalResponse>(module_FinalResponse.fields()[i], f, i);
...
StructMetadata<::cpp2::SinkPayload>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_SinkPayload_fields) {
    genStructFieldMetadata<::cpp2::SinkPayload>(module_SinkPayload.fields()[i], f, i);
...
StructMetadata<::cpp2::CompatibleWithKeywordSink>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_CompatibleWithKeywordSink_fields) {
    genStructFieldMetadata<::cpp2::CompatibleWithKeywordSink>(module_CompatibleWithKeywordSink.fields()[i], f, i);
...
StructMetadata<::cpp2::InitialException>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_InitialException_fields) {
    genStructFieldMetadata<::cpp2::InitialException>(module_InitialException.fields()[i], f, i);
...
StructMetadata<::cpp2::SinkException1>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_SinkException1_fields) {
    genStructFieldMetadata<::cpp2::SinkException1>(module_SinkException1.fields()[i], f, i);
...
StructMetadata<::cpp2::SinkException2>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_SinkException2_fields) {
    genStructFieldMetadata<::cpp2::SinkException2>(module_SinkException2.fields()[i], f, i);
...
void ExceptionMetadata<::cpp2::InitialException>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    genExceptionMetadata<::cpp2::InitialException>(metadata, kGenerateAll);
    return;
  }

  auto res = genExceptionMetadata<::cpp2::InitialException>(metadata, {.genAnnotations = folly::kIsDebug});
  if (res.preExists) {
    return;
  }
...
void ExceptionMetadata<::cpp2::SinkException1>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    genExceptionMetadata<::cpp2::SinkException1>(metadata, kGenerateAll);
    return;
  }

  auto res = genExceptionMetadata<::cpp2::SinkException1>(metadata, {.genAnnotations = folly::kIsDebug});
  if (res.preExists) {
    return;
  }
...
void ExceptionMetadata<::cpp2::SinkException2>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    genExceptionMetadata<::cpp2::SinkException2>(metadata, kGenerateAll);
    return;
  }

  auto res = genExceptionMetadata<::cpp2::SinkException2>(metadata, {.genAnnotations = folly::kIsDebug});
  if (res.preExists) {
    return;
  }
...
void ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::SinkService>>::gen_methodThrow([[maybe_unused]] ThriftMetadata& metadata, ThriftService& service, std::size_t index, [[maybe_unused]] std::size_t schemaIndex) {
  ...
  [[maybe_unused]] auto module_SinkService_methodThrow_ex_1Annotations = std::move(*module_SinkService_methodThrow_ex_1.structured_annotations());
  module_SinkService_methodThrow_ex_1.structured_annotations()->clear();
...
void ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::SinkService>>::gen(::apache::thrift::metadata::ThriftServiceMetadataResponse& response) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    genServiceMetadataResponse<::cpp2::SinkService>(response);
    DCHECK_EQ(*response.context()->module()->name(), "module");
    DCHECK_EQ(*response.context()->service_info()->name(), "module.SinkService");
    return;
  }
...
const ThriftServiceContextRef* ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::SinkService>>::genRecurse(ThriftMetadata& metadata, std::vector<ThriftServiceContextRef>& services) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    const ThriftServiceContextRef* context = genServiceMetadataRecurse<::cpp2::SinkService>(metadata, services);
    DCHECK_EQ(*metadata.services()["module.SinkService"].name(), "module.SinkService");
    DCHECK_EQ(*context->service_name(), "module.SinkService");
    DCHECK_EQ(*context->module()->name(), "module");
    return context;
  }

  ::apache::thrift::metadata::ThriftService module_SinkService = genServiceMetadata<::cpp2::SinkService>(metadata, {.genAnnotations = folly::kIsDebug});
  ...
  for (auto& function_gen : functions) {
    ...
    function_gen(metadata, module_SinkService, index++, schemaIndex++);
  }
