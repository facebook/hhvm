...
type include_typedef_IncludedMyI32 = int;
/**
...
class include_typedef_IncludedFoo implements \IThriftSyncStruct, \IThriftStructMetadata {
  ...
  const type TConstructorShape = shape(
    ?'i_field' => ?include_typedef_IncludedMyI32,
    ?'i_field2' => ?int,
  );
  ...
  public function __construct(?include_typedef_IncludedMyI32 $i_field = null, ?int $i_field2 = null)[] {
              ...
              "type" => tmeta_ThriftType::fromShape(
                shape(
                  "t_typedef" => tmeta_ThriftTypedefType::fromShape(
                    shape(
                      "name" => "php_include.IncludedMyI32",
