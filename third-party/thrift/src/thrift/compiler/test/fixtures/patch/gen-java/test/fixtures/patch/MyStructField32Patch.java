...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="MyStructField32Patch", builder=MyStructField32Patch.Builder.class)
public final class MyStructField32Patch implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public MyStructField32Patch(
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="patchPrior", requiredness=Requiredness.NONE) final Map<String, test.fixtures.patch.MyStructField32Patch1> patchPrior,
        ...
        @com.facebook.swift.codec.ThriftField(value=6, name="patch", requiredness=Requiredness.NONE) final Map<String, test.fixtures.patch.MyStructField32Patch1> patch,
    ...
    @ThriftConstructor
    protected MyStructField32Patch() {
      this.assign = null;
      this.clear = false;
    ...
    public static class Builder {
        ...
        private Map<String, test.fixtures.patch.MyStructField32Patch1> patchPrior = null;
        private Map<String, Map<String, Integer>> add = null;
        private Map<String, test.fixtures.patch.MyStructField32Patch1> patch = null;
        ...
        public Builder setPatchPrior(Map<String, test.fixtures.patch.MyStructField32Patch1> patchPrior) {
            this.patchPrior = patchPrior;
            return this;
        }
    
        public Map<String, test.fixtures.patch.MyStructField32Patch1> getPatchPrior() { return patchPrior; }
        ...
        public Builder setPatch(Map<String, test.fixtures.patch.MyStructField32Patch1> patch) {
            this.patch = patch;
            return this;
        }
    
        public Map<String, test.fixtures.patch.MyStructField32Patch1> getPatch() { return patch; }
        ...
        public Builder() { }
        public Builder(MyStructField32Patch other) {
    ...
    private static final TField CLEAR_FIELD_DESC = new TField("clear", TType.BOOL, (short)2);
        private final Map<String, test.fixtures.patch.MyStructField32Patch1> patchPrior;
    ...
    private static final TField ADD_FIELD_DESC = new TField("add", TType.MAP, (short)5);
        private final Map<String, test.fixtures.patch.MyStructField32Patch1> patch;
    ...
    static {
      ...
      com.facebook.thrift.type.TypeRegistry.add(new com.facebook.thrift.type.Type(
        new com.facebook.thrift.type.UniversalName("test.dev/fixtures/patch/MyStructField32Patch"), 
        MyStructField32Patch.class, MyStructField32Patch::read0));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MyStructField32Patch other = (MyStructField32Patch)o;
    ...
    public static com.facebook.thrift.payload.Reader<MyStructField32Patch> asReader() {
      return MyStructField32Patch::read0;
    }
    
    public static MyStructField32Patch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(MyStructField32Patch.NAMES_TO_IDS, MyStructField32Patch.THRIFT_NAMES_TO_IDS, MyStructField32Patch.FIELD_METADATA);
      MyStructField32Patch.Builder builder = new MyStructField32Patch.Builder();
      while (true) {
        ...
        case _PATCHPRIOR:
          if (__field.type == TType.MAP) {
            Map<String, test.fixtures.patch.MyStructField32Patch1> patchPrior;
            {
            TMap _map = oprot.readMapBegin();
            patchPrior = new HashMap<String, test.fixtures.patch.MyStructField32Patch1>(Math.max(0, _map.size));
            for (int _i = 0; (_map.size < 0) ? oprot.peekMap() : (_i < _map.size); _i++) {
                
                String _key1 = oprot.readString();
                test.fixtures.patch.MyStructField32Patch1 _value1 = test.fixtures.patch.MyStructField32Patch1.read0(oprot);
        ...
        case _PATCH:
          if (__field.type == TType.MAP) {
            Map<String, test.fixtures.patch.MyStructField32Patch1> patch;
            {
            TMap _map = oprot.readMapBegin();
            patch = new HashMap<String, test.fixtures.patch.MyStructField32Patch1>(Math.max(0, _map.size));
            for (int _i = 0; (_map.size < 0) ? oprot.peekMap() : (_i < _map.size); _i++) {
    ...
    public void write0(TProtocol oprot) throws TException {
      ...
      if (patchPrior != null) {
        ...
        Map<String, test.fixtures.patch.MyStructField32Patch1> _iter0 = patchPrior;
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, _iter0.size()));
        for (Map.Entry<String, test.fixtures.patch.MyStructField32Patch1> _iter1 : _iter0.entrySet()) {
          oprot.writeString(_iter1.getKey());
      ...
      if (patch != null) {
        ...
        Map<String, test.fixtures.patch.MyStructField32Patch1> _iter0 = patch;
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, _iter0.size()));
        for (Map.Entry<String, test.fixtures.patch.MyStructField32Patch1> _iter1 : _iter0.entrySet()) {
          oprot.writeString(_iter1.getKey());
          _iter1.getValue().write0(oprot);
    ...
    private static class _MyStructField32PatchLazy {
        private static final MyStructField32Patch _DEFAULT = new MyStructField32Patch.Builder().build();
    }
    
    public static MyStructField32Patch defaultInstance() {
        return  _MyStructField32PatchLazy._DEFAULT;
    }
}
