...
class ReserveIds implements \IThriftSyncStruct, \IThriftStructMetadata {
  ...
  public static function fromMap_DEPRECATED(<<__Soft>> KeyedContainer<string, mixed> $map)[]: this {
    return new static(
      HH\FIXME\UNSAFE_CAST<mixed, Vector<int>>(idx($map, 'ids'), 'map value is mixed'),
      HH\FIXME\UNSAFE_CAST<mixed, Map<int, int>>(idx($map, 'id_ranges'), 'map value is mixed'),
    );
  }
...
class DeprecatedUnvalidatedAnnotations implements \IThriftSyncStruct, \IThriftStructMetadata {
  ...
  public static function fromMap_DEPRECATED(<<__Soft>> KeyedContainer<string, mixed> $map)[]: this {
    return new static(
      HH\FIXME\UNSAFE_CAST<mixed, Map<string, string>>(idx($map, 'items'), 'map value is mixed'),
    );
  }
