        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (::fbthrift::TType::I64, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::intValue(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising intValue field of ComplexUnion")?));
                }
                (::fbthrift::TType::String, 5, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::stringValue(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising stringValue field of ComplexUnion")?));
                }
                (::fbthrift::TType::List, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::intListValue(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising intListValue field of ComplexUnion")?));
                }
                (::fbthrift::TType::List, 3, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::stringListValue(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising stringListValue field of ComplexUnion")?));
                }
                (::fbthrift::TType::Map, 9, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::typedefValue(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising typedefValue field of ComplexUnion")?));
                }
                (::fbthrift::TType::String, 14, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::stringRef(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising stringRef field of ComplexUnion")?));
                }
    ...
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (::fbthrift::TType::List, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::intListValue(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising intListValue field of ListUnion")?));
                }
                (::fbthrift::TType::List, 3, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::stringListValue(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising stringListValue field of ListUnion")?));
                }
                (fty, _, false) => p.skip(fty)?,
                (badty, badid, true) => return ::std::result::Result::Err(::std::convert::From::from(::fbthrift::ProtocolError::UnwantedExtraUnionField(
                    "ListUnion".to_string(),
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (::fbthrift::TType::String, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::binaryData(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising binaryData field of DataUnion")?));
                }
                (::fbthrift::TType::String, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::stringData(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising stringData field of DataUnion")?));
                }
                (fty, _, false) => p.skip(fty)?,
                (badty, badid, true) => return ::std::result::Result::Err(::std::convert::From::from(::fbthrift::ProtocolError::UnwantedExtraUnionField(
                    "DataUnion".to_string(),
    ...
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                ...
                (::fbthrift::TType::String, 1) => field_strVal = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising strVal field of Val")?),
                (::fbthrift::TType::I32, 2) => field_intVal = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising intVal field of Val")?),
                (::fbthrift::TType::Map, 9) => field_typedefValue = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising typedefValue field of Val")?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (::fbthrift::TType::Struct, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::v1(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising v1 field of ValUnion")?));
                }
                (::fbthrift::TType::Struct, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::v2(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising v2 field of ValUnion")?));
                }
                (fty, _, false) => p.skip(fty)?,
                (badty, badid, true) => return ::std::result::Result::Err(::std::convert::From::from(::fbthrift::ProtocolError::UnwantedExtraUnionField(
                    "ValUnion".to_string(),
    ...
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (::fbthrift::TType::String, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::thingOne(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising thingOne field of VirtualComplexUnion")?));
                }
                (::fbthrift::TType::String, 2, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::thingTwo(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising thingTwo field of VirtualComplexUnion")?));
                }
                (fty, _, false) => p.skip(fty)?,
                (badty, badid, true) => return ::std::result::Result::Err(::std::convert::From::from(::fbthrift::ProtocolError::UnwantedExtraUnionField(
    ...
    P: ::fbthrift::ProtocolReader,
{
    ...
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (::fbthrift::TType::Stop, _) => break,
                (::fbthrift::TType::I64, 1) => field_num = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising num field of NonCopyableStruct")?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
    ...
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32, once) {
                ...
                (::fbthrift::TType::Struct, 1, false) => {
                    once = true;
                    alt = ::std::option::Option::Some(Self::s(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising s field of NonCopyableUnion")?));
                }
                (fty, _, false) => p.skip(fty)?,
                (badty, badid, true) => return ::std::result::Result::Err(::std::convert::From::from(::fbthrift::ProtocolError::UnwantedExtraUnionField(
