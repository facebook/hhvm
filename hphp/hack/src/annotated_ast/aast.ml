...
module AnnotatedAST (Annotations : ASTAnnotationTypes) = struct
  ...
  and funcbody_annotation =
    (Annotations.FuncBodyAnnotation.t[@visitors.opaque])
   ...
   * and noreturn *)
  and assert_expr = AE_assert of expr
  ...
  and special_func = Genva of expr list
