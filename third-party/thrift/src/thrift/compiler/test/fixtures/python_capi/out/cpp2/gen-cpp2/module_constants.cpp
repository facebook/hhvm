...
::std::string_view _fbthrift_schema_b07ee18afae86328() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_b07ee18afae86328_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_b07ee18afae86328_uris() {
  return {};
}
