...
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::B>> {
 ...
 private:
  ...
  static void gen_stream_stuff(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_sink_stuff(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
template <>
