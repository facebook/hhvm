...
public class RequestContext implements TBase, java.io.Serializable, Cloneable {
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof RequestContext))
      return false;
    RequestContext that = (RequestContext)_that;
  ...
  public static RequestContext deserialize(TProtocol iprot) throws TException {
    TField __field;
    ...
    RequestContext _that;
    _that = new RequestContext(
    );
    _that.validate();
    return _that;
  }
