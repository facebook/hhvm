          ...
          if (__field.type == TType.LIST) {
            {
              ...
              tmp_prepend = new ArrayList<Short>(Math.max(0, _list16.size));
              for (int _i17 = 0; 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              tmp_append = new ArrayList<Short>(Math.max(0, _list19.size));
              for (int _i20 = 0; 
