...
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 2> TStructDataStorage<::cpp2::Foo>::fields_names = {{
  "foo",
  "bar",
}};
THRIFT_DATA_SECTION const std::array<int16_t, 2> TStructDataStorage<::cpp2::Foo>::fields_ids = {{
  1,
  2,
}};
THRIFT_DATA_SECTION const std::array<protocol::TType, 2> TStructDataStorage<::cpp2::Foo>::fields_types = {{
  TType::T_STRUCT,
  TType::T_STRUCT,
}};
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 2> TStructDataStorage<::cpp2::Foo>::storage_names = {{
  "__fbthrift_field_foo",
  "__fbthrift_field_bar",
}};
THRIFT_DATA_SECTION const std::array<int, 2> TStructDataStorage<::cpp2::Foo>::isset_indexes = {{
  -1,
  -1,
}};
