...
inline bool equal(CVarRef v1, const Resource& v2) {
  if (!v2.get()) return cellEqual(*v1.asCell(), false);
  return cellEqual(*v1.asCell(), v2.get());
}
...
inline bool less(CVarRef v1, const Resource& v2) {
  if (!v2.get()) return cellLess(*v1.asCell(), false);
  return cellLess(*v1.asCell(), v2.get());
}
...
inline bool more(CVarRef v1, const Resource& v2) {
  if (!v2.get()) return cellGreater(*v1.asCell(), false);
  return cellGreater(*v1.asCell(), v2.get());
}
...
inline bool same(CObjRef v1, const Resource& v2)  { return false;}
...
inline bool equal(CObjRef v1, const Resource& v2) { return false;}
...
inline bool less(CObjRef v1, const Resource& v2)  { return false;}
...
inline bool more(CObjRef v1, const Resource& v2)  { return false;}
...
inline bool same(const Resource& v1, CObjRef v2)  { return false;}
inline bool same(const Resource& v1, const Resource& v2)  { return v1.same(v2);}
inline bool same(const Resource& v1, CVarRef v2)  { return same(v2, v1);}
...
inline bool equal(const Resource& v1, CObjRef v2) { return false;}
inline bool equal(const Resource& v1, const Resource& v2) { return v1.equal(v2);}
inline bool equal(const Resource& v1, CVarRef v2) { return equal(v2, v1);}
...
inline bool less(const Resource& v1, CObjRef v2)  { return false;}
inline bool less(const Resource& v1, const Resource& v2)  { return v1.less(v2);}
inline bool less(const Resource& v1, CVarRef v2)  { return more(v2, v1);}
...
inline bool more(const Resource& v1, CObjRef v2)  { return false;}
inline bool more(const Resource& v1, const Resource& v2)  { return v1.more(v2);}
inline bool more(const Resource& v1, CVarRef v2)  { return less(v2, v1);}
