...
class MyStructField26Patch(_fbthrift_python_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.Sequence[int], bool, _typing.Mapping[int, apache.thrift.op.patch.thrift_types.I16Patch], _typing.Sequence[int], _typing.Sequence[int]]]]: ...
...
class MyStructField29Patch(_fbthrift_python_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.Sequence[_typing.Mapping[str, int]], bool, _typing.Mapping[int, MyStructField29Patch1], _typing.Sequence[_typing.Mapping[str, int]], _typing.Sequence[_typing.Mapping[str, int]]]]]: ...
