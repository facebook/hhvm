...
class PrimitivesServiceInterface(
    ...
    async def _fbthrift__handler_init(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_mutable_types._fbthrift_PrimitivesService_init_args, args, protocol)
        value = await self.init(args_struct.param0,args_struct.param1,)
        return_struct = _fbthrift__module__thrift_mutable_types._fbthrift_PrimitivesService_init_result(success=value)
    ...
    async def _fbthrift__handler_method_that_throws(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_mutable_types._fbthrift_PrimitivesService_method_that_throws_args, args, protocol)
        try:
            value = await self.method_that_throws()
            return_struct = _fbthrift__module__thrift_mutable_types._fbthrift_PrimitivesService_method_that_throws_result(success=value)
        except _fbthrift__module__thrift_mutable_types.CustomException as e:
            return_struct = _fbthrift__module__thrift_mutable_types._fbthrift_PrimitivesService_method_that_throws_result(e=e)
    ...
    async def _fbthrift__handler_return_void_method(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_mutable_types._fbthrift_PrimitivesService_return_void_method_args, args, protocol)
        value = await self.return_void_method(args_struct.id,)
        return_struct = _fbthrift__module__thrift_mutable_types._fbthrift_PrimitivesService_return_void_method_result()
        return serialize_iobuf(return_struct, protocol)
