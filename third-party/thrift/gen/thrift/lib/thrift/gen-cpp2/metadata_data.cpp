...
const std::array<folly::StringPiece, 6> TStructDataStorage<::apache::thrift::metadata::ThriftField>::fields_names = {{
  "id",
  "type",
  "name",
  "is_optional",
...
const std::array<int16_t, 6> TStructDataStorage<::apache::thrift::metadata::ThriftField>::fields_ids = {{
  1,
  2,
  3,
  4,
...
const std::array<protocol::TType, 6> TStructDataStorage<::apache::thrift::metadata::ThriftField>::fields_types = {{
  TType::T_I32,
  TType::T_STRUCT,
  TType::T_STRING,
  TType::T_BOOL,
