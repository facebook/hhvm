...
//
// @generated SignedSource<<606747c2e09bad9b577b6e5a185aefe6>>
//
...
impl<P: Params> NodeMut<P> for Expr_<P::Ex, P::En> {
    ...
    fn recurse<'node>(
        ...
        match self {
            ...
            Expr_::Lfun(a) => helper20(a, c, v),
            Expr_::Xml(a) => helper21(a, c, v),
            Expr_::Import(a) => helper22(a, c, v),
...
impl<P: Params> NodeMut<P> for PackageDef<P::Ex, P::En> {
    fn accept<'node>(
        &'node mut self,
        c: &mut P::Context,
        v: &mut dyn VisitorMut<'node, Params = P>,
