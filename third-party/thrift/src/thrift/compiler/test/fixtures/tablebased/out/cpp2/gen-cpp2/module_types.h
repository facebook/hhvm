...
class ContainerStruct final  {
 private:
  ...
  static constexpr const std::int16_t __fbthrift_reflection_field_ids[] = {0,12,2,3,4,5,6,7,8};
...
template <> struct TSchemaAssociation<::test::fixtures::tablebased::TrivialTypesStruct> {
