...
class Uri implements \IThriftSyncStruct, \IThriftStructMetadata, \IThriftShapishSyncStruct {
  ...
  public static function fromMap_DEPRECATED(@KeyedContainer<string, mixed> $map)[]: this {
    return new static(
      HH\FIXME\UNSAFE_CAST<mixed, string>(idx($map, 'value'), 'map value is mixed'),
    );
  }
...
class Priority implements \IThriftSyncStruct, \IThriftStructMetadata, \IThriftShapishSyncStruct {
  ...
  public static function fromMap_DEPRECATED(@KeyedContainer<string, mixed> $map)[]: this {
    return new static(
      HH\FIXME\UNSAFE_CAST<mixed, \facebook\thrift\annotation\RpcPriority>(idx($map, 'level'), 'map value is mixed'),
    );
  }
...
class DeprecatedUnvalidatedAnnotations implements \IThriftSyncStruct, \IThriftStructMetadata, \IThriftShapishSyncStruct {
  ...
  public static function fromMap_DEPRECATED(@KeyedContainer<string, mixed> $map)[]: this {
    return new static(
      HH\FIXME\UNSAFE_CAST<mixed, dict<string, string>>(idx($map, 'items'), 'map value is mixed'),
    );
  }
