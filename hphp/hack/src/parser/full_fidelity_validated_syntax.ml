...
module Make(Token : TokenType)(SyntaxValue : SyntaxValueType) = struct
  ...
  and validate_expression : expression validator = fun x ->
    ...
    | Syntax.PrintExpression _ -> tag validate_print_expression (fun x -> ExprPrint x) x
  ...
  and invalidate_expression : expression invalidator = fun (value, thing) ->
    ...
    | ExprPrint                        thing -> invalidate_print_expression               (value, thing)
  ...
  and validate_lambda_body : lambda_body validator = fun x ->
    ...
    | Syntax.PrintExpression _ -> tag validate_print_expression (fun x -> LambdaPrint x) x
  ...
  and invalidate_lambda_body : lambda_body invalidator = fun (value, thing) ->
    ...
    | LambdaPrint                        thing -> invalidate_print_expression               (value, thing)
  ...
  and validate_constructor_expression : constructor_expression validator = fun x ->
    ...
    | Syntax.PrintExpression _ -> tag validate_print_expression (fun x -> CExprPrint x) x
  ...
  and invalidate_constructor_expression : constructor_expression invalidator = fun (value, thing) ->
    ...
    | CExprPrint                        thing -> invalidate_print_expression               (value, thing)
  ...
  and validate_print_expression : print_expression validator = function
  | { Syntax.syntax = Syntax.PrintExpression x; value = v } -> v,
    { print_expression = validate_expression x.Syntax.print_expression
    ; print_keyword = validate_token x.Syntax.print_keyword
    }
  | s -> validation_fail SyntaxKind.PrintExpression s
  and invalidate_print_expression : print_expression invalidator = fun (v, x) ->
    { Syntax.syntax =
      Syntax.PrintExpression
      { Syntax.print_keyword = invalidate_token x.print_keyword
      ; Syntax.print_expression = invalidate_expression x.print_expression
      }
    ; Syntax.value = v
    }
