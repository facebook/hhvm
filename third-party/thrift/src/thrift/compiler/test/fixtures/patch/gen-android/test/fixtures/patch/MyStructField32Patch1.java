...
public class MyStructField32Patch1 implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyStructField32Patch1 deserialize(TProtocol iprot) throws TException {
    ...
    MyStructField32Patch1 _that;
    _that = new MyStructField32Patch1(
      tmp_assign
      ,tmp_clear
      ,tmp_patchPrior
      ,tmp_add
