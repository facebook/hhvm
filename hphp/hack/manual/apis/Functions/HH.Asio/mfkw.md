...
This function is similar to ` mfk() `, except the [` Map `](/docs/apis/Classes/HH/Map/) in the returned
...
[` Map `](/docs/apis/Classes/HH/Map/) is `` w ``rapped by a ``` ResultOrExceptionWrapper ```.
