...
^ "\u{40}partially-generated SignedSource<<12345checksum>>\n" in
  Asserter.String_asserter.assert_equals "" (ServerDocblockAt.clean_comments s) "clean";

let s = "This file is generated. Do not modify it manually!\n"
^ "\n"
^ "This file was generated by:\n"
^ "  somewhere/dir/file\n"
...
let s =
  ...
  (* DISABLED - doesn't work for this one
  let s = "(c) Facebook, Inc. and its affiliates. Confidential and proprietary." in
  Asserter.String_asserter.assert_equals "" (ServerDocblockAt.clean_comments s) "clean"; *)
