...
public class NoDeprecated implements TBase, java.io.Serializable, Cloneable, Comparable<NoDeprecated> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(NoDeprecated.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public NoDeprecated build() {
      NoDeprecated result = new NoDeprecated();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(NoDeprecated other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("NoDeprecated");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
