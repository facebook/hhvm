 ...
 *
 */
class ReflectionClassBak implements Reflector {
  ...
  public static function export($name, $ret=false) {
    $obj = new ReflectionClassBak($name);
    $str = (string)$obj;
    if ($ret) {
      return $str;
    }
  ...
  public function getProperty($name) {
    ...
    $cls = new ReflectionClassBak("ReflectionProperty");
  ...
  public function getInterfaces() {
    ...
    foreach ($this->fetch('interfaces') as $name => $_) {
      $cls = new ReflectionClassBak($name);
      if ($cls->isInterface()) {
        $ret[$cls->getName()] = $cls;
      }
    }
  ...
  public function getParentClass() {
    ...
    return new ReflectionClassBak($parent);
  }
  ...
  public function isSubclassOf($cls) {
    if ($cls instanceof ReflectionClassBak) {
      $cls = $cls->name;
    }
 ...
 *
 */
class ReflectionObjectBak extends ReflectionClassBak {
  // This doc comment block generated by idl/sysdoc.php
  /**
  ...
  public static function export($obj, $ret=false) {
    $obj = new ReflectionObjectBak($obj);
    $str = (string)$obj;
    if ($ret) {
      return $str;
    }
