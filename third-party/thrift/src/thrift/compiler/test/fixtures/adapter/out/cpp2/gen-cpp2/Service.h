...
#endif
  virtual void async_tm_func(apache::thrift::HandlerCallback<::facebook::thrift::test::MyI32_4873>::Ptr callback, std::unique_ptr<::facebook::thrift::test::StringWithAdapter_7208> p_arg1, std::unique_ptr<::std::string> p_arg2, std::unique_ptr<::facebook::thrift::test::Foo> p_arg3);
 private:
