...
template void TccStructTraits<::test::fixtures::enums::SomeStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::test::fixtures::enums::MyStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
std::partial_ordering SomeStruct::operator<=>([[maybe_unused]] const SomeStruct& rhs) const {
  return ::apache::thrift::op::compare<SomeStruct>(*this, rhs);
}
