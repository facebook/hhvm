...
let test_jget_string () =
  ...
  Hh_json_helpers.(
    ...
    let results =
      results
      ^ Printf.sprintf
          "string_opt: str=%B num=%B nul=%B abs=%B non=%B\n"
          str
          num
          nul
          abs
    ...
    let results =
      results
      ^ Printf.sprintf
          "string_d: str=%B num=%B nul=%B abs=%B non=%B\n"
          str
          num
          nul
          abs
    ...
    let results =
      results
      ^ Printf.sprintf
          "string_exn: str=%B num=%B nul=%B abs=%B non=%B\n"
          str
          num
          nul
          abs
...
let test_jget_number () =
  ...
  Hh_json_helpers.(
    ...
    let results =
      results
      ^ Printf.sprintf
          "int_opt: int=%B float=%B string=%B\n"
          iint
          ifloat
          istring
    in
    ...
    let results =
      results
      ^ Printf.sprintf
          "float_opt: int=%B float=%B string=%B\n"
          fint
          ffloat
          fstring
    in
