...
class MyParent {
  ...
  'value1' => int,
  'inner' => MyParentFix::MyParentShapeFix, // for some reason this is fine?!
...
class MyChild {
  ...
  'value1' => int,
  'value2' => string,
  'inner' => MyChildFix::MyChildShapeFix, // for some reason this is fine?!
...
class MyParentFix {
  const type MyParentShapeFix = MyParent::MyParentShape;
}
  class MyChildFix {
    const type MyChildShapeFix = MyChild::MyChildShape;
  }
