...
module WithSyntax (Syntax : Syntax_sig.Syntax_S) = struct
  ...
  let make_record_field p0 p1 p2 p3 p4 stack =
    ...
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3; p4] [a0; a1; a2; a3; a4] "record_field"
      in
  ...
  let make_namespace_declaration p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "namespace_declaration"
      in
  ...
  let make_namespace_group_use_declaration p0 p1 p2 p3 p4 p5 p6 stack =
    ...
    | a6 :: a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      ...
      in
      let node =
        Syntax.make_namespace_group_use_declaration p0 p1 p2 p3 p4 p5 p6
      in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_namespace_use_clause p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "namespace_use_clause"
      in
  ...
  let make_function_declaration p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "function_declaration"
      in
  ...
  let make_function_declaration_header p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 stack =
    ...
    | a9 :: a8 :: a7 :: a6 :: a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      ...
      in
      let node =
        Syntax.make_function_declaration_header p0 p1 p2 p3 p4 p5 p6 p7 p8 p9
      in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_methodish_declaration p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "methodish_declaration"
      in
  ...
  let make_classish_declaration p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 stack =
    ...
    | a10 :: a9 :: a8 :: a7 :: a6 :: a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      ...
      in
      let node =
        Syntax.make_classish_declaration p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10
      in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_trait_use_precedence_item p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "trait_use_precedence_item"
      in
  ...
  let make_trait_use_alias_item p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "trait_use_alias_item"
      in
  ...
  let make_require_clause p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "require_clause"
      in
  ...
  let make_type_const_declaration p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 stack =
    ...
    | a9 :: a8 :: a7 :: a6 :: a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      ...
      in
      let node =
        Syntax.make_type_const_declaration p0 p1 p2 p3 p4 p5 p6 p7 p8 p9
      in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_old_attribute_specification p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "old_attribute_specification"
      in
  ...
  let make_markup_section p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "markup_section"
      in
  ...
  let make_elseif_clause p0 p1 p2 p3 p4 stack =
    ...
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3; p4] [a0; a1; a2; a3; a4] "elseif_clause"
      in
  ...
  let make_try_statement p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "try_statement"
      in
  ...
  let make_anonymous_function p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 stack =
    ...
    | a11
      ...
      in
      let node =
        Syntax.make_anonymous_function p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11
      in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_cast_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "cast_expression"
      in
  ...
  let make_scope_resolution_expression p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "scope_resolution_expression"
      in
  ...
  let make_member_selection_expression p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "member_selection_expression"
      in
  ...
  let make_yield_from_expression p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "yield_from_expression"
      in
  ...
  let make_nullable_as_expression p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "nullable_as_expression"
      in
  ...
  let make_eval_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "eval_expression"
      in
  ...
  let make_define_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "define_expression"
      in
  ...
  let make_isset_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "isset_expression"
      in
  ...
  let make_parenthesized_expression p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "parenthesized_expression"
      in
  ...
  let make_embedded_braced_expression p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "embedded_braced_expression"
      in
  ...
  let make_list_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "list_expression"
      in
  ...
  let make_constructor_call p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "constructor_call"
      in
      let node = Syntax.make_constructor_call p0 p1 p2 p3 in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"

  let make_record_creation_expression p0 p1 p2 p3 p4 stack =
    match stack with
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify
      ...
      in
      let node = Syntax.make_record_creation_expression p0 p1 p2 p3 p4 in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_array_creation_expression p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "array_creation_expression"
      in
  ...
  let make_subscript_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "subscript_expression"
      in
  ...
  let make_xhp_children_declaration p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "xhp_children_declaration"
      in
  ...
  let make_xhp_category_declaration p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "xhp_category_declaration"
      in
  ...
  let make_xhp_enum_type p0 p1 p2 p3 p4 stack =
    ...
    | a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3; p4] [a0; a1; a2; a3; a4] "xhp_enum_type"
      in
  ...
  let make_xhp_class_attribute p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "xhp_class_attribute"
      in
  ...
  let make_xhp_simple_attribute p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "xhp_simple_attribute"
      in
  ...
  let make_xhp_spread_attribute p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "xhp_spread_attribute"
      in
  ...
  let make_closure_type_specifier p0 p1 p2 p3 p4 p5 p6 p7 p8 stack =
    ...
    | a8 :: a7 :: a6 :: a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      ...
      in
      let node =
        Syntax.make_closure_type_specifier p0 p1 p2 p3 p4 p5 p6 p7 p8
      in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_closure_parameter_type_specifier p0 p1 stack =
    ...
    | a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1] [a0; a1] "closure_parameter_type_specifier"
      in
  ...
  let make_field_specifier p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "field_specifier"
      in
  ...
  let make_shape_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "shape_expression"
      in
  ...
  let make_tuple_expression p0 p1 p2 p3 stack =
    ...
    | a3 :: a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2; p3] [a0; a1; a2; a3] "tuple_expression"
      in
  ...
  let make_attributized_specifier p0 p1 stack =
    match stack with
    | a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1] [a0; a1] "attributized_specifier" in
      let node = Syntax.make_attributized_specifier p0 p1 in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_tuple_type_specifier p0 p1 p2 stack =
    ...
    | a2 :: a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1; p2] [a0; a1; a2] "tuple_type_specifier"
      in
  ...
  let make_pocket_atom_expression p0 p1 stack =
    match stack with
    | a1 :: a0 :: rem ->
      let () = verify ~stack [p0; p1] [a0; a1] "pocket_atom_expression" in
  ...
  let make_pocket_atom_mapping_declaration p0 p1 p2 p3 p4 p5 stack =
    ...
    | a5 :: a4 :: a3 :: a2 :: a1 :: a0 :: rem ->
      ...
      in
      let node =
        Syntax.make_pocket_atom_mapping_declaration p0 p1 p2 p3 p4 p5
      in
      (node :: rem, node)
    | _ -> failwith "Unexpected stack state"
  ...
  let make_pocket_mapping_id_declaration p0 p1 stack =
    ...
    | a1 :: a0 :: rem ->
      let () =
        verify ~stack [p0; p1] [a0; a1] "pocket_mapping_id_declaration"
      in
