...
template void IssetInspectionStruct::readNoXfer<>(apache::thrift::CompactProtocolReader*);
template uint32_t IssetInspectionStruct::write<>(apache::thrift::CompactProtocolWriter*) const;
template uint32_t IssetInspectionStruct::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
template uint32_t IssetInspectionStruct::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
