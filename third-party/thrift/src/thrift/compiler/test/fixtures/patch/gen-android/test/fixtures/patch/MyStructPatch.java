...
public class MyStructPatch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public final MyStructFieldPatch patchPrior;
  /**
   * Initialize fields, using the given defaults. Applies third.
   */
  public final MyStructEnsureStruct ensure;
  /**
  ...
  public static MyStructPatch deserialize(TProtocol iprot) throws TException {
    ...
    MyStructEnsureStruct tmp_ensure = null;
    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            tmp_patchPrior = MyStructFieldPatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case ENSURE:
          if (__field.type == TType.STRUCT) {
            tmp_ensure = MyStructEnsureStruct.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<Short>(Math.max(0, 2*_set45.size));
              for (int _i46 = 0; 
                   (_set45.size < 0) ? iprot.peekSet() : (_i46 < _set45.size); 
                   ++_i46)
              {
                Short _elem47;
