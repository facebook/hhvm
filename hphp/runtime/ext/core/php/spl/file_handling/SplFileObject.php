...
class SplFileObject extends SplFileInfo
   ...
   * @return     mixed   Returns TRUE on success or FALSE on failure.
   */
  public function flock($operation, inout $wouldblock) {
    $result = flock($this->rsrc, $operation, inout $wouldblock);
    return $result;
  }
   ...
   *                     documentation.
   *
   * @return     varray  The values parsed will be returned as an array.
   */
  public function fscanf($format): varray {
    return varray(fscanf($this->rsrc, $format));
  }
  ...
  public function getCsvControl() {
    return varray[$this->delimiter, $this->enclosure, $this->escape];
  }
