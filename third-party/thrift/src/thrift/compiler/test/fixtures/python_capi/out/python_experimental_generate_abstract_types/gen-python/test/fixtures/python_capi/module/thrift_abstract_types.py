...
class PrimitiveStruct(_abc.ABC):
    ...
    @_abc.abstractmethod
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[bool, int, int, int, int, float, float, str, bytes, _fbthrift_iobuf.IOBuf, _fbthrift_iobuf.IOBuf, MyStruct, EmptyStruct, bytes, str, _fbthrift__test__fixtures__python_capi__thrift_dep__thrift_abstract_types.SomeError]]]: ...
    @_abc.abstractmethod
