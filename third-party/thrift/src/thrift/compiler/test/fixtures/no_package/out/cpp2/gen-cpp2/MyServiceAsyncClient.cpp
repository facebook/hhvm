...
template <typename RpcOptions>
void apache::thrift::Client<::cpp2::MyService>::fbthrift_send_invalid_return_for_hack(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback, std::unique_ptr<folly::IOBuf> interceptorFrameworkMetadata) {
...
template <typename RpcOptions>
void apache::thrift::Client<::cpp2::MyService>::fbthrift_send_rpc_skipped_codegen(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback, std::unique_ptr<folly::IOBuf> interceptorFrameworkMetadata) {
...
#if FOLLY_HAS_COROUTINES
#endif // FOLLY_HAS_COROUTINES
void apache::thrift::Client<::cpp2::MyService>::invalid_return_for_hack(std::unique_ptr<apache::thrift::RequestCallback> callback) {
  ::apache::thrift::RpcOptions rpcOptions;
  invalid_return_for_hack(rpcOptions, std::move(callback));
}

void apache::thrift::Client<::cpp2::MyService>::invalid_return_for_hack(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback) {
...
apache::thrift::SerializedRequest apache::thrift::Client<::cpp2::MyService>::fbthrift_serialize_invalid_return_for_hack(const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack) {
  return apache::thrift::detail::ac::withProtocolWriter(apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId(), [&](auto&& prot) {
    using ProtocolWriter = std::decay_t<decltype(prot)>;
    ::cpp2::MyService_invalid_return_for_hack_pargs args;
    const auto sizer = [&](ProtocolWriter* p) { return args.serializedSizeZC(p); };
    const auto writer = [&](ProtocolWriter* p) { args.write(p); };
    return apache::thrift::preprocessSendT<ProtocolWriter>(
        &prot,
...
void apache::thrift::Client<::cpp2::MyService>::fbthrift_serialize_and_send_invalid_return_for_hack(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback, bool stealRpcOptions) {
  apache::thrift::SerializedRequest request = fbthrift_serialize_invalid_return_for_hack(rpcOptions, *header, contextStack);
  channel_->compressRequest(request, rpcOptions, *header);
  std::unique_ptr<folly::IOBuf> interceptorFrameworkMetadata = nullptr;
  if (contextStack != nullptr) {
    interceptorFrameworkMetadata = detail::ContextStackUnsafeAPI(*contextStack).getInterceptorFrameworkMetadata(rpcOptions);
  ...
  if (stealRpcOptions) {
    fbthrift_send_invalid_return_for_hack(std::move(request), std::move(rpcOptions), std::move(header), std::move(callback), std::move(interceptorFrameworkMetadata));
  } else {
    fbthrift_send_invalid_return_for_hack(std::move(request), rpcOptions, std::move(header), std::move(callback), std::move(interceptorFrameworkMetadata));
  }
}

std::pair<::apache::thrift::ContextStack::UniquePtr, std::shared_ptr<::apache::thrift::transport::THeader>> apache::thrift::Client<::cpp2::MyService>::invalid_return_for_hackCtx(apache::thrift::RpcOptions* rpcOptions) {
  auto header = std::make_shared<apache::thrift::transport::THeader>(
      apache::thrift::transport::THeader::ALLOW_BIG_FRAMES);
  header->setProtocolId(channel_->getProtocolId());
  if (rpcOptions) {
...
void apache::thrift::Client<::cpp2::MyService>::sync_invalid_return_for_hack(::std::set<float>& _return) {
  ::apache::thrift::RpcOptions rpcOptions;
  sync_invalid_return_for_hack(rpcOptions, _return);
}

void apache::thrift::Client<::cpp2::MyService>::sync_invalid_return_for_hack(apache::thrift::RpcOptions& rpcOptions, ::std::set<float>& _return) {
  apache::thrift::ClientReceiveState returnState;
  apache::thrift::ClientSyncCallback<false> callback(&returnState);
  auto channel = apache::thrift::GeneratedAsyncClient::getChannelShared();
  auto protocolId = channel->getProtocolId();
  ...
  callback.waitUntilDone(
    evb,
    [&] {
      fbthrift_serialize_and_send_invalid_return_for_hack(rpcOptions, ctxAndHeader.second, ctxAndHeader.first.get(), std::move(wrappedCallback));
    });
  returnState.resetProtocolId(protocolId);
  returnState.resetCtx(std::move(ctxAndHeader.first));
  SCOPE_EXIT {
...
template <typename CallbackType>
folly::SemiFuture<::std::set<float>> apache::thrift::Client<::cpp2::MyService>::fbthrift_semifuture_invalid_return_for_hack(apache::thrift::RpcOptions& rpcOptions) {
  using CallbackHelper = apache::thrift::detail::FutureCallbackHelper<::std::set<float>>;
  folly::Promise<CallbackHelper::PromiseResult> promise;
  auto semifuture = promise.getSemiFuture();
  auto ctxAndHeader = invalid_return_for_hackCtx(&rpcOptions);
  auto wrappedCallbackAndContextStack = apache::thrift::GeneratedAsyncClient::template prepareRequestClientCallback<false /* kIsOneWay */>(
    std::make_unique<CallbackType>(std::move(promise), recv_wrapped_invalid_return_for_hack, channel_),
    std::move(ctxAndHeader.first));
  auto header = std::move(ctxAndHeader.second);
  auto* contextStack = wrappedCallbackAndContextStack.second;
  auto wrappedCallback = std::move(wrappedCallbackAndContextStack.first);
  ...
  if (contextStack != nullptr) {
    ...
    if (auto exTry = contextStack->processClientInterceptorsOnRequest(apache::thrift::ClientInterceptorOnRequestArguments(argsAsRefs), header.get(), rpcOptions);
        exTry.hasException()) {
      return folly::makeSemiFuture<::std::set<float>>(std::move(exTry).exception());
    }
    interceptorFrameworkMetadata = detail::ContextStackUnsafeAPI(*contextStack).getInterceptorFrameworkMetadata(rpcOptions);
  }
  apache::thrift::SerializedRequest request = fbthrift_serialize_invalid_return_for_hack(rpcOptions, *header, contextStack);
  fbthrift_send_invalid_return_for_hack(std::move(request), rpcOptions, std::move(header), std::move(wrappedCallback), std::move(interceptorFrameworkMetadata));
  return std::move(semifuture).deferValue(CallbackHelper::processClientInterceptorsAndExtractResult);
}

folly::Future<::std::set<float>> apache::thrift::Client<::cpp2::MyService>::future_invalid_return_for_hack() {
  ::apache::thrift::RpcOptions rpcOptions;
  return future_invalid_return_for_hack(rpcOptions);
}

folly::Future<::std::set<float>> apache::thrift::Client<::cpp2::MyService>::future_invalid_return_for_hack(apache::thrift::RpcOptions& rpcOptions) {
...
folly::SemiFuture<::std::set<float>> apache::thrift::Client<::cpp2::MyService>::semifuture_invalid_return_for_hack() {
  ::apache::thrift::RpcOptions rpcOptions;
  return semifuture_invalid_return_for_hack(rpcOptions);
}

folly::SemiFuture<::std::set<float>> apache::thrift::Client<::cpp2::MyService>::semifuture_invalid_return_for_hack(apache::thrift::RpcOptions& rpcOptions) {
...
void apache::thrift::Client<::cpp2::MyService>::invalid_return_for_hack(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback) {
  invalid_return_for_hack(std::make_unique<apache::thrift::FunctionReplyCallback>(std::move(callback)));
}

#if FOLLY_HAS_COROUTINES
#endif // FOLLY_HAS_COROUTINES
folly::exception_wrapper apache::thrift::Client<::cpp2::MyService>::recv_wrapped_invalid_return_for_hack(::std::set<float>& _return, ::apache::thrift::ClientReceiveState& state) {
    if (auto ew = apache::thrift::detail::ac::check_recv_state(state)) {
    return ew;
  }

  using result = ::cpp2::MyService_invalid_return_for_hack_presult;
  return apache::thrift::detail::ac::withProtocolReader(state.protocolId(), [&](auto&& reader) {
    return apache::thrift::detail::ac::recv_wrapped<result>(
        &reader, state, _return);
  });
...
void apache::thrift::Client<::cpp2::MyService>::recv_invalid_return_for_hack(::std::set<float>& _return, ::apache::thrift::ClientReceiveState& state) {
...
void apache::thrift::Client<::cpp2::MyService>::recv_instance_invalid_return_for_hack(::std::set<float>& _return, ::apache::thrift::ClientReceiveState& state) {
  return recv_invalid_return_for_hack(_return, state);
}

folly::exception_wrapper apache::thrift::Client<::cpp2::MyService>::recv_instance_wrapped_invalid_return_for_hack(::std::set<float>& _return, ::apache::thrift::ClientReceiveState& state) {
  return recv_wrapped_invalid_return_for_hack(_return, state);
}

void apache::thrift::Client<::cpp2::MyService>::rpc_skipped_codegen(std::unique_ptr<apache::thrift::RequestCallback> callback) {
  ::apache::thrift::RpcOptions rpcOptions;
  rpc_skipped_codegen(rpcOptions, std::move(callback));
}

void apache::thrift::Client<::cpp2::MyService>::rpc_skipped_codegen(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback) {
...
apache::thrift::SerializedRequest apache::thrift::Client<::cpp2::MyService>::fbthrift_serialize_rpc_skipped_codegen(const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack) {
  return apache::thrift::detail::ac::withProtocolWriter(apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId(), [&](auto&& prot) {
    using ProtocolWriter = std::decay_t<decltype(prot)>;
    ::cpp2::MyService_rpc_skipped_codegen_pargs args;
    const auto sizer = [&](ProtocolWriter* p) { return args.serializedSizeZC(p); };
    const auto writer = [&](ProtocolWriter* p) { args.write(p); };
    return apache::thrift::preprocessSendT<ProtocolWriter>(
        &prot,
...
void apache::thrift::Client<::cpp2::MyService>::fbthrift_serialize_and_send_rpc_skipped_codegen(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback, bool stealRpcOptions) {
  apache::thrift::SerializedRequest request = fbthrift_serialize_rpc_skipped_codegen(rpcOptions, *header, contextStack);
  channel_->compressRequest(request, rpcOptions, *header);
  std::unique_ptr<folly::IOBuf> interceptorFrameworkMetadata = nullptr;
  if (contextStack != nullptr) {
    interceptorFrameworkMetadata = detail::ContextStackUnsafeAPI(*contextStack).getInterceptorFrameworkMetadata(rpcOptions);
  ...
  if (stealRpcOptions) {
    fbthrift_send_rpc_skipped_codegen(std::move(request), std::move(rpcOptions), std::move(header), std::move(callback), std::move(interceptorFrameworkMetadata));
  } else {
    fbthrift_send_rpc_skipped_codegen(std::move(request), rpcOptions, std::move(header), std::move(callback), std::move(interceptorFrameworkMetadata));
  }
}

std::pair<::apache::thrift::ContextStack::UniquePtr, std::shared_ptr<::apache::thrift::transport::THeader>> apache::thrift::Client<::cpp2::MyService>::rpc_skipped_codegenCtx(apache::thrift::RpcOptions* rpcOptions) {
  auto header = std::make_shared<apache::thrift::transport::THeader>(
      apache::thrift::transport::THeader::ALLOW_BIG_FRAMES);
  header->setProtocolId(channel_->getProtocolId());
  if (rpcOptions) {
...
void apache::thrift::Client<::cpp2::MyService>::sync_rpc_skipped_codegen() {
  ::apache::thrift::RpcOptions rpcOptions;
  sync_rpc_skipped_codegen(rpcOptions);
}

void apache::thrift::Client<::cpp2::MyService>::sync_rpc_skipped_codegen(apache::thrift::RpcOptions& rpcOptions) {
  apache::thrift::ClientReceiveState returnState;
  apache::thrift::ClientSyncCallback<false> callback(&returnState);
  auto channel = apache::thrift::GeneratedAsyncClient::getChannelShared();
  auto protocolId = channel->getProtocolId();
  ...
  callback.waitUntilDone(
    evb,
    [&] {
      fbthrift_serialize_and_send_rpc_skipped_codegen(rpcOptions, ctxAndHeader.second, ctxAndHeader.first.get(), std::move(wrappedCallback));
    });
  returnState.resetProtocolId(protocolId);
  returnState.resetCtx(std::move(ctxAndHeader.first));
  SCOPE_EXIT {
...
template <typename CallbackType>
folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::MyService>::fbthrift_semifuture_rpc_skipped_codegen(apache::thrift::RpcOptions& rpcOptions) {
  using CallbackHelper = apache::thrift::detail::FutureCallbackHelper<folly::Unit>;
  folly::Promise<CallbackHelper::PromiseResult> promise;
  auto semifuture = promise.getSemiFuture();
  auto ctxAndHeader = rpc_skipped_codegenCtx(&rpcOptions);
  auto wrappedCallbackAndContextStack = apache::thrift::GeneratedAsyncClient::template prepareRequestClientCallback<false /* kIsOneWay */>(
    std::make_unique<CallbackType>(std::move(promise), recv_wrapped_rpc_skipped_codegen, channel_),
    std::move(ctxAndHeader.first));
  auto header = std::move(ctxAndHeader.second);
  auto* contextStack = wrappedCallbackAndContextStack.second;
  auto wrappedCallback = std::move(wrappedCallbackAndContextStack.first);
  ...
  apache::thrift::SerializedRequest request = fbthrift_serialize_rpc_skipped_codegen(rpcOptions, *header, contextStack);
  fbthrift_send_rpc_skipped_codegen(std::move(request), rpcOptions, std::move(header), std::move(wrappedCallback), std::move(interceptorFrameworkMetadata));
  return std::move(semifuture).deferValue(CallbackHelper::processClientInterceptorsAndExtractResult);
}

folly::Future<folly::Unit> apache::thrift::Client<::cpp2::MyService>::future_rpc_skipped_codegen() {
  ::apache::thrift::RpcOptions rpcOptions;
  return future_rpc_skipped_codegen(rpcOptions);
}

folly::Future<folly::Unit> apache::thrift::Client<::cpp2::MyService>::future_rpc_skipped_codegen(apache::thrift::RpcOptions& rpcOptions) {
  using CallbackType = apache::thrift::FutureCallback<folly::Unit>;
  return fbthrift_semifuture_rpc_skipped_codegen<CallbackType>(rpcOptions).toUnsafeFuture();
}

folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::MyService>::semifuture_rpc_skipped_codegen() {
  ::apache::thrift::RpcOptions rpcOptions;
  return semifuture_rpc_skipped_codegen(rpcOptions);
}

folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::MyService>::semifuture_rpc_skipped_codegen(apache::thrift::RpcOptions& rpcOptions) {
  using CallbackType = apache::thrift::SemiFutureCallback<folly::Unit>;
  return fbthrift_semifuture_rpc_skipped_codegen<CallbackType>(rpcOptions);
}

void apache::thrift::Client<::cpp2::MyService>::rpc_skipped_codegen(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback) {
  rpc_skipped_codegen(std::make_unique<apache::thrift::FunctionReplyCallback>(std::move(callback)));
}

#if FOLLY_HAS_COROUTINES
#endif // FOLLY_HAS_COROUTINES
folly::exception_wrapper apache::thrift::Client<::cpp2::MyService>::recv_wrapped_rpc_skipped_codegen(::apache::thrift::ClientReceiveState& state) {
    if (auto ew = apache::thrift::detail::ac::check_recv_state(state)) {
    return ew;
  }

  using result = ::cpp2::MyService_rpc_skipped_codegen_presult;
  return apache::thrift::detail::ac::withProtocolReader(state.protocolId(), [&](auto&& reader) {
    return apache::thrift::detail::ac::recv_wrapped<result>(
        &reader, state);
  });
...
void apache::thrift::Client<::cpp2::MyService>::recv_rpc_skipped_codegen(::apache::thrift::ClientReceiveState& state) {
...
void apache::thrift::Client<::cpp2::MyService>::recv_instance_rpc_skipped_codegen(::apache::thrift::ClientReceiveState& state) {
  recv_rpc_skipped_codegen(state);
}

folly::exception_wrapper apache::thrift::Client<::cpp2::MyService>::recv_instance_wrapped_rpc_skipped_codegen(::apache::thrift::ClientReceiveState& state) {
