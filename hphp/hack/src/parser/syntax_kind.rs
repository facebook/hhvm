...
impl SyntaxKind {
    ...
    pub fn ocaml_tag(self) -> u8 {
        match self {
            ...
            SyntaxKind::PocketAtomExpression => 166,
            SyntaxKind::PocketIdentifierExpression => 167,
            SyntaxKind::PocketAtomMappingDeclaration => 168,
            SyntaxKind::PocketEnumDeclaration => 169,
            SyntaxKind::PocketFieldTypeExprDeclaration => 170,
            SyntaxKind::PocketFieldTypeDeclaration => 171,
            SyntaxKind::PocketMappingIdDeclaration => 172,
            SyntaxKind::PocketMappingTypeDeclaration => 173,
        }
    }
}
