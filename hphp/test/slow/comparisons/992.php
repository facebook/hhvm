...
$i = 0;
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gt(vec[1], vec['1'])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = vec[1];
 ...
 $b = 't';
 $b = vec['1'];
 try { P(HH\Lib\Legacy_FIXME\gt(vec[1], $b)); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gt(vec[1], vec['a'])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = vec[1];
 try { P(HH\Lib\Legacy_FIXME\gt($a, vec['a'])); } catch (Throwable $_) { print 'E'; }
 $b = 1;
 $b = 't';
 $b = vec['a'];
 try { P(HH\Lib\Legacy_FIXME\gt(vec[1], $b)); } catch (Throwable $_) { print 'E'; }
