...
var (
    ...
    premadeThriftType_dummy_DummyStruct1 = func() *metadata.ThriftType {
        return metadata.NewThriftType().SetTStruct(
            metadata.NewThriftStructType().
                SetName("dummy.DummyStruct1"),
        )
    }()
...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    thriftTypesWithFullName = append(thriftTypesWithFullName, thriftTypeWithFullName{ "dummy.DummyStruct1", premadeThriftType_dummy_DummyStruct1 })
