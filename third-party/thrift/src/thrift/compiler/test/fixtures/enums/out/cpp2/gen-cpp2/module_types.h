...
class MyStruct final  {
 private:
  ...
  static constexpr const std::int16_t __fbthrift_reflection_field_ids[] = {0,1,2,4,6};
...
template <> struct TSchemaAssociation<::test::fixtures::enums::SomeStruct> {
