...
#endif
  virtual void async_tm_sink(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int64_t p_sink);
...
#endif
  virtual void async_tm_deleteDataById(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int64_t p_id);
