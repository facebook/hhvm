...
#define YYTOKEN(num, name) name = num,
   ...
   YYTOKEN_MAP
  {
    ...
    YYTOKEN(375, T_DICT)
    YYTOKEN(376, T_VEC)
    YYTOKEN(377, T_VARRAY)
    YYTOKEN(378, T_DARRAY)
    YYTOKEN(379, T_KEYSET)
    YYTOKEN(380, T_CALLABLE)
    YYTOKEN(381, T_CLASS_C)
    YYTOKEN(382, T_METHOD_C)
    YYTOKEN(383, T_FUNC_C)
    YYTOKEN(384, T_LINE)
    YYTOKEN(385, T_FILE)
    YYTOKEN(386, T_COMMENT)
    YYTOKEN(387, T_DOC_COMMENT)
    YYTOKEN(388, T_OPEN_TAG)
    YYTOKEN(389, T_OPEN_TAG_WITH_ECHO)
    YYTOKEN(390, T_CLOSE_TAG)
    YYTOKEN(391, T_WHITESPACE)
    YYTOKEN(392, T_START_HEREDOC)
    YYTOKEN(393, T_END_HEREDOC)
    YYTOKEN(394, T_DOLLAR_OPEN_CURLY_BRACES)
    YYTOKEN(395, T_CURLY_OPEN)
    YYTOKEN(396, T_DOUBLE_COLON)
    YYTOKEN(397, T_NAMESPACE)
    YYTOKEN(398, T_NS_C)
    YYTOKEN(399, T_DIR)
    YYTOKEN(400, T_NS_SEPARATOR)
    YYTOKEN(401, T_XHP_LABEL)
    YYTOKEN(402, T_XHP_TEXT)
    YYTOKEN(403, T_XHP_ATTRIBUTE)
    YYTOKEN(404, T_XHP_CATEGORY)
    YYTOKEN(405, T_XHP_CATEGORY_LABEL)
    YYTOKEN(406, T_XHP_CHILDREN)
    YYTOKEN(407, T_ENUM)
    YYTOKEN(408, T_XHP_REQUIRED)
    YYTOKEN(409, T_TRAIT)
    YYTOKEN(410, T_ELLIPSIS)
    YYTOKEN(411, T_INSTEADOF)
    YYTOKEN(412, T_TRAIT_C)
    YYTOKEN(413, T_HH_ERROR)
    YYTOKEN(414, T_FINALLY)
    YYTOKEN(415, T_XHP_TAG_LT)
    YYTOKEN(416, T_XHP_TAG_GT)
    YYTOKEN(417, T_TYPELIST_LT)
    YYTOKEN(418, T_TYPELIST_GT)
    YYTOKEN(419, T_UNRESOLVED_LT)
    YYTOKEN(420, T_COLLECTION)
    YYTOKEN(421, T_SHAPE)
    YYTOKEN(422, T_TYPE)
    YYTOKEN(423, T_UNRESOLVED_TYPE)
    YYTOKEN(424, T_NEWTYPE)
    YYTOKEN(425, T_UNRESOLVED_NEWTYPE)
    YYTOKEN(426, T_COMPILER_HALT_OFFSET)
    YYTOKEN(427, T_ASYNC)
