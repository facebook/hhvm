...
public class AllowLegacyDeprecatedTerseWritesRef implements TBase, java.io.Serializable, Cloneable, Comparable<AllowLegacyDeprecatedTerseWritesRef> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(AllowLegacyDeprecatedTerseWritesRef.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public AllowLegacyDeprecatedTerseWritesRef build() {
      AllowLegacyDeprecatedTerseWritesRef result = new AllowLegacyDeprecatedTerseWritesRef();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(AllowLegacyDeprecatedTerseWritesRef other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("AllowLegacyDeprecatedTerseWritesRef");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
