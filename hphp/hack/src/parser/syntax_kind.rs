...
impl SyntaxKind {
    ...
    pub fn ocaml_tag(&self) -> u8 {
        match self {
            ...
            SyntaxKind::EmptyExpression => 105,
            SyntaxKind::DefineExpression => 106,
            SyntaxKind::HaltCompilerExpression => 107,
            SyntaxKind::IssetExpression => 108,
            SyntaxKind::FunctionCallExpression => 109,
            SyntaxKind::ParenthesizedExpression => 110,
            SyntaxKind::BracedExpression => 111,
            ...
            SyntaxKind::ArrayCreationExpression => 118,
            SyntaxKind::ArrayIntrinsicExpression => 119,
