...
+ [` ::_getValidErrno(): Errno `](/hsl/Classes/HH.Lib.OS/NotFoundException/_getValidErrno/)
+ [` ->__construct(string $message) `](/hsl/Classes/HH.Lib.OS/NotFoundException/__construct/)
