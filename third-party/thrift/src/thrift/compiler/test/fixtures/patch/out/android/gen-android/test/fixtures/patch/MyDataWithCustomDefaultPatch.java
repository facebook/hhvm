...
public class MyDataWithCustomDefaultPatch implements TBase, java.io.Serializable, Cloneable {
   ...
   * 
   */
  public final MyDataWithCustomDefault assign;
  /**
   ...
   */
  public final MyDataWithCustomDefaultFieldPatch patchPrior;
  /**
   * Initialize fields, using the given defaults. Applies third.
   */
  public final MyDataWithCustomDefaultEnsureStruct ensure;
  /**
   * Patches any set value, including newly set values. Applies last.
   */
  public final MyDataWithCustomDefaultFieldPatch patch;
  /**
  ...
  public static MyDataWithCustomDefaultPatch deserialize(TProtocol iprot) throws TException {
    MyDataWithCustomDefault tmp_assign = null;
    Boolean tmp_clear = null;
    MyDataWithCustomDefaultFieldPatch tmp_patchPrior = null;
    MyDataWithCustomDefaultEnsureStruct tmp_ensure = null;
    MyDataWithCustomDefaultFieldPatch tmp_patch = null;
      ...
      switch (__field.id)
      {
        case ASSIGN:
          if (__field.type == TType.STRUCT) {
            tmp_assign = MyDataWithCustomDefault.deserialize(iprot);
          } else {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            tmp_patchPrior = MyDataWithCustomDefaultFieldPatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case ENSURE:
          if (__field.type == TType.STRUCT) {
            tmp_ensure = MyDataWithCustomDefaultEnsureStruct.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case PATCH:
          if (__field.type == TType.STRUCT) {
            tmp_patch = MyDataWithCustomDefaultFieldPatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              tmp_remove = new ArrayList<Short>(Math.max(0, _list69.size));
              for (int _i70 = 0; 
    ...
    MyDataWithCustomDefaultPatch _that;
    _that = new MyDataWithCustomDefaultPatch(
      tmp_assign
      ,tmp_clear
      ,tmp_patchPrior
      ,tmp_ensure
