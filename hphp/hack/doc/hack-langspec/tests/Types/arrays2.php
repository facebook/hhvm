...
class C2 {
  ...
  public array<float, bool> $pr_float_bool =
    array(1.2 => true, 1.4 => false, 1.5 => true);
  ...
  public array<float, string> $pr_float_string =
    array(4.5 => "abc", 9.88 => "def");
  ...
  public array<string, string> $pr_string_string =
    array('red' => 'yes', 'green' => 'no');
  ...
  public function __construct() {
    ...
    $this->pr_num_num[7] = 10;
    $this->pr_num_num[-3.5] = 6.7;
...
function main(): void {
  ...
  echo "pr_bool_bool: ";
  var_dump($c2->pr_bool_bool);
  echo "pr_bool_int: ";
  var_dump($c2->pr_bool_int);
  echo "pr_bool_float: ";
  var_dump($c2->pr_bool_float);
  echo "pr_bool_num: ";
  var_dump($c2->pr_bool_num);
  echo "pr_bool_string: ";
  var_dump($c2->pr_bool_string);
  //  echo "pr_bool_void: "; var_dump($c2->pr_bool_void);

  echo "\n====== int keys ======\n\n";
  echo "pr_int_bool: ";
  var_dump($c2->pr_int_bool);
  echo "pr_int_int: ";
  var_dump($c2->pr_int_int);
  echo "pr_int_float: ";
  var_dump($c2->pr_int_float);
  echo "pr_int_num: ";
  var_dump($c2->pr_int_num);
  echo "pr_int_string: ";
  var_dump($c2->pr_int_string);
  //  echo "pr_int_void: "; var_dump($c2->pr_int_void);

  echo "\n====== float keys (implicitly converted to int) ======\n\n";
  echo "pr_float_bool: ";
  var_dump($c2->pr_float_bool);
  echo "pr_float_int: ";
  var_dump($c2->pr_float_int);
  echo "pr_float_float: ";
  var_dump($c2->pr_float_float);
  echo "pr_float_num: ";
  var_dump($c2->pr_float_num);
  echo "pr_float_string: ";
  var_dump($c2->pr_float_string);
  //  echo "pr_float_void: "; var_dump($c2->pr_float_void);

  echo "\n====== num keys (implicitly converted to int) ======\n\n";
  echo "pr_num_bool: ";
  var_dump($c2->pr_num_bool);
  echo "pr_num_int: ";
  var_dump($c2->pr_num_int);
  echo "pr_num_float: ";
  var_dump($c2->pr_num_float);
  echo "pr_num_num: ";
  var_dump($c2->pr_num_num);
  echo "pr_num_string: ";
  var_dump($c2->pr_num_string);
  //  echo "pr_num_void: "; var_dump($c2->pr_num_void);

  echo "\n====== string keys ======\n\n";
  echo "pr_string_bool: ";
  var_dump($c2->pr_string_bool);
  echo "pr_string_int: ";
  var_dump($c2->pr_string_int);
  echo "pr_string_float: ";
  var_dump($c2->pr_string_float);
  echo "pr_string_num: ";
  var_dump($c2->pr_string_num);
  echo "pr_string_string: ";
  var_dump($c2->pr_string_string);
  ...
  echo "\n====== array<bool> keys ======\n\n";
  echo "pr_arraybool_bool: ";
  var_dump($c2->pr_arraybool_bool);
  echo "pr_arraybool_int: ";
  var_dump($c2->pr_arraybool_int);
  echo "pr_arraybool_float: ";
  var_dump($c2->pr_arraybool_float);
  echo "pr_arraybool_num: ";
  var_dump($c2->pr_arraybool_num);
  echo "pr_arraybool_string: ";
  var_dump($c2->pr_arraybool_string);
  //  echo "pr_arraybool_void: "; var_dump($c2->pr_arraybool_void);

  echo "\n====== C1 keys ======\n\n";
  echo "pr_C1_bool: ";
  var_dump($c2->pr_C1_bool);
  echo "pr_C1_int: ";
  var_dump($c2->pr_C1_int);
  echo "pr_C1_float: ";
  var_dump($c2->pr_C1_float);
  echo "pr_C1_num: ";
  var_dump($c2->pr_C1_num);
  echo "pr_C1_string: ";
  var_dump($c2->pr_C1_string);
