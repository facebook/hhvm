...
class SomeStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_SomeStruct):
    ...
    @reasonable.setter
    def reasonable(self, value: _fbthrift_current_module.Metasyntactic) -> None: ...


    @property
    def fine(self) -> _fbthrift_current_module.Metasyntactic: ...
    @fine.setter
    def fine(self, value: _fbthrift_current_module.Metasyntactic) -> None: ...


    @property
    def questionable(self) -> _fbthrift_current_module.Metasyntactic: ...
    @questionable.setter
    def questionable(self, value: _fbthrift_current_module.Metasyntactic) -> None: ...
...
class MyStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_MyStruct):
    ...
    @me2_3.setter
    def me2_3(self, value: _fbthrift_current_module.MyEnum2) -> None: ...


    @property
    def me3_n3(self) -> _fbthrift_current_module.MyEnum3: ...
    @me3_n3.setter
    def me3_n3(self, value: _fbthrift_current_module.MyEnum3) -> None: ...


    @property
    def me1_t1(self) -> _fbthrift_current_module.MyEnum1: ...
    @me1_t1.setter
    def me1_t1(self, value: _fbthrift_current_module.MyEnum1) -> None: ...


    @property
    def me1_t2(self) -> _fbthrift_current_module.MyEnum1: ...
    @me1_t2.setter
    def me1_t2(self, value: _fbthrift_current_module.MyEnum1) -> None: ...
