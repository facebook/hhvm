...
var (
    ...
    premadeThriftType_module_RefFields = metadata.NewThriftType().SetTStruct(
        metadata.NewThriftStructType().
            SetName("module.RefFields"),
            )
    premadeThriftType_module_RefFieldsFieldPatch = metadata.NewThriftType().SetTStruct(
        metadata.NewThriftStructType().
            SetName("module.RefFieldsFieldPatch"),
            )
    premadeThriftType_module_RefFieldsEnsureStruct = metadata.NewThriftType().SetTStruct(
        metadata.NewThriftStructType().
    ...
    premadeThriftType_module_RefFieldsField7Patch = metadata.NewThriftType().SetTStruct(
        metadata.NewThriftStructType().
            SetName("module.RefFieldsField7Patch"),
            )
)
...
var structMetadatas = []*metadata.ThriftStruct{
    ...
    SetName("assign").
    SetIsOptional(true).
    SetType(premadeThriftType_module_RefFields),
            metadata.NewThriftField().
    SetId(2).
    SetName("clear").
    SetIsOptional(false).
    ...
    SetName("patchPrior").
    SetIsOptional(false).
    SetType(premadeThriftType_module_RefFieldsFieldPatch),
            metadata.NewThriftField().
    SetId(5).
    SetName("ensure").
    SetIsOptional(false).
    SetType(premadeThriftType_module_RefFieldsEnsureStruct),
            metadata.NewThriftField().
    SetId(6).
    SetName("patch").
    SetIsOptional(false).
    ...
    SetName("opt_box").
    SetIsOptional(false).
    SetType(premadeThriftType_module_RefFieldsField7Patch),
        },
    ),
    metadata.NewThriftStruct().
    SetName("module.RefFieldsEnsureStruct").
