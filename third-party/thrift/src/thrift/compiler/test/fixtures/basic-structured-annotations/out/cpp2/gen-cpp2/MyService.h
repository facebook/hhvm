...
class ServiceHandler<::test::fixtures::basic-structured-annotations::MyService> : public apache::thrift::ServerInterface {
  static_assert(!folly::is_detected_v<detail::st::detect_complete, ::test::fixtures::basic-structured-annotations::MyService>, "Definition collision with service tag. Either rename the Thrift service using @cpp.Name annotation or rename the conflicting C++ type.");
