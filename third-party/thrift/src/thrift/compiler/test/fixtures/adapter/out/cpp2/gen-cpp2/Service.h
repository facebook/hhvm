...
class ServiceHandler<::facebook::thrift::test::Service> : public apache::thrift::ServerInterface {
 ...
 public:
  ...
  virtual void fbthrift_execute_decorators_before_func(apache::thrift::Cpp2RequestContext& /*requestCtx*/, apache::thrift::detail::DecoratorArgType<::std::string>::type /*p_arg1*/, apache::thrift::detail::DecoratorArgType<::std::string>::type /*p_arg2*/, apache::thrift::detail::DecoratorArgType<::facebook::thrift::test::Foo>::type /*p_arg3*/) {}
...
template <> struct TSchemaAssociation<::facebook::thrift::test::Service, false> {
  ...
  static constexpr ::std::string_view definitionKey = {"\xde\xec\xa4\xda\x21\x97\x3c\x6f\x66\xfa\x43\x5d\xc5\x83\x7d\xdc", 16};
};
}
} // namespace apache::thrift
