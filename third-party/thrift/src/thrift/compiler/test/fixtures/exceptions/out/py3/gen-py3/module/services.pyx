...
async def Raiser_doBland_coro(
    ...
    try:
        ...
        print(
            "Unexpected error in service handler Raiser.doBland:",
            file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
        ...
        print("Coroutine was cancelled in service handler Raiser.doBland:", file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
...
async def Raiser_doRaise_coro(
    ...
    try:
        ...
        print(
            "Unexpected error in service handler Raiser.doRaise:",
            file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, repr(ex).encode('UTF-8')
        ...
        print("Coroutine was cancelled in service handler Raiser.doRaise:", file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, (f'Application was cancelled on the server with message: {str(ex)}').encode('UTF-8')
        ))
...
async def Raiser_get200_coro(
    ...
    try:
        ...
        print(
            "Unexpected error in service handler Raiser.get200:",
            file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, repr(ex).encode('UTF-8')
        ...
        print("Coroutine was cancelled in service handler Raiser.get200:", file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, (f'Application was cancelled on the server with message: {str(ex)}').encode('UTF-8')
        ))
...
async def Raiser_get500_coro(
    ...
    try:
        ...
        print(
            "Unexpected error in service handler Raiser.get500:",
            file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, repr(ex).encode('UTF-8')
        ...
        print("Coroutine was cancelled in service handler Raiser.get500:", file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, (f'Application was cancelled on the server with message: {str(ex)}').encode('UTF-8')
        ))
...
async def Raiser_onStartServing_coro(
    ...
    try:
        ...
        print(
            "Unexpected error in service handler Raiser.onStartServing:",
            file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, repr(ex).encode('UTF-8')
        ...
        print("Coroutine was cancelled in service handler Raiser.onStartServing:", file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, (f'Application was cancelled on the server with message: {str(ex)}').encode('UTF-8')
        ))
...
async def Raiser_onStopRequested_coro(
    ...
    try:
        ...
        print(
            "Unexpected error in service handler Raiser.onStopRequested:",
            file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, repr(ex).encode('UTF-8')
        ...
        print("Coroutine was cancelled in service handler Raiser.onStopRequested:", file=sys.stderr)
        traceback.print_exc()
        promise.cPromise.setException(cTApplicationException(
            cTApplicationExceptionType__UNKNOWN, (f'Application was cancelled on the server with message: {str(ex)}').encode('UTF-8')
        ))
