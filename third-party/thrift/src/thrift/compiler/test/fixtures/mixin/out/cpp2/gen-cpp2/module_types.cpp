...
template void TccStructTraits<::cpp2::Mixin1>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::Mixin2>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::Mixin3Base>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
