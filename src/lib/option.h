...
public:
   ...
   */
  static bool Load(const char *filename); // PHP file
  static void Load(Hdf &config);
  static void Load(ServerDataPtr server);
...
private:
  ...
  static bool Load(VariableTablePtr variables);
  static ExpressionPtr GetValue(VariableTablePtr variables, const char *var);
  static bool GetArrayElements(ExpressionPtr value, ExpressionListPtr &out);
  static bool Load(bool &option, ExpressionPtr value);
  static bool Load(int &option, ExpressionPtr value);
  static bool Load(std::string &option, ExpressionPtr value);
  static bool Load(std::set<std::string> &option, ExpressionPtr value);
  static bool Load(std::map<std::string, std::string> &option,
                   ExpressionPtr value);
  static bool Load(std::map<std::string, int> &option, ExpressionPtr value);
