...
#include <cpp/ext/hash/hash_md.h>
#include <cpp/ext/hash/hash_sha.h>
#include <cpp/ext/hash/hash_ripemd.h>
#include <cpp/ext/hash/hash_whirlpool.h>
#include <cpp/ext/hash/hash_tiger.h>
#include <cpp/ext/hash/hash_snefru.h>
#include <cpp/ext/hash/hash_gost.h>
#include <cpp/ext/hash/hash_adler32.h>
#include <cpp/ext/hash/hash_crc32.h>
#include <cpp/ext/hash/hash_haval.h>
...
static Variant php_hash_do_hash(CStrRef algo, CStrRef data, bool isfilename,
  ...
  if (!ops) {
    Logger::Warning("Unknown hashing algorithm: %s", algo.data());
    return false;
  }
  Variant f;
  if (isfilename) {
...
Variant f_hash_init(CStrRef algo, int options /* = 0 */,
  ...
  if ((options & k_HASH_HMAC) && key.empty()) {
    Logger::Warning("HMAC requested without a key");
    return false;
  }
