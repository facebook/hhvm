...
pub trait SyntaxType<C>: SyntaxTypeBase<C>
{
    ...
    fn make_case_type_variant(ctx: &C, case_type_variant_bar: Self, case_type_variant_type: Self, case_type_variant_where_clause: Self) -> Self;
    ...
    fn make_anonymous_function(ctx: &C, anonymous_attribute_spec: Self, anonymous_async_keyword: Self, anonymous_function_keyword: Self, anonymous_type_parameters: Self, anonymous_left_paren: Self, anonymous_parameters: Self, anonymous_right_paren: Self, anonymous_ctx_list: Self, anonymous_colon: Self, anonymous_readonly_return: Self, anonymous_type: Self, anonymous_use: Self, anonymous_body: Self) -> Self;
    ...
    fn make_lambda_signature(ctx: &C, lambda_function_keyword: Self, lambda_type_parameters: Self, lambda_left_paren: Self, lambda_parameters: Self, lambda_right_paren: Self, lambda_contexts: Self, lambda_colon: Self, lambda_readonly_return: Self, lambda_type: Self) -> Self;
    ...
    fn make_closure_parameter_type_specifier(ctx: &C, closure_parameter_optional: Self, closure_parameter_call_convention: Self, closure_parameter_readonly: Self, closure_parameter_pre_ellipsis: Self, closure_parameter_type: Self, closure_parameter_ellipsis: Self) -> Self;
    fn make_tuple_or_union_or_intersection_element_type_specifier(ctx: &C, tuple_or_union_or_intersection_element_optional: Self, tuple_or_union_or_intersection_element_pre_ellipsis: Self, tuple_or_union_or_intersection_element_type: Self, tuple_or_union_or_intersection_element_ellipsis: Self) -> Self;
