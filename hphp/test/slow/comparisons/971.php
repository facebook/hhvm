...
$i = 0;
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\lt(varray['1'], varray[1])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray['1'];
 try { P(HH\Lib\Legacy_FIXME\lt($a, varray[1])); } catch (Throwable $_) { print 'E'; }
 $b = 1;
 $b = 't';
 $b = varray[1];
 try { P(HH\Lib\Legacy_FIXME\lt(varray['1'], $b)); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\lt(varray['1'], varray[2])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray['1'];
 try { P(HH\Lib\Legacy_FIXME\lt($a, varray[2])); } catch (Throwable $_) { print 'E'; }
 $b = 1;
 $b = 't';
 $b = varray[2];
 try { P(HH\Lib\Legacy_FIXME\lt(varray['1'], $b)); } catch (Throwable $_) { print 'E'; }
