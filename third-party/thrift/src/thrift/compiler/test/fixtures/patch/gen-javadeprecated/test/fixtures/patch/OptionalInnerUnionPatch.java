...
public class OptionalInnerUnionPatch implements TBase, java.io.Serializable, Cloneable, Comparable<OptionalInnerUnionPatch> {
   ...
   */
  public InnerUnionPatch patchPrior;
  /**
  ...
  static {
    FieldMetaData.addStructMetaDataMap(OptionalInnerUnionPatch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    private InnerUnionPatch patchPrior;
    private InnerUnion ensure;
    private InnerUnionPatch patch;
    ...
    public Builder setPatchPrior(final InnerUnionPatch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }
    ...
    public Builder setPatch(final InnerUnionPatch patch) {
      this.patch = patch;
      return this;
    }
   ...
   * Clears any set value. Applies first.
   */
  public OptionalInnerUnionPatch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public OptionalInnerUnionPatch setPatchPrior(InnerUnionPatch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((InnerUnionPatch)__value);
      }
      break;
    ...
    case PATCH:
      if (__value == null) {
        ...
        setPatch((InnerUnionPatch)__value);
      }
      break;
  ...
  @Override
  public int compareTo(OptionalInnerUnionPatch other) {
    if (other == null) {
      ...
      switch (__field.id)
      {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            this.patchPrior = new InnerUnionPatch();
        ...
        case PATCH:
          if (__field.type == TType.STRUCT) {
            this.patch = new InnerUnionPatch();
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("OptionalInnerUnionPatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
