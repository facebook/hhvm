...
cdef class __Foo_FieldsSetter(__StructFieldsSetter):
    ...
    @staticmethod
    cdef __Foo_FieldsSetter _fbthrift_create(_transitive_cbindings.cFoo* struct_cpp_obj):
        cdef __Foo_FieldsSetter __fbthrift_inst = __Foo_FieldsSetter.__new__(__Foo_FieldsSetter)
        __fbthrift_inst._struct_cpp_obj = struct_cpp_obj
        __fbthrift_inst._setters[__cstring_view(<const char*>"a")] = __Foo_FieldsSetter._set_field_0
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        ...
        if _fbthrift_value is None:
            __reset_field[_transitive_cbindings.cFoo](deref(self._struct_cpp_obj), 0)
            return
