...
function run_test(
  ...
  if ($file_name_stripped !== 'non_errors_namespace.php') {
      $errors[] = "Expected File Name non_errors_namespace.php ".
...
function test_function(): void {
  run_test(
    ...
    shape(
      'class_name' => null,
      'function_name' => 'FunctionCredentialTest\\test_function',
    ),
  );
}
...
trait TestTrait {
  public function test_trait_method(): void {
    run_test(
      ...
      'class_name' => 'FunctionCredentialTest\\TestClass',
...
abstract class BaseClass {
  public function test_inherited_method(): void {
    run_test('test_inherited_method', __FUNCTION_CREDENTIAL__, shape(
      'class_name' => 'FunctionCredentialTest\\BaseClass',
