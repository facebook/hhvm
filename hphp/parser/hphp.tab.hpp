...
#define YYTOKEN(num, name) name = num,
   ...
   YYTOKEN_MAP {
     ...
     YYTOKEN(360, T_LIST)
     YYTOKEN(361, T_ARRAY)
     YYTOKEN(362, T_CLASS_C)
     YYTOKEN(363, T_METHOD_C)
     YYTOKEN(364, T_FUNC_C)
     YYTOKEN(365, T_LINE)
     YYTOKEN(366, T_FILE)
     YYTOKEN(367, T_COMMENT)
     YYTOKEN(368, T_DOC_COMMENT)
     YYTOKEN(369, T_OPEN_TAG)
     YYTOKEN(370, T_OPEN_TAG_WITH_ECHO)
     YYTOKEN(371, T_CLOSE_TAG)
     YYTOKEN(372, T_WHITESPACE)
     YYTOKEN(373, T_START_HEREDOC)
     YYTOKEN(374, T_END_HEREDOC)
     YYTOKEN(375, T_DOLLAR_OPEN_CURLY_BRACES)
     YYTOKEN(376, T_CURLY_OPEN)
     YYTOKEN(377, T_DOUBLE_COLON)
     YYTOKEN(378, T_NAMESPACE)
     YYTOKEN(379, T_NS_C)
     YYTOKEN(380, T_DIR)
     YYTOKEN(381, T_NS_SEPARATOR)
     YYTOKEN(382, T_YIELD)
     YYTOKEN(383, T_XHP_LABEL)
     YYTOKEN(384, T_XHP_TEXT)
     YYTOKEN(385, T_XHP_ATTRIBUTE)
     YYTOKEN(386, T_XHP_CATEGORY)
     YYTOKEN(387, T_XHP_CATEGORY_LABEL)
     YYTOKEN(388, T_XHP_CHILDREN)
     YYTOKEN(389, T_XHP_ENUM)
     YYTOKEN(390, T_XHP_REQUIRED)
     YYTOKEN(391, T_TRAIT)
     YYTOKEN(392, T_INSTEADOF)
     YYTOKEN(393, T_TRAIT_C)
     YYTOKEN(394, T_VARARG)
     YYTOKEN(395, T_HH_ERROR)
     YYTOKEN(396, T_FINALLY)
     YYTOKEN(397, T_XHP_TAG_LT)
     YYTOKEN(398, T_XHP_TAG_GT)
     YYTOKEN(399, T_TYPELIST_LT)
     YYTOKEN(400, T_TYPELIST_GT)
     YYTOKEN(401, T_UNRESOLVED_LT)
     YYTOKEN(402, T_COLLECTION)
     YYTOKEN(403, T_SHAPE)
     YYTOKEN(404, T_TYPE)
     YYTOKEN(405, T_UNRESOLVED_TYPE)
     YYTOKEN(406, T_NEWTYPE)
     YYTOKEN(407, T_UNRESOLVED_NEWTYPE)
     YYTOKEN(408, T_COMPILER_HALT_OFFSET)
     YYTOKEN(409, T_AWAIT)
     YYTOKEN(410, T_ASYNC)
     YYTOKEN(411, T_TUPLE)
     YYTOKEN(412, T_FROM)
     ...
     YYTOKEN(415, T_IN)
     YYTOKEN(416, T_ON)
     YYTOKEN(417, T_EQUALS)
     YYTOKEN(418, T_INTO)
     YYTOKEN(419, T_LET)
     YYTOKEN(420, T_ORDERBY)
     YYTOKEN(421, T_ASCENDING)
     YYTOKEN(422, T_DESCENDING)
     YYTOKEN(423, T_SELECT)
     YYTOKEN(424, T_GROUP)
     YYTOKEN(425, T_BY)
