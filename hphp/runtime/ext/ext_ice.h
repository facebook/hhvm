		...
		class c_ICE : public ExtObjectData ,public Sweepable{
			public:
				...
				*/
				...
				// need to implement
			public: c_ICE(Class* cls = c_ICE::s_cls);
			public: ~c_ICE();
			public: void t___construct();
			public: Object t_stringtoproxy(CStrRef str=null_string);
		...
		class c_TypeInfo : public ExtObjectData , public UnmarshalCallback , public Sweepable{
				public:
						DECLARE_CLASS(TypeInfo, TypeInfo, ObjectData)
								...
								// need to implement
				public: c_TypeInfo(Class* cls = c_TypeInfo::s_cls);
				public: ~c_TypeInfo();
				public: void t___construct();
...
class c_Proxy : public ExtObjectDataFlags<ObjectData::HasCall> {
  ...
  */
  ...
  // need to implement
  public: c_Proxy(Class* cls = c_Proxy::s_cls);
  ...
  public: Object t_ice_timeout(int64_t lasttime = 0);
  public: Object t_ice_context(CArrRef ctx = null_variant);
  public: Object t_ice_checkedcast(CStrRef classid=null_string, CVarRef facetOrCtx = null_variant, CVarRef ctx = null_variant);
  public: Object t_ice_uncheckedcast(CStrRef classid=null_string, CVarRef facet = null_variant);
		...
		class c_IcePHP_class : public ExtObjectData,public Sweepable  {
				public:
						DECLARE_CLASS(IcePHP_class, IcePHP_class, ObjectData)
								...
								// need to implement
				public: c_IcePHP_class(Class* cls = c_IcePHP_class::s_cls);
