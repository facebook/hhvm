...
THRIFT_DATA_MEMBER const folly::StringPiece TStructDataStorage<::cpp2::RefUnion>::name = "RefUnion";
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::RefUnion>::fields_names = {{
  "field1",
}};
...
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::RefUnion>::storage_names = {{
  "field1",
}};
