...
#pragma once
#if __has_include(<thrift/compiler/test/fixtures/no_package/gen-cpp2/FooService.h>)
#include <thrift/compiler/test/fixtures/no_package/gen-cpp2/FooService.h>
#else
#include <thrift/compiler/test/fixtures/no_package/gen-cpp2/module_clients.h>
#endif
#if __has_include(<thrift/compiler/test/fixtures/no_package/gen-cpp2/FB303Service.h>)
#include <thrift/compiler/test/fixtures/no_package/gen-cpp2/FB303Service.h>
#else
#include <thrift/compiler/test/fixtures/no_package/gen-cpp2/module_clients.h>
#endif
#if __has_include(<thrift/compiler/test/fixtures/no_package/gen-cpp2/MyService.h>)
#include <thrift/compiler/test/fixtures/no_package/gen-cpp2/MyService.h>
#else
#include <thrift/compiler/test/fixtures/no_package/gen-cpp2/module_clients.h>
#endif
#if __has_include(<thrift/compiler/test/fixtures/no_package/gen-cpp2/DbMixedStackArguments.h>)
...
class FB303ServiceClientWrapper : public ::thrift::py3::ClientWrapper {
  public:
    ...
    folly::Future<::cpp2::ReservedKeyword> simple_rpc(
      apache::thrift::RpcOptions& rpcOptions,
