...
static CallMap s_callMap {
    ...
    {CheckInOutMismatch, checkInOutMismatch, DNone, SSync,
                          {{SSA, 0},
                           extra(&InOutArgsData::numArgs),
                           extra(&InOutArgsData::inoutArgs)}},
    {ThrowInOutMismatch, checkInOutMismatch, DNone, SSync,
                          {{SSA, 0},
                           extra(&InOutArgsData::numArgs),
                           extra(&InOutArgsData::inoutArgs)}},
    ...
    {CmpArrLike,         ArrayData::Compare, DSSA, SSync,
                          {{SSA, 0}, {SSA, 1}}},
    {GtRes,              static_cast<ResCmpFn>(more), DSSA, SNone,
                          {{SSA, 0}, {SSA, 1}}},
    {GteRes,             static_cast<ResCmpFn>(moreEqual), DSSA, SNone,
                          {{SSA, 0}, {SSA, 1}}},
    {LtRes,              static_cast<ResCmpFn>(less), DSSA, SNone,
                          {{SSA, 0}, {SSA, 1}}},
    {LteRes,             static_cast<ResCmpFn>(lessEqual), DSSA, SNone,
                          {{SSA, 0}, {SSA, 1}}},
    {CmpRes,             static_cast<ResCmpFnInt>(compare), DSSA, SNone,
                          {{SSA, 0}, {SSA, 1}}},
