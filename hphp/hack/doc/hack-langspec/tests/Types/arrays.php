...
class C1 {
  ...
  private array<string, bool> $a_string_bool =
    array('X1' => true, 'X2' => false);
  //*/
  ///*
  ...
  private array<mixed, int> $a_mixed_int =
    array(5 => 10, null => 20, 5.5 => 30);
  //*/
  /*
...
function main(): void {
  ...
  $c1->test_conversions(array(), array(true, false), array(), array(10, 20));

  echo "================= Class C1::test_intrinsics ===================\n\n";

  $c1->test_intrinsics(array(0, 100, 67));
...
class C5 {
  ...
  private array<int, string> $colorsM2 =
    array(0 => "red", 1 => "white", 2 => "blue");
  private array<int, string> $colorsM3 =
    array(2 => "blue", 0 => "red", 1 => "white");

  private array<string, bool> $flags =
    array("F1" => true, "F2" => false, "F3" => false, "F4" => true);
