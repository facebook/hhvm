...
cdef shared_ptr[_fbthrift_cbindings.cMixin1] Mixin1_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cMixin1](deref(
        (<_fbthrift_ctypes.Mixin1?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))

cdef object Mixin1_from_cpp(const shared_ptr[_fbthrift_cbindings.cMixin1]& c_struct):
    return _fbthrift_ctypes.Mixin1._create_FBTHRIFT_ONLY_DO_NOT_USE(c_struct)

cdef shared_ptr[_fbthrift_cbindings.cMixin2] Mixin2_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cMixin2](deref(
        (<_fbthrift_ctypes.Mixin2?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))

cdef object Mixin2_from_cpp(const shared_ptr[_fbthrift_cbindings.cMixin2]& c_struct):
    return _fbthrift_ctypes.Mixin2._create_FBTHRIFT_ONLY_DO_NOT_USE(c_struct)

cdef shared_ptr[_fbthrift_cbindings.cMixin3Base] Mixin3Base_convert_to_cpp(object inst) except*:
    return make_shared[_fbthrift_cbindings.cMixin3Base](deref(
        (<_fbthrift_ctypes.Mixin3Base?>inst)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE
    ))

cdef object Mixin3Base_from_cpp(const shared_ptr[_fbthrift_cbindings.cMixin3Base]& c_struct):
