...
public class LoopEnsureStruct implements TBase, java.io.Serializable, Cloneable {
  ...
  static {
    ...
    tmpMetaDataMap.put(BAR, new FieldMetaData("bar", TFieldRequirementType.OPTIONAL, 
        new StructMetaData(TType.STRUCT, Bar.class)));
    metaDataMap = Collections.unmodifiableMap(tmpMetaDataMap);
  }

  static {
    FieldMetaData.addStructMetaDataMap(LoopEnsureStruct.class, metaDataMap);
  }
  ...
  public LoopEnsureStruct setBar(Bar bar) {
    this.bar = bar;
    return this;
  }
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("LoopEnsureStruct");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
