...
- `some_dir/gen-cpp2/MyModule_fatal_types.h`: metadata for all types declared in the module, necessary when using `reflect_struct`, `reflect_enum`, `fatal::enum_traits` and related primitives;
