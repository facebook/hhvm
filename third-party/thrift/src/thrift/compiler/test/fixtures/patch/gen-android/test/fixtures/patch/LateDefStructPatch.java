...
public class LateDefStructPatch implements TBase, java.io.Serializable, Cloneable {
   ...
   * 
   */
  public final LateDefStruct assign;
  /**
   ...
   */
  public final LateDefStructFieldPatch patchPrior;
  /**
   * Initialize fields, using the given defaults. Applies third.
   */
  public final LateDefStructEnsureStruct ensure;
  /**
   * Patches any set value, including newly set values. Applies last.
   */
  public final LateDefStructFieldPatch patch;
  /**
  ...
  public static LateDefStructPatch deserialize(TProtocol iprot) throws TException {
    LateDefStruct tmp_assign = null;
    Boolean tmp_clear = null;
    LateDefStructFieldPatch tmp_patchPrior = null;
    LateDefStructEnsureStruct tmp_ensure = null;
    LateDefStructFieldPatch tmp_patch = null;
      ...
      switch (__field.id)
      {
        case ASSIGN:
          if (__field.type == TType.STRUCT) {
            tmp_assign = LateDefStruct.deserialize(iprot);
          } else {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            tmp_patchPrior = LateDefStructFieldPatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case ENSURE:
          if (__field.type == TType.STRUCT) {
            tmp_ensure = LateDefStructEnsureStruct.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case PATCH:
          if (__field.type == TType.STRUCT) {
            tmp_patch = LateDefStructFieldPatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<Short>(Math.max(0, 2*_set273.size));
              for (int _i274 = 0; 
    ...
    LateDefStructPatch _that;
    _that = new LateDefStructPatch(
      tmp_assign
      ,tmp_clear
      ,tmp_patchPrior
      ,tmp_ensure
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.remove != null) {
      oprot.writeFieldBegin(REMOVE_FIELD_DESC);
      {
        ...
        for (Short _iter276 : this.remove)        {
          oprot.writeI16(_iter276);
        }
        oprot.writeSetEnd();
      }
      oprot.writeFieldEnd();
