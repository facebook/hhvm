...
StructMetadata<::cpp2::BasicTypes>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::cpp2::BasicTypes>(metadata, kGenerateAll).metadata;
  }

  auto res = genStructMetadata<::cpp2::BasicTypes>(metadata, {.genAnnotations = folly::kIsDebug});
  if (res.preExists) {
    return res.metadata;
  }
