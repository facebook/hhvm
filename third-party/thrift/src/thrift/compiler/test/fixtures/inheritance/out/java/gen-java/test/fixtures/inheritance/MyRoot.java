...
public interface MyRoot extends java.io.Closeable, com.facebook.thrift.util.BlockingService {
    ...
    static com.facebook.thrift.client.ClientBuilder<MyRoot> clientBuilder() {
        return new ClientBuilder<MyRoot>() {
            @java.lang.Override
            public MyRoot build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                MyRoot.Reactive _delegate =
                    new MyRootReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    public interface Async extends java.io.Closeable, com.facebook.thrift.util.AsyncService {
        ...
        static com.facebook.thrift.client.ClientBuilder<MyRoot.Async> clientBuilder() {
            return new ClientBuilder<MyRoot.Async>() {
                @java.lang.Override
                public MyRoot.Async build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    MyRoot.Reactive _delegate =
                        new MyRootReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    interface Reactive extends reactor.core.Disposable, com.facebook.thrift.util.ReactiveService {
        ...
        static com.facebook.thrift.client.ClientBuilder<MyRoot.Reactive> clientBuilder() {
            return new ClientBuilder<MyRoot.Reactive>() {
                @java.lang.Override
                public MyRoot.Reactive build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    return new MyRootReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
                }
            };
        }
