...
func (p *MyStructField21Patch) GetPatch() map[int32]*patch1.I16Patch {
  return p.Patch
}
...
func (m *MyStructField21PatchBuilder) Patch(patch map[int32]*patch1.I16Patch) *MyStructField21PatchBuilder {
  m.obj.Patch = patch
  return m
}
...
func (m *MyStructField21Patch) SetPatch(patch map[int32]*patch1.I16Patch) *MyStructField21Patch {
  m.Patch = patch
  return m
}
...
func (p *MyStructField21Patch)  ReadField3(iprot thrift.Protocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
func (p *MyStructField21Patch) writeField3(oprot thrift.Protocol) (err error) {
...
func (p *MyStructField21Patch) String() string {
  ...
  return fmt.Sprintf("MyStructField21Patch({Assign:%s Clear:%s Patch:%s Remove:%s Prepend:%s Append:%s})", assignVal, clearVal, patchVal, removeVal, prependVal, appendVal)
}
