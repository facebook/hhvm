...
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::Raiser>> {
 ...
 private:
  ...
  static void gen_doBland(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_doRaise(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_get200(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_get500(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
} // namespace md
} // namespace detail
} // namespace thrift
