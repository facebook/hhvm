...
// Invalid DN
var_dump(ldap_sasl_bind($link, "Invalid DN", test_passwd(), 'DIGEST-MD5', 'realm', $sasl_user));

// Invalid user
var_dump(ldap_sasl_bind($link, null, "ThisIsNotCorrecttest_passwd()", 'DIGEST-MD5', "realm", "invalid$sasl_user"));

// Invalid password
var_dump(ldap_sasl_bind($link, null, "ThisIsNotCorrecttest_passwd()", 'DIGEST-MD5', "realm", $sasl_user));
