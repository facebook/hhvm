...
template void TccStructTraits<::facebook::thrift::test::fixtures::runtime_annotations::MyAnnotation>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::runtime_annotations::MyStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::runtime_annotations::MyUnion>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::runtime_annotations::MyException>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
