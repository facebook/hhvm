...
void apache::thrift::ServiceHandler<::test_cpp2::cpp_reflection::service3>::sync_methodB(::std::int32_t /*x*/, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> /*y*/, double /*z*/) {
  apache::thrift::detail::si::throw_app_exn_unimplemented("methodB");
}

void apache::thrift::ServiceHandler<::test_cpp2::cpp_reflection::service3>::methodB(::std::int32_t p_x, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_y, double p_z) {
...
::std::int32_t apache::thrift::ServiceHandler<::test_cpp2::cpp_reflection::service3>::sync_methodD(::std::int32_t /*i*/, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> /*j*/, double /*k*/) {
  apache::thrift::detail::si::throw_app_exn_unimplemented("methodD");
}

::std::int32_t apache::thrift::ServiceHandler<::test_cpp2::cpp_reflection::service3>::methodD(::std::int32_t p_i, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_j, double p_k) {
...
void apache::thrift::ServiceHandler<::test_cpp2::cpp_reflection::service3>::sync_methodF(::test_cpp2::cpp_reflection::struct3& /*_return*/, ::std::int32_t /*l*/, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> /*m*/, double /*n*/) {
  apache::thrift::detail::si::throw_app_exn_unimplemented("methodF");
}

void apache::thrift::ServiceHandler<::test_cpp2::cpp_reflection::service3>::methodF(::test_cpp2::cpp_reflection::struct3& _return, ::std::int32_t p_l, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_m, double p_n) {
