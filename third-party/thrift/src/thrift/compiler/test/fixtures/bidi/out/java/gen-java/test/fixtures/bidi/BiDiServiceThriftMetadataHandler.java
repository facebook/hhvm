...
public class BiDiServiceThriftMetadataHandler implements com.facebook.thrift.server.ThriftMetadataHandler {
    ...
    private static void addFunctions_0(List<ThriftFunction> functions) {
            ...
            }
            {
              ...
              exceptions.add(new ThriftField.Builder()
                  .setId(1)
                  .setType(ThriftType.fromTStruct(new ThriftStructType.Builder().setName("test.fixtures.bidi.BiDiMethodException").build()))
                  .setName("exception_1")
                  .setIsOptional(false)
                  .build());
    ...
    static {
        ...
        THRIFT_SERVICE = new ThriftService.Builder()
            .setName("test.fixtures.bidi.BiDiService")
    ...
    public String getFullyQualifiedName() {
        return "test.fixtures.bidi.BiDiService";
    }
    ...
    public Map<String, ThriftEnum> getEnums() {
        return BiDiServiceThriftMetadataHandlerEnums.getEnums();
    }

    @Override
    public Map<String, ThriftStruct> getStructs() {
        return BiDiServiceThriftMetadataHandlerStructs.getStructs();
    }

    @Override
    public Map<String, ThriftException> getExceptions() {
        return BiDiServiceThriftMetadataHandlerExceptions.getExceptions();
    }
}
