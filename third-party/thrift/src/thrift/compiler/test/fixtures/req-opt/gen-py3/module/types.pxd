...
cdef extern from "thrift/compiler/test/fixtures/req-opt/src/gen-py3/module/types.h":
  pass
...
cdef extern from "thrift/compiler/test/fixtures/req-opt/src/gen-cpp2/module_metadata.h" namespace "apache::thrift::detail::md":
...
cdef extern from "thrift/compiler/test/fixtures/req-opt/src/gen-cpp2/module_metadata.h" namespace "apache::thrift::detail::md":
    cdef cppclass StructMetadata[T]:
        @staticmethod
        void gen(__fbthrift_cThriftMetadata &metadata)
cdef extern from "thrift/compiler/test/fixtures/req-opt/src/gen-cpp2/module_types_custom_protocol.h" namespace "::cpp2":
