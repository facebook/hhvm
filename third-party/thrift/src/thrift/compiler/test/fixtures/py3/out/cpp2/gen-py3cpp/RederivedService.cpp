...
apache::thrift::ServiceHandler<::py3::simple::RederivedService>::semifuture_get_seven() {
  auto expected{apache::thrift::detail::si::InvocationType::SemiFuture};
  __fbthrift_invocation_get_seven.compare_exchange_strong(
      expected,
...
apache::thrift::ServiceHandler<::py3::simple::RederivedService>::future_get_seven() {
  ...
  return apache::thrift::detail::si::future(
      semifuture_get_seven(),
      getInternalKeepAlive());
}

#if FOLLY_HAS_COROUTINES
folly::coro::Task<::std::int32_t>
apache::thrift::ServiceHandler<::py3::simple::RederivedService>::co_get_seven() {
...
void apache::thrift::ServiceHandler<::py3::simple::RederivedService>::async_tm_get_seven(
...
#endif // FOLLY_HAS_COROUTINES
  auto invocationType =
      __fbthrift_invocation_get_seven.load(std::memory_order_relaxed);
  try {
