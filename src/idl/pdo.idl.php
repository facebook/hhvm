<?php
/**
 * Automatically generated by running "php schema.php pdo".
 *
...
DefineFunction(
  array(
    ...
    'return' => array(
      'type'   => Variant,
      'desc'   => "If the database server successfully prepares the statement, PDO::prepare() returns a PDOStatement object. If the database server cannot successfully prepare the statement, PDO::prepare() returns FALSE or emits PDOException (depending on error handling). Note: Emulated prepared statements does not communicate with the database server so PDO::prepare() does not check the statement.",
    ),
    'args'   => array(
      array(
        'name'   => "statement",
...
DefineFunction(
  array(
    ...
    'return' => array(
      'type'   => Boolean,
      'desc'   => "Returns TRUE on success or FALSE on failure. PDOStatement PDO::rollBack Last updated: Fri, 06 Aug 2010  ",
    ),
    'args'   => array(
      array(
        'name'   => "attribute",
