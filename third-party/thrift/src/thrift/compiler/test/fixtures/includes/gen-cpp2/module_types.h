...
class MyStruct final  {
 private:
  ...
  struct __fbthrift_ordinal_impl {
    ...
    template<> static constexpr int value<::apache::thrift::ident::MyIncludedField> = 1;
    template<> static constexpr int value<::apache::thrift::field_id<2>> = 2;
    template<> static constexpr int value<::apache::thrift::ident::MyOtherIncludedField> = 2;
    template<> static constexpr int value<::apache::thrift::field_id<3>> = 3;
    template<> static constexpr int value<::apache::thrift::ident::MyIncludedInt> = 3;
#else
    ...
    static constexpr int value_impl(folly::tag_t<::apache::thrift::ident::MyIncludedField>) { return 1; }
    static constexpr int value_impl(folly::tag_t<::apache::thrift::field_id<2>>) { return 2; }
    static constexpr int value_impl(folly::tag_t<::apache::thrift::ident::MyOtherIncludedField>) { return 2; }
    static constexpr int value_impl(folly::tag_t<::apache::thrift::field_id<3>>) { return 3; }
    static constexpr int value_impl(folly::tag_t<::apache::thrift::ident::MyIncludedInt>) { return 3; }
  ...
  struct __fbthrift_ordinal_impl_for_non_unique_type {
    ...
    template<class T> struct Impl<::apache::thrift::type::struct_t<::cpp2::Included>, T, std::enable_if_t<sizeof(T) != -1>> { static constexpr int value = 1; };
    template<class T> struct Impl<::apache::thrift::type::struct_t<::cpp2::Included>, T, std::enable_if_t<sizeof(T) != -2>> { static constexpr int value = 2; };
 ...
 public:
  ...
  MyStruct() :
      __fbthrift_field_MyIncludedField(static_cast<::cpp2::Included>(::apache::thrift::detail::make_structured_constant<::cpp2::Included>(::apache::thrift::detail::wrap_struct_argument<::apache::thrift::ident::MyIntField>(static_cast<::std::int64_t>(2)), ::apache::thrift::detail::wrap_struct_argument<::apache::thrift::ident::MyTransitiveField>(static_cast<::cpp2::Foo>(::apache::thrift::detail::make_structured_constant<::cpp2::Foo>(::apache::thrift::detail::wrap_struct_argument<::apache::thrift::ident::a>(static_cast<::std::int64_t>(2)))))))),
