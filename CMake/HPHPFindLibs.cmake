...
macro(hphp_link target)
  ...
  target_link_libraries(${target} ${VISIBILITY} libcompile_ffi_stubs)
  target_link_libraries(${target} ${VISIBILITY} librust_facts_ffi_stubs)
  target_link_libraries(${target} ${VISIBILITY} librust_parser_ffi_stubs)
  target_link_libraries(${target} ${VISIBILITY} libdecl_cpp_ffi_stubs)
