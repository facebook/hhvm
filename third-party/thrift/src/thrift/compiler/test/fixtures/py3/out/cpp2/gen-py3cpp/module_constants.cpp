...
::std::string_view _fbthrift_schema_cb2e7e89aab8f829() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_cb2e7e89aab8f829_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_cb2e7e89aab8f829_uris() {
  return {};
}
