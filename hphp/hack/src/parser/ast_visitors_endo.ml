...
class virtual ['self] endo =
  object (self : 'self)
    ...
    method on_ClassVars env this
      ...
      if c0 == r0 && c1 == r1 && c2 == r2
      then this
      else ClassVars { cv_kinds = r0; cv_hint = r1; cv_names = r2; cv_doc_comment = c3 }
    ...
    method on_class_elt env this =
      ...
      | ClassVars cv as this ->
          self#on_ClassVars env this cv
    ...
    method on_stmt env this =
      ...
      | Using s -> self#on_Using env this s
    ...
    method on_Using env this s =
      let r1 = self#on_expr env s.us_expr in
      let r2 = self#on_block env s.us_block in
      if s.us_expr == r1 && s.us_block == r2
      then this
      else Using { s with us_expr = r1; us_block = r2 }
