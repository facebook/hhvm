          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.assign = new HashMap<String,String>(Math.max(0, 2*_map78.size));
              for (int _i79 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.patchPrior = new HashMap<String,com.facebook.thrift.op.StringPatch>(Math.max(0, 2*_map82.size));
              for (int _i83 = 0; 
                   ...
                   ++_i83)
              {
                ...
                _val85.read(iprot);
                this.patchPrior.put(_key84, _val85);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.add = new HashMap<String,String>(Math.max(0, 2*_map86.size));
              for (int _i87 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.patch = new HashMap<String,com.facebook.thrift.op.StringPatch>(Math.max(0, 2*_map90.size));
              for (int _i91 = 0; 
                   (_map90.size < 0) ? iprot.peekMap() : (_i91 < _map90.size); 
                   ++_i91)
              {
                String _key92;
                com.facebook.thrift.op.StringPatch _val93;
                _key92 = iprot.readString();
                _val93 = new com.facebook.thrift.op.StringPatch();
                _val93.read(iprot);
                this.patch.put(_key92, _val93);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.remove = new HashSet<String>(Math.max(0, 2*_set94.size));
              for (int _i95 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.put = new HashMap<String,String>(Math.max(0, 2*_map97.size));
              for (int _i98 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.patchPrior != null) {
      oprot.writeFieldBegin(PATCH_PRIOR_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, com.facebook.thrift.op.StringPatch> _iter102 : this.patchPrior.entrySet())        {
    ...
    if (this.patch != null) {
      oprot.writeFieldBegin(PATCH_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, com.facebook.thrift.op.StringPatch> _iter104 : this.patch.entrySet())        {
