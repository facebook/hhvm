...
var exceptionMetadatas = func() []*metadata.ThriftException {
    ...
    fbthriftResults = append(fbthriftResults, getMetadataThriftException(premadeStructSpec_FooStreamEx))
    fbthriftResults = append(fbthriftResults, getMetadataThriftException(premadeStructSpec_FooEx))
    fbthriftResults = append(fbthriftResults, getMetadataThriftException(premadeStructSpec_FooEx2))
    return fbthriftResults
}()
