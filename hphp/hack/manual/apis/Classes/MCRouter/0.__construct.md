...
The following example shows you how to explicitly create an instance of [` MCRouter `](/docs/apis/Classes/MCRouter/) using `` new ``, by definition, its constructor. You must create a configuration string (or provide a configuration file that contains appropriate configuration information), and, optionally, a persistence identifier can bet passed as the second parameter to the constructor.
