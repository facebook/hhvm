...
folly::Future<std::unique_ptr<::thrift::py3::ClientWrapper>>
FactoriesClientWrapper::createMyInteraction() {
  return folly::via(
      channel_->getEventBase(),
      [=]() -> std::unique_ptr<::thrift::py3::ClientWrapper> {
        auto interaction_client = static_cast<std::unique_ptr<apache::thrift::GeneratedAsyncClient>>(std::make_unique<FactoriesAsyncClient::MyInteraction>(((FactoriesAsyncClient*)async_client_.get())->createMyInteraction()));
        return static_cast<std::unique_ptr<::thrift::py3::ClientWrapper>>(std::make_unique<MyInteractionInteractionWrapper>(std::move(interaction_client), channel_));
      }
  );
}
...
folly::Future<std::unique_ptr<::thrift::py3::ClientWrapper>>
FactoriesClientWrapper::createMyInteractionFast() {
  return folly::via(
      channel_->getEventBase(),
      [=]() -> std::unique_ptr<::thrift::py3::ClientWrapper> {
        auto interaction_client = static_cast<std::unique_ptr<apache::thrift::GeneratedAsyncClient>>(std::make_unique<FactoriesAsyncClient::MyInteractionFast>(((FactoriesAsyncClient*)async_client_.get())->createMyInteractionFast()));
        return static_cast<std::unique_ptr<::thrift::py3::ClientWrapper>>(std::make_unique<MyInteractionFastInteractionWrapper>(std::move(interaction_client), channel_));
      }
  );
}
...
folly::Future<std::unique_ptr<::thrift::py3::ClientWrapper>>
FactoriesClientWrapper::createSerialInteraction() {
  return folly::via(
      channel_->getEventBase(),
      [=]() -> std::unique_ptr<::thrift::py3::ClientWrapper> {
        auto interaction_client = static_cast<std::unique_ptr<apache::thrift::GeneratedAsyncClient>>(std::make_unique<FactoriesAsyncClient::SerialInteraction>(((FactoriesAsyncClient*)async_client_.get())->createSerialInteraction()));
        return static_cast<std::unique_ptr<::thrift::py3::ClientWrapper>>(std::make_unique<SerialInteractionInteractionWrapper>(std::move(interaction_client), channel_));
      }
  );
}
...
folly::Future<int32_t>
FactoriesClientWrapper::MyInteractionInteractionWrapper::frobnicate(
    apache::thrift::RpcOptions& rpcOptions) {
  auto* client = static_cast<::cpp2::FactoriesAsyncClient::MyInteraction*>(async_client_.get());
  folly::Promise<int32_t> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<::thrift::py3::FutureCallback<int32_t>>(
    std::move(_promise), rpcOptions, client->recv_wrapped_frobnicate, channel_);
...
folly::Future<folly::Unit>
FactoriesClientWrapper::MyInteractionInteractionWrapper::ping(
    apache::thrift::RpcOptions& rpcOptions) {
  auto* client = static_cast<::cpp2::FactoriesAsyncClient::MyInteraction*>(async_client_.get());
  folly::Promise<folly::Unit> _promise;
  auto _future = _promise.getFuture();
...
folly::Future<apache::thrift::ClientBufferedStream<bool>>
FactoriesClientWrapper::MyInteractionInteractionWrapper::truthify(
    apache::thrift::RpcOptions& rpcOptions) {
  auto* client = static_cast<::cpp2::FactoriesAsyncClient::MyInteraction*>(async_client_.get());
  folly::Promise<apache::thrift::ClientBufferedStream<bool>> _promise;
  auto _future = _promise.getFuture();
...
folly::Future<int32_t>
FactoriesClientWrapper::MyInteractionFastInteractionWrapper::frobnicate(
    apache::thrift::RpcOptions& rpcOptions) {
  auto* client = static_cast<::cpp2::FactoriesAsyncClient::MyInteractionFast*>(async_client_.get());
  folly::Promise<int32_t> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<::thrift::py3::FutureCallback<int32_t>>(
    std::move(_promise), rpcOptions, client->recv_wrapped_frobnicate, channel_);
...
folly::Future<folly::Unit>
FactoriesClientWrapper::MyInteractionFastInteractionWrapper::ping(
    apache::thrift::RpcOptions& rpcOptions) {
  auto* client = static_cast<::cpp2::FactoriesAsyncClient::MyInteractionFast*>(async_client_.get());
  folly::Promise<folly::Unit> _promise;
  auto _future = _promise.getFuture();
...
folly::Future<apache::thrift::ClientBufferedStream<bool>>
FactoriesClientWrapper::MyInteractionFastInteractionWrapper::truthify(
    apache::thrift::RpcOptions& rpcOptions) {
  auto* client = static_cast<::cpp2::FactoriesAsyncClient::MyInteractionFast*>(async_client_.get());
  folly::Promise<apache::thrift::ClientBufferedStream<bool>> _promise;
  auto _future = _promise.getFuture();
...
folly::Future<folly::Unit>
FactoriesClientWrapper::SerialInteractionInteractionWrapper::frobnicate(
    apache::thrift::RpcOptions& rpcOptions) {
  auto* client = static_cast<::cpp2::FactoriesAsyncClient::SerialInteraction*>(async_client_.get());
  folly::Promise<folly::Unit> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<::thrift::py3::FutureCallback<folly::Unit>>(
    std::move(_promise), rpcOptions, client->recv_wrapped_frobnicate, channel_);
