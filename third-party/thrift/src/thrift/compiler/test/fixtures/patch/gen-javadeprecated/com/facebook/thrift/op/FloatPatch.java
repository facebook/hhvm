...
public class FloatPatch implements TBase, java.io.Serializable, Cloneable, Comparable<FloatPatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(FloatPatch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public Builder setAssign(final float assign) {
      this.assign = assign;
    ...
    public Builder setAdd(final float add) {
      this.add = add;
      __optional_isset.set(__ADD_ISSET_ID, true);
      return this;
    }

    public FloatPatch build() {
      FloatPatch result = new FloatPatch();
   ...
   * Clear any set value.
   */
  public FloatPatch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
  ...
  public Object getFieldValue(int fieldID) {
    switch (fieldID) {
    case ASSIGN:
      return new Float(getAssign());

    case CLEAR:
      return new Boolean(isClear());

    case ADD:
      return new Float(getAdd());
  ...
  @Override
  public int compareTo(FloatPatch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("FloatPatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
