...
namespace HH\FIXME {
   ...
   * expression.
   */
  function UNSAFE_CAST<
    <<__Explicit>> Tin as supportdyn<mixed>,
    <<__Explicit>> Tout as supportdyn<mixed>,
  >(Tin $t, ?\HH\FormatString<nothing> $msg = null)[]: ~Tout;
...
namespace HH_FIXME {
  /**
   * This is a placeholder for a type that is missing from the codebase.
   * DO NOT USE.
   */
