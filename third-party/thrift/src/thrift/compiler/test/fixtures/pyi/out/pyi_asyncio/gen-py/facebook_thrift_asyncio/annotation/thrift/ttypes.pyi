...
class Sealed:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.thrift.thrift_types.Sealed": ...   # type: ignore
    def _to_mutable_python(self) -> "facebook.thrift.annotation.thrift.thrift_mutable_types.Sealed": ...   # type: ignore
    def _to_py3(self) -> "facebook.thrift.annotation.thrift.types.Sealed": ...   # type: ignore
    def _to_py_deprecated(self) -> Sealed: ...
...
class AllowUnsafeNonSealedKeyType:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.thrift.thrift_types.AllowUnsafeNonSealedKeyType": ...   # type: ignore
    def _to_mutable_python(self) -> "facebook.thrift.annotation.thrift.thrift_mutable_types.AllowUnsafeNonSealedKeyType": ...   # type: ignore
    def _to_py3(self) -> "facebook.thrift.annotation.thrift.types.AllowUnsafeNonSealedKeyType": ...   # type: ignore
    def _to_py_deprecated(self) -> AllowUnsafeNonSealedKeyType: ...
...
class Deprecated:
    ...
    def _to_mutable_python(self) -> "facebook.thrift.annotation.thrift.thrift_mutable_types.Deprecated": ...   # type: ignore
