...
IMPL_OPCODE_CALL(ThrowOrWarnCannotModifyReadonlyCollection)
IMPL_OPCODE_CALL(ThrowOrWarnLocalMustBeValueTypeException)
IMPL_OPCODE_CALL(ThrowOrWarnMustBeEnclosedInReadonly)
IMPL_OPCODE_CALL(ThrowOrWarnMustBeMutableException)
IMPL_OPCODE_CALL(ThrowOrWarnMustBeReadonlyException)
IMPL_OPCODE_CALL(ThrowOrWarnMustBeValueTypeException)
