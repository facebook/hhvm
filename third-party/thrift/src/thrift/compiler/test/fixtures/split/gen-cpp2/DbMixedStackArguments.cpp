...
void apache::thrift::ServiceHandler<::cpp2::DbMixedStackArguments>::sync_getDataByKey1(::std::string& /*_return*/, std::unique_ptr<::std::string> /*key*/) {
  apache::thrift::detail::si::throw_app_exn_unimplemented("getDataByKey1");
}

void apache::thrift::ServiceHandler<::cpp2::DbMixedStackArguments>::getDataByKey1(::std::string& _return, std::unique_ptr<::std::string> p_key) {
