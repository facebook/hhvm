...
var_dump( array_map(fun('callback'), varray[1, 2, 3], varray[]) );
var_dump( array_map(fun('callback'), varray[], varray['a', 'b', 'c']) );
...
var_dump( array_map(fun('callback'), varray[], varray[1, 2, 3], varray['a', 'b']) );  // passing more no. of arrays than callback function argument
