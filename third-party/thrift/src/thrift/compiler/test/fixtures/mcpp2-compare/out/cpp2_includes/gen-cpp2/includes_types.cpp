...
template void TccStructTraits<::a::different::ns::AStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::a::different::ns::AStructB>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
const std::vector<std::any>& TEnumTraits<::a::different::ns::AnEnum>::annotations() noexcept {
  return ::apache::thrift::detail::annotation::empty_annotations();
}

const std::vector<std::any>& TEnumTraits<::a::different::ns::AnEnum>::enumValueAnnotations(::a::different::ns::AnEnum value) noexcept {
...
std::partial_ordering AStruct::operator<=>([[maybe_unused]] const AStruct& rhs) const {
  return ::apache::thrift::op::compare<AStruct>(*this, rhs);
}
...
std::partial_ordering AStructB::operator<=>([[maybe_unused]] const AStructB& rhs) const {
  return ::apache::thrift::op::compare<AStructB>(*this, rhs);
}
