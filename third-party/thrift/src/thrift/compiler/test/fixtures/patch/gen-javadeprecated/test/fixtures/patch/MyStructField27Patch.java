          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.assign = new HashSet<String>(Math.max(0, 2*_set66.size));
              for (int _i67 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.remove = new HashSet<String>(Math.max(0, 2*_set69.size));
              for (int _i70 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.add = new HashSet<String>(Math.max(0, 2*_set72.size));
              for (int _i73 = 0; 
