...
namespace deprecated_terse_write_constants {
  ...
  FOLLY_EXPORT ::std::string_view _fbthrift_schema_56ecb842712df682();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_56ecb842712df682_includes();
