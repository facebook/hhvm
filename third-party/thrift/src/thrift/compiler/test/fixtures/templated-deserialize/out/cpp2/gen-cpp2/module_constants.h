...
namespace module_constants {
  ...
  FOLLY_EXPORT ::std::string_view _fbthrift_schema_16d25f1b9abc78f8();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_16d25f1b9abc78f8_includes();
