---
title: CloseableSeekableReadWriteHandle
---
...
interface CloseableSeekableReadWriteHandle implements SeekableReadWriteHandle, CloseableReadWriteHandle, CloseableSeekableWriteHandle, CloseableSeekableReadHandle {...}
```
