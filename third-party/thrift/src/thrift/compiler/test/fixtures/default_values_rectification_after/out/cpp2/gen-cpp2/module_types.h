...
class TestStruct final  {
 ...
 public:
  ...
  const ::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::EmptyStruct& get_unqualified_struct_field() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]];
  ...
  const ::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::EmptyStruct* get_optional_struct_field() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]];

  /** Glean { "field": "optional_struct_field" } */
  [[deprecated("Use `FOO.optional_struct_field().value()` instead of `FOO.get_optional_struct_field()`")]]
  ::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::EmptyStruct* get_optional_struct_field() & [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]];
