...
public class MyDataWithCustomDefaultSafePatch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyDataWithCustomDefaultSafePatch deserialize(TProtocol iprot) throws TException {
    ...
    MyDataWithCustomDefaultSafePatch _that;
    _that = new MyDataWithCustomDefaultSafePatch(
      tmp_version
      ,tmp_data
    );
    _that.validate();
