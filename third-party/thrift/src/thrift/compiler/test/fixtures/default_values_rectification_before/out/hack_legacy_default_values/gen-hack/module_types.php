...
namespace facebook\thrift\compiler\test\fixtures\default_values_rectification_before;

/**
 * Original thrift struct:-
 * EmptyStruct
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/compiler/test/fixtures/default_values_rectification_before/EmptyStruct'))>>
 ...
 * TestStruct
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/compiler/test/fixtures/default_values_rectification_before/TestStruct'))>>
class TestStruct implements \IThriftSyncStruct, \IThriftStructMetadata {
  ...
  const \ThriftStructTypes::TSpec SPEC = dict[
    ...
    4 => shape(
      ...
      'type' => \TType::STRUCT,
      'class' => \facebook\thrift\compiler\test\fixtures\default_values_rectification_before\EmptyStruct::class,
    ),
    5 => shape(
  ...
  const type TConstructorShape = shape(
    ...
    ?'unqualified_struct_field' => ?\facebook\thrift\compiler\test\fixtures\default_values_rectification_before\EmptyStruct,
    ?'optional_int_field' => ?int,
    ?'optional_bool_field' => ?bool,
    ?'optional_list_field' => ?Vector<int>,
    ?'optional_struct_field' => ?\facebook\thrift\compiler\test\fixtures\default_values_rectification_before\EmptyStruct,
  );
   ...
   */
  public ?\facebook\thrift\compiler\test\fixtures\default_values_rectification_before\EmptyStruct $unqualified_struct_field;
  /**
   * Original thrift field:-
