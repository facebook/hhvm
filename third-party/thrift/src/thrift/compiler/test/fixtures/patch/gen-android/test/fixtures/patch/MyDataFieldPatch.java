...
public class MyDataFieldPatch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyDataFieldPatch deserialize(TProtocol iprot) throws TException {
    ...
    MyDataFieldPatch _that;
    _that = new MyDataFieldPatch(
      tmp_data1
      ,tmp_data2
    );
    _that.validate();
