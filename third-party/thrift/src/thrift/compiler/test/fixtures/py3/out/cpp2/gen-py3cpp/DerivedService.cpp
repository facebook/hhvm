...
apache::thrift::ServiceHandler<::py3::simple::DerivedService>::semifuture_get_six() {
  auto expected{apache::thrift::detail::si::InvocationType::SemiFuture};
  __fbthrift_invocation_get_six.compare_exchange_strong(
      expected,
...
apache::thrift::ServiceHandler<::py3::simple::DerivedService>::future_get_six() {
...
apache::thrift::ServiceHandler<::py3::simple::DerivedService>::co_get_six() {
...
void apache::thrift::ServiceHandler<::py3::simple::DerivedService>::async_tm_get_six(
...
#endif // FOLLY_HAS_COROUTINES
  auto invocationType =
      __fbthrift_invocation_get_six.load(std::memory_order_relaxed);
  try {
...
apache::thrift::ServiceRequestInfoMap DerivedServiceServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"get_six",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::py3::simple::DerivedService>("get_six")}},
  };
