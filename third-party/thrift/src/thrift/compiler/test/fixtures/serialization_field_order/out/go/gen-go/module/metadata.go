...
var (
    ...
    premadeThriftType_module_Foo2 = func() *metadata.ThriftType {
        return metadata.NewThriftType().SetTStruct(
            metadata.NewThriftStructType().
                SetName("module.Foo2"),
        )
...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    fbthriftThriftTypesMap["module.Foo2"] = premadeThriftType_module_Foo2
...
var structMetadatas = func() []*metadata.ThriftStruct {
    ...
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_Foo2))
