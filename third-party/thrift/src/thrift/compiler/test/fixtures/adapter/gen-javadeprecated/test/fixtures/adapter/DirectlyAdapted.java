...
public class DirectlyAdapted implements TBase, java.io.Serializable, Cloneable, Comparable<DirectlyAdapted> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(DirectlyAdapted.class, metaDataMap);
  }
  ...
  public DirectlyAdapted setField(int field) {
    this.field = field;
    setFieldIsSet(true);
    return this;
  }
  ...
  @Override
  public int compareTo(DirectlyAdapted other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("DirectlyAdapted");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
