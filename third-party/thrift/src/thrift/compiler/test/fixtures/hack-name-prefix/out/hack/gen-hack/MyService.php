...
class MyService_getStruct_result extends \ThriftSyncStructWithResult implements \IThriftStructMetadata {
  ...
  const \ThriftStructTypes::TSpec SPEC = dict[
    0 => shape(
      'var' => 'success',
      'type' => \TType::STRUCT,
      'class' => \test\fixtures\name_prefix\TMyPrefix_MyStruct::class,
    ),
    1 => shape(
      'var' => 'ex',
      'type' => \TType::STRUCT,
      'class' => \test\fixtures\name_prefix\TMyPrefix_MyException::class,
    ),
  ];
  const dict<string, int> FIELDMAP = dict[
    'success' => 0,
      ...
      shape(
        ...
        'metadata' => \tmeta_ThriftMetadata::fromShape(
          shape(
            ...
            'structs' => dict[
              'module.MyStruct' => \test\fixtures\name_prefix\TMyPrefix_MyStruct::getStructMetadata(),
            ],
            'exceptions' => dict[
              'module.MyException' => \test\fixtures\name_prefix\TMyPrefix_MyException::getExceptionMetadata(),
            ],
            'services' => dict[
            ],
          )
