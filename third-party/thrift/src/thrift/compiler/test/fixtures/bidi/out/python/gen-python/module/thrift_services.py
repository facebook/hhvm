...
class BiDiServiceInterface(
    ...
    def __get_reflection__():
        return _fbthrift_get_services_reflection_module("BiDiService")
    ...
    def _fbthrift__bidi_wrapper_simple(
        ...
        protocol: Protocol
    ) -> _typing.Callable[[_typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]], _typing.Awaitable[_typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]]]:
        async def _fbthrift_iobuf_bidi_callback(
            ...
            async def _handle_sink() -> _typing.AsyncGenerator[builtins.int, None]:
                async for iobuf_item in _iobuf_agen:
                    sink_elem = deserialize(
                        _fbthrift__module__thrift_types._fbthrift_BiDiService_simple_result_sink_elem,
                        iobuf_item,
                        protocol
                    )
            ...
            return CloseableGenerator(
                ...
                protocol,
                _fbthrift__module__thrift_types._fbthrift_BiDiService_simple_result_stream_elem,
                (),
            )
    ...
    async def _fbthrift__handler_simple(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _typing.Tuple[_fbthrift_iobuf.IOBuf, _typing.Callable[[_typing.Callable[[], _typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]]], _typing.Awaitable[_typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]]]]:
        ...
        bidi_callback = value
        return_struct = _fbthrift__module__thrift_types._fbthrift_BiDiService_simple_result()
    ...
    def _fbthrift__bidi_wrapper_response(
        ...
        async def _fbthrift_iobuf_bidi_callback(
            ...
            async def _handle_sink() -> _typing.AsyncGenerator[builtins.int, None]:
                async for iobuf_item in _iobuf_agen:
                    sink_elem = deserialize(
                        _fbthrift__module__thrift_types._fbthrift_BiDiService_response_result_sink_elem,
                        iobuf_item,
                        protocol
                    )
                    if sink_elem.success is None:
            ...
            return CloseableGenerator(
                handler_bidi_callback(_handle_sink()),
                protocol,
                _fbthrift__module__thrift_types._fbthrift_BiDiService_response_result_stream_elem,
                (),
            )
    ...
    async def _fbthrift__handler_response(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _typing.Tuple[_fbthrift_iobuf.IOBuf, _typing.Callable[[_typing.Callable[[], _typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]]], _typing.Awaitable[_typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]]]]:
        ...
        return_struct = _fbthrift__module__thrift_types._fbthrift_BiDiService_response_result(success=value)
    ...
    def _fbthrift__bidi_wrapper_canThrow(
        ...
        async def _fbthrift_iobuf_bidi_callback(
            ...
            async def _handle_sink() -> _typing.AsyncGenerator[builtins.int, None]:
                async for iobuf_item in _iobuf_agen:
                    sink_elem = deserialize(
                        _fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result_sink_elem,
                        iobuf_item,
                        protocol
                    )
            ...
            return CloseableGenerator(
                handler_bidi_callback(_handle_sink()),
                protocol,
                _fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result_stream_elem,
                (
                    UserExceptionMeta(_fbthrift__module__thrift_types.BiDiStreamException, "_ex0__ex", 'BiDiStreamException'),
                ),
            )
    ...
    async def _fbthrift__handler_canThrow(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _typing.Tuple[_fbthrift_iobuf.IOBuf, _typing.Callable[[_typing.Callable[[], _typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]]], _typing.Awaitable[_typing.AsyncGenerator[_fbthrift_iobuf.IOBuf, None]]]]:
        ...
        try:
            ...
            bidi_callback = value
            return_struct = _fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result()
            return_bidi_callback = self._fbthrift__bidi_wrapper_canThrow(bidi_callback, protocol)
        except _fbthrift__module__thrift_types.BiDiMethodException as e:
            return_struct = _fbthrift__module__thrift_types._fbthrift_BiDiService_canThrow_result(_ex0__ex=e)
