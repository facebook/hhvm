...
UNSUPPORTED_FILES_CONVERTER = {
    ...
    "async is currently not supported. (Other[0])": [
        ...
        'unused_awaitable7.php',
        'unused_awaitable8.php',
        'unused_awaitable9.php',
        'unused_awaitable10.php',
        'unused_awaitable11.php',
        'unused_awaitable12.php',
        'unused_awaitable13.php',
        'unused_awaitable14.php',
        'unused_awaitable15.php',
        'unused_awaitable16.php',
        'void_option2.php',
        'void_usage_2.php',
...
OTHER_UNPARSEABLE_FILES = [
    ...
    'keyset/is_indexish.php',
    'keyset/keyset_literal.php',
    'keyset/keyset_literal_wrong_bracket.php',
