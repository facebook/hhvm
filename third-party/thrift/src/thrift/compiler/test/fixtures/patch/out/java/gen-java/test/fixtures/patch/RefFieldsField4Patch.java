...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="RefFieldsField4Patch", builder=RefFieldsField4Patch.Builder.class)
public final class RefFieldsField4Patch implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    ...
    @ThriftConstructor
    protected RefFieldsField4Patch() {
      this.assign = null;
      this.clear = false;
    ...
    public static class Builder {
        ...
        public Builder() { }
        public Builder(RefFieldsField4Patch other) {
    ...
    static {
      ...
      com.facebook.thrift.type.TypeRegistry.add(new com.facebook.thrift.type.Type(
        new com.facebook.thrift.type.UniversalName("test.dev/fixtures/patch/RefFieldsField4Patch"),
        RefFieldsField4Patch.class, RefFieldsField4Patch::read0));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefFieldsField4Patch other = (RefFieldsField4Patch)o;
    ...
    public static com.facebook.thrift.payload.Reader<RefFieldsField4Patch> asReader() {
      return RefFieldsField4Patch::read0;
    }
    
    public static RefFieldsField4Patch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(RefFieldsField4Patch.NAMES_TO_IDS, RefFieldsField4Patch.THRIFT_NAMES_TO_IDS, RefFieldsField4Patch.FIELD_METADATA);
      RefFieldsField4Patch.Builder builder = new RefFieldsField4Patch.Builder();
      while (true) {
    ...
    private static class _RefFieldsField4PatchLazy {
        private static final RefFieldsField4Patch _DEFAULT = new RefFieldsField4Patch.Builder().build();
    }
    
    public static RefFieldsField4Patch defaultInstance() {
        return  _RefFieldsField4PatchLazy._DEFAULT;
    }
}
