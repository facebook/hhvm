...
class virtual ['self] iter =
  object (self : 'self)
    ...
    method on_ClassTraitRequire env c0 c1 =
      ...
      self#on_hint env c1;
    method on_ClassVars env cv =
      self#on_list self#on_kind env cv.cv_kinds;
      self#on_option self#on_hint env cv.cv_hint;
      self#on_list self#on_class_var env cv.cv_names;
    ...
    method on_Hfun env c0 c1 c2 c3 c4 =
      ...
      self#on_list (self#on_option self#on_param_kind) env c2;
      self#on_variadic_hint env c3;
      self#on_hint env c4;
