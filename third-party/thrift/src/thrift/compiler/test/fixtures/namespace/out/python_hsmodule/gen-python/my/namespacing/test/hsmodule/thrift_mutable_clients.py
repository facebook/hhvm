        ...
        async def init(
            ...
            *,
            ...
            _fbthrift_resp = await self._send_request(
                "HsTestService",
                "init",
                python_module_root__my__namespacing__test__hsmodule__thrift_mutable_types._fbthrift_HsTestService_init_args(
                    int1=int1,),
                python_module_root__my__namespacing__test__hsmodule__thrift_mutable_types._fbthrift_HsTestService_init_result,
