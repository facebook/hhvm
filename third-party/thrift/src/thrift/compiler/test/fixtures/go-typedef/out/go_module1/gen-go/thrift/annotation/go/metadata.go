...
var (
    ...
    premadeThriftType_go_Name *metadata.ThriftType = nil
    premadeThriftType_go_Tag *metadata.ThriftType = nil
)
...
var premadeThriftTypesInitOnce = sync.OnceFunc(func() {
    ...
    premadeThriftType_go_Name = metadata.NewThriftType().SetTStruct(
        metadata.NewThriftStructType().
            SetName("go.Name"),
    )
    premadeThriftType_go_Tag = metadata.NewThriftType().SetTStruct(
        metadata.NewThriftStructType().
            SetName("go.Tag"),
    )
})
...
var premadeThriftTypesMapOnce = sync.OnceValue(
    func() map[string]*metadata.ThriftType {
        ...
        return map[string]*metadata.ThriftType{
            ...
            "go.Name": premadeThriftType_go_Name,
            "go.Tag": premadeThriftType_go_Tag,
        }
    },
)
