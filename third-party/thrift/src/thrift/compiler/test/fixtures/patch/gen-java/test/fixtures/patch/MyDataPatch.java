...
public final class MyDataPatch implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public MyDataPatch(
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="patchPrior", requiredness=Requiredness.NONE) final test.fixtures.patch.MyDataFieldPatch patchPrior,
        @com.facebook.swift.codec.ThriftField(value=5, name="ensure", requiredness=Requiredness.NONE) final test.fixtures.patch.MyData ensure,
        @com.facebook.swift.codec.ThriftField(value=6, name="patch", requiredness=Requiredness.NONE) final test.fixtures.patch.MyDataFieldPatch patch
    ) {
        this.assign = assign;
        this.clear = clear;
    ...
    public static class Builder {
        ...
        private test.fixtures.patch.MyDataFieldPatch patchPrior = null;
        ...
        public Builder setPatchPrior(test.fixtures.patch.MyDataFieldPatch patchPrior) {
            this.patchPrior = patchPrior;
            return this;
        }
    ...
    private static final TField CLEAR_FIELD_DESC = new TField("clear", TType.BOOL, (short)2);
        private final test.fixtures.patch.MyDataFieldPatch patchPrior;
    ...
    public static com.facebook.thrift.payload.Reader<MyDataPatch> asReader() {
      return MyDataPatch::read0;
    }
    
    public static MyDataPatch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(MyDataPatch.NAMES_TO_IDS, MyDataPatch.THRIFT_NAMES_TO_IDS, MyDataPatch.FIELD_METADATA);
      MyDataPatch.Builder builder = new MyDataPatch.Builder();
      while (true) {
        ...
        case _PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            test.fixtures.patch.MyDataFieldPatch patchPrior = test.fixtures.patch.MyDataFieldPatch.read0(oprot);
    ...
    private static class _MyDataPatchLazy {
        private static final MyDataPatch _DEFAULT = new MyDataPatch.Builder().build();
    }
    
    public static MyDataPatch defaultInstance() {
        return  _MyDataPatchLazy._DEFAULT;
    }
}
