...
class ServiceHandler<::cpp2::MyService> : public apache::thrift::ServerInterface {
 ...
 public:
  ...
  virtual void sync_lobDataById(::std::int64_t /*id*/, std::unique_ptr<::std::string> /*dataStr*/);
  [[deprecated("Use sync_lobDataById instead")]] virtual void lobDataById(::std::int64_t /*id*/, std::unique_ptr<::std::string> /*dataStr*/);
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_cppDoNothing();
  virtual folly::coro::Task<void> co_cppDoNothing(apache::thrift::RequestParams params);
#endif
  virtual void async_tm_cppDoNothing(apache::thrift::HandlerCallbackPtr<void> callback);
 private:
 ...
 public:
  ...
  virtual void fbthrift_execute_decorators_before_lobDataById(apache::thrift::Cpp2RequestContext& /*requestCtx*/, apache::thrift::detail::DecoratorArgType<::std::int64_t>::type /*p_id*/, apache::thrift::detail::DecoratorArgType<::std::string>::type /*p_dataStr*/) {}
  ...
  virtual void fbthrift_execute_decorators_before_cppDoNothing(apache::thrift::Cpp2RequestContext& /*requestCtx*/) {}
  virtual void fbthrift_execute_decorators_after_cppDoNothing(apache::thrift::Cpp2RequestContext& /*requestCtx*/) {}
  static void fbthrift_invoke_decorator_after_cppDoNothing(void* iface, apache::thrift::Cpp2RequestContext* ctx) {
    static_cast<ServiceHandler<::cpp2::MyService>*>(iface)->fbthrift_execute_decorators_after_cppDoNothing(*ctx);
  }
};
...
class MyServiceAsyncProcessor : public ::apache::thrift::GeneratedAsyncProcessorBase {
 ...
 private:
  ...
  //
  template <typename ProtocolIn_, typename ProtocolOut_>
  void setUpAndProcess_getRandomData(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      apache::thrift::SerializedCompressedRequest&& serializedRequest,
      apache::thrift::Cpp2RequestContext* ctx,
      folly::EventBase* eb,
  ...
  template <class ProtocolIn_, class ProtocolOut_>
  static apache::thrift::SerializedResponse return_getRandomData(
      apache::thrift::ContextStack* ctx,
      ::std::string const& _return);

  template <class ProtocolIn_, class ProtocolOut_>
  static void throw_wrapped_getRandomData(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      int32_t protoSeqId,
      apache::thrift::ContextStack* ctx,
      folly::exception_wrapper ew,
  ...
  //
  template <typename ProtocolIn_, typename ProtocolOut_>
  void setUpAndProcess_cppDoNothing(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      apache::thrift::SerializedCompressedRequest&& serializedRequest,
      apache::thrift::Cpp2RequestContext* ctx,
      folly::EventBase* eb,
  ...
  template <typename ProtocolIn_, typename ProtocolOut_>
  void executeRequest_cppDoNothing(apache::thrift::ServerRequest&& serverRequest);

  template <class ProtocolIn_, class ProtocolOut_>
  static apache::thrift::SerializedResponse return_cppDoNothing(
      apache::thrift::ContextStack* ctx);

  template <class ProtocolIn_, class ProtocolOut_>
  static void throw_wrapped_cppDoNothing(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      int32_t protoSeqId,
      apache::thrift::ContextStack* ctx,
      folly::exception_wrapper ew,
