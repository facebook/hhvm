...
// Test FixedMap's PHP-accessible public methods.
...
function main() {
  ...
  echo "\n= differencebykey =\n";
  $m1 = new FixedMap(Map {1 => 1, 2 => 2, 3 => 3});
  $m2 = new FixedMap(Map {1 => 1, 2 => 2});
  $res =$m1->differenceByKey($m2);
  var_dump($res instanceof FixedMap);
  show_keyed_iter($res);
  ...
  echo "\n= fromItems =\n";
  var_dump(FixedMap::fromItems(Vector {}) instanceof FixedMap);
  show_keyed_iter(FixedMap::fromItems((Vector {Pair {1, 2}, Pair {3, 4}, Pair {5, 6}})));
}
