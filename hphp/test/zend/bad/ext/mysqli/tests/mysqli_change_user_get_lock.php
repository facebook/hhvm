<?php
	...
	$test_table_name = 'test_mysqli_change_user_get_lock_table_1'; require_once('table.inc');
...
?>
<?php
	$test_table_name = 'test_mysqli_change_user_get_lock_table_1'; require_once("clean_table.inc");
?>