...
class ServiceHandler<::apache::thrift::fixtures::types::SomeService> : public apache::thrift::ServerInterface {
  static_assert(!folly::is_detected_v<detail::st::detect_complete, ::apache::thrift::fixtures::types::SomeService>, "Definition collision with service tag. Either rename the Thrift service using @cpp.Name annotation or rename the conflicting C++ type.");
