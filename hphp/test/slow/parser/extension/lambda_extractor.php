...
$fjson = ReflectionFunctionAbstract::find_single_function($json, $rm->getStartLine());
var_dump(ReflectionFunctionAbstract::body_bounds($fjson));
...
var_dump(ReflectionFunctionAbstract::body_bounds($allfuns[$ra->getStartLine()]));
var_dump(ReflectionFunctionAbstract::body_bounds($allfuns[$rl->getStartLine()]));
var_dump(ReflectionFunctionAbstract::body_bounds($allfuns[$ranon->getStartLine()]));
