...
public class MyService {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void ping(AsyncMethodCallback resultHandler35) throws TException {
      checkReady();
      ping_call method_call = new ping_call(resultHandler35, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class ping_call extends TAsyncMethodCall {
      public ping_call(AsyncMethodCallback resultHandler36, TAsyncClient client32, TProtocolFactory protocolFactory33, TNonblockingTransport transport34) throws TException {
    ...
    public void getRandomData(AsyncMethodCallback resultHandler40) throws TException {
      checkReady();
      getRandomData_call method_call = new getRandomData_call(resultHandler40, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getRandomData_call extends TAsyncMethodCall {
      public getRandomData_call(AsyncMethodCallback resultHandler41, TAsyncClient client37, TProtocolFactory protocolFactory38, TNonblockingTransport transport39) throws TException {
    ...
    public void sink(long sink, AsyncMethodCallback resultHandler45) throws TException {
      checkReady();
      sink_call method_call = new sink_call(sink, resultHandler45, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class sink_call extends TAsyncMethodCall {
      private long sink;
      public sink_call(long sink, AsyncMethodCallback resultHandler46, TAsyncClient client42, TProtocolFactory protocolFactory43, TNonblockingTransport transport44) throws TException {
    ...
    public void putDataById(long id, String data, AsyncMethodCallback resultHandler50) throws TException {
      checkReady();
      putDataById_call method_call = new putDataById_call(id, data, resultHandler50, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class putDataById_call extends TAsyncMethodCall {
      private long id;
      private String data;
      public putDataById_call(long id, String data, AsyncMethodCallback resultHandler51, TAsyncClient client47, TProtocolFactory protocolFactory48, TNonblockingTransport transport49) throws TException {
    ...
    public void deleteDataById(long id, AsyncMethodCallback resultHandler65) throws TException {
      checkReady();
      deleteDataById_call method_call = new deleteDataById_call(id, resultHandler65, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class deleteDataById_call extends TAsyncMethodCall {
      private long id;
      public deleteDataById_call(long id, AsyncMethodCallback resultHandler66, TAsyncClient client62, TProtocolFactory protocolFactory63, TNonblockingTransport transport64) throws TException {
    ...
    public void invalid_return_for_hack(AsyncMethodCallback resultHandler75) throws TException {
      checkReady();
      invalid_return_for_hack_call method_call = new invalid_return_for_hack_call(resultHandler75, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class invalid_return_for_hack_call extends TAsyncMethodCall {
      public invalid_return_for_hack_call(AsyncMethodCallback resultHandler76, TAsyncClient client72, TProtocolFactory protocolFactory73, TNonblockingTransport transport74) throws TException {
        super(client72, protocolFactory73, transport74, resultHandler76, false);
      }
    ...
    public void rpc_skipped_codegen(AsyncMethodCallback resultHandler80) throws TException {
      checkReady();
      rpc_skipped_codegen_call method_call = new rpc_skipped_codegen_call(resultHandler80, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class rpc_skipped_codegen_call extends TAsyncMethodCall {
      public rpc_skipped_codegen_call(AsyncMethodCallback resultHandler81, TAsyncClient client77, TProtocolFactory protocolFactory78, TNonblockingTransport transport79) throws TException {
        super(client77, protocolFactory78, transport79, resultHandler81, false);
      }
            ...
            if (__field.type == TType.SET) {
              {
                ...
                this.success = new HashSet<Float>(Math.max(0, 2*_set82.size));
                for (int _i83 = 0; 
                     (_set82.size < 0) ? iprot.peekSet() : (_i83 < _set82.size); 
                     ++_i83)
                {
                  float _elem84;
                  _elem84 = iprot.readFloat();
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (float _iter85 : this.success)          {
            oprot.writeFloat(_iter85);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
