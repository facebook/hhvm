...
<<__EntryPoint>>
function main_1048() :mixed{
$i = 0;
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gte('php', true)); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = 'php';
 ...
 $b = 't';
 $b = true;
 try { P(HH\Lib\Legacy_FIXME\gte('php', $b)); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gte('php', false)); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = 'php';
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gte('php', 1)); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = 'php';
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gte('php', 0)); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = 'php';
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\gte('php', null)); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = 'php';
