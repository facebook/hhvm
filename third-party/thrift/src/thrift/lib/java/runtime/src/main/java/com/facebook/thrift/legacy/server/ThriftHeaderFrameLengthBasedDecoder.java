...
public class ThriftHeaderFrameLengthBasedDecoder extends ByteToMessageDecoder {
  ...
  private Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
    ...
    // extract frame from index - initial bytes to strip
