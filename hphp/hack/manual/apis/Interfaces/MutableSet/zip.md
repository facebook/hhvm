...
Returns a [` MutableSet `](/docs/apis/Interfaces/MutableSet/) where each value is a [` Pair `](/docs/apis/Classes/HH/Pair/) that combines the
value of the current [` MutableSet `](/docs/apis/Interfaces/MutableSet/) and the provided [` Traversable `](/docs/apis/Interfaces/HH/Traversable/)
...
+ [` Traversable<Tu> `](/docs/apis/Interfaces/HH/Traversable/)`` $traversable `` - The [` Traversable `](/docs/apis/Interfaces/HH/Traversable/) to use to combine with the
  elements of the current [` MutableSet `](/docs/apis/Interfaces/MutableSet/).
...
* [` MutableSet<nothing> `](/docs/apis/Interfaces/MutableSet/) - The [` MutableSet `](/docs/apis/Interfaces/MutableSet/) that combines the values of the current
  [` MutableSet `](/docs/apis/Interfaces/MutableSet/) with the provided [` Traversable `](/docs/apis/Interfaces/HH/Traversable/).
<!-- HHAPIDOC -->
