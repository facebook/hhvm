...
impl TokenKind {
    ...
    pub fn ocaml_tag(self) -> u8 {
        match self {
            ...
            TokenKind::Empty => 34,
            TokenKind::Endfor => 35,
            TokenKind::Endforeach => 36,
            TokenKind::Endif => 37,
            TokenKind::Endswitch => 38,
            TokenKind::Endwhile => 39,
            TokenKind::Enum => 40,
            TokenKind::Eval => 41,
            TokenKind::Extends => 42,
            TokenKind::Fallthrough => 43,
            TokenKind::Float => 44,
            TokenKind::File => 45,
            TokenKind::Final => 46,
            TokenKind::Finally => 47,
            TokenKind::For => 48,
            TokenKind::Foreach => 49,
            TokenKind::From => 50,
            TokenKind::Function => 51,
            TokenKind::Global => 52,
            TokenKind::Concurrent => 53,
            TokenKind::Goto => 54,
            TokenKind::HaltCompiler => 55,
            TokenKind::If => 56,
            TokenKind::Implements => 57,
            TokenKind::Include => 58,
            TokenKind::Include_once => 59,
            TokenKind::Inout => 60,
            TokenKind::Instanceof => 61,
            TokenKind::Insteadof => 62,
            TokenKind::Int => 63,
            TokenKind::Integer => 64,
            TokenKind::Interface => 65,
            TokenKind::Is => 66,
            TokenKind::Isset => 67,
            TokenKind::Keyset => 68,
            TokenKind::Let => 69,
            TokenKind::List => 70,
            TokenKind::Mixed => 71,
            TokenKind::Namespace => 72,
            TokenKind::New => 73,
            TokenKind::Newtype => 74,
            TokenKind::Noreturn => 75,
            TokenKind::Num => 76,
            TokenKind::Object => 77,
            TokenKind::Parent => 78,
            TokenKind::Print => 79,
            TokenKind::Private => 80,
            TokenKind::Protected => 81,
            TokenKind::Public => 82,
            TokenKind::Real => 83,
            TokenKind::Reify => 84,
            TokenKind::Record => 85,
            TokenKind::RecordDec => 86,
            TokenKind::Require => 87,
            TokenKind::Require_once => 88,
            TokenKind::Required => 89,
            TokenKind::Lateinit => 90,
            TokenKind::Resource => 91,
            TokenKind::Return => 92,
            TokenKind::SelfToken => 93,
            TokenKind::Shape => 94,
            TokenKind::Static => 95,
            TokenKind::String => 96,
            TokenKind::Super => 97,
            TokenKind::Suspend => 98,
            TokenKind::Switch => 99,
            TokenKind::This => 100,
            TokenKind::Throw => 101,
            TokenKind::Trait => 102,
            ...
            TokenKind::Using => 108,
            TokenKind::Var => 109,
            TokenKind::Varray => 110,
            TokenKind::Vec => 111,
            TokenKind::Void => 112,
            TokenKind::Where => 113,
            TokenKind::While => 114,
            TokenKind::Yield => 115,
            TokenKind::NullLiteral => 116,
            TokenKind::LeftBracket => 117,
            TokenKind::RightBracket => 118,
            TokenKind::LeftParen => 119,
            TokenKind::RightParen => 120,
            TokenKind::LeftBrace => 121,
            TokenKind::RightBrace => 122,
            TokenKind::Dot => 123,
            TokenKind::MinusGreaterThan => 124,
            TokenKind::PlusPlus => 125,
            TokenKind::MinusMinus => 126,
            TokenKind::StarStar => 127,
            TokenKind::Star => 128,
            TokenKind::Plus => 129,
            TokenKind::Minus => 130,
            TokenKind::Tilde => 131,
            TokenKind::Exclamation => 132,
            TokenKind::Dollar => 133,
            TokenKind::Slash => 134,
            TokenKind::Percent => 135,
            TokenKind::LessThanEqualGreaterThan => 136,
            TokenKind::LessThanLessThan => 137,
            TokenKind::GreaterThanGreaterThan => 138,
            TokenKind::LessThan => 139,
            TokenKind::GreaterThan => 140,
            TokenKind::LessThanEqual => 141,
            TokenKind::GreaterThanEqual => 142,
            TokenKind::EqualEqual => 143,
            TokenKind::EqualEqualEqual => 144,
            TokenKind::ExclamationEqual => 145,
            TokenKind::ExclamationEqualEqual => 146,
            TokenKind::Carat => 147,
            TokenKind::Bar => 148,
            TokenKind::Ampersand => 149,
            TokenKind::AmpersandAmpersand => 150,
            TokenKind::BarBar => 151,
            TokenKind::Question => 152,
            TokenKind::QuestionAs => 153,
            TokenKind::QuestionColon => 154,
            TokenKind::QuestionQuestion => 155,
            TokenKind::QuestionQuestionEqual => 156,
            TokenKind::Colon => 157,
            TokenKind::Semicolon => 158,
            TokenKind::Equal => 159,
            TokenKind::StarStarEqual => 160,
            TokenKind::StarEqual => 161,
            TokenKind::SlashEqual => 162,
            TokenKind::PercentEqual => 163,
            TokenKind::PlusEqual => 164,
            TokenKind::MinusEqual => 165,
            TokenKind::DotEqual => 166,
            TokenKind::LessThanLessThanEqual => 167,
            TokenKind::GreaterThanGreaterThanEqual => 168,
            TokenKind::AmpersandEqual => 169,
            TokenKind::CaratEqual => 170,
            TokenKind::BarEqual => 171,
            TokenKind::Comma => 172,
            TokenKind::At => 173,
            TokenKind::ColonColon => 174,
            TokenKind::EqualGreaterThan => 175,
            TokenKind::EqualEqualGreaterThan => 176,
            TokenKind::QuestionMinusGreaterThan => 177,
            TokenKind::DotDotDot => 178,
            TokenKind::DollarDollar => 179,
            TokenKind::BarGreaterThan => 180,
            TokenKind::SlashGreaterThan => 181,
            TokenKind::LessThanSlash => 182,
            TokenKind::LessThanQuestion => 183,
            TokenKind::QuestionGreaterThan => 184,
            TokenKind::ColonAt => 185,
