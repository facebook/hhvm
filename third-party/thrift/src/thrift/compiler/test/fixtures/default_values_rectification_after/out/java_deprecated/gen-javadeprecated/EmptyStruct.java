...
public class EmptyStruct implements TBase, java.io.Serializable, Cloneable, Comparable<EmptyStruct> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(EmptyStruct.class, metaDataMap);
  }
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("EmptyStruct");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
