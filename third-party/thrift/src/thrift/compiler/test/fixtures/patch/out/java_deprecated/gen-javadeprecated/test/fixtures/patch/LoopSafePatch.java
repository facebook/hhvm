...
public class LoopSafePatch implements TBase, java.io.Serializable, Cloneable, Comparable<LoopSafePatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(LoopSafePatch.class, metaDataMap);
  }
  ...
  public LoopSafePatch setVersion(int version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public LoopSafePatch setData(byte[] data) {
    this.data = data;
    return this;
  }
  ...
  @Override
  public int compareTo(LoopSafePatch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("LoopSafePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
