...
class ServiceMetadata<::apache::thrift::ServiceHandler<::test::fixtures::basic_structured_annotations::MyService>> {
 ...
 private:
  ...
  static void gen_first(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_second(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
} // namespace md
} // namespace detail
} // namespace thrift
