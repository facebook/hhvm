...
class A {
  ...
  public static varray $s1 = [1, 2, 3];
  public static darray $s2 = [1, 2, 3];
  ...
  public static varray $s7 = CONDCONST6;
  ...
  public static VAlias $s13 = CONDCONST6;
