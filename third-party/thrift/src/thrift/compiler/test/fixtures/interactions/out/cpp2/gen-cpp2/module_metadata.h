...
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::MyService>> {
 ...
 private:
  ...
  static void gen_interact(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_interactFast(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_serialize(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
template <>
...
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::InteractWithShared>> {
 ...
 private:
  ...
  static void gen_do_some_similar_things(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
template <>
class ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::BoxService>> {
 ...
 private:
  ...
  static void gen_getABoxSession(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
} // namespace md
} // namespace detail
} // namespace thrift
