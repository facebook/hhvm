...
mod tests {
    ...
    fn de_ser_const_vec_arraykey_eq_vec_string_and_int() {
        ...
        let js = vec![
            json!([{"Rwitness":{"Tiny":{"file":"|f.php","span":26388480394827i64}}},{"Tclass":[[{"Tiny":{"file":"|f.php","span":26388480394827i64}},"\\HH\\vec"],"Inexact",[[{"Rhint":{"Tiny":{"file":"|f.php","span":26388480393864i64}}},{"Tprim":"Tarraykey"}]]]}]),
