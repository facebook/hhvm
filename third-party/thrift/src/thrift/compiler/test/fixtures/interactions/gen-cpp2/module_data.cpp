...
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::CustomException>::fields_names = {{
  "message",
}};
THRIFT_DATA_SECTION const std::array<int16_t, 1> TStructDataStorage<::cpp2::CustomException>::fields_ids = {{
  1,
}};
THRIFT_DATA_SECTION const std::array<protocol::TType, 1> TStructDataStorage<::cpp2::CustomException>::fields_types = {{
  TType::T_STRING,
}};
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::CustomException>::storage_names = {{
  "__fbthrift_field_message",
}};
THRIFT_DATA_SECTION const std::array<int, 1> TStructDataStorage<::cpp2::CustomException>::isset_indexes = {{
  0,
}};
