...
cdef class FieldsWithIncludedStruct(thrift.py3.types.Struct):
    ...
    def __init__(FieldsWithIncludedStruct self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_foo_cbindings.cFieldsWithIncludedStruct]()
        self._fields_setter = _fbthrift_types_fields.__FieldsWithIncludedStruct_FieldsSetter._fbthrift_create(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get())
        super().__init__(**kwargs)

    def __call__(FieldsWithIncludedStruct self, **kwargs):
        if not kwargs:
            return self
        cdef FieldsWithIncludedStruct __fbthrift_inst = FieldsWithIncludedStruct.__new__(FieldsWithIncludedStruct)
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_foo_cbindings.cFieldsWithIncludedStruct](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
        __fbthrift_inst._fields_setter = _fbthrift_types_fields.__FieldsWithIncludedStruct_FieldsSetter._fbthrift_create(__fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get())
        for __fbthrift_name, _fbthrift_value in kwargs.items():
            (<thrift.py3.types.Struct>__fbthrift_inst)._fbthrift_set_field(__fbthrift_name, _fbthrift_value)
        return __fbthrift_inst
    ...
    cdef object _fbthrift_isset(self):
        return _fbthrift_IsSet("FieldsWithIncludedStruct", {
          "injected_field": deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).injected_field_ref().has_value(),
        })

    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_foo_cbindings.cFieldsWithIncludedStruct] cpp_obj):
        __fbthrift_inst = <FieldsWithIncludedStruct>FieldsWithIncludedStruct.__new__(FieldsWithIncludedStruct)
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = cmove(cpp_obj)
        return __fbthrift_inst
    ...
    def __hash__(FieldsWithIncludedStruct self):
        return super().__hash__()

    def __repr__(FieldsWithIncludedStruct self):
        return super().__repr__()

    def __str__(FieldsWithIncludedStruct self):
        return super().__str__()


    def __copy__(FieldsWithIncludedStruct self):
        return self

    def __richcmp__(self, other, int op):
        r = self._fbthrift_cmp_sametype(other, op)
        return __richcmp[_foo_cbindings.cFieldsWithIncludedStruct](
            self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
            (<FieldsWithIncludedStruct>other)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE,
            op,
        ) if r is None else r

    @staticmethod
    def __get_reflection__():
        return get_types_reflection().get_reflection__FieldsWithIncludedStruct()

    @staticmethod
    def __get_metadata__():
        cdef __fbthrift_cThriftMetadata meta
        _foo_cbindings.StructMetadata[_foo_cbindings.cFieldsWithIncludedStruct].gen(meta)
        return __MetadataBox.box(cmove(meta))
    ...
    @classmethod
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_foo_cbindings.cFieldsWithIncludedStruct](idx))

    @classmethod
    def _fbthrift_get_struct_size(cls):
        return 1

    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(FieldsWithIncludedStruct self, __Protocol proto):
        cdef unique_ptr[_fbthrift_iobuf.cIOBuf] data
        with nogil:
            data = cmove(serializer.cserialize[_foo_cbindings.cFieldsWithIncludedStruct](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
        return _fbthrift_iobuf.from_unique_ptr(cmove(data))

    cdef cuint32_t _fbthrift_deserialize(FieldsWithIncludedStruct self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        cdef cuint32_t needed
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_foo_cbindings.cFieldsWithIncludedStruct]()
        with nogil:
            needed = serializer.cdeserialize[_foo_cbindings.cFieldsWithIncludedStruct](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed


    def _to_python(self):
        return thrift.python.converter.to_python_struct(
            _fbthrift_python_types.FieldsWithIncludedStruct,
            self,
        )
    ...
    def _to_py_deprecated(self):
        import thrift.util.converter
        py_deprecated_types = importlib.import_module("foo.ttypes")
        return thrift.util.converter.to_py_struct(py_deprecated_types.FieldsWithIncludedStruct, self)
