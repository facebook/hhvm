...
::std::string_view _fbthrift_schema_1df5cd128411d3a6() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_1df5cd128411d3a6_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_1df5cd128411d3a6_uris() {
  return {};
}
