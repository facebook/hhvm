...
static Variant HHVM_FUNCTION(imap_body, const Resource& imap_stream, int64_t msg_number,
                    int64_t options /* = 0 */) {
...
static Variant HHVM_FUNCTION(imap_bodystruct, const Resource& imap_stream, int64_t msg_number,
...
static bool HHVM_FUNCTION(imap_clearflag_full, const Resource& imap_stream, const String& sequence,
                           const String& flag,
                           int64_t options /* = 0 */) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static bool HHVM_FUNCTION(imap_close, const Resource& imap_stream, int64_t flag /* = 0 */) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
  if (flag) {
    if (flag != PHP_EXPUNGE) {
...
static bool HHVM_FUNCTION(imap_createmailbox, const Resource& imap_stream, const String& mailbox) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static bool HHVM_FUNCTION(imap_delete, const Resource& imap_stream, const String& msg_number,
                   int64_t options /* = 0 */) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static bool HHVM_FUNCTION(imap_deletemailbox, const Resource& imap_stream, const String& mailbox) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static Variant HHVM_FUNCTION(imap_fetch_overview, const Resource& imap_stream, const String& sequence,
                              int64_t options /* = 0 */) {
...
static Variant HHVM_FUNCTION(imap_fetchbody, const Resource& imap_stream, int64_t msg_number,
...
static Variant HHVM_FUNCTION(imap_fetchheader, const Resource& imap_stream, int64_t msg_number,
                           int64_t options /* = 0 */) {
...
static Variant HHVM_FUNCTION(imap_fetchstructure, const Resource& imap_stream, int64_t msg_number,
                              int64_t options /* = 0 */) {
...
static bool HHVM_FUNCTION(imap_gc, const Resource& imap_stream, int64_t caches) {
...
static Variant HHVM_FUNCTION(imap_headerinfo, const Resource& imap_stream, int64_t msg_number,
...
static Variant HHVM_FUNCTION(imap_header, const Resource& imap_stream, int64_t msg_number,
                      int64_t fromlength /* = 0 */,
                      int64_t subjectlength /* = 0 */,
                      const String& defaulthost /* = "" */) {
...
static Variant HHVM_FUNCTION(imap_list, const Resource& imap_stream, const String& ref,
...
static Variant HHVM_FUNCTION(imap_listmailbox, const Resource& imap_stream, const String& ref,
                           const String& pattern) {
  return HHVM_FN(imap_list)(imap_stream, ref, pattern);
}

static bool HHVM_FUNCTION(imap_mail_copy, const Resource& imap_stream, const String& msglist,
...
static bool HHVM_FUNCTION(imap_mail_move, const Resource& imap_stream, const String& msglist,
...
static bool HHVM_FUNCTION(imap_mail, const String& to, const String& subject, const String& message,
...
static Variant HHVM_FUNCTION(imap_msgno, const Resource& imap_stream, int64_t uid) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static Variant HHVM_FUNCTION(imap_open, const String& mailbox, const String& username,
...
static bool HHVM_FUNCTION(imap_renamemailbox, const Resource& imap_stream, const String& old_mbox,
...
static bool HHVM_FUNCTION(imap_reopen, const Resource& imap_stream, const String& mailbox,
                   int64_t options /* = 0 */, int64_t retries /* = 0 */) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
  long flags = NIL;
  long cl_flags = NIL;
...
static Variant HHVM_FUNCTION(imap_search, const Resource& imap_stream, const String& criteria,
                      int64_t options /* = 0 */,
...
static bool HHVM_FUNCTION(imap_setflag_full, const Resource& imap_stream, const String& sequence,
                         const String& flag,
                         int64_t options /* = 0 */) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static Variant HHVM_FUNCTION(imap_status, const Resource& imap_stream, const String& mailbox,
                      int64_t options /* = 0 */) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
  Object ret(SystemLib::AllocStdClassObject());
...
static bool HHVM_FUNCTION(imap_subscribe, const Resource& imap_stream, const String& mailbox) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static Variant HHVM_FUNCTION(imap_timeout, int64_t timeout_type, int64_t timeout /* = -1 */) {
  int actual_type;
  if (timeout == -1) {
    switch (timeout_type) {
      case 1:
...
static Variant HHVM_FUNCTION(imap_uid, const Resource& imap_stream, int64_t msg_number) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
  if (!obj->checkMsgNumber(msg_number)) {
    return false;
  }
...
static bool HHVM_FUNCTION(imap_undelete, const Resource& imap_stream, const String& msg_number,
                     int64_t flags /* = 0 */) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
...
static bool HHVM_FUNCTION(imap_unsubscribe, const Resource& imap_stream, const String& mailbox) {
  ImapStream *obj = imap_stream.getTyped<ImapStream>();
