...
void fg1_mysql_connect(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_connect(TypedValue* rv, ActRec* ar, int32_t count) {
...
void fg1_mysql_connect_with_db(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_connect_with_db(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  switch (count) {
  default: // count >= 8
...
TypedValue* fg_mysql_connect_with_db(ActRec* ar) {
  ...
  if (count <= 8) {
    if ((count <= 7 || (args - 7)->m_type == KindOfInt64) &&
        ...
        (count <= 5 || (args - 5)->m_type == KindOfInt64) &&
        (count <= 4 || (args - 4)->m_type == KindOfBoolean) &&
...
void fg1_mysql_pconnect(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_pconnect(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  switch (count) {
  default: // count >= 6
    if ((args-5)->m_type != KindOfInt64) {
...
void fg1_mysql_pconnect_with_db(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_pconnect_with_db(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  switch (count) {
  default: // count >= 7
    if ((args-6)->m_type != KindOfInt64) {
...
void fg1_mysql_set_timeout(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_set_timeout(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
...
void fg1_mysql_escape_string(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_escape_string(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
...
void fg1_mysql_real_escape_string(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_real_escape_string(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_set_charset(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_set_charset(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_create_db(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_create_db(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_select_db(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_select_db(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_drop_db(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_drop_db(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_query(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_query(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_multi_query(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_multi_query(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_unbuffered_query(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_unbuffered_query(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_db_query(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_db_query(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  switch (count) {
  default: // count >= 3
  case 2:
...
void fg1_mysql_list_tables(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_list_tables(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  Variant defVal1;
...
void fg1_mysql_list_fields(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_list_fields(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  switch (count) {
  default: // count >= 3
  case 2:
...
void fg1_mysql_data_seek(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_data_seek(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
...
void fg1_mysql_async_connect_start(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_async_connect_start(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  switch (count) {
  default: // count >= 4
    if (!IS_STRING_TYPE((args-3)->m_type)) {
...
void fg1_mysql_async_query_start(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_async_query_start(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToStringInPlace(args-0);
  rv->m_type = KindOfBoolean;
...
void fg1_mysql_async_fetch_array(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_async_fetch_array(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_async_wait_actionable(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_async_wait_actionable(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
...
void fg1_mysql_fetch_array(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_fetch_array(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_fetch_object(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_fetch_object(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  switch (count) {
  default: // count >= 3
...
void fg1_mysql_result(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_result(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_db_name(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_db_name(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_tablename(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_tablename(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_fetch_field(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_fetch_field(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_field_seek(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_field_seek(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
  rv->m_type = KindOfBoolean;
...
void fg1_mysql_field_name(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_field_name(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_field_table(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_field_table(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_field_len(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_field_len(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_field_type(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_field_type(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
...
void fg1_mysql_field_flags(TypedValue* rv, ActRec* ar, int32_t count) __attribute__((noinline,cold));
void fg1_mysql_field_flags(TypedValue* rv, ActRec* ar, int32_t count) {
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  tvCastToInt64InPlace(args-1);
