...
#define YYTOKEN(num, name) name = num,
   ...
   YYTOKEN_MAP {
     ...
     YYTOKEN(374, T_ARRAY)
     YYTOKEN(375, T_DICT)
     YYTOKEN(376, T_CALLABLE)
     YYTOKEN(377, T_CLASS_C)
     YYTOKEN(378, T_METHOD_C)
     YYTOKEN(379, T_FUNC_C)
     YYTOKEN(380, T_LINE)
     YYTOKEN(381, T_FILE)
     YYTOKEN(382, T_COMMENT)
     YYTOKEN(383, T_DOC_COMMENT)
     YYTOKEN(384, T_OPEN_TAG)
     YYTOKEN(385, T_OPEN_TAG_WITH_ECHO)
     YYTOKEN(386, T_CLOSE_TAG)
     YYTOKEN(387, T_WHITESPACE)
     YYTOKEN(388, T_START_HEREDOC)
     YYTOKEN(389, T_END_HEREDOC)
     YYTOKEN(390, T_DOLLAR_OPEN_CURLY_BRACES)
     YYTOKEN(391, T_CURLY_OPEN)
     YYTOKEN(392, T_DOUBLE_COLON)
     YYTOKEN(393, T_NAMESPACE)
     YYTOKEN(394, T_NS_C)
     YYTOKEN(395, T_DIR)
     YYTOKEN(396, T_NS_SEPARATOR)
     YYTOKEN(397, T_XHP_LABEL)
     YYTOKEN(398, T_XHP_TEXT)
     YYTOKEN(399, T_XHP_ATTRIBUTE)
     YYTOKEN(400, T_XHP_CATEGORY)
     YYTOKEN(401, T_XHP_CATEGORY_LABEL)
     YYTOKEN(402, T_XHP_CHILDREN)
     YYTOKEN(403, T_ENUM)
     YYTOKEN(404, T_XHP_REQUIRED)
     YYTOKEN(405, T_TRAIT)
     YYTOKEN(406, T_ELLIPSIS)
     YYTOKEN(407, T_INSTEADOF)
     YYTOKEN(408, T_TRAIT_C)
     YYTOKEN(409, T_HH_ERROR)
     YYTOKEN(410, T_FINALLY)
     YYTOKEN(411, T_XHP_TAG_LT)
     YYTOKEN(412, T_XHP_TAG_GT)
     YYTOKEN(413, T_TYPELIST_LT)
     YYTOKEN(414, T_TYPELIST_GT)
     YYTOKEN(415, T_UNRESOLVED_LT)
     YYTOKEN(416, T_COLLECTION)
     YYTOKEN(417, T_SHAPE)
     YYTOKEN(418, T_TYPE)
     YYTOKEN(419, T_UNRESOLVED_TYPE)
     YYTOKEN(420, T_NEWTYPE)
     YYTOKEN(421, T_UNRESOLVED_NEWTYPE)
     YYTOKEN(422, T_COMPILER_HALT_OFFSET)
     YYTOKEN(423, T_ASYNC)
     YYTOKEN(424, T_LAMBDA_OP)
     YYTOKEN(425, T_LAMBDA_CP)
     YYTOKEN(426, T_UNRESOLVED_OP)
   };
#endif
