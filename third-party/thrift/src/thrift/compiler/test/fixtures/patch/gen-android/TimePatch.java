...
public class TimePatch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public final TimeStruct assign;
  /**
   * Clear any set value.
   */
  ...
  public static TimePatch deserialize(TProtocol iprot) throws TException {
    TimeStruct tmp_assign = null;
      ...
      switch (__field.id)
      {
        case ASSIGN:
          if (__field.type == TType.STRUCT) {
            tmp_assign = TimeStruct.deserialize(iprot);
          } else {
