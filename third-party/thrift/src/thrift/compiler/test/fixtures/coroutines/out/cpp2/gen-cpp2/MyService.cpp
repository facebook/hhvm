...
void apache::thrift::ServiceHandler<::cpp2::MyService>::async_eb_getDataById(
    apache::thrift::HandlerCallbackPtr<std::unique_ptr<::std::string>> callback, ::std::int64_t /*id*/) {
  callback->exception(
