...
public class MyDataEnsureStruct implements TBase, java.io.Serializable, Cloneable, Comparable<MyDataEnsureStruct> {
  ...
  static {
    ...
    tmpMetaDataMap.put(DATA1, new FieldMetaData("data1", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.STRING)));
    tmpMetaDataMap.put(DATA2, new FieldMetaData("data2", TFieldRequirementType.OPTIONAL, 
        new FieldValueMetaData(TType.I32)));
    metaDataMap = Collections.unmodifiableMap(tmpMetaDataMap);
  }

  static {
    FieldMetaData.addStructMetaDataMap(MyDataEnsureStruct.class, metaDataMap);
  }
  ...
  public MyDataEnsureStruct setData1(String data1) {
    this.data1 = data1;
    return this;
  }
  ...
  public MyDataEnsureStruct setData2(int data2) {
    this.data2 = data2;
    setData2IsSet(true);
    return this;
  }
  ...
  @Override
  public int compareTo(MyDataEnsureStruct other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MyDataEnsureStruct");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
