...
X(LdIterEnd,                    IterId);
X(KillIter,                     IterId);
X(LIterInitArr,                 IterData);
X(LIterInitArrK,                IterData);
X(LIterInitObj,                 IterData);
X(LIterInitObjK,                IterData);
X(LIterNextArr,                 IterData);
X(LIterNextArrK,                IterData);
X(LIterNextObj,                 IterData);
X(LIterNextObjK,                IterData);
