...
public class NewType implements TBase, java.io.Serializable, Cloneable {
  ...
  public NewType deepCopy() {
    return new NewType(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof NewType))
      return false;
    NewType that = (NewType)_that;
  ...
  public static NewType deserialize(TProtocol iprot) throws TException {
    TField __field;
