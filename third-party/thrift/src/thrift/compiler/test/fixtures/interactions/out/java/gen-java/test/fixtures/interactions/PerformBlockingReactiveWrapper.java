...
public class PerformBlockingReactiveWrapper 
    implements Perform.Reactive {
    private final Perform _delegate;

    public PerformBlockingReactiveWrapper(Perform _delegate) {
    ...
    public class MyInteractionImpl implements MyInteraction {
        private Perform.MyInteraction _delegateInteraction;

        MyInteractionImpl(Perform.MyInteraction delegateInteraction) {
    ...
    public class MyInteractionFastImpl implements MyInteractionFast {
        private Perform.MyInteractionFast _delegateInteraction;

        MyInteractionFastImpl(Perform.MyInteractionFast delegateInteraction) {
            this._delegateInteraction = delegateInteraction;
        }
    ...
    public class SerialInteractionImpl implements SerialInteraction {
        private Perform.SerialInteraction _delegateInteraction;

        SerialInteractionImpl(Perform.SerialInteraction delegateInteraction) {
            this._delegateInteraction = delegateInteraction;
        }
