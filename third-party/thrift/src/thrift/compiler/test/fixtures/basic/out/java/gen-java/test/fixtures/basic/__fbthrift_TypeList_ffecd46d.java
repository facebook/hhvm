...
public class __fbthrift_TypeList_ffecd46d implements TypeList {
  ...
  private static void addToList0() {
    ...
    add("test.dev/fixtures/basic/MyExceptionWithMessage", "test.fixtures.basic.MyExceptionWithMessage");
