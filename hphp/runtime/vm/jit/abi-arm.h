...
/*
 * Note: d8-d15 are currently marked as reserved.  If we decide to make them
 * available for the JIT, we need to add them to this set and add support for
 * saving / restoring them upon entering / leaving the TC.
*/
