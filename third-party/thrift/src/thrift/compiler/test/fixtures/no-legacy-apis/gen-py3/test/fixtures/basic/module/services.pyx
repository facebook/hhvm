...
cdef class Promise__test_fixtures_basic_module_types_cMyStruct:
    cdef cFollyPromise[unique_ptr[_test_fixtures_basic_module_types.cMyStruct]]* cPromise

    def __cinit__(self):
        self.cPromise = new cFollyPromise[unique_ptr[_test_fixtures_basic_module_types.cMyStruct]](cFollyPromise[unique_ptr[_test_fixtures_basic_module_types.cMyStruct]].makeEmpty())

    def __dealloc__(self):
        del self.cPromise

    @staticmethod
    cdef _fbthrift_create(cFollyPromise[unique_ptr[_test_fixtures_basic_module_types.cMyStruct]] cPromise):
        cdef Promise__test_fixtures_basic_module_types_cMyStruct inst = Promise__test_fixtures_basic_module_types_cMyStruct.__new__(Promise__test_fixtures_basic_module_types_cMyStruct)
...
cdef api void call_cy_MyService_query(
    ...
    cFollyPromise[unique_ptr[_test_fixtures_basic_module_types.cMyStruct]] cPromise,
    unique_ptr[_test_fixtures_basic_module_types.cMyUnion] u
):
    cdef Promise__test_fixtures_basic_module_types_cMyStruct __promise = Promise__test_fixtures_basic_module_types_cMyStruct._fbthrift_create(cmove(cPromise))
    arg_u = _test_fixtures_basic_module_types.MyUnion._fbthrift_create(shared_ptr[_test_fixtures_basic_module_types.cMyUnion](u.release()))
...
async def MyService_query_coro(
    object self,
    Promise__test_fixtures_basic_module_types_cMyStruct promise,
    u
):
    try:
        ...
        promise.cPromise.setValue(make_unique[_test_fixtures_basic_module_types.cMyStruct](deref((<_test_fixtures_basic_module_types.MyStruct?> result)._cpp_obj)))
