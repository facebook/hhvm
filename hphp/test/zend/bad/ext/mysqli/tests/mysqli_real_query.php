<?php
	...
	$tmp    = NULL;
	$link   = NULL;
	$test_table_name = 'test_mysqli_real_query_table_1'; require('table.inc');
...
ver_param;')) {
	...
	if (NULL !== ($tmp = mysqli_real_query($link, "SELECT id FROM test_mysqli_real_query_table_1")))
...
if (!mysqli_query($link, "DROP TABLE IF EXISTS test_mysqli_real_query_table_1"))
