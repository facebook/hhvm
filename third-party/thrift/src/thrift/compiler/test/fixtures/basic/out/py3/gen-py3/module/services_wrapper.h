...
class FooServiceWrapper : virtual public FooServiceSvIf {
  ...
  public:
    ...
    void async_tm_simple_rpc(apache::thrift::HandlerCallback<void>::Ptr callback) override;
...
class FB303ServiceWrapper : virtual public FB303ServiceSvIf {
  ...
  public:
    ...
    void async_tm_simple_rpc(apache::thrift::HandlerCallback<std::unique_ptr<::test::fixtures::basic::ReservedKeyword>>::Ptr callback
...
class MyServiceWrapper : virtual public MyServiceSvIf {
  ...
  public:
    ...
    void async_tm_ping(apache::thrift::HandlerCallback<void>::Ptr callback) override;
    void async_tm_getRandomData(apache::thrift::HandlerCallback<std::unique_ptr<std::string>>::Ptr callback) override;
    void async_tm_sink(apache::thrift::HandlerCallback<void>::Ptr callback
        , int64_t sink
    ) override;
    ...
    void async_tm_getDataById(apache::thrift::HandlerCallback<std::unique_ptr<std::string>>::Ptr callback
        , int64_t id
    ) override;
    void async_tm_deleteDataById(apache::thrift::HandlerCallback<void>::Ptr callback
        , int64_t id
    ) override;
    ...
    void async_tm_invalid_return_for_hack(apache::thrift::HandlerCallback<std::unique_ptr<std::set<float>>>::Ptr callback) override;
    void async_tm_rpc_skipped_codegen(apache::thrift::HandlerCallback<void>::Ptr callback) override;
folly::SemiFuture<folly::Unit> semifuture_onStartServing() override;
folly::SemiFuture<folly::Unit> semifuture_onStopRequested() override;
};
...
class DbMixedStackArgumentsWrapper : virtual public DbMixedStackArgumentsSvIf {
  ...
  public:
    ...
    void async_tm_getDataByKey1(apache::thrift::HandlerCallback<std::unique_ptr<std::string>>::Ptr callback
        , std::unique_ptr<std::string> key
    ) override;
folly::SemiFuture<folly::Unit> semifuture_onStartServing() override;
folly::SemiFuture<folly::Unit> semifuture_onStopRequested() override;
