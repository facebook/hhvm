...
public final class MyStruct implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public MyStruct(
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="MyDataField", requiredness=Requiredness.NONE) final test.fixtures.no_package.MyDataItem myDataField,
        @com.facebook.swift.codec.ThriftField(value=4, name="myEnum", requiredness=Requiredness.NONE) final test.fixtures.no_package.MyEnum myEnum,
    ...
    protected MyStruct() {
      ...
      this.myEnum = test.fixtures.no_package.MyEnum.fromInteger(0);
      this.oneway = false;
      this.readonly = false;
    ...
    public static class Builder {
        ...
        private test.fixtures.no_package.MyDataItem myDataField = null;
        private test.fixtures.no_package.MyEnum myEnum = test.fixtures.no_package.MyEnum.fromInteger(0);
        ...
        @com.facebook.swift.codec.ThriftField(value=3, name="MyDataField", requiredness=Requiredness.NONE)    public Builder setMyDataField(test.fixtures.no_package.MyDataItem myDataField) {
            this.myDataField = myDataField;
            return this;
        }

        public test.fixtures.no_package.MyDataItem getMyDataField() { return myDataField; }

        @com.facebook.swift.codec.ThriftField(value=4, name="myEnum", requiredness=Requiredness.NONE)    public Builder setMyEnum(test.fixtures.no_package.MyEnum myEnum) {
            this.myEnum = myEnum;
            return this;
        }

        public test.fixtures.no_package.MyEnum getMyEnum() { return myEnum; }
    ...
    private final test.fixtures.no_package.MyDataItem myDataField;
    ...
    private final test.fixtures.no_package.MyEnum myEnum;
    ...
    public void write0(TProtocol oprot) throws TException {
        ...
        {
            test.fixtures.no_package.MyDataItem _fbthriftVar0 = this.myDataField;
            if (_fbthriftVar0 != null) {
        ...
        {
            test.fixtures.no_package.MyEnum _fbthriftVar0 = this.myEnum;
