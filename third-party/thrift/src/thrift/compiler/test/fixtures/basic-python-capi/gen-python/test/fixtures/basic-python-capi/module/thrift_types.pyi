...
class PrimitiveStruct(_fbthrift_python_types.Struct):
    ...
    some_error: _typing.Final[test.fixtures.basic-python-capi.thrift_dep.thrift_types.SomeError] = ...
    def __init__(
        self, *,
        booly: _typing.Optional[bool]=...,
        ...
        some_error: _typing.Optional[test.fixtures.basic-python-capi.thrift_dep.thrift_types.SomeError]=...
    ) -> None: ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[bool, int, int, int, int, float, float, str, bytes, _fbthrift_iobuf.IOBuf, _fbthrift_iobuf.IOBuf, MyStruct, EmptyStruct, bytes, str, test.fixtures.basic-python-capi.thrift_dep.thrift_types.SomeError]]]: ...
    def _to_python(self) -> _typing.Self: ...
...
class MapStruct(_fbthrift_python_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.Mapping[MyEnum, str], _typing.Mapping[int, str], _typing.Mapping[bytes, PrimitiveStruct], _typing.Mapping[str, float], _typing.Mapping[int, float], _typing.Sequence[_typing.Mapping[int, int]], _typing.Mapping[int, _typing.Sequence[int]], _typing.Mapping[int, _typing.Sequence[float]], _typing.Mapping[bytes, _fbthrift_iobuf.IOBuf]]]]: ...
    def _to_python(self) -> _typing.Self: ...
...
class ComposeStruct(_fbthrift_python_types.Struct):
    ...
    xenum: _typing.Final[test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepEnum] = ...
    xstruct: _typing.Final[test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepStruct] = ...
    friends: _typing.Final[_typing.Sequence[test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepStruct]] = ...
    serial_struct: _typing.Final[test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedStruct] = ...
    serial_union: _typing.Final[test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedUnion] = ...
    serial_error: _typing.Final[test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedError] = ...
    def __init__(
        self, *,
        ...
        xenum: _typing.Optional[test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepEnum]=...,
        xstruct: _typing.Optional[test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepStruct]=...,
        friends: _typing.Optional[_typing.Sequence[test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepStruct]]=...,
        serial_struct: _typing.Optional[test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedStruct]=...,
        serial_union: _typing.Optional[test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedUnion]=...,
        serial_error: _typing.Optional[test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedError]=...
    ) -> None: ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[MyEnum, AnnoyingEnum, PrimitiveStruct, ListStruct, test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepEnum, test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepStruct, _typing.Sequence[test.fixtures.basic-python-capi.thrift_dep.thrift_types.DepStruct], test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedStruct, test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedUnion, test.fixtures.basic-python-capi.serialized_dep.thrift_types.SerializedError]]]: ...
    def _to_python(self) -> _typing.Self: ...
