...
func (p *ProcessInEbThreadUnsafe) Read(iprot thrift.Protocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *ProcessInEbThreadUnsafe) Write(oprot thrift.Protocol) error {
  if err := oprot.WriteStructBegin("ProcessInEbThreadUnsafe"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if err := oprot.WriteFieldStop(); err != nil {
    return thrift.PrependError("write field stop error: ", err) }
  if err := oprot.WriteStructEnd(); err != nil {
...
func (p *ProcessInEbThreadUnsafe) String() string {
  if p == nil {
    return "<nil>"
  }

  return fmt.Sprintf("ProcessInEbThreadUnsafe({})")
}
...
func (p RuntimeAnnotationBuilder) Emit() *RuntimeAnnotation{
  return &RuntimeAnnotation{
  }
}

func (p *RuntimeAnnotation) Read(iprot thrift.Protocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *RuntimeAnnotation) Write(oprot thrift.Protocol) error {
  if err := oprot.WriteStructBegin("RuntimeAnnotation"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if err := oprot.WriteFieldStop(); err != nil {
    return thrift.PrependError("write field stop error: ", err) }
  if err := oprot.WriteStructEnd(); err != nil {
...
func (p *RuntimeAnnotation) String() string {
  if p == nil {
    return "<nil>"
  }

  return fmt.Sprintf("RuntimeAnnotation({})")
}
