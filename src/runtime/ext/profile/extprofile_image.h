...
inline Variant x_getimagesize(CStrRef filename, VRefParam imageinfo = null) {
...
inline Variant x_exif_thumbnail(CStrRef filename, VRefParam width = null, VRefParam height = null, VRefParam imagetype = null) {
