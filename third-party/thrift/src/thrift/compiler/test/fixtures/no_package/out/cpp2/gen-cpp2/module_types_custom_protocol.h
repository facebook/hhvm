...
_readField_MyDataField:
  {
    ...
    ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyDataItemAlias>::readWithContext(*iprot, this->__fbthrift_field_MyDataField, _readState);
...
uint32_t MyStruct::serializedSize(Protocol_ const* prot_) const {
  ...
  }
  {
    ...
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyDataItemAlias>::serializedSize<false>(*prot_, this->__fbthrift_field_MyDataField);
  }
  {
...
uint32_t MyStruct::serializedSizeZC(Protocol_ const* prot_) const {
  ...
  {
    xfer += prot_->serializedFieldSize("MyDataField", apache::thrift::protocol::TType::T_STRUCT, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyDataItemAlias>::serializedSize<true>(*prot_, this->__fbthrift_field_MyDataField);
  }
  {
    xfer += prot_->serializedFieldSize("myEnum", apache::thrift::protocol::TType::T_I32, 4);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::enumeration, ::cpp2::MyEnum>::serializedSize<false>(*prot_, this->__fbthrift_field_myEnum);
...
uint32_t MyStruct::write(Protocol_* prot_) const {
  ...
  }
  {
    ...
    previousFieldHasValue = true;
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyDataItemAlias>::write(*prot_, this->__fbthrift_field_MyDataField);
    xfer += prot_->writeFieldEnd();
  }
  {
    ...
    switch (_readState.fieldId) {
      case 1:
      {
        if (_readState.isCompatibleWithType(iprot, apache::thrift::protocol::TType::T_I32)) {
          ...
          ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::enumeration, ::cpp2::MyEnumAlias>::readWithContext(*iprot, value_.myEnum, _readState);
        } else {
          _readState.skip(iprot);
        }
        break;
...
uint32_t MyUnion::serializedSize(Protocol_ const* prot_) const {
  ...
  switch(this->getType()) {
    case MyUnion::Type::myEnum:
    {
      ...
      xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::enumeration, ::cpp2::MyEnumAlias>::serializedSize<false>(*prot_, value_.myEnum);
      break;
    }
...
uint32_t MyUnion::write(Protocol_* prot_) const {
  ...
  switch(this->getType()) {
    case MyUnion::Type::myEnum:
    {
      ...
      xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::enumeration, ::cpp2::MyEnumAlias>::write(*prot_, value_.myEnum);
      xfer += prot_->writeFieldEnd();
      break;
    }
    case MyUnion::Type::myStruct:
...
_readField_myStruct:
  {
    _readState.beforeSubobject(iprot);
    ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyStruct>::readWithContext(*iprot, this->__fbthrift_field_myStruct, _readState);
    _readState.afterSubobject(iprot);
  }
 this->__isset.set(2, true);
...
uint32_t MyException::serializedSize(Protocol_ const* prot_) const {
  ...
  }
  {
    ...
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyStruct>::serializedSize<false>(*prot_, this->__fbthrift_field_myStruct);
  }
  {
...
uint32_t MyException::serializedSizeZC(Protocol_ const* prot_) const {
  ...
  {
    xfer += prot_->serializedFieldSize("myStruct", apache::thrift::protocol::TType::T_STRUCT, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyStruct>::serializedSize<true>(*prot_, this->__fbthrift_field_myStruct);
  }
  {
    xfer += prot_->serializedFieldSize("myUnion", apache::thrift::protocol::TType::T_STRUCT, 4);
...
uint32_t MyException::write(Protocol_* prot_) const {
  ...
  }
  {
    ...
    previousFieldHasValue = true;
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::cpp2::MyStruct>::write(*prot_, this->__fbthrift_field_myStruct);
    xfer += prot_->writeFieldEnd();
  }
  {
    constexpr int16_t kPrevFieldId = 3;
