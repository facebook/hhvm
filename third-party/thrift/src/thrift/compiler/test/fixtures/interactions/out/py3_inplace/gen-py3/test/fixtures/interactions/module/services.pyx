...
async def InteractWithShared_do_some_similar_things_coro(
    ...
    try:
        ...
        promise.cPromise.setValue(make_unique[_test_fixtures_another_interactions_shared_cbindings.cDoSomethingResult](_test_fixtures_another_interactions_shared_thrift_converter.DoSomethingResult_convert_to_cpp(result._to_python())))
...
async def BoxService_getABoxSession_coro(
    ...
    try:
        ...
        promise.cPromise.setValue(make_unique[_test_fixtures_interactions_module_cbindings.cShouldBeBoxed](_test_fixtures_interactions_module_thrift_converter.ShouldBeBoxed_convert_to_cpp(result._to_python())))
