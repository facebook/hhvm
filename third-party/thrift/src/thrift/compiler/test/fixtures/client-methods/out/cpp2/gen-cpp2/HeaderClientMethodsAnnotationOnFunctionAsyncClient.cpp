...
apache::thrift::SerializedRequest apache::thrift::Client<::cpp2::HeaderClientMethodsAnnotationOnFunction>::fbthrift_serialize_echo(Protocol_* prot, const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack, const ::cpp2::EchoRequest& p_request) {
...
template <typename Protocol_>
apache::thrift::SerializedRequest apache::thrift::Client<::cpp2::HeaderClientMethodsAnnotationOnFunction>::fbthrift_serialize_echo_2(Protocol_* prot, const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack, const ::cpp2::EchoRequest& p_request) {
