...
#if (defined(HHVM_FACEBOOK) || defined(LIBDWARF_CONST_NAME) || defined(LIBDWARF_USE_NEW_PRODUCER_API))
...
struct DwarfInfo {
  ...
  void addLineEntries(TCRange range, int lineNumber, FunctionInfo* f);
