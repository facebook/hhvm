...
public class WrappedFields implements TBase, java.io.Serializable, Cloneable, Comparable<WrappedFields> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(WrappedFields.class, metaDataMap);
  }
  ...
  public WrappedFields setField1(int field1) {
    this.field1 = field1;
    setField1IsSet(true);
    return this;
  }
  ...
  @Override
  public int compareTo(WrappedFields other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("WrappedFields");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
