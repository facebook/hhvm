...
public class FB303Service {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void simple_rpc(int int_parameter, AsyncMethodCallback resultHandler20) throws TException {
      checkReady();
    ...
    public static class simple_rpc_call extends TAsyncMethodCall {
      ...
      public simple_rpc_call(int int_parameter, AsyncMethodCallback resultHandler21, TAsyncClient client17, TProtocolFactory protocolFactory18, TNonblockingTransport transport19) throws TException {
