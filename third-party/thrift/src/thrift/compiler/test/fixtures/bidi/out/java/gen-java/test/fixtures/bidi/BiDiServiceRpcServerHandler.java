...
public class BiDiServiceRpcServerHandler 
  ...
  public BiDiServiceRpcServerHandler(BiDiService _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new BiDiServiceBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public BiDiServiceRpcServerHandler(BiDiService.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new BiDiServiceAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public BiDiServiceRpcServerHandler(BiDiService.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
  ...
  public reactor.core.publisher.Flux<com.facebook.thrift.payload.ServerResponsePayload> singleRequestStreamingResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    final String _qualifiedMethodName = "BiDiService." + _name;
