...
#endif
  virtual void async_tm_methodA(apache::thrift::HandlerCallback<void>::Ptr callback);
...
#endif
  virtual void async_tm_methodB(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int32_t p_x, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_y, double p_z);
...
#endif
  virtual void async_tm_methodC(apache::thrift::HandlerCallback<::std::int32_t>::Ptr callback);
...
#endif
  virtual void async_tm_methodD(apache::thrift::HandlerCallback<::std::int32_t>::Ptr callback, ::std::int32_t p_i, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_j, double p_k);
...
#endif
  virtual void async_tm_methodE(apache::thrift::HandlerCallback<std::unique_ptr<::test_cpp2::cpp_reflection::struct2>>::Ptr callback);
...
#endif
  virtual void async_tm_methodF(apache::thrift::HandlerCallback<std::unique_ptr<::test_cpp2::cpp_reflection::struct3>>::Ptr callback, ::std::int32_t p_l, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_m, double p_n);
 private:
