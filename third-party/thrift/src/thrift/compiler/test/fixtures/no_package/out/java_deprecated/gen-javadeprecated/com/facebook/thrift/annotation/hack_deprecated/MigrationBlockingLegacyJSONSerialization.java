...
public class MigrationBlockingLegacyJSONSerialization implements TBase, java.io.Serializable, Cloneable, Comparable<MigrationBlockingLegacyJSONSerialization> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MigrationBlockingLegacyJSONSerialization.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public MigrationBlockingLegacyJSONSerialization build() {
      MigrationBlockingLegacyJSONSerialization result = new MigrationBlockingLegacyJSONSerialization();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(MigrationBlockingLegacyJSONSerialization other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MigrationBlockingLegacyJSONSerialization");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
