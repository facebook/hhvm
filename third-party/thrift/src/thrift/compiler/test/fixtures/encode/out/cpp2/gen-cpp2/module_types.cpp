...
template void TccStructTraits<::facebook::thrift::test::fixtures::encode::Foo>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::encode::Bar>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::encode::Baz>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::test::fixtures::encode::OpEncodeStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
