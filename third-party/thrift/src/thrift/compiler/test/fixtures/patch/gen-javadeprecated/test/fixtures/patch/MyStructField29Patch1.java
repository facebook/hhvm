...
public class MyStructField29Patch1 implements TBase, java.io.Serializable, Cloneable, Comparable<MyStructField29Patch1> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MyStructField29Patch1.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public MyStructField29Patch1 build() {
      MyStructField29Patch1 result = new MyStructField29Patch1();
   ...
   * 
   */
  public MyStructField29Patch1 setAssign(Map<String,Integer> assign) {
    this.assign = assign;
    return this;
  }
   ...
   * Clears a value. Applies first.
   */
  public MyStructField29Patch1 setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public MyStructField29Patch1 setPatchPrior(Map<String,com.facebook.thrift.op.I32Patch> patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Add the given values, if the keys are not already present. Applies forth.
   */
  public MyStructField29Patch1 setAdd(Map<String,Integer> add) {
    this.add = add;
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public MyStructField29Patch1 setPatch(Map<String,com.facebook.thrift.op.I32Patch> patch) {
    this.patch = patch;
    return this;
  }
   ...
   * Removes entries, if present. Applies third.
   */
  public MyStructField29Patch1 setRemove(Set<String> remove) {
    this.remove = remove;
    return this;
  }
   ...
   * Adds or replaces the given key/value pairs. Applies fifth.
   */
  public MyStructField29Patch1 setPut(Map<String,Integer> put) {
    this.put = put;
    return this;
  }
  ...
  @Override
  public int compareTo(MyStructField29Patch1 other) {
    if (other == null) {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.assign = new HashMap<String,Integer>(Math.max(0, 2*_map127.size));
              for (int _i128 = 0; 
                   ...
                   ++_i128)
              {
                ...
                this.assign.put(_key129, _val130);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.patchPrior = new HashMap<String,com.facebook.thrift.op.I32Patch>(Math.max(0, 2*_map131.size));
              for (int _i132 = 0; 
                   (_map131.size < 0) ? iprot.peekMap() : (_i132 < _map131.size); 
                   ++_i132)
              {
                String _key133;
                com.facebook.thrift.op.I32Patch _val134;
                _key133 = iprot.readString();
                _val134 = new com.facebook.thrift.op.I32Patch();
                _val134.read(iprot);
                this.patchPrior.put(_key133, _val134);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.add = new HashMap<String,Integer>(Math.max(0, 2*_map135.size));
              for (int _i136 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.patch = new HashMap<String,com.facebook.thrift.op.I32Patch>(Math.max(0, 2*_map139.size));
              for (int _i140 = 0; 
                   (_map139.size < 0) ? iprot.peekMap() : (_i140 < _map139.size); 
                   ++_i140)
              {
                String _key141;
                com.facebook.thrift.op.I32Patch _val142;
                _key141 = iprot.readString();
                _val142 = new com.facebook.thrift.op.I32Patch();
                _val142.read(iprot);
                this.patch.put(_key141, _val142);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.remove = new HashSet<String>(Math.max(0, 2*_set143.size));
              for (int _i144 = 0; 
                   (_set143.size < 0) ? iprot.peekSet() : (_i144 < _set143.size); 
                   ++_i144)
              {
                String _elem145;
                _elem145 = iprot.readString();
                this.remove.add(_elem145);
              }
              iprot.readSetEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.put = new HashMap<String,Integer>(Math.max(0, 2*_map146.size));
              for (int _i147 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.assign != null) {
      if (isSetAssign()) {
        oprot.writeFieldBegin(ASSIGN_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter150 : this.assign.entrySet())          {
    ...
    if (this.patchPrior != null) {
      oprot.writeFieldBegin(PATCH_PRIOR_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, com.facebook.thrift.op.I32Patch> _iter151 : this.patchPrior.entrySet())        {
    ...
    if (this.add != null) {
      oprot.writeFieldBegin(ADD_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Integer> _iter152 : this.add.entrySet())        {
    ...
    if (this.patch != null) {
      oprot.writeFieldBegin(PATCH_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, com.facebook.thrift.op.I32Patch> _iter153 : this.patch.entrySet())        {
    ...
    if (this.remove != null) {
      oprot.writeFieldBegin(REMOVE_FIELD_DESC);
      {
        ...
        for (String _iter154 : this.remove)        {
    ...
    if (this.put != null) {
      oprot.writeFieldBegin(PUT_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, Integer> _iter155 : this.put.entrySet())        {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MyStructField29Patch1");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
