...
class PicklingCompatibilityTest(unittest.TestCase):
    ...
    def pickled_python(self) -> bytes:
        return (
            b"\x80\x04\x95{\x00\x00\x00\x00\x00\x00\x00\x8c\x13thrift.python."
            b"types\x94\x8c\x10_unpickle_struct\x94\x93\x94\x8c\x18test_thrift"
            b".thrift_types\x94\x8c\x04hard\x94\x93\x94C$\x15T\x19u\x02\x02"
            b"\x04\x06\n\x10\x1a\x18\x03foo\x1c$\xd8\x04\x00\x18\x0csome "
            b"default\x00\x94\x86\x94R\x94."
        )

    def pickled_py3(self) -> bytes:
        return (
            b"\x80\x04\x95q\x00\x00\x00\x00\x00\x00\x00\x8c\x15thrift.py3."
            b"serializer\x94\x8c\x0bdeserialize\x94\x93\x94\x8c\x11test_thrift"
            b".types\x94\x8c\x04hard\x94\x93\x94C$\x15T\x19u\x02\x02\x04\x06"
            b"\n\x10\x1a\x18\x03foo\x1c$\xd8\x04\x00\x18\x0csome default"
