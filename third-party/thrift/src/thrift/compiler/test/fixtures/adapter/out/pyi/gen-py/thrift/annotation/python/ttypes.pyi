...
class NoIntBaseClassDeprecated:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.python.thrift_types.NoIntBaseClassDeprecated": ...   # type: ignore
    def _to_mutable_python(self) -> "facebook.thrift.annotation.python.thrift_mutable_types.NoIntBaseClassDeprecated": ...   # type: ignore
    def _to_py3(self) -> "facebook.thrift.annotation.python.types.NoIntBaseClassDeprecated": ...   # type: ignore
    def _to_py_deprecated(self) -> NoIntBaseClassDeprecated: ...
