...
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 2> TStructDataStorage<::cpp2::Included>::fields_names = {{
  "MyIntField",
  "MyTransitiveField",
}};
THRIFT_DATA_SECTION const std::array<int16_t, 2> TStructDataStorage<::cpp2::Included>::fields_ids = {{
  1,
  2,
}};
THRIFT_DATA_SECTION const std::array<protocol::TType, 2> TStructDataStorage<::cpp2::Included>::fields_types = {{
  TType::T_I64,
  TType::T_STRUCT,
}};
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 2> TStructDataStorage<::cpp2::Included>::storage_names = {{
  "__fbthrift_field_MyIntField",
  "__fbthrift_field_MyTransitiveField",
}};
THRIFT_DATA_SECTION const std::array<int, 2> TStructDataStorage<::cpp2::Included>::isset_indexes = {{
  0,
  1,
}};
