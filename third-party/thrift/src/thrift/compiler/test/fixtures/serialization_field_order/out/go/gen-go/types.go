...
func (x *Foo2) writeField1(p thrift.Encoder) error {  // Field2
    if err := p.WriteFieldBegin("field2", thrift.I32, 1); err != nil {
        return fmt.Errorf("Foo2 write field begin error: %w", err)
    }
    ...
    if err := p.WriteFieldEnd(); err != nil {
        return fmt.Errorf("Foo2 write field end error: %w", err)
    }
    return nil
}
...
func (x *Foo2) Write(p thrift.Encoder) error {
    if err := p.WriteStructBegin("Foo2"); err != nil {
        return fmt.Errorf("Foo2 write struct begin error: %w", err)
    }
    ...
    if err := p.WriteFieldStop(); err != nil {
        return fmt.Errorf("Foo2 write field stop error: %w", err)
    }

    if err := p.WriteStructEnd(); err != nil {
        return fmt.Errorf("Foo2 write struct end error: %w", err)
    }
    return nil
}
...
func (x *Foo2) Read(p thrift.Decoder) error {
    if _, err := p.ReadStructBegin(); err != nil {
        return fmt.Errorf("Foo2 read error: %w", err)
    }

    for {
        fieldName, wireType, id, err := p.ReadFieldBegin()
        if err != nil {
            return fmt.Errorf("Foo2 field %d ('%s') read error: %w", id, fieldName, err)
        }
    ...
    if err := p.ReadStructEnd(); err != nil {
        return fmt.Errorf("Foo2 read struct end error: %w", err)
    }
...
func (x *Foo2) GetThriftStructMetadata() *metadata.ThriftStruct {
    return premadeStructMetadata_Foo2
}
