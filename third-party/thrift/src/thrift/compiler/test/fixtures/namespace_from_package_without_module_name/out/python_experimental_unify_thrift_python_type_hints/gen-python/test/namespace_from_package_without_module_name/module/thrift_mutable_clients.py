        ...
        async def init(
            ...
            *,
            ...
            _fbthrift_resp = await self._send_request(
                "TestService",
                "init",
                test.namespace_from_package_without_module_name.module.thrift_mutable_types._fbthrift_TestService_init_args(
                    int1=int1,),
                test.namespace_from_package_without_module_name.module.thrift_mutable_types._fbthrift_TestService_init_result,
