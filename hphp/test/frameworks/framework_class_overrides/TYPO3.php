...
class Typo3 extends Framework {
  ...
  public function __construct(string $name) {
    ...
    parent::__construct($name, $tc, $env_vars, null, false, TestFindModes::TOKEN);
  }
  ...
  protected function install(): void {
    ...
    $filePath = $this->getInstallRoot() . '/typo3/sysext/core/Resources/PHP/TYPO3.Flow/Classes/TYPO3/Flow/Package/PackageManagerInterface.php';
    file_put_contents($filePath, str_replace('public function initialize(','//public function initialize(', file_get_contents($filePath)));
    $filePath = $this->getInstallRoot() . '/typo3/sysext/core/Resources/PHP/TYPO3.Flow/Classes/TYPO3/Flow/Package/PackageInterface.php';
    file_put_contents($filePath, str_replace('public function boot(','//public function boot(', file_get_contents($filePath)));
  }
