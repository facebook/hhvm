...
class FooStreamEx(thrift.py3.exceptions.GeneratedError):
    ...
    def __eq__(self, other):
        return isinstance(other, FooStreamEx) and self._fbthrift__inner == other._fbthrift__inner
...
class FooEx(thrift.py3.exceptions.GeneratedError):
    ...
    def __eq__(self, other):
        return isinstance(other, FooEx) and self._fbthrift__inner == other._fbthrift__inner
...
class FooEx2(thrift.py3.exceptions.GeneratedError):
    ...
    def __eq__(self, other):
        return isinstance(other, FooEx2) and self._fbthrift__inner == other._fbthrift__inner
