...
public class OptionalBytePatch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public final BytePatch patchPrior;
  /**
  ...
  public static OptionalBytePatch deserialize(TProtocol iprot) throws TException {
    Boolean tmp_clear = null;
    BytePatch tmp_patchPrior = null;
    Byte tmp_ensure = null;
    BytePatch tmp_patch = null;
    TField __field;
      ...
      switch (__field.id)
      {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            tmp_patchPrior = BytePatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        ...
        case PATCH:
          if (__field.type == TType.STRUCT) {
            tmp_patch = BytePatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
    ...
    OptionalBytePatch _that;
    _that = new OptionalBytePatch(
      tmp_clear
      ,tmp_patchPrior
      ,tmp_ensure
      ,tmp_patch
