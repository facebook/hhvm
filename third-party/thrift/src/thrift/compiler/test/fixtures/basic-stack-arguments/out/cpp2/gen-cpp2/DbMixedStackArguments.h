...
#endif
  virtual void async_tm_getDataByKey0(apache::thrift::HandlerCallback<std::unique_ptr<::std::string>>::Ptr callback, std::unique_ptr<::std::string> p_key);
...
#endif
  virtual void async_tm_getDataByKey1(apache::thrift::HandlerCallback<::std::string>::Ptr callback, const ::std::string& p_key);
 private:
