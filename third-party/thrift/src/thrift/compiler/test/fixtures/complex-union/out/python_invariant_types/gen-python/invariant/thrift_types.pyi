...
class InvariantTypes(_fbthrift_python_types.Union, _fbthrift_python_abstract_types.InvariantTypes):
    struct_map: _typing.Final[_fbthrift_python_types.ImmutableMap[_fbthrift_StructForInvariantTypes, builtins.int]] = ...
    union_map: _typing.Final[_fbthrift_python_types.ImmutableMap[_fbthrift_UnionForInvariantTypes, builtins.int]] = ...
    def __init__(
        self, *,
