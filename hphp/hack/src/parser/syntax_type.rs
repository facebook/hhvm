...
pub trait SyntaxType<C>: SyntaxTypeBase<C>
{
    ...
    fn make_parameter_declaration(ctx: &C, parameter_attribute: Self, parameter_visibility: Self, parameter_optional: Self, parameter_call_convention: Self, parameter_readonly: Self, parameter_type: Self, parameter_ellipsis: Self, parameter_name: Self, parameter_default_value: Self, parameter_parameter_end: Self) -> Self;
    ...
    fn make_closure_parameter_type_specifier(ctx: &C, closure_parameter_optional: Self, closure_parameter_call_convention: Self, closure_parameter_readonly: Self, closure_parameter_type: Self, closure_parameter_ellipsis: Self) -> Self;
    fn make_tuple_or_union_or_intersection_element_type_specifier(ctx: &C, tuple_or_union_or_intersection_element_optional: Self, tuple_or_union_or_intersection_element_type: Self, tuple_or_union_or_intersection_element_ellipsis: Self) -> Self;
