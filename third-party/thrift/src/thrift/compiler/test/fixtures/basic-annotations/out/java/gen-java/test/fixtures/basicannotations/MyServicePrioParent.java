...
public interface MyServicePrioParent extends java.io.Closeable, com.facebook.thrift.util.BlockingService {
    ...
    static com.facebook.thrift.client.ClientBuilder<MyServicePrioParent> clientBuilder() {
        return new ClientBuilder<MyServicePrioParent>() {
            @java.lang.Override
            public MyServicePrioParent build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                MyServicePrioParent.Reactive _delegate =
                    new MyServicePrioParentReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    public interface Async extends java.io.Closeable, com.facebook.thrift.util.AsyncService {
        ...
        static com.facebook.thrift.client.ClientBuilder<MyServicePrioParent.Async> clientBuilder() {
            return new ClientBuilder<MyServicePrioParent.Async>() {
                @java.lang.Override
                public MyServicePrioParent.Async build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    MyServicePrioParent.Reactive _delegate =
                        new MyServicePrioParentReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    interface Reactive extends reactor.core.Disposable, com.facebook.thrift.util.ReactiveService {
        ...
        static com.facebook.thrift.client.ClientBuilder<MyServicePrioParent.Reactive> clientBuilder() {
            return new ClientBuilder<MyServicePrioParent.Reactive>() {
                @java.lang.Override
                public MyServicePrioParent.Reactive build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    return new MyServicePrioParentReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
                }
            };
        }
