...
class C1 {
  ...
  public function __construct() {
    ...
    */
    ...
    echo
      "(bool)\"123ABC\": pr_bool = >".($this->pr_bool ? "true" : "false")."<\n";

    //    $this->pr_bool = "456.78ABC";	// string is incompatible with bool
    $this->pr_bool = (bool)"456.78ABC";
    echo "(bool)\"456.78ABC\": pr_bool = >".
      ($this->pr_bool ? "true" : "false").
      "<\n";
    ...
    echo "new CustomButton(\"LOWER\"): pr_CustomButton= >".
      $this->pr_CustomButton.
      "<\n";
