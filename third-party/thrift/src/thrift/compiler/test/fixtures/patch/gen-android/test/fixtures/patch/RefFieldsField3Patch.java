...
public class RefFieldsField3Patch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static RefFieldsField3Patch deserialize(TProtocol iprot) throws TException {
    ...
    RefFieldsField3Patch _that;
    _that = new RefFieldsField3Patch(
      tmp_assign
      ,tmp_clear
      ,tmp_prepend
      ,tmp_append
