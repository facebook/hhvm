...
template void ExStruct::readNoXfer<>(apache::thrift::CompactProtocolReader*);
template uint32_t ExStruct::write<>(apache::thrift::CompactProtocolWriter*) const;
template uint32_t ExStruct::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
template uint32_t ExStruct::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;

template void TestUnion::readNoXfer<>(apache::thrift::CompactProtocolReader*);
template uint32_t TestUnion::write<>(apache::thrift::CompactProtocolWriter*) const;
template uint32_t TestUnion::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
template uint32_t TestUnion::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
