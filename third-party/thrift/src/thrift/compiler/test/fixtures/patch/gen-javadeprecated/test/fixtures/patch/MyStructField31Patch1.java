...
public class MyStructField31Patch1 implements TBase, java.io.Serializable, Cloneable, Comparable<MyStructField31Patch1> {
  private static final TStruct STRUCT_DESC = new TStruct("MyStructField31Patch1");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MyStructField31Patch1.class, metaDataMap);
  }

  public MyStructField31Patch1() {
  }
  ...
  public static class Builder {
    ...
    public MyStructField31Patch1 build() {
      MyStructField31Patch1 result = new MyStructField31Patch1();
   ...
   */
  public MyStructField31Patch1(MyStructField31Patch1 other) {
  ...
  public MyStructField31Patch1 deepCopy() {
    return new MyStructField31Patch1(this);
  }
   ...
   * Assigns a value. If set, all other operations are ignored.
   */
  public MyStructField31Patch1 setAssign(Map<String,Integer> assign) {
    this.assign = assign;
    return this;
  }
   ...
   * Clears a value. Applies first.
   */
  public MyStructField31Patch1 setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public MyStructField31Patch1 setPatchPrior(Map<String,com.facebook.thrift.op.I32Patch> patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Add the given values, if the keys are not already present. Applies forth.
   */
  public MyStructField31Patch1 setAdd(Map<String,Integer> add) {
    this.add = add;
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public MyStructField31Patch1 setPatch(Map<String,com.facebook.thrift.op.I32Patch> patch) {
    this.patch = patch;
    return this;
  }
   ...
   * Removes entries, if present. Applies third.
   */
  public MyStructField31Patch1 setRemove(Set<String> remove) {
    this.remove = remove;
    return this;
  }
   ...
   * Adds or replaces the given key/value pairs. Applies fifth.
   */
  public MyStructField31Patch1 setPut(Map<String,Integer> put) {
    this.put = put;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof MyStructField31Patch1))
      return false;
    MyStructField31Patch1 that = (MyStructField31Patch1)_that;
  ...
  @Override
  public int compareTo(MyStructField31Patch1 other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MyStructField31Patch1");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
