...
class MetadataType {
 ...
 public:
  ...
  MetadataType(char* buffer, const std::uint64_t bufferLength)
  ...
  static std::uint8_t declaredException(
  ...
  static std::uint8_t dEPRECATED_proxyException(
      const std::uint8_t bits, const bool value) {
    return value
  ...
  static std::uint8_t appUnknownException(
      const std::uint8_t bits, const bool value) {
    return value
        ? static_cast<std::uint8_t>(bits | (static_cast<std::uint8_t>(1) << 2u))
        : static_cast<std::uint8_t>(
              bits & ~(static_cast<std::uint8_t>(1) << 2u));
  }
  ...
  static std::uint8_t anyException(const std::uint8_t bits, const bool value) {
    return value
        ? static_cast<std::uint8_t>(bits | (static_cast<std::uint8_t>(1) << 3u))
        : static_cast<std::uint8_t>(
              bits & ~(static_cast<std::uint8_t>(1) << 3u));
  }
