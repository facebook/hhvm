...
fn assemble_opcode<'arena>(
    ...
    match tok {
        b"Add" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Add, "Add"),
        b"Sub" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Sub, "Sub"),
        b"Mul" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Mul, "Mul"),
        b"Pow" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Pow, "Pow"),
        b"Not" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Not, "Not"),
        b"NSame" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::NSame, "NSame"),
        b"Eq" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Eq, "Eq"),
        b"Neq" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Neq, "Neq"),
        b"Lte" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Lte, "Lte"),
        b"Gt" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Gt, "Gt"),
        b"Gte" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Gte, "Gte"),
        b"Cmp" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Cmp, "Cmp"),
        b"BitAnd" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::BitAnd, "BitAnd"),
        b"BitOr" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::BitOr, "BitOr"),
        b"BitXor" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::BitXor, "BitXor"),
        b"BitNot" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::BitNot, "BitNot"),
        b"Shl" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Shl, "Shl"),
        b"Shr" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Shr, "Shr"),
        b"CastBool" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CastBool, "CastBool")
        }
        b"CastInt" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CastInt, "CastInt"),
        b"CastDouble" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CastDouble, "CastDouble")
        }
        b"CastString" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CastString, "CastString")
        }
        b"CastDict" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CastDict, "CastDict")
        }
        b"CastKeyset" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CastKeyset, "CastKeyset")
        }
        b"CastVec" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CastVec, "CastVec"),
        b"DblAsBits" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::DblAsBits, "DblAsBits")
        }
        b"InstanceOf" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::InstanceOf, "InstanceOf")
        }

        b"Print" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Print, "Print"),
        b"Div" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Div, "Div"),
        b"Dir" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Dir, "Dir"),
        b"PopC" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::PopC, "PopC"),
        b"Concat" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Concat, "Concat"),
        b"Null" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Null, "Null"),
        b"RetC" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::RetC, "RetC"),
        b"Lt" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Lt, "Lt"),
        b"Mod" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Mod, "Mod"),
        b"Exit" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Exit, "Exit"),
        b"Same" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Same, "Same"),
        b"NullUninit" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::NullUninit, "NullUninit")
        }
        b"String" => assemble_string_opcode(alloc, token_iter),
        b"Int" => assemble_int_opcode(token_iter),
        b"Double" => assemble_double_opcode(token_iter),
        b"False" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::False, "False"),
        b"Dict" => assemble_adata_id_carrying_instr(alloc, token_iter, hhbc::Opcode::Dict, "Dict"),
        b"Vec" => assemble_adata_id_carrying_instr(alloc, token_iter, hhbc::Opcode::Vec, "Vec"),
        b"Keyset" => {
            assemble_adata_id_carrying_instr(alloc, token_iter, hhbc::Opcode::Keyset, "Keyset")
        }
        b"True" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::True, "True"),
        b"LazyClass" => assemble_lazyclass_opcode(alloc, token_iter),
        ...
        b"PopL" => {
            assemble_local_carrying_opcode_instr(token_iter, decl_map, hhbc::Opcode::PopL, "PopL")
        }
        b"PushL" => {
            assemble_local_carrying_opcode_instr(token_iter, decl_map, hhbc::Opcode::PushL, "PushL")
        }
        ...
        b"JmpZ" => assemble_jump_opcode_instr(token_iter, hhbc::Opcode::JmpZ, "JmpZ"),
        b"Jmp" => assemble_jump_opcode_instr(token_iter, hhbc::Opcode::Jmp, "Jmp"),
        b"JmpNZ" => assemble_jump_opcode_instr(token_iter, hhbc::Opcode::JmpNZ, "JmpNZ"),
        ...
        b"IncDecM" => assemble_inc_dec_m(alloc, token_iter, decl_map),

        b"RetM" => assemble_retm_opcode_instr(token_iter),
        b"NewObj" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::NewObj, "NewObj"),
        b"NewObjD" => {
            assemble_obj_class_name_instr(alloc, token_iter, hhbc::Opcode::NewObjD, "NewObjD")
        }
        b"NewObjS" => {
            token_iter.next();
        ...
        b"Dup" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Dup, "Dup"),
        b"Throw" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Throw, "Throw"),
        ...
        b"CreateCl" => assemble_create_cl(alloc, token_iter),
        b"ResolveFunc" => {
            assemble_resolve_func(alloc, token_iter, hhbc::Opcode::ResolveFunc, "ResolveFunc")
        }
        ...
        b"NewVec" => assemble_u32_carrying_opcode(token_iter, hhbc::Opcode::NewVec, "NewVec"),
        b"NewKeysetArray" => {
            assemble_u32_carrying_opcode(token_iter, hhbc::Opcode::NewKeysetArray, "NewKeysetArray")
        }
        b"ConcatN" => assemble_u32_carrying_opcode(token_iter, hhbc::Opcode::ConcatN, "ConcatN"),
        ...
        | b"IsUnsetL"
        | b"UnsetG"
        | b"UnsetM" => assemble_set_instruct(alloc, token_iter, decl_map),
        b"CnsE" | b"ClsCns" | b"ClsCnsD" | b"ClsCnsL" => assemble_cns(alloc, token_iter, decl_map),
        ...
        b"SelfCls" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::SelfCls, "SelfCls"),
        b"ParentCls" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::ParentCls, "ParentCls")
        }
        b"LateBoundCls" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::LateBoundCls, "LateBoundCls")
        }
        ...
        b"This" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::This, "This"),
        b"CreateCont" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::CreateCont, "CreateCont")
        }
        b"Yield" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Yield, "Yield"),
        b"File" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::File, "File"),
        b"Incl" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Incl, "Incl"),
        b"AddElemC" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::AddElemC, "AddElemC")
        }
        b"ClassName" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::ClassName, "ClassName")
        }
        ...
        b"NewPair" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::NewPair, "NewPair"),
        b"Clone" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Clone, "Clone"),
        b"Idx" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Idx, "Idx"),
        b"YieldK" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::YieldK, "YieldK"),
        ...
        b"AKExists" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::AKExists, "AKExists")
        }
        b"Await" => assemble_single_opcode_instr(token_iter, || hhbc::Opcode::Await, "Await"),
        b"InclOnce" => {
        ...
        b"ArrayIdx" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::ArrayIdx, "ArrayIdx")
        }
        b"ChainFaults" => {
        ...
        b"AwaitAll" => assemble_await_all(token_iter),
        b"WHResult" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::WHResult, "WHResult")
        }
        b"AddNewElemC" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::AddNewElemC, "AddNewElemC")
        }
        ...
        b"FuncCred" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::FuncCred, "FuncCred")
        }
        b"MemoGetEager" => assemble_memo_get_eager(token_iter),
        b"MemoSetEager" => assemble_memo_set_eager(token_iter),
        ...
        b"GetClsRGProp" => {
            assemble_single_opcode_instr(token_iter, || hhbc::Opcode::GetClsRGProp, "GetClsRGProp")
        }
        ...
        tok => todo!("assembling instrs: {}", String::from_utf8_lossy(tok)),
    }
}
...
fn assemble_cns<'arena>(
    ...
    let op = match tok.into_identifier()? {
        ...
        _ => return Err(tok.error("Unknown cns opcode")),
    };
...
fn assemble_fatal_op(token_iter: &mut Lexer<'_>) -> Result<hhbc::FatalOp> {
    let tok = token_iter.expect_token()?;
    let fop = match tok.into_identifier()? {
        b"Runtime" => hhbc::FatalOp::Runtime,
        b"Parse" => hhbc::FatalOp::Parse,
        b"RuntimeOmitFrame" => hhbc::FatalOp::RuntimeOmitFrame,
...
fn assemble_incdecl_opcode<'arena>(
    ...
    if let Some(idx) = decl_map.get(lcl) {
        ...
        Err(tok.error("Unknown local var given to IncDecL instr"))
    }
}
...
fn assemble_resolve_class<'arena>(
    ...
    let op = match tok.into_identifier()? {
        ...
        _ => return Err(tok.error("Unknown resolve class opcode")),
    };
    Ok(hhbc::Instruct::Opcode(op))
}
...
fn assemble_local(token_iter: &mut Lexer<'_>, decl_map: &DeclMap<'_>) -> Result<hhbc::Local> {
    match token_iter.next() {
        ...
        None => Err(token_iter.error("Expected local")),
    }
}
