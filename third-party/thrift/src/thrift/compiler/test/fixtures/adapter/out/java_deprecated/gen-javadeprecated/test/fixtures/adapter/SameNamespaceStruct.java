...
public class SameNamespaceStruct implements TBase, java.io.Serializable, Cloneable, Comparable<SameNamespaceStruct> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(SameNamespaceStruct.class, metaDataMap);
  }
  ...
  public SameNamespaceStruct setData(long data) {
    this.data = data;
    setDataIsSet(true);
    return this;
  }
  ...
  @Override
  public int compareTo(SameNamespaceStruct other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("SameNamespaceStruct");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
