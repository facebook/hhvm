...
apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::semifuture_getDataByKey0(std::unique_ptr<::std::string> p_key) {
...
apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::future_getDataByKey0(std::unique_ptr<::std::string> p_key) {
...
apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::co_getDataByKey0(std::unique_ptr<::std::string> p_key) {
...
folly::coro::Task<std::unique_ptr<::std::string>> apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::co_getDataByKey0(
...
void apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::async_tm_getDataByKey0(
...
folly::SemiFuture<std::unique_ptr<::std::string>>
apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::semifuture_getDataByKey1(std::unique_ptr<::std::string> p_key) {
  auto expected{apache::thrift::detail::si::InvocationType::SemiFuture};
...
folly::Future<std::unique_ptr<::std::string>>
apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::future_getDataByKey1(std::unique_ptr<::std::string> p_key) {
  auto expected{apache::thrift::detail::si::InvocationType::Future};
  __fbthrift_invocation_getDataByKey1.compare_exchange_strong(
      expected,
      apache::thrift::detail::si::InvocationType::SemiFuture,
...
#if FOLLY_HAS_COROUTINES
folly::coro::Task<std::unique_ptr<::std::string>>
apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::co_getDataByKey1(std::unique_ptr<::std::string> p_key) {
  auto expected{apache::thrift::detail::si::InvocationType::Coro};
  __fbthrift_invocation_getDataByKey1.compare_exchange_strong(
      expected,
      apache::thrift::detail::si::InvocationType::Future,
...
folly::coro::Task<std::unique_ptr<::std::string>> apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::co_getDataByKey1(
    apache::thrift::RequestParams /* params */, std::unique_ptr<::std::string> p_key) {
  auto expected{apache::thrift::detail::si::InvocationType::CoroParam};
  __fbthrift_invocation_getDataByKey1.compare_exchange_strong(
      expected,
...
void apache::thrift::ServiceHandler<::test::fixtures::basic::DbMixedStackArguments>::async_tm_getDataByKey1(
    apache::thrift::HandlerCallbackPtr<std::unique_ptr<::std::string>> callback, std::unique_ptr<::std::string> p_key) {
  // It's possible the coroutine versions will delegate to a future-based
  // version. If that happens, we need the RequestParams arguments to be
  // available to the future through the thread-local backchannel, so we create
...
apache::thrift::ServiceRequestInfoMap DbMixedStackArgumentsServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"getDataByKey0",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::test::fixtures::basic::DbMixedStackArguments>("getDataByKey0")}},
  {"getDataByKey1",
    { false,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::test::fixtures::basic::DbMixedStackArguments>("getDataByKey1")}},
  };
