...
const ::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct& TestStruct::get_unqualified_struct_field() const& {
...
const ::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct* TestStruct::get_optional_struct_field() const& {
  return optional_struct_field_ref().has_value() ? std::addressof(__fbthrift_field_optional_struct_field) : nullptr;
}

::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct* TestStruct::get_optional_struct_field() & {
  return optional_struct_field_ref().has_value() ? std::addressof(__fbthrift_field_optional_struct_field) : nullptr;
}
