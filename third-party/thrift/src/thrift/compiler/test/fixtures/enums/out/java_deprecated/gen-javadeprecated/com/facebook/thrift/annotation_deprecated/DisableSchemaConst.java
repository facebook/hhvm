...
public class DisableSchemaConst implements TBase, java.io.Serializable, Cloneable, Comparable<DisableSchemaConst> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(DisableSchemaConst.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public DisableSchemaConst build() {
      DisableSchemaConst result = new DisableSchemaConst();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(DisableSchemaConst other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("DisableSchemaConst");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
