...
class Client<::py3::simple::SimpleService> : public apache::thrift::GeneratedAsyncClient {
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_get_five(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_five(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_get_five(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
 ...
 private:
  ...
  void fbthrift_send_get_five(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_add_five(apache::thrift::RpcOptions* rpcOptions, ::std::int32_t p_num) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_add_five(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_num);
    } else {
      fbthrift_serialize_and_send_add_five(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_num);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_add_five(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<void> co_do_nothing(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_do_nothing(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_do_nothing(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_do_nothing(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::string> co_concat(apache::thrift::RpcOptions* rpcOptions, const ::std::string& p_first, const ::std::string& p_second) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_concat(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_first, p_second);
    } else {
      fbthrift_serialize_and_send_concat(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_first, p_second);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_concat(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_get_value(apache::thrift::RpcOptions* rpcOptions, const ::py3::simple::SimpleStruct& p_simple_struct) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_value(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_simple_struct);
    } else {
      fbthrift_serialize_and_send_get_value(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_simple_struct);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_get_value(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<bool> co_negate(apache::thrift::RpcOptions* rpcOptions, bool p_input) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_negate(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    } else {
      fbthrift_serialize_and_send_negate(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_negate(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int8_t> co_tiny(apache::thrift::RpcOptions* rpcOptions, ::std::int8_t p_input) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_tiny(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    } else {
      fbthrift_serialize_and_send_tiny(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_tiny(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int16_t> co_small(apache::thrift::RpcOptions* rpcOptions, ::std::int16_t p_input) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_small(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    } else {
      fbthrift_serialize_and_send_small(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_small(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int64_t> co_big(apache::thrift::RpcOptions* rpcOptions, ::std::int64_t p_input) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_big(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    } else {
      fbthrift_serialize_and_send_big(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_big(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<double> co_two(apache::thrift::RpcOptions* rpcOptions, double p_input) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_two(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    } else {
      fbthrift_serialize_and_send_two(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_input);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_two(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<void> co_expected_exception(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_expected_exception(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_expected_exception(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_expected_exception(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_unexpected_exception(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_unexpected_exception(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_unexpected_exception(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_unexpected_exception(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_sum_i16_list(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::int16_t>& p_numbers) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_sum_i16_list(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    } else {
      fbthrift_serialize_and_send_sum_i16_list(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_sum_i16_list(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_sum_i32_list(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::int32_t>& p_numbers) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_sum_i32_list(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    } else {
      fbthrift_serialize_and_send_sum_i32_list(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_sum_i32_list(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_sum_i64_list(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::int64_t>& p_numbers) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_sum_i64_list(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    } else {
      fbthrift_serialize_and_send_sum_i64_list(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_sum_i64_list(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::string> co_concat_many(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::string>& p_words) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_concat_many(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words);
    } else {
      fbthrift_serialize_and_send_concat_many(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_concat_many(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_count_structs(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::py3::simple::SimpleStruct>& p_items) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_count_structs(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_items);
    } else {
      fbthrift_serialize_and_send_count_structs(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_items);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_count_structs(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_sum_set(apache::thrift::RpcOptions* rpcOptions, const ::std::set<::std::int32_t>& p_numbers) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_sum_set(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    } else {
      fbthrift_serialize_and_send_sum_set(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_numbers);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_sum_set(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<bool> co_contains_word(apache::thrift::RpcOptions* rpcOptions, const ::std::set<::std::string>& p_words, const ::std::string& p_word) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_contains_word(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words, p_word);
    } else {
      fbthrift_serialize_and_send_contains_word(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words, p_word);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_contains_word(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::string> co_get_map_value(apache::thrift::RpcOptions* rpcOptions, const ::std::map<::std::string, ::std::string>& p_words, const ::std::string& p_key) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_map_value(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words, p_key);
    } else {
      fbthrift_serialize_and_send_get_map_value(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words, p_key);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_get_map_value(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int16_t> co_map_length(apache::thrift::RpcOptions* rpcOptions, const ::std::map<::std::string, ::py3::simple::SimpleStruct>& p_items) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_map_length(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_items);
    } else {
      fbthrift_serialize_and_send_map_length(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_items);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_map_length(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int16_t> co_sum_map_values(apache::thrift::RpcOptions* rpcOptions, const ::std::map<::std::string, ::std::int16_t>& p_items) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_sum_map_values(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_items);
    } else {
      fbthrift_serialize_and_send_sum_map_values(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_items);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_sum_map_values(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_complex_sum_i32(apache::thrift::RpcOptions* rpcOptions, const ::py3::simple::ComplexStruct& p_counter) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_complex_sum_i32(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_counter);
    } else {
      fbthrift_serialize_and_send_complex_sum_i32(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_counter);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_complex_sum_i32(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::string> co_repeat_name(apache::thrift::RpcOptions* rpcOptions, const ::py3::simple::ComplexStruct& p_counter) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_repeat_name(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_counter);
    } else {
      fbthrift_serialize_and_send_repeat_name(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_counter);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_repeat_name(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::py3::simple::SimpleStruct> co_get_struct(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_struct(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_get_struct(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_get_struct(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::vector<::std::int32_t>> co_fib(apache::thrift::RpcOptions* rpcOptions, ::std::int16_t p_n) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_fib(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_n);
    } else {
      fbthrift_serialize_and_send_fib(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_n);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_fib(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::set<::std::string>> co_unique_words(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::string>& p_words) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_unique_words(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words);
    } else {
      fbthrift_serialize_and_send_unique_words(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_unique_words(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::map<::std::string, ::std::int16_t>> co_words_count(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::string>& p_words) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_words_count(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words);
    } else {
      fbthrift_serialize_and_send_words_count(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_words);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_words_count(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::py3::simple::AnEnum> co_set_enum(apache::thrift::RpcOptions* rpcOptions, ::py3::simple::AnEnum p_in_enum) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_set_enum(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_in_enum);
    } else {
      fbthrift_serialize_and_send_set_enum(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_in_enum);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_set_enum(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::vector<::std::vector<::std::int32_t>>> co_list_of_lists(apache::thrift::RpcOptions* rpcOptions, ::std::int16_t p_num_lists, ::std::int16_t p_num_items) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_list_of_lists(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_num_lists, p_num_items);
    } else {
      fbthrift_serialize_and_send_list_of_lists(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_num_lists, p_num_items);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_list_of_lists(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::map<::std::string, ::std::map<::std::string, ::std::int32_t>>> co_word_character_frequency(apache::thrift::RpcOptions* rpcOptions, const ::std::string& p_sentence) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_word_character_frequency(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_sentence);
    } else {
      fbthrift_serialize_and_send_word_character_frequency(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_sentence);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_word_character_frequency(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::vector<::std::set<::std::string>>> co_list_of_sets(apache::thrift::RpcOptions* rpcOptions, const ::std::string& p_some_words) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_list_of_sets(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_some_words);
    } else {
      fbthrift_serialize_and_send_list_of_sets(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_some_words);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_list_of_sets(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_nested_map_argument(apache::thrift::RpcOptions* rpcOptions, const ::std::map<::std::string, ::std::vector<::py3::simple::SimpleStruct>>& p_struct_map) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_nested_map_argument(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_struct_map);
    } else {
      fbthrift_serialize_and_send_nested_map_argument(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_struct_map);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_nested_map_argument(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::string> co_make_sentence(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::vector<::std::string>>& p_word_chars) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_make_sentence(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_word_chars);
    } else {
      fbthrift_serialize_and_send_make_sentence(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_word_chars);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_make_sentence(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::set<::std::int32_t>> co_get_union(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::set<::std::int32_t>>& p_sets) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_union(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_sets);
    } else {
      fbthrift_serialize_and_send_get_union(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_sets);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_get_union(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::set<::std::string>> co_get_keys(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::map<::std::string, ::std::string>>& p_string_map) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_keys(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_string_map);
    } else {
      fbthrift_serialize_and_send_get_keys(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_string_map);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_get_keys(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<double> co_lookup_double(apache::thrift::RpcOptions* rpcOptions, ::std::int32_t p_key) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_lookup_double(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_key);
    } else {
      fbthrift_serialize_and_send_lookup_double(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_key);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_lookup_double(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::string> co_retrieve_binary(apache::thrift::RpcOptions* rpcOptions, const ::std::string& p_something) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_retrieve_binary(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_something);
    } else {
      fbthrift_serialize_and_send_retrieve_binary(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_something);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_retrieve_binary(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::set<::std::string>> co_contain_binary(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::std::string>& p_binaries) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_contain_binary(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_binaries);
    } else {
      fbthrift_serialize_and_send_contain_binary(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_binaries);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_contain_binary(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::std::vector<::py3::simple::AnEnum>> co_contain_enum(apache::thrift::RpcOptions* rpcOptions, const ::std::vector<::py3::simple::AnEnum>& p_the_enum) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_contain_enum(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_the_enum);
    } else {
      fbthrift_serialize_and_send_contain_enum(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_the_enum);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_contain_enum(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::py3::simple::BinaryUnionStruct> co_get_binary_union_struct(apache::thrift::RpcOptions* rpcOptions, const ::py3::simple::BinaryUnion& p_u) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_binary_union_struct(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_u);
    } else {
      fbthrift_serialize_and_send_get_binary_union_struct(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_u);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_get_binary_union_struct(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
 ...
 private:
  ...
  folly::coro::Task<::py3::simple::SimpleStruct> co_get_struct_hidden(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      fbthrift_serialize_and_send_get_struct_hidden(*rpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    } else {
      fbthrift_serialize_and_send_get_struct_hidden(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  ...
  template <typename RpcOptions>
  void fbthrift_send_get_struct_hidden(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback);
