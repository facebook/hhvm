...
function test_preg_replace() :mixed{
  ...
  VS(preg_replace("/xxx", "w", varray["xxxx"]), dict[]);
  VS(preg_replace("/xxx/", "w", varray["xxxx"]), dict(varray["wx"]));
  VS(preg_replace("/xxx/", "w", varray["xxxx", "yyyy"]), dict(varray["wx", "yyyy"]));
  VS(preg_replace(varray["/xxx/", "/xxx"], "w", varray["xxxx"]), dict[]);
  VS(preg_replace(varray["/xxx/", "/xxx/"], "w", varray["xxxx"]), dict(varray["wx"]));

  VS(preg_replace("/xxx", varray["w"], varray["xxxx"]), false);
  VS(preg_replace(varray["/xxx"], varray["w"], varray["xxxx"]), dict[]);
  VS(preg_replace(varray["/xxx/"], varray["w"], varray["xxxx"]), dict(varray["wx"]));
}
