...
public:
    ...
    SBE_NODISCARD static const char *errorKindMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
    ...
    static SBE_CONSTEXPR std::uint16_t errorKindId() SBE_NOEXCEPT
    {
        return -1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t errorKindSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool errorKindInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t errorKindEncodingOffset() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t errorKindEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }
    ...
    SBE_NODISCARD static const char *errorBlameMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t errorBlameId() SBE_NOEXCEPT
    {
        return -1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t errorBlameSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool errorBlameInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t errorBlameEncodingOffset() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t errorBlameEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }
    ...
    SBE_NODISCARD static const char *errorSafetyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t errorSafetyId() SBE_NOEXCEPT
    {
        return -1;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t errorSafetySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool errorSafetyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t errorSafetyEncodingOffset() SBE_NOEXCEPT
    {
        return 2;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t errorSafetyEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }
    ...
    ErrorClassification &errorSafety(const ErrorSafety::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
