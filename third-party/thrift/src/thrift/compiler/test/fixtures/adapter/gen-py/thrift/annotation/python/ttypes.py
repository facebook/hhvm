...
__all__ = ['UTF8STRINGS', 'Hidden', 'Flags', 'Name', 'IOBuf', 'Adapter', 'MarshalCapi']
...
class Hidden:
  ...
  def _to_python(self):
    ...
    return thrift.python.converter.to_python_struct(python_types.Hidden, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.python.types")
    return thrift.py3.converter.to_py3_struct(py3_types.Hidden, self)
...
class IOBuf:
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.python.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.IOBuf, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.python.types")
    return thrift.py3.converter.to_py3_struct(py3_types.IOBuf, self)
...
all_structs.append(Hidden)
Hidden.thrift_spec = (
)

Hidden.thrift_struct_annotations = {
}
Hidden.thrift_field_annotations = {
}
...
all_structs.append(IOBuf)
IOBuf.thrift_spec = (
)

IOBuf.thrift_struct_annotations = {
}
IOBuf.thrift_field_annotations = {
}
