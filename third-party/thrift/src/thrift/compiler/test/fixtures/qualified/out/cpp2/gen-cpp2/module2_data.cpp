...
::folly::Range<const ::std::string_view*>(*TSchemaAssociation<::module2::Struct>::bundle)() =
    nullptr;

::folly::Range<const ::std::string_view*>(*TSchemaAssociation<::module2::BigStruct>::bundle)() =
    nullptr;
