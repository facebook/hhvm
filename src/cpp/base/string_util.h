...
#include <lib/system/gen/php/globals/constants.fw.h>
...
public:
   ...
   * Split/joins.
   */
  static Array  Explode(CStrRef input, CStrRef delimiter,
                        int limit = 0x7FFFFFFF);
  static String Implode(CArrRef items, CStrRef delim); // == Join()
  static Array  Split(CStrRef str, int split_length = 1);
  static String ChunkSplit(CStrRef body, int chunklen = 76,
