...
class ReserveIds:
  ...
  def write(self, oprot):
    ...
    if self.id_ranges != None:
      ...
      sorted19 = self.id_ranges.items()
      sorted19 = sorted(sorted19, key=lambda tuple20: tuple20[0])
      for kiter17,viter18 in sorted19:
...
class DeprecatedUnvalidatedAnnotations:
  ...
  def write(self, oprot):
    ...
    if self.items != None:
      ...
      sorted32 = self.items.items()
      sorted32 = sorted(sorted32, key=lambda tuple33: tuple33[0])
      for kiter30,viter31 in sorted32:
        oprot.writeString(kiter30.encode('utf-8')) if UTF8STRINGS and not isinstance(kiter30, bytes) else oprot.writeString(kiter30)
        oprot.writeString(viter31.encode('utf-8')) if UTF8STRINGS and not isinstance(viter31, bytes) else oprot.writeString(viter31)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
