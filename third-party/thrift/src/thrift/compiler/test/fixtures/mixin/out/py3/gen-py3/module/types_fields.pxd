...
ctypedef void (*__Mixin1_FieldsSetterFunc)(__Mixin1_FieldsSetter, object) except *

cdef class __Mixin1_FieldsSetter(__StructFieldsSetter):
    cdef _module_cbindings.cMixin1* _struct_cpp_obj
...
ctypedef void (*__Mixin2_FieldsSetterFunc)(__Mixin2_FieldsSetter, object) except *

cdef class __Mixin2_FieldsSetter(__StructFieldsSetter):
    cdef _module_cbindings.cMixin2* _struct_cpp_obj
...
ctypedef void (*__Mixin3Base_FieldsSetterFunc)(__Mixin3Base_FieldsSetter, object) except *

cdef class __Mixin3Base_FieldsSetter(__StructFieldsSetter):
    cdef _module_cbindings.cMixin3Base* _struct_cpp_obj
