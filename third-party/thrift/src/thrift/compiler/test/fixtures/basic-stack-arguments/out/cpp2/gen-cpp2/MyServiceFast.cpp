...
apache::thrift::ServiceRequestInfoMap MyServiceFastServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"hasDataById",
    { true,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::MyServiceFast>("hasDataById")}},
  {"getDataById",
    { true,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::MyServiceFast>("getDataById")}},
  {"putDataById",
    { true,
     apache::thrift::RpcKind::SINGLE_REQUEST_SINGLE_RESPONSE,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::MyServiceFast>("putDataById")}},
  {"lobDataById",
    { true,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::MyServiceFast>("lobDataById")}},
  };
