...
ctypedef void (*__Limits_FieldsSetterFunc)(__Limits_FieldsSetter, object) except *

cdef class __Limits_FieldsSetter(__StructFieldsSetter):
    cdef _module_cbindings.cLimits* _struct_cpp_obj
    cdef cumap[__cstring_view, __Limits_FieldsSetterFunc] _setters
