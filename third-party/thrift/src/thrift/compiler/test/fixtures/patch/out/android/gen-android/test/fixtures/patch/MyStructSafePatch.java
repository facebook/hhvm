...
public class MyStructSafePatch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public MyStructSafePatch(MyStructSafePatch other) {
  ...
  public MyStructSafePatch deepCopy() {
    return new MyStructSafePatch(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof MyStructSafePatch))
      return false;
    MyStructSafePatch that = (MyStructSafePatch)_that;
  ...
  public static MyStructSafePatch deserialize(TProtocol iprot) throws TException {
    ...
    MyStructSafePatch _that;
    _that = new MyStructSafePatch(
      tmp_version
      ,tmp_data
    );
    _that.validate();
