...
public class MyStructField31Patch1 implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyStructField31Patch1 deserialize(TProtocol iprot) throws TException {
    ...
    MyStructField31Patch1 _that;
    _that = new MyStructField31Patch1(
      tmp_assign
      ,tmp_clear
      ,tmp_patchPrior
      ,tmp_add
