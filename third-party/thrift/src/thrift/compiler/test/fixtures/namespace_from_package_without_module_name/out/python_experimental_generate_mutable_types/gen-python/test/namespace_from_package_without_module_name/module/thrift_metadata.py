...
import test.namespace_from_package_without_module_name.module.thrift_enums as _fbthrift_current_module_enums
import test.namespace_from_package_without_module_name.module.thrift_enums
...
def _fbthrift_gen_metadata_service_TestService(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    qualified_name = "module.TestService"
...
def _fbthrift_metadata_service_response_TestService() -> _fbthrift_metadata.ThriftServiceMetadataResponse:
    ...
    context = _fbthrift_metadata.ThriftServiceContext(service_info=metadata.services["module.TestService"], module=_fbthrift_metadata.ThriftModuleContext(name="module"))
