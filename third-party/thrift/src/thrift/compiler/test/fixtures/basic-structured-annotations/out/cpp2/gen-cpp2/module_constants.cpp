...
::std::string_view _fbthrift_schema_ad72e69e5d39d595() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_ad72e69e5d39d595_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_ad72e69e5d39d595_uris() {
  return {};
}
