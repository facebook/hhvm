...
module WithOp (Op : Op_S) = struct
  ...
  let make_end_of_file arg0 state =
    if Op.is_zero arg0 then
      (state, Op.zero)
    else
      (state, Op.flatten [arg0])
  ...
  let make_prefixed_string_expression arg0 arg1 state =
    if Op.is_zero arg0 && Op.is_zero arg1 then
      (state, Op.zero)
    else
      (state, Op.flatten [arg0; arg1])
  ...
  let make_file_attribute_specification arg0 arg1 arg2 arg3 arg4 state =
    if
      Op.is_zero arg0
      && Op.is_zero arg1
      && Op.is_zero arg2
    ...
    then
      ...
      (state, Op.flatten [arg0; arg1; arg2; arg3; arg4])
  ...
  let make_enum_declaration arg0 arg1 arg2 arg3 arg4 arg5 arg6 arg7 arg8 state
    ...
    then
      ...
      (state, Op.flatten [arg0; arg1; arg2; arg3; arg4; arg5; arg6; arg7; arg8])

  let make_enumerator arg0 arg1 arg2 arg3 state =
    if Op.is_zero arg0 && Op.is_zero arg1 && Op.is_zero arg2 && Op.is_zero arg3
    then
      (state, Op.zero)
    else
  ...
  let make_record_declaration
      arg0 arg1 arg2 arg3 arg4 arg5 arg6 arg7 arg8 state =
    if
      Op.is_zero arg0
      && Op.is_zero arg1
      && Op.is_zero arg2
  ...
  let make_alias_declaration arg0 arg1 arg2 arg3 arg4 arg5 arg6 arg7 state =
    ...
    then
      ...
      (state, Op.flatten [arg0; arg1; arg2; arg3; arg4; arg5; arg6; arg7])
  ...
  let make_namespace_group_use_declaration
      arg0 arg1 arg2 arg3 arg4 arg5 arg6 state =
    if
      Op.is_zero arg0
      && Op.is_zero arg1
      && Op.is_zero arg2
    ...
    then
      ...
      (state, Op.flatten [arg0; arg1; arg2; arg3; arg4; arg5; arg6])
  ...
  let make_function_declaration_header
      arg0 arg1 arg2 arg3 arg4 arg5 arg6 arg7 arg8 arg9 state =
    if
      Op.is_zero arg0
      && Op.is_zero arg1
      && Op.is_zero arg2
    ...
    then
      ...
      ( state,
        Op.flatten [arg0; arg1; arg2; arg3; arg4; arg5; arg6; arg7; arg8; arg9]
      )
  ...
  let make_classish_declaration
      arg0 arg1 arg2 arg3 arg4 arg5 arg6 arg7 arg8 arg9 arg10 state =
    if
      Op.is_zero arg0
      && Op.is_zero arg1
      && Op.is_zero arg2
  ...
  let make_parameter_declaration arg0 arg1 arg2 arg3 arg4 arg5 state =
    ...
    then
      ...
      (state, Op.flatten [arg0; arg1; arg2; arg3; arg4; arg5])
  ...
  let make_anonymous_function
      arg0 arg1 arg2 arg3 arg4 arg5 arg6 arg7 arg8 arg9 arg10 arg11 state =
    if
      Op.is_zero arg0
      && Op.is_zero arg1
      && Op.is_zero arg2
  ...
  let make_type_parameter arg0 arg1 arg2 arg3 arg4 state =
    if
      Op.is_zero arg0
      && Op.is_zero arg1
      && Op.is_zero arg2
  ...
  let make_pocket_field_type_expr_declaration arg0 arg1 arg2 arg3 state =
    if Op.is_zero arg0 && Op.is_zero arg1 && Op.is_zero arg2 && Op.is_zero arg3
    then
      (state, Op.zero)
    else
  ...
  let make_pocket_field_type_declaration arg0 arg1 arg2 arg3 state =
    if Op.is_zero arg0 && Op.is_zero arg1 && Op.is_zero arg2 && Op.is_zero arg3
    then
      (state, Op.zero)
    else
  ...
  let make_pocket_mapping_id_declaration arg0 arg1 state =
    if Op.is_zero arg0 && Op.is_zero arg1 then
      (state, Op.zero)
    else
      (state, Op.flatten [arg0; arg1])

  let make_pocket_mapping_type_declaration arg0 arg1 arg2 arg3 state =
    if Op.is_zero arg0 && Op.is_zero arg1 && Op.is_zero arg2 && Op.is_zero arg3
    then
      (state, Op.zero)
    else
