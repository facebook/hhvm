...
folly::SemiFuture<std::unique_ptr<::test::fixtures::basic::ReservedKeyword>>
apache::thrift::ServiceHandler<::test::fixtures::basic::FB303Service>::semifuture_simple_rpc(::std::int32_t p_int_parameter) {
...
folly::Future<std::unique_ptr<::test::fixtures::basic::ReservedKeyword>>
apache::thrift::ServiceHandler<::test::fixtures::basic::FB303Service>::future_simple_rpc(::std::int32_t p_int_parameter) {
...
folly::coro::Task<std::unique_ptr<::test::fixtures::basic::ReservedKeyword>>
apache::thrift::ServiceHandler<::test::fixtures::basic::FB303Service>::co_simple_rpc(::std::int32_t p_int_parameter) {
...
folly::coro::Task<std::unique_ptr<::test::fixtures::basic::ReservedKeyword>> apache::thrift::ServiceHandler<::test::fixtures::basic::FB303Service>::co_simple_rpc(
...
void apache::thrift::ServiceHandler<::test::fixtures::basic::FB303Service>::async_tm_simple_rpc(
    apache::thrift::HandlerCallbackPtr<std::unique_ptr<::test::fixtures::basic::ReservedKeyword>> callback, ::std::int32_t p_int_parameter) {
...
apache::thrift::ServiceRequestInfoMap FB303ServiceServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"simple_rpc",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::test::fixtures::basic::FB303Service>("simple_rpc")}},
  };
