...
class type ['a] type_visitor_type =
  object
    ...
    method on_tshape :
      'a -> Reason.t -> shape_kind -> 'b shape_field_type Nast.ShapeMap.t -> 'a
...
class virtual ['a] type_visitor : ['a] type_visitor_type =
  object (this)
    ...
    method on_tshape : type a.
        _ -> Reason.t -> shape_kind -> a shape_field_type Nast.ShapeMap.t -> _
        =
      fun acc _ _ fdm ->
    ...
    method on_type : type a. _ -> a ty -> _ =
      fun acc (r, x) ->
        match x with
