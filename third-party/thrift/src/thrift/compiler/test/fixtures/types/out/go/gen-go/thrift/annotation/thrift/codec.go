...
var (
    premadeStructSpec_Experimental =
        &thrift.StructSpec{
            Name:                 "Experimental",
            ScopedName:           "thrift.Experimental",
            IsUnion:              false,
    ...
    premadeStructSpec_RequiresBackwardCompatibility =
        &thrift.StructSpec{
    ...
    premadeStructSpec_SerializeInFieldIdOrder =
        &thrift.StructSpec{
    ...
    premadeStructSpec_ExceptionMessage =
        &thrift.StructSpec{
    ...
    premadeStructSpec_DeprecatedUnvalidatedAnnotations =
        &thrift.StructSpec{
    ...
    premadeStructSpec_AllowReservedIdentifier =
        &thrift.StructSpec{
    ...
    premadeStructSpec_AllowReservedFilename =
        &thrift.StructSpec{
