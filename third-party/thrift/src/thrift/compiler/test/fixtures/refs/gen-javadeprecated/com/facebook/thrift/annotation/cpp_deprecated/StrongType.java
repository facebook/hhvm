...
public class StrongType implements TBase, java.io.Serializable, Cloneable, Comparable<StrongType> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(StrongType.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public StrongType build() {
      StrongType result = new StrongType();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(StrongType other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("StrongType");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
