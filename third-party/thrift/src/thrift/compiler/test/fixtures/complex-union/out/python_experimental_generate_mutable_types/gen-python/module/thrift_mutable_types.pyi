...
class ComplexUnion(_fbthrift_python_mutable_types.MutableUnion, _fbthrift_compatible_with_ComplexUnion):
    ...
    @property
    def intListValue(self) -> _typing.MutableSequence[int]: ...
    @intListValue.setter
    def intListValue(self, value: _typing.MutableSequence[int]): ...


    @property
    def stringListValue(self) -> _typing.MutableSequence[str]: ...
    @stringListValue.setter
    def stringListValue(self, value: _typing.MutableSequence[str]): ...
