...
var (
    ...
    premadeThriftType_emptyns_Foo *metadata.ThriftType = nil
)
...
var premadeThriftTypesInitOnce = sync.OnceFunc(func() {
    ...
    premadeThriftType_emptyns_Foo = metadata.NewThriftType().SetTStruct(
...
var premadeThriftTypesMapOnce = sync.OnceValue(
    func() map[string]*metadata.ThriftType {
        ...
        thriftTypesWithFullName = append(thriftTypesWithFullName, thriftTypeWithFullName{ "emptyns.Foo", premadeThriftType_emptyns_Foo })
