          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.mapMap = new HashMap<String,Map<String,Integer>>(Math.max(0, 2*_map37.size));
              for (int _i38 = 0; 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.listMap = new ArrayList<Map<String,Integer>>(Math.max(0, _list45.size));
              for (int _i46 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.optMapVal = new HashMap<String,String>(Math.max(0, 2*_map52.size));
              for (int _i53 = 0; 
                   ...
                   ++_i53)
              {
                ...
                this.optMapVal.put(_key54, _val55);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.optSetVal = new HashSet<String>(Math.max(0, 2*_set56.size));
              for (int _i57 = 0; 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.optListVal = new ArrayList<Short>(Math.max(0, _list59.size));
              for (int _i60 = 0; 
