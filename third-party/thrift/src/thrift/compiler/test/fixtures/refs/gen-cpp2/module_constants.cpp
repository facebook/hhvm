...
::cpp2::StructWithRef const& module_constants::kStructWithRef() {
  static folly::Indestructible<::cpp2::StructWithRef> const instance{::apache::thrift::detail::make_structured_constant<::cpp2::StructWithRef>(::apache::thrift::detail::wrap_struct_argument<::apache::thrift::ident::def_field>(static_cast<::cpp2::Empty>(::apache::thrift::detail::make_structured_constant<::cpp2::Empty>())), ::apache::thrift::detail::wrap_struct_argument<::apache::thrift::ident::opt_field>(static_cast<::cpp2::Empty>(::apache::thrift::detail::make_structured_constant<::cpp2::Empty>())), ::apache::thrift::detail::wrap_struct_argument<::apache::thrift::ident::req_field>(static_cast<::cpp2::Empty>(::apache::thrift::detail::make_structured_constant<::cpp2::Empty>())))};
  return *instance;
}
