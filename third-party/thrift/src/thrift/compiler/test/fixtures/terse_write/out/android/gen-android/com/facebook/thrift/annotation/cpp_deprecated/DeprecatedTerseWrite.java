...
public class DeprecatedTerseWrite implements TBase, java.io.Serializable, Cloneable {
  ...
  public static DeprecatedTerseWrite deserialize(TProtocol iprot) throws TException {
    TField __field;
    ...
    DeprecatedTerseWrite _that;
    _that = new DeprecatedTerseWrite(
    );
    _that.validate();
    return _that;
  }
