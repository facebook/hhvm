...
public class MyStructNestedAnnotation implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyStructNestedAnnotation deserialize(TProtocol iprot) throws TException {
    ...
    MyStructNestedAnnotation _that;
    _that = new MyStructNestedAnnotation(
      tmp_name
    );
    _that.validate();
    return _that;
