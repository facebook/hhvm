...
::folly::Range<const ::std::string_view*> TSchemaAssociation<::extra::svc::containerStruct2, false>::bundle() {
    return ::extra::svc::extra_services_constants::_fbthrift_schema_2dacd8c4e3df59ee_includes();
}
