...
void thrift_transcode_write_fixed32_le(TranscodeCursor* cursor, uint32_t value);

// Write a little-endian 64-bit fixed-width value used by Protobuf.
void thrift_transcode_write_fixed64_le(TranscodeCursor* cursor, uint64_t value);
...
void thrift_transcode_write_fixed16_be(TranscodeCursor* cursor, uint16_t value);

// Write a big-endian 32-bit fixed-width value used by Binary and Compact.
void thrift_transcode_write_fixed32_be(TranscodeCursor* cursor, uint32_t value);

// Write a big-endian 64-bit fixed-width value used by Binary and Compact.
void thrift_transcode_write_fixed64_be(TranscodeCursor* cursor, uint64_t value);
