...
#ifndef __TEST_EXT_SPL_H__
#define __TEST_EXT_SPL_H__
...
class TestExtSpl : public TestCppExt {
 public:
  virtual bool RunTests(const std::string &which);

  bool test_spl_classes();
  bool test_spl_object_hash();
  bool test_class_implements();
  bool test_class_parents();
