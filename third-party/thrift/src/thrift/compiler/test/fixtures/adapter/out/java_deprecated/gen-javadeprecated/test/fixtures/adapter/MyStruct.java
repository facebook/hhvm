          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.set_string = new HashSet<String>(Math.max(0, 2*_set83.size));
              for (int _i84 = 0; 
                   (_set83.size < 0) ? iprot.peekSet() : (_i84 < _set83.size); 
                   ++_i84)
              {
                String _elem85;
                _elem85 = iprot.readString();
                this.set_string.add(_elem85);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.set_string != null) {
      oprot.writeFieldBegin(SET_STRING_FIELD_DESC);
      {
        ...
        for (String _iter86 : this.set_string)        {
