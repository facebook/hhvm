...
var (
    ...
    premadeThriftType_hsmodule_HsFoo = func() *metadata.ThriftType {
        return &metadata.ThriftType{
...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    fbthriftThriftTypesMap["hsmodule.HsFoo"] = premadeThriftType_hsmodule_HsFoo
    return fbthriftThriftTypesMap
}()

var structMetadatas = func() []*metadata.ThriftStruct {
    fbthriftResults := make([]*metadata.ThriftStruct, 0)
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_HsFoo))
