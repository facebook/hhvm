...
::std::string_view _fbthrift_schema_f047d2fb0cb3f2fe() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_f047d2fb0cb3f2fe_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_f047d2fb0cb3f2fe_uris() {
  return {};
}
