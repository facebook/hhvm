...
class StructWithNonOptionalBox(thrift.py3.types.Struct, _typing.Hashable):
    class __fbthrift_IsSet:
        a: bool
        b: bool
        c: bool
    ...
    b: Final[_typing.Sequence[int]] = ...

    c: Final[StructWithRef] = ...
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['StructWithNonOptionalBox'], bytes]]: ...
    def __hash__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __lt__(self, other: 'StructWithNonOptionalBox') -> bool: ...
    def __gt__(self, other: 'StructWithNonOptionalBox') -> bool: ...
    def __le__(self, other: 'StructWithNonOptionalBox') -> bool: ...
    def __ge__(self, other: 'StructWithNonOptionalBox') -> bool: ...

    def _to_python(self) -> "module.thrift_types.StructWithNonOptionalBox": ...   # type: ignore
    def _to_py3(self) -> StructWithNonOptionalBox: ...
    def _to_py_deprecated(self) -> "module.ttypes.StructWithNonOptionalBox": ...   # type: ignore
