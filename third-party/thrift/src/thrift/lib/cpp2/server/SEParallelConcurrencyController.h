...
/**
 * ParallelConcurrencyController that uses a folly::SerialExecutor to
 * schedule tasks.
 */
class SEParallelConcurrencyController
    : public ParallelConcurrencyControllerBase {
 public:
  explicit SEParallelConcurrencyController(
