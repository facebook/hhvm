...
cdef class Foo(thrift.py3.types.Struct):
    def __init__(Foo self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_structs_cbindings.cFoo]()
    ...
    def __call__(Foo self, **kwargs):
        ...
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_structs_cbindings.cFoo](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    cdef object _fbthrift_isset(self):
        return _fbthrift_IsSet("Foo", {
          "value": deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE).value_ref().has_value(),
        })

    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module_structs_cbindings.cFoo] cpp_obj):
    ...
    def __copy__(Foo self):
        cdef shared_ptr[_module_structs_cbindings.cFoo] cpp_obj = make_shared[_module_structs_cbindings.cFoo](
    ...
    def __richcmp__(self, other, int op):
        ...
        return __richcmp[_module_structs_cbindings.cFoo](
    ...
    def __get_metadata__():
        ...
        _module_structs_cbindings.StructMetadata[_module_structs_cbindings.cFoo].gen(meta)
    ...
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module_structs_cbindings.cFoo](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(Foo self, __Protocol proto):
        ...
        with nogil:
            data = cmove(serializer.cserialize[_module_structs_cbindings.cFoo](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
    ...
    cdef cuint32_t _fbthrift_deserialize(Foo self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module_structs_cbindings.cFoo]()
        with nogil:
            needed = serializer.cdeserialize[_module_structs_cbindings.cFoo](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
