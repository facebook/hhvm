...
final class Pair<+Tv1, +Tv2> implements ConstVector<mixed> {
 ...
 /**
   ...
   *
   * That said, Pairs only have two elements. So the performance impact on
   ...
   *
   * @return - an ImmVector containing the integer keys of the current Pair as
   *           values.
   */
  ...
  /**
   * Returns a ImmVector containing the values of the current Pair that meet a
   * supplied condition.
   *
  ...
  /**
   * Returns an ImmVector containing the values of the current Pair that meet a
   * supplied condition applied to its keys and values.
   *
   ...
   *
   *  If the number of elements of the current Pair are not equal to the number
   ...
   *                        of the current Pair.
   *
   *  @return - The ImmVector that combines the values of the current Pair with
   ...
   *
   * n is 1-based. So the first element is 1, the second 2. There is no element
   * 3 in a Pair, but if you specify an element greater than 2, it will just
   * return all elements in the Pair.
   *
  ...
  /**
   * Returns an ImmVector containing the values of the current Pair up to but
   ...
   * element 3 in a Pair, but if you specify an element greater than or equal to
   * 2, it will just return empty. If you specify 0, it will return all the
  ...
  /**
   * Returns a subset of the current Pair starting from a given key up to, but
   ...
   *
   * @param $start - The starting key of the current Pair to begin the returned
   *                 ImmVector.
