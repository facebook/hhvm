...
public:
  ...
  void moduleInit() override {
    ...
    REGISTER_CONSTANT_VALUE(CASE_LOWER, 0);
    REGISTER_CONSTANT_VALUE(CASE_UPPER, 1);
    REGISTER_CONSTANT_VALUE(COUNT_NORMAL, 0);
    REGISTER_CONSTANT_VALUE(COUNT_RECURSIVE, 1);
    REGISTER_CONSTANT_VALUE(FILTER_USE_BOTH, 1);
    REGISTER_CONSTANT_VALUE(FILTER_USE_KEY,  2);
    REGISTER_CONSTANT_VALUE(SORT_ASC, 4);
    REGISTER_CONSTANT_VALUE(SORT_DESC, 3);
    REGISTER_CONSTANT_VALUE(SORT_FLAG_CASE, 8);
    REGISTER_CONSTANT_VALUE(SORT_LOCALE_STRING, 5);
    REGISTER_CONSTANT_VALUE(SORT_NATURAL, 6);
    REGISTER_CONSTANT_VALUE(SORT_NUMERIC, 1);
    REGISTER_CONSTANT_VALUE(SORT_REGULAR, 0);
    REGISTER_CONSTANT_VALUE(SORT_STRING, 2);
