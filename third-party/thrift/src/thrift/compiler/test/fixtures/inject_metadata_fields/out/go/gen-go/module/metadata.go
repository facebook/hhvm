...
var structMetadatas = func() []*metadata.ThriftStruct {
    ...
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_FieldsInjectedToEmptyStruct))
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_FieldsInjectedToStruct))
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_FieldsInjectedWithIncludedStruct))
