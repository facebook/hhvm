...
class MyStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_MyStruct, _fbthrift_python_abstract_types.MyStruct):
    ...
    def __init__(
        self, *,
        a: _typing.Optional[typeshed_one.AdapterOneType[_fbthrift__b__thrift_mutable_types.B]]=...,
        b: _typing.Optional[typeshed_three.AdapterThreeType[_fbthrift__c__thrift_mutable_types.C1]]=...,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[typeshed_one.AdapterOneType[_fbthrift__b__thrift_mutable_types.B], typeshed_three.AdapterThreeType[_fbthrift__c__thrift_mutable_types.C1], typeshed_two.AdapterTwoType[_fbthrift__c__thrift_mutable_types.C2]]]]: ...
...
class _fbthrift_MyService_adapted_return_result(_fbthrift_python_mutable_types.MutableStruct):
    success: _typing.Final[typeshed_one.AdapterOneType[_fbthrift__b__thrift_mutable_types.B]]

    def __init__(
        self, *, success: _typing.Optional[typeshed_one.AdapterOneType[_fbthrift__b__thrift_mutable_types.B]] = ...
    ) -> None: ...
