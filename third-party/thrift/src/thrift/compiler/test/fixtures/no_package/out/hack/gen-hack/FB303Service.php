...
interface FB303ServiceAsyncIf extends \IThriftAsyncIf {
   ...
   */
  public function renamed_rpc(int $renamed_parameter): Awaitable<MyRenamedStruct>;
}
...
internal trait FB303ServiceClientBase {
   ...
   *   renamed_rpc(1: i32 int_parameter);
   */
  public async function renamed_rpc(int $renamed_parameter): Awaitable<MyRenamedStruct> {
...
abstract class FB303ServiceAsyncProcessorBase extends \ThriftAsyncProcessor {
  ...
  protected async function process_renamed_rpc(int $seqid, \TProtocol $input, \TProtocol $output): Awaitable<void> {
    ...
    try {
      ...
      $this->eventHandler_->preExec($handler_ctx, 'FB303Service', 'renamed_rpc', $args);
...
class FB303Service_renamed_rpc_result extends \ThriftSyncStructWithResult implements \IThriftStructMetadata {
  ...
  const type TResult = MyRenamedStruct;

  const \ThriftStructTypes::TSpec SPEC = dict[
    0 => shape(
      'var' => 'success',
      'type' => \TType::STRUCT,
      'class' => MyRenamedStruct::class,
    ),
  ];
  const dict<string, int> FIELDMAP = dict[
    'success' => 0,
  ...
  public function readFromJson(string $jsonText): void {
    ...
    if (idx($parsed, 'success') !== null) {
      $_tmp0 = \fb_json_encode_force_php_arrays(HH\FIXME\UNSAFE_CAST<mixed, MyRenamedStruct>($parsed['success']));
      $_tmp1 = MyRenamedStruct::withDefaultValues();
      ...
      shape(
        ...
        'metadata' => \tmeta_ThriftMetadata::fromShape(
          shape(
            ...
            'structs' => dict[
              'module.ReservedKeyword' => MyRenamedStruct::getStructMetadata(),
            ],
            'exceptions' => dict[
            ],
            'services' => dict[
