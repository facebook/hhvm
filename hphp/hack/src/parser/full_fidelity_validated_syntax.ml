...
module Make(Token : TokenType)(SyntaxValue : SyntaxValueType) = struct
  ...
  | { Syntax.syntax = Syntax.EnumDeclaration x; value = v } -> v,
    ...
    ; enum_includes_list = validate_list_with (validate_specifier) x.enum_includes_list
    ; enum_includes_keyword = validate_option_with (validate_token) x.enum_includes_keyword
  ...
  and invalidate_enum_declaration : enum_declaration invalidator = fun (v, x) ->
    { Syntax.syntax =
      ...
      ; enum_includes_keyword = invalidate_option_with (invalidate_token) x.enum_includes_keyword
      ; enum_includes_list = invalidate_list_with (invalidate_specifier) x.enum_includes_list
  ...
  | { Syntax.syntax = Syntax.EnumClassDeclaration x; value = v } -> v,
    ...
    ; enum_class_extends_list = validate_list_with (validate_specifier) x.enum_class_extends_list
    ; enum_class_extends = validate_option_with (validate_token) x.enum_class_extends
  ...
  and invalidate_enum_class_declaration : enum_class_declaration invalidator = fun (v, x) ->
    { Syntax.syntax =
      ...
      ; enum_class_extends = invalidate_option_with (invalidate_token) x.enum_class_extends
      ; enum_class_extends_list = invalidate_list_with (invalidate_specifier) x.enum_class_extends_list
  ...
  | { Syntax.syntax = Syntax.AnonymousFunction x; value = v } -> v,
    ...
    ; anonymous_ctx_list = validate_option_with (validate_capability) x.anonymous_ctx_list
  ...
  and invalidate_anonymous_function : anonymous_function invalidator = fun (v, x) ->
    { Syntax.syntax =
      ...
      ; anonymous_ctx_list = invalidate_option_with (invalidate_capability) x.anonymous_ctx_list
