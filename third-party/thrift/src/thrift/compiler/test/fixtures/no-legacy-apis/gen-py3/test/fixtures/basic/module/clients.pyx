...
cdef void MyService_query_callback(
    cFollyTry[_test_fixtures_basic_module_types.cMyStruct]&& result,
    PyObject* userdata
):
    ...
    if result.hasException():
        ...
        try:
            pyfuture.set_result(_test_fixtures_basic_module_types.MyStruct._fbthrift_create(make_shared[_test_fixtures_basic_module_types.cMyStruct](cmove(result.value()))))
...
cdef class MyService(thrift.py3.client.Client):
    ...
    def query(
            MyService self,
            _test_fixtures_basic_module_types.MyUnion u not None,
        ...
        bridgeFutureWith[_test_fixtures_basic_module_types.cMyStruct](
            self._executor,
            down_cast_ptr[cMyServiceClientWrapper, cClientWrapper](self._client.get()).query(rpc_options._cpp_obj, 
                deref((<_test_fixtures_basic_module_types.MyUnion>u)._cpp_obj),
            ),
