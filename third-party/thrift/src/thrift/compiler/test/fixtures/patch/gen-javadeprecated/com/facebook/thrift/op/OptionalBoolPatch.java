...
public class OptionalBoolPatch implements TBase, java.io.Serializable, Cloneable, Comparable<OptionalBoolPatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(OptionalBoolPatch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    private BoolPatch patchPrior;
    private boolean ensure;
    private BoolPatch patch;
    ...
    public Builder setPatchPrior(final BoolPatch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }

    public Builder setEnsure(final boolean ensure) {
      this.ensure = ensure;
      __optional_isset.set(__ENSURE_ISSET_ID, true);
      return this;
    }

    public Builder setPatch(final BoolPatch patch) {
      this.patch = patch;
      return this;
    }

    public OptionalBoolPatch build() {
      OptionalBoolPatch result = new OptionalBoolPatch();
   ...
   * Patches any previously set values. Applies second.
   */
  public BoolPatch getPatchPrior() {
   ...
   * Patches any previously set values. Applies second.
   */
  public OptionalBoolPatch setPatchPrior(BoolPatch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((BoolPatch)__value);
      }
      break;
  ...
  @Override
  public int compareTo(OptionalBoolPatch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("OptionalBoolPatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
    ...
    if (isSetEnsure())
    {
      ...
      sb.append(space);
      sb.append(":").append(space);
      sb.append(TBaseHelper.toString(this.isEnsure(), indent + 1, prettyPrint));
      first = false;
    }
    if (!first) sb.append("," + newLine);
    sb.append(indentStr);
