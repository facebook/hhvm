...
if (NOT LIBMAGICKWAND_LIBRARIES OR NOT LIBMAGICKWAND_INCLUDE_DIRS OR
    NOT LIBMAGICKCORE_LIBRARIES)
  ...
  if (ImageMagick_MagickCore_FOUND)
    set (LIBMAGICKCORE_INCLUDE_DIRS ${ImageMagick_MagickCore_INCLUDE_DIR} ${ImageMagick_MagickCore_ARCH_INCLUDE_DIR} CACHE STRING "")
