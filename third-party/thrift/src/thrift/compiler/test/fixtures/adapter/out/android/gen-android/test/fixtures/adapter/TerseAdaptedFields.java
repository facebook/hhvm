          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_set_field = new HashSet<Integer>(Math.max(0, 2*_set76.size));
              for (int _i77 = 0; 
                   (_set76.size < 0) ? iprot.peekSet() : (_i77 < _set76.size); 
                   ++_i77)
              {
                Integer _elem78;
                _elem78 = iprot.readI32();
                tmp_set_field.add(_elem78);
              }
              iprot.readSetEnd();
            }
          } else {
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.set_field != null) {
      oprot.writeFieldBegin(SET_FIELD_FIELD_DESC);
      {
        ...
        for (Integer _iter79 : this.set_field)        {
