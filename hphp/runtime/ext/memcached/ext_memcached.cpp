...
Variant HHVM_METHOD(Memcached, getbykey, const String& server_key,
  ...
  memcached_behavior_set(&data->m_impl->memcached, MEMCACHED_BEHAVIOR_SUPPORT_CAS,
...
bool HHVM_METHOD(Memcached, getdelayedbykey, const String& server_key,
  ...
  if (!data->getMultiImpl(server_key, keys, with_cas, NULL)) return false;
...
Variant HHVM_METHOD(Memcached, getstats) {
  FETCH_MEMCACHED_DATA(data, this_);
  memcached_return_t error;
  memcached_stat_st *stats = memcached_stat(&data->m_impl->memcached, NULL, &error);
  if (!stats) {
    data->handleError(error);
    return false;
  }
...
const StaticString s_RES_CONNECTION_SOCKET_CREATE_FAILURE("RES_CONNECTION_SOCKET_CREATE_FAILURE");
 ...
 public:
  ...
  virtual void moduleInit() {
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_DISTRIBUTION_CONSISTENT.get(), q_Memcached$$DISTRIBUTION_CONSISTENT
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_DISTRIBUTION_MODULA.get(), q_Memcached$$DISTRIBUTION_MODULA
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_GET_PRESERVE_ORDER.get(), q_Memcached$$GET_PRESERVE_ORDER
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_BINARY_PROTOCOL.get(), q_Memcached$$OPT_BINARY_PROTOCOL
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_BUFFER_WRITES.get(), q_Memcached$$OPT_BUFFER_WRITES
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_CACHE_LOOKUPS.get(), q_Memcached$$OPT_CACHE_LOOKUPS
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_COMPRESSION.get(), q_Memcached$$OPT_COMPRESSION
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_CONNECT_TIMEOUT.get(), q_Memcached$$OPT_CONNECT_TIMEOUT
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_LIBKETAMA_COMPATIBLE.get(), q_Memcached$$OPT_LIBKETAMA_COMPATIBLE
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_RETRY_TIMEOUT.get(), q_Memcached$$OPT_RETRY_TIMEOUT
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_SERVER_FAILURE_LIMIT.get(), q_Memcached$$OPT_SERVER_FAILURE_LIMIT
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_SOCKET_RECV_SIZE.get(), q_Memcached$$OPT_SOCKET_RECV_SIZE
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_SOCKET_SEND_SIZE.get(), q_Memcached$$OPT_SOCKET_SEND_SIZE
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_OPT_TCP_NODELAY.get(), q_Memcached$$OPT_TCP_NODELAY
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_BAD_KEY_PROVIDED.get(), q_Memcached$$RES_BAD_KEY_PROVIDED
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_CONNECTION_SOCKET_CREATE_FAILURE.get(), q_Memcached$$RES_CONNECTION_SOCKET_CREATE_FAILURE
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_HOST_LOOKUP_FAILURE.get(), q_Memcached$$RES_HOST_LOOKUP_FAILURE
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_INVALID_HOST_PROTOCOL.get(), q_Memcached$$RES_INVALID_HOST_PROTOCOL
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_NO_SERVERS.get(), q_Memcached$$RES_NO_SERVERS
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_NOT_SUPPORTED.get(), q_Memcached$$RES_NOT_SUPPORTED
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_PAYLOAD_FAILURE.get(), q_Memcached$$RES_PAYLOAD_FAILURE
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_PROTOCOL_ERROR.get(), q_Memcached$$RES_PROTOCOL_ERROR
    );
    Native::registerClassConstant<KindOfInt64>(
    ...
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_UNKNOWN_READ_FAILURE.get(), q_Memcached$$RES_UNKNOWN_READ_FAILURE
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_RES_WRITE_FAILURE.get(), q_Memcached$$RES_WRITE_FAILURE
    );
    Native::registerClassConstant<KindOfInt64>(
      s_Memcached.get(), s_SERIALIZER_IGBINARY.get(), q_Memcached$$SERIALIZER_IGBINARY
    );
    Native::registerClassConstant<KindOfInt64>(
