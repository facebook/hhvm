...
void EnumMetadata<::cpp2::Animal>::gen(ThriftMetadata& metadata) {
  auto res = genEnumMetadata<::cpp2::Animal>(metadata, folly::kIsDebug);
  if (res.preExists) {
    return;
  }
...
StructMetadata<::cpp2::Color>::gen(ThriftMetadata& metadata) {
  auto res = genStructMetadata<::cpp2::Color>(metadata, folly::kIsDebug);
  if (res.preExists) {
    return res.metadata;
  }
  ...
  for (const auto& f : *module_Color_fields) {
    ...
    DCHECK(structuredAnnotationsEquality(
      *field.structured_annotations(),
      newAnnotations,
      getFieldAnnotationTypes<::cpp2::Color>(i, static_cast<std::int16_t>(f.id))
    ));
...
StructMetadata<::cpp2::Vehicle>::gen(ThriftMetadata& metadata) {
  auto res = genStructMetadata<::cpp2::Vehicle>(metadata, folly::kIsDebug);
  if (res.preExists) {
    return res.metadata;
  }
  ...
  for (const auto& f : *module_Vehicle_fields) {
    ...
    DCHECK(structuredAnnotationsEquality(
      *field.structured_annotations(),
      newAnnotations,
      getFieldAnnotationTypes<::cpp2::Vehicle>(i, static_cast<std::int16_t>(f.id))
    ));
...
StructMetadata<::cpp2::Person>::gen(ThriftMetadata& metadata) {
  auto res = genStructMetadata<::cpp2::Person>(metadata, folly::kIsDebug);
  if (res.preExists) {
    return res.metadata;
  }
  ...
  for (const auto& f : *module_Person_fields) {
    ...
    DCHECK(structuredAnnotationsEquality(
      *field.structured_annotations(),
      newAnnotations,
      getFieldAnnotationTypes<::cpp2::Person>(i, static_cast<std::int16_t>(f.id))
    ));
