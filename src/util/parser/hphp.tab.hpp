...
#define YYTOKEN_MIN 258
     ...
     YYTOKEN(331, T_BREAK),
     YYTOKEN(332, T_CONTINUE),
     YYTOKEN(333, T_FUNCTION),
     YYTOKEN(334, T_CONST),
     YYTOKEN(335, T_RETURN),
     YYTOKEN(336, T_TRY),
     YYTOKEN(337, T_CATCH),
     YYTOKEN(338, T_THROW),
     YYTOKEN(339, T_USE),
     YYTOKEN(340, T_GLOBAL),
     YYTOKEN(341, T_PUBLIC),
     YYTOKEN(342, T_PROTECTED),
     YYTOKEN(343, T_PRIVATE),
     YYTOKEN(344, T_FINAL),
     YYTOKEN(345, T_ABSTRACT),
     YYTOKEN(346, T_STATIC),
     YYTOKEN(347, T_VAR),
     YYTOKEN(348, T_UNSET),
     YYTOKEN(349, T_ISSET),
     YYTOKEN(350, T_EMPTY),
     YYTOKEN(351, T_HALT_COMPILER),
     YYTOKEN(352, T_CLASS),
     YYTOKEN(353, T_INTERFACE),
     YYTOKEN(354, T_EXTENDS),
     YYTOKEN(355, T_IMPLEMENTS),
     YYTOKEN(356, T_OBJECT_OPERATOR),
     YYTOKEN(357, T_DOUBLE_ARROW),
     YYTOKEN(358, T_LIST),
     YYTOKEN(359, T_ARRAY),
     YYTOKEN(360, T_CLASS_C),
     YYTOKEN(361, T_METHOD_C),
     YYTOKEN(362, T_FUNC_C),
     YYTOKEN(363, T_LINE),
     YYTOKEN(364, T_FILE),
     YYTOKEN(365, T_COMMENT),
     YYTOKEN(366, T_DOC_COMMENT),
     YYTOKEN(367, T_OPEN_TAG),
     YYTOKEN(368, T_OPEN_TAG_WITH_ECHO),
     YYTOKEN(369, T_CLOSE_TAG),
     YYTOKEN(370, T_WHITESPACE),
     YYTOKEN(371, T_START_HEREDOC),
     YYTOKEN(372, T_END_HEREDOC),
     YYTOKEN(373, T_DOLLAR_OPEN_CURLY_BRACES),
     YYTOKEN(374, T_CURLY_OPEN),
     YYTOKEN(375, T_PAAMAYIM_NEKUDOTAYIM),
     YYTOKEN(376, T_HPHP_NOTE),
     YYTOKEN(377, T_HPHP_DECLARE)
   };
#ifndef YYTOKEN_MAX
#define YYTOKEN_MAX 377
#endif
