...
class c_SplFileInfo : public ExtObjectData {
  ...
  public: int64_t t_getperms();
  public: int64_t t_getinode();
  public: int64_t t_getsize();
  public: int64_t t_getowner();
  public: int64_t t_getgroup();
  public: int64_t t_getatime();
  public: int64_t t_getmtime();
  public: int64_t t_getctime();
