...
abstract class TestServiceAsyncProcessorBase extends \ThriftAsyncProcessor {
  ...
  protected function getMethodMetadata_init(
    ...
    \test\namespace_from_package\module\TestService_init_result,
    int,
  > {
    return new \ThriftServiceRequestResponseMethod(
      \test\namespace_from_package\module\TestService_init_args::class,
      \test\namespace_from_package\module\TestService_init_result::class,
      async (
        TestServiceAsyncIf $handler,
        \test\namespace_from_package\module\TestService_init_args $args,
      )[defaults] ==> {
