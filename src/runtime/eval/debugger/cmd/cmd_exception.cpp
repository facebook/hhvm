...
void CmdException::sendImpl(DebuggerThriftBuffer &thrift) {
  DebuggerCommand::sendImpl(thrift);
}

void CmdException::recvImpl(DebuggerThriftBuffer &thrift) {
...
bool CmdException::onServer(DebuggerProxy *proxy) {
