...
#include <thrift/compiler/test/fixtures/no_package/gen-py3/module/clients_wrapper.h>
...
FooServiceClientWrapper::simple_rpc(
  ...
  auto* client = static_cast<::cpp2::FooServiceAsyncClient*>(async_client_.get());
...
folly::Future<::cpp2::ReservedKeyword>
FB303ServiceClientWrapper::simple_rpc(
    apache::thrift::RpcOptions& rpcOptions,
    int32_t arg_int_parameter) {
  auto* client = static_cast<::cpp2::FB303ServiceAsyncClient*>(async_client_.get());
  using CallbackHelper = apache::thrift::detail::FutureCallbackHelper<::cpp2::ReservedKeyword>;
  folly::Promise<CallbackHelper::PromiseResult> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<::thrift::py3::FutureCallback<::cpp2::ReservedKeyword>>(
    std::move(_promise), rpcOptions, client->recv_wrapped_simple_rpc, channel_);
  try {
    client->simple_rpc(
      rpcOptions,
    ...
    return folly::makeFuture<::cpp2::ReservedKeyword>(folly::exception_wrapper(
      std::current_exception()
    ));
  }
  return std::move(_future).thenValue(CallbackHelper::extractResult);
