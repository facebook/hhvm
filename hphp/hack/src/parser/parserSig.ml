  ...
  module WithLexer(Lexer : Lexer_S) = struct
    module type Parser_S = sig
      ...
      module Make : sig
        ...
        val property_declaration : t -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        ...
        val anonymous_function : t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
        val php7_anonymous_function : t -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> SC.r -> t * SC.r
