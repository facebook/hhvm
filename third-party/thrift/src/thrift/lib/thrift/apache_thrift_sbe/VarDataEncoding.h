...
#ifndef _APACHE_THRIFT_SBE_VARDATAENCODING_CXX_H_
#define _APACHE_THRIFT_SBE_VARDATAENCODING_CXX_H_
...
public:
        ...
        m_actingVersion(actingVersion)
    {
        ...
        {
            throw std::runtime_error("buffer too short for flyweight [E107] in VarDataEncoding");
        }
    }
