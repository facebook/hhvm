...
Variant f_get_browser(const String& user_agent = null_string, bool return_array = false);
...
bool f_php_check_syntax(const String& filename, VRefParam error_message = uninit_null());
