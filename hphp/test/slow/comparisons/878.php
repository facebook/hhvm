...
$i = 0;
 ...
 print ++$i;
 print "\t";
 print (varray[2]===__hhvm_intrinsics\dummy_cast_to_kindofarray(vec[])) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = varray[2];
 ...
 print ++$i;
 print "\t";
 print (varray[2]===darray['a' => 1, 'b' => 2]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = varray[2];
 ...
 print ++$i;
 print "\t";
 print (varray[2]===varray[darray['a' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = varray[2];
 ...
 print ++$i;
 print "\t";
 print (varray[2]===varray[darray['b' => 1]]) ? 'Y' : 'N';
 $a = 1;
 $a = 't';
 $a = varray[2];
