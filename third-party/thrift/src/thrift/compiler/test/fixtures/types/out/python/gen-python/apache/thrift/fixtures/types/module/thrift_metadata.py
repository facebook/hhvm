...
import apache.thrift.fixtures.types.module.thrift_enums as _fbthrift_current_module_enums
import apache.thrift.fixtures.types.module.thrift_enums
...
def _fbthrift_gen_metadata_struct_MyStructWithForwardRefEnum(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # a
    new_struct = apache.thrift.fixtures.types.module.thrift_enums._fbthrift_gen_metadata_enum_MyForwardRefEnum(new_struct)    # b
    new_struct = apache.thrift.fixtures.types.module.thrift_enums._fbthrift_gen_metadata_enum_MyForwardRefEnum(new_struct)
    return new_struct
...
def _fbthrift_gen_metadata_struct_Renaming(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    fields = [
        _fbthrift_metadata.ThriftField(id=1, type=_fbthrift_metadata.ThriftType(t_primitive=_fbthrift_metadata.ThriftPrimitiveType.THRIFT_I64_TYPE), name="foo", is_optional=False, structured_annotations=[
            _fbthrift_metadata.ThriftConstStruct(type=_fbthrift_metadata.ThriftStructType(name="cpp.Name"), fields= { "value": _fbthrift_metadata.ThriftConstValue(cv_string="bar"),  }),
        ]),
    ]
    struct_dict = dict(metadata_struct.structs)
    struct_dict[qualified_name] = _fbthrift_metadata.ThriftStruct(name=qualified_name, fields=fields,
        is_union=False,
        structured_annotations=[
            _fbthrift_metadata.ThriftConstStruct(type=_fbthrift_metadata.ThriftStructType(name="cpp.Name"), fields= { "value": _fbthrift_metadata.ThriftConstValue(cv_string="Renamed"),  }),
        ])
    new_struct = metadata_struct(structs=struct_dict)
...
def _fbthrift_gen_metadata_struct_ForwardUsageRoot(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # ForwardUsageStruct
    new_struct = _fbthrift_gen_metadata_struct_ForwardUsageStruct(new_struct)    # ForwardUsageByRef
    new_struct = _fbthrift_gen_metadata_struct_ForwardUsageByRef(new_struct)
    return new_struct
...
def _fbthrift_gen_metadata_struct_ForwardUsageStruct(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # foo
    new_struct = _fbthrift_gen_metadata_struct_ForwardUsageRoot(new_struct)
    return new_struct
...
def _fbthrift_gen_metadata_struct_IncompleteMap(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # field
     # key
    new_struct = _fbthrift_gen_metadata_struct_IncompleteMapDep(new_struct) # val 
    return new_struct
...
def _fbthrift_gen_metadata_struct_CompleteMap(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # field
     # key
    new_struct = _fbthrift_gen_metadata_struct_CompleteMapDep(new_struct) # val 
    return new_struct
...
def _fbthrift_gen_metadata_struct_IncompleteList(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # field
    new_struct = _fbthrift_gen_metadata_struct_IncompleteListDep(new_struct)
    return new_struct
...
def _fbthrift_gen_metadata_struct_CompleteList(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # field
    new_struct = _fbthrift_gen_metadata_struct_CompleteListDep(new_struct)
    return new_struct
...
def _fbthrift_gen_metadata_struct_AdaptedList(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # field
    new_struct = _fbthrift_gen_metadata_struct_AdaptedListDep(new_struct)
    return new_struct
...
def _fbthrift_gen_metadata_struct_AdaptedListDep(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # field
    new_struct = _fbthrift_gen_metadata_struct_AdaptedList(new_struct)
    return new_struct
...
def _fbthrift_gen_metadata_struct_DependentAdaptedList(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    # field
    new_struct = _fbthrift_gen_metadata_struct_DependentAdaptedListDep(new_struct)
    return new_struct
...
def getThriftModuleMetadata() -> _fbthrift_metadata.ThriftMetadata:
    ...
    meta = _fbthrift_current_module_enums._fbthrift_gen_metadata_enum_has_bitwise_ops(meta)
    meta = _fbthrift_current_module_enums._fbthrift_gen_metadata_enum_is_unscoped(meta)
    meta = _fbthrift_current_module_enums._fbthrift_gen_metadata_enum_MyForwardRefEnum(meta)
