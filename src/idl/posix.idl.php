...
DefineFunction(
  array(
    'name'   => "posix_setgid",
    'desc'   => "Set the real group ID of the current process. This is a privileged function and needs appropriate privileges (usually root) on the system to be able to perform this function. The appropriate order of function calls is posix_setgid() first, posix_setuid() last. Note: If the caller is a super user, this will also set the effective group id.",
    'return' => array(
      'type'   => Boolean,
      'desc'   => "Returns TRUE on success or FALSE on failure.",
    ),
