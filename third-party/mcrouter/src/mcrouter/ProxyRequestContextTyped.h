  ...
  void onBeforeRequestSent(
    ...
    if constexpr (HasLogBeforeRequestSent<AdditionalLogger, Request>::value) {
      ...
      RequestLoggerContext loggerContext(
          ...
          /* beforeReqLatencyInjectedOvershootUs */ 0,
          /* afterReqLatencyInjectedOvershootUs */ 0,
  ...
  void onReplyReceived(
    ...
    RequestLoggerContext loggerContext(
        ...
        *reply.result_ref(),
        ...
        fiber_local<RouterInfo>::getAccumulatedInjectedBeforeReqOvershootUs(),
        fiber_local<RouterInfo>::getAccumulatedInjectedAfterReqOvershootUs(),
        poolIndex,
        getProductId(request),
        getRegionalizationEntity(request),
        getUsecaseIdForLogging(request),
