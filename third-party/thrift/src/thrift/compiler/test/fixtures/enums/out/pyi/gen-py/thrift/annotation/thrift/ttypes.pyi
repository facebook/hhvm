...
class AllowUnsafeRequiredFieldQualifier:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.thrift.thrift_types.AllowUnsafeRequiredFieldQualifier": ...   # type: ignore
    def _to_mutable_python(self) -> "facebook.thrift.annotation.thrift.thrift_mutable_types.AllowUnsafeRequiredFieldQualifier": ...   # type: ignore
    def _to_py3(self) -> "facebook.thrift.annotation.thrift.types.AllowUnsafeRequiredFieldQualifier": ...   # type: ignore
    def _to_py_deprecated(self) -> AllowUnsafeRequiredFieldQualifier: ...
...
class AllowLegacyMissingUris:
    ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def __dir__(self) -> __T.Sequence[str]: ...
    def _to_python(self) -> "facebook.thrift.annotation.thrift.thrift_types.AllowLegacyMissingUris": ...   # type: ignore
    def _to_mutable_python(self) -> "facebook.thrift.annotation.thrift.thrift_mutable_types.AllowLegacyMissingUris": ...   # type: ignore
    def _to_py3(self) -> "facebook.thrift.annotation.thrift.types.AllowLegacyMissingUris": ...   # type: ignore
    def _to_py_deprecated(self) -> AllowLegacyMissingUris: ...
