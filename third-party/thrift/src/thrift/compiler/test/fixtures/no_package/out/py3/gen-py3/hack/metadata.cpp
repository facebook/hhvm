...
#include "thrift/compiler/test/fixtures/no_package/gen-py3/hack/metadata.h"

#include "thrift/compiler/test/fixtures/no_package/gen-cpp2/hack_handlers.h"
...
::apache::thrift::metadata::ThriftMetadata hack_getThriftModuleMetadata() {
  ...
  ::apache::thrift::detail::md::StructMetadata<LegacyOmitPrefixInNameString>::gen(metadata);
  ::apache::thrift::detail::md::StructMetadata<LegacyAlwaysIncludeNamePrefixInProcessor>::gen(metadata);
