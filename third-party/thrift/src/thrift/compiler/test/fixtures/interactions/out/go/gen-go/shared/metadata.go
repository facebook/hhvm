...
var (
    ...
    premadeThriftType_shared_DoSomethingResult = func() *metadata.ThriftType {
...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    fbthriftThriftTypesMap["shared.DoSomethingResult"] = premadeThriftType_shared_DoSomethingResult
    return fbthriftThriftTypesMap
}()

var structMetadatas = func() []*metadata.ThriftStruct {
    fbthriftResults := make([]*metadata.ThriftStruct, 0)
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_DoSomethingResult))
...
var serviceMetadatas = func() []*metadata.ThriftService {
    ...
    SetName("shared.InteractLocally").
    SetFunctions(
