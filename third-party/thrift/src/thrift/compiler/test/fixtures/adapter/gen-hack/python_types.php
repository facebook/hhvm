 ...
 * IOBuf
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/annotation/python/IOBuf'))>>
class IOBuf implements \IThriftSyncStruct, \IThriftStructMetadata, \IThriftShapishSyncStruct {
  use \ThriftSerializationTrait;
