...
This function is similar to ` vfk() `, except the [` Vector `](/docs/apis/Classes/HH/Vector/) in the returned
[` Awaitable `](/docs/apis/Classes/HH/Awaitable/) contains `` ResultOrExceptionWrapper ``s instead of raw values.




This function is similar to [` Vector::filterWithKey() `](/docs/apis/Classes/HH/Vector/filterWithKey/), but the mapping of the
key/value pairs are done using [` Awaitable `](/docs/apis/Classes/HH/Awaitable/)s.
...
of the [` Vector `](/docs/apis/Classes/HH/Vector/) is `` w ``rapped by a ``` ResultOrExceptionWrapper ```.
...
+ [` KeyedTraversable<Tk, `](/docs/apis/Interfaces/HH/KeyedTraversable/)`` T> $inputs `` - The [` KeyedTraversable `](/docs/apis/Interfaces/HH/KeyedTraversable/) of keys and values to map.
