    ...
    S: SyntaxType<Token=Token, Value=Value>,
{
    ...
    fn make_const_declaration(s: Bool<'a>, arg0: Self::R, arg1: Self::R, arg2: Self::R, arg3: Self::R, arg4: Self::R) -> (Bool<'a>, Self::R) {
    ...
    fn make_attributized_specifier(s: Bool<'a>, arg0: Self::R, arg1: Self::R) -> (Bool<'a>, Self::R) {
