...
struct ForEachField<::test::fixtures::patch::MyStructEnsureStruct> {
  ...
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
    ...
    f(17, static_cast<T&&>(t).lateStructVal_ref()...);
    f(18, static_cast<T&&>(t).unionVal_ref()...);
    f(19, static_cast<T&&>(t).structVal_ref()...);
    f(20, static_cast<T&&>(t).enumVal_ref()...);
    f(21, static_cast<T&&>(t).binaryVal_ref()...);
    f(22, static_cast<T&&>(t).stringVal_ref()...);
    f(23, static_cast<T&&>(t).doubleVal_ref()...);
    f(24, static_cast<T&&>(t).floatVal_ref()...);
    f(25, static_cast<T&&>(t).i64Val_ref()...);
    f(26, static_cast<T&&>(t).i32Val_ref()...);
    f(27, static_cast<T&&>(t).i16Val_ref()...);
    f(28, static_cast<T&&>(t).byteVal_ref()...);
    f(29, static_cast<T&&>(t).boolVal_ref()...);
  }
};
