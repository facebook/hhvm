...
template void TccStructTraits<::cpp2::A>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::U>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::Bang>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
std::partial_ordering U::operator<=>([[maybe_unused]] const U& rhs) const {
  return ::apache::thrift::op::compare<U>(*this, rhs);
}
...
std::partial_ordering Bang::operator<=>([[maybe_unused]] const Bang& rhs) const {
  return ::apache::thrift::op::compare<Bang>(*this, rhs);
}
