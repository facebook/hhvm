...
type client_mode =
  ...
  | MODE_GEN_REMOTE_ASTS of string
...
let mode_to_string = function
  ...
  | MODE_GEN_REMOTE_DECLS_FULL -> "MODE_GEN_REMOTE_DECLS_FULL"
  | MODE_GEN_REMOTE_DECLS_INCREMENTAL -> "MODE_GEN_REMOTE_DECLS_INCREMENTAL"
  | MODE_GEN_SHALLOW_DECLS_DIR _ -> "MODE_GEN_SHALLOW_DECLS_DIR"
  | MODE_GEN_REMOTE_ASTS _ -> "MODE_GEN_REMOTE_ASTS"
  ...
  | MODE_REFACTOR_SOUND_DYNAMIC _ -> "MODE_REFACTOR_SOUND_DYNAMIC"
