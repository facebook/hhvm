...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__signature || setStructField(*fbthrift_data, 0, *_fbthrift__signature) == -1) {
    return nullptr;
  }
  ...
  if (!_fbthrift__color || setStructField(*fbthrift_data, 1, *_fbthrift__color) == -1) {
    return nullptr;
  }
...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__path || setStructField(*fbthrift_data, 0, *_fbthrift__path) == -1) {
    return nullptr;
  }
  return std::move(fbthrift_data).release();
}
...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__adaptedStruct || setStructField(*fbthrift_data, 0, *_fbthrift__adaptedStruct) == -1) {
    return nullptr;
  }
  return std::move(fbthrift_data).release();
}
...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__data || setStructField(*fbthrift_data, 0, *_fbthrift__data) == -1) {
    return nullptr;
  }
  return std::move(fbthrift_data).release();
}
...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__name || setStructField(*fbthrift_data, 0, *_fbthrift__name) == -1) {
    return nullptr;
  }
  return std::move(fbthrift_data).release();
}
