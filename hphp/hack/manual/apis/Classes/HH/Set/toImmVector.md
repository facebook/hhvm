...
This example shows that ` toImmVector ` returns an `` ImmVector `` containing the [` Set `](/docs/apis/Classes/HH/Set/)'s values. Mutating the original [` Set `](/docs/apis/Classes/HH/Set/) doesn't affect the `` ImmVector ``.
