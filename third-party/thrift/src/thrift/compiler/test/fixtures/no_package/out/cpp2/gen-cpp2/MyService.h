...
class ServiceHandler<::cpp2::MyService> : public apache::thrift::ServerInterface {
 ...
 public:
  ...
  virtual void fbthrift_execute_decorators_before_sink(apache::thrift::Cpp2RequestContext& /*requestCtx*/, apache::thrift::detail::DecoratorArgType<::std::int64_t>::type /*p_sink*/) {}
  virtual void fbthrift_execute_decorators_after_sink(apache::thrift::Cpp2RequestContext& /*requestCtx*/) {}
  static void fbthrift_invoke_decorator_after_sink(void* iface, apache::thrift::Cpp2RequestContext* ctx) {
    static_cast<ServiceHandler<::cpp2::MyService>*>(iface)->fbthrift_execute_decorators_after_sink(*ctx);
  }
  ...
  virtual void fbthrift_execute_decorators_before_deleteDataById(apache::thrift::Cpp2RequestContext& /*requestCtx*/, apache::thrift::detail::DecoratorArgType<::std::int64_t>::type /*p_id*/) {}
  virtual void fbthrift_execute_decorators_after_deleteDataById(apache::thrift::Cpp2RequestContext& /*requestCtx*/) {}
  static void fbthrift_invoke_decorator_after_deleteDataById(void* iface, apache::thrift::Cpp2RequestContext* ctx) {
    static_cast<ServiceHandler<::cpp2::MyService>*>(iface)->fbthrift_execute_decorators_after_deleteDataById(*ctx);
  }
  ...
  virtual void fbthrift_execute_decorators_after_invalid_return_for_hack(apache::thrift::Cpp2RequestContext& /*requestCtx*/, apache::thrift::detail::DecoratorReturnType<::std::set<float>>::type /*result*/) {}
  static void fbthrift_invoke_decorator_after_invalid_return_for_hack(void* iface, apache::thrift::Cpp2RequestContext* ctx, apache::thrift::detail::DecoratorReturnType<::std::set<float>>::type result) {
    static_cast<ServiceHandler<::cpp2::MyService>*>(iface)->fbthrift_execute_decorators_after_invalid_return_for_hack(*ctx, result);
  }
  ...
  static void fbthrift_invoke_decorator_after_rpc_skipped_codegen(void* iface, apache::thrift::Cpp2RequestContext* ctx) {
    static_cast<ServiceHandler<::cpp2::MyService>*>(iface)->fbthrift_execute_decorators_after_rpc_skipped_codegen(*ctx);
  }
};
...
class MyServiceAsyncProcessor : public ::apache::thrift::GeneratedAsyncProcessorBase {
 ...
 private:
  ...
  template <class ProtocolIn_, class ProtocolOut_>
  static apache::thrift::SerializedResponse return_sink(
      apache::thrift::ContextStack* ctx);

  template <class ProtocolIn_, class ProtocolOut_>
  static void throw_wrapped_sink(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      int32_t protoSeqId,
      apache::thrift::ContextStack* ctx,
      folly::exception_wrapper ew,
  ...
  //
  template <typename ProtocolIn_, typename ProtocolOut_>
  void setUpAndProcess_deleteDataById(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      apache::thrift::SerializedCompressedRequest&& serializedRequest,
      apache::thrift::Cpp2RequestContext* ctx,
      folly::EventBase* eb,
  ...
  template <class ProtocolIn_, class ProtocolOut_>
  static apache::thrift::SerializedResponse return_deleteDataById(
      apache::thrift::ContextStack* ctx);

  template <class ProtocolIn_, class ProtocolOut_>
  static void throw_wrapped_deleteDataById(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      int32_t protoSeqId,
      apache::thrift::ContextStack* ctx,
      folly::exception_wrapper ew,
  ...
  //
  template <typename ProtocolIn_, typename ProtocolOut_>
  void setUpAndProcess_invalid_return_for_hack(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      apache::thrift::SerializedCompressedRequest&& serializedRequest,
      apache::thrift::Cpp2RequestContext* ctx,
      folly::EventBase* eb,
  ...
  template <class ProtocolIn_, class ProtocolOut_>
  static apache::thrift::SerializedResponse return_invalid_return_for_hack(
      apache::thrift::ContextStack* ctx,
      ::std::set<float> const& _return);

  template <class ProtocolIn_, class ProtocolOut_>
  static void throw_wrapped_invalid_return_for_hack(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      int32_t protoSeqId,
      apache::thrift::ContextStack* ctx,
      folly::exception_wrapper ew,
  ...
  //
  template <typename ProtocolIn_, typename ProtocolOut_>
  void setUpAndProcess_rpc_skipped_codegen(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      apache::thrift::SerializedCompressedRequest&& serializedRequest,
      apache::thrift::Cpp2RequestContext* ctx,
      folly::EventBase* eb,
  ...
  template <class ProtocolIn_, class ProtocolOut_>
  static apache::thrift::SerializedResponse return_rpc_skipped_codegen(
      apache::thrift::ContextStack* ctx);

  template <class ProtocolIn_, class ProtocolOut_>
  static void throw_wrapped_rpc_skipped_codegen(
      apache::thrift::ResponseChannelRequest::UniquePtr req,
      int32_t protoSeqId,
      apache::thrift::ContextStack* ctx,
      folly::exception_wrapper ew,
