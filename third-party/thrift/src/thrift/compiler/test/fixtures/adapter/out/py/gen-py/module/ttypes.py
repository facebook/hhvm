...
class MyAnnotation:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'color' in json_obj and json_obj['color'] is not None:
      ...
      if wrap_enum_constants:
        self.color = ThriftEnumWrapper(Color, self.color)
  ...
  def _to_python(self):
    ...
    python_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.MyAnnotation, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.MyAnnotation, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.types")
...
class Foo:
        ...
        if ftype == TType.LIST:
          ...
          if _size60 >= 0:
            for _i64 in range(_size60):
              ...
              self.adapted_list.append(_elem65)
          else: 
            while iprot.peekList():
              _elem66 = iprot.readI32()
              self.adapted_list.append(_elem66)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.SET:
          self.adapted_set = set()
          (_etype70, _size67) = iprot.readSetBegin()
          if _size67 >= 0:
            for _i71 in range(_size67):
              _elem72 = iprot.readI32()
              self.adapted_set.add(_elem72)
          else: 
            while iprot.peekSet():
              _elem73 = iprot.readI32()
              self.adapted_set.add(_elem73)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 14:
        if ftype == TType.MAP:
          ...
          if _size74 >= 0:
            for _i78 in range(_size74):
              ...
              self.adapted_map[_key79] = _val80
          else: 
            while iprot.peekMap():
              _key81 = iprot.readString().decode('utf-8') if UTF8STRINGS else iprot.readString()
              _val82 = iprot.readI32()
              self.adapted_map[_key81] = _val82
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 15:
  ...
  def __repr__(self):
    ...
    if self.adapted_list is not None:
      value = pprint.pformat(self.adapted_list, indent=0)
      value = padding.join(value.splitlines(True))
      L.append('    adapted_list=%s' % (value))
    if self.adapted_set is not None:
      value = pprint.pformat(self.adapted_set, indent=0)
      value = padding.join(value.splitlines(True))
      L.append('    adapted_set=%s' % (value))
...
class Baz(object):
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.Baz, self)
...
class Bar:
  ...
  def write(self, oprot):
    ...
    if self.structListField != None:
      ...
      for iter241 in self.structListField:
        iter241.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.structListFieldWithTypedef != None:
      ...
      for iter243 in self.structListFieldWithTypedef:
        iter243.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'structField' in json_obj and json_obj['structField'] is not None:
      self.structField = Foo()
      self.structField.readFromJson(json_obj['structField'], is_text=False, **kwargs)
    ...
    if 'structListField' in json_obj and json_obj['structListField'] is not None:
      self.structListField = []
      for _tmp_e244 in json_obj['structListField']:
        _struct245 = Foo()
        _struct245.readFromJson(_tmp_e244, is_text=False, **kwargs)
        self.structListField.append(_struct245)
    if 'optionalStructListField' in json_obj and json_obj['optionalStructListField'] is not None:
      self.optionalStructListField = []
      for _tmp_e246 in json_obj['optionalStructListField']:
        _struct247 = Foo()
        _struct247.readFromJson(_tmp_e246, is_text=False, **kwargs)
        self.optionalStructListField.append(_struct247)
    ...
    if 'optionalUnionField' in json_obj and json_obj['optionalUnionField'] is not None:
      self.optionalUnionField = Baz()
      self.optionalUnionField.readFromJson(json_obj['optionalUnionField'], is_text=False, **kwargs)
    ...
    if 'structListFieldWithTypedef' in json_obj and json_obj['structListFieldWithTypedef'] is not None:
      self.structListFieldWithTypedef = []
      for _tmp_e248 in json_obj['structListFieldWithTypedef']:
        _struct249 = Foo()
        _struct249.readFromJson(_tmp_e248, is_text=False, **kwargs)
        self.structListFieldWithTypedef.append(_struct249)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.Bar, self)
...
class DirectlyAdapted:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.DirectlyAdapted, self)
...
class IndependentDirectlyAdapted:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.IndependentDirectlyAdapted, self)
...
class StructWithFieldAdapter:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.StructWithFieldAdapter, self)
...
class TerseAdaptedFields:
        ...
        if ftype == TType.SET:
          ...
          if _size250 >= 0:
            for _i254 in range(_size250):
              ...
              self.set_field.add(_elem255)
          else: 
            while iprot.peekSet():
              _elem256 = iprot.readI32()
              self.set_field.add(_elem256)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'set_field' in json_obj and json_obj['set_field'] is not None:
      ...
      for _tmp_e258 in json_obj['set_field']:
        if _tmp_e258 > 0x7fffffff or _tmp_e258 < -0x80000000:
          raise TProtocolException(TProtocolException.INVALID_DATA, 'number exceeds limit in field')
        self.set_field.add(_tmp_e258)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.TerseAdaptedFields, self)
...
class B:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'a' in json_obj and json_obj['a'] is not None:
      self.a = A()
      self.a.readFromJson(json_obj['a'], is_text=False, **kwargs)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.B, self)
...
class A:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.A, self)
...
class Config:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.Config, self)
...
class MyStruct:
        ...
        if ftype == TType.SET:
          ...
          if _size259 >= 0:
            for _i263 in range(_size259):
              _elem264 = iprot.readString().decode('utf-8') if UTF8STRINGS else iprot.readString()
              self.set_string.add(_elem264)
          else: 
            while iprot.peekSet():
              _elem265 = iprot.readString().decode('utf-8') if UTF8STRINGS else iprot.readString()
              self.set_string.add(_elem265)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.set_string != None:
      ...
      for iter266 in self.set_string:
        oprot.writeString(iter266.encode('utf-8')) if UTF8STRINGS and not isinstance(iter266, bytes) else oprot.writeString(iter266)
      oprot.writeSetEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'set_string' in json_obj and json_obj['set_string'] is not None:
      ...
      for _tmp_e267 in json_obj['set_string']:
        self.set_string.add(_tmp_e267)
...
class AdaptTestStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.AdaptTestStruct, self)
...
class AdaptTemplatedTestStruct:
        ...
        if ftype == TType.LIST:
          ...
          if _size268 >= 0:
            for _i272 in range(_size268):
              ...
              self.adaptedList.append(_elem273)
          else: 
            while iprot.peekList():
              _elem274 = iprot.readI64()
              self.adaptedList.append(_elem274)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.SET:
          ...
          if _size275 >= 0:
            for _i279 in range(_size275):
              ...
              self.adaptedSet.add(_elem280)
          else: 
            while iprot.peekSet():
              _elem281 = iprot.readI64()
              self.adaptedSet.add(_elem281)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.MAP:
          ...
          if _size282 >= 0:
            for _i286 in range(_size282):
              ...
              self.adaptedMap[_key287] = _val288
          else: 
            while iprot.peekMap():
              _key289 = iprot.readI64()
              _val290 = iprot.readI64()
              self.adaptedMap[_key289] = _val290
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 11:
        ...
        if ftype == TType.LIST:
          ...
          if _size291 >= 0:
            for _i295 in range(_size291):
              ...
              self.adaptedListDefault.append(_elem296)
          else: 
            while iprot.peekList():
              _elem297 = iprot.readI64()
              self.adaptedListDefault.append(_elem297)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 20:
        if ftype == TType.SET:
          ...
          if _size298 >= 0:
            for _i302 in range(_size298):
              ...
              self.adaptedSetDefault.add(_elem303)
          else: 
            while iprot.peekSet():
              _elem304 = iprot.readI64()
              self.adaptedSetDefault.add(_elem304)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 21:
        if ftype == TType.MAP:
          ...
          if _size305 >= 0:
            for _i309 in range(_size305):
              ...
              _val311 = iprot.readI64()
              self.adaptedMapDefault[_key310] = _val311
          else: 
            while iprot.peekMap():
              _key312 = iprot.readI64()
              _val313 = iprot.readI64()
              self.adaptedMapDefault[_key312] = _val313
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 22:
  ...
  def write(self, oprot):
    ...
    if self.adaptedList != None:
      ...
      for iter314 in self.adaptedList:
    ...
    if self.adaptedSet != None:
      ...
      for iter315 in self.adaptedSet:
    ...
    if self.adaptedMap != None:
      ...
      for kiter316,viter317 in self.adaptedMap.items():
    ...
    if self.adaptedListDefault != None:
      ...
      for iter318 in self.adaptedListDefault:
    ...
    if self.adaptedSetDefault != None:
      ...
      for iter319 in self.adaptedSetDefault:
    ...
    if self.adaptedMapDefault != None:
      ...
      for kiter320,viter321 in self.adaptedMapDefault.items():
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'adaptedList' in json_obj and json_obj['adaptedList'] is not None:
      self.adaptedList = []
      for _tmp_e322 in json_obj['adaptedList']:
        self.adaptedList.append(_tmp_e322)
    if 'adaptedSet' in json_obj and json_obj['adaptedSet'] is not None:
      self.adaptedSet = set_cls()
      for _tmp_e323 in json_obj['adaptedSet']:
        self.adaptedSet.add(_tmp_e323)
    if 'adaptedMap' in json_obj and json_obj['adaptedMap'] is not None:
      self.adaptedMap = dict_cls()
      for _tmp_k324, _tmp_v325 in json_obj['adaptedMap'].items():
        _tmp_kp326 = long(_tmp_k324)
        self.adaptedMap[_tmp_kp326] = _tmp_v325
    ...
    if 'adaptedListDefault' in json_obj and json_obj['adaptedListDefault'] is not None:
      self.adaptedListDefault = []
      for _tmp_e327 in json_obj['adaptedListDefault']:
        self.adaptedListDefault.append(_tmp_e327)
    if 'adaptedSetDefault' in json_obj and json_obj['adaptedSetDefault'] is not None:
      self.adaptedSetDefault = set_cls()
      for _tmp_e328 in json_obj['adaptedSetDefault']:
        self.adaptedSetDefault.add(_tmp_e328)
    if 'adaptedMapDefault' in json_obj and json_obj['adaptedMapDefault'] is not None:
      self.adaptedMapDefault = dict_cls()
      for _tmp_k329, _tmp_v330 in json_obj['adaptedMapDefault'].items():
        _tmp_kp331 = long(_tmp_k329)
        self.adaptedMapDefault[_tmp_kp331] = _tmp_v330
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.AdaptTemplatedTestStruct, self)
...
class AdaptTemplatedNestedTestStruct:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'adaptedStruct' in json_obj and json_obj['adaptedStruct'] is not None:
      self.adaptedStruct = AdaptTemplatedTestStruct()
      self.adaptedStruct.readFromJson(json_obj['adaptedStruct'], is_text=False, **kwargs)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.AdaptTemplatedNestedTestStruct, self)
...
class AdaptTestUnion(object):
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.AdaptTestUnion, self)
...
class AdaptedStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.AdaptedStruct, self)
...
class DirectlyAdaptedStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.DirectlyAdaptedStruct, self)
...
class StructFieldAdaptedStruct:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'adaptedTypedef' in json_obj and json_obj['adaptedTypedef'] is not None:
      self.adaptedTypedef = AdaptedStruct()
      self.adaptedTypedef.readFromJson(json_obj['adaptedTypedef'], is_text=False, **kwargs)
    if 'directlyAdapted' in json_obj and json_obj['directlyAdapted'] is not None:
      self.directlyAdapted = DirectlyAdaptedStruct()
      self.directlyAdapted.readFromJson(json_obj['directlyAdapted'], is_text=False, **kwargs)
    if 'typedefOfAdapted' in json_obj and json_obj['typedefOfAdapted'] is not None:
      self.typedefOfAdapted = DirectlyAdaptedStruct()
      self.typedefOfAdapted.readFromJson(json_obj['typedefOfAdapted'], is_text=False, **kwargs)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.StructFieldAdaptedStruct, self)
...
class CircularAdaptee:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'field' in json_obj and json_obj['field'] is not None:
      self.field = CircularStruct()
      self.field.readFromJson(json_obj['field'], is_text=False, **kwargs)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.CircularAdaptee, self)
...
class CircularStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.CircularStruct, self)
...
class ReorderedStruct:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'reordered_dependent_adapted' in json_obj and json_obj['reordered_dependent_adapted'] is not None:
      self.reordered_dependent_adapted = DeclaredAfterStruct()
      self.reordered_dependent_adapted.readFromJson(json_obj['reordered_dependent_adapted'], is_text=False, **kwargs)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.ReorderedStruct, self)
...
class DeclaredAfterStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.DeclaredAfterStruct, self)
...
class RenamedStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.RenamedStruct, self)
...
class SameNamespaceStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.SameNamespaceStruct, self)
...
class HeapAllocated:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.HeapAllocated, self)
...
class MoveOnly:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'ptr' in json_obj and json_obj['ptr'] is not None:
      self.ptr = HeapAllocated()
      self.ptr.readFromJson(json_obj['ptr'], is_text=False, **kwargs)
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.MoveOnly, self)
...
class AlsoMoveOnly:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.AlsoMoveOnly, self)
...
class ApplyAdapter:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.ApplyAdapter, self)
...
class TransitiveAdapted:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.TransitiveAdapted, self)
...
class CountingStruct:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.CountingStruct, self)
...
class Person:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.Person, self)
...
class Person2:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.Person2, self)
...
class RenamedStructWithStructAdapterAndFieldAdapter:
  ...
  def _to_mutable_python(self):
    ...
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.test.fixtures.adapter.module.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.RenamedStructWithStructAdapterAndFieldAdapter, self)
...
AdaptedA = A
StringWithCppAdapter = UnimplementedTypedef()
...
FooWithAdapter_9317 = FooWithAdapter
...
Bar.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
  ...
  (5, TType.STRUCT, 'unionField', [Baz, Baz.thrift_spec, True], None, 2, ), # 5
  (6, TType.STRUCT, 'optionalUnionField', [Baz, Baz.thrift_spec, True], None, 1, ), # 6
