...
+ [` ::_getValidErrno(): Errno `](/docs/hsl/Classes/HH.Lib.OS/AlreadyExistsException/_getValidErrno/)
+ [` ->__construct(string $message) `](/docs/hsl/Classes/HH.Lib.OS/AlreadyExistsException/__construct/)
