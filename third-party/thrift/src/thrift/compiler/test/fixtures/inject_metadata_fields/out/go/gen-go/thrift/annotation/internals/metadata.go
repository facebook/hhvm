...
var (
    ...
    premadeThriftType_internal_InjectMetadataFields = func() *metadata.ThriftType {
...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    fbthriftThriftTypesMap["internal.InjectMetadataFields"] = premadeThriftType_internal_InjectMetadataFields
    return fbthriftThriftTypesMap
}()

var structMetadatas = func() []*metadata.ThriftStruct {
    fbthriftResults := make([]*metadata.ThriftStruct, 0)
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_InjectMetadataFields))
