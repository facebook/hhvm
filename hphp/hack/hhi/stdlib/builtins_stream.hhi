...
const int STREAM_AWAIT_READ = 2;
const int STREAM_AWAIT_WRITE = 4;
const int STREAM_AWAIT_READ_WRITE = 6;
const int STREAM_AWAIT_ERROR = -1;
const int STREAM_AWAIT_TIMEOUT = 0;
const int STREAM_AWAIT_READY = 1;
const int STREAM_AWAIT_CLOSED = 2;
const int STREAM_URL_STAT_LINK = 1;
const int STREAM_URL_STAT_QUIET = 2;
...
function stream_await($fp, $events, $timeout = 0.0);
