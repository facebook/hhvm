...
func (x *Empty) GetThriftStructMetadata() *metadata.ThriftStruct {
    return premadeStructMetadata_Empty
}
...
func (x *Nada) GetThriftStructMetadata() *metadata.ThriftStruct {
    return premadeStructMetadata_Nada
}
