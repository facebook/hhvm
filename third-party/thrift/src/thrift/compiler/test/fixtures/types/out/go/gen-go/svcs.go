...
func init() {
    thrift.InternalRegisterClientConstructor[SomeServiceClient](NewSomeServiceChannelClient)
}
...
func (p *SomeServiceProcessor) GetInteractionProcessors() []thrift.Processor {
