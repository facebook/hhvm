...
public class PerformRpcServerHandler 
  ...
  public PerformRpcServerHandler(Perform _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new PerformBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public PerformRpcServerHandler(Perform.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new PerformAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public PerformRpcServerHandler(Perform.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
  ...
  public reactor.core.publisher.Flux<com.facebook.thrift.payload.ServerResponsePayload> singleRequestStreamingResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    final String _qualifiedMethodName = "Perform." + _name;
