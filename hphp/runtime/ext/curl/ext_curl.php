...
/**
 * Specifies how many persistent connections to maintain for an HTTP server.
 *
 * @param string $address - Domain name for an HTTP server. Connections to this
 *    server, regardless of what server objects to fetch (specified by a URL),
 *    will be cached as persistent connections for re-use.
 * @param int $max_conn   - Maximum number of connections to keep.
 * @param int $port       - Port number of the HTTP server.
 *
 * @return void
 */
<<__Native, __HipHopSpecific>>
function evhttp_set_cache(string $address, int $max_conn, int $port = 80): void;
 ...
 * @param int $timeout   - How many seconds to wait for response.
 *
 ...
 * @param int $timeout   - How many seconds to wait for response.
 *
 * @return mixed - An object evhttp_recv() can use to eventually retrieve HTTP
 ...
 *
 * @param resource $handle - The object created by calling evhttp_async_get()
 *      or evhttp_async_post().
 *
 * @return mixed - HTTP response. FALSE if any failure.
 */
<<__Native, __HipHopSpecific>>
function evhttp_recv(resource $handle): mixed;
