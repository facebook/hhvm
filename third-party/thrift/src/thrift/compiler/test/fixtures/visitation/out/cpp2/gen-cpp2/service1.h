...
#endif
  virtual void async_tm_method1(apache::thrift::HandlerCallback<void>::Ptr callback);
...
#endif
  virtual void async_tm_method2(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int32_t p_x, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_y, double p_z);
...
#endif
  virtual void async_tm_method3(apache::thrift::HandlerCallback<::std::int32_t>::Ptr callback);
...
#endif
  virtual void async_tm_method4(apache::thrift::HandlerCallback<::std::int32_t>::Ptr callback, ::std::int32_t p_i, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_j, double p_k);
...
#endif
  virtual void async_tm_method5(apache::thrift::HandlerCallback<std::unique_ptr<::test_cpp2::cpp_reflection::struct2>>::Ptr callback);
...
#endif
  virtual void async_tm_method6(apache::thrift::HandlerCallback<std::unique_ptr<::test_cpp2::cpp_reflection::struct2>>::Ptr callback, ::std::int32_t p_l, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> p_m, double p_n);
 private:
