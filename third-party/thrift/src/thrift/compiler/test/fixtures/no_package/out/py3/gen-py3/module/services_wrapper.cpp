...
#include <thrift/compiler/test/fixtures/no_package/gen-py3/module/services_wrapper.h>
#include <thrift/compiler/test/fixtures/no_package/gen-py3/module/services_api.h>
...
void FB303ServiceWrapper::async_tm_simple_rpc(
  apache::thrift::HandlerCallbackPtr<std::unique_ptr<::cpp2::ReservedKeyword>> callback
  ...
  folly::via(
    ...
    [this, ctx,
     ...
     int_parameter
        ...
        auto [promise, future] = folly::makePromiseContract<std::unique_ptr<::cpp2::ReservedKeyword>>();
        call_cy_FB303Service_simple_rpc(
            this->if_object,
            ctx,
            std::move(promise),
            int_parameter        );
        std::move(future).via(this->executor).thenTry([callback = std::move(callback)](folly::Try<std::unique_ptr<::cpp2::ReservedKeyword>>&& t) {
          (void)t;
          callback->complete(std::move(t));
        });
    });
