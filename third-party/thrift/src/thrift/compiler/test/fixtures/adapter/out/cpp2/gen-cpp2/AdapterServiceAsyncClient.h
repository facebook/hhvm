...
class Client<::facebook::thrift::test::AdapterService> : public apache::thrift::GeneratedAsyncClient {
 ...
 private:
  ...
  folly::coro::Task<::facebook::thrift::test::CountingStruct> co_count(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      fbthrift_serialize_and_send_count(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
 ...
 private:
  ...
  apache::thrift::SerializedRequest fbthrift_serialize_count(Protocol_* prot, const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack);
 ...
 private:
  ...
  folly::coro::Task<::facebook::thrift::test::HeapAllocated> co_adaptedTypes(apache::thrift::RpcOptions* rpcOptions, const ::facebook::thrift::test::HeapAllocated& p_arg) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      fbthrift_serialize_and_send_adaptedTypes(*defaultRpcOptions, std::move(header), ctx.get(), std::move(wrappedCallback), p_arg);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
 ...
 private:
  template <typename Protocol_>
  apache::thrift::SerializedRequest fbthrift_serialize_adaptedTypes(Protocol_* prot, const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack, const ::facebook::thrift::test::HeapAllocated& p_arg);
  template <typename RpcOptions>
