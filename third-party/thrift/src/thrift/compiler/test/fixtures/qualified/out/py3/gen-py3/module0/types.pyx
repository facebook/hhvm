...
cdef class Struct(thrift.py3.types.Struct):
    ...
    def __init__(Struct self, **kwargs):
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module0_cbindings.cStruct]()
    ...
    def __call__(Struct self, **kwargs):
        ...
        __fbthrift_inst._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module0_cbindings.cStruct](deref(self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    @staticmethod
    cdef _create_FBTHRIFT_ONLY_DO_NOT_USE(shared_ptr[_module0_cbindings.cStruct] cpp_obj):
    ...
    def __copy__(Struct self):
        cdef shared_ptr[_module0_cbindings.cStruct] cpp_obj = make_shared[_module0_cbindings.cStruct](
    ...
    def __richcmp__(self, other, int op):
        ...
        return __richcmp[_module0_cbindings.cStruct](
    ...
    def __get_metadata__():
        ...
        _module0_cbindings.StructMetadata[_module0_cbindings.cStruct].gen(meta)
    ...
    def _fbthrift_get_field_name_by_index(cls, idx):
        return __sv_to_str(__get_field_name_by_index[_module0_cbindings.cStruct](idx))
    ...
    cdef _fbthrift_iobuf.IOBuf _fbthrift_serialize(Struct self, __Protocol proto):
        ...
        with nogil:
            data = cmove(serializer.cserialize[_module0_cbindings.cStruct](self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto))
    ...
    cdef cuint32_t _fbthrift_deserialize(Struct self, const _fbthrift_iobuf.cIOBuf* buf, __Protocol proto) except? 0:
        ...
        self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE = make_shared[_module0_cbindings.cStruct]()
        with nogil:
            needed = serializer.cdeserialize[_module0_cbindings.cStruct](buf, self._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE.get(), proto)
        return needed
...
cdef vector[_module0_cbindings.cEnum] List__Enum__make_instance(object items) except *:
    cdef vector[_module0_cbindings.cEnum] c_inst
    if items is not None:
        for item in items:
            if not isinstance(item, Enum):
                raise TypeError(f"{item!r} is not of type Enum")
            c_inst.push_back(<_module0_cbindings.cEnum><int>item)
    return cmove(c_inst)

cdef object List__Enum__from_cpp(const vector[_module0_cbindings.cEnum]& c_vec) except *:
    cdef list py_list = []
    cdef int idx = 0
...
c0 = Struct._create_FBTHRIFT_ONLY_DO_NOT_USE(constant_shared_ptr(_module0_cbindings.cc0()))
e0s = List__Enum__from_cpp(_module0_cbindings.ce0s())
