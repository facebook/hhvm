...
const unsigned g_methodIndexHMapSizeSys = 984;
extern const MethodIndexHMap g_methodIndexHMapSys [];
const MethodIndexHMap g_methodIndexHMapSys [g_methodIndexHMapSizeSys] = {
H(startDocument,456,1), H(getExtensionName,322,1), H(finalize,390,1), 
H(onClient,180,1), H(version,373,1), H(registerNodeClass,96,1), 
H(openURI,488,1), H(getStackTrace,164,1), H(getEndLine,313,1), 
H(__wakeup,279,1), H(getSize,200,1), H(endAttribute,489,1), 
H(getTimezone,145,1), H(rollback,280,1), H(getstrength,41,1), 
H(getStaticVariables,348,1), H(ksort,23,1), Z, 
H(quit,170,1), H(add,242,1), Z, 
H(getConstants,328,1), Z, Z, 
Z, Z, Z, 
H(getStartLine,326,1), H(current,7,1), Z, 
Z, H(__unset,398,1), H(appendXML,115,1), 
H(getAttributeNS,122,1), H(getClasses,345,1), H(setDate,142,1), 
Z, Z, H(querysingle,384,1), 
Z, Z, Z, 
H(isUserDefined,308,1), H(fault,420,1), H(endDocument,469,1), 
Z, Z, Z, 
Z, Z, H(compare,47,1), 
H(getcolumnmeta,289,1), H(__call,8,1), H(fgetcsv,425,1), 
H(isFinal,316,1), Z, Z, 
Z, H(c14n,67,1), Z, 
H(getMTime,204,1), H(hasChildren,303,1), Z, 
Z, Z, Z, 
Z, Z, Z, 
H(isArray,365,1), Z, H(evaluate,138,1), 
Z, H(fetchcolumn,288,1), Z, 
H(eof,431,1), Z, Z, 
Z, Z, H(serialize,393,1), 
H(loadXML,105,1), H(lasterrorcode,383,1), H(currentRef,274,1), 
H(__sleep,287,1), H(__gettypes,414,1), Z, 
Z, Z, H(__getfunctions,411,1), 
Z, H(__destruct,38,1), Z, 
H(setserverparams,233,1), Z, H(__get,74,1), 
Z, Z, H(cloneNode,64,1), 
Z, Z, Z, 
H(export,318,1), H(helpBody,171,1), H(getAttributeNodeNS,117,1), 
Z, H(getCsvControl,427,1), H(xpath,395,1), 
Z, H(addsoapheader,416,1), H(newInstanceArgs,312,1), 
Z, H(hasMethod,314,1), Z, 
H(getElementsByTagNameNS,88,1), H(delete,244,1), Z, 
Z, H(getVars,34,1), H(isLink,199,1), 
H(appendByKey,253,1), H(getMulti,249,1), H(createElement,99,1), 
H(getNodePath,70,1), H(fetchobject,298,1), H(appendData,80,1), 
H(getNumberOfParameters,347,1), H(getCode,27,1), H(registerNamespace,140,1), 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, H(flock,436,1), 
H(prependByKey,273,1), H(setText,212,1), Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, H(query,137,1), H(contains,446,1), 
Z, Z, Z, 
Z, Z, H(endDTDEntity,463,1), 
H(setTimezone,147,1), H(geterrorcode,40,1), Z, 
Z, H(ftruncate,430,1), H(setclass,421,1), 
Z, Z, Z, 
Z, H(getFlags,22,1), Z, 
H(__setsoapheaders,406,1), Z, Z, 
H(fgetc,433,1), H(error,157,1), H(startElementNS,466,1), 
H(getstats,236,1), Z, Z, 
H(setFileClass,190,1), H(getDelayed,254,1), H(removeAttributeNS,123,1), 
H(getLineNo,57,1), H(get,240,1), Z, 
Z, Z, Z, 
Z, H(connect,245,1), Z, 
Z, Z, H(isSuspicious,451,1), 
H(createElementNS,100,1), H(getBasename,187,1), H(saveXML,94,1), 
H(replaceChild,65,1), Z, Z, 
H(getNumberOfRequiredParameters,346,1), H(registerPHPFunctions,139,1), Z, 
H(arg,154,1), Z, Z, 
Z, H(__init__,30,1), H(done,52,1), 
H(invoke,352,1), Z, Z, 
H(startDTDEntity,457,1), Z, H(setMulti,260,1), 
H(helpCmds,155,1), H(hasAttributes,66,1), Z, 
Z, H(valid,3,1), H(isWhitespaceInElementContent,83,1), 
Z, H(errorcode,276,1), Z, 
Z, H(sortwithsortkeys,37,1), H(getIterator,135,1), 
H(registerXPathNamespace,396,1), H(getParameters,349,1), Z, 
Z, Z, Z, 
H(normalize,69,1), H(isPublic,359,1), H(setISODate,146,1), 
Z, Z, H(splitText,84,1), 
H(getNamedItem,133,1), H(endDTDAttlist,454,1), H(getlocale,45,1), 
H(getValue,369,1), H(uksort,18,1), H(setIndent,481,1), 
H(setIDAttribute,125,1), H(prepare,285,1), Z, 
H(read,184,1), Z, Z, 
H(tutorial,161,1), Z, H(endElement,476,1), 
H(argCount,153,1), Z, Z, 
Z, H(isValid,220,1), H(hasAttribute,118,1), 
Z, Z, Z, 
Z, Z, H(append,5,1), 
H(__getlastrequest,405,1), H(getProperties,319,1), H(openFile,209,1), 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
H(getMessage,25,1), H(fetch,270,1), Z, 
Z, H(isIterateable,306,1), Z, 
H(send,55,1), Z, Z, 
Z, Z, Z, 
Z, H(columncount,293,1), Z, 
H(set,232,1), Z, Z, 
Z, H(isDefault,370,1), Z, 
Z, Z, Z, 
Z, H(createDocumentType,131,1), Z, 
Z, Z, H(importNode,101,1), 
Z, H(cas,272,1), H(fflush,432,1), 
H(natsort,16,1), Z, Z, 
H(getavailabledrivers,282,1), H(load,97,1), H(offsetGet,11,1), 
H(lookupPrefix,68,1), H(writeDTDElement,470,1), Z, 
H(getClassNames,344,1), H(__set,63,1), H(asort,20,1), 
Z, Z, Z, 
Z, H(isWritable,186,1), Z, 
Z, Z, Z, 
Z, H(outputMemory,455,1), H(loadDims,223,1), 
Z, Z, H(text,491,1), 
H(getStaticPropertyValue,307,1), H(nextImpl,50,1), Z, 
Z, Z, H(fgets,435,1), 
H(closecursor,295,1), H(isOptional,366,1), Z, 
Z, H(writeDTDAttlist,485,1), H(startPI,490,1), 
Z, Z, H(exec,277,1), 
Z, Z, Z, 
Z, Z, H(getElementsByTagName,85,1), 
H(escapestring,378,1), H(isId,60,1), H(getElementById,111,1), 
Z, H(argRest,176,1), Z, 
H(endPI,479,1), Z, Z, 
H(attach,440,1), Z, Z, 
H(getATime,207,1), H(receive,54,1), Z, 
Z, H(loadextension,374,1), H(createAttribute,107,1), 
H(setOption,255,1), H(addAttribute,394,1), Z, 
Z, Z, H(open,380,1), 
H(writeComment,459,1), H(getLanguage,219,1), H(getFilename,201,1), 
H(getDelayedByKey,259,1), H(getServerByKey,264,1), Z, 
H(setAccessible,371,1), H(getTrace,33,1), H(begintransaction,284,1), 
Z, H(__isset,76,1), H(startDTDAttlist,483,1), 
H(fstat,439,1), H(next,1,1), H(casByKey,257,1), 
H(flush,247,1), H(insertBefore,58,1), Z, 
H(isnormalized,275,1), Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
H(quote,283,1), Z, H(print,167,1), 
H(setStaticPropertyValue,336,1), Z, Z, 
H(relaxNGValidate,90,1), Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, H(createDocumentFragment,114,1), 
H(getPosition,364,1), H(changes,381,1), Z, 
Z, H(getResultMessage,250,1), H(attributes,403,1), 
Z, Z, Z, 
Z, H(getParentClass,323,1), H(hasFeature,132,1), 
Z, H(setDeclaredEncoding,213,1), H(fgetss,424,1), 
Z, Z, Z, 
H(nextrowset,290,1), Z, H(addChild,402,1), 
H(endComment,461,1), H(isReadable,193,1), H(isAbstract,339,1), 
Z, Z, Z, 
Z, H(replaceData,81,1), Z, 
Z, Z, H(update,56,1), 
H(handle,418,1), H(getConstructor,311,1), Z, 
H(getNamespaces,397,1), H(xend,158,1), H(getErrors,228,1), 
H(getServerList,265,1), H(count,15,1), H(writeCData,468,1), 
H(getGroup,189,1), H(getLine,29,1), H(__getlastrequestheaders,410,1), 
Z, Z, H(__construct,6,1), 
Z, Z, H(ask,156,1), 
Z, H(writeAttributeNS,471,1), Z, 
H(replace,246,1), H(addfunction,415,1), Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, H(setobject,419,1), 
Z, Z, H(bindcolumn,291,1), 
H(columntype,386,1), Z, Z, 
Z, Z, H(lastinsertid,278,1), 
Z, Z, Z, 
Z, Z, Z, 
Z, H(deleteData,82,1), H(bindvalue,299,1), 
H(getDefaultValue,367,1), H(getName,152,1), H(setstrength,42,1), 
H(writeDTD,462,1), H(getLabel,48,1), Z, 
Z, Z, H(getInnerIterator,4,1), 
H(createAttributens,98,1), Z, Z, 
Z, H(debugdumpparams,300,1), H(getTraceAsString,32,1), 
Z, H(openMemory,487,1), H(addUrl,229,1), 
H(writePI,472,1), H(paramcount,391,1), Z, 
Z, Z, Z, 
Z, Z, H(getInfo,444,1), 
H(isSameNode,72,1), Z, Z, 
H(getMultiByKey,269,1), H(setIndentString,473,1), H(getPerms,185,1), 
H(getextendedstats,248,1), H(getMethod,321,1), H(getPathInfo,195,1), 
H(startCData,484,1), Z, Z, 
H(setoptimeout,238,1), H(loadImages,226,1), H(printFrame,166,1), 
Z, Z, H(getattribute,36,1), 
Z, Z, Z, 
Z, H(fwrite,438,1), Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
H(setAttributeNodeNS,120,1), H(getClass,362,1), H(openblob,382,1), 
Z, Z, Z, 
Z, H(setMultiByKey,268,1), H(columnname,385,1), 
H(fetchAll,267,1), Z, Z, 
Z, Z, H(fullEndElement,453,1), 
H(getSubPathname,301,1), H(isDir,205,1), H(setIDAttributeNS,116,1), 
H(isSupported,75,1), Z, Z, 
Z, Z, H(removeAllExcept,445,1), 
H(returnsReference,351,1), Z, Z, 
Z, H(save,106,1), H(__setcookie,407,1), 
Z, Z, Z, 
Z, H(getClosure,353,1), Z, 
Z, H(isInterface,330,1), H(appendChild,62,1), 
H(clear,227,1), Z, H(xinclude,108,1), 
H(sort,39,1), H(createTextNode,103,1), Z, 
H(startAttributens,464,1), Z, H(setAttributeNS,121,1), 
Z, Z, Z, 
Z, Z, Z, 
H(setattribute,44,1), H(removeAttribute,128,1), H(substringData,78,1), 
H(isInstance,315,1), H(deleteByKey,262,1), Z, 
H(setAttributeNode,129,1), Z, Z, 
Z, H(addCompletion,175,1), H(__soapcall,408,1), 
Z, Z, Z, 
H(errorinfo,286,1), H(addserver,231,1), H(getFunctions,342,1), 
H(detect,214,1), Z, Z, 
H(getLinkTarget,192,1), Z, Z, 
H(create,43,1), H(getEncoding,217,1), Z, 
Z, Z, H(getExtension,310,1), 
Z, H(hasAttributeNS,119,1), H(asXML,399,1), 
Z, H(removeAll,443,1), Z, 
Z, H(setChecks,450,1), H(help,173,1), 
Z, H(addByKey,266,1), H(isPrivate,354,1), 
Z, Z, Z, 
H(addAll,442,1), H(getConstant,327,1), H(getPrevious,28,1), 
Z, H(hasConstant,320,1), Z, 
Z, H(getInterfaceNames,325,1), H(startAttribute,474,1), 
H(__getlastresponse,413,1), Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, Z, H(listAbbreviations,151,1), 
H(reset,389,1), H(close,183,1), H(getMaxLineLen,429,1), 
H(fscanf,422,1), Z, H(item,134,1), 
H(getOwner,203,1), H(endDTDElement,482,1), H(areConfusable,449,1), 
H(setVars,35,1), H(normalizeDocument,113,1), Z, 
H(getTransitions,149,1), Z, H(bindparam,294,1), 
Z, H(setpersistence,417,1), Z, 
Z, H(detectAll,215,1), Z, 
H(wrap,178,1), H(helpSection,169,1), H(setMaxLineLen,428,1), 
Z, H(getMethods,305,1), H(getPathname,188,1), 
H(offsetExists,10,1), H(isProtected,355,1), H(removeAttributeNode,127,1), 
H(execute,297,1), H(__setlocation,409,1), H(replaceByKey,258,1), 
H(setIDAttributeNode,126,1), H(lasterrormsg,377,1), H(setInfoClass,191,1), 
H(writeDTDEntity,478,1), H(createComment,112,1), H(addFile,230,1), 
H(startComment,492,1), H(format,141,1), H(getArrayCopy,14,1), 
H(listIdentifiers,150,1), H(endDTD,486,1), H(createProcessingInstruction,95,1), 
H(children,401,1), Z, H(test,333,1), 
Z, H(get_args,49,1), H(startElement,465,1), 
H(createaggregate,379,1), H(rewind,9,1), H(__dorequest,404,1), 
H(getChildren,304,1), H(setAllowedLocales,448,1), H(writeElementNS,452,1), 
H(hasChildNodes,77,1), H(createDocument,130,1), H(commit,281,1), 
H(isLocal,182,1), H(getCurrentLocation,177,1), H(getFile,31,1), 
H(validate,87,1), H(onAutoComplete,179,1), H(setFlags,17,1), 
H(addString,222,1), Z, Z, 
Z, Z, Z, 
Z, H(fseek,423,1), Z, 
Z, H(css,225,1), Z, 
H(lastinsertrowid,376,1), H(hasProperty,332,1), Z, 
Z, Z, Z, 
Z, Z, H(output,163,1), 
H(info,165,1), Z, Z, 
Z, Z, Z, 
Z, H(numcolumns,387,1), Z, 
H(startDTDElement,467,1), Z, H(decrement,235,1), 
Z, H(writeAttribute,460,1), H(createfunction,375,1), 
H(argValue,162,1), H(getserverstatus,237,1), H(schemaValidate,93,1), 
H(__toString,26,1), H(onServer,181,1), H(fetcharray,388,1), 
Z, Z, Z, 
H(isDestructor,360,1), Z, H(isDefaultValueAvailable,361,1), 
H(getConfidence,218,1), H(isDefaultNamespace,59,1), H(isDot,210,1), 
H(getResultCode,251,1), H(getRealPath,194,1), Z, 
H(isPassedByReference,368,1), H(key,2,1), H(getInode,198,1), 
Z, H(relaxNGValidateSource,102,1), H(num_args,53,1), 
Z, Z, Z, 
Z, Z, Z, 
Z, H(removeChild,73,1), Z, 
H(getCommand,160,1), Z, H(pconnect,241,1), 
Z, Z, Z, 
H(isFile,202,1), H(isSubclassOf,331,1), Z, 
Z, H(startDTD,480,1), H(isConstructor,358,1), 
H(getInterfaces,338,1), Z, Z, 
Z, H(getDocComment,329,1), H(setCsvControl,426,1), 
Z, Z, Z, 
H(getFrame,172,1), H(setValue,372,1), Z, 
Z, H(endCData,458,1), Z, 
Z, Z, Z, 
H(natcasesort,19,1), H(increment,234,1), H(isInternal,340,1), 
Z, Z, H(loadHTML,91,1), 
H(getDefaultProperties,335,1), Z, H(get_arg,51,1), 
Z, H(modify,148,1), H(code,168,1), 
H(geterrormessage,46,1), H(getDeclaringClass,357,1), H(helpTitle,159,1), 
Z, H(seek,21,1), H(fpassthru,434,1), 
H(getFileInfo,206,1), H(offsetUnset,12,1), H(getOffset,143,1), 
H(setcompressthreshold,239,1), H(saveHTML,104,1), H(createCDATASection,86,1), 
H(unserialize,392,1), Z, Z, 
H(rowcount,296,1), H(schemaValidateSource,89,1), H(getStaticProperties,334,1), 
Z, Z, H(mapping,224,1), 
H(getByKey,261,1), H(loadHTMLFile,109,1), Z, 
Z, H(createEntityReference,92,1), H(c14nfile,71,1), 
H(getUTF8,216,1), H(args,174,1), H(getType,211,1), 
Z, Z, Z, 
Z, Z, Z, 
H(insertData,79,1), Z, Z, 
H(getOption,263,1), H(allowsNull,363,1), Z, 
H(getSubPath,302,1), H(getINIEntries,343,1), H(detach,441,1), 
Z, H(newInstance,309,1), H(setTime,144,1), 
Z, Z, H(implementsInterface,324,1), 
H(writeElement,475,1), Z, Z, 
Z, H(uasort,24,1), Z, 
Z, Z, Z, 
Z, H(getProperty,341,1), H(prepend,256,1), 
Z, H(setfetchmode,292,1), Z, 
H(addServers,271,1), H(isInstantiable,337,1), H(getversion,243,1), 
H(getAttributeNode,124,1), H(getPath,197,1), H(offsetSet,13,1), 
H(isStatic,356,1), Z, Z, 
H(invokeArgs,350,1), Z, Z, 
Z, Z, Z, 
Z, Z, H(getModifiers,317,1), 
H(saveHTMLFile,110,1), Z, Z, 
Z, Z, Z, 
Z, Z, Z, 
Z, H(getSeverity,221,1), Z, 
Z, Z, Z, 
Z, H(lookupNamespaceUri,61,1), Z, 
H(getCTime,196,1), H(ftell,437,1), H(__getlastresponseheaders,412,1), 
H(isExecutable,208,1), H(getNamedItemNS,136,1), H(setInfo,447,1), 
H(writeRaw,477,1), H(setByKey,252,1), H(getDocNamespaces,400,1)
};
#undef M
#undef H
#undef Z
...
"detach", "addAll", "removeAll", "getInfo", "removeAllExcept", 
"contains", "setInfo", "setAllowedLocales", "areConfusable", "setChecks", 
