...
fn emit_reified_init_body<'a>(
    ...
    let return_instr = InstrSeq::gather(vec![instr::null(), instr::ret_c(VerifyRetKind::None)]);
...
pub fn emit_class<'a>(emitter: &mut Emitter, ast_class: &'a ast::Class_) -> Result<Class> {
