...
from test.fixtures.nolegacy.module.clients_wrapper cimport cMyServiceAsyncClient, cMyServiceClientWrapper


cdef void MyService_query_callback(
    cFollyTry[_test_fixtures_nolegacy_module_types.cTestStruct]&& result,
    PyObject* userdata
):
...
cdef class MyService(thrift.py3.client.Client):
    ...
    def query(
            MyService self,
            _test_fixtures_nolegacy_module_types.TestUnion val not None,
        ...
        bridgeFutureWith[_test_fixtures_nolegacy_module_types.cTestStruct](
            self._executor,
            down_cast_ptr[cMyServiceClientWrapper, cClientWrapper](self._client.get()).query(rpc_options._cpp_obj, 
                deref((<_test_fixtures_nolegacy_module_types.TestUnion>val)._cpp_obj),
            ),
