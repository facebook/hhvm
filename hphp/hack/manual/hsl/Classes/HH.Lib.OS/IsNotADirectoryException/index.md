...
+ [` ::_getValidErrno(): Errno `](/hsl/Classes/HH.Lib.OS/IsNotADirectoryException/_getValidErrno/)
+ [` ->__construct(string $message) `](/hsl/Classes/HH.Lib.OS/IsNotADirectoryException/__construct/)
