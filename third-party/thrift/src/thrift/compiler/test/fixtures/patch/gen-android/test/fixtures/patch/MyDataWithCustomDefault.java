...
public class MyDataWithCustomDefault implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public MyDataWithCustomDefault(MyDataWithCustomDefault other) {
    if (other.isSetData1()) {
  ...
  public MyDataWithCustomDefault deepCopy() {
    return new MyDataWithCustomDefault(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof MyDataWithCustomDefault))
      return false;
    MyDataWithCustomDefault that = (MyDataWithCustomDefault)_that;
  ...
  public static MyDataWithCustomDefault deserialize(TProtocol iprot) throws TException {
    ...
    MyDataWithCustomDefault _that;
    _that = new MyDataWithCustomDefault(
      tmp_data1
      ,tmp_data2
    );
    _that.validate();
