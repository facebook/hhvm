...
class MyStructFieldPatch(_fbthrift_python_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[MyStructField30Patch, MyStructField29Patch, MyStructField28Patch, MyStructField27Patch, MyStructField26Patch, LateDefStructPatch, MyDataPatch, MyStructField23Patch, apache.thrift.op.patch.thrift_types.BinaryPatch, apache.thrift.op.patch.thrift_types.StringPatch, apache.thrift.op.patch.thrift_types.DoublePatch, apache.thrift.op.patch.thrift_types.FloatPatch, apache.thrift.op.patch.thrift_types.I64Patch, apache.thrift.op.patch.thrift_types.I32Patch, apache.thrift.op.patch.thrift_types.I16Patch, apache.thrift.op.patch.thrift_types.BytePatch, apache.thrift.op.patch.thrift_types.BoolPatch, LateDefStructPatch, MyUnionPatch, MyDataPatch, MyStructField10Patch, apache.thrift.op.patch.thrift_types.BinaryPatch, apache.thrift.op.patch.thrift_types.StringPatch, apache.thrift.op.patch.thrift_types.DoublePatch, apache.thrift.op.patch.thrift_types.FloatPatch, apache.thrift.op.patch.thrift_types.I64Patch, apache.thrift.op.patch.thrift_types.I32Patch, apache.thrift.op.patch.thrift_types.I16Patch, apache.thrift.op.patch.thrift_types.BytePatch, apache.thrift.op.patch.thrift_types.BoolPatch]]]: ...
...
class LoopEnsureStruct(_fbthrift_python_types.Struct):
    bar: _typing.Final[_typing.Optional[Bar]] = ...
    def __init__(
        self, *,
        bar: _typing.Optional[Bar]=...
    ) -> None: ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[Bar]]]: ...
    def _to_python(self) -> LoopEnsureStruct: ...
    def _to_py3(self) -> "test.fixtures.patch.module.types.LoopEnsureStruct": ...  # type: ignore
    def _to_py_deprecated(self) -> "module.ttypes.LoopEnsureStruct": ...  # type: ignore
