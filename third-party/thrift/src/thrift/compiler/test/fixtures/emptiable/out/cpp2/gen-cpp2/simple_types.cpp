...
template void TccStructTraits<::apache::thrift::test::MyStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::apache::thrift::test::EmptiableStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::apache::thrift::test::EmptiableTerseStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::apache::thrift::test::NotEmptiableStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
bool EmptiableTerseStruct::__fbthrift_is_empty() const {
  ...
  if (!(::apache::thrift::op::isEmpty<::apache::thrift::type::enum_t<::apache::thrift::test::MyEnum>>(this->__fbthrift_field_enum_field))) {
    return false;
  }
  ...
  if (!(::apache::thrift::op::isEmpty<::apache::thrift::type::struct_t<::apache::thrift::test::MyStruct>>(this->__fbthrift_field_struct_field))) {
    return false;
  }
  return true;
}
