...
void HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::setUpAndProcess_echo(
  ...
  processInThread(
      ...
      &HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::
          executeRequest_echo<ProtocolIn_, ProtocolOut_>,
      this);
}

template <typename ProtocolIn_, typename ProtocolOut_>
void HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::executeRequest_echo(
...
/* static */ apache::thrift::SerializedResponse HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::return_echo(
...
template <class ProtocolIn_, class ProtocolOut_>
void HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::throw_wrapped_echo(
    apache::thrift::ResponseChannelRequest::UniquePtr req,
...
//
template <typename ProtocolIn_, typename ProtocolOut_>
void HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::setUpAndProcess_echo_2(
    apache::thrift::ResponseChannelRequest::UniquePtr req,
    apache::thrift::SerializedCompressedRequest&& serializedRequest,
    apache::thrift::Cpp2RequestContext* ctx,
    folly::EventBase* eb,
...
template <typename ProtocolIn_, typename ProtocolOut_>
void HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::executeRequest_echo_2(
    apache::thrift::ServerRequest&& serverRequest) {
  // make sure getRequestContext is null
  // so async calls don't accidentally use it
  iface_->setRequestContext(nullptr);
...
template <class ProtocolIn_, class ProtocolOut_>
/* static */ apache::thrift::SerializedResponse HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::return_echo_2(
    apache::thrift::ContextStack* ctx,
    ::cpp2::EchoResponse const& _return) {
  ProtocolOut_ prot;
...
template <class ProtocolIn_, class ProtocolOut_>
void HeaderClientMethodsAnnotationOnFunctionAsyncProcessor::throw_wrapped_echo_2(
    apache::thrift::ResponseChannelRequest::UniquePtr req,
    [[maybe_unused]] int32_t protoSeqId,
    apache::thrift::ContextStack* ctx,
    folly::exception_wrapper ew,
