...
echo "Test arrays\n";
echo multiArgTopLevel(varray[1,1,2,3], array(), darray[1=>2]).' ';
echo multiArgTopLevel(varray[1,1,2,3], array(), darray[1=>2]).' ';
echo multiArgTopLevel(varray[1,1,2,3], varray["a"], darray[1=>2]).' ';
echo multiArgTopLevel(varray[1,1,2,3], varray["a"], darray[1=>2]).' ';
echo multiArgTopLevel(varray[2,1,2,3], array(), darray[1=>2]).' ';
echo multiArgTopLevel(varray[2,1,2,3], array(), darray[1=>2]).' ';
echo multiArgTopLevel(varray[1,1,2,3], array(), darray[2=>1]).' ';
echo multiArgTopLevel(varray[1,1,2,3], array(), darray[2=>1]).' ';
echo multiArgTopLevel(array(), varray[1,1,2,3], darray[1=>2]).' ';
echo multiArgTopLevel(array(), varray[1,1,2,3], darray[1=>2]).' ';
