...
public class BarSafePatch implements TBase, java.io.Serializable, Cloneable, Comparable<BarSafePatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(BarSafePatch.class, metaDataMap);
  }
  ...
  public BarSafePatch setVersion(int version) {
    this.version = version;
    setVersionIsSet(true);
    return this;
  }
  ...
  public BarSafePatch setData(byte[] data) {
    this.data = data;
    return this;
  }
  ...
  @Override
  public int compareTo(BarSafePatch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("BarSafePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
