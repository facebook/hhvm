...
TEST(UtilTest, is_eligible_for_constexpr) {
...
TEST(UtilTest, for_each_transitive_field) {
  auto program = t_program("path/to/program.thrift", "path/to/program.thrift");
...
TEST(UtilTest, get_gen_type_class) {
...
TEST(UtilTest, get_internal_injected_field_id) {
