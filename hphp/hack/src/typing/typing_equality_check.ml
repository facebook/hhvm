...
let rec assert_nontrivial p bop env ty1 ty2 =
  ...
  | (_, Tpu _), _
  | _, (_, Tpu _) -> failwith "TODO(T36532263) typing_equality_check Tpu"
  | (_, Tpu_access _), _
  | _, (_, Tpu_access _) -> failwith "TODO(T36532263) typing_equality_check Taccess"
  | (_, (Terr | Tany _ | Tnonnull | Tarraykind _ | Tprim _ | Toption _ | Tdynamic
