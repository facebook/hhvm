...
::std::string_view _fbthrift_schema_615b2bf51f6e9a81() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_615b2bf51f6e9a81_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_615b2bf51f6e9a81_uris() {
  return {};
}
