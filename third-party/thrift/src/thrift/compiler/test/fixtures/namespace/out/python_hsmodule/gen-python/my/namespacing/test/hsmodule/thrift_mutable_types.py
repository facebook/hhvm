...
class HsFoo(metaclass=_fbthrift_python_mutable_types.MutableStructMeta):
    _fbthrift_SPEC = (
    ...
    def _to_python(self):
        ...
        import importlib
        immutable_types = importlib.import_module("python_module_root.my.namespacing.test.hsmodule.thrift_types")
        return thrift.python.converter.to_python_struct(immutable_types.HsFoo, self)
...
class _fbthrift_HsTestService_init_args(metaclass=_fbthrift_python_mutable_types.MutableStructMeta):
    _fbthrift_SPEC = (
        _fbthrift_python_types.FieldInfo(
            1,  # id
            _fbthrift_python_types.FieldQualifier.Unqualified, # qualifier
...
class _fbthrift_HsTestService_init_result(metaclass=_fbthrift_python_mutable_types.MutableStructMeta):
    _fbthrift_SPEC = (
        _fbthrift_python_types.FieldInfo(
            0,  # id
