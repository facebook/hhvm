...
class NamePrefix:
  ...
  def __repr__(self):
    ...
    if self.apply_to_services is not None:
      ...
      value = padding.join(value.splitlines(True))
      L.append('    apply_to_services=%s' % (value))
    return "%s(%s)" % (self.__class__.__name__, "\n" + ",\n".join(L) if L else '')
...
class LegacyOmitPrefixInNameString:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('LegacyOmitPrefixInNameString')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.LegacyOmitPrefixInNameString, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.LegacyOmitPrefixInNameString, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.hack.types")
    return thrift.py3.converter.to_py3_struct(py3_types.LegacyOmitPrefixInNameString, self)
...
class LegacyAlwaysIncludeNamePrefixInProcessor:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('LegacyAlwaysIncludeNamePrefixInProcessor')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.LegacyAlwaysIncludeNamePrefixInProcessor, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.LegacyAlwaysIncludeNamePrefixInProcessor, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.hack.types")
    return thrift.py3.converter.to_py3_struct(py3_types.LegacyAlwaysIncludeNamePrefixInProcessor, self)
...
class ConstantsClass:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('ConstantsClass')
    if self.name != None:
      oprot.writeFieldBegin('name', TType.STRING, 1)
      oprot.writeString(self.name.encode('utf-8')) if UTF8STRINGS and not isinstance(self.name, bytes) else oprot.writeString(self.name)
      oprot.writeFieldEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.ConstantsClass, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.ConstantsClass, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.hack.types")
    return thrift.py3.converter.to_py3_struct(py3_types.ConstantsClass, self)
...
class MigrationBlockingLegacyJSONSerialization:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('MigrationBlockingLegacyJSONSerialization')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.MigrationBlockingLegacyJSONSerialization, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.MigrationBlockingLegacyJSONSerialization, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.hack.types")
    return thrift.py3.converter.to_py3_struct(py3_types.MigrationBlockingLegacyJSONSerialization, self)
...
class FixmeWrongType:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('FixmeWrongType')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.FixmeWrongType, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.FixmeWrongType, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.hack.types")
    return thrift.py3.converter.to_py3_struct(py3_types.FixmeWrongType, self)
...
class UnsafeArray:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('UnsafeArray')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.UnsafeArray, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.hack.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.UnsafeArray, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.hack.types")
    return thrift.py3.converter.to_py3_struct(py3_types.UnsafeArray, self)
...
all_structs.append(LegacyOmitPrefixInNameString)
LegacyOmitPrefixInNameString.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

LegacyOmitPrefixInNameString.thrift_struct_annotations = {
}
LegacyOmitPrefixInNameString.thrift_field_annotations = {
}

all_structs.append(LegacyAlwaysIncludeNamePrefixInProcessor)
LegacyAlwaysIncludeNamePrefixInProcessor.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

LegacyAlwaysIncludeNamePrefixInProcessor.thrift_struct_annotations = {
}
LegacyAlwaysIncludeNamePrefixInProcessor.thrift_field_annotations = {
}

all_structs.append(ConstantsClass)
ConstantsClass.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
  (1, TType.STRING, 'name', True, None, 2, ), # 1
)))

ConstantsClass.thrift_struct_annotations = {
}
ConstantsClass.thrift_field_annotations = {
}

def ConstantsClass__init__(self, name=None,):
  self.name = name

ConstantsClass.__init__ = ConstantsClass__init__

def ConstantsClass__setstate__(self, state):
  state.setdefault('name', None)
  self.__dict__ = state

ConstantsClass.__getstate__ = lambda self: self.__dict__.copy()
ConstantsClass.__setstate__ = ConstantsClass__setstate__
...
all_structs.append(MigrationBlockingLegacyJSONSerialization)
MigrationBlockingLegacyJSONSerialization.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

MigrationBlockingLegacyJSONSerialization.thrift_struct_annotations = {
}
MigrationBlockingLegacyJSONSerialization.thrift_field_annotations = {
}

all_structs.append(FixmeWrongType)
FixmeWrongType.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

FixmeWrongType.thrift_struct_annotations = {
}
FixmeWrongType.thrift_field_annotations = {
}

all_structs.append(UnsafeArray)
UnsafeArray.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

UnsafeArray.thrift_struct_annotations = {
}
UnsafeArray.thrift_field_annotations = {
}
