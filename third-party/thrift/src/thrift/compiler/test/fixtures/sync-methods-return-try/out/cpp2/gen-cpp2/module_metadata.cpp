...
StructMetadata<::cpp2::StreamItem>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::cpp2::StreamItem>(metadata, kGenerateAll).metadata;
  }
...
void ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::PubSubStreamingService>>::gen_returnstream([[maybe_unused]] ThriftMetadata& metadata, ThriftService& service, std::size_t index, [[maybe_unused]] std::size_t schemaIndex) {
  ...
  [[maybe_unused]] auto module_PubSubStreamingService_returnstream_from_1Annotations = std::move(*module_PubSubStreamingService_returnstream_from_1.structured_annotations());
  module_PubSubStreamingService_returnstream_from_1.structured_annotations()->clear();
...
void ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::PubSubStreamingService>>::gen(::apache::thrift::metadata::ThriftServiceMetadataResponse& response) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    genServiceMetadataResponse<::cpp2::PubSubStreamingService>(response);
    DCHECK_EQ(*response.context()->module()->name(), "module");
    DCHECK_EQ(*response.context()->service_info()->name(), "module.PubSubStreamingService");
    return;
  }
