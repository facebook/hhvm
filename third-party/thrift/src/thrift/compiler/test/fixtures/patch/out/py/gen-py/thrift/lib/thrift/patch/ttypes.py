...
__all__ = ['UTF8STRINGS', 'GeneratePatch', 'GeneratePatchNew', 'AssignOnlyPatch', 'BoolPatch', 'BytePatch', 'I16Patch', 'I32Patch', 'I64Patch', 'FloatPatch', 'DoublePatch', 'StringPatch', 'BinaryPatch', 'FieldId', 'FieldIdList']
...
class GeneratePatchNew:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('GeneratePatchNew')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_py3(self):
    ...
    import thrift.py3.converter
    py3_types = importlib.import_module("apache.thrift.op.patch.types")
    return thrift.py3.converter.to_py3_struct(py3_types.GeneratePatchNew, self)
...
all_structs.append(GeneratePatchNew)
GeneratePatchNew.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

GeneratePatchNew.thrift_struct_annotations = {
}
GeneratePatchNew.thrift_field_annotations = {
}
