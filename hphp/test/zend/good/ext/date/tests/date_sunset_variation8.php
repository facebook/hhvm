...
foreach( $time_date as $date => $time ){
    echo "\n--$date--\n";
    var_dump( date_sunset($time, SUNFUNCS_RET_STRING, 90.0, 0.0 ) );
    var_dump( date_sunset($time, SUNFUNCS_RET_DOUBLE, 90.0, 0.0 ) );
    var_dump( date_sunset($time, SUNFUNCS_RET_TIMESTAMP, 90.0, 0.0 ) );
    var_dump( date_sunset($time, SUNFUNCS_RET_STRING, -90.0, 0.0 ) );
    var_dump( date_sunset($time, SUNFUNCS_RET_DOUBLE, -90.0, 0.0 ) );
    var_dump( date_sunset($time, SUNFUNCS_RET_TIMESTAMP, -90.0, 0.0 ) );
}
