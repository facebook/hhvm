...
abstract class FooHackServiceAsyncProcessorBase extends \ThriftAsyncProcessor {
  ...
  protected async function process_fetchStatus(int $seqid, \TProtocol $input, \TProtocol $output): Awaitable<void> {
    ...
    $result = FooHackService_fetchStatus_result::withDefaultValues();
    try {
      $args = $this->readHelper(FooHackService_fetchStatus_args::class, $input, 'fetchStatus', $handler_ctx);
      $this->eventHandler_->preExec($handler_ctx, '\test\foo\php\ns\FooHackService', 'fetchStatus', $args);
    ...
    switch ($fn_name) {
      case 'fetchStatus':
        return new \ThriftServiceRequestResponseMethod(
          FooHackService_fetchStatus_args::class,
          FooHackService_fetchStatus_result::class,
          async (
            FooHackServiceAsyncIf $handler,
            FooHackService_fetchStatus_args $args,
          )[defaults] ==> {
