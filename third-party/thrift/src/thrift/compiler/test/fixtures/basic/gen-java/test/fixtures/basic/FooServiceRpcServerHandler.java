...
public class FooServiceRpcServerHandler 
  ...
  public FooServiceRpcServerHandler(FooService _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new FooServiceBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public FooServiceRpcServerHandler(FooService.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new FooServiceAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public FooServiceRpcServerHandler(FooService.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
  ...
  private static reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload>
    ...
    com.facebook.swift.service.ContextChain _chain) {
          ...
          if (com.facebook.thrift.util.resources.RpcResources.isForceExecutionOffEventLoop()) {
            ...
            _delegateResponse = _delegate.simpleRpc();
          }
              ...
              reactor.core.publisher.Mono.fromSupplier(
                () -> {
                  ...
                  return com.facebook.thrift.util.RpcPayloadUtil.createServerResponsePayload(
                    _payload,
                    _create_simpleRpc_response_writer(null, _chain, _payload.getMessageSeqId()));
                }
              )
            )
