...
let whitespace = "[\r\t\n ]"
let copyright_docblock = "Copyright .* All Rights Reserved\\."
let codegen_docblock = "This file was generated by:\\(.\\|" ^ whitespace ^ "\\)*For codegen logic, refer to [a-zA-Z0-9_]*\\."
let generated_docblock = "This file is generated. Do not modify it manually!\\(.\\|" ^ whitespace ^ "\\)*@generated SignedSource<<.*>>"
let docblock_regexp = Str.regexp (String.concat ~sep:"\\|" [copyright_docblock; codegen_docblock; generated_docblock])
...
let clean_comments (raw_comments : string) : string =
  String.strip (Str.global_replace docblock_regexp "" raw_comments)
