...
template<>
void reset_field<::facebook::thrift::annotation::cpp::ScopedEnumAsUnionType>(
...
template<>
void reset_field<::facebook::thrift::annotation::cpp::FieldInterceptor>(
...
template<>
void reset_field<::facebook::thrift::annotation::cpp::UseOpEncode>(
