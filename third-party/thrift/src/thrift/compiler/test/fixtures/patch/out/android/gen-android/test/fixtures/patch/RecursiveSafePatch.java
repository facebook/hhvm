...
public class RecursiveSafePatch implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("RecursiveSafePatch");
   ...
   */
  public RecursiveSafePatch(RecursiveSafePatch other) {
  ...
  public RecursiveSafePatch deepCopy() {
    return new RecursiveSafePatch(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof RecursiveSafePatch))
      return false;
    RecursiveSafePatch that = (RecursiveSafePatch)_that;
  ...
  public static RecursiveSafePatch deserialize(TProtocol iprot) throws TException {
    ...
    RecursiveSafePatch _that;
    _that = new RecursiveSafePatch(
      tmp_version
      ,tmp_data
    );
    _that.validate();
