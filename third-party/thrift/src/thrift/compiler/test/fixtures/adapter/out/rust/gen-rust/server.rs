    ...
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                ...
                (::fbthrift::TType::String, 1) => field_arg1 = ::std::option::Option::Some(<crate::types::adapters::StringWithAdapter as ::fbthrift::adapter::ThriftAdapter>::from_thrift_field::<fbthrift::metadata::NoThriftAnnotations>(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising arg1 arg of func")?, 1)?),
                (::fbthrift::TType::String, 2) => field_arg2 = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising arg2 arg of func")?),
                (::fbthrift::TType::Struct, 3) => field_arg3 = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising arg3 arg of func")?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
...
impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_AdapterService_adaptedTypes {
    ...
    fn read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        loop {
            ...
            match (fty, fid as ::std::primitive::i32) {
                (::fbthrift::TType::Stop, _) => break,
                (::fbthrift::TType::Struct, 1) => field_arg = ::std::option::Option::Some(::anyhow::Context::context(::fbthrift::Deserialize::read(p), "Error while deserialising arg arg of adaptedTypes")?),
                (fty, _) => p.skip(fty)?,
            }
            p.read_field_end()?;
        }
