...
String::String(const std::string &s) {
  SmartPtr<StringData>::operator=(NEW(StringData)(s.data(), s.size(),
                                                  CopyString));
}

String::String(const char *s, StringDataMode mode) {
  if (s) {
    SmartPtr<StringData>::operator=(NEW(StringData)(s, mode));
  }
}

String::String(const char *s, int length, StringDataMode mode) {
  if (s) {
    SmartPtr<StringData>::operator=(NEW(StringData)(s, length, mode));
  }
}

String::String(StringData *data) {
  SmartPtr<StringData>::operator=(data);
}

String::String(CStrRef str) {
