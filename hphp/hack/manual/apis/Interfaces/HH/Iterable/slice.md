...
Returns a subset of the current [` Iterable `](/docs/apis/Interfaces/HH/Iterable/) starting from a given key up
...
` $start ` is 0-based. `` $len `` is 1-based. So [` slice(0, `](/docs/apis/Interfaces/HH/Iterable/slice/)`` 2) `` would return the
...
+ ` int $start ` - The starting key of the current [` Iterable `](/docs/apis/Interfaces/HH/Iterable/) to begin the
  returned [` Iterable `](/docs/apis/Interfaces/HH/Iterable/).
+ ` int $len ` - The length of the returned [` Iterable `](/docs/apis/Interfaces/HH/Iterable/).
