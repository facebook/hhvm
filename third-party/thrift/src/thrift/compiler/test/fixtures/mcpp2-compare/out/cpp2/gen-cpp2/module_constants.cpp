...
::std::string_view _fbthrift_schema_8912084f6ded564d() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_8912084f6ded564d_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_8912084f6ded564d_uris() {
  return {};
}
