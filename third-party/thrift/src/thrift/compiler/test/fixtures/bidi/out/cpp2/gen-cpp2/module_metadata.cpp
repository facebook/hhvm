...
StructMetadata<::cpp2::BiDiSinkException>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::cpp2::BiDiSinkException>(metadata, kGenerateAll).metadata;
  }
  ...
  for (const auto& f : *module_BiDiSinkException_fields) {
    genStructFieldMetadata<::cpp2::BiDiSinkException>(module_BiDiSinkException.fields()[i], f, i);
...
StructMetadata<::cpp2::BiDiStreamException>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::cpp2::BiDiStreamException>(metadata, kGenerateAll).metadata;
  }
  ...
  for (const auto& f : *module_BiDiStreamException_fields) {
    genStructFieldMetadata<::cpp2::BiDiStreamException>(module_BiDiStreamException.fields()[i], f, i);
...
StructMetadata<::cpp2::BiDiMethodException>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::cpp2::BiDiMethodException>(metadata, kGenerateAll).metadata;
  }
  ...
  for (const auto& f : *module_BiDiMethodException_fields) {
    genStructFieldMetadata<::cpp2::BiDiMethodException>(module_BiDiMethodException.fields()[i], f, i);
...
void ExceptionMetadata<::cpp2::BiDiSinkException>::gen(ThriftMetadata& metadata) {
  ...
  std::size_t i = 0;
  for (const auto& f : *module_BiDiSinkException_fields) {
    [[maybe_unused]] auto& field = module_BiDiSinkException.fields()[i];
...
void ExceptionMetadata<::cpp2::BiDiStreamException>::gen(ThriftMetadata& metadata) {
  ...
  std::size_t i = 0;
  for (const auto& f : *module_BiDiStreamException_fields) {
    [[maybe_unused]] auto& field = module_BiDiStreamException.fields()[i];
    DCHECK_EQ(*field.id(), f.id);
    DCHECK_EQ(*field.name(), f.name);
    DCHECK_EQ(*field.is_optional(), f.is_optional);
...
void ExceptionMetadata<::cpp2::BiDiMethodException>::gen(ThriftMetadata& metadata) {
  ...
  std::size_t i = 0;
  for (const auto& f : *module_BiDiMethodException_fields) {
    [[maybe_unused]] auto& field = module_BiDiMethodException.fields()[i];
    DCHECK_EQ(*field.id(), f.id);
    DCHECK_EQ(*field.name(), f.name);
    DCHECK_EQ(*field.is_optional(), f.is_optional);
...
void ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::BiDiService>>::gen(::apache::thrift::metadata::ThriftServiceMetadataResponse& response) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    genServiceMetadataResponse<::cpp2::BiDiService>(response);
    DCHECK_EQ(*response.context()->module()->name(), "module");
    DCHECK_EQ(*response.context()->service_info()->name(), "module.BiDiService");
    return;
  }
...
const ThriftServiceContextRef* ServiceMetadata<::apache::thrift::ServiceHandler<::cpp2::BiDiService>>::genRecurse(ThriftMetadata& metadata, std::vector<ThriftServiceContextRef>& services) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    const ThriftServiceContextRef* context = genServiceMetadataRecurse<::cpp2::BiDiService>(metadata, services);
    DCHECK_EQ(*metadata.services()["module.BiDiService"].name(), "module.BiDiService");
    DCHECK_EQ(*context->service_name(), "module.BiDiService");
