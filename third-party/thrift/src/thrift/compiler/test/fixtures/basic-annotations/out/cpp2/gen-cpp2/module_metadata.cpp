  ...
  for (const auto& f : *module_MyStructNestedAnnotation_fields) {
    ...
    DCHECK(structuredAnnotationsEquality(
      *field.structured_annotations(),
      newAnnotations,
      getFieldAnnotationTypes<::cpp2::MyStructNestedAnnotation>(i, static_cast<std::int16_t>(f.id))
    ));
...
StructMetadata<::cpp2::detail::YourStruct>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_MyStruct_fields) {
    ...
    DCHECK(structuredAnnotationsEquality(
      *field.structured_annotations(),
      newAnnotations,
      getFieldAnnotationTypes<::cpp2::detail::YourStruct>(i, static_cast<std::int16_t>(f.id))
    ));
...
StructMetadata<::cpp2::SecretStruct>::gen(ThriftMetadata& metadata) {
  ...
  for (const auto& f : *module_SecretStruct_fields) {
    ...
    DCHECK(structuredAnnotationsEquality(
      *field.structured_annotations(),
      newAnnotations,
      getFieldAnnotationTypes<::cpp2::SecretStruct>(i, static_cast<std::int16_t>(f.id))
    ));
