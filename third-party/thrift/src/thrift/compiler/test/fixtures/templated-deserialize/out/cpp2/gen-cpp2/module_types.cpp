...
template void TccStructTraits<::cpp2::SmallStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::containerStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
const std::vector<std::any>& TEnumTraits<::cpp2::MyEnumA>::annotations() noexcept {
  return ::apache::thrift::detail::annotation::empty_annotations();
}

const std::vector<std::any>& TEnumTraits<::cpp2::MyEnumA>::enumValueAnnotations(::cpp2::MyEnumA value) noexcept {
