...
class c_Memcached : public ExtObjectData, public Sweepable {
 public:
  ...
  public: Variant t_get(CStrRef key, CVarRef cache_cb = null_variant, Variant cas_token = null_variant);
  DECLARE_METHOD_INVOKE_HELPERS(get);
  public: Variant t_getbykey(CStrRef server_key, CStrRef key, CVarRef cache_cb = null_variant, Variant cas_token = null_variant);
  ...
  public: Variant t_getmulti(CArrRef keys, Variant cas_tokens = null_variant, int flags = 0);
  DECLARE_METHOD_INVOKE_HELPERS(getmulti);
  public: Variant t_getmultibykey(CStrRef server_key, CArrRef keys, Variant cas_tokens = null_variant, int flags = 0);
