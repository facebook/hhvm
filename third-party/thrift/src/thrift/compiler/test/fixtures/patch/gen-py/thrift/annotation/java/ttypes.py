...
__all__ = ['UTF8STRINGS', 'Mutable', 'Annotation', 'BinaryString', 'EnableIsSet', 'Adapter', 'Wrapper']
...
class EnableIsSet:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('EnableIsSet')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.java.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.EnableIsSet, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.java.types")
    return thrift.py3.converter.to_py3_struct(py3_types.EnableIsSet, self)
...
all_structs.append(EnableIsSet)
EnableIsSet.thrift_spec = (
)

EnableIsSet.thrift_struct_annotations = {
}
EnableIsSet.thrift_field_annotations = {
}
