...
class Included final  {
 private:
  ...
  struct __fbthrift_ordinal_impl {
    ...
    template<> static constexpr int value<::apache::thrift::ident::MyTransitiveField> = 2;
#else
    ...
    static constexpr int value_impl(folly::tag_t<::apache::thrift::ident::MyTransitiveField>) { return 2; }
 ...
 public:
  ...
  Included() :
      ...
      __fbthrift_field_MyTransitiveField(static_cast<::cpp2::Foo>(::apache::thrift::detail::make_structured_constant<::cpp2::Foo>(::apache::thrift::detail::wrap_struct_argument<::apache::thrift::ident::a>(static_cast<::std::int64_t>(2))))) {
  }
