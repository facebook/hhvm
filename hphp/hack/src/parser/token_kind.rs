...
pub enum TokenKind {
    ...
    DollarDollar = 171,
    BarGreaterThan = 172,
    BarQuestionGreaterThan = 173,
    SlashGreaterThan = 174,
    LessThanSlash = 175,
    LessThanQuestion = 176,
    Backtick = 177,
    XHP = 178,
    Hash = 179,
    Readonly = 180,
    ...
    DecimalLiteral = 189,
    OctalLiteral = 190,
    HexadecimalLiteral = 191,
    BinaryLiteral = 192,
    FloatingLiteral = 193,
    SingleQuotedStringLiteral = 194,
    DoubleQuotedStringLiteral = 195,
    DoubleQuotedStringLiteralHead = 196,
    StringLiteralBody = 197,
    DoubleQuotedStringLiteralTail = 198,
    HeredocStringLiteral = 199,
    HeredocStringLiteralHead = 200,
    HeredocStringLiteralTail = 201,
    NowdocStringLiteral = 202,
    BooleanLiteral = 203,
    XHPCategoryName = 204,
    XHPElementName = 205,
    XHPClassName = 206,
    XHPStringLiteral = 207,
    XHPBody = 208,
    XHPComment = 209,
    Hashbang = 210,
}
...
impl TokenKind {
    ...
    pub fn from_string(
        ...
        match keyword {
            ...
            b"absent" if !only_reserved => Some(TokenKind::Absent),
            _ => None,
        }
    }
    ...
    pub fn ocaml_tag(self) -> u8 {
        match self {
            ...
            TokenKind::Include => 48,
            TokenKind::Include_once => 49,
            TokenKind::Inout => 50,
            TokenKind::Instanceof => 51,
            TokenKind::Insteadof => 52,
            TokenKind::Int => 53,
            TokenKind::Integer => 54,
            TokenKind::Interface => 55,
            TokenKind::Is => 56,
            TokenKind::Isset => 57,
            TokenKind::Keyset => 58,
            TokenKind::Lateinit => 59,
            TokenKind::List => 60,
            TokenKind::Match => 61,
            TokenKind::Mixed => 62,
            TokenKind::Module => 63,
            ...
            TokenKind::BarQuestionGreaterThan => 173,
            TokenKind::SlashGreaterThan => 174,
            TokenKind::LessThanSlash => 175,
            TokenKind::LessThanQuestion => 176,
            TokenKind::Backtick => 177,
            TokenKind::XHP => 178,
            TokenKind::Hash => 179,
            TokenKind::Readonly => 180,
            TokenKind::Internal => 181,
            TokenKind::Package => 182,
            TokenKind::Let => 183,
            TokenKind::Optional => 184,
            TokenKind::Absent => 185,
            TokenKind::ErrorToken => 186,
            TokenKind::Name => 187,
            TokenKind::Variable => 188,
            TokenKind::DecimalLiteral => 189,
            TokenKind::OctalLiteral => 190,
            TokenKind::HexadecimalLiteral => 191,
            TokenKind::BinaryLiteral => 192,
            TokenKind::FloatingLiteral => 193,
            TokenKind::SingleQuotedStringLiteral => 194,
            TokenKind::DoubleQuotedStringLiteral => 195,
            TokenKind::DoubleQuotedStringLiteralHead => 196,
            TokenKind::StringLiteralBody => 197,
            TokenKind::DoubleQuotedStringLiteralTail => 198,
            TokenKind::HeredocStringLiteral => 199,
            TokenKind::HeredocStringLiteralHead => 200,
            TokenKind::HeredocStringLiteralTail => 201,
            TokenKind::NowdocStringLiteral => 202,
            TokenKind::BooleanLiteral => 203,
            TokenKind::XHPCategoryName => 204,
            TokenKind::XHPElementName => 205,
            TokenKind::XHPClassName => 206,
            TokenKind::XHPStringLiteral => 207,
            TokenKind::XHPBody => 208,
            TokenKind::XHPComment => 209,
            TokenKind::Hashbang => 210,
        }
    }
    ...
    pub fn try_from_u8(tag: u8) -> Option<Self> {
        match tag {
            ...
            26 => Some(TokenKind::Delay),
            27 => Some(TokenKind::Dict),
            28 => Some(TokenKind::Do),
            29 => Some(TokenKind::Double),
            30 => Some(TokenKind::Echo),
            31 => Some(TokenKind::Else),
            32 => Some(TokenKind::Empty),
            33 => Some(TokenKind::Endif),
            34 => Some(TokenKind::Enum),
            35 => Some(TokenKind::Eval),
            ...
            48 => Some(TokenKind::Include),
            49 => Some(TokenKind::Include_once),
            50 => Some(TokenKind::Inout),
            51 => Some(TokenKind::Instanceof),
            52 => Some(TokenKind::Insteadof),
            53 => Some(TokenKind::Int),
            54 => Some(TokenKind::Integer),
            55 => Some(TokenKind::Interface),
            56 => Some(TokenKind::Is),
            57 => Some(TokenKind::Isset),
            58 => Some(TokenKind::Keyset),
            59 => Some(TokenKind::Lateinit),
            60 => Some(TokenKind::List),
            61 => Some(TokenKind::Match),
            62 => Some(TokenKind::Mixed),
            63 => Some(TokenKind::Module),
            64 => Some(TokenKind::Named),
            ...
            173 => Some(TokenKind::BarQuestionGreaterThan),
            174 => Some(TokenKind::SlashGreaterThan),
            175 => Some(TokenKind::LessThanSlash),
            176 => Some(TokenKind::LessThanQuestion),
            177 => Some(TokenKind::Backtick),
            178 => Some(TokenKind::XHP),
            179 => Some(TokenKind::Hash),
            180 => Some(TokenKind::Readonly),
            181 => Some(TokenKind::Internal),
            182 => Some(TokenKind::Package),
            183 => Some(TokenKind::Let),
            184 => Some(TokenKind::Optional),
            185 => Some(TokenKind::Absent),
            186 => Some(TokenKind::ErrorToken),
            187 => Some(TokenKind::Name),
            188 => Some(TokenKind::Variable),
            189 => Some(TokenKind::DecimalLiteral),
            190 => Some(TokenKind::OctalLiteral),
            191 => Some(TokenKind::HexadecimalLiteral),
            192 => Some(TokenKind::BinaryLiteral),
            193 => Some(TokenKind::FloatingLiteral),
            194 => Some(TokenKind::SingleQuotedStringLiteral),
            195 => Some(TokenKind::DoubleQuotedStringLiteral),
            196 => Some(TokenKind::DoubleQuotedStringLiteralHead),
            197 => Some(TokenKind::StringLiteralBody),
            198 => Some(TokenKind::DoubleQuotedStringLiteralTail),
            199 => Some(TokenKind::HeredocStringLiteral),
            200 => Some(TokenKind::HeredocStringLiteralHead),
            201 => Some(TokenKind::HeredocStringLiteralTail),
            202 => Some(TokenKind::NowdocStringLiteral),
            203 => Some(TokenKind::BooleanLiteral),
            204 => Some(TokenKind::XHPCategoryName),
            205 => Some(TokenKind::XHPElementName),
            206 => Some(TokenKind::XHPClassName),
            207 => Some(TokenKind::XHPStringLiteral),
            208 => Some(TokenKind::XHPBody),
            209 => Some(TokenKind::XHPComment),
            210 => Some(TokenKind::Hashbang),
            _ => None,
        }
    }
    ...
    pub fn fixed_width(self) -> Option<NonZeroUsize> {
        match self {
            ...
            TokenKind::Delay => Some(unsafe { NonZeroUsize::new_unchecked(5) }),
            ...
            TokenKind::Absent => Some(unsafe { NonZeroUsize::new_unchecked(6) }),
            _ => None,
        }
    }
}
