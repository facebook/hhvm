...
#HHVM has problems 3.8+; don't use the found version if it's >=3.8
if (PC_SQLITE3_FOUND AND NOT (PC_SQLITE3_VERSION VERSION_LESS "3.8"))
    ...
    find_library(LIBSQLITE3_LIBRARY
        NAMES sqlite3)
endif (PC_SQLITE3_FOUND AND NOT (PC_SQLITE3_VERSION VERSION_LESS "3.8"))
