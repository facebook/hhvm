...
The following example shows how to retrieve the key from an [` MCRouterException `](/docs/apis/Classes/MCRouterException/) using its `` getKey `` method. If there is no key associated with the exception, then ``` "" ``` will be returned.
