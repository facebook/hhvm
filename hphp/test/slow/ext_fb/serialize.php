...
$ret = null;
$unserialized = fb_unserialize(fb_serialize(array("test")), inout $ret);
...
var_dump(fb_unserialize(  fb_serialize(array("test"), FB_SERIALIZE_HACK_ARRAYS), inout $ret,   FB_SERIALIZE_HACK_ARRAYS
));
var_dump($ret);
...
$ret = null;
var_dump(fb_unserialize(fb_serialize(array("test", 42)), inout $ret));
var_dump($ret);

$ret = null;
var_dump(
  fb_unserialize(fb_serialize(array("test" => 'testval', 42 => '42val')), inout $ret)
);
var_dump($ret);
