...
::std::string_view _fbthrift_schema_9c7d8ae2c8fd19c3() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_9c7d8ae2c8fd19c3_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_9c7d8ae2c8fd19c3_uris() {
  return {};
}
