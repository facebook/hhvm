...
function apply_tuple_mono((function(int,string):void) $f, (int,string) $params):void {
  ($f)(...$params);
}

function apply_params_mono((function(int,string):void) $f, int $i, string $s):void {
  ($f)($i, $s);
}
...
function test_poly():void {
  ...
  //apply_params_poly<(int,string)>(foo<>, 2, "A");
}
