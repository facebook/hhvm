...
THRIFT_DATA_MEMBER const folly::StringPiece TStructDataStorage<::cpp2::Request>::name = "Request";
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::Request>::fields_names = {{
  "i",
}};
...
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 1> TStructDataStorage<::cpp2::Request>::storage_names = {{
  "__fbthrift_field_i",
}};
