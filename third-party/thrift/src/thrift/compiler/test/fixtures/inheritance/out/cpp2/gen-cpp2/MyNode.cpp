...
void apache::thrift::ServiceHandler<::cpp2::MyNode>::async_tm_do_mid(apache::thrift::HandlerCallbackPtr<void> callback) {
...
::folly::Range<const ::std::string_view*>(*TSchemaAssociation<::cpp2::MyNode>::bundle)() =
    nullptr;
}
