...
int RuntimeOption::RuntimeErrorReportingLevel = 8191;
...
bool RuntimeOption::ThrowMissingArgument = false;
bool RuntimeOption::ThrowInvalidArgument = false;
bool RuntimeOption::NoticeExtraArguments = true;
...
void RuntimeOption::Load(Hdf &config) {
...

  {
    ...
    RuntimeErrorReportingLevel =
      logger["RuntimeErrorReportingLevel"].getInt32(8191);
  ...
  }
  {
    ...
    ThrowMissingArgument = error["ThrowMissingArgument"].getBool();
    ThrowInvalidArgument = error["ThrowInvalidArgument"].getBool();
    NoticeExtraArguments = error["NoticeExtraArguments"].getBool(true);
