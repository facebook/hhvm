...
__all__ = ['UTF8STRINGS', 'Void', 'JsonType', 'StandardProtocol', 'DurationStruct', 'TimeStruct', 'FractionStruct', 'UriStruct', 'JsonValue', 'TypeUri', 'TypeName', 'ByteString', 'ByteBuffer', 'Fraction', 'SimpleFraction', 'Uuid', 'UuidString', 'Path', 'PathSegments', 'Domain', 'DomainLabels', 'QueryString', 'QueryArgs', 'Uri', 'JsonString', 'Json', 'JsonObject', 'JsonArray']
...
class DurationStruct:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if is_text:
      json_obj = loads(json)
    if 'seconds' in json_obj and json_obj['seconds'] is not None:
      self.seconds = long(json_obj['seconds'])
    if 'nanos' in json_obj and json_obj['nanos'] is not None:
      self.nanos = json_obj['nanos']
      if self.nanos > 0x7fffffff or self.nanos < -0x80000000:
  ...
  def __repr__(self):
    ...
    if self.nanos is not None:
      value = pprint.pformat(self.nanos, indent=0)
      value = padding.join(value.splitlines(True))
      L.append('    nanos=%s' % (value))
  ...
  def _to_py3(self):
    ...
    return thrift.py3.converter.to_py3_struct(py3_types.DurationStruct, self)
...
class TimeStruct:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('TimeStruct')
    if self.seconds != None:
      oprot.writeFieldBegin('seconds', TType.I64, 1)
      oprot.writeI64(self.seconds)
      oprot.writeFieldEnd()
  ...
  def _to_py3(self):
    ...
    import thrift.py3.converter
    py3_types = importlib.import_module("apache.thrift.type.standard.types")
    return thrift.py3.converter.to_py3_struct(py3_types.TimeStruct, self)
...
class JsonValue(object):
  ...
  def get_objectValue(self):
    assert self.field == 6
    return self.value

  def set_boolValue(self, value):
    self.field = 1
    self.value = value
  ...
  def set_objectValue(self, value):
    self.field = 6
    self.value = value
  ...
  def __repr__(self):
    ...
    if self.field == 3:
      padding = ' ' * 11
      value = padding.join(value.splitlines(True))
      member = '\n    %s=%s' % ('floatValue', value)
    if self.field == 4:
      padding = ' ' * 12
      value = padding.join(value.splitlines(True))
      member = '\n    %s=%s' % ('stringValue', value)
    if self.field == 5:
      padding = ' ' * 11
      value = padding.join(value.splitlines(True))
      member = '\n    %s=%s' % ('arrayValue', value)
    if self.field == 6:
      padding = ' ' * 12
      value = padding.join(value.splitlines(True))
      member = '\n    %s=%s' % ('objectValue', value)
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.BOOL:
          _fbthrift_boolValue = iprot.readBool()
          assert self.field == 0 and self.value is None
          self.set_boolValue(_fbthrift_boolValue)
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.I64:
          _fbthrift_intValue = iprot.readI64()
          assert self.field == 0 and self.value is None
          self.set_intValue(_fbthrift_intValue)
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.DOUBLE:
          _fbthrift_floatValue = iprot.readDouble()
          assert self.field == 0 and self.value is None
          self.set_floatValue(_fbthrift_floatValue)
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
          _fbthrift_stringValue = iprot.readString().decode('utf-8') if UTF8STRINGS else iprot.readString()
          assert self.field == 0 and self.value is None
          self.set_stringValue(_fbthrift_stringValue)
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.LIST:
          _fbthrift_arrayValue = []
          (_etype35, _size32) = iprot.readListBegin()
          if _size32 >= 0:
            for _i36 in range(_size32):
              _elem37 = JsonValue()
              _elem37.read(iprot)
              _fbthrift_arrayValue.append(_elem37)
          else: 
            while iprot.peekList():
              _elem38 = JsonValue()
              _elem38.read(iprot)
              _fbthrift_arrayValue.append(_elem38)
          iprot.readListEnd()
          assert self.field == 0 and self.value is None
          self.set_arrayValue(_fbthrift_arrayValue)
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.MAP:
          _fbthrift_objectValue = {}
          ...
          if _size39 >= 0:
            for _i43 in range(_size39):
              ...
              _val45 = JsonValue()
              _val45.read(iprot)
              _fbthrift_objectValue[_key44] = _val45
          else: 
            while iprot.peekMap():
              _key46 = iprot.readString().decode('utf-8') if UTF8STRINGS else iprot.readString()
              _val47 = JsonValue()
              _val47.read(iprot)
              _fbthrift_objectValue[_key46] = _val47
          iprot.readMapEnd()
          assert self.field == 0 and self.value is None
          self.set_objectValue(_fbthrift_objectValue)
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      ...
      return
    oprot.writeUnionBegin('JsonValue')
    if self.field == 1:
      oprot.writeFieldBegin('boolValue', TType.BOOL, 1)
      boolValue = self.value
    ...
    if self.field == 2:
      ...
      oprot.writeFieldEnd()
    if self.field == 3:
      oprot.writeFieldBegin('floatValue', TType.DOUBLE, 3)
    ...
    if self.field == 4:
      ...
      oprot.writeString(stringValue.encode('utf-8')) if UTF8STRINGS and not isinstance(stringValue, bytes) else oprot.writeString(stringValue)
      oprot.writeFieldEnd()
    if self.field == 5:
      oprot.writeFieldBegin('arrayValue', TType.LIST, 5)
      arrayValue = self.value
      oprot.writeListBegin(TType.STRUCT, len(arrayValue))
      for iter48 in arrayValue:
        iter48.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.field == 6:
      oprot.writeFieldBegin('objectValue', TType.MAP, 6)
      objectValue = self.value
      oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(objectValue))
      for kiter49,viter50 in objectValue.items():
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'boolValue' in obj:
      _fbthrift_boolValue = obj['boolValue']
      self.set_boolValue(_fbthrift_boolValue)
    if 'intValue' in obj:
      _fbthrift_intValue = long(obj['intValue'])
      self.set_intValue(_fbthrift_intValue)
    if 'floatValue' in obj:
      _fbthrift_floatValue = float(obj['floatValue'])
      self.set_floatValue(_fbthrift_floatValue)
    if 'stringValue' in obj:
      _fbthrift_stringValue = obj['stringValue']
      self.set_stringValue(_fbthrift_stringValue)
    if 'arrayValue' in obj:
      _fbthrift_arrayValue = []
      for _tmp_e51 in obj['arrayValue']:
        _struct52 = JsonValue()
        _struct52.readFromJson(_tmp_e51, is_text=False, relax_enum_validation=relax_enum_validation, custom_set_cls=set_cls, custom_dict_cls=dict_cls)
        _fbthrift_arrayValue.append(_struct52)
      self.set_arrayValue(_fbthrift_arrayValue)
    if 'objectValue' in obj:
      _fbthrift_objectValue = dict_cls()
      for _tmp_k53, _tmp_v54 in obj['objectValue'].items():
        _tmp_kp55 = _tmp_k53
        _struct56 = JsonValue()
        _struct56.readFromJson(_tmp_v54, is_text=False, relax_enum_validation=relax_enum_validation, custom_set_cls=set_cls, custom_dict_cls=dict_cls)
        _fbthrift_objectValue[_tmp_kp55] = _struct56
      self.set_objectValue(_fbthrift_objectValue)
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("apache.thrift.type.standard.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.JsonValue, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("apache.thrift.type.standard.types")
    return thrift.py3.converter.to_py3_struct(py3_types.JsonValue, self)
...
JsonString = UnimplementedTypedef()
Json = JsonValue
JsonObject = UnimplementedTypedef()
JsonArray = UnimplementedTypedef()
all_structs.append(DurationStruct)
DurationStruct.thrift_spec = (
  None, # 0
  (1, TType.I64, 'seconds', None, None, 2, ), # 1
  (2, TType.I32, 'nanos', None, 0, 2, ), # 2
)

DurationStruct.thrift_struct_annotations = {
  "thrift.uri": "facebook.com/thrift/type/Duration",
}
DurationStruct.thrift_field_annotations = {
}

def DurationStruct__init__(self, seconds=None, nanos=DurationStruct.thrift_spec[2][4],):
  self.seconds = seconds
  self.nanos = nanos

DurationStruct.__init__ = DurationStruct__init__

def DurationStruct__setstate__(self, state):
  state.setdefault('seconds', None)
  state.setdefault('nanos', 0)
  self.__dict__ = state

DurationStruct.__getstate__ = lambda self: self.__dict__.copy()
DurationStruct.__setstate__ = DurationStruct__setstate__

all_structs.append(TimeStruct)
TimeStruct.thrift_spec = (
  None, # 0
  (1, TType.I64, 'seconds', None, None, 2, ), # 1
  (2, TType.I32, 'nanos', None, None, 2, ), # 2
)

TimeStruct.thrift_struct_annotations = {
  "thrift.uri": "facebook.com/thrift/type/Time",
}
TimeStruct.thrift_field_annotations = {
}

def TimeStruct__init__(self, seconds=None, nanos=None,):
  self.seconds = seconds
  self.nanos = nanos

TimeStruct.__init__ = TimeStruct__init__

def TimeStruct__setstate__(self, state):
  state.setdefault('seconds', None)
  state.setdefault('nanos', None)
  self.__dict__ = state

TimeStruct.__getstate__ = lambda self: self.__dict__.copy()
TimeStruct.__setstate__ = TimeStruct__setstate__
...
all_structs.append(JsonValue)
JsonValue.thrift_spec = (
  None, # 0
  (1, TType.BOOL, 'boolValue', None, None, 2, ), # 1
  (2, TType.I64, 'intValue', None, None, 2, ), # 2
  (3, TType.DOUBLE, 'floatValue', None, None, 2, ), # 3
  (4, TType.STRING, 'stringValue', True, None, 2, ), # 4
  (5, TType.LIST, 'arrayValue', (TType.STRUCT,[JsonValue, JsonValue.thrift_spec, True]), None, 2, ), # 5
  (6, TType.MAP, 'objectValue', (TType.STRING,True,TType.STRUCT,[JsonValue, JsonValue.thrift_spec, True]), None, 2, ), # 6
)

JsonValue.thrift_struct_annotations = {
  "cpp.frozen2_exclude": "1",
  "py3.hidden": "1",
}
JsonValue.thrift_field_annotations = {
}

def JsonValue__init__(self, boolValue=None, intValue=None, floatValue=None, stringValue=None, arrayValue=None, objectValue=None,):
  self.field = 0
  self.value = None
...
JsonValue.__init__ = JsonValue__init__
