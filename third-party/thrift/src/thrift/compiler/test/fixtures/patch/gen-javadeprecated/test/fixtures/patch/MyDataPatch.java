...
public class MyDataPatch implements TBase, java.io.Serializable, Cloneable, Comparable<MyDataPatch> {
   ...
   */
  public MyDataFieldPatch patchPrior;
  /**
   * Initialize fields, using the given defaults. Applies third.
   */
  public MyDataEnsureStruct ensure;
  /**
  ...
  static {
    ...
    tmpMetaDataMap.put(ENSURE, new FieldMetaData("ensure", TFieldRequirementType.DEFAULT, 
        new StructMetaData(TType.STRUCT, MyDataEnsureStruct.class)));
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MyDataPatch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public Builder setPatchPrior(final MyDataFieldPatch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }

    public Builder setEnsure(final MyDataEnsureStruct ensure) {
      this.ensure = ensure;
      return this;
    }
   ...
   * Patches any previously set values. Applies second.
   */
  public MyDataFieldPatch getPatchPrior() {
   ...
   * Patches any previously set values. Applies second.
   */
  public MyDataPatch setPatchPrior(MyDataFieldPatch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Initialize fields, using the given defaults. Applies third.
   */
  public MyDataPatch setEnsure(MyDataEnsureStruct ensure) {
    this.ensure = ensure;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((MyDataFieldPatch)__value);
      }
      break;
    ...
    case ENSURE:
      if (__value == null) {
        ...
        setEnsure((MyDataEnsureStruct)__value);
      }
      break;
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof MyDataPatch))
      return false;
  ...
  @Override
  public int compareTo(MyDataPatch other) {
    if (other == null) {
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            this.patchPrior = new MyDataFieldPatch();
        ...
        case ENSURE:
          if (__field.type == TType.STRUCT) {
            this.ensure = new MyDataEnsureStruct();
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MyDataPatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
