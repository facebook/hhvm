...
public class MyStructField30Patch implements TBase, java.io.Serializable, Cloneable, Comparable<MyStructField30Patch> {
   ...
   * 
   */
  public MyStructField30Patch setAssign(Map<String,String> assign) {
    this.assign = assign;
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public MyStructField30Patch setPatchPrior(Map<String,com.facebook.thrift.op.StringPatch> patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Add the given values, if the keys are not already present. Applies forth.
   */
  public MyStructField30Patch setAdd(Map<String,String> add) {
    this.add = add;
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public MyStructField30Patch setPatch(Map<String,com.facebook.thrift.op.StringPatch> patch) {
    this.patch = patch;
    return this;
  }
   ...
   * Adds or replaces the given key/value pairs. Applies fifth.
   */
  public MyStructField30Patch setPut(Map<String,String> put) {
    this.put = put;
    return this;
  }
