...
uint32_t Foo::serializedSize(Protocol_ const* prot_) const {
  ...
  xfer += prot_->serializedStructSize("Foo");
  {
    ...
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::facebook::thrift::compiler::test::fixtures::aliasing::other::Foo, ::apache::thrift::type::struct_t<::facebook::thrift::compiler::test::fixtures::aliasing::other::Foo>>::serializedSize<false>(*prot_, this->__fbthrift_field_other_foo);
  }
  {
    xfer += prot_->serializedFieldSize("yet_another_foo", apache::thrift::protocol::TType::T_STRUCT, 2);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::facebook::thrift::compiler::test::fixtures::aliasing::not_module::Foo, ::apache::thrift::type::struct_t<::facebook::thrift::compiler::test::fixtures::aliasing::not_module::Foo>>::serializedSize<false>(*prot_, this->__fbthrift_field_yet_another_foo);
  }
...
uint32_t Foo::serializedSizeZC(Protocol_ const* prot_) const {
  ...
  {
    xfer += prot_->serializedFieldSize("other_foo", apache::thrift::protocol::TType::T_STRUCT, 1);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::facebook::thrift::compiler::test::fixtures::aliasing::other::Foo, ::apache::thrift::type::struct_t<::facebook::thrift::compiler::test::fixtures::aliasing::other::Foo>>::serializedSize<true>(*prot_, this->__fbthrift_field_other_foo);
  }
  {
    xfer += prot_->serializedFieldSize("yet_another_foo", apache::thrift::protocol::TType::T_STRUCT, 2);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::facebook::thrift::compiler::test::fixtures::aliasing::not_module::Foo, ::apache::thrift::type::struct_t<::facebook::thrift::compiler::test::fixtures::aliasing::not_module::Foo>>::serializedSize<true>(*prot_, this->__fbthrift_field_yet_another_foo);
  }
  xfer += prot_->serializedSizeStop();
  return xfer;
}
...
uint32_t Foo::write(Protocol_* prot_) const {
  ...
  bool previousFieldHasValue = true;
  {
    ...
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::facebook::thrift::compiler::test::fixtures::aliasing::other::Foo, ::apache::thrift::type::struct_t<::facebook::thrift::compiler::test::fixtures::aliasing::other::Foo>>::write(*prot_, this->__fbthrift_field_other_foo);
  ...
  }
  {
    ...
    previousFieldHasValue = true;
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::structure, ::facebook::thrift::compiler::test::fixtures::aliasing::not_module::Foo, ::apache::thrift::type::struct_t<::facebook::thrift::compiler::test::fixtures::aliasing::not_module::Foo>>::write(*prot_, this->__fbthrift_field_yet_another_foo);
    xfer += prot_->writeFieldEnd();
  }
