...
public class MyStruct implements TBase, java.io.Serializable, Cloneable {
  ...
  public final DurationStruct durationVal;
  public final TimeStruct timeVal;
  ...
  public DurationStruct getDurationVal() {
  ...
  public static MyStruct deserialize(TProtocol iprot) throws TException {
    ...
    DurationStruct tmp_durationVal = null;
    TimeStruct tmp_timeVal = null;
    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
        ...
        case DURATIONVAL:
          if (__field.type == TType.STRUCT) {
            tmp_durationVal = DurationStruct.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case TIMEVAL:
          if (__field.type == TType.STRUCT) {
            tmp_timeVal = TimeStruct.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
