...
function f2(Counter $p1, Counter $p2): void {
  ...
  $v1 = $p1 +
    $p2; // int-like operations are allowed because of Counter's constraint
}
...
class C_Fullname {
  ...
  public static function fa(
    TTA_class_Fullname $p1,
    array<TTA_class_Fullname> $p2,
  ): void {
    $v = $p1->firstName;
    $v = $p2[0]->lastName;
  }
  ...
  public static function fb(
    OTA_class_Fullname $p1,
    array<OTA_class_Fullname> $p2,
  ): void {
    //    $v = $p1->firstName;
    //    $v = $p2[0]->lastName;
  }
...
class C_MyCollection {
  public static function fa(
    TTA_interface_MyCollection1 $p1,
    TTA_interface_MyCollection3 $p2,
  ): void {}
  public static function fb(
    TTA_interface_MyCollection1 $p1,
    TTA_interface_MyCollection3 $p2,
...
function addComplex(
  TTA_shape_complex $c1,
  TTA_shape_complex $c2,
): TTA_shape_complex {
  $result = $c1;
  //	...
  return $result;
