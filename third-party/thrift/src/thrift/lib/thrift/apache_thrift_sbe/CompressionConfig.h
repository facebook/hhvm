...
class CompressionConfig {
 ...
 public:
  ...
  CompressionConfig(char* buffer, const std::uint64_t bufferLength)
  ...
  SBE_NODISCARD static const char* CodecConfigMetaAttribute(
  ...
  static SBE_CONSTEXPR std::uint16_t codecConfigId() SBE_NOEXCEPT { return -1; }

  SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t codecConfigSinceVersion()
      SBE_NOEXCEPT {
    return 0;
  }

  SBE_NODISCARD bool codecConfigInActingVersion() SBE_NOEXCEPT { return true; }

  SBE_NODISCARD static SBE_CONSTEXPR std::size_t codecConfigEncodingOffset()
      SBE_NOEXCEPT {
    return 0;
  }
 ...
 public:
  ...
  SBE_NODISCARD static const char* compressionSizeLimitMetaAttribute(
      const MetaAttribute metaAttribute) SBE_NOEXCEPT {
    switch (metaAttribute) {
      case MetaAttribute::PRESENCE:
        return "required";
  ...
  compressionSizeLimitSinceVersion() SBE_NOEXCEPT {
    return 0;
  }
  ...
  compressionSizeLimitEncodingOffset() SBE_NOEXCEPT {
    return 1;
  }

  static SBE_CONSTEXPR std::int64_t compressionSizeLimitNullValue()
      SBE_NOEXCEPT {
    return SBE_NULLVALUE_INT64;
  }

  static SBE_CONSTEXPR std::int64_t compressionSizeLimitMinValue()
      SBE_NOEXCEPT {
    return INT64_C(-9223372036854775807);
  }

  static SBE_CONSTEXPR std::int64_t compressionSizeLimitMaxValue()
      SBE_NOEXCEPT {
    return INT64_C(9223372036854775807);
  }

  static SBE_CONSTEXPR std::size_t compressionSizeLimitEncodingLength()
      SBE_NOEXCEPT {
    return 8;
  }
  ...
  CompressionConfig& compressionSizeLimit(const std::int64_t value)
      SBE_NOEXCEPT {
