...
class ServiceHandler<::test::namespace_from_package_without_module_name::TestService> : public apache::thrift::ServerInterface {
  static_assert(!folly::is_detected_v<detail::st::detect_complete, ::test::namespace_from_package_without_module_name::TestService>, "Definition collision with service tag. Either rename the Thrift service using @cpp.Name annotation or rename the conflicting C++ type.");
