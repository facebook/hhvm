...
bool TestCodeRun::TestArrayForEach() {
  MVCR("<?php\n"
    "function testInternalPointerDuringForeach(\n"
    "    $checkKey = -1, $checkKey2 = -1,\n"
    "    $breakKey = -1, $loopKey = false,\n"
    "    $op = 'none') {\n"
    ...
    "  var_dump(current($arr));\n"
    "}\n"
    "$ops = array('none', 'key', 'current', 'next', 'prev', 'reset', 'end');\n"
    "foreach ($ops as $op) {\n"
    "  echo \"-------------------------------------------------------\\n\";\n"
    "  echo $op . \"\\n\";\n"
    "  echo \"-------------------------------------------------------\\n\";\n"
    "  testInternalPointerDuringForeach(-1, -1, -1, -1, $op);\n"
    "  echo \"-------------------------------------------------------\\n\";\n"
    "  testInternalPointerDuringForeach(4, -1, -1, -1, $op);\n"
    "  echo \"-------------------------------------------------------\\n\";\n"
    "  testInternalPointerDuringForeach(4, 6, -1, -1, $op);\n"
    "}\n");
