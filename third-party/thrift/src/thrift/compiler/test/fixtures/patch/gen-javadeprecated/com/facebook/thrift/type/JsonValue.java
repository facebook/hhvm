...
public class JsonValue extends TUnion<JsonValue> {
  ...
  static {
    ...
    tmpMetaDataMap.put(BOOLVALUE, new FieldMetaData("boolValue", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.BOOL)));
    tmpMetaDataMap.put(INTVALUE, new FieldMetaData("intValue", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.I64)));
    tmpMetaDataMap.put(FLOATVALUE, new FieldMetaData("floatValue", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.DOUBLE)));
    tmpMetaDataMap.put(STRINGVALUE, new FieldMetaData("stringValue", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.STRING)));
    tmpMetaDataMap.put(ARRAYVALUE, new FieldMetaData("arrayValue", TFieldRequirementType.DEFAULT, 
        new ListMetaData(TType.LIST, 
            new StructMetaData(TType.STRUCT, JsonValue.class))));
    tmpMetaDataMap.put(OBJECTVALUE, new FieldMetaData("objectValue", TFieldRequirementType.DEFAULT, 
  ...
  protected void checkType(short setField, Object __value) throws ClassCastException {
    switch (setField) {
      case BOOLVALUE:
        ...
        throw new ClassCastException("Was expecting value of type Boolean for field 'boolValue', but got " + __value.getClass().getSimpleName());
      case INTVALUE:
      ...
      case FLOATVALUE:
        ...
        throw new ClassCastException("Was expecting value of type Double for field 'floatValue', but got " + __value.getClass().getSimpleName());
      case STRINGVALUE:
      ...
      case ARRAYVALUE:
        ...
        throw new ClassCastException("Was expecting value of type List<JsonValue> for field 'arrayValue', but got " + __value.getClass().getSimpleName());
      case OBJECTVALUE:
        if (__value instanceof Map) {
          break;
        }
        throw new ClassCastException("Was expecting value of type Map<String,JsonValue> for field 'objectValue', but got " + __value.getClass().getSimpleName());
      default:
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    if (__field.type != TType.STOP)
    {
      ...
      if (__stopField.type != TType.STOP) {
        throw new TProtocolException(TProtocolException.INVALID_DATA, "Union 'JsonValue' is missing a STOP byte");
      }
    }
    iprot.readStructEnd();
  }
