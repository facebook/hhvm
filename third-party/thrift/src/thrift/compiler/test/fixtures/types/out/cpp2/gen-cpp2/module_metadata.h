...
class ServiceMetadata<::apache::thrift::ServiceHandler<::apache::thrift::fixtures::types::SomeService>> {
 ...
 private:
  ...
  static void gen_bounce_map(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
  static void gen_binary_keyed_map(ThriftMetadata& metadata, ThriftService& context, std::size_t index, std::size_t schemaIndex);
};
} // namespace md
} // namespace detail
} // namespace thrift
