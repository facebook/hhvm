...
pub struct Foo {
    pub other_foo: module__types::Foo,
    pub yet_another_foo: not_module__types::Foo,
...
impl ::std::default::Default for self::Foo {
    fn default() -> Self {
        Self {
            other_foo: ::std::default::Default::default(),
            yet_another_foo: ::std::default::Default::default(),
...
impl ::std::fmt::Debug for self::Foo {
    fn fmt(&self, formatter: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        formatter
            .debug_struct("Foo")
            .field("other_foo", &self.other_foo)
            .field("yet_another_foo", &self.yet_another_foo)
            .finish()
    }
}
...
impl ::fbthrift::GetUri for self::Foo {
    fn uri() -> &'static ::std::primitive::str {
        "facebook.com/thrift/compiler/test/fixtures/aliasing/Foo"
    }
}
    ...
    P: ::fbthrift::ProtocolWriter,
{
    ...
    fn rs_thrift_write(&self, p: &mut P) {
        ...
        p.write_field_begin("other_foo", ::fbthrift::TType::Struct, 1);
        ::fbthrift::Serialize::rs_thrift_write(&self.other_foo, p);
        p.write_field_end();
        p.write_field_begin("yet_another_foo", ::fbthrift::TType::Struct, 2);
        ::fbthrift::Serialize::rs_thrift_write(&self.yet_another_foo, p);
        p.write_field_end();
        p.write_field_stop();
        p.write_struct_end();
    }
    ...
    P: ::fbthrift::ProtocolReader,
{
    ...
    fn rs_thrift_read(p: &mut P) -> ::anyhow::Result<Self> {
        static FIELDS: &[::fbthrift::Field] = &[
            ::fbthrift::Field::new("other_foo", ::fbthrift::TType::Struct, 1),
            ::fbthrift::Field::new("yet_another_foo", ::fbthrift::TType::Struct, 2),
        ];
        ...
        let fallback  = 'fastpath: {
            if (fty, fid) == (::fbthrift::TType::Struct, 1) {
                output.other_foo = ::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingFieldError { field: "other_foo", strct: "Foo"})?;
                p.read_field_end()?;
            } else {
                break 'fastpath true;
            }
            ...
            if (fty, fid) == (::fbthrift::TType::Struct, 2) {
                output.yet_another_foo = ::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingFieldError { field: "yet_another_foo", strct: "Foo"})?;
                p.read_field_end()?;
            } else {
                break 'fastpath true;
            }
        ...
        if fallback {
            loop {
                match (fty, fid) {
                    ...
                    (::fbthrift::TType::Struct, 1) => output.other_foo = ::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingFieldError { field: "other_foo", strct: "Foo"})?,
                    (::fbthrift::TType::Struct, 2) => output.yet_another_foo = ::anyhow::Context::context(::fbthrift::Deserialize::rs_thrift_read(p), ::fbthrift::errors::DeserializingFieldError { field: "yet_another_foo", strct: "Foo"})?,
                    (fty, _) => p.skip(fty)?,
                }
                p.read_field_end()?;
                (_, fty, fid) = p.read_field_begin(|_| (), FIELDS)?;
