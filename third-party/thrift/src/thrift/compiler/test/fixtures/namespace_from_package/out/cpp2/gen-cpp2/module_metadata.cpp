...
const ThriftServiceContextRef* ServiceMetadata<::apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>>::genRecurse([[maybe_unused]] ThriftMetadata& metadata, std::vector<ThriftServiceContextRef>& services) {
  ...
  module_TestService.name() = "test.dev/namespace_from_package/module/TestService";
  ...
  metadata.services()->emplace("test.dev/namespace_from_package/module/TestService", std::move(module_TestService));
  context.service_name() = "test.dev/namespace_from_package/module/TestService";
