...
cdef api void call_cy_NestedContainers_listMap(
    ...
    cdef Promise_cFollyUnit __promise = Promise_cFollyUnit._fbthrift_create(cmove(cPromise))
    arg_foo = _module_types.List__Map__i32_i32._create_FBTHRIFT_ONLY_DO_NOT_USE(__to_shared_ptr(cmove(foo)))
    __context = RequestContext._fbthrift_create(ctx)
    __context_token = __THRIFT_REQUEST_CONTEXT.set(__context)
    asyncio.get_event_loop().create_task(
...
cdef api void call_cy_NestedContainers_listSet(
    ...
    cdef Promise_cFollyUnit __promise = Promise_cFollyUnit._fbthrift_create(cmove(cPromise))
    arg_foo = _module_types.List__Set__i32._create_FBTHRIFT_ONLY_DO_NOT_USE(__to_shared_ptr(cmove(foo)))
    __context = RequestContext._fbthrift_create(ctx)
    __context_token = __THRIFT_REQUEST_CONTEXT.set(__context)
    asyncio.get_event_loop().create_task(
...
cdef api void call_cy_NestedContainers_turtles(
    ...
    cdef Promise_cFollyUnit __promise = Promise_cFollyUnit._fbthrift_create(cmove(cPromise))
    arg_foo = _module_types.List__List__Map__i32_Map__i32_Set__i32._create_FBTHRIFT_ONLY_DO_NOT_USE(__to_shared_ptr(cmove(foo)))
    __context = RequestContext._fbthrift_create(ctx)
    __context_token = __THRIFT_REQUEST_CONTEXT.set(__context)
    asyncio.get_event_loop().create_task(
