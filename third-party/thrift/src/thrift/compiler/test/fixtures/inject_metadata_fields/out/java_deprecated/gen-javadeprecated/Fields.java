...
public class Fields implements TBase, java.io.Serializable, Cloneable, Comparable<Fields> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(Fields.class, metaDataMap);
  }
  ...
  public Fields setInjected_field(String injected_field) {
    this.injected_field = injected_field;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof Fields))
      return false;
    Fields that = (Fields)_that;
