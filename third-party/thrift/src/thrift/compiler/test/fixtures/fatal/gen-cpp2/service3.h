...
class ServiceHandler<::test_cpp2::cpp_reflection::service3> : public apache::thrift::ServerInterface {
 ...
 public:
  ...
  virtual void methodF(::test_cpp2::cpp_reflection::struct3& /*_return*/, ::std::int32_t /*l*/, std::unique_ptr<::test_cpp2::cpp_reflection::struct1> /*m*/, double /*n*/);
...
class service3AsyncProcessor : public ::apache::thrift::GeneratedAsyncProcessor {
 ...
 public:
  using ProcessFuncs = GeneratedAsyncProcessor::ProcessFuncs<service3AsyncProcessor>;
