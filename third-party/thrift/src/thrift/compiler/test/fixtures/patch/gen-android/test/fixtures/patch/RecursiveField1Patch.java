          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_assign = new HashMap<String,Recursive>(Math.max(0, 2*_map261.size));
              for (int _i262 = 0; 
                   ...
                   ++_i262)
              {
                ...
                _val264 = Recursive.deserialize(iprot);
                tmp_assign.put(_key263, _val264);
              }
              iprot.readMapEnd();
            }
          } else {
    ...
    if (this.assign != null) {
      if (isSetAssign()) {
        oprot.writeFieldBegin(ASSIGN_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Recursive> _iter265 : this.assign.entrySet())          {
