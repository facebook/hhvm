...
abstract class Framework {
  ...
  protected function __construct(private string $name,
    ...
    $this->setTestNamePattern(Options::getFrameworkInfo($name, "test_name_regex"));
    $this->setTestFilePattern(Options::getFrameworkInfo($name, "test_file_regex"));
  ...
  private function setTestCommand(bool $redirect = true): void {
    ...
    if ($this->parallel) {
      $this->test_command .= Options::$test_by_single_test
        ? " --filter"
        : " '%test%'";
    }
    if ($redirect) {
