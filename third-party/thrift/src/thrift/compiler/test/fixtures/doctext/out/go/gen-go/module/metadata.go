...
var structMetadatas = func() []*metadata.ThriftStruct {
    ...
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_U))
    return fbthriftResults
}()

var exceptionMetadatas = func() []*metadata.ThriftException {
    fbthriftResults := make([]*metadata.ThriftException, 0)
    fbthriftResults = append(fbthriftResults, getMetadataThriftException(premadeStructSpec_Bang))
    return fbthriftResults
}()
