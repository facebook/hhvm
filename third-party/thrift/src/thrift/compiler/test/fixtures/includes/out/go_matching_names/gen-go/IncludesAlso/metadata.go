...
var (
    premadeThriftType_IncludesAlso_Also = func() *metadata.ThriftType {
        return &metadata.ThriftType{
            TStruct: &metadata.ThriftStructType{
    Name: "IncludesAlso.Also",
},
...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    fbthriftThriftTypesMap["IncludesAlso.Also"] = premadeThriftType_IncludesAlso_Also
    return fbthriftThriftTypesMap
}()

var structMetadatas = func() []*metadata.ThriftStruct {
    fbthriftResults := make([]*metadata.ThriftStruct, 0)
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_Also))
