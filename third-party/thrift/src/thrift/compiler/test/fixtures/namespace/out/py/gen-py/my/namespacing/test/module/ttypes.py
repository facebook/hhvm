...
class Foo:
  ...
  def _to_python(self):
    ...
    python_types = importlib.import_module("my.namespacing.test.module.module.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.Foo, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("my.namespacing.test.module.module.thrift_mutable_types")
