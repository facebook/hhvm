...
cdef class __MyStruct_FieldsSetter(__StructFieldsSetter):
    ...
    cdef void _set_field_2(self, _fbthrift_value) except *:
        ...
        if not isinstance(_fbthrift_value, _module_types.MyDataItem):
            _fbthrift_value = _from_python_or_raise(_fbthrift_value, "MyDataField", _module_types.MyDataItem)
        deref(self._struct_cpp_obj).MyDataField_ref().assign(deref((<_module_types.MyDataItem?> _fbthrift_value)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    cdef void _set_field_3(self, _fbthrift_value) except *:
        ...
        deref(self._struct_cpp_obj).myEnum_ref().assign(<_module_cbindings.cMyEnum><int>_fbthrift_value)
    ...
    cdef void _set_field_7(self, _fbthrift_value) except *:
        ...
        if _fbthrift_value is None:
            ...
            return
        deref(self._struct_cpp_obj).floatSet_ref().assign(_module_types.Set__float__make_instance(_fbthrift_value))
...
cdef class __Containers_FieldsSetter(__StructFieldsSetter):
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        # for field I32List
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cContainers](deref(self._struct_cpp_obj), 0)
            return
        deref(self._struct_cpp_obj).I32List_ref().assign(_module_types.List__i32__make_instance(_fbthrift_value))

    cdef void _set_field_1(self, _fbthrift_value) except *:
        # for field StringSet
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cContainers](deref(self._struct_cpp_obj), 1)
            return
        deref(self._struct_cpp_obj).StringSet_ref().assign(_module_types.Set__string__make_instance(_fbthrift_value))

    cdef void _set_field_2(self, _fbthrift_value) except *:
        # for field StringToI64Map
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cContainers](deref(self._struct_cpp_obj), 2)
            return
        deref(self._struct_cpp_obj).StringToI64Map_ref().assign(_module_types.Map__string_i64__make_instance(_fbthrift_value))
...
cdef class __MyException_FieldsSetter(__StructFieldsSetter):
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        # for field MyIntField
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyException](deref(self._struct_cpp_obj), 0)
            return
        if not isinstance(_fbthrift_value, int):
            raise TypeError(f'MyIntField is not a { int !r}.')
        _fbthrift_value = <cint64_t> _fbthrift_value
    ...
    cdef void _set_field_1(self, _fbthrift_value) except *:
        # for field MyStringField
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyException](deref(self._struct_cpp_obj), 1)
            return
        if not isinstance(_fbthrift_value, str):
            raise TypeError(f'MyStringField is not a { str !r}.')
        deref(self._struct_cpp_obj).MyStringField_ref().assign(cmove(bytes_to_string(_fbthrift_value.encode('utf-8'))))
    ...
    cdef void _set_field_2(self, _fbthrift_value) except *:
        # for field myStruct
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyException](deref(self._struct_cpp_obj), 2)
            return
        if not isinstance(_fbthrift_value, _module_types.MyStruct):
            _fbthrift_value = _from_python_or_raise(_fbthrift_value, "myStruct", _module_types.MyStruct)
        deref(self._struct_cpp_obj).myStruct_ref().assign(deref((<_module_types.MyStruct?> _fbthrift_value)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))

    cdef void _set_field_3(self, _fbthrift_value) except *:
        # for field myUnion
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyException](deref(self._struct_cpp_obj), 3)
            return
        if not isinstance(_fbthrift_value, _module_types.MyUnion):
            _fbthrift_value = _from_python_or_raise(_fbthrift_value, "myUnion", _module_types.MyUnion)
        deref(self._struct_cpp_obj).myUnion_ref().assign(deref((<_module_types.MyUnion?> _fbthrift_value)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
...
cdef class __MyExceptionWithMessage_FieldsSetter(__StructFieldsSetter):
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        # for field MyIntField
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyExceptionWithMessage](deref(self._struct_cpp_obj), 0)
            return
        if not isinstance(_fbthrift_value, int):
            raise TypeError(f'MyIntField is not a { int !r}.')
        _fbthrift_value = <cint64_t> _fbthrift_value
    ...
    cdef void _set_field_1(self, _fbthrift_value) except *:
        # for field MyStringField
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyExceptionWithMessage](deref(self._struct_cpp_obj), 1)
            return
        if not isinstance(_fbthrift_value, str):
            raise TypeError(f'MyStringField is not a { str !r}.')
        deref(self._struct_cpp_obj).MyStringField_ref().assign(cmove(bytes_to_string(_fbthrift_value.encode('utf-8'))))
    ...
    cdef void _set_field_2(self, _fbthrift_value) except *:
        # for field myStruct
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyExceptionWithMessage](deref(self._struct_cpp_obj), 2)
            return
        if not isinstance(_fbthrift_value, _module_types.MyStruct):
            _fbthrift_value = _from_python_or_raise(_fbthrift_value, "myStruct", _module_types.MyStruct)
        deref(self._struct_cpp_obj).myStruct_ref().assign(deref((<_module_types.MyStruct?> _fbthrift_value)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
    ...
    cdef void _set_field_3(self, _fbthrift_value) except *:
        # for field myUnion
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cMyExceptionWithMessage](deref(self._struct_cpp_obj), 3)
            return
        if not isinstance(_fbthrift_value, _module_types.MyUnion):
            _fbthrift_value = _from_python_or_raise(_fbthrift_value, "myUnion", _module_types.MyUnion)
        deref(self._struct_cpp_obj).myUnion_ref().assign(deref((<_module_types.MyUnion?> _fbthrift_value)._cpp_obj_FBTHRIFT_ONLY_DO_NOT_USE))
...
cdef class __ReservedKeyword_FieldsSetter(__StructFieldsSetter):
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        ...
        if _fbthrift_value is None:
            __reset_field[_module_cbindings.cReservedKeyword](deref(self._struct_cpp_obj), 0)
            return
        if not isinstance(_fbthrift_value, int):
