...
class C {
    function foo(int $x, int $y, named int $a,
                 named int $b = 4, named int $c = 5, int ...$args) {
        $v = vec[];
        $v[] = $x;
        $v[] = $y;
        $v[] = $a;
...
function dispatch(C $c) {
    $c->foo(1, 2, a=30, b=40, c=50);
    $c->foo(1, 2, a=30, c=50);
    $c->foo(1, 2, a=30, b=40);
    $c->foo(1, 2, a=30, b=40, 8, 9, 10, 11);
