          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_assign = new HashMap<String,Integer>(Math.max(0, 2*_map212.size));
              for (int _i213 = 0; 
                   ...
                   ++_i213)
              {
                ...
                tmp_assign.put(_key214, _val215);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_patchPrior = new HashMap<String,I32Patch>(Math.max(0, 2*_map216.size));
              for (int _i217 = 0; 
                   ...
                   ++_i217)
              {
                ...
                _val219 = I32Patch.deserialize(iprot);
                tmp_patchPrior.put(_key218, _val219);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_add = new HashMap<String,Integer>(Math.max(0, 2*_map220.size));
              for (int _i221 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_patch = new HashMap<String,I32Patch>(Math.max(0, 2*_map224.size));
              for (int _i225 = 0; 
                   ...
                   ++_i225)
              {
                ...
                _val227 = I32Patch.deserialize(iprot);
                tmp_patch.put(_key226, _val227);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<String>(Math.max(0, 2*_set228.size));
              for (int _i229 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_put = new HashMap<String,Integer>(Math.max(0, 2*_map231.size));
              for (int _i232 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.patchPrior != null) {
      oprot.writeFieldBegin(PATCH_PRIOR_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, I32Patch> _iter236 : this.patchPrior.entrySet())        {
    ...
    if (this.patch != null) {
      oprot.writeFieldBegin(PATCH_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, I32Patch> _iter238 : this.patch.entrySet())        {
