          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_assign = new HashMap<String,Recursive>(Math.max(0, 2*_map281.size));
              for (int _i282 = 0; 
                   ...
                   ++_i282)
              {
                ...
                _val284 = Recursive.deserialize(iprot);
                tmp_assign.put(_key283, _val284);
              }
              iprot.readMapEnd();
            }
          } else {
    ...
    if (this.assign != null) {
      if (isSetAssign()) {
        oprot.writeFieldBegin(ASSIGN_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Recursive> _iter285 : this.assign.entrySet())          {
