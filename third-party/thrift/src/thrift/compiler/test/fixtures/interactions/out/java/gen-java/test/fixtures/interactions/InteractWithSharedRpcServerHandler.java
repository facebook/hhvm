...
public class InteractWithSharedRpcServerHandler 
  ...
  private final java.util.List<com.facebook.thrift.payload.Reader> _doSomeSimilarThingsReaders;

  private final java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers;

  public InteractWithSharedRpcServerHandler(InteractWithShared _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new InteractWithSharedBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public InteractWithSharedRpcServerHandler(InteractWithShared.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new InteractWithSharedAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public InteractWithSharedRpcServerHandler(InteractWithShared.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
  ...
  private static java.util.List<com.facebook.thrift.payload.Reader> _create_doSomeSimilarThings_request_readers() {
  ...
  private static com.facebook.thrift.payload.Writer _create_doSomeSimilarThings_response_writer(
      ...
      try {
        ...
        test.fixtures.another_interactions.DoSomethingResult _fbthriftVar0 = (test.fixtures.another_interactions.DoSomethingResult)_r;
  ...
  private static reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload>
    ...
    com.facebook.swift.service.ContextChain _chain) {
          ...
          reactor.core.publisher.Mono<test.fixtures.another_interactions.DoSomethingResult> _delegateResponse =
            _delegate
              .doSomeSimilarThings();
          ...
          reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload> _internalResponse =
            _delegateResponse.map(_response -> {
              ...
              com.facebook.thrift.payload.ServerResponsePayload _serverResponsePayload =
                com.facebook.thrift.util.RpcPayloadUtil.createServerResponsePayload(
                  _payload,
                  _create_doSomeSimilarThings_response_writer(_response, _chain, _payload.getMessageSeqId()));
              ...
              reactor.core.publisher.Mono.fromSupplier(
                () -> {
                  org.apache.thrift.TApplicationException _tApplicationException =
                    new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "method doSomeSimilarThings returned null");
            ...
            .<com.facebook.thrift.payload.ServerResponsePayload>onErrorResume(_t -> {
                ...
                String _errorMessage = String.format("Internal error processing doSomeSimilarThings: %s", _t.getMessage() == null ? "<null>" : _t.getMessage());
                org.apache.thrift.TApplicationException _tApplicationException =
  ...
  public reactor.core.publisher.Flux<com.facebook.thrift.payload.ServerResponsePayload> singleRequestStreamingResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    final String _qualifiedMethodName = "InteractWithShared." + _name;
