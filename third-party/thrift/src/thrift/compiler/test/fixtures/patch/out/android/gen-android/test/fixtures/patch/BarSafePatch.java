...
public class BarSafePatch implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("BarSafePatch");
   ...
   */
  public BarSafePatch(BarSafePatch other) {
  ...
  public BarSafePatch deepCopy() {
    return new BarSafePatch(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof BarSafePatch))
      return false;
    BarSafePatch that = (BarSafePatch)_that;
  ...
  public static BarSafePatch deserialize(TProtocol iprot) throws TException {
