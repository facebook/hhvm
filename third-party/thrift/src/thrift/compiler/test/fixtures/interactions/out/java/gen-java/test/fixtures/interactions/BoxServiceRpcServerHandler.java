...
public class BoxServiceRpcServerHandler 
  ...
  private final java.util.List<com.facebook.thrift.payload.Reader> _getABoxSessionReaders;

  private final java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers;

  public BoxServiceRpcServerHandler(BoxService _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new BoxServiceBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public BoxServiceRpcServerHandler(BoxService.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new BoxServiceAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public BoxServiceRpcServerHandler(BoxService.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    ...
    _methodMap.put("getABoxSession", this);
    _getABoxSessionReaders = _create_getABoxSession_request_readers();


  }


  private static java.util.List<com.facebook.thrift.payload.Reader> _create_getABoxSession_request_readers() {
    java.util.List<com.facebook.thrift.payload.Reader> _readerList = new java.util.ArrayList<>();

    _readerList.add(Readers.wrap(test.fixtures.interactions.ShouldBeBoxed.asReader()));

    return _readerList;
  }

  private static com.facebook.thrift.payload.Writer _create_getABoxSession_response_writer(
  ...
  private static reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload>
    ...
    com.facebook.swift.service.ContextChain _chain) {
          ...
          test.fixtures.interactions.ShouldBeBoxed req = (test.fixtures.interactions.ShouldBeBoxed) _iterator.next();

          _chain.postRead(_data);

          reactor.core.publisher.Mono<test.fixtures.interactions.ShouldBeBoxed> _delegateResponse =
            _delegate
              .getABoxSession(req);
          ...
          reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload> _internalResponse =
            _delegateResponse.map(_response -> {
              ...
              com.facebook.thrift.payload.ServerResponsePayload _serverResponsePayload =
                com.facebook.thrift.util.RpcPayloadUtil.createServerResponsePayload(
                  _payload,
                  _create_getABoxSession_response_writer(_response, _chain, _payload.getMessageSeqId()));
              ...
              reactor.core.publisher.Mono.fromSupplier(
                () -> {
                  org.apache.thrift.TApplicationException _tApplicationException =
                    new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "method getABoxSession returned null");
            ...
            .<com.facebook.thrift.payload.ServerResponsePayload>onErrorResume(_t -> {
                ...
                String _errorMessage = String.format("Internal error processing getABoxSession: %s", _t.getMessage() == null ? "<null>" : _t.getMessage());
                org.apache.thrift.TApplicationException _tApplicationException =
  ...
  public reactor.core.publisher.Flux<com.facebook.thrift.payload.ServerResponsePayload> singleRequestStreamingResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    final String _qualifiedMethodName = "BoxService." + _name;
  ...
  public reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload> singleRequestSingleResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    try {
      switch (_name) {
        case "getABoxSession":
          _result = _dogetABoxSession(_delegate, _payload, _getABoxSessionReaders, _chain);
        break;
        default: {
            _chain.preRead();
            org.apache.thrift.TApplicationException _tApplicationException = new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.UNKNOWN_METHOD, "no method found with name " + _name);
