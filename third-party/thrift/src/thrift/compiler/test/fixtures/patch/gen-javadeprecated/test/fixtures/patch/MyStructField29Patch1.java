          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.assign = new HashMap<String,Integer>(Math.max(0, 2*_map139.size));
              for (int _i140 = 0; 
                   ...
                   ++_i140)
              {
                ...
                this.assign.put(_key141, _val142);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.patchPrior = new HashMap<String,com.facebook.thrift.op.I32Patch>(Math.max(0, 2*_map143.size));
              for (int _i144 = 0; 
                   (_map143.size < 0) ? iprot.peekMap() : (_i144 < _map143.size); 
                   ++_i144)
              {
                String _key145;
                com.facebook.thrift.op.I32Patch _val146;
                _key145 = iprot.readString();
                _val146 = new com.facebook.thrift.op.I32Patch();
                _val146.read(iprot);
                this.patchPrior.put(_key145, _val146);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.add = new HashMap<String,Integer>(Math.max(0, 2*_map147.size));
              for (int _i148 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.patch = new HashMap<String,com.facebook.thrift.op.I32Patch>(Math.max(0, 2*_map151.size));
              for (int _i152 = 0; 
                   (_map151.size < 0) ? iprot.peekMap() : (_i152 < _map151.size); 
                   ++_i152)
              {
                String _key153;
                com.facebook.thrift.op.I32Patch _val154;
                _key153 = iprot.readString();
                _val154 = new com.facebook.thrift.op.I32Patch();
                _val154.read(iprot);
                this.patch.put(_key153, _val154);
              }
              iprot.readMapEnd();
            }
          } else {
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.remove = new HashSet<String>(Math.max(0, 2*_set155.size));
              for (int _i156 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              this.put = new HashMap<String,Integer>(Math.max(0, 2*_map158.size));
              for (int _i159 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.patchPrior != null) {
      oprot.writeFieldBegin(PATCH_PRIOR_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, com.facebook.thrift.op.I32Patch> _iter163 : this.patchPrior.entrySet())        {
    ...
    if (this.patch != null) {
      oprot.writeFieldBegin(PATCH_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, com.facebook.thrift.op.I32Patch> _iter165 : this.patch.entrySet())        {
