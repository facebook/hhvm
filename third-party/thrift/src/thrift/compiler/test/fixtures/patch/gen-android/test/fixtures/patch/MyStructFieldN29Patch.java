          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_assign = new HashSet<String>(Math.max(0, 2*_set39.size));
              for (int _i40 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<String>(Math.max(0, 2*_set42.size));
              for (int _i43 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_add = new HashSet<String>(Math.max(0, 2*_set45.size));
              for (int _i46 = 0; 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.assign != null) {
      if (isSetAssign()) {
        oprot.writeFieldBegin(ASSIGN_FIELD_DESC);
        {
          ...
          for (String _iter48 : this.assign)          {
    ...
    if (this.remove != null) {
      oprot.writeFieldBegin(REMOVE_FIELD_DESC);
      {
        ...
        for (String _iter49 : this.remove)        {
