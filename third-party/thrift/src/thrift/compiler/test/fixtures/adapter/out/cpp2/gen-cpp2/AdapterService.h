...
#endif
  virtual void async_tm_count(apache::thrift::HandlerCallback<std::unique_ptr<::facebook::thrift::test::CountingStruct>>::Ptr callback);
...
#endif
  virtual void async_tm_adaptedTypes(apache::thrift::HandlerCallback<std::unique_ptr<::facebook::thrift::test::HeapAllocated>>::Ptr callback, std::unique_ptr<::facebook::thrift::test::HeapAllocated> p_arg);
 private:
