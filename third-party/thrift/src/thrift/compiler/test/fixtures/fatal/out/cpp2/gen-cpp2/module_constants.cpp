...
::std::string_view _fbthrift_schema_88e292afa83da650() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_88e292afa83da650_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_88e292afa83da650_uris() {
  return {};
}
