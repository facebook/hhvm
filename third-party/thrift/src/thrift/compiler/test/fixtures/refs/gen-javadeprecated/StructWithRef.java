...
public class StructWithRef implements TBase, java.io.Serializable, Cloneable, Comparable<StructWithRef> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(StructWithRef.class, metaDataMap);
  }
  ...
  public StructWithRef setDef_field(Empty def_field) {
    this.def_field = def_field;
    return this;
  }
  ...
  public StructWithRef setOpt_field(Empty opt_field) {
    this.opt_field = opt_field;
    return this;
  }
  ...
  public StructWithRef setReq_field(Empty req_field) {
    this.req_field = req_field;
    return this;
  }
  ...
  @Override
  public int compareTo(StructWithRef other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("StructWithRef");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
