...
class _fbthrift_compatible_with_RefFieldsField2Patch:
    pass


class RefFieldsField2Patch(_fbthrift_python_types.Struct, _fbthrift_compatible_with_RefFieldsField2Patch):
    assign: _typing.Final[_typing.Optional[_typing.Sequence[int]]] = ...
    clear: _typing.Final[bool] = ...
    prepend: _typing.Final[_typing.Sequence[int]] = ...
    append: _typing.Final[_typing.Sequence[int]] = ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.Sequence[int], bool, _typing.Sequence[int], _typing.Sequence[int]]]]: ...
    def _to_python(self) -> _typing.Self: ...
    def _to_py3(self) -> "test.fixtures.patch.module.types.RefFieldsField2Patch": ...  # type: ignore
    def _to_py_deprecated(self) -> "module.ttypes.RefFieldsField2Patch": ...  # type: ignore
...
class _fbthrift_compatible_with_RefFieldsField5Patch:
    pass


class RefFieldsField5Patch(_fbthrift_python_types.Struct, _fbthrift_compatible_with_RefFieldsField5Patch):
    assign: _typing.Final[_typing.Optional[_typing.Sequence[int]]] = ...
    clear: _typing.Final[bool] = ...
    prepend: _typing.Final[_typing.Sequence[int]] = ...
    append: _typing.Final[_typing.Sequence[int]] = ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[_typing.Sequence[int], bool, _typing.Sequence[int], _typing.Sequence[int]]]]: ...
    def _to_python(self) -> _typing.Self: ...
    def _to_py3(self) -> "test.fixtures.patch.module.types.RefFieldsField5Patch": ...  # type: ignore
    def _to_py_deprecated(self) -> "module.ttypes.RefFieldsField5Patch": ...  # type: ignore
...
class RefFieldsFieldPatch(_fbthrift_python_types.Struct, _fbthrift_compatible_with_RefFieldsFieldPatch):
    ...
    shared_const: _typing.Final[RefFieldsField2Patch] = ...
    shared_mustable: _typing.Final[RefFieldsField3Patch] = ...
    opt_unique: _typing.Final[RefFieldsField4Patch] = ...
    opt_shared_const: _typing.Final[RefFieldsField5Patch] = ...
    ...
    def __init__(
        ...
        shared_const: _typing.Optional[_fbthrift_compatible_with_RefFieldsField2Patch]=...,
        ...
        opt_shared_const: _typing.Optional[_fbthrift_compatible_with_RefFieldsField5Patch]=...,
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[RefFieldsField1Patch, RefFieldsField2Patch, RefFieldsField3Patch, RefFieldsField4Patch, RefFieldsField5Patch, RefFieldsField6Patch, RefFieldsField7Patch]]]: ...
    def _to_python(self) -> _typing.Self: ...
