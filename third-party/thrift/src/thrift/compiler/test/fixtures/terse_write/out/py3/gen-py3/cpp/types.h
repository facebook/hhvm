...
template<>
inline void reset_field<::facebook::thrift::annotation::cpp::FastServer>(
    ::facebook::thrift::annotation::cpp::FastServer& obj, uint16_t index) {
  switch (index) {
  }
}
...
template<>
inline const std::unordered_map<std::string_view, std::string_view>& PyStructTraits<
    ::facebook::thrift::annotation::cpp::FastServer>::namesmap() {
  static const folly::Indestructible<NamesMap> map {
    {
    }
  };
