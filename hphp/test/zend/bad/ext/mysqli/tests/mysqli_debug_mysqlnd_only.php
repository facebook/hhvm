<?php
	...
	$test_table_name = 'test_mysqli_debug_mysqlnd_only_table_1'; require_once('table.inc');
...
?>
<?php
	$test_table_name = 'test_mysqli_debug_mysqlnd_only_table_1'; require_once("clean_table.inc");
?>