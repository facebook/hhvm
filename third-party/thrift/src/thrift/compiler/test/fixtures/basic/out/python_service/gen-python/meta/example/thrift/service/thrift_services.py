...
EchoServiceInterface,
    ...
    async def _fbthrift__handler_echo_2(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__meta__example__thrift__service__thrift_types._fbthrift_ExtendedEchoService_echo_2_args, args, protocol)
        try:
...
class ExtendedMyServiceInterface(
    ...
    async def _fbthrift__handler_putDataById_2(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__meta__example__thrift__service__thrift_types._fbthrift_ExtendedMyService_putDataById_2_args, args, protocol)
