...
class RocketUpgradeAsyncProcessor : public ::apache::thrift::GeneratedAsyncProcessor {
 ...
 public:
  using ProcessFuncs = GeneratedAsyncProcessor::ProcessFuncs<RocketUpgradeAsyncProcessor>;
 ...
 private:
  ...
  static apache::thrift::LegacySerializedResponse return_upgradeToRocket(int32_t protoSeqId, apache::thrift::ContextStack* ctx);
  template <class ProtocolIn_, class ProtocolOut_>
