...
class MyStruct final  {
 private:
  ...
  struct __fbthrift_ordinal_impl {
    ...
    template<> static constexpr int value<::apache::thrift::ident::OtherStructField> = 1;
#else
    ...
    static constexpr int value_impl(folly::tag_t<::apache::thrift::ident::OtherStructField>) { return 1; }
  ...
  struct __fbthrift_ordinal_impl_for_non_unique_type {
    ...
    template<class T> struct Impl<::apache::thrift::type::struct_t<::matching_module_name::OtherStruct>, T, std::enable_if_t<sizeof(T) != -1>> { static constexpr int value = 1; };
