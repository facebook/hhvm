...
pub enum TokenKind {
    ...
    DecimalLiteral = 182,
    OctalLiteral = 183,
    HexadecimalLiteral = 184,
    BinaryLiteral = 185,
    FloatingLiteral = 186,
    SingleQuotedStringLiteral = 187,
    DoubleQuotedStringLiteral = 188,
    DoubleQuotedStringLiteralHead = 189,
    StringLiteralBody = 190,
    DoubleQuotedStringLiteralTail = 191,
    HeredocStringLiteral = 192,
    HeredocStringLiteralHead = 193,
    HeredocStringLiteralTail = 194,
    NowdocStringLiteral = 195,
    BooleanLiteral = 196,
    XHPCategoryName = 197,
    XHPElementName = 198,
    XHPClassName = 199,
    XHPStringLiteral = 200,
    XHPBody = 201,
    XHPComment = 202,
    Hashbang = 203,
}
...
impl TokenKind {
    ...
    pub fn ocaml_tag(self) -> u8 {
        match self {
            ...
            TokenKind::ErrorToken => 179,
            TokenKind::Name => 180,
            TokenKind::Variable => 181,
            TokenKind::DecimalLiteral => 182,
            TokenKind::OctalLiteral => 183,
            TokenKind::HexadecimalLiteral => 184,
            TokenKind::BinaryLiteral => 185,
            TokenKind::FloatingLiteral => 186,
            TokenKind::SingleQuotedStringLiteral => 187,
            TokenKind::DoubleQuotedStringLiteral => 188,
            TokenKind::DoubleQuotedStringLiteralHead => 189,
            TokenKind::StringLiteralBody => 190,
            TokenKind::DoubleQuotedStringLiteralTail => 191,
            TokenKind::HeredocStringLiteral => 192,
            TokenKind::HeredocStringLiteralHead => 193,
            TokenKind::HeredocStringLiteralTail => 194,
            TokenKind::NowdocStringLiteral => 195,
            TokenKind::BooleanLiteral => 196,
            TokenKind::XHPCategoryName => 197,
            TokenKind::XHPElementName => 198,
            TokenKind::XHPClassName => 199,
            TokenKind::XHPStringLiteral => 200,
            TokenKind::XHPBody => 201,
            TokenKind::XHPComment => 202,
            TokenKind::Hashbang => 203,
        }
    }
    ...
    pub fn try_from_u8(tag: u8) -> Option<Self> {
        match tag {
            ...
            179 => Some(TokenKind::ErrorToken),
            180 => Some(TokenKind::Name),
            181 => Some(TokenKind::Variable),
            182 => Some(TokenKind::DecimalLiteral),
            183 => Some(TokenKind::OctalLiteral),
            184 => Some(TokenKind::HexadecimalLiteral),
            185 => Some(TokenKind::BinaryLiteral),
            186 => Some(TokenKind::FloatingLiteral),
            187 => Some(TokenKind::SingleQuotedStringLiteral),
            188 => Some(TokenKind::DoubleQuotedStringLiteral),
            189 => Some(TokenKind::DoubleQuotedStringLiteralHead),
            190 => Some(TokenKind::StringLiteralBody),
            191 => Some(TokenKind::DoubleQuotedStringLiteralTail),
            192 => Some(TokenKind::HeredocStringLiteral),
            193 => Some(TokenKind::HeredocStringLiteralHead),
            194 => Some(TokenKind::HeredocStringLiteralTail),
            195 => Some(TokenKind::NowdocStringLiteral),
            196 => Some(TokenKind::BooleanLiteral),
            197 => Some(TokenKind::XHPCategoryName),
            198 => Some(TokenKind::XHPElementName),
            199 => Some(TokenKind::XHPClassName),
            200 => Some(TokenKind::XHPStringLiteral),
            201 => Some(TokenKind::XHPBody),
            202 => Some(TokenKind::XHPComment),
            203 => Some(TokenKind::Hashbang),
            _ => None,
        }
    }
