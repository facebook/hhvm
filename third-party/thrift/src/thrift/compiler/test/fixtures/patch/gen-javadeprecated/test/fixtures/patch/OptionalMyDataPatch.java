...
public class OptionalMyDataPatch implements TBase, java.io.Serializable, Cloneable, Comparable<OptionalMyDataPatch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(OptionalMyDataPatch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    private MyDataPatch patchPrior;
    ...
    public Builder setPatchPrior(final MyDataPatch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }
   ...
   * Clears any set value. Applies first.
   */
  public OptionalMyDataPatch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public OptionalMyDataPatch setPatchPrior(MyDataPatch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Assigns the value, if not already set to the same field. Applies third.
   */
  public OptionalMyDataPatch setEnsure(MyData ensure) {
    this.ensure = ensure;
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public OptionalMyDataPatch setPatch(MyDataPatch patch) {
    this.patch = patch;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((MyDataPatch)__value);
      }
      break;
  ...
  @Override
  public int compareTo(OptionalMyDataPatch other) {
    if (other == null) {
      ...
      switch (__field.id)
      {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            this.patchPrior = new MyDataPatch();
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("OptionalMyDataPatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
