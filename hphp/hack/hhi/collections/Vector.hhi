...
final class Vector<Tv> implements MutableVector<Tv> {
   ...
   */
  <<__Rx, __OnlyRxIfArgs, __MutableReturn>>
  public function zip<Tu>(<<__OnlyRxIfImpl(HH\Rx\Traversable::class)>> Traversable<Tu> $traversable): Vector<Pair<Tv, Tu>>;
  ...
  *
  ...
  public function setAll(<<__OnlyRxIfImpl(HH\Rx\KeyedTraversable::class)>> ?KeyedTraversable<int, Tv> $it): Vector<Tv>;
   ...
   */
  <<__Rx, __Mutable, __OnlyRxIfArgs, __ReturnsVoidToRx>>
  public function addAll(<<__OnlyRxIfImpl(HH\Rx\Traversable::class)>> ?Traversable<Tv> $it): Vector<Tv>;
   ...
   */
  <<__Rx, __OnlyRxIfArgs, __MutableReturn>>
  public static function fromItems(<<__OnlyRxIfImpl(HH\Rx\Traversable::class)>> ?Traversable<Tv> $items): Vector<Tv>;
