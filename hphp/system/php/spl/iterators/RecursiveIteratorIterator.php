...
class RecursiveIteratorIterator implements OuterIterator, Traversable {
  ...
  public function next() {
    ...
    $maxDepthReached = ($this->maxDepth > -1 && $this->getDepth() >= $this->maxDepth);

    if ($this->mode == self::SELF_FIRST) {
      if ($this->callHasChildren() && !$this->getInnerIteratorFlag() && !$maxDepthReached) {
   ...
   *
   * @param      int     $max_depth   The maximum allowed depth. -1 is used for any depth.
   *
