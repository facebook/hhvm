...
class InitialResponse final  {
 ...
 public:
  ...
  /** Glean {"file": "thrift/compiler/test/fixtures/sink/src/module.thrift", "name": "InitialResponse", "kind": "struct", "field": "content" } */
...
class FinalResponse final  {
 ...
 public:
  ...
  /** Glean {"file": "thrift/compiler/test/fixtures/sink/src/module.thrift", "name": "FinalResponse", "kind": "struct", "field": "content" } */
  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::field_ref<const T&> content_ref() const& {
    return {this->__fbthrift_field_content, __isset.at(0), __isset.bit(0)};
  }
...
class SinkPayload final  {
 ...
 public:
  ...
  /** Glean {"file": "thrift/compiler/test/fixtures/sink/src/module.thrift", "name": "SinkPayload", "kind": "struct", "field": "content" } */
  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::field_ref<const T&> content_ref() const& {
    return {this->__fbthrift_field_content, __isset.at(0), __isset.bit(0)};
  }
...
class CompatibleWithKeywordSink final  {
 ...
 public:
  ...
  /** Glean {"file": "thrift/compiler/test/fixtures/sink/src/module.thrift", "name": "CompatibleWithKeywordSink", "kind": "struct", "field": "sink" } */
  template <typename..., typename T = ::std::string>
...
class FOLLY_EXPORT InitialException : public virtual apache::thrift::TException {
 ...
 public:
  ...
  /** Glean {"file": "thrift/compiler/test/fixtures/sink/src/module.thrift", "name": "InitialException", "kind": "exception", "field": "reason" } */
  template <typename..., typename T = ::std::string>
...
class FOLLY_EXPORT SinkException1 : public virtual apache::thrift::TException {
 ...
 public:
  ...
  /** Glean {"file": "thrift/compiler/test/fixtures/sink/src/module.thrift", "name": "SinkException1", "kind": "exception", "field": "reason" } */
  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::field_ref<const T&> reason_ref() const& {
    return {this->__fbthrift_field_reason, __isset.at(0), __isset.bit(0)};
  }
...
class FOLLY_EXPORT SinkException2 : public virtual apache::thrift::TException {
 ...
 public:
  ...
  /** Glean {"file": "thrift/compiler/test/fixtures/sink/src/module.thrift", "name": "SinkException2", "kind": "exception", "field": "reason" } */
