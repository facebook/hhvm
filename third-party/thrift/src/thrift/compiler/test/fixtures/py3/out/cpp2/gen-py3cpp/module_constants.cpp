...
::std::string_view _fbthrift_schema_8bfc35f5fd4af816() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_8bfc35f5fd4af816_includes() {
#if FBTHRIFT_CAN_POPULATE_SCHEMA_LIST
  static const ::std::array<::std::string_view, 1> includes = {
    _fbthrift_schema_8bfc35f5fd4af816(),
  };
