...
impl TokenKind {
    ...
    pub fn ocaml_tag(self) -> u8 {
        match self {
            ...
            TokenKind::List => 68,
            TokenKind::Mixed => 69,
            TokenKind::Namespace => 70,
            TokenKind::New => 71,
            TokenKind::Newtype => 72,
            TokenKind::Noreturn => 73,
            TokenKind::Num => 74,
            TokenKind::Object => 75,
            TokenKind::Parent => 76,
            TokenKind::Print => 77,
            TokenKind::Private => 78,
            TokenKind::Protected => 79,
            TokenKind::Public => 80,
            TokenKind::Real => 81,
            TokenKind::Reify => 82,
            TokenKind::Record => 83,
            TokenKind::RecordDec => 84,
            TokenKind::Require => 85,
            TokenKind::Require_once => 86,
            TokenKind::Required => 87,
            TokenKind::Lateinit => 88,
            TokenKind::Resource => 89,
            TokenKind::Return => 90,
            TokenKind::SelfToken => 91,
            TokenKind::Shape => 92,
            TokenKind::Static => 93,
            TokenKind::String => 94,
            TokenKind::Super => 95,
            TokenKind::Suspend => 96,
            TokenKind::Switch => 97,
            TokenKind::This => 98,
            TokenKind::Throw => 99,
            TokenKind::Trait => 100,
            ...
            TokenKind::Using => 106,
            TokenKind::Var => 107,
            TokenKind::Varray => 108,
            TokenKind::Vec => 109,
            TokenKind::Void => 110,
            TokenKind::Where => 111,
            TokenKind::While => 112,
            TokenKind::Yield => 113,
            TokenKind::NullLiteral => 114,
            TokenKind::LeftBracket => 115,
            TokenKind::RightBracket => 116,
            TokenKind::LeftParen => 117,
            TokenKind::RightParen => 118,
            TokenKind::LeftBrace => 119,
            TokenKind::RightBrace => 120,
            TokenKind::Dot => 121,
            TokenKind::MinusGreaterThan => 122,
            TokenKind::PlusPlus => 123,
            TokenKind::MinusMinus => 124,
            TokenKind::StarStar => 125,
            TokenKind::Star => 126,
            TokenKind::Plus => 127,
            TokenKind::Minus => 128,
            TokenKind::Tilde => 129,
            TokenKind::Exclamation => 130,
            TokenKind::Dollar => 131,
            TokenKind::Slash => 132,
            TokenKind::Percent => 133,
            TokenKind::LessThanEqualGreaterThan => 134,
            TokenKind::LessThanLessThan => 135,
            TokenKind::GreaterThanGreaterThan => 136,
            TokenKind::LessThan => 137,
            TokenKind::GreaterThan => 138,
            TokenKind::LessThanEqual => 139,
            TokenKind::GreaterThanEqual => 140,
            TokenKind::EqualEqual => 141,
            TokenKind::EqualEqualEqual => 142,
            TokenKind::ExclamationEqual => 143,
            TokenKind::ExclamationEqualEqual => 144,
            TokenKind::Carat => 145,
            TokenKind::Bar => 146,
            TokenKind::Ampersand => 147,
            TokenKind::AmpersandAmpersand => 148,
            TokenKind::BarBar => 149,
            TokenKind::Question => 150,
            TokenKind::QuestionAs => 151,
            TokenKind::QuestionColon => 152,
            TokenKind::QuestionQuestion => 153,
            TokenKind::QuestionQuestionEqual => 154,
            TokenKind::Colon => 155,
            TokenKind::Semicolon => 156,
            TokenKind::Equal => 157,
            TokenKind::StarStarEqual => 158,
            TokenKind::StarEqual => 159,
            TokenKind::SlashEqual => 160,
            TokenKind::PercentEqual => 161,
            TokenKind::PlusEqual => 162,
            TokenKind::MinusEqual => 163,
            TokenKind::DotEqual => 164,
            TokenKind::LessThanLessThanEqual => 165,
            TokenKind::GreaterThanGreaterThanEqual => 166,
            TokenKind::AmpersandEqual => 167,
            TokenKind::CaratEqual => 168,
            TokenKind::BarEqual => 169,
            TokenKind::Comma => 170,
            TokenKind::At => 171,
            TokenKind::ColonColon => 172,
            TokenKind::EqualGreaterThan => 173,
            TokenKind::EqualEqualGreaterThan => 174,
            TokenKind::QuestionMinusGreaterThan => 175,
            TokenKind::DotDotDot => 176,
            TokenKind::DollarDollar => 177,
            TokenKind::BarGreaterThan => 178,
            TokenKind::SlashGreaterThan => 179,
            TokenKind::LessThanSlash => 180,
            TokenKind::LessThanQuestion => 181,
            TokenKind::QuestionGreaterThan => 182,
            TokenKind::ColonAt => 183,
