...
template void TccStructTraits<::cpp2_struct_footprint::SimpleStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::ComplexStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::Struct1>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::Struct2>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::Struct3>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::Struct4>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::Struct5>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::ExStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2_struct_footprint::TestUnion>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
std::partial_ordering ComplexStruct::operator<=>([[maybe_unused]] const ComplexStruct& rhs) const {
  return ::apache::thrift::op::compare<ComplexStruct>(*this, rhs);
}
...
std::partial_ordering ExStruct::operator<=>([[maybe_unused]] const ExStruct& rhs) const {
  return ::apache::thrift::op::compare<ExStruct>(*this, rhs);
}
...
std::partial_ordering TestUnion::operator<=>([[maybe_unused]] const TestUnion& rhs) const {
  return ::apache::thrift::op::compare<TestUnion>(*this, rhs);
}
