...
public class Interaction implements TBase, java.io.Serializable, Cloneable {
  ...
  public static Interaction deserialize(TProtocol iprot) throws TException {
    TField __field;
