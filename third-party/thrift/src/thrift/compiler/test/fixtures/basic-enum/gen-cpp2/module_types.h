...
class MyStruct final  {
 private:
  ...
  struct __fbthrift_ordinal_impl {
    ...
    template<> static constexpr int value<::apache::thrift::ident::myBigEnum> = 2;
#else
    ...
    static constexpr int value_impl(folly::tag_t<::apache::thrift::ident::myBigEnum>) { return 2; }
  ...
  struct __fbthrift_ordinal_impl_for_non_unique_type {
    ...
    template<class T> struct Impl<::apache::thrift::type::enum_t<::test::fixtures::enumstrict::MyEnum>, T, std::enable_if_t<sizeof(T) != -1>> { static constexpr int value = 1; };
    template<class T> struct Impl<::apache::thrift::type::enum_t<::test::fixtures::enumstrict::MyBigEnum>, T, std::enable_if_t<sizeof(T) != -2>> { static constexpr int value = 2; };
