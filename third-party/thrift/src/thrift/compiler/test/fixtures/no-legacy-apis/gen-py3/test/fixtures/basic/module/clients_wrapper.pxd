...
cdef extern from "thrift/compiler/test/fixtures/no-legacy-apis/src/gen-cpp2/module_clients.h" namespace "::test::fixtures::basic":
...
cdef extern from "thrift/compiler/test/fixtures/no-legacy-apis/src/gen-py3/module/clients_wrapper.h" namespace "::test::fixtures::basic":
  cdef cppclass cMyServiceClientWrapper "::test::fixtures::basic::MyServiceClientWrapper":
    void setPersistentHeader(const string& key, const string& value)
    void addEventHandler(const shared_ptr[cTProcessorEventHandler]& handler)

    cFollyFuture[_test_fixtures_basic_module_types.cMyStruct] query(cRpcOptions, 
      _test_fixtures_basic_module_types.cMyUnion arg_u,)
