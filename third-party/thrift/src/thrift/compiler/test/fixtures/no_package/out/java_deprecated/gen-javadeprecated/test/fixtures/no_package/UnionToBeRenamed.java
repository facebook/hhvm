...
public class UnionToBeRenamed extends TUnion<UnionToBeRenamed> implements Comparable<UnionToBeRenamed> {
  ...
  public static UnionToBeRenamed reserved_field(int __value) {
  ...
  protected void checkType(short setField, Object __value) throws ClassCastException {
    switch (setField) {
      case RESERVED_FIELD:
        ...
        throw new ClassCastException("Was expecting value of type Integer for field 'reserved_field', but got " + __value.getClass().getSimpleName());
      default:
  ...
  public void setReserved_field(int __value) {
    setField_ = RESERVED_FIELD;
    value_ = __value;
  }
  ...
  @Override
  public int compareTo(UnionToBeRenamed other) {
