...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="RefFieldsField7Patch", builder=RefFieldsField7Patch.Builder.class)
public final class RefFieldsField7Patch implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    ...
    @ThriftConstructor
    protected RefFieldsField7Patch() {
      this.assign = null;
      this.clear = false;
    ...
    public static class Builder {
        ...
        public Builder() { }
        public Builder(RefFieldsField7Patch other) {
    ...
    static {
      ...
      com.facebook.thrift.type.TypeRegistry.add(new com.facebook.thrift.type.Type(
        new com.facebook.thrift.type.UniversalName("test.dev/fixtures/patch/RefFieldsField7Patch"),
        RefFieldsField7Patch.class, RefFieldsField7Patch::read0));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefFieldsField7Patch other = (RefFieldsField7Patch)o;
    ...
    public static com.facebook.thrift.payload.Reader<RefFieldsField7Patch> asReader() {
      return RefFieldsField7Patch::read0;
    }
    
    public static RefFieldsField7Patch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(RefFieldsField7Patch.NAMES_TO_IDS, RefFieldsField7Patch.THRIFT_NAMES_TO_IDS, RefFieldsField7Patch.FIELD_METADATA);
      RefFieldsField7Patch.Builder builder = new RefFieldsField7Patch.Builder();
      while (true) {
    ...
    private static class _RefFieldsField7PatchLazy {
        private static final RefFieldsField7Patch _DEFAULT = new RefFieldsField7Patch.Builder().build();
    }
    
    public static RefFieldsField7Patch defaultInstance() {
        return  _RefFieldsField7PatchLazy._DEFAULT;
    }
}
