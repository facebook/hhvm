...
class Foo:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if is_text:
      json_obj = loads(json)
    if 'MyInt' in json_obj and json_obj['MyInt'] is not None:
      self.MyInt = long(json_obj['MyInt'])
  ...
  def _to_python(self):
    ...
    python_types = importlib.import_module("test.namespace_from_package.module.thrift_types")
