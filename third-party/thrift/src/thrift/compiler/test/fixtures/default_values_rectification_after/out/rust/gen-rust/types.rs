...
impl ::std::default::Default for self::TestStruct {
    fn default() -> Self {
        Self {
            unqualified_int_field: ::std::default::Default::default(),
            unqualified_bool_field: ::std::default::Default::default(),
            unqualified_list_field: ::std::default::Default::default(),
            unqualified_struct_field: ::std::default::Default::default(),
    ...
    P: ::fbthrift::ProtocolReader,
{
    ...
    fn rs_thrift_read(p: &mut P) -> ::anyhow::Result<Self> {
        ...
        ::std::result::Result::Ok(Self {
            unqualified_int_field: field_unqualified_int_field.unwrap_or_default(),
            unqualified_bool_field: field_unqualified_bool_field.unwrap_or_default(),
            unqualified_list_field: field_unqualified_list_field.unwrap_or_default(),
            unqualified_struct_field: field_unqualified_struct_field.unwrap_or_default(),
