...
class type ['env] type_mapper_type =
  object
    ...
    method on_tdynamic : 'env -> Reason.t -> Tvid.t option -> 'env * locl_ty
    ...
    method on_tclass_ptr : 'env -> Reason.t -> locl_ty -> 'env * locl_ty
...
class ['env] shallow_type_mapper : ['env] type_mapper_type =
  object (this)
    ...
    method on_tdynamic env r sv = (env, mk (r, Tdynamic sv))
    ...
    method on_tclass_ptr env r ty = (env, mk (r, Tclass_ptr ty))
    ...
    method on_type env ty =
      ...
      | Tdynamic sv -> this#on_tdynamic env r sv
      ...
      | Tclass_ptr ty -> this#on_tclass_ptr env r ty
