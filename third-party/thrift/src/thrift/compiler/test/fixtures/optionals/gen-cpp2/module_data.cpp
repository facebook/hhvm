...
THRIFT_DATA_MEMBER const std::array<::cpp2::Animal, 3> TEnumDataStorage<::cpp2::Animal>::values = {{
  type::DOG,
  type::CAT,
  type::TARANTULA,
}};
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 3> TEnumDataStorage<::cpp2::Animal>::names = {{
  "DOG",
  "CAT",
  "TARANTULA",
}};
