...
type DeprecatedTerseWrite struct {
}
// Compile time interface enforcer
var _ thrift.Struct = (*DeprecatedTerseWrite)(nil)

func NewDeprecatedTerseWrite() *DeprecatedTerseWrite {
    return (&DeprecatedTerseWrite{}).setDefaults()
}



func (x *DeprecatedTerseWrite) Write(p thrift.Encoder) error {
    if err := p.WriteStructBegin("DeprecatedTerseWrite"); err != nil {
        return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", x), err)
    }
...
func (x *DeprecatedTerseWrite) Read(p thrift.Decoder) error {
    if _, err := p.ReadStructBegin(); err != nil {
        return thrift.PrependError(fmt.Sprintf("%T read error: ", x), err)
    }
...
func (x *DeprecatedTerseWrite) String() string {
    return thrift.StructToString(reflect.ValueOf(x))
}

func (x *DeprecatedTerseWrite) setDefaults() *DeprecatedTerseWrite {
    return x
}
