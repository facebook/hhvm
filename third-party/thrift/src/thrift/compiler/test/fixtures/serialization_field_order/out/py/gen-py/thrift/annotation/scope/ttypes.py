...
__all__ = ['UTF8STRINGS', 'Transitive', 'Program', 'Struct', 'Union', 'Exception', 'ThrownException', 'Field', 'Typedef', 'Service', 'Interaction', 'Function', 'FunctionParameter', 'EnumValue', 'Const', 'Enum', 'Structured', 'Interface', 'RootDefinition', 'Definition', 'DisableSchemaConst']
...
class ThrownException:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('ThrownException')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.scope.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.ThrownException, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.scope.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.ThrownException, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.scope.types")
    return thrift.py3.converter.to_py3_struct(py3_types.ThrownException, self)
...
class FunctionParameter:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('FunctionParameter')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.scope.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.FunctionParameter, self)

  def _to_mutable_python(self):
    import importlib
    import thrift.python.mutable_converter
    python_mutable_types = importlib.import_module("facebook.thrift.annotation.scope.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.FunctionParameter, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.scope.types")
    return thrift.py3.converter.to_py3_struct(py3_types.FunctionParameter, self)
...
class DisableSchemaConst:
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('DisableSchemaConst')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_py3(self):
    ...
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.scope.types")
    return thrift.py3.converter.to_py3_struct(py3_types.DisableSchemaConst, self)
...
all_structs.append(ThrownException)
ThrownException.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

ThrownException.thrift_struct_annotations = {
}
ThrownException.thrift_field_annotations = {
}
...
all_structs.append(FunctionParameter)
FunctionParameter.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

FunctionParameter.thrift_struct_annotations = {
}
FunctionParameter.thrift_field_annotations = {
}
...
all_structs.append(DisableSchemaConst)
DisableSchemaConst.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

DisableSchemaConst.thrift_struct_annotations = {
}
DisableSchemaConst.thrift_field_annotations = {
}
