...
extern const InstanceOfInfo cw_Directory$$instanceof_table[] = {
  {0x11506C8F,1,"Directory",&cw_Directory},
};
...
extern const MethodCallInfoTable cw_Directory$$call_info_table[] = {
  { 0x649EF301, 0, 4, "read", &ci_Directory$$read },
  { 0x3EBF5341, 1, 5, "close", &ci_Directory$$close },
  { 0x5E27AF6A, 1, 6, "rewind", &ci_Directory$$rewind },
  { 0x229C615F, 1, 11, "__construct", &ci_Directory$$__construct },
};
...
static const ClassPropTableEntry cpt_table_entries[] = {
  {0x74541532,0,0,0,68,-1,GET_PROPERTY_OFFSET(c_Directory, m_handle),&NAMSTR(s_sys_ss46eeef5c, "handle") },
  {0x26880074,-1,0,0,68,-1,GET_PROPERTY_OFFSET(c_Directory, m_path),&NAMSTR(s_sys_ss7362b3c4, "path") },
