 ...
 * HackInteractionService
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/test/fixtures/interaction_namespaces/module2/HackInteractionService'))>>
interface HackInteractionServiceAsyncIf extends \IThriftAsyncIf {
  /**
 ...
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/test/fixtures/interaction_namespaces/module2/HackInteractionService'))>>
interface HackInteractionServiceAsyncClientIf extends HackInteractionServiceAsyncIf {
}
 ...
 */
<<\ThriftTypeInfo(shape('uri' => 'facebook.com/thrift/test/fixtures/interaction_namespaces/module2/HackInteractionService'))>>
interface HackInteractionServiceClientIf extends \IThriftSyncIf {
  /**
   * Original thrift definition:-
   * void
   *   noop();
 ...
 * HackInteractionService
 */
trait HackInteractionServiceClientBase {
  require extends \ThriftClientBase;

  /* interaction handlers factory methods */
  public function createHackInteraction(): HackInteractionService_HackInteraction {
    $interaction = new HackInteractionService_HackInteraction($this->input_, $this->output_, $this->channel_);
  ...
  public async function noop(): Awaitable<void> {
    ...
    $args = HackInteractionService_noop_args::withDefaultValues();
    await $this->asyncHandler_->genBefore(HackInteractionServiceStaticMetadata::THRIFT_SVC_NAME, "noop", $args);
    $currentseqid = $this->sendImplHelper($args, "noop", false, HackInteractionServiceStaticMetadata::THRIFT_SVC_NAME );
    await $this->genAwaitResponse(HackInteractionService_noop_result::class, "noop", true, $currentseqid, $rpc_options);
  }

}

class HackInteractionServiceAsyncClient extends \ThriftClientBase implements HackInteractionServiceAsyncClientIf {
...
class HackInteractionService_HackInteraction extends \ThriftClientBase {
  ...
  public function __construct(\TProtocol $input, ?\TProtocol $output = null, ?\IThriftMigrationAsyncChannel $channel = null)[leak_safe] {
    ...
    if ($this->channel_ is nonnull) {
      $this->interactionId = $this->channel_->createInteraction("HackInteraction");
    } else {
...
class HackInteractionService_noop_args implements \IThriftSyncStruct, \IThriftStructMetadata {
  ...
  public function getName()[]: string {
    return 'HackInteractionService_noop_args';
  }

  public static function getStructMetadata()[]: \tmeta_ThriftStruct {
    return \tmeta_ThriftStruct::fromShape(
      shape(
        "name" => "module2.noop_args",
        "is_union" => false,
      )
    );
  }
...
class HackInteractionService_noop_result extends \ThriftSyncStructWithoutResult implements \IThriftStructMetadata {
  use \ThriftSerializationTrait;
  ...
  public function getName()[]: string {
    return 'HackInteractionService_noop_result';
  }

  public static function getStructMetadata()[]: \tmeta_ThriftStruct {
    return \tmeta_ThriftStruct::fromShape(
      shape(
        "name" => "module2.HackInteractionService_noop_result",
        "is_union" => false,
      )
    );
  }
...
class HackInteractionService_HackInteraction_ping_args implements \IThriftSyncStruct, \IThriftStructMetadata {
  use \ThriftSerializationTrait;
  ...
  public function getName()[]: string {
    return 'HackInteractionService_HackInteraction_ping_args';
  }
...
class HackInteractionService_HackInteraction_ping_result extends \ThriftSyncStructWithResult implements \IThriftStructMetadata {
  use \ThriftSerializationTrait;
  ...
  public function getName()[]: string {
    return 'HackInteractionService_HackInteraction_ping_result';
  }

  public static function getStructMetadata()[]: \tmeta_ThriftStruct {
    return \tmeta_ThriftStruct::fromShape(
      shape(
        "name" => "module2.HackInteractionService_HackInteraction_ping_result",
        "fields" => vec[
          \tmeta_ThriftField::fromShape(
            shape(
              "id" => 0,
...
class HackInteractionServiceStaticMetadata implements \IThriftServiceStaticMetadata {
  ...
  public static function getServiceMetadata()[]: \tmeta_ThriftService {
    return \tmeta_ThriftService::fromShape(
      shape(
        "name" => "module2.HackInteractionService",
        "functions" => vec[
