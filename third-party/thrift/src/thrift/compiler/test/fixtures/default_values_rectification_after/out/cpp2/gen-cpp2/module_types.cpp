...
template void TccStructTraits<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::EmptyStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::TestStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
