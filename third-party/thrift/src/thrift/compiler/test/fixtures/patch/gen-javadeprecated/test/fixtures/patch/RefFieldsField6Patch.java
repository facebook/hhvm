...
public class RefFieldsField6Patch implements TBase, java.io.Serializable, Cloneable, Comparable<RefFieldsField6Patch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(RefFieldsField6Patch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public RefFieldsField6Patch build() {
      RefFieldsField6Patch result = new RefFieldsField6Patch();
   ...
   * 
   */
  public RefFieldsField6Patch setAssign(List<Integer> assign) {
    this.assign = assign;
    return this;
  }
   ...
   * Clears a value. Applies first.
   */
  public RefFieldsField6Patch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Prepends to the front of a given list.
   */
  public RefFieldsField6Patch setPrepend(List<Integer> prepend) {
    this.prepend = prepend;
    return this;
  }
   ...
   * Appends to the back of a given list.
   */
  public RefFieldsField6Patch setAppend(List<Integer> append) {
    this.append = append;
    return this;
  }
  ...
  @Override
  public int compareTo(RefFieldsField6Patch other) {
    if (other == null) {
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.assign = new ArrayList<Integer>(Math.max(0, _list324.size));
              for (int _i325 = 0; 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.prepend = new ArrayList<Integer>(Math.max(0, _list327.size));
              for (int _i328 = 0; 
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              this.append = new ArrayList<Integer>(Math.max(0, _list330.size));
              for (int _i331 = 0; 
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("RefFieldsField6Patch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
