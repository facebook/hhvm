...
var_dump( in_array("Good", varray[0,"hello"]) );
//false in strict mode
var_dump( in_array("Good", varray[0,"hello"], TRUE) );

//matching integer 0 in array("this"), result:true in loose type check
var_dump( in_array(0, varray["this"]) );
// false in strict mode
var_dump( in_array(0, varray["this"]),TRUE );

//matching string "this" in array(0), result:true in loose type check
var_dump( in_array("this", varray[0]) );
// false in stric mode
var_dump( in_array("this", varray[0], TRUE) );
...
var_dump( in_array('123abc', varray[123]) );
var_dump( in_array('123abc', varray[123], TRUE) ); // false in strict mode
