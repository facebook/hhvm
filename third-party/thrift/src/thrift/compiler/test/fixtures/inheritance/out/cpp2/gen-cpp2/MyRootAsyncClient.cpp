...
folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::MyRoot>::fbthrift_semifuture_do_root(apache::thrift::RpcOptions& rpcOptions) {
  ...
  return fbthrift_semifuture_do_root(std::move(semifuture), rpcOptions, std::move(wrappedCallbackAndContextStack.first), wrappedCallbackAndContextStack.second, std::move(ctxAndHeader.second));
}

folly::SemiFuture<folly::Unit> apache::thrift::Client<::cpp2::MyRoot>::fbthrift_semifuture_do_root(folly::SemiFuture<typename apache::thrift::detail::FutureCallbackHelper<folly::Unit>::PromiseResult> semifuture, apache::thrift::RpcOptions& rpcOptions, apache::thrift::RequestClientCallback::Ptr wrappedCallback, apache::thrift::ContextStack* contextStack, std::shared_ptr<::apache::thrift::transport::THeader> header) {
  using CallbackHelper = apache::thrift::detail::FutureCallbackHelper<folly::Unit>;
  apache::thrift::SerializedRequest request = fbthrift_serialize_do_root(rpcOptions, *header, contextStack);
#if FOLLY_HAS_COROUTINES
