...
class def_PY_RESERVED_KEYWORD:
  ...
  def _to_mutable_python(self):
    ...
    python_mutable_types = importlib.import_module("test.thrift_mutable_types")
    return thrift.python.mutable_converter.to_mutable_python_struct_or_union(python_mutable_types.def_PY_RESERVED_KEYWORD, self)
