...
public class FB303ServiceRpcServerHandler 
  ...
  private final java.util.List<com.facebook.thrift.payload.Reader> _simpleRpcReaders;

  private final java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers;

  public FB303ServiceRpcServerHandler(FB303Service _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new FB303ServiceBlockingReactiveWrapper(_delegate), _eventHandlers);
  }

  public FB303ServiceRpcServerHandler(FB303Service.Async _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
    this(new FB303ServiceAsyncReactiveWrapper(_delegate), _eventHandlers);
  }

  public FB303ServiceRpcServerHandler(FB303Service.Reactive _delegate,
                                    java.util.List<com.facebook.swift.service.ThriftEventHandler> _eventHandlers) {
  ...
  private static com.facebook.thrift.payload.Writer _create_simpleRpc_response_writer(
  ...
  private static reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload>
    ...
    com.facebook.swift.service.ContextChain _chain) {
          ...
          int intParameter = (int) _iterator.next();

          _chain.postRead(_data);

          reactor.core.publisher.Mono<test.fixtures.basic.ReservedKeyword> _delegateResponse =
            _delegate
              .simpleRpc(intParameter);
          ...
          reactor.core.publisher.Mono<com.facebook.thrift.payload.ServerResponsePayload> _internalResponse =
            _delegateResponse.map(_response -> {
              ...
              com.facebook.thrift.payload.ServerResponsePayload _serverResponsePayload =
                com.facebook.thrift.util.RpcPayloadUtil.createServerResponsePayload(
                  _payload,
                  _create_simpleRpc_response_writer(_response, _chain, _payload.getMessageSeqId()));
              ...
              reactor.core.publisher.Mono.fromSupplier(
                () -> {
                  org.apache.thrift.TApplicationException _tApplicationException =
                    new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "method simpleRpc returned null");
            ...
            .<com.facebook.thrift.payload.ServerResponsePayload>onErrorResume(_t -> {
                ...
                String _errorMessage = String.format("Internal error processing simpleRpc: %s", _t.getMessage() == null ? "<null>" : _t.getMessage());
                org.apache.thrift.TApplicationException _tApplicationException =
  ...
  public reactor.core.publisher.Flux<com.facebook.thrift.payload.ServerResponsePayload> singleRequestStreamingResponse(com.facebook.thrift.payload.ServerRequestPayload _payload) {
    ...
    final String _qualifiedMethodName = "FB303Service." + _name;
