...
public class ReconnectingAsyncNetty4Client extends AbstractAsyncClient {
  ...
  public static void main(String... args) {
    ...
    ReconnectingAsyncNetty4Client c = new ReconnectingAsyncNetty4Client();
    c.runTest(
  ...
  protected PingService.Async getClient(SocketAddress address) {
    return PingService.Async.clientBuilder().build(factory, address);
  }
}
