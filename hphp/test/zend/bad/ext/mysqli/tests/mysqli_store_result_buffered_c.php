<?php
	...
	$test_table_name = 'test_mysqli_store_result_buffered_c_table_1'; require('table.inc');
...
<?php
	$test_table_name = 'test_mysqli_store_result_buffered_c_table_1'; require_once("clean_table.inc");
?>