<?php
	$test_table_name = 'test_mysqli_stmt_send_long_data_packet_size_mysqlnd_table_1'; require('table.inc');
...
?>
<?php
	$test_table_name = 'test_mysqli_stmt_send_long_data_packet_size_mysqlnd_table_1'; require_once("clean_table.inc");
?>