...
public class OptionalI64Patch implements TBase, java.io.Serializable, Cloneable, Comparable<OptionalI64Patch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(OptionalI64Patch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    private I64Patch patchPrior;
    private long ensure;
    private I64Patch patch;
    ...
    public Builder setPatchPrior(final I64Patch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }

    public Builder setEnsure(final long ensure) {
      this.ensure = ensure;
      __optional_isset.set(__ENSURE_ISSET_ID, true);
      return this;
    }

    public Builder setPatch(final I64Patch patch) {
      this.patch = patch;
      return this;
    }

    public OptionalI64Patch build() {
      OptionalI64Patch result = new OptionalI64Patch();
   ...
   * Clears any set value. Applies first.
   */
  public OptionalI64Patch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public OptionalI64Patch setPatchPrior(I64Patch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Assigns the value, if not already set to the same field. Applies third.
   */
  public OptionalI64Patch setEnsure(long ensure) {
    this.ensure = ensure;
    setEnsureIsSet(true);
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public OptionalI64Patch setPatch(I64Patch patch) {
    this.patch = patch;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((I64Patch)__value);
      }
      break;
  ...
  @Override
  public int compareTo(OptionalI64Patch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("OptionalI64Patch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
