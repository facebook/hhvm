...
PyObject* Constructor<::apache::thrift::python::capi::ComposedStruct<
  ...
  if (!_fbthrift__MyIncludedField ||
      setStructField(*fbthrift_data, _fbthrift__tuple_pos[0], *_fbthrift__MyIncludedField) == -1) {
    return nullptr;
  }
  ...
  if (!_fbthrift__MyOtherIncludedField ||
      setStructField(*fbthrift_data, _fbthrift__tuple_pos[1], *_fbthrift__MyOtherIncludedField) == -1) {
    return nullptr;
  }
  StrongRef _fbthrift__MyIncludedInt(
    Constructor<int64_t>{}
    .constructFrom(val.MyIncludedInt_ref()));
  if (!_fbthrift__MyIncludedInt ||
      setStructField(*fbthrift_data, _fbthrift__tuple_pos[2], *_fbthrift__MyIncludedInt) == -1) {
    return nullptr;
  }
