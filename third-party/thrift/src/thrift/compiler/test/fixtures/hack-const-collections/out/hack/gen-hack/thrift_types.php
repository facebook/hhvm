...
class ReserveIds implements \IThriftSyncStruct, \IThriftStructMetadata {
   ...
   */
  public \ConstMap<int, int> $id_ranges;

  public function __construct(?\ConstVector<int> $ids = null, ?\ConstMap<int, int> $id_ranges = null)[] {
    $this->ids = $ids ?? Vector {};
...
class DeprecatedUnvalidatedAnnotations implements \IThriftSyncStruct, \IThriftStructMetadata {
   ...
   */
  public \ConstMap<string, string> $items;

  public function __construct(?\ConstMap<string, string> $items = null)[] {
