...
#include "thrift/compiler/test/fixtures/no-legacy-apis/src/gen-cpp2/module_data.h"
#include "thrift/compiler/test/fixtures/no-legacy-apis/src/gen-cpp2/module_types.h"
