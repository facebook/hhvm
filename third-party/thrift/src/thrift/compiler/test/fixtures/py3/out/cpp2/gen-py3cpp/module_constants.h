...
namespace module_constants {
  ...
  constexpr const char* const A_WORD_ = "Good word";
  /** Glean {"constant": "A_WORD"} */
  constexpr const char* A_WORD() {
    return A_WORD_;
  }
  ...
  FOLLY_EXPORT ::std::string_view _fbthrift_schema_cb2e7e89aab8f829();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_cb2e7e89aab8f829_includes();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_cb2e7e89aab8f829_uris();
