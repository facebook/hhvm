 ...
 * }
 *)
module SearchKeys = SharedMem.NoCache (SharedMem.ProfiledImmediate) (Relative_path.S) (struct
 ...
 * }
 *)
module SearchKeyToTermMap = SharedMem.WithCache (SharedMem.ProfiledImmediate) (Relative_path.S) (struct
