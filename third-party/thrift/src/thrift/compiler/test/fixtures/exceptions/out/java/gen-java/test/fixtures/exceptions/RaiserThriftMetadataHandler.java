...
public class RaiserThriftMetadataHandler implements com.facebook.thrift.server.ThriftMetadataHandler {
    ...
    public Map<String, ThriftEnum> getEnums() {
        return RaiserThriftMetadataHandlerEnums.getEnums();
    }

    @Override
    public Map<String, ThriftStruct> getStructs() {
        return RaiserThriftMetadataHandlerStructs.getStructs();
    }

    @Override
    public Map<String, ThriftException> getExceptions() {
        return RaiserThriftMetadataHandlerExceptions.getExceptions();
    }
}
