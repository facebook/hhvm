...
DefineFunction(
  array(
    ...
    'return' => array(
      'type'   => null,
      'desc'   => "No value is returned. ob_clean Output Control Functions Last updated: Fri, 06 Aug 2010  ",
    ),
  ));
...
DefineFunction(
  array(
    'name'   => "ob_get_flush",
    'desc'   => "ob_get_flush() flushes the output buffer, return it as a string and turns off output buffering. Note: This function is similar to ob_end_flush(), except that this function returns the buffer as a string.",
    'return' => array(
      'type'   => String,
