...
public class AllowReservedIdentifierName implements TBase, java.io.Serializable, Cloneable {
  ...
  public static AllowReservedIdentifierName deserialize(TProtocol iprot) throws TException {
    TField __field;
    ...
    AllowReservedIdentifierName _that;
    _that = new AllowReservedIdentifierName(
    );
    _that.validate();
    return _that;
  }
