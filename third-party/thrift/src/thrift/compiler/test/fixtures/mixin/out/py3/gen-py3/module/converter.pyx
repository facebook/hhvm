...
cdef shared_ptr[_fbthrift_ctypes.cMixin1] Mixin1_convert_to_cpp(object inst):
...
cdef shared_ptr[_fbthrift_ctypes.cMixin2] Mixin2_convert_to_cpp(object inst):
...
cdef shared_ptr[_fbthrift_ctypes.cMixin3Base] Mixin3Base_convert_to_cpp(object inst):
