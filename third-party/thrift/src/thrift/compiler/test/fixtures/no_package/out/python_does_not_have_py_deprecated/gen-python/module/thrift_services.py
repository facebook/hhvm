...
class FooServiceInterface(
    ...
    async def _fbthrift__handler_simple_rpc(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_FooService_simple_rpc_args, args, protocol)
        value = await self.simple_rpc()
        return_struct = _fbthrift__module__thrift_types._fbthrift_FooService_simple_rpc_result()
...
class FB303ServiceInterface(
    ...
    async def simple_rpc(
        ...
        ) -> _fbthrift__module__thrift_types.ReservedKeyword:
        raise NotImplementedError("async def simple_rpc is not implemented")

    async def _fbthrift__handler_simple_rpc(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_FB303Service_simple_rpc_args, args, protocol)
        value = await self.simple_rpc(args_struct.int_parameter,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_FB303Service_simple_rpc_result(success=value)
        return serialize_iobuf(return_struct, protocol)
...
class MyServiceInterface(
    ...
    async def _fbthrift__handler_ping(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_ping_args, args, protocol)
        value = await self.ping()
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_ping_result()
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_getRandomData(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_getRandomData_args, args, protocol)
        value = await self.getRandomData()
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_getRandomData_result(success=value)
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_sink(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_sink_args, args, protocol)
        value = await self.sink(args_struct.sink,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_sink_result()
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_putDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_putDataById_args, args, protocol)
        value = await self.putDataById(args_struct.id,args_struct.data,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_putDataById_result()
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_hasDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_hasDataById_args, args, protocol)
        value = await self.hasDataById(args_struct.id,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_hasDataById_result(success=value)
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_getDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_getDataById_args, args, protocol)
        value = await self.getDataById(args_struct.id,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_getDataById_result(success=value)
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_deleteDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_deleteDataById_args, args, protocol)
        value = await self.deleteDataById(args_struct.id,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_deleteDataById_result()
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_lobDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> None:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_lobDataById_args, args, protocol)
    ...
    async def _fbthrift__handler_invalid_return_for_hack(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_invalid_return_for_hack_args, args, protocol)
        value = await self.invalid_return_for_hack()
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_invalid_return_for_hack_result(success=value)
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_rpc_skipped_codegen(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_MyService_rpc_skipped_codegen_args, args, protocol)
        value = await self.rpc_skipped_codegen()
        return_struct = _fbthrift__module__thrift_types._fbthrift_MyService_rpc_skipped_codegen_result()
        return serialize_iobuf(return_struct, protocol)
...
class DbMixedStackArgumentsInterface(
    ...
    async def _fbthrift__handler_getDataByKey0(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_DbMixedStackArguments_getDataByKey0_args, args, protocol)
        value = await self.getDataByKey0(args_struct.key,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_DbMixedStackArguments_getDataByKey0_result(success=value)
        return serialize_iobuf(return_struct, protocol)
    ...
    async def _fbthrift__handler_getDataByKey1(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__module__thrift_types._fbthrift_DbMixedStackArguments_getDataByKey1_args, args, protocol)
        value = await self.getDataByKey1(args_struct.key,)
        return_struct = _fbthrift__module__thrift_types._fbthrift_DbMixedStackArguments_getDataByKey1_result(success=value)
        return serialize_iobuf(return_struct, protocol)
