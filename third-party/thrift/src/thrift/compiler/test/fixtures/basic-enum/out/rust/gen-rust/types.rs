...
impl ::std::str::FromStr for EmptyEnum {
    ...
    fn from_str(string: &::std::primitive::str) -> ::std::result::Result<Self, Self::Err> {
        ...
        ::fbthrift::help::enum_from_str(VARIANTS_BY_NAME, string, "EmptyEnum").map(|v| Self(v as i32))
    }
}
...
impl ::fbthrift::ThriftEnum for MyUseIntrinsicDefaultEnum {
    ...
    fn from_inner_value(inner_value: i32) -> ::anyhow::Result<Self> {
        inner_value.try_into().map(Self).map_err(|e| {
            ::anyhow::anyhow!("Value {inner_value} is out of range for MyUseIntrinsicDefaultEnum: {e}")
        })
    }
}
...
impl ::std::str::FromStr for MyUseIntrinsicDefaultEnum {
    ...
    fn from_str(string: &::std::primitive::str) -> ::std::result::Result<Self, Self::Err> {
        ...
        ::fbthrift::help::enum_from_str(VARIANTS_BY_NAME, string, "MyUseIntrinsicDefaultEnum").map(|v| Self(v as i32))
    }
}
...
impl ::fbthrift::GetTypeNameType for self::MyUseIntrinsicDefaultEnum {
    fn type_name_type() -> fbthrift::TypeNameType {
        ::fbthrift::TypeNameType::EnumType
    }
}
...
impl ::fbthrift::ThriftEnum for MyBigEnum {
    ...
    fn from_inner_value(inner_value: i32) -> ::anyhow::Result<Self> {
        inner_value.try_into().map(Self).map_err(|e| {
            ::anyhow::anyhow!("Value {inner_value} is out of range for MyBigEnum: {e}")
        })
    }
}
...
impl ::std::str::FromStr for MyBigEnum {
    ...
    fn from_str(string: &::std::primitive::str) -> ::std::result::Result<Self, Self::Err> {
        ...
        ::fbthrift::help::enum_from_str(VARIANTS_BY_NAME, string, "MyBigEnum").map(|v| Self(v as i32))
    }
}
...
impl ::fbthrift::GetTypeNameType for self::MyBigEnum {
    fn type_name_type() -> fbthrift::TypeNameType {
        ::fbthrift::TypeNameType::EnumType
    }
}
