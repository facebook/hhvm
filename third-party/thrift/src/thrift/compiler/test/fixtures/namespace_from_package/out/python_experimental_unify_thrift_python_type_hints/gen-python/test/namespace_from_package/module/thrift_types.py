...
@test.namespace_from_package.module.thrift_abstract_types.Foo.register
class Foo(metaclass=_fbthrift_python_types.StructMeta):
    ...
    def _to_mutable_python(self):
        ...
        import importlib
        mutable_types = importlib.import_module("test.namespace_from_package.module.thrift_mutable_types")
