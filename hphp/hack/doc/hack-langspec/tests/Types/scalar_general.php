...
function main(): void {
  ...
  echo
    "is_numeric(\"123abc\"): ".(\is_numeric("123abc") ? "True" : "False")."\n";
  echo "is_numeric(\"abc\"): ".(\is_numeric("abc") ? "True" : "False")."\n";
  echo "is_numeric(null): ".(\is_numeric(null) ? "True" : "False")."\n";
  echo "is_numeric(array(10,20)): ".
    (\is_numeric(array(10, 20)) ? "True" : "False").
    "\n";
  ...
  echo "is_scalar(array(10,20)): ".
    (\is_scalar(array(10, 20)) ? "True" : "False").
    "\n";
  ...
  echo
    "is_null(array(10,20)): ".(\is_null(array(10, 20)) ? "True" : "False")."\n";
