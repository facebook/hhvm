...
$i = 0;
 print ++$i;
 print "\t";
 try { P('1'<true); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = '1';
 ...
 print ++$i;
 print "\t";
 try { P('1'<false); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = '1';
 ...
 print ++$i;
 print "\t";
 try { P('1'<null); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = '1';
 ...
 print ++$i;
 print "\t";
 try { P('1'<__hhvm_intrinsics\dummy_cast_to_kindofarray(vec[])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = '1';
