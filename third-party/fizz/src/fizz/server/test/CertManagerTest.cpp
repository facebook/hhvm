...
TEST_F(CertManagerTest, TestNoMatchDefault) {
  ...
  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("test.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  ...
  EXPECT_EQ(
      manager_.getCert(
          res2, err, std::string("test.com"), kEcdsa, kEcdsa, getChlo()),
      Status::Success);
...
TEST_F(CertManagerTest, TestNoSniDefault) {
  ...
  Error err;
  EXPECT_EQ(
      manager_.getCert(res, err, folly::none, kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_EQ(res->cert, cert);
}
...
TEST_F(CertManagerTest, TestNoDefault) {
  ...
  Error err;
  EXPECT_EQ(
      manager_.getCert(res, err, std::string("blah.com"), {}, {}, getChlo()),
      Status::Success);
...
TEST_F(CertManagerTest, TestAlts) {
  ...
  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("www.test.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_EQ(res->cert, cert);

  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("www.example.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_EQ(res->cert, cert);

  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("foo.example.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_EQ(res->cert, cert);
}
...
TEST_F(CertManagerTest, TestWildcard) {
  ...
  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("bar.test.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_EQ(res->cert, cert);

  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("foo.bar.test.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_FALSE(res.hasValue());
}
...
TEST_F(CertManagerTest, TestExactMatch) {
  ...
  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("foo.test.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_EQ(res->cert, cert2);
}
...
TEST_F(CertManagerTest, TestNoWildcard) {
  ...
  EXPECT_EQ(
      manager_.getCert(
          res, err, std::string("blah.test.com"), kRsa, kRsa, getChlo()),
      Status::Success);
  EXPECT_FALSE(res.hasValue());
