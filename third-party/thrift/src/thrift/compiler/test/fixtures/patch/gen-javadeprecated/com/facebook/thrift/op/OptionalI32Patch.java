...
public class OptionalI32Patch implements TBase, java.io.Serializable, Cloneable, Comparable<OptionalI32Patch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(OptionalI32Patch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    private I32Patch patchPrior;
    private int ensure;
    private I32Patch patch;
    ...
    public Builder setPatchPrior(final I32Patch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }

    public Builder setEnsure(final int ensure) {
      this.ensure = ensure;
      __optional_isset.set(__ENSURE_ISSET_ID, true);
      return this;
    }

    public Builder setPatch(final I32Patch patch) {
      this.patch = patch;
      return this;
    }

    public OptionalI32Patch build() {
      OptionalI32Patch result = new OptionalI32Patch();
   ...
   * Clears any set value. Applies first.
   */
  public OptionalI32Patch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public OptionalI32Patch setPatchPrior(I32Patch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((I32Patch)__value);
      }
      break;
  ...
  @Override
  public int compareTo(OptionalI32Patch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("OptionalI32Patch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
