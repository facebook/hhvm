...
ADAPTER_TRANSFORM: Dict[Target, str] = {
    ...
    Target.THRIFT: "{}|@cpp.Adapter{{name = '::apache::thrift::test::TemplatedTestAdapter'}}|@java.Adapter{{adapterClassName = 'com.facebook.thrift.adapter.test.GenericTypeAdapter', typeClassName = 'com.facebook.thrift.adapter.test.Wrapper'}}",
