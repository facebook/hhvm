...
public final class InnerUnionPatch implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public InnerUnionPatch(
        ...
        @com.facebook.swift.codec.ThriftField(value=6, name="patch", requiredness=Requiredness.NONE) final test.fixtures.patch.InnerUnionFieldPatch patch
    ) {
        this.assign = assign;
        this.clear = clear;
    ...
    public static class Builder {
        ...
        private test.fixtures.patch.InnerUnionFieldPatch patchPrior = null;
