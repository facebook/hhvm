          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.assign = new HashSet<String>(Math.max(0, 2*_set90.size));
              for (int _i91 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.remove = new HashSet<String>(Math.max(0, 2*_set93.size));
              for (int _i94 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              this.add = new HashSet<String>(Math.max(0, 2*_set96.size));
              for (int _i97 = 0; 
