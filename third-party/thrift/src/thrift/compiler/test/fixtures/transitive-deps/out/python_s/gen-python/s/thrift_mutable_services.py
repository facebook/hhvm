...
class TestServiceInterface(
    ...
    def getFunctionTable(self) -> _typing.Mapping[bytes, _fbthrift_FunctionEntry]:
        functionTable = {
            b"test": _fbthrift_FunctionEntry(RpcKind.SINGLE_REQUEST_SINGLE_RESPONSE, self._fbthrift__handler_test),
        }
    ...
    def __get_thrift_definition_key__() -> bytes:
        return b"\xea\xa9\xf2\xe9\xb9\xa4\x9a\x9d\x6f\xe6\xe6\xf4\xf1\x32\x7e\xf9"
...
def _fbthrift_get_services_reflection_module(service_name):
    try:
        import importlib
        _mod = importlib.import_module("s.thrift_services_reflection")
