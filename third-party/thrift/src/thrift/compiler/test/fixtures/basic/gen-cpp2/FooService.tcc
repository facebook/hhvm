...
void FooServiceAsyncProcessor::executeRequest_simple_rpc(apache::thrift::ServerRequest&& serverRequest) {
  ...
  apache::thrift::ContextStack::UniquePtr ctxStack = apache::thrift::ContextStack::create(this->coalesceLegacyEventHandlersWith(server), this->getServiceName(), "FooService.simple_rpc", serverRequest.requestContext());
  try {
