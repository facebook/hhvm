...
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 1> TStructDataStorage<::matching_module_name::MyStruct>::fields_names = {{
  "OtherStructField",
}};
THRIFT_DATA_SECTION const std::array<int16_t, 1> TStructDataStorage<::matching_module_name::MyStruct>::fields_ids = {{
  1,
}};
THRIFT_DATA_SECTION const std::array<protocol::TType, 1> TStructDataStorage<::matching_module_name::MyStruct>::fields_types = {{
  TType::T_STRUCT,
}};
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 1> TStructDataStorage<::matching_module_name::MyStruct>::storage_names = {{
  "__fbthrift_field_OtherStructField",
}};
THRIFT_DATA_SECTION const std::array<int, 1> TStructDataStorage<::matching_module_name::MyStruct>::isset_indexes = {{
  0,
}};
