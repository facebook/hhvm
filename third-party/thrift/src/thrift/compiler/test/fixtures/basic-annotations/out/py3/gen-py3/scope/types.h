...
#include "thrift/compiler/test/fixtures/basic-annotations/gen-cpp2/scope_data.h"
#include "thrift/compiler/test/fixtures/basic-annotations/gen-cpp2/scope_types.h"
#include "thrift/compiler/test/fixtures/basic-annotations/gen-cpp2/scope_metadata.h"
namespace thrift {
namespace py3 {
...
template<>
inline void reset_field<::facebook::thrift::annotation::ThrownException>(
    ::facebook::thrift::annotation::ThrownException& obj, uint16_t index) {
  switch (index) {
  }
}
...
template<>
inline void reset_field<::facebook::thrift::annotation::FunctionParameter>(
    ::facebook::thrift::annotation::FunctionParameter& obj, uint16_t index) {
  switch (index) {
  }
}
...
template<>
inline void reset_field<::facebook::thrift::annotation::DisableSchemaConst>(
    ::facebook::thrift::annotation::DisableSchemaConst& obj, uint16_t index) {
  switch (index) {
  }
}
...
template<>
inline const std::unordered_map<std::string_view, std::string_view>& PyStructTraits<
    ::facebook::thrift::annotation::ThrownException>::namesmap() {
  static const folly::Indestructible<NamesMap> map {
    {
    }
  };
...
template<>
inline const std::unordered_map<std::string_view, std::string_view>& PyStructTraits<
    ::facebook::thrift::annotation::FunctionParameter>::namesmap() {
  static const folly::Indestructible<NamesMap> map {
    {
    }
  };
...
template<>
inline const std::unordered_map<std::string_view, std::string_view>& PyStructTraits<
    ::facebook::thrift::annotation::DisableSchemaConst>::namesmap() {
  static const folly::Indestructible<NamesMap> map {
    {
    }
  };
