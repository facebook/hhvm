...
public class NoDeprecated implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public NoDeprecated(NoDeprecated other) {
  }

  public NoDeprecated deepCopy() {
    return new NoDeprecated(this);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof NoDeprecated))
      return false;
    NoDeprecated that = (NoDeprecated)_that;
  ...
  public static NoDeprecated deserialize(TProtocol iprot) throws TException {
    TField __field;
