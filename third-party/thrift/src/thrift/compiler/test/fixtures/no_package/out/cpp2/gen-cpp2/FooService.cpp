...
std::unique_ptr<apache::thrift::AsyncProcessor> apache::thrift::ServiceHandler<::cpp2::FooService>::getProcessor() {
  return std::make_unique<::cpp2::FooServiceAsyncProcessor>(this);
}

apache::thrift::ServiceHandler<::cpp2::FooService>::CreateMethodMetadataResult apache::thrift::ServiceHandler<::cpp2::FooService>::createMethodMetadata() {
  return ::apache::thrift::detail::ap::createMethodMetadataMap<::cpp2::FooServiceAsyncProcessor>(getServiceRequestInfoMap().value().get());
}


std::optional<std::reference_wrapper<apache::thrift::ServiceRequestInfoMap const>> apache::thrift::ServiceHandler<::cpp2::FooService>::getServiceRequestInfoMap() const {
  return __fbthrift_serviceInfoHolder.requestInfoMap();
}

::cpp2::FooServiceServiceInfoHolder apache::thrift::ServiceHandler<::cpp2::FooService>::__fbthrift_serviceInfoHolder;
...
void apache::thrift::ServiceHandler<::cpp2::FooService>::simple_rpc() {
  apache::thrift::detail::si::throw_app_exn_unimplemented("simple_rpc");
}

void apache::thrift::ServiceHandler<::cpp2::FooService>::sync_simple_rpc() {
  return simple_rpc();
}

folly::SemiFuture<folly::Unit>
apache::thrift::ServiceHandler<::cpp2::FooService>::semifuture_simple_rpc() {
...
apache::thrift::ServiceHandler<::cpp2::FooService>::future_simple_rpc() {
  ...
  return apache::thrift::detail::si::future(
      semifuture_simple_rpc(),
      getInternalKeepAlive());
}

#if FOLLY_HAS_COROUTINES
folly::coro::Task<void>
apache::thrift::ServiceHandler<::cpp2::FooService>::co_simple_rpc() {
...
folly::coro::Task<void> apache::thrift::ServiceHandler<::cpp2::FooService>::co_simple_rpc(
...
void apache::thrift::ServiceHandler<::cpp2::FooService>::async_tm_simple_rpc(
...
apache::thrift::ServiceRequestInfoMap FooServiceServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"simple_rpc",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::FooService>("simple_rpc")}},
  };
