...
public class FactoriesAsyncReactiveWrapper 
    implements Factories.Reactive {
    private final Factories.Async _delegate;

    public FactoriesAsyncReactiveWrapper(Factories.Async _delegate) {
    ...
    public class MyInteractionImpl implements MyInteraction {
        private Factories.Async.MyInteraction _delegateInteraction;

        MyInteractionImpl(Factories.Async.MyInteraction delegateInteraction) {
    ...
    public class MyInteractionFastImpl implements MyInteractionFast {
        private Factories.Async.MyInteractionFast _delegateInteraction;

        MyInteractionFastImpl(Factories.Async.MyInteractionFast delegateInteraction) {
            this._delegateInteraction = delegateInteraction;
        }
    ...
    public class SerialInteractionImpl implements SerialInteraction {
        private Factories.Async.SerialInteraction _delegateInteraction;

        SerialInteractionImpl(Factories.Async.SerialInteraction delegateInteraction) {
            this._delegateInteraction = delegateInteraction;
        }
