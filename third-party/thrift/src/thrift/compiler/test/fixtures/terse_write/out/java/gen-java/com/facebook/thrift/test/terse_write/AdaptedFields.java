...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="AdaptedFields", builder=AdaptedFields.Builder.class)
public final class AdaptedFields implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    public AdaptedFields(
        ...
        @com.facebook.swift.codec.ThriftField(value=2, name="field2", requiredness=Requiredness.TERSE) final int field2,
        @com.facebook.swift.codec.ThriftField(value=3, name="field3", requiredness=Requiredness.TERSE) final int field3
    ) {
        this.field1 = field1;
        this.field2 = field2;
        this.field3 = field3;
    ...
    public static Builder builder(AdaptedFields other) {
    ...
    public static AdaptedFields read0(TProtocol oprot) throws TException {
      ...
      AdaptedFields.Builder builder = new AdaptedFields.Builder();
      while (true) {
