...
namespace {
const int FB_UNSERIALIZE_NONSTRING_VALUE = 0;
const int FB_UNSERIALIZE_UNEXPECTED_END = 0;
const int FB_UNSERIALIZE_UNRECOGNIZED_OBJECT_TYPE = 0;
const int FB_UNSERIALIZE_UNEXPECTED_ARRAY_KEY_TYPE = 0;
const int FB_UNSERIALIZE_MAX_DEPTH_EXCEEDED = 0;

const int FB_SERIALIZE_HACK_ARRAYS = 0;
const int FB_SERIALIZE_HACK_ARRAYS_AND_KEYSETS = 0;
const int FB_SERIALIZE_VARRAY_DARRAY = 0;
const int FB_SERIALIZE_POST_HACK_ARRAY_MIGRATION = 0;

const int FB_COMPACT_SERIALIZE_FORCE_PHP_ARRAYS = 0;

const int XHPROF_FLAGS_NO_BUILTINS = 0;
const int XHPROF_FLAGS_CPU = 0;
const int XHPROF_FLAGS_MEMORY = 0;
const int XHPROF_FLAGS_VTSC = 0;
const int XHPROF_FLAGS_TRACE = 0;
const int XHPROF_FLAGS_MEASURE_XHPROF_DISABLE = 0;
const int XHPROF_FLAGS_MALLOC = 0;
const int XHPROF_FLAGS_I_HAVE_INFINITE_MEMORY = 0;

const int SETPROFILE_FLAGS_ENTERS = 1;
const int SETPROFILE_FLAGS_EXITS = 2;
const int SETPROFILE_FLAGS_DEFAULT = 3;
const int SETPROFILE_FLAGS_FRAME_PTRS = 4;
const int SETPROFILE_FLAGS_CTORS = 8;
const int SETPROFILE_FLAGS_RESUME_AWARE = 16;
/* This flag enables access to $this upon instance method entry in the
 * setprofile handler. It *may break* in the future. */
const int SETPROFILE_FLAGS_THIS_OBJECT__MAY_BREAK = 32;
