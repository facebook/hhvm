...
void apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::fbthrift_send_func(apache::thrift::SerializedRequest&& request, RpcOptions&& rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::RequestClientCallback::Ptr callback, std::unique_ptr<folly::IOBuf> interceptorFrameworkMetadata) {

  static ::apache::thrift::MethodMetadata::Data* methodMetadata =
        new ::apache::thrift::MethodMetadata::Data(
                "func",
                ::apache::thrift::FunctionQualifier::Unspecified,
                "facebook.com/thrift/test/fixtures/adapter/Service");
...
void apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::func(std::unique_ptr<apache::thrift::RequestCallback> callback, const ::facebook::thrift::test::fixtures::adapter::StringWithAdapter_7208& p_arg1, const ::facebook::thrift::test::fixtures::adapter::StringWithCppAdapter& p_arg2, const ::facebook::thrift::test::fixtures::adapter::Foo& p_arg3) {
  ::apache::thrift::RpcOptions rpcOptions;
  func(rpcOptions, std::move(callback), p_arg1, p_arg2, p_arg3);
}

void apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::func(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const ::facebook::thrift::test::fixtures::adapter::StringWithAdapter_7208& p_arg1, const ::facebook::thrift::test::fixtures::adapter::StringWithCppAdapter& p_arg2, const ::facebook::thrift::test::fixtures::adapter::Foo& p_arg3) {
...
apache::thrift::SerializedRequest apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::fbthrift_serialize_func(const RpcOptions& rpcOptions, apache::thrift::transport::THeader& header, apache::thrift::ContextStack* contextStack, const ::facebook::thrift::test::fixtures::adapter::StringWithAdapter_7208& p_arg1, const ::facebook::thrift::test::fixtures::adapter::StringWithCppAdapter& p_arg2, const ::facebook::thrift::test::fixtures::adapter::Foo& p_arg3) {
  return apache::thrift::detail::ac::withProtocolWriter(apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId(), [&](auto&& prot) {
    ...
    ::facebook::thrift::test::fixtures::adapter::Service_func_pargs args;
    args.get<0>().value = const_cast<::facebook::thrift::test::fixtures::adapter::StringWithAdapter_7208*>(&p_arg1);
    args.get<1>().value = const_cast<::facebook::thrift::test::fixtures::adapter::StringWithCppAdapter*>(&p_arg2);
    args.get<2>().value = const_cast<::facebook::thrift::test::fixtures::adapter::Foo*>(&p_arg3);
...
std::pair<::apache::thrift::ContextStack::UniquePtr, std::shared_ptr<::apache::thrift::transport::THeader>> apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::funcCtx(apache::thrift::RpcOptions* rpcOptions) {
...
::facebook::thrift::test::fixtures::adapter::MyI32_4873 apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::sync_func(const ::facebook::thrift::test::fixtures::adapter::StringWithAdapter_7208& p_arg1, const ::facebook::thrift::test::fixtures::adapter::StringWithCppAdapter& p_arg2, const ::facebook::thrift::test::fixtures::adapter::Foo& p_arg3) {
  ::apache::thrift::RpcOptions rpcOptions;
...
folly::SemiFuture<::facebook::thrift::test::fixtures::adapter::MyI32_4873> apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::fbthrift_semifuture_func(apache::thrift::RpcOptions& rpcOptions, const ::facebook::thrift::test::fixtures::adapter::StringWithAdapter_7208& p_arg1, const ::facebook::thrift::test::fixtures::adapter::StringWithCppAdapter& p_arg2, const ::facebook::thrift::test::fixtures::adapter::Foo& p_arg3) {
  using CallbackHelper = apache::thrift::detail::FutureCallbackHelper<::facebook::thrift::test::fixtures::adapter::MyI32_4873>;
  ...
  if (contextStack != nullptr) {
    ...
    if (auto exTry = contextStack->processClientInterceptorsOnRequest(apache::thrift::ClientInterceptorOnRequestArguments(argsAsRefs), header.get(), rpcOptions);
        exTry.hasException()) {
      return folly::makeSemiFuture<::facebook::thrift::test::fixtures::adapter::MyI32_4873>(std::move(exTry).exception());
    }
    interceptorFrameworkMetadata = detail::ContextStackUnsafeAPI(*contextStack).getInterceptorFrameworkMetadata(rpcOptions);
  }
  apache::thrift::SerializedRequest request = fbthrift_serialize_func(rpcOptions, *header, contextStack, p_arg1, p_arg2, p_arg3);
...
folly::Future<::facebook::thrift::test::fixtures::adapter::MyI32_4873> apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::future_func(const ::facebook::thrift::test::fixtures::adapter::StringWithAdapter_7208& p_arg1, const ::facebook::thrift::test::fixtures::adapter::StringWithCppAdapter& p_arg2, const ::facebook::thrift::test::fixtures::adapter::Foo& p_arg3) {
  ::apache::thrift::RpcOptions rpcOptions;
...
folly::exception_wrapper apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::recv_wrapped_func(::facebook::thrift::test::fixtures::adapter::MyI32_4873& _return, ::apache::thrift::ClientReceiveState& state) {
  ...
  using result = ::facebook::thrift::test::fixtures::adapter::Service_func_presult;
...
::facebook::thrift::test::fixtures::adapter::MyI32_4873 apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::recv_func(::apache::thrift::ClientReceiveState& state) {
  ::facebook::thrift::test::fixtures::adapter::MyI32_4873 _return;
...
::facebook::thrift::test::fixtures::adapter::MyI32_4873 apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::recv_instance_func(::apache::thrift::ClientReceiveState& state) {
  return recv_func(state);
}

folly::exception_wrapper apache::thrift::Client<::facebook::thrift::test::fixtures::adapter::Service>::recv_instance_wrapped_func(::facebook::thrift::test::fixtures::adapter::MyI32_4873& _return, ::apache::thrift::ClientReceiveState& state) {
