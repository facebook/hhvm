...
void apache::thrift::ServiceHandler<::test::namespace_from_package_without_module_name::TestService>::async_tm_init(apache::thrift::HandlerCallback<::std::int64_t>::Ptr callback, ::std::int64_t p_int1) {
