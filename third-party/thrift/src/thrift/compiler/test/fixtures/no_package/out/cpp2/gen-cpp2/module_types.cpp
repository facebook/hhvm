...
template void TccStructTraits<::cpp2::MyUnion>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::MyException>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::MyExceptionWithMessage>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::ReservedKeyword>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::cpp2::UnionToBeRenamed>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
const std::string_view TEnumTraits<::cpp2::HackEnum>::__fbthrift_module_name_internal_do_not_use = kModuleName;
folly::Range<::cpp2::HackEnum const*> const TEnumTraits<::cpp2::HackEnum>::values = folly::range(TEnumDataStorage<::cpp2::HackEnum>::values);
folly::Range<std::string_view const*> const TEnumTraits<::cpp2::HackEnum>::names = folly::range(TEnumDataStorage<::cpp2::HackEnum>::names);

bool TEnumTraits<::cpp2::HackEnum>::findName(type value, std::string_view* out) noexcept {
  return ::apache::thrift::detail::st::enum_find_name(value, out);
}

bool TEnumTraits<::cpp2::HackEnum>::findValue(std::string_view name, type* out) noexcept {
  return ::apache::thrift::detail::st::enum_find_value(name, out);
}

const std::vector<std::any>& TEnumTraits<::cpp2::HackEnum>::annotations() noexcept {
  return ::apache::thrift::detail::annotation::empty_annotations();
}

const std::vector<std::any>& TEnumTraits<::cpp2::HackEnum>::enumValueAnnotations(::cpp2::HackEnum value) noexcept {
  switch (static_cast<std::int32_t>(value)) {
    default:
      return ::apache::thrift::detail::annotation::empty_annotations();
  }
...
MyStruct::MyStruct(apache::thrift::FragileConstructor, ::std::int64_t MyIntField__arg, ::std::string MyStringField__arg, ::cpp2::MyDataItemAlias MyDataField__arg, ::cpp2::MyEnum myEnum__arg, bool oneway__arg, bool readonly__arg, bool idempotent__arg, ::std::set<float> floatSet__arg, ::std::string no_hack_codegen_field__arg) :
...
const ::cpp2::MyDataItemAlias& MyStruct::get_MyDataField() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return __fbthrift_field_MyDataField;
}

::cpp2::MyDataItemAlias MyStruct::get_MyDataField() && {
  return static_cast<::cpp2::MyDataItemAlias&&>(__fbthrift_field_MyDataField);
}
...
MyException::MyException(apache::thrift::FragileConstructor, ::std::int64_t MyIntField__arg, ::std::string MyStringField__arg, ::cpp2::MyStruct myStruct__arg, ::cpp2::MyUnion myUnion__arg) :
    __fbthrift_field_MyIntField(std::move(MyIntField__arg)),
    __fbthrift_field_MyStringField(std::move(MyStringField__arg)),
...
const ::cpp2::MyStruct& MyException::get_myStruct() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return __fbthrift_field_myStruct;
}

::cpp2::MyStruct MyException::get_myStruct() && {
  return static_cast<::cpp2::MyStruct&&>(__fbthrift_field_myStruct);
}

const ::cpp2::MyUnion& MyException::get_myUnion() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return __fbthrift_field_myUnion;
}

::cpp2::MyUnion MyException::get_myUnion() && {
...
MyExceptionWithMessage::MyExceptionWithMessage(apache::thrift::FragileConstructor, ::std::int64_t MyIntField__arg, ::std::string MyStringField__arg, ::cpp2::MyStruct myStruct__arg, ::cpp2::MyUnion myUnion__arg) :
    __fbthrift_field_MyIntField(std::move(MyIntField__arg)),
    __fbthrift_field_MyStringField(std::move(MyStringField__arg)),
    __fbthrift_field_myStruct(std::move(myStruct__arg)),
    __fbthrift_field_myUnion(std::move(myUnion__arg)) { 
...
const ::cpp2::MyStruct& MyExceptionWithMessage::get_myStruct() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return __fbthrift_field_myStruct;
}

::cpp2::MyStruct MyExceptionWithMessage::get_myStruct() && {
  return static_cast<::cpp2::MyStruct&&>(__fbthrift_field_myStruct);
}

const ::cpp2::MyUnion& MyExceptionWithMessage::get_myUnion() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return __fbthrift_field_myUnion;
}

::cpp2::MyUnion MyExceptionWithMessage::get_myUnion() && {
  return static_cast<::cpp2::MyUnion&&>(__fbthrift_field_myUnion);
}
...
folly::Range<::cpp2::UnionToBeRenamed::Type const*> const TEnumTraits<::cpp2::UnionToBeRenamed::Type>::values = folly::range(TEnumDataStorage<::cpp2::UnionToBeRenamed::Type>::values);
folly::Range<std::string_view const*> const TEnumTraits<::cpp2::UnionToBeRenamed::Type>::names = folly::range(TEnumDataStorage<::cpp2::UnionToBeRenamed::Type>::names);

bool TEnumTraits<::cpp2::UnionToBeRenamed::Type>::findName(type value, std::string_view* out) noexcept {
  return ::apache::thrift::detail::st::enum_find_name(value, out);
}

bool TEnumTraits<::cpp2::UnionToBeRenamed::Type>::findValue(std::string_view name, type* out) noexcept {
  return ::apache::thrift::detail::st::enum_find_value(name, out);
}
}} // apache::thrift
namespace cpp2 {
