...
Returns a subset of the current [` ConstSet `](/docs/apis/Interfaces/ConstSet/) starting from a given key up
...
` $start ` is 0-based. `` $len `` is 1-based. So [` slice(0, `](/docs/apis/Interfaces/ConstSet/slice/)`` 2) `` would return the
...
+ ` int $start ` - The starting value in the current [` ConstSet `](/docs/apis/Interfaces/ConstSet/) for the
  returned [` ConstSet `](/docs/apis/Interfaces/ConstSet/).
+ ` int $len ` - The length of the returned [` ConstSet `](/docs/apis/Interfaces/ConstSet/).
