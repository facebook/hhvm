...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="RefFieldsField6Patch", builder=RefFieldsField6Patch.Builder.class)
public final class RefFieldsField6Patch implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    ...
    @ThriftConstructor
    protected RefFieldsField6Patch() {
      this.assign = null;
      this.clear = false;
    ...
    public static class Builder {
        ...
        public Builder() { }
        public Builder(RefFieldsField6Patch other) {
    ...
    static {
      ...
      com.facebook.thrift.type.TypeRegistry.add(new com.facebook.thrift.type.Type(
        new com.facebook.thrift.type.UniversalName("test.dev/fixtures/patch/RefFieldsField6Patch"),
        RefFieldsField6Patch.class, RefFieldsField6Patch::read0));
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefFieldsField6Patch other = (RefFieldsField6Patch)o;
    ...
    public static com.facebook.thrift.payload.Reader<RefFieldsField6Patch> asReader() {
      return RefFieldsField6Patch::read0;
    }
    
    public static RefFieldsField6Patch read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(RefFieldsField6Patch.NAMES_TO_IDS, RefFieldsField6Patch.THRIFT_NAMES_TO_IDS, RefFieldsField6Patch.FIELD_METADATA);
      RefFieldsField6Patch.Builder builder = new RefFieldsField6Patch.Builder();
      while (true) {
    ...
    private static class _RefFieldsField6PatchLazy {
        private static final RefFieldsField6Patch _DEFAULT = new RefFieldsField6Patch.Builder().build();
    }
    
    public static RefFieldsField6Patch defaultInstance() {
        return  _RefFieldsField6PatchLazy._DEFAULT;
    }
}
