...
struct ForEachField<::test::fixtures::patch::MyStructFieldPatchStruct> {
  template <typename F, typename... T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
    f(0, static_cast<T&&>(t).optMapVal_ref()...);
    f(1, static_cast<T&&>(t).optSetVal_ref()...);
    f(2, static_cast<T&&>(t).optListVal_ref()...);
    f(3, static_cast<T&&>(t).optLateStructVal_ref()...);
    f(4, static_cast<T&&>(t).optStructVal_ref()...);
    f(5, static_cast<T&&>(t).optEnumVal_ref()...);
    f(6, static_cast<T&&>(t).optBinaryVal_ref()...);
    f(7, static_cast<T&&>(t).optStringVal_ref()...);
    f(8, static_cast<T&&>(t).optDoubleVal_ref()...);
    f(9, static_cast<T&&>(t).optFloatVal_ref()...);
    f(10, static_cast<T&&>(t).optI64Val_ref()...);
    f(11, static_cast<T&&>(t).optI32Val_ref()...);
    f(12, static_cast<T&&>(t).optI16Val_ref()...);
    f(13, static_cast<T&&>(t).optByteVal_ref()...);
    f(14, static_cast<T&&>(t).optBoolVal_ref()...);
    f(15, static_cast<T&&>(t).timeVal_ref()...);
    f(16, static_cast<T&&>(t).durationVal_ref()...);
...
template <>
struct ForEachField<::test::fixtures::patch::RecursiveFieldN1PatchStruct> {
  template <typename F, typename... T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
    f(0, static_cast<T&&>(t).assign_ref()...);
    f(1, static_cast<T&&>(t).clear_ref()...);
