...
var (
    premadeThriftType_module_Empty = func() *metadata.ThriftType {
        return metadata.NewThriftType().SetTStruct(
            metadata.NewThriftStructType().
                SetName("module.Empty"),
        )
    }()
    premadeThriftType_module_Nada = func() *metadata.ThriftType {
...
var premadeThriftTypesMap = func() map[string]*metadata.ThriftType {
    ...
    fbthriftThriftTypesMap["module.Empty"] = premadeThriftType_module_Empty
    fbthriftThriftTypesMap["module.Nada"] = premadeThriftType_module_Nada
    return fbthriftThriftTypesMap
}()

var structMetadatas = func() []*metadata.ThriftStruct {
    fbthriftResults := make([]*metadata.ThriftStruct, 0)
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_Empty))
    fbthriftResults = append(fbthriftResults, getMetadataThriftStruct(premadeStructSpec_Nada))
