...
template <>
struct TccStructTraits<::cpp2::ShouldBeBoxed> {
  static void translateFieldName(
      std::string_view _fname,
      int16_t& fid,
      apache::thrift::protocol::TType& _ftype) noexcept;
...
_readField_sessionId:
  {
    ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::string, ::std::string>::readWithContext(*iprot, this->__fbthrift_field_sessionId, _readState);
  }
 this->__isset.set(0, true);
...
_loop:
  ...
  if (iprot->kUsesFieldNames()) {
    _readState.template fillFieldTraitsFromName<apache::thrift::detail::TccStructTraits<ShouldBeBoxed>>();
  }
...
template <class Protocol_>
uint32_t ShouldBeBoxed::serializedSize(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("ShouldBeBoxed");
  {
    xfer += prot_->serializedFieldSize("sessionId", apache::thrift::protocol::T_STRING, 1);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::string, ::std::string>::serializedSize<false>(*prot_, this->__fbthrift_field_sessionId);
  }
  xfer += prot_->serializedSizeStop();
  return xfer;
}
...
template <class Protocol_>
uint32_t ShouldBeBoxed::serializedSizeZC(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("ShouldBeBoxed");
  {
    xfer += prot_->serializedFieldSize("sessionId", apache::thrift::protocol::T_STRING, 1);
...
template <class Protocol_>
uint32_t ShouldBeBoxed::write(Protocol_* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->writeStructBegin("ShouldBeBoxed");
  bool previousFieldHasValue = true;
  {
    constexpr int16_t kPrevFieldId = 0;
    xfer += ::apache::thrift::detail::writeFieldBegin<apache::thrift::protocol::T_STRING, 1, kPrevFieldId>(*prot_, "sessionId", previousFieldHasValue);
    previousFieldHasValue = true;
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::string, ::std::string>::write(*prot_, this->__fbthrift_field_sessionId);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldStop();
  xfer += prot_->writeStructEnd();
...
extern template void ShouldBeBoxed::readNoXfer<>(apache::thrift::BinaryProtocolReader*);
extern template uint32_t ShouldBeBoxed::write<>(apache::thrift::BinaryProtocolWriter*) const;
extern template uint32_t ShouldBeBoxed::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template uint32_t ShouldBeBoxed::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template void ShouldBeBoxed::readNoXfer<>(apache::thrift::CompactProtocolReader*);
extern template uint32_t ShouldBeBoxed::write<>(apache::thrift::CompactProtocolWriter*) const;
extern template uint32_t ShouldBeBoxed::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
extern template uint32_t ShouldBeBoxed::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
