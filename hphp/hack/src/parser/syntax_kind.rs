...
impl SyntaxKind {
    pub fn to_string(&self) -> &str {
        match self {
            ...
            SyntaxKind::ClassAliasDeclaration                          => "class_alias_declaration",
    ...
    pub fn ocaml_tag(self) -> u8 {
        match self {
            ...
            SyntaxKind::ClassAliasDeclaration => 39,
            SyntaxKind::ClassishBody => 40,
            SyntaxKind::TraitUse => 41,
            SyntaxKind::RequireClause => 42,
            SyntaxKind::RequireClauseConstraint => 43,
            ...
            SyntaxKind::NamedArgument => 49,
            SyntaxKind::ParameterDeclaration => 50,
            ...
            SyntaxKind::ClassPtrTypeSpecifier => 161,
            ...
            SyntaxKind::ModuleMembershipDeclaration => 181,
            SyntaxKind::PackageExpression => 182,
        }
    }
}
