...
pub mod r#impl {
    pub mod foo {
        ...
        impl<'mock> r#return<'mock> {
            ...
            pub fn mock_result(&self, mut mock: impl ::std::ops::FnMut(crate::types::ThereAreNoPascalCaseKeywords) -> ::std::result::Result<(), ::::errors::foo::ReturnError> + ::std::marker::Send + ::std::marker::Sync + 'mock) {
                let mut closure = self.closure.lock().unwrap();
            ...
            pub fn throw<E>(&self, exception: E)
            where
                E: ::std::convert::Into<::::errors::foo::ReturnError>,
        ...
        impl<'mock> super_<'mock> {
            ...
            pub fn mock_result(&self, mut mock: impl ::std::ops::FnMut(crate::types::ThereAreNoPascalCaseKeywords) -> ::std::result::Result<(), ::::errors::foo::SuperError> + ::std::marker::Send + ::std::marker::Sync + 'mock) {
                let mut closure = self.closure.lock().unwrap();
                *closure = ::std::boxed::Box::new(move |bar| mock(bar));
            }
            ...
            pub fn throw<E>(&self, exception: E)
            where
                E: ::std::convert::Into<::::errors::foo::SuperError>,
                E: ::std::clone::Clone + ::std::marker::Send + ::std::marker::Sync + 'mock,
            {
                let mut closure = self.closure.lock().unwrap();
                *closure = ::std::boxed::Box::new(move |_: crate::types::ThereAreNoPascalCaseKeywords| ::std::result::Result::Err(exception.clone().into()));
