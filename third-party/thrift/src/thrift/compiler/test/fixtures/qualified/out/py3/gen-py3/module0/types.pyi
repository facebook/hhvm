...
import sys
import itertools
import module0.thrift_types


class Enum(thrift.python.types.Enum, int):
    ONE: Enum = ...
    TWO: Enum = ...
    THREE: Enum = ...
    def _to_python(self) -> module0.thrift_types.Enum: ...
...
class Struct(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def _to_python(self) -> module0.thrift_types.Struct: ...
    def _to_py3(self) -> Struct: ...
    def _to_py_deprecated(self) -> "module0.ttypes.Struct": ...   # type: ignore
