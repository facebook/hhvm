...
class MyEnumA(thrift.python.types.Enum, int):
    fieldA: MyEnumA = ...
    fieldB: MyEnumA = ...
    fieldC: MyEnumA = ...
    def _to_python(self) -> module.thrift_types.MyEnumA: ...
...
class AnnotatedEnum(thrift.python.types.Enum, int):
    FIELDA: AnnotatedEnum = ...
    FIELDB: AnnotatedEnum = ...
    FIELDC: AnnotatedEnum = ...
    def _to_python(self) -> module.thrift_types.AnnotatedEnum: ...
...
class AnnotatedEnum2(thrift.python.types.Enum, int):
    FIELDA: AnnotatedEnum2 = ...
    FIELDB: AnnotatedEnum2 = ...
    FIELDC: AnnotatedEnum2 = ...
    def _to_python(self) -> module.thrift_types.AnnotatedEnum2: ...
...
class MyEnumB(thrift.python.types.Enum, int):
    AField: MyEnumB = ...
    def _to_python(self) -> module.thrift_types.MyEnumB: ...
...
class AnnotatedStruct(thrift.py3.types.Struct, _typing.Hashable):
    ...
    indirection_a: _typing.Final[int] = ...
    indirection_b: _typing.Final[_typing.Sequence[float]] = ...
    indirection_c: _typing.Final[_typing.AbstractSet[int]] = ...
...
class List__Bar__double(_typing.Sequence[float], _typing.Hashable):
    ...
    def __radd__(self, other: _typing.Sequence[float]) -> 'List__Bar__double': ...
