          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_assign = new HashSet<String>(Math.max(0, 2*_set54.size));
              for (int _i55 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<String>(Math.max(0, 2*_set57.size));
              for (int _i58 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_add = new HashSet<String>(Math.max(0, 2*_set60.size));
              for (int _i61 = 0; 
