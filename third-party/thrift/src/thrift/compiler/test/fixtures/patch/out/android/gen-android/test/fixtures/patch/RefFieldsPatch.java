...
public class RefFieldsPatch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public final RefFieldsFieldPatch patchPrior;
  /**
   * Initialize fields, using the given defaults. Applies third.
   */
  public final RefFieldsEnsureStruct ensure;
  /**
   * Patches any set value, including newly set values. Applies last.
   */
  public final RefFieldsFieldPatch patch;
  /**
  ...
  public static RefFieldsPatch deserialize(TProtocol iprot) throws TException {
    RefFields tmp_assign = null;
    Boolean tmp_clear = null;
    RefFieldsFieldPatch tmp_patchPrior = null;
    RefFieldsEnsureStruct tmp_ensure = null;
    RefFieldsFieldPatch tmp_patch = null;
      ...
      switch (__field.id)
      {
        case ASSIGN:
          if (__field.type == TType.STRUCT) {
            tmp_assign = RefFields.deserialize(iprot);
          } else {
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            tmp_patchPrior = RefFieldsFieldPatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case ENSURE:
          if (__field.type == TType.STRUCT) {
            tmp_ensure = RefFieldsEnsureStruct.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        case PATCH:
          if (__field.type == TType.STRUCT) {
            tmp_patch = RefFieldsFieldPatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
          ...
          if (__field.type == TType.LIST) {
            {
              ...
              tmp_remove = new ArrayList<Short>(Math.max(0, _list284.size));
              for (int _i285 = 0; 
    ...
    RefFieldsPatch _that;
    _that = new RefFieldsPatch(
      tmp_assign
      ,tmp_clear
      ,tmp_patchPrior
      ,tmp_ensure
