...
public class TimeStruct implements TBase, java.io.Serializable, Cloneable, Comparable<TimeStruct> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(TimeStruct.class, metaDataMap);
  }
   ...
   * The count of seconds.
   */
  public TimeStruct setSeconds(long seconds) {
    this.seconds = seconds;
    setSecondsIsSet(true);
    return this;
  }
   ...
   * The count of nanoseconds.
   */
  public TimeStruct setNanos(int nanos) {
    this.nanos = nanos;
    setNanosIsSet(true);
    return this;
  }
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("TimeStruct");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
