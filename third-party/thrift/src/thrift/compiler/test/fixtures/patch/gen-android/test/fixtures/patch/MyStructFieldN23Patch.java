...
public class MyStructFieldN23Patch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyStructFieldN23Patch deserialize(TProtocol iprot) throws TException {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_assign = new HashMap<String,String>(Math.max(0, 2*_map41.size));
              for (int _i42 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_add = new HashMap<String,String>(Math.max(0, 2*_map45.size));
              for (int _i46 = 0; 
          ...
          if (__field.type == TType.SET) {
            {
              ...
              tmp_remove = new HashSet<String>(Math.max(0, 2*_set49.size));
              for (int _i50 = 0; 
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_put = new HashMap<String,String>(Math.max(0, 2*_map52.size));
              for (int _i53 = 0; 
    ...
    MyStructFieldN23Patch _that;
    _that = new MyStructFieldN23Patch(
      tmp_assign
      ,tmp_clear
      ,tmp_add
      ,tmp_remove
