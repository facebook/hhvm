...
#define YYTOKEN(num, name) name = num,
   ...
   YYTOKEN_MAP {
     ...
     YYTOKEN(364, T_NULLSAFE_OBJECT_OPERATOR)
     YYTOKEN(365, T_DOUBLE_ARROW)
     YYTOKEN(366, T_LIST)
     YYTOKEN(367, T_ARRAY)
     YYTOKEN(368, T_CALLABLE)
     YYTOKEN(369, T_CLASS_C)
     YYTOKEN(370, T_METHOD_C)
     YYTOKEN(371, T_FUNC_C)
     YYTOKEN(372, T_LINE)
     YYTOKEN(373, T_FILE)
     YYTOKEN(374, T_COMMENT)
     YYTOKEN(375, T_DOC_COMMENT)
     YYTOKEN(376, T_OPEN_TAG)
     YYTOKEN(377, T_OPEN_TAG_WITH_ECHO)
     YYTOKEN(378, T_CLOSE_TAG)
     YYTOKEN(379, T_WHITESPACE)
     YYTOKEN(380, T_START_HEREDOC)
     YYTOKEN(381, T_END_HEREDOC)
     YYTOKEN(382, T_DOLLAR_OPEN_CURLY_BRACES)
     YYTOKEN(383, T_CURLY_OPEN)
     YYTOKEN(384, T_DOUBLE_COLON)
     YYTOKEN(385, T_NAMESPACE)
     YYTOKEN(386, T_NS_C)
     YYTOKEN(387, T_DIR)
     YYTOKEN(388, T_NS_SEPARATOR)
     YYTOKEN(389, T_XHP_LABEL)
     YYTOKEN(390, T_XHP_TEXT)
     YYTOKEN(391, T_XHP_ATTRIBUTE)
     YYTOKEN(392, T_XHP_CATEGORY)
     YYTOKEN(393, T_XHP_CATEGORY_LABEL)
     YYTOKEN(394, T_XHP_CHILDREN)
     YYTOKEN(395, T_ENUM)
     YYTOKEN(396, T_XHP_REQUIRED)
     YYTOKEN(397, T_TRAIT)
     YYTOKEN(398, T_ELLIPSIS)
     YYTOKEN(399, T_INSTEADOF)
     YYTOKEN(400, T_TRAIT_C)
     YYTOKEN(401, T_HH_ERROR)
     YYTOKEN(402, T_FINALLY)
     YYTOKEN(403, T_XHP_TAG_LT)
     YYTOKEN(404, T_XHP_TAG_GT)
     YYTOKEN(405, T_TYPELIST_LT)
     YYTOKEN(406, T_TYPELIST_GT)
     YYTOKEN(407, T_UNRESOLVED_LT)
     YYTOKEN(408, T_COLLECTION)
     YYTOKEN(409, T_SHAPE)
     YYTOKEN(410, T_VARRAY)
     YYTOKEN(411, T_MIARRAY)
     YYTOKEN(412, T_MSARRAY)
     YYTOKEN(413, T_TYPE)
     ...
     YYTOKEN(422, T_IN)
     YYTOKEN(423, T_ON)
     YYTOKEN(424, T_EQUALS)
     YYTOKEN(425, T_INTO)
     YYTOKEN(426, T_LET)
     YYTOKEN(427, T_ORDERBY)
     YYTOKEN(428, T_ASCENDING)
     YYTOKEN(429, T_DESCENDING)
     YYTOKEN(430, T_SELECT)
     YYTOKEN(431, T_GROUP)
     YYTOKEN(432, T_BY)
     YYTOKEN(433, T_LAMBDA_OP)
     YYTOKEN(434, T_LAMBDA_CP)
     YYTOKEN(435, T_UNRESOLVED_OP)
   };
#endif
