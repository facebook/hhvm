...
class folly_sorted_vector_map__Map__i32_string(thrift.py3.types.Map):
    ...
    @staticmethod
    def from_python(python_map: thrift.python.types.Map) -> folly_sorted_vector_map__Map__i32_string:
        _keys = python_map.keys()
        _values = python_map.values()
        return folly_sorted_vector_map__Map__i32_string(
            items=dict(zip(_keys, _values)),
            private_ctor_token=thrift.py3.types._fbthrift_map_private_ctor,
        )
...
class ContainerStruct(thrift.py3.types.Struct):
    ...
    def fieldG(self) -> _typing.Mapping[int, str]:
        if self._fbthrift_inner__fieldG is None:
            ...
            self._fbthrift_inner__fieldG = folly_sorted_vector_map__Map__i32_string.from_python(__python_val)
