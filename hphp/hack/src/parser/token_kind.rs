...
impl TokenKind {
    ...
    pub fn try_from_u8(tag: u8) -> Option<Self> {
        match tag {
            ...
            94 => Some(TokenKind::Suspend),
            95 => Some(TokenKind::Switch),
            96 => Some(TokenKind::This),
            97 => Some(TokenKind::Throw),
            98 => Some(TokenKind::Trait),
            99 => Some(TokenKind::Try),
            100 => Some(TokenKind::Tuple),
            101 => Some(TokenKind::Type),
            102 => Some(TokenKind::Unset),
            ...
            180 => Some(TokenKind::ColonAt),
            181 => Some(TokenKind::Backtick),
            182 => Some(TokenKind::XHP),
            183 => Some(TokenKind::Hash),
    ...
    pub fn fixed_width(self) -> Option<NonZeroUsize> {
        match self {
            ...
            TokenKind::Goto => Some(unsafe { NonZeroUsize::new_unchecked(4) }),
            ...
            TokenKind::ColonAt => Some(unsafe { NonZeroUsize::new_unchecked(2) }),
