...
void apache::thrift::ServiceHandler<::cpp2::MyServiceFast>::async_eb_hasDataById(apache::thrift::HandlerCallback<bool>::Ptr callback, ::std::int64_t /*id*/) {
  callback->exception(apache::thrift::detail::si::create_app_exn_unimplemented("hasDataById"));
}

void apache::thrift::ServiceHandler<::cpp2::MyServiceFast>::async_eb_getDataById(apache::thrift::HandlerCallback<::std::string>::Ptr callback, ::std::int64_t /*id*/) {
  callback->exception(apache::thrift::detail::si::create_app_exn_unimplemented("getDataById"));
}

void apache::thrift::ServiceHandler<::cpp2::MyServiceFast>::async_eb_putDataById(apache::thrift::HandlerCallback<void>::Ptr callback, ::std::int64_t /*id*/, const ::std::string& /*data*/) {
