...
class Foo(metaclass=_fbthrift_python_types.StructMeta):
    ...
    def __get_thrift_definition_key__() -> bytes:
        return b"\x0b\x17\xd1\xad\xdc\x1a\x95\xcd\x54\xf6\x12\xc3\x71\x96\x9c\x30"
    ...
    def _to_mutable_python(self):
        ...
        import importlib
        mutable_types = importlib.import_module("python_module_root.my.namespacing.test.module.module.thrift_mutable_types")
...
def _fbthrift_metadata__struct_Foo():
    return python_module_root__my__namespacing__test__module__module__thrift_metadata.gen_metadata_struct_Foo()

def _fbthrift_get_reflection_module():
    try:
        import importlib
        return importlib.import_module("python_module_root.my.namespacing.test.module.module.thrift_reflection")
    except ImportError:
        return None
