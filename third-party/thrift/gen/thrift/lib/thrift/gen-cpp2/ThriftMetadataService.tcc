...
void ThriftMetadataServiceAsyncProcessor::process_getThriftServiceMetadata(apache::thrift::ResponseChannelRequest::UniquePtr req, apache::thrift::SerializedCompressedRequest&& serializedRequest, apache::thrift::Cpp2RequestContext* ctx, folly::EventBase* eb, apache::thrift::concurrency::ThreadManager* tm) {
  ...
  try {
    ...
    apache::thrift::detail::ap::process_handle_exn_deserialization<ProtocolOut_>(
        ew, std::move(req), ctx, eb, "getThriftServiceMetadata");
    return;
  }
...
apache::thrift::LegacySerializedResponse ThriftMetadataServiceAsyncProcessor::return_getThriftServiceMetadata(int32_t protoSeqId, apache::thrift::ContextStack* ctx, ::apache::thrift::metadata::ThriftServiceMetadataResponse const& _return) {
  ProtocolOut_ prot;
  ...
  return serializeLegacyResponse("getThriftServiceMetadata", &prot, protoSeqId, ctx, result);
}
