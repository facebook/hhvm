...
class _fbthrift_unadapted_MyStruct(metaclass=_fbthrift_python_types.StructMeta):
    _fbthrift_SPEC = (
        (
            ...
            None,  # default value
            (my.Adapter, lambda: _fbthrift_unadapted_AnnotationWithContainers(names=_fbthrift_python_types.List(, ("bar", "baz", )), counts=_fbthrift_python_types.Map(, , {"c": 3}))),  # adapter info
        ),
    )
