...
$i = 0;
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>true); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 $b = 't';
 $b = true;
 try { P(varray[darray['b' => 1]]>$b); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>false); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>1); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>0); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>null); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>__hhvm_intrinsics\dummy_cast_to_kindofarray(vec[])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>varray[1]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>varray[2]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>darray[0 => '1']); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>varray['a']); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>darray['a' => 1]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>darray['b' => 1]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>darray['a' => 1, 'b' => 2]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>varray[darray['a' => 1]]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>varray[darray['b' => 1]]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
 ...
 print ++$i;
 print "\t";
 try { P(varray[darray['b' => 1]]>'php'); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = varray[darray['b' => 1]];
