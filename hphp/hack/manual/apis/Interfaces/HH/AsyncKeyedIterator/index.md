...
If an ` async ` function returns an [` AsyncIterator<Tk, `](/docs/apis/Interfaces/HH/AsyncIterator/)`` Tv> ``, then you can
...
* [` ->next(): Awaitable<?(Tk, Tv)> `](/docs/apis/Interfaces/HH/AsyncKeyedIterator/next/)\
