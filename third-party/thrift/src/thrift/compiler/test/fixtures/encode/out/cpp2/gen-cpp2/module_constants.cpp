...
::std::string_view _fbthrift_schema_9b2234d2e0a63aa() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_9b2234d2e0a63aa_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_9b2234d2e0a63aa_uris() {
  return {};
}
