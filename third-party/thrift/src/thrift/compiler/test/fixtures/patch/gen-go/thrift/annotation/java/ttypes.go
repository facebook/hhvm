...
func (p EnableIsSetBuilder) Emit() *EnableIsSet{
  return &EnableIsSet{
  }
}

func (p *EnableIsSet) Read(iprot thrift.Protocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *EnableIsSet) Write(oprot thrift.Protocol) error {
  if err := oprot.WriteStructBegin("EnableIsSet"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if err := oprot.WriteFieldStop(); err != nil {
    return thrift.PrependError("write field stop error: ", err) }
  if err := oprot.WriteStructEnd(); err != nil {
...
func (p *EnableIsSet) String() string {
  if p == nil {
    return "<nil>"
  }

  return fmt.Sprintf("EnableIsSet({})")
}
