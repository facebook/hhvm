...
StructMetadata<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::EmptyStruct>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::EmptyStruct>(metadata, kGenerateAll).metadata;
  }

  auto res = genStructMetadata<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::EmptyStruct>(metadata, {.genAnnotations = folly::kIsDebug});
  if (res.preExists) {
    return res.metadata;
  }
...
const ::apache::thrift::metadata::ThriftStruct&
StructMetadata<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::TestStruct>::gen(ThriftMetadata& metadata) {
  if (FLAGS_thrift_enable_schema_to_metadata_conversion) {
    return genStructMetadata<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::TestStruct>(metadata, kGenerateAll).metadata;
  }

  auto res = genStructMetadata<::facebook::thrift::compiler::test::fixtures::default_values_rectification_after::TestStruct>(metadata, {.genAnnotations = folly::kIsDebug});
  if (res.preExists) {
    return res.metadata;
  }
