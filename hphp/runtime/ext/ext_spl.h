...
namespace HPHP {
///////////////////////////////////////////////////////////////////////////////
class SPL: public RequestEventHandler {
public:
  virtual void requestInit();
  virtual void requestShutdown();
	//SPL class handler normalized "Class::function"
	bool bool_spl_register_class(CStrRef className);
	void set_spl_register_class(CStrRef className);
	void unset_spl_register_class(CStrRef className);

  DECLARE_STATIC_REQUEST_LOCAL(SPL, s_instance);

private:
	Array m_spl_registered;
};
Array f_spl_classes();
