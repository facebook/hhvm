...
containerStruct::containerStruct() :
  ...
  13}}})),
      fieldN(),
      fieldQ(),
      fieldR(static_cast<::some::valid::ns::MyEnumA>( ::some::valid::ns::MyEnumA::fieldB)),
      req_fieldR(static_cast<::some::valid::ns::MyEnumA>( ::some::valid::ns::MyEnumA::fieldB)),
      opt_fieldR(static_cast<::some::valid::ns::MyEnumA>( ::some::valid::ns::MyEnumA::fieldB)),
      fieldS(static_cast<::some::valid::ns::MyEnumA>( ::some::valid::ns::MyEnumA::fieldB)),
