...
const std::string_view TEnumTraits<::facebook::thrift::test::terse_write::deprecated::MyEnum>::type_name = TEnumDataStorage<::facebook::thrift::test::terse_write::deprecated::MyEnum>::type_name;
