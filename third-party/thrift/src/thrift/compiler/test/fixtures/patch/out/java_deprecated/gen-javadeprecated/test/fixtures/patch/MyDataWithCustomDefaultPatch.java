...
public class MyDataWithCustomDefaultPatch implements TBase, java.io.Serializable, Cloneable, Comparable<MyDataWithCustomDefaultPatch> {
   ...
   * 
   */
  public MyDataWithCustomDefault assign;
  /**
   ...
   */
  public MyDataWithCustomDefaultFieldPatch patchPrior;
  /**
   * Initialize fields, using the given defaults. Applies third.
   */
  public MyDataWithCustomDefaultEnsureStruct ensure;
  /**
   * Patches any set value, including newly set values. Applies last.
   */
  public MyDataWithCustomDefaultFieldPatch patch;
  /**
  ...
  static {
    ...
    tmpMetaDataMap.put(PATCHPRIOR, new FieldMetaData("patchPrior", TFieldRequirementType.DEFAULT, 
        new StructMetaData(TType.STRUCT, MyDataWithCustomDefaultFieldPatch.class)));
    tmpMetaDataMap.put(ENSURE, new FieldMetaData("ensure", TFieldRequirementType.DEFAULT, 
        new StructMetaData(TType.STRUCT, MyDataWithCustomDefaultEnsureStruct.class)));
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MyDataWithCustomDefaultPatch.class, metaDataMap);
  }
  ...
  public MyDataWithCustomDefaultPatch(
      boolean clear,
      MyDataWithCustomDefaultFieldPatch patchPrior,
      MyDataWithCustomDefaultEnsureStruct ensure,
      MyDataWithCustomDefaultFieldPatch patch,
      List<Short> remove) {
    this();
    this.clear = clear;
    setClearIsSet(true);
  ...
  public MyDataWithCustomDefaultPatch(
      MyDataWithCustomDefault assign,
      boolean clear,
      MyDataWithCustomDefaultFieldPatch patchPrior,
      MyDataWithCustomDefaultEnsureStruct ensure,
      MyDataWithCustomDefaultFieldPatch patch,
  ...
  public static class Builder {
    private MyDataWithCustomDefault assign;
    private boolean clear;
    private MyDataWithCustomDefaultFieldPatch patchPrior;
    private MyDataWithCustomDefaultEnsureStruct ensure;
    private MyDataWithCustomDefaultFieldPatch patch;
    ...
    public Builder setAssign(final MyDataWithCustomDefault assign) {
      this.assign = assign;
      return this;
    }
    ...
    public Builder setPatchPrior(final MyDataWithCustomDefaultFieldPatch patchPrior) {
      this.patchPrior = patchPrior;
      return this;
    }

    public Builder setEnsure(final MyDataWithCustomDefaultEnsureStruct ensure) {
      this.ensure = ensure;
      return this;
    }

    public Builder setPatch(final MyDataWithCustomDefaultFieldPatch patch) {
      this.patch = patch;
      return this;
    }
   ...
   */
  public MyDataWithCustomDefaultPatch(MyDataWithCustomDefaultPatch other) {
  ...
  public MyDataWithCustomDefaultPatch deepCopy() {
    return new MyDataWithCustomDefaultPatch(this);
  }
   ...
   * 
   */
  public MyDataWithCustomDefault getAssign() {
    return this.assign;
  }
   ...
   * 
   */
  public MyDataWithCustomDefaultPatch setAssign(MyDataWithCustomDefault assign) {
    this.assign = assign;
    return this;
  }
   ...
   * Clears a value. Applies first.
   */
  public MyDataWithCustomDefaultPatch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any previously set values. Applies second.
   */
  public MyDataWithCustomDefaultFieldPatch getPatchPrior() {
   ...
   * Patches any previously set values. Applies second.
   */
  public MyDataWithCustomDefaultPatch setPatchPrior(MyDataWithCustomDefaultFieldPatch patchPrior) {
    this.patchPrior = patchPrior;
    return this;
  }
   ...
   * Initialize fields, using the given defaults. Applies third.
   */
  public MyDataWithCustomDefaultEnsureStruct getEnsure() {
    return this.ensure;
  }
   ...
   * Initialize fields, using the given defaults. Applies third.
   */
  public MyDataWithCustomDefaultPatch setEnsure(MyDataWithCustomDefaultEnsureStruct ensure) {
    this.ensure = ensure;
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public MyDataWithCustomDefaultFieldPatch getPatch() {
    return this.patch;
  }
   ...
   * Patches any set value, including newly set values. Applies last.
   */
  public MyDataWithCustomDefaultPatch setPatch(MyDataWithCustomDefaultFieldPatch patch) {
    this.patch = patch;
    return this;
  }
   ...
   * Removes entries, if present. Applies third.
   */
  public MyDataWithCustomDefaultPatch setRemove(List<Short> remove) {
    this.remove = remove;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case ASSIGN:
      if (__value == null) {
        ...
        setAssign((MyDataWithCustomDefault)__value);
      }
      break;
    ...
    case PATCHPRIOR:
      if (__value == null) {
        ...
        setPatchPrior((MyDataWithCustomDefaultFieldPatch)__value);
      }
      break;
    ...
    case ENSURE:
      if (__value == null) {
        ...
        setEnsure((MyDataWithCustomDefaultEnsureStruct)__value);
      }
      break;
    ...
    case PATCH:
      if (__value == null) {
        ...
        setPatch((MyDataWithCustomDefaultFieldPatch)__value);
      }
      break;
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof MyDataWithCustomDefaultPatch))
      return false;
    MyDataWithCustomDefaultPatch that = (MyDataWithCustomDefaultPatch)_that;
  ...
  @Override
  public int compareTo(MyDataWithCustomDefaultPatch other) {
    if (other == null) {
      ...
      switch (__field.id)
      {
        case ASSIGN:
          if (__field.type == TType.STRUCT) {
            this.assign = new MyDataWithCustomDefault();
        ...
        case PATCHPRIOR:
          if (__field.type == TType.STRUCT) {
            this.patchPrior = new MyDataWithCustomDefaultFieldPatch();
        ...
        case ENSURE:
          if (__field.type == TType.STRUCT) {
            this.ensure = new MyDataWithCustomDefaultEnsureStruct();
        ...
        case PATCH:
          if (__field.type == TType.STRUCT) {
            this.patch = new MyDataWithCustomDefaultFieldPatch();
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("MyDataWithCustomDefaultPatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
