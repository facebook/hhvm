...
public class Person2 implements TBase, java.io.Serializable, Cloneable, Comparable<Person2> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(Person2.class, metaDataMap);
  }
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("Person2");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
