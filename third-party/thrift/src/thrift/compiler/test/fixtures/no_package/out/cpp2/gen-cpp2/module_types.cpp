...
const ::cpp2::MyDataItemAlias& MyStruct::get_MyDataField() const& {
...
const ::cpp2::MyStruct& MyException::get_myStruct() const& {
...
const ::cpp2::MyUnion& MyException::get_myUnion() const& {
...
const ::cpp2::MyStruct& MyExceptionWithMessage::get_myStruct() const& {
  return __fbthrift_field_myStruct;
}
...
const ::cpp2::MyUnion& MyExceptionWithMessage::get_myUnion() const& {
  return __fbthrift_field_myUnion;
}
