...
class MyStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_compatible_with_MyStruct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[int, str, MyDataItem, MyEnum, bool, _fbthrift_python_mutable_containers.MutableList[float], _typing.MutableMapping[bytes, str], _fbthrift_python_mutable_containers.MutableSet[int]]]]: ...
...
class Onion(_fbthrift_python_mutable_types.MutableUnion, _fbthrift_compatible_with_Onion):
    ...
    fbthrift_current_value: _typing.Final[_typing.Union[None, MyEnum, PrimitiveStruct, str, _fbthrift_python_mutable_containers.MutableSet[int], _fbthrift_python_mutable_containers.MutableList[float], _typing.MutableMapping[bytes, str], int]]
