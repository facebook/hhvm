...
abstract class A {
  ...
  const sabc = 'abc';
  const f3 = 3.0;
  abstract public function a(?varray $a1 = null, varray $a2 = varray[]):mixed;
...
class B extends A {
  ...
  public function a(?varray $a1 = null, varray $a2 = varray[], varray $a3 = varray[1, 2, 3], varray $a4 = varray["abc"]) :mixed{}
