...
inline Variant operator/(bool    n, CVarRef v);
inline Variant operator/(char    n, CVarRef v);
inline Variant operator/(short   n, CVarRef v);
inline Variant operator/(int     n, CVarRef v);
inline Variant operator/(CStrRef n, CVarRef v) { return Variant(n) / v;}
inline Variant operator/(litstr  n, CVarRef v) { return Variant(n) / v;}
inline Variant operator/(CArrRef n, CVarRef v) { return Variant(n) / v;}
inline Variant operator/(CObjRef n, CVarRef v) { return Variant(n) / v;}
