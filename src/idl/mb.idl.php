  ...
  array(
    ...
    'args'   => array(
      array(
        ...
        'type'   => Variant,
        'value'  => "null_variant",
        'desc'   => "Specify the Unicode value as an integer , or as one of the following string s: \"none\" : no output \"long\" : Output character code value (Example: U+3000, JIS+7E7E) \"entity\" : Output character entity (Example: È€)",
      ),
    ),
  ));
