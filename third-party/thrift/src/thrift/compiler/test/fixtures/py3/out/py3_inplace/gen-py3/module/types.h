...
template<>
inline void reset_field<::py3::simple::IssetInspectionStruct>(
    ::py3::simple::IssetInspectionStruct& obj, uint16_t index) {
  switch (index) {
    case 0:
      obj.int_field_ref().copy_from(default_inst<::py3::simple::IssetInspectionStruct>().int_field_ref());
      return;
    case 1:
      obj.opt_str_field_ref().copy_from(default_inst<::py3::simple::IssetInspectionStruct>().opt_str_field_ref());
      return;
    case 2:
      obj.bool_field_ref().copy_from(default_inst<::py3::simple::IssetInspectionStruct>().bool_field_ref());
      return;
  }
}
...
template<>
inline const std::unordered_map<std::string_view, std::string_view>& PyStructTraits<
    ::py3::simple::IssetInspectionStruct>::namesmap() {
  static const folly::Indestructible<NamesMap> map {
    {
    }
  };
