...
StructMetadata<::test::fixtures::basic-python-capi::ComposeStruct>::gen(ThriftMetadata& metadata) {
  ...
  module_ComposeStruct_fields = new std::array<EncodedThriftField, 10>{{
    ...
    {5, "xenum", false, std::make_unique<Enum<::test::fixtures::basic-python-capi::DepEnum>>("thrift_dep.DepEnum"), std::vector<ThriftConstStruct>{}},
    {6, "xstruct", false, std::make_unique<Struct<::test::fixtures::basic-python-capi::DepStruct>>("thrift_dep.DepStruct"), std::vector<ThriftConstStruct>{}},
