...
var_dump(array_uintersect_assoc($arr1, $arr2, fun('incorrect_return_value')));

echo "\n-- comparison function taking too many parameters --\n";
try { var_dump(array_uintersect_assoc($arr1, $arr2, fun('too_many_parameters'))); } catch (Exception $e) { var_dump($e->getMessage()); }

echo "\n-- comparison function taking too few parameters --\n";
var_dump(array_uintersect_assoc($arr1, $arr2, fun('too_few_parameters')));
