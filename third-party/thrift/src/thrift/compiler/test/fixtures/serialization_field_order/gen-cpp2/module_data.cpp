...
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 3> TStructDataStorage<::cpp2::Foo2>::fields_names = {{
  "field1",
  "field2",
  "field3",
}};
THRIFT_DATA_SECTION const std::array<int16_t, 3> TStructDataStorage<::cpp2::Foo2>::fields_ids = {{
  3,
  1,
  2,
}};
THRIFT_DATA_SECTION const std::array<protocol::TType, 3> TStructDataStorage<::cpp2::Foo2>::fields_types = {{
  TType::T_I32,
  TType::T_I32,
  TType::T_I32,
}};
THRIFT_DATA_SECTION const std::array<folly::StringPiece, 3> TStructDataStorage<::cpp2::Foo2>::storage_names = {{
  "__fbthrift_field_field1",
  "__fbthrift_field_field2",
  "__fbthrift_field_field3",
}};
THRIFT_DATA_SECTION const std::array<int, 3> TStructDataStorage<::cpp2::Foo2>::isset_indexes = {{
  0,
  1,
  2,
}};
