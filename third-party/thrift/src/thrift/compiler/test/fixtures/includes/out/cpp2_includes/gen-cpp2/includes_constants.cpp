...
::std::string_view _fbthrift_schema_eba45c6d4c6de0d() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_eba45c6d4c6de0d_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_eba45c6d4c6de0d_uris() {
  return {};
}
