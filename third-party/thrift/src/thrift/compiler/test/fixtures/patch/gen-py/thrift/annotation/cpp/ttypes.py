...
__all__ = ['UTF8STRINGS', 'RefType', 'EnumUnderlyingType', 'Type', 'Ref', 'Name', 'Lazy', 'DisableLazyChecksum', 'Adapter', 'PackIsset', 'MinimizePadding', 'TriviallyRelocatable', 'ScopedEnumAsUnionType', 'StrongType', 'FieldInterceptor', 'UseOpEncode', 'EnumType', 'Frozen2Exclude', 'Frozen2RequiresCompleteContainerParams', 'GenerateTypedInterceptor']
...
class Type:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'template' in json_obj and json_obj['template'] is not None:
...
class EnumType:
  ...
  def readFromJson(self, json, is_text=True, **kwargs):
    ...
    if 'type' in json_obj and json_obj['type'] is not None:
      self.type = json_obj['type']
      if not self.type in EnumUnderlyingType._VALUES_TO_NAMES:
        msg = 'Integer value ''%s'' is not a recognized value of enum type EnumUnderlyingType' % self.type
        if relax_enum_validation:
            warnings.warn(msg)
        else:
            raise TProtocolException(TProtocolException.INVALID_DATA, msg)
...
class GenerateTypedInterceptor:
  r"""
  ...
  def write(self, oprot):
    ...
    if (isinstance(oprot, TCompactProtocol.TCompactProtocolAccelerated) or (isinstance(oprot, THeaderProtocol.THeaderProtocolAccelerate) and oprot.get_protocol_id() == THeaderProtocol.THeaderProtocol.T_COMPACT_PROTOCOL)) and self.thrift_spec is not None and fastproto is not None:
      oprot.trans.write(fastproto.encode(self, [self.__class__, self.thrift_spec, False], utf8strings=UTF8STRINGS, protoid=2))
      return
    oprot.writeStructBegin('GenerateTypedInterceptor')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def _to_python(self):
    ...
    import thrift.python.converter
    python_types = importlib.import_module("facebook.thrift.annotation.cpp.thrift_types")
    return thrift.python.converter.to_python_struct(python_types.GenerateTypedInterceptor, self)

  def _to_py3(self):
    import importlib
    import thrift.py3.converter
    py3_types = importlib.import_module("facebook.thrift.annotation.cpp.types")
    return thrift.py3.converter.to_py3_struct(py3_types.GenerateTypedInterceptor, self)
...
all_structs.append(GenerateTypedInterceptor)
GenerateTypedInterceptor.thrift_spec = tuple(__EXPAND_THRIFT_SPEC((
)))

GenerateTypedInterceptor.thrift_struct_annotations = {
}
GenerateTypedInterceptor.thrift_field_annotations = {
}
