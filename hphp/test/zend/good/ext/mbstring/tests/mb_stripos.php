<?hh
<<__EntryPoint>>
function entrypoint_mb_stripos(): void {
  ...
  print  mb_stripos($euc_jp,b"\xc6\xfc\xcb\xdc\xb8\xec", 0, 'EUC-JP') . "\n";
  print  mb_stripos($euc_jp, b'0', 0,     'EUC-JP') . "\n";
  print  mb_stripos($euc_jp, '3', 0,       'EUC-JP') . "\n";
  print  mb_stripos($euc_jp, '0', 0,       'EUC-JP') . "\n";
  print  mb_stripos($euc_jp,b"\xc6\xfc\xcb\xdc\xb8\xec", 15, 'EUC-JP') . "\n";
  ...
  $r = mb_stripos($euc_jp,b"\xc6\xfc\xcb\xdc\xb8\xec", -15, 'EUC-JP');
  ...
  ($r === FALSE) ? print "OK_NEGATIVE_OFFSET\n" : print "NG_NEGATIVE_OFFSET\n";
  $r = mb_stripos($euc_jp,b"\xc6\xfc\xcb\xdc\xb8\xec", -50, 'EUC-JP');
  ($r === FALSE) ? print "OK_NEGATIVE_OFFSET\n" : print "NG_NEGATIVE_OFFSET\n";
  ...
  print ("== OUT OF RANGE ==\n");
  $r =  mb_stripos($euc_jp,b"\xc6\xfc\xcb\xdc\xb8\xec", 40, 'EUC-JP');
  ...
  // Non-existent
  echo "== NON-EXISTENT ==\n";
  $r = mb_stripos($euc_jp, b"\xb4\xda\xb9\xf1\xb8\xec", 0, 'EUC-JP');
  ...
  print  mb_stripos($euc_jp,b"\xc6\xfc\xcb\xdc\xb8\xec", 0) . "\n";
  print  mb_stripos($euc_jp, b'0', 0) . "\n";
  print  mb_stripos($euc_jp, '3', 0) . "\n";
  print  mb_stripos($euc_jp, '0', 0) . "\n";

  $r = mb_stripos($euc_jp,b"\xb4\xda\xb9\xf1\xb8\xec", 0);
  ($r === FALSE) ? print "OK_STR\n"     : print "NG_STR\n";
  $r = mb_stripos($euc_jp,b"\n", 0);
  ($r === FALSE) ? print "OK_NEWLINE\n" : print "NG_NEWLINE\n";
  ...
  print  mb_stripos($euc_jp,b"\xc6\xfc\xcb\xdc\xb8\xec") . "\n";
  print  mb_stripos($euc_jp, b'0') . "\n";
  print  mb_stripos($euc_jp, '3') . "\n";
  print  mb_stripos($euc_jp, '0') . "\n";

  $r = mb_stripos($euc_jp,b"\xb4\xda\xb9\xf1\xb8\xec");
  ($r === FALSE) ? print "OK_STR\n"     : print "NG_STR\n";
  $r = mb_stripos($euc_jp,b"\n");
  ($r === FALSE) ? print "OK_NEWLINE\n" : print "NG_NEWLINE\n";
