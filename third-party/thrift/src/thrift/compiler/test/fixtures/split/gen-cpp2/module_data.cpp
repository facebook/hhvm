...
THRIFT_DATA_MEMBER const std::array<::cpp2::MyUnion::Type, 3> TEnumDataStorage<::cpp2::MyUnion::Type>::values = {{
  type::myEnum,
  type::myStruct,
  type::myDataItem,
}};
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 3> TEnumDataStorage<::cpp2::MyUnion::Type>::names = {{
  "myEnum",
  "myStruct",
  "myDataItem",
}};
...
THRIFT_DATA_MEMBER const std::array<folly::StringPiece, 7> TStructDataStorage<::cpp2::MyStruct>::storage_names = {{
