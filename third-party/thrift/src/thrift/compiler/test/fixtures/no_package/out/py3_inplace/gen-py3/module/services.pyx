...
from module.services_wrapper cimport cFooServiceInterface
from module.services_wrapper cimport cFB303ServiceInterface
...
cdef class Promise__module_cbindings_cReservedKeyword:
    cdef cFollyPromise[unique_ptr[_module_cbindings.cReservedKeyword]]* cPromise

    def __cinit__(self):
        self.cPromise = new cFollyPromise[unique_ptr[_module_cbindings.cReservedKeyword]](cFollyPromise[unique_ptr[_module_cbindings.cReservedKeyword]].makeEmpty())

    def __dealloc__(self):
        del self.cPromise

    @staticmethod
    cdef _fbthrift_create(cFollyPromise[unique_ptr[_module_cbindings.cReservedKeyword]] cPromise):
        cdef Promise__module_cbindings_cReservedKeyword inst = Promise__module_cbindings_cReservedKeyword.__new__(Promise__module_cbindings_cReservedKeyword)
...
cdef api void call_cy_FB303Service_simple_rpc(
    object self,
    Cpp2RequestContext* ctx,
    cFollyPromise[unique_ptr[_module_cbindings.cReservedKeyword]] cPromise,
    cint32_t int_parameter
) noexcept:
    cdef Promise__module_cbindings_cReservedKeyword __promise = Promise__module_cbindings_cReservedKeyword._fbthrift_create(cmove(cPromise))
...
async def FB303Service_simple_rpc_coro(
    object self,
    Promise__module_cbindings_cReservedKeyword promise,
    int_parameter
):
    try:
        result = await self.simple_rpc(
        ...
        promise.cPromise.setValue(make_unique[_module_cbindings.cReservedKeyword](_module_thrift_converter.ReservedKeyword_convert_to_cpp(result._to_python())))
...
async def MyService_invalid_return_for_hack_coro(
    ...
    try:
        ...
        promise.cPromise.setValue(make_unique[cset[float]](_module_types.Set__float__make_instance(result)))
