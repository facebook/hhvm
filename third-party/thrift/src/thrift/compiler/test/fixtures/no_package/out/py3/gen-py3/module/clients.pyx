...
from module.clients_wrapper cimport cFooServiceAsyncClient, cFooServiceClientWrapper
from module.clients_wrapper cimport cFB303ServiceAsyncClient, cFB303ServiceClientWrapper
...
cdef void FB303Service_simple_rpc_callback(
    cFollyTry[_module_cbindings.cReservedKeyword]&& result,
    PyObject* userdata
) noexcept:
    client, pyfuture, options = <object> userdata  
    if result.hasException():
        ...
        try:
            pyfuture.set_result(_module_types.ReservedKeyword._create_FBTHRIFT_ONLY_DO_NOT_USE(make_shared[_module_cbindings.cReservedKeyword](cmove(result.value()))))
        except Exception as ex:
            pyfuture.set_exception(ex.with_traceback(None))
...
cdef void MyService_invalid_return_for_hack_callback(
    ...
    if result.hasException():
        ...
        try:
            pyfuture.set_result(_module_types.Set__float__from_cpp(cmove(result.value())))
        except Exception as ex:
            pyfuture.set_exception(ex.with_traceback(None))
...
cdef class FB303Service(thrift.py3.client.Client):
    ...
    _fbthrift_annotations_DO_NOT_USE_simple_rpc = {
        'return': 'module.types.ReservedKeyword',
        'int_parameter': 'int', 
    }
    ...
    def simple_rpc(
        ...
        __future = __loop.create_future()
        __userdata = (self, __future, rpc_options)
        bridgeFutureWith[_module_cbindings.cReservedKeyword](
            self._executor,
