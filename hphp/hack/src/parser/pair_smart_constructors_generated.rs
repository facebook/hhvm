    ...
    SC1::Output: NodeType,
{
    ...
    fn make_parameter_declaration(&mut self, attribute: Self::Output, visibility: Self::Output, optional: Self::Output, call_convention: Self::Output, readonly: Self::Output, type_: Self::Output, ellipsis: Self::Output, name: Self::Output, default_value: Self::Output, parameter_end: Self::Output) -> Self::Output {
        Node(self.0.make_parameter_declaration(attribute.0, visibility.0, optional.0, call_convention.0, readonly.0, type_.0, ellipsis.0, name.0, default_value.0, parameter_end.0), self.1.make_parameter_declaration(attribute.1, visibility.1, optional.1, call_convention.1, readonly.1, type_.1, ellipsis.1, name.1, default_value.1, parameter_end.1))
    }
    ...
    fn make_module_declaration(&mut self, attribute_spec: Self::Output, new_keyword: Self::Output, module_keyword: Self::Output, name: Self::Output, left_brace: Self::Output, imports: Self::Output, exports: Self::Output, right_brace: Self::Output) -> Self::Output {
        Node(self.0.make_module_declaration(attribute_spec.0, new_keyword.0, module_keyword.0, name.0, left_brace.0, imports.0, exports.0, right_brace.0), self.1.make_module_declaration(attribute_spec.1, new_keyword.1, module_keyword.1, name.1, left_brace.1, imports.1, exports.1, right_brace.1))
    }
