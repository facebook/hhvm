...
$i = 0;
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=true); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 $b = 't';
 $b = true;
 try { P(dict['b' => 1]<=$b); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=false); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=1); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=0); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=null); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=dict[]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=vec[1]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=vec[2]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=dict['0' => '1']); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=vec['a']); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=dict['a' => 1]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=dict['b' => 1]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=dict['a' => 1, 'b' => 2]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=vec[dict['a' => 1]]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<=vec[dict['b' => 1]]); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
 ...
 print ++$i;
 print "\t";
 try { P(dict['b' => 1]<='php'); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = dict['b' => 1];
