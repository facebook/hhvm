...
DefineFunction(
  array(
    ...
    'flags'  =>  NoEffect | NoInjection | FunctionIsFoldable,
    'return' => array(
      'type'   => Boolean,
...
DefineFunction(
  array(
    'name'   => "is_int",
    'desc'   => "Finds whether the type of the given variable is integer. Note: To test if a variable is a number or a numeric string (such as form input, which is always a string), you must use is_numeric().",
    'flags'  =>  NoEffect | NoInjection | FunctionIsFoldable,
    'return' => array(
      'type'   => Boolean,
...
DefineFunction(
  array(
    'name'   => "is_float",
    'desc'   => "Finds whether the type of the given variable is float. Note: To test if a variable is a number or a numeric string (such as form input, which is always a string), you must use is_numeric().",
    'flags'  =>  NoEffect | NoInjection | FunctionIsFoldable,
    'return' => array(
      'type'   => Boolean,
...
DefineFunction(
  array(
    ...
    'flags'  =>  NoInjection | FunctionIsFoldable,
    'return' => array(
      'type'   => Int64,
...
DefineFunction(
  array(
    ...
    'return' => array(
      'type'   => Variant,
      'desc'   => "If given a string , integer or float , the value itself will be printed. If given an array , values will be presented in a format that shows keys and elements. Similar notation is used for object s.\nWhen the return parameter is TRUE, this function will return a string . Otherwise, the return value is TRUE.",
    ),
    'args'   => array(
      array(
        'name'   => "expression",
  ...
  array(
    ...
    'args'   => array(
      ...
      array(
        ...
        'type'   => Boolean,
        'value'  => "false",
        'desc'   => "If used and set to TRUE, var_export() will return the variable representation instead of outputing it. Note: This function uses internal output buffering with this parameter so it can not be used inside an ob_start() callback function.",
      ),
    ),
  ));
