...
public class TerseWrite implements TBase, java.io.Serializable, Cloneable, Comparable<TerseWrite> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(TerseWrite.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public TerseWrite build() {
      TerseWrite result = new TerseWrite();
      return result;
    }
  }
  ...
  @Override
  public int compareTo(TerseWrite other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("TerseWrite");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
