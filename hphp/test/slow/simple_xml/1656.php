...
var_dump((array)$a->subnode->offsetGet(0)->attributes());
var_dump((array)$a->subnode->offsetGet(1)->attributes());
var_dump($a->asxml());
...
var_dump($a->getname());
var_dump((array)$a->children()->subnode->offsetGet(0)->subsubnode);
