...
::std::string_view _fbthrift_schema_581154fd6af1d033() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_581154fd6af1d033_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_581154fd6af1d033_uris() {
  return {};
}
