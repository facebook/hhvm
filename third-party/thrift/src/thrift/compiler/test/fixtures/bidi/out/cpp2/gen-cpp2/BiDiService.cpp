...
apache::thrift::ServiceRequestInfoMap BiDiServiceServiceInfoHolder::staticRequestInfoMap() {
  ...
  {"simple",
    { false,
     ...
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::BiDiService>("simple")}},
  {"response",
    { false,
     apache::thrift::RpcKind::BIDIRECTIONAL_STREAM,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::BiDiService>("response")}},
  {"canThrow",
    { false,
     apache::thrift::RpcKind::BIDIRECTIONAL_STREAM,
     ...
     apache::thrift::concurrency::NORMAL,
     std::nullopt,
     ::apache::thrift::detail::getFunctionNode<::cpp2::BiDiService>("canThrow")}},
  };
