...
cdef extern from "thrift/compiler/test/fixtures/no_package/gen-cpp2/module_types.h" namespace "::cpp2":
...
cdef extern from "thrift/lib/cpp2/gen/module_metadata_h.h" namespace "apache::thrift::detail::md":
    cdef cppclass StructMetadata[T]:
        @staticmethod
        void gen(__fbthrift_cThriftMetadata &metadata)
cdef extern from "thrift/compiler/test/fixtures/no_package/gen-cpp2/module_types_custom_protocol.h" namespace "::cpp2":
    ...
    cdef cppclass cMyExceptionWithMessage "::cpp2::MyExceptionWithMessage"(cTException):
    ...
    cdef enum class cUnionToBeRenamed__type "::cpp2::UnionToBeRenamed::Type":
        __EMPTY__,
        reserved_field,
...
cdef extern from "thrift/compiler/test/fixtures/no_package/gen-cpp2/module_constants.h" namespace "::cpp2":
    cdef cbool cFLAG "::cpp2::module_constants::FLAG"
    cdef cint8_t cOFFSET "::cpp2::module_constants::OFFSET"
    cdef cint16_t cCOUNT "::cpp2::module_constants::COUNT"
    cdef cint32_t cMASK "::cpp2::module_constants::MASK"
    cdef double cE "::cpp2::module_constants::E"
    cdef const char* cDATE "::cpp2::module_constants::DATE"()
    cdef vector[cint32_t] cAList "::cpp2::module_constants::AList"()
    cdef cset[string] cASet "::cpp2::module_constants::ASet"()
    cdef cmap[string,vector[cint32_t]] cAMap "::cpp2::module_constants::AMap"()
