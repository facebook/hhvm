...
class Service1_func_result extends \ThriftSyncStructWithResult implements \IThriftStructMetadata {
  ...
  public function readFromJson(string $jsonText): void {
    ...
    if (idx($parsed, 'success') !== null) {
      $_tmp0 = \fb_json_encode_force_php_arrays(HH\FIXME\UNSAFE_CAST<mixed, MyStruct>($parsed['success']));
      $_tmp1 = MyStruct::withDefaultValues();
      $_tmp1->readFromJson($_tmp0);
      $this->success = $_tmp1;
    }
...
class Service1_func2_args implements \IThriftAsyncStruct, \IThriftStructMetadata, \IThriftShapishAsyncStruct {
  ...
  public function readFromJson(string $jsonText): void {
    ...
    if (idx($parsed, 'arg1') !== null) {
      $_tmp0 = \fb_json_encode_force_php_arrays(HH\FIXME\UNSAFE_CAST<mixed, StructWithWrapper>($parsed['arg1']));
