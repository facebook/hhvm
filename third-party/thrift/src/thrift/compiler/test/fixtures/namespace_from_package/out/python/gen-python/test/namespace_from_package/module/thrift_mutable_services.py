...
class TestServiceInterface(
    ...
    async def _fbthrift__handler_init(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(_fbthrift__test__namespace_from_package__module__thrift_mutable_types._fbthrift_TestService_init_args, args, protocol)
        value = await self.init(args_struct.int1,)
        return_struct = _fbthrift__test__namespace_from_package__module__thrift_mutable_types._fbthrift_TestService_init_result(success=value)
