...
template void TccStructTraits<::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
template void TccStructTraits<::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::TestStruct>::translateFieldName(
    std::string_view, int16_t&, apache::thrift::protocol::TType&);
} // namespace apache::thrift::detail
...
std::partial_ordering EmptyStruct::operator<=>([[maybe_unused]] const EmptyStruct& rhs) const {
  return ::apache::thrift::op::compare<EmptyStruct>(*this, rhs);
}
...
TestStruct::TestStruct(apache::thrift::FragileConstructor, ::std::int32_t unqualified_int_field__arg, bool unqualified_bool_field__arg, ::std::vector<::std::int32_t> unqualified_list_field__arg, ::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct unqualified_struct_field__arg, ::std::int32_t optional_int_field__arg, bool optional_bool_field__arg, ::std::vector<::std::int32_t> optional_list_field__arg, ::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct optional_struct_field__arg) :
...
std::partial_ordering TestStruct::operator<=>([[maybe_unused]] const TestStruct& rhs) const {
  return ::apache::thrift::op::compare<TestStruct>(*this, rhs);
}
...
const ::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct& TestStruct::get_unqualified_struct_field() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return __fbthrift_field_unqualified_struct_field;
}

::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct TestStruct::get_unqualified_struct_field() && {
  return static_cast<::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct&&>(__fbthrift_field_unqualified_struct_field);
}
...
const ::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct* TestStruct::get_optional_struct_field() const& [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return optional_struct_field_ref().has_value() ? std::addressof(__fbthrift_field_optional_struct_field) : nullptr;
}

::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct* TestStruct::get_optional_struct_field() & [[FOLLY_ATTR_CLANG_LIFETIMEBOUND]] {
  return optional_struct_field_ref().has_value() ? std::addressof(__fbthrift_field_optional_struct_field) : nullptr;
}
...
static_assert(
    ::apache::thrift::detail::st::gen_check_json<
        ...
        ::facebook::thrift::compiler::test::fixtures::default_values_rectification_before::EmptyStruct>,
...
namespace facebook::thrift::compiler::test::fixtures::default_values_rectification_before { namespace {
