...
impl TokenKind {
    ...
    pub fn ocaml_tag(&self) -> u8 {
        match self {
            ...
            TokenKind::LessThanEqualGreaterThan => 140,
            TokenKind::LessThanLessThan => 141,
            TokenKind::GreaterThanGreaterThan => 142,
            TokenKind::LessThan => 143,
            TokenKind::GreaterThan => 144,
            TokenKind::LessThanEqual => 145,
            TokenKind::GreaterThanEqual => 146,
            TokenKind::EqualEqual => 147,
            TokenKind::EqualEqualEqual => 148,
            TokenKind::ExclamationEqual => 149,
            TokenKind::ExclamationEqualEqual => 150,
            TokenKind::Carat => 151,
            TokenKind::Bar => 152,
            TokenKind::Ampersand => 153,
            TokenKind::AmpersandAmpersand => 154,
            TokenKind::BarBar => 155,
            TokenKind::Question => 156,
            TokenKind::QuestionAs => 157,
            TokenKind::QuestionColon => 158,
            TokenKind::QuestionQuestion => 159,
            TokenKind::QuestionQuestionEqual => 160,
            TokenKind::Colon => 161,
            TokenKind::Semicolon => 162,
            TokenKind::Equal => 163,
            TokenKind::StarStarEqual => 164,
            TokenKind::StarEqual => 165,
            TokenKind::SlashEqual => 166,
            TokenKind::PercentEqual => 167,
            TokenKind::PlusEqual => 168,
            TokenKind::MinusEqual => 169,
            TokenKind::DotEqual => 170,
            TokenKind::LessThanLessThanEqual => 171,
            TokenKind::GreaterThanGreaterThanEqual => 172,
            TokenKind::AmpersandEqual => 173,
            TokenKind::CaratEqual => 174,
            TokenKind::BarEqual => 175,
            TokenKind::Comma => 176,
            TokenKind::At => 177,
            TokenKind::ColonColon => 178,
            TokenKind::EqualGreaterThan => 179,
            TokenKind::EqualEqualGreaterThan => 180,
            TokenKind::QuestionMinusGreaterThan => 181,
            TokenKind::DotDotDot => 182,
            TokenKind::DollarDollar => 183,
            TokenKind::BarGreaterThan => 184,
            TokenKind::SlashGreaterThan => 185,
            TokenKind::LessThanSlash => 186,
            TokenKind::LessThanQuestion => 187,
            TokenKind::QuestionGreaterThan => 188,
            TokenKind::ColonAt => 189,
            TokenKind::ErrorToken => 190,
            TokenKind::Name => 191,
            TokenKind::Variable => 192,
            TokenKind::DecimalLiteral => 193,
            TokenKind::OctalLiteral => 194,
            TokenKind::HexadecimalLiteral => 195,
            TokenKind::BinaryLiteral => 196,
            TokenKind::FloatingLiteral => 197,
            TokenKind::SingleQuotedStringLiteral => 198,
            TokenKind::DoubleQuotedStringLiteral => 199,
            TokenKind::DoubleQuotedStringLiteralHead => 200,
            TokenKind::StringLiteralBody => 201,
            TokenKind::DoubleQuotedStringLiteralTail => 202,
            TokenKind::HeredocStringLiteral => 203,
            TokenKind::HeredocStringLiteralHead => 204,
            TokenKind::HeredocStringLiteralTail => 205,
            TokenKind::NowdocStringLiteral => 206,
            TokenKind::BooleanLiteral => 207,
            TokenKind::XHPCategoryName => 208,
            TokenKind::XHPElementName => 209,
            TokenKind::XHPClassName => 210,
            TokenKind::XHPStringLiteral => 211,
            TokenKind::XHPBody => 212,
            TokenKind::XHPComment => 213,
            TokenKind::Markup => 214,
        }
    }
}
