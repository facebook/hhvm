...
class Fields final  {
 private:
  ...
  static constexpr const std::int16_t __fbthrift_reflection_field_ids[] = {0,100};
...
class FieldsInjectedToEmptyStruct final  {
 private:
  ...
  static constexpr const std::int16_t __fbthrift_reflection_field_ids[] = {0,-1100};
...
class FieldsInjectedToStruct final  {
 private:
  ...
  static constexpr const std::int16_t __fbthrift_reflection_field_ids[] = {0,1,-1100};
...
class FieldsInjectedWithIncludedStruct final  {
 private:
  ...
  static constexpr const std::int16_t __fbthrift_reflection_field_ids[] = {0,1,-1100,-1101,-1102};
...
template <> struct TSchemaAssociation<::cpp2::Fields> {
