...
public interface FooBarBazService extends java.io.Closeable, com.facebook.thrift.util.BlockingService {
    ...
    static com.facebook.thrift.client.ClientBuilder<FooBarBazService> clientBuilder() {
        return new ClientBuilder<FooBarBazService>() {
            @java.lang.Override
            public FooBarBazService build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                FooBarBazService.Reactive _delegate =
                    new FooBarBazServiceReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    public interface Async extends java.io.Closeable, com.facebook.thrift.util.AsyncService {
        ...
        static com.facebook.thrift.client.ClientBuilder<FooBarBazService.Async> clientBuilder() {
            return new ClientBuilder<FooBarBazService.Async>() {
                @java.lang.Override
                public FooBarBazService.Async build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    FooBarBazService.Reactive _delegate =
                        new FooBarBazServiceReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
    ...
    interface Reactive extends reactor.core.Disposable, com.facebook.thrift.util.ReactiveService {
        ...
        static com.facebook.thrift.client.ClientBuilder<FooBarBazService.Reactive> clientBuilder() {
            return new ClientBuilder<FooBarBazService.Reactive>() {
                @java.lang.Override
                public FooBarBazService.Reactive build(com.facebook.thrift.client.v2.manager.RpcClientBinding rpcClientBinding) {
                    return new FooBarBazServiceReactiveClient(protocolId, rpcClientBinding, headersMono, persistentHeadersMono);
                }
            };
        }
