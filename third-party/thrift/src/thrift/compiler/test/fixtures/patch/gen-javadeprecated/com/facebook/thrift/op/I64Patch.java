...
public class I64Patch implements TBase, java.io.Serializable, Cloneable, Comparable<I64Patch> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(I64Patch.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public Builder setAssign(final long assign) {
      this.assign = assign;
    ...
    public Builder setAdd(final long add) {
      this.add = add;
      __optional_isset.set(__ADD_ISSET_ID, true);
      return this;
    }

    public I64Patch build() {
      I64Patch result = new I64Patch();
   ...
   * If set, all other patch operations are ignored.
   */
  public I64Patch setAssign(long assign) {
    this.assign = assign;
    setAssignIsSet(true);
    return this;
  }
   ...
   * Clear any set value.
   */
  public I64Patch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Add to a given value.
   */
  public I64Patch setAdd(long add) {
    this.add = add;
    setAddIsSet(true);
    return this;
  }
  ...
  public Object getFieldValue(int fieldID) {
    switch (fieldID) {
    case ASSIGN:
      return new Long(getAssign());

    case CLEAR:
      return new Boolean(isClear());

    case ADD:
      return new Long(getAdd());
  ...
  @Override
  public int compareTo(I64Patch other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("I64Patch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
