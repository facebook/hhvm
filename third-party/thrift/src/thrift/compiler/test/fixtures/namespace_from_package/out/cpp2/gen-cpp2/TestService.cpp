...
void apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>::async_tm_init(apache::thrift::HandlerCallback<::std::int64_t>::Ptr callback, ::std::int64_t p_int1) {
