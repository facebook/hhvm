<?php
 ...
 function x($a, $b, $c, $d) {}function p($x) { echo $x . "
"; return $x; }class c {  function __construct($a, $b, $c, $d) {}  function f($a, $b, $c, $d) {}  static function g($a, $b, $c, $d) {}}function rt(&$a, $v) {  $a = $v;}function id($x) { return $x; }function dump($a, $b) {  var_dump($a, $b);}echo "sfc
