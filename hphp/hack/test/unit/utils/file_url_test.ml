  ...
  let examples =
    [
      ...
      ( "file:///C:/WINDOWS/Desktop/FileURLs/trailing.",
        "C:/WINDOWS/Desktop/FileURLs/trailing." );
      ( "file:///Macintosh%20HD/fileURLs/trailing.",
        "/Macintosh HD/fileURLs/trailing." );
      ...
      ( "file:///Macintosh%20HD/fileURLs/mozilla-banner",
        "/Macintosh HD/fileURLs/mozilla-banner" );
...
let test_create () =
  ...
  let examples =
    [
      ("c:\\autoexec.bat", "file:///c%3A%5Cautoexec.bat");
      ("c:/autoexec.bat", "file:///c%3A/autoexec.bat");
      ("c:\\\\autoexec.bat", "file:///c%3A%5C%5Cautoexec.bat");
      ("c://autoexec.bat", "file:///c%3A//autoexec.bat");
