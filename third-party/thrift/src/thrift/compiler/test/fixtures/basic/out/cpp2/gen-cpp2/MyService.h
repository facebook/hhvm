...
#endif
  virtual void async_tm_invalid_return_for_hack(apache::thrift::HandlerCallback<std::unique_ptr<::std::set<float>>>::Ptr callback);
...
#endif
  virtual void async_tm_rpc_skipped_codegen(apache::thrift::HandlerCallback<void>::Ptr callback);
 private:
