...
class ThriftField final  {
 ...
 private:
  ::std::vector<::apache::thrift::metadata::ThriftConstStruct> structured_annotations;
 private:
  ::std::map<::std::string, ::std::string> unstructured_annotations;
 ...
 public:
  ...
  FOLLY_ERASE ::apache::thrift::optional_field_ref<const T&> unstructured_annotations_ref() const& {
    return {this->unstructured_annotations, __isset.unstructured_annotations};
  }

  template <typename..., typename T = ::std::map<::std::string, ::std::string>>
  FOLLY_ERASE ::apache::thrift::optional_field_ref<const T&&> unstructured_annotations_ref() const&& {
    return {std::move(this->unstructured_annotations), __isset.unstructured_annotations};
  }
  ...
  ::std::map<::std::string, ::std::string>& set_unstructured_annotations(T_ThriftField_unstructured_annotations_struct_setter&& unstructured_annotations_) {
    unstructured_annotations = std::forward<T_ThriftField_unstructured_annotations_struct_setter>(unstructured_annotations_);
    __isset.unstructured_annotations = true;
    return unstructured_annotations;
  }
