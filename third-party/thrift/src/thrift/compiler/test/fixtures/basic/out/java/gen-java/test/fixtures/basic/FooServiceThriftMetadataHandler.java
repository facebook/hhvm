...
public class FooServiceThriftMetadataHandler implements com.facebook.thrift.server.ThriftMetadataHandler {
    ...
    static {
        ...
        THRIFT_SERVICE = new ThriftService.Builder()
            .setName("test.fixtures.basic.FooService")
    ...
    public String getFullyQualifiedName() {
        return "test.fixtures.basic.FooService";
    }
    ...
    public Map<String, ThriftEnum> getEnums() {
        return FooServiceThriftMetadataHandlerEnums.getEnums();
    }

    @Override
    public Map<String, ThriftStruct> getStructs() {
        return FooServiceThriftMetadataHandlerStructs.getStructs();
    }

    @Override
    public Map<String, ThriftException> getExceptions() {
        return FooServiceThriftMetadataHandlerExceptions.getExceptions();
    }
}
