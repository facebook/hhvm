...
$i = 0;
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\lte(vec['a'], vec[1])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = vec['a'];
 ...
 $b = 't';
 $b = vec[1];
 try { P(HH\Lib\Legacy_FIXME\lte(vec['a'], $b)); } catch (Throwable $_) { print 'E'; }
 ...
 print ++$i;
 print "\t";
 try { P(HH\Lib\Legacy_FIXME\lte(vec['a'], vec[2])); } catch (Throwable $_) { print 'E'; }
 $a = 1;
 $a = 't';
 $a = vec['a'];
 try { P(HH\Lib\Legacy_FIXME\lte($a, vec[2])); } catch (Throwable $_) { print 'E'; }
 $b = 1;
 $b = 't';
 $b = vec[2];
 try { P(HH\Lib\Legacy_FIXME\lte(vec['a'], $b)); } catch (Throwable $_) { print 'E'; }
