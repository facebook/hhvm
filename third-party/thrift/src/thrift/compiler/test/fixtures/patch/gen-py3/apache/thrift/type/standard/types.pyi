...
class JsonType(thrift.py3.types.Enum):
    Null: JsonType = ...
    Boolean: JsonType = ...
    Number: JsonType = ...
    String: JsonType = ...
    Array: JsonType = ...
    Object: JsonType = ...
    def _to_python(self) -> "apache.thrift.type.standard.thrift_types.JsonType": ...   # type: ignore
    def _to_py3(self) -> JsonType: ...
    def _to_py_deprecated(self) -> int: ...
...
class DurationStruct(thrift.py3.types.Struct, _typing.Hashable):
    ...
    def __init__(
        self, *,
        seconds: _typing.Optional[int]=None,
        nanos: _typing.Optional[int]=None
    ) -> None: ...

    def __call__(
        self, *,
        seconds: _typing.Union[int, '__NotSet', None]=NOTSET,
        nanos: _typing.Union[int, '__NotSet', None]=NOTSET
    ) -> DurationStruct: ...

    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['DurationStruct'], bytes]]: ...
    def __hash__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __lt__(self, other: 'DurationStruct') -> bool: ...
    def __gt__(self, other: 'DurationStruct') -> bool: ...
    def __le__(self, other: 'DurationStruct') -> bool: ...
    def __ge__(self, other: 'DurationStruct') -> bool: ...

    def _to_python(self) -> "apache.thrift.type.standard.thrift_types.DurationStruct": ...   # type: ignore
    def _to_py3(self) -> DurationStruct: ...
    def _to_py_deprecated(self) -> "thrift.lib.thrift.standard.ttypes.DurationStruct": ...   # type: ignore

class TimeStruct(thrift.py3.types.Struct, _typing.Hashable):
    class __fbthrift_IsSet:
        seconds: bool
        nanos: bool
        pass
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['TimeStruct'], bytes]]: ...
    def __hash__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __lt__(self, other: 'TimeStruct') -> bool: ...
    def __gt__(self, other: 'TimeStruct') -> bool: ...
    def __le__(self, other: 'TimeStruct') -> bool: ...
    def __ge__(self, other: 'TimeStruct') -> bool: ...

    def _to_python(self) -> "apache.thrift.type.standard.thrift_types.TimeStruct": ...   # type: ignore
    def _to_py3(self) -> TimeStruct: ...
