...
public class Sealed implements TBase, java.io.Serializable, Cloneable, Comparable<Sealed> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(Sealed.class, metaDataMap);
  }
  ...
  @Override
  public int compareTo(Sealed other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("Sealed");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
