...
$hdl = 'string_val';
$extra_arg = 10;
try { var_dump( xml_set_unparsed_entity_decl_handler(null, $hdl, $extra_arg) ); } catch (Exception $e) { echo "\n".'Warning: '.$e->getMessage().' in '.__FILE__.' on line '.__LINE__."\n"; }
...
try { var_dump( xml_set_unparsed_entity_decl_handler(null) ); } catch (Exception $e) { echo "\n".'Warning: '.$e->getMessage().' in '.__FILE__.' on line '.__LINE__."\n"; }
