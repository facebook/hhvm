...
_readField_sessionId:
  {
    ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::string, ::std::string, ::apache::thrift::type::string_t>::readWithContext(*iprot, this->__fbthrift_field_sessionId, _readState);
  }
 this->__isset.set(0, true);
...
uint32_t ShouldBeBoxed::serializedSize(Protocol_ const* prot_) const {
  ...
  {
    xfer += prot_->serializedFieldSize("sessionId", apache::thrift::protocol::TType::T_STRING, 1);
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::string, ::std::string, ::apache::thrift::type::string_t>::serializedSize<false>(*prot_, this->__fbthrift_field_sessionId);
  }
  xfer += prot_->serializedSizeStop();
  return xfer;
}
...
uint32_t ShouldBeBoxed::write(Protocol_* prot_) const {
  ...
  if constexpr (requires { prot_->fieldOrder(); }) {
    if (prot_->fieldOrder() == ::apache::thrift::FieldOrder::IdAscending) {
      return ::apache::thrift::op::detail::StructEncode<ShouldBeBoxed>{}(*prot_, *this);
    }
  }
  uint32_t xfer = 0;
  ...
  {
    constexpr int16_t kPrevFieldId = 0;
    xfer += ::apache::thrift::detail::writeFieldBegin<apache::thrift::protocol::TType::T_STRING, 1, kPrevFieldId>(*prot_, "sessionId", previousFieldHasValue);
    previousFieldHasValue = true;
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::string, ::std::string, ::apache::thrift::type::string_t>::write(*prot_, this->__fbthrift_field_sessionId);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldStop();
  xfer += prot_->writeStructEnd();
