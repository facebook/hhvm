...
void c_Vector::initFvFields(c_FixedVector* fv) {
  fv->m_data = m_data;
  fv->m_size = m_size;
...
Object c_Vector::t_tofixedvector() {
  if (m_frozenCopy.isNull()) {
    c_FixedVector* fv = NEWOBJ(c_FixedVector)();
    initFvFields(fv);
    m_frozenCopy = fv;
  }
...
Object c_Vector::t_tofixedset() {
  return materializeDefaultImpl<c_FixedSet>(this);
}
...
bool c_FixedVector::t_isempty() {
  return BaseVector::isempty();
}

int64_t c_FixedVector::t_count() {
  return BaseVector::count();
}

Object c_FixedVector::t_items() {
  return BaseVector::items();
}

// ConstIndexAccess

bool c_FixedVector::t_containskey(CVarRef key) {
  return BaseVector::containskey(key);
}

Variant c_FixedVector::t_at(CVarRef key) {
  return BaseVector::at(key);
}

Variant c_FixedVector::t_get(CVarRef key) {
  return BaseVector::get(key);
}

// KeyedIterable

Object c_FixedVector::t_getiterator() {
  return BaseVector::getiterator();
}

Object c_FixedVector::t_map(CVarRef callback) {
  return php_map<c_FixedVector>(callback, &makeArgsFromVectorValue);
}

Object c_FixedVector::t_mapwithkey(CVarRef callback) {
  return php_map<c_FixedVector>(callback, &makeArgsFromVectorKeyAndValue);
}

Object c_FixedVector::t_filter(CVarRef callback) {
  return php_filter<c_FixedVector>(callback, &makeArgsFromVectorValue);
}

Object c_FixedVector::t_filterwithkey(CVarRef callback) {
  return php_filter<c_FixedVector>(callback, &makeArgsFromVectorKeyAndValue);
}

Object c_FixedVector::t_zip(CVarRef iterable) {
  BaseVector* bv;
  Object obj = bv = NEWOBJ(c_FixedVector);
  BaseVector::zip(bv, iterable);
  return obj;
}

Object c_FixedVector::t_kvzip() {
  BaseVector* bv;
  Object obj = bv = NEWOBJ(c_FixedVector);
  BaseVector::kvzip(bv);
  return obj;
...
Object c_FixedVector::ti_slice(CVarRef vec, CVarRef offset,
                                CVarRef len /* = null */) {
  return BaseVector::slice<c_FixedVector>("FixedVector", vec, offset, len);
}

// Others

void c_FixedVector::t___construct(CVarRef iterable /* = null_variant */) {
  BaseVector::construct(iterable);
}

Object c_FixedVector::t_lazy() {
  return BaseVector::lazy();
}

Array c_FixedVector::t_toarray() {
  return BaseVector::toarray();
}

Array c_FixedVector::t_tokeysarray() {
  return BaseVector::tokeysarray();
}

Array c_FixedVector::t_tovaluesarray() {
  return BaseVector::tovaluesarray();
}

int64_t c_FixedVector::t_linearsearch(CVarRef search_value) {
  return BaseVector::linearsearch(search_value);
}

Object c_FixedVector::t_values() {
  return Object::attach(BaseVector::Clone<c_FixedVector>(this));
}


// Non PHP methods.

c_FixedVector::c_FixedVector(Class* cls) : BaseVector(cls) {
  o_subclassData.u16 = Collection::FixedVectorType;
}
...
bool c_FixedMap::t_isempty() { return php_isEmpty(); }

bool c_Map::t_isempty() { return php_isEmpty();  }

int64_t c_FixedMap::t_count() { return size(); }

int64_t c_Map::t_count() { return size(); }

Object c_FixedMap::t_items() { return php_items(); }
...
Object c_FixedMap::t_keys() { return php_keys(); }

Object c_Map::t_keys() { return php_keys(); }

Object c_FixedMap::t_lazy() { return php_lazy(); }
...
Object c_FixedMap::t_kvzip() { return php_kvzip(); }
...
Variant c_FixedMap::t_at(CVarRef key) { return php_at(key); }
...
Variant c_FixedMap::t_get(CVarRef key) { return php_get(key); }
...
bool c_FixedMap::t_contains(CVarRef key) { return php_contains(key); }

bool c_Map::t_contains(CVarRef key) { return php_contains(key); }

bool c_FixedMap::t_containskey(CVarRef key) { return php_contains(key); }
...
Array c_FixedMap::t_toarray() { return php_toArray(); }
...
Object c_FixedMap::t_values() { return php_values(); }
...
Array c_FixedMap::t_tokeysarray() { return php_toKeysArray(); }
...
Array c_FixedMap::t_tovaluesarray() { return php_toValuesArray(); }
...
Object c_FixedMap::t_differencebykey(CVarRef it) {
  return php_differenceByKey<c_FixedMap>(it);
}
...
Object c_FixedMap::t_getiterator() { return php_getIterator(); }
...
Object c_FixedMap::t_map(CVarRef callback) {
  return php_map<c_FixedMap>(callback, &makeArgsFromMapValue);
}
...
Object c_FixedMap::t_mapwithkey(CVarRef callback) {
  return php_map<c_FixedMap>(callback, &makeArgsFromMapKeyAndValue);
}
...
Object c_FixedMap::t_filter(CVarRef callback) {
  return php_filter<c_FixedMap>(callback, &makeArgsFromMapValue);
}
...
Object c_FixedMap::t_filterwithkey(CVarRef callback) {
  return php_filter<c_FixedMap>(callback, &makeArgsFromMapKeyAndValue);
}
...
Object c_FixedMap::t_zip(CVarRef iterable) {
  return php_zip<c_FixedMap>(iterable);
}
...
Object c_FixedMap::ti_fromitems(CVarRef iterable) {
  return php_mapFromIterable<c_FixedMap>(iterable);
}
...
ObjectData* collectionDeepCopyFixedMap(c_FixedMap* map) {
  return collectionDeepCopyBaseMap<c_FixedMap>(map);
}
...
c_FixedMap::c_FixedMap(Class* cb) : BaseMap(cb) {
  o_subclassData.u16 = Collection::FixedMapType;
}

void c_FixedMap::t___construct(CVarRef iterable /* = null_variant */) {
  php_construct(iterable);
}

c_FixedMap* c_FixedMap::Clone(ObjectData* obj) {
  return BaseMap::Clone<c_FixedMap>(obj);
}
...
void c_FixedSet::t___construct(CVarRef iterable /* = null_variant */) {
  BaseSet::php_construct(iterable);
}

bool c_FixedSet::t_isempty() {
  return BaseSet::php_isEmpty();
}

int64_t c_FixedSet::t_count() {
  return BaseSet::php_count();
}

Object c_FixedSet::t_items() {
  return BaseSet::php_items();
}

Object c_FixedSet::t_values() {
  return BaseSet::php_values<c_FixedVector>();
}

Object c_FixedSet::t_lazy() {
  return BaseSet::php_lazy();
}

bool c_FixedSet::t_contains(CVarRef key) {
  return BaseSet::php_contains(key);
}

Array c_FixedSet::t_toarray() {
  return BaseSet::php_toArray();
}

Array c_FixedSet::t_tokeysarray() {
  return BaseSet::php_toKeysArray();
}

Array c_FixedSet::t_tovaluesarray() {
  return BaseSet::php_toValuesArray();
}

Object c_FixedSet::t_getiterator() {
  return BaseSet::php_getIterator();
}

Object c_FixedSet::t_map(CVarRef callback) {
  return BaseSet::php_map<c_FixedSet>(callback);
}

Object c_FixedSet::t_filter(CVarRef callback) {
  return BaseSet::php_filter<c_FixedSet>(callback);
}

Object c_FixedSet::t_zip(CVarRef iterable) {
  return BaseSet::php_zip<c_FixedSet>(iterable);
}

Object c_FixedSet::ti_fromitems(CVarRef iterable) {
  return BaseSet::php_fromItems<c_FixedSet>(iterable);
}

Object c_FixedSet::ti_fromarrays(int _argc, CArrRef _argv) {
  return BaseSet::php_fromArrays<c_FixedSet>(_argc, _argv);
}

c_FixedSet::c_FixedSet(Class* cls) : BaseSet(cls) {
  o_subclassData.u16 = Collection::FixedSetType;
}

void c_FixedSet::Unserialize(ObjectData* obj, VariableUnserializer* uns,
    int64_t sz, char type) {
  BaseSet::Unserialize("FixedSet", obj, uns, sz, type);
}

c_FixedSet* c_FixedSet::Clone(ObjectData* obj) {
  return BaseSet::Clone<c_FixedSet>(obj);
}
...
COLLECTION_MAGIC_METHODS(FixedVector)
COLLECTION_MAGIC_METHODS(Map)
COLLECTION_MAGIC_METHODS(FixedMap)
COLLECTION_MAGIC_METHODS(Set)
COLLECTION_MAGIC_METHODS(FixedSet)
...
#define ITERABLE_MATERIALIZE_METHODS(cls) \
  ...
  Object c_##cls::t_tofixedvector() { \
    c_FixedVector* fv; \
    Object o = fv = NEWOBJ(c_FixedVector)(); \
    fv->init(VarNR(this)); \
    return o; \
  } \
  ...
  Object c_##cls::t_tofixedset() { \
    c_FixedSet* st; \
    Object o = st = NEWOBJ(c_FixedSet)(); \
    st->init(VarNR(this)); \
    return o; \
  }
...
KEYEDITERABLE_MATERIALIZE_METHODS(FixedMap)
ITERABLE_MATERIALIZE_METHODS(Set)
ITERABLE_MATERIALIZE_METHODS(FixedSet)
KEYEDITERABLE_MATERIALIZE_METHODS(Pair)
KEYEDITERABLE_MATERIALIZE_METHODS(FixedVector)
    ...
    case KindOfObject: {
      ...
      switch (obj->getCollectionType()) {
        ...
        case Collection::FixedMapType:
          obj = collectionDeepCopyFixedMap(static_cast<c_FixedMap*>(obj));
          break;
        ...
        case Collection::FixedSetType:
          obj = collectionDeepCopyFixedSet(static_cast<c_FixedSet*>(obj));
          break;
        case Collection::FixedVectorType:
          obj = collectionDeepCopyFixedVector(
                  static_cast<c_FixedVector*>(obj));
          break;
...
ObjectData* collectionDeepCopyFixedVector(c_FixedVector* vec) {
  return collectionDeepCopyBaseVector<c_FixedVector>(vec);
}
...
void collectionSet(ObjectData* obj, TypedValue* key, TypedValue* val) {
  ...
  switch (obj->getCollectionType()) {
    ...
    case Collection::PairType:
      ...
      break;
    case Collection::FixedVectorType:
      collectionThrowHelper(ErrMsgType::CannotAssign, "FixedVector");
      break;
    case Collection::FixedMapType:
      collectionThrowHelper(ErrMsgType::CannotAssign, "FixedMap");
      break;
    case Collection::InvalidType:
      assert(false);
  }
...
void collectionUnset(ObjectData* obj, TypedValue* key) {
  ...
  switch (obj->getCollectionType()) {
    ...
    case Collection::PairType:
      ...
      break;
    case Collection::FixedVectorType:
      collectionThrowHelper(ErrMsgType::CannotUnset, "FixedVector");
      break;
    case Collection::FixedMapType:
      collectionThrowHelper(ErrMsgType::CannotUnset, "FixedMap");
      break;
    case Collection::FixedSetType:
      collectionThrowHelper(ErrMsgType::CannotUnset, "FixedSet");
      break;
    case Collection::InvalidType:
      assert(false);
      break;
...
void collectionAppend(ObjectData* obj, TypedValue* val) {
  ...
  switch (obj->getCollectionType()) {
    ...
    case Collection::PairType:
      ...
      break;
    case Collection::FixedVectorType:
      collectionThrowHelper(ErrMsgType::CannotAdd, "FixedVector");
      break;
    case Collection::FixedMapType:
      collectionThrowHelper(ErrMsgType::CannotAdd, "FixedMap");
      break;
    case Collection::FixedSetType:
      collectionThrowHelper(ErrMsgType::CannotAdd, "FixedSet");
      break;
    case Collection::InvalidType:
      assert(false);
      break;
...
static inline Variant& collectionOffsetAtImpl(ObjectData* obj,
  ...
  switch (obj->getCollectionType()) {
    ...
    case Collection::PairType:
      ...
      break;
    case Collection::FixedVectorType:
      collectionThrowHelper(ErrMsgType::OnlyIntKeys, "FixedVectors");
      res = nullptr;
      break;
    case Collection::InvalidType:
      assert(false);
...
void collectionUnserialize(ObjectData* obj, VariableUnserializer* uns,
  ...
  switch (obj->getCollectionType()) {
    ...
    case Collection::SetType:
      ...
      break;
    case Collection::FixedVectorType:
      c_FixedVector::Unserialize(obj, uns, sz, type);
      break;
    case Collection::FixedSetType:
      c_FixedSet::Unserialize(obj, uns, sz, type);
      break;
    case Collection::PairType:
...
ObjectData* newCollectionHelper(uint32_t type, uint32_t size) {
  ...
  switch (type) {
    ...
    case Collection::FixedVectorType: obj = NEWOBJ(c_FixedVector)(); break;
    case Collection::FixedMapType: obj = NEWOBJ(c_FixedMap)(); break;
    case Collection::FixedSetType: obj = NEWOBJ(c_FixedSet)(); break;
    case Collection::InvalidType:
      obj = nullptr;
