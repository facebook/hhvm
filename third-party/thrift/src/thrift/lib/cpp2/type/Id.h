...
inline constexpr bool is_ordinal_v = false;
template <Ordinal ord>
inline constexpr bool is_ordinal_v<std::integral_constant<Ordinal, ord>> = true;
...
template <typename Id>
inline constexpr bool is_field_id_v = false;
template <FieldId id>
inline constexpr bool is_field_id_v<std::integral_constant<FieldId, id>> = true;

// Helpers for ident tags defined in code gen.
template <typename Id, typename = void>
inline constexpr bool is_ident_v = false;
template <typename Id>
...
template <typename Id>
inline constexpr bool is_id_v = detail::is_type_tag_v<Id> ||
